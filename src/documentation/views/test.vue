...
.test.ma12.pa12.bd1.bdrs2
  ...
  w-tabs(v-model="currTab" :items="tabs")
...
export default {
  data: () => ({
    ...
    tabs: [
      ...
      { id: 3, title: 'Tab 3 has a long title', content: 'Tab 3 content.' }
    ],
    deletedTabs: []
  }),
  ...
  methods: {
    ...
    addTab (index) {
      this.tabs.splice(index ?? this.tabs.length, 0, { title: `Tab ${this.tabs.length}`, content: `Tab ${this.tabs.length} content.` })
    }
  }
}
</script>
