...
export default {
  data: () => ({
    ...
    waveUiOptions: [
      ...
      { label: 'css.appClasses', definition: 'Custom CSS classes to add to the <code>.w-app</code> element. Accepts a space-separated string or an array of class names. Default: <code>""</code>. Example: <code>"row"</code> or <code>["row", "my-custom-class"]</code>.' },
      { label: 'css.colorShades', definition: 'With this option set to true, custom colors and status colors generate shade classes. Default: <code>true</code>.' },
      { label: 'css.colorShadeCssVariables', definition: 'With this option set to true, generated custom/status shades also expose <code>--w-{name}-color</code> variables. Built-in palette shades always expose variables.' },
