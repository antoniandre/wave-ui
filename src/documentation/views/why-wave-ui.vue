...
div
  ...
  w-alert.alert--info.pa5(icon-outside)
    .title3
      ...
      span.ml3 An emerging new UI framework for Vue.js with only the bright side.
      w-icon.ml2(size="1.2em" style="color: #ffc518") mdi mdi-white-balance-sunny
  ...
  p.
    ...
    This way, you stay the master of your global styles.

  p.
    Which means that if you decide to style a button from scratch from this #[button default button],
    to this #[w-button great button], Wave UI will not be on your way with tons of default styles.#[br]
