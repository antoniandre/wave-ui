...
main
  ...
  alert.top-alert.pa5(info)
    .title3
      ...
      span A UI framework for Vue.js — designed to shine without the shadows.
  ...
  p.
    ...
    Instead, you get a clean foundation that's easy to extend.#[br]#[br]
