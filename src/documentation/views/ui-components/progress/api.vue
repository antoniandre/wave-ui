...
const propsDescs = {
  ...
  ariaLabel: 'Sets the accessible name of the progress bar for assistive technology (e.g. <code>"Upload progress"</code>). Recommended whenever the purpose of the progress bar is not obvious from surrounding context.',
