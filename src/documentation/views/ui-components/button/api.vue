...
const propsDescs = {
  ...
  type: 'Provide a native HTML type attribute.',
  ...
  icon: 'Sets the button to a round icon style, containing only an icon. This prop accepts a string: e.g. <code>mdi mdi-home</code>.',
