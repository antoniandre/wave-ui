...
div(style="max-width: 1000px")
  ...
  example(content-class="pt5")
    ...
    template(#html).
      &lt;w-button @click="showAlert = !showAlert" color="primary" outline&gt;{{ showAlert ? 'Hide' : 'Show' }} alert&lt;/w-button&gt;
      &lt;w-transition-expand y&gt;
        &lt;w-alert v-if="showAlert" color="success"&gt;The alert is now visible.&lt;/w-alert&gt;
      &lt;/w-transition-expand&gt;
    template(#js).
      data: () => ({
        showAlert: false
  ...
  example(content-class="py0")
    ...
    template(#html).
      &lt;w-alert color="primary"&gt;This is an alert with a primary color.&lt;/w-alert&gt;
      &lt;w-alert bg-color="primary" color="white"&gt;This is an alert with a primary background color.&lt;/w-alert&gt;
      &lt;w-alert color="pink"&gt;This is an alert with a pink color.&lt;/w-alert&gt;
      &lt;w-alert bg-color="pink" color="white"&gt;This is an alert with a pink background color.&lt;/w-alert&gt;
      &lt;p&gt;You can even mix different colors and background colors.&lt;/p&gt;
      &lt;w-alert bg-color="purple" color="cyan-light4"&gt;This is an alert with a purple background and cyan color.&lt;/w-alert&gt;
      &lt;w-alert bg-color="cyan-light4" color="purple"&gt;This is an alert with a cyan background and purple color.&lt;/w-alert&gt;
  ...
  example(content-class="py0")
    ...
    template(#html).
      &lt;w-alert bg-color="yellow-light5" color="amber" icon="wi-star"&gt;This is an alert with a custom icon.&lt;/w-alert&gt;
  ...
  example(content-class="py0")
    ...
    template(#html).
      &lt;w-alert class="size--xs" color="info" success&gt;This is an extra small alert.&lt;/w-alert&gt;
      ...
      &lt;w-alert class="size--xl" color="info" success&gt;This is an extra large alert.&lt;/w-alert&gt;
</template>
