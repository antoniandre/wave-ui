...
const propsDescs = {
  ...
  noSlider: 'When set to <code>true</code>, removes the slider bellow the active tab title.',
  pillSlider: 'When set to <code>true</code>, places the slider underneath the active tab title text in pill shape.',
