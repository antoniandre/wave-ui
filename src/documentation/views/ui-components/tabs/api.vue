...
const propsDescs = {
  ...
  itemIdKey: 'Specifies the name of the attribute in each item object where to find the item\'s unique ID.<br>Having a unique ID is important when injecting and replacing tabs. If no unique id is provided, Wave UI will generate one and <strong>inject it in each item</strong>.',
