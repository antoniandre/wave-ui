...
const propsDescs = {
  ...
  xs: 'Sets the size (font-size) of the rating component to extra small.',
  sm: 'Sets the size (font-size) of the rating component to small.',
  md: 'Sets the size (font-size) of the rating component to medium.',
