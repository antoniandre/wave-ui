...
div
  ...
  ul
    li #[code menu-props] #[small.grey E.g. #[code.grey :menu-props="{ bgColor: 'green' }"]]
  ...
  example
    ...
    w-confirm(:menu-props="{ bgColor: 'indigo-light1', color: 'white' }") Ask for confirm
    template(#pug).
      w-confirm.mb2(bg-color="success") Ask for confirm
      w-confirm.mb2(bg-color="info" color="yellow") Ask for confirm
      w-confirm(:menu-props="{ bgColor: 'indigo-light1', color: 'white' }") Ask for confirm
  ...
  example.example--no-arrow
    w-confirm.ma2(no-arrow :menu-props="{ bgColor: 'blue-light5' }") Bottom
    w-confirm.ma2(no-arrow right) Right
    w-confirm.ma2.mb12(:menu-props="{ noPosition: true, detachTo: '.example--no-arrow' }") No position
