  ...
  w-card(bg-color="blue-light5")
    ...
    div
      .w-flex.wrap.my1
        ...
        w-checkbox.mr3.mb1(:value="true" readonly label="Checked &amp; readonly")
      .w-flex.wrap.my1
        w-checkbox.mr3.mb1(:value="false" label="Unchecked")
        w-checkbox.mr3.mb1(:value="false" disabled label="Unchecked &amp; disabled")
        w-checkbox.mr3.mb1(:value="false" readonly label="Unchecked &amp; readonly")
      .w-flex.wrap.my1
        ...
        w-checkbox.mr3.mb1(:value="true" readonly indeterminate label="Indeterminate &amp; readonly")
