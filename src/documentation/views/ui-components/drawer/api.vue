...
const propsDescs = {
  ...
  ariaLabel: 'Sets the accessible label (<code>aria-label</code>) for the drawer dialog. Recommended so assistive technology can identify the purpose of the drawer.'
}
