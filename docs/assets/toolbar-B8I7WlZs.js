import{A as e,G as t,P as n,c as r,d as i,g as a,h as o}from"./runtime-core.esm-bundler-CLfruy3s.js";import{t as s}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{r as c}from"./index-I7dyuwKt.js";function l(s,c){let l=n(`title-link`),u=n(`w-toolbar`),d=n(`w-icon`),f=n(`w-button`),p=n(`example`),m=n(`w-card`),h=n(`w-flex`),g=n(`w-divider`);return e(),i(`div`,null,[a(l,{h2:``},{default:t(()=>[...c[0]||=[o(`Simple toolbar with shadow`,-1)]]),_:1}),a(p,{"content-class":`pa4`},{pug:t(()=>[...c[5]||=[o(`w-toolbar(shadow)
  .title2 Title
  .spacer
  span.ml2 Item 1
  span.ml2 Item 2
