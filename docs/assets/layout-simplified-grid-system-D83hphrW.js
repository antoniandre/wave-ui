import{r as t,g as e,o as i,a as s,b as r,w as l,e as o,F as a,j as f,_ as w}from"./index-eD21R81v.js";const x={class:"box"},v={class:"box"},k={class:"box"};function y(C,n){const d=t("title-link"),g=t("router-link"),b=t("alert"),u=t("w-grid"),p=t("example");return i(),e("main",null,[s(d,{class:"mt4",h1:""},{default:l(()=>n[0]||(n[0]=[o("Simplified grid system (CSS grids)")])),_:1}),s(b,{info:""},{default:l(()=>[n[2]||(n[2]=o(`The 12-cell based flexbox grid system works well and for most cases, but it has
