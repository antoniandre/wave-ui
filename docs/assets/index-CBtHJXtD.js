...
re-run.
`)],-1)])),_:1,__:[22]}),l(i,{class:"mt10",h3:""},{default:s(()=>e[23]||(e[23]=[n("Creating a validator function")])),_:1,__:[23]}),e[83]||(e[83]=t("p",null,[n(`A validator is a custom function that tells Wave UI if the field is valid or invalid when the
...
`)])),_:1,__:[24]},8,["dark"]),l(C,{class:"mt12"}),l(i,{h2:""},{default:s(()=>e[25]||(e[25]=[n("Basic validation")])),_:1,__:[25]}),e[84]||(e[84]=t("p",null,[n("In this example and by default, the fields are validated on "),t("span",{class:"code"},"keyup"),n(", on "),t("span",{class:"code"},"blur"),n(`,
...
})`)])),default:s(()=>[l(p,{modelValue:o.form1.valid,"onUpdate:modelValue":e[0]||(e[0]=u=>o.form1.valid=u)},{default:s(()=>[l(d,{label:"First name",validators:[o.validators.required,o.validators.alphabetical]},null,8,["validators"]),l(d,{class:"mt3",label:"Last name",validators:[o.validators.required]},null,8,["validators"]),t("div",M,[e[27]||(e[27]=t("strong",null,"v-model:",-1)),t("code",D,v(o.form1.valid===!1?"false":o.form1.valid||"null"),1),l(f,{type:"submit",disabled:o.form1.valid===!1},{default:s(()=>e[26]||(e[26]=[n("Validate")])),_:1,__:[26]},8,["disabled"])])]),_:1},8,["modelValue"])]),_:1}),l(m,{warning:""},{default:s(()=>e[31]||(e[31]=[t("strong",null,"Heads up!",-1),t("div",null,[n("The v-model value has 3 states: "),t("code",null,"true"),n(" and "),t("code",null,"false"),n(` for success and error, but also
...
`)])),_:1,__:[32]}),l(i,{h2:""},{default:s(()=>e[33]||(e[33]=[n("Direct submission to a server")])),_:1,__:[33]}),e[85]||(e[85]=h(`<p class="mt6">The <span class="code">w-form</span> prevents the form submission by default - for modern usage where an AJAX
...
`)])),default:s(()=>[l(p,{action:"test.php",method:"post",target:"_blank","allow-submit":""},{default:s(()=>[l(d,{label:"First name",validators:[o.validators.required]},null,8,["validators"]),l(d,{class:"mt3",label:"Last name",validators:[o.validators.required]},null,8,["validators"]),t("div",O,[l(f,{type:"submit"},{default:s(()=>e[34]||(e[34]=[n("Validate")])),_:1,__:[34]})])]),_:1})]),_:1}),l(m,{tip:""},{default:s(()=>e[38]||(e[38]=[n(`To submit a form via the HTML standard way like in this example, you need to add
the `),t("code",null,"action",-1),n(" attribute and optionally a "),t("code",null,"method",-1),n(` attribute.
`)])),_:1,__:[38]}),l(i,{h2:""},{default:s(()=>e[39]||(e[39]=[n("Validate on submit, on blur, on keyup")])),_:1,__:[39]}),e[86]||(e[86]=h(`<p>By default the validation happens on <span class="code">keyup</span>, on <span class="code">blur</span> and on
...
`)])),default:s(()=>[l(p,{"no-keyup-validation":"","no-blur-validation":""},{default:s(()=>[l(d,{label:"First name",validators:[o.validators.required]},null,8,["validators"]),l(d,{class:"mt3",label:"Last name",validators:[o.validators.required]},null,8,["validators"]),t("div",B,[l(f,{type:"submit"},{default:s(()=>e[40]||(e[40]=[n("Validate")])),_:1,__:[40]})])]),_:1})]),_:1}),l(i,{h2:""},{default:s(()=>e[44]||(e[44]=[n("Reset the form")])),_:1,__:[44]}),e[87]||(e[87]=t("p",null,[n("Once the form is invalid, you can reset it with a basic HTML reset button, like in this example."),t("br"),n(`
...
`)])),default:s(()=>[l(p,{modelValue:o.form4.valid,"onUpdate:modelValue":e[1]||(e[1]=u=>o.form4.valid=u)},{default:s(()=>[l(d,{label:"First name",validators:[o.validators.required]},null,8,["validators"]),l(d,{class:"mt3",label:"Last name",validators:[o.validators.required]},null,8,["validators"]),t("div",P,[l(f,{class:"my1 mr2","bg-color":"warning",type:"reset"},{default:s(()=>e[45]||(e[45]=[n("Reset")])),_:1,__:[45]}),l(f,{class:"my1",type:"submit"},{default:s(()=>e[46]||(e[46]=[n("Validate")])),_:1,__:[46]})])]),_:1},8,["modelValue"])]),_:1}),l(i,{h2:""},{default:s(()=>e[50]||(e[50]=[n("On validate, on success & on error events")])),_:1,__:[50]}),e[88]||(e[88]=h(`<p class="title5">These events are fired on submit.</p><ul><li class="mt1"><code>before-validate</code> is always fired as soon as a submission is attempted (e.g. submit
...
for this purpose.`)])),_:1,__:[51]}),l(b,null,{pug:s(()=>e[53]||(e[53]=[n(`w-alert(
  :success="success"
  :error="error"
  :info="!success && !error").
...
`)])),default:s(()=>[l(U,{"content-class":"pa0",class:j(a.$store.state.darkMode?"grey-dark6--bg":"white--bg")},{default:s(()=>[t("div",N,[l(L,null,{default:s(()=>[o.form6.submitted?(g(),_(y,{key:0,class:"my0 text-light",success:"","no-border":""},{default:s(()=>e[57]||(e[57]=[n("The form is valid, ready to send it!")])),_:1,__:[57]})):o.form6.valid===!1?(g(),_(y,{key:1,class:"my0 text-light",error:"","no-border":""},{default:s(()=>[n("The form has "+v(o.form6.errorsCount)+" errors.",1)]),_:1})):I("",!0)]),_:1})]),l(p,{class:"px8 pt2 pb12",modelValue:o.form6.valid,"onUpdate:modelValue":e[6]||(e[6]=u=>o.form6.valid=u),"errors-count":o.form6.errorsCount,"onUpdate:errorsCount":e[7]||(e[7]=u=>o.form6.errorsCount=u),onValidate:c.onValidate,onSuccess:c.onSuccess},{default:s(()=>[l(d,{required:"",label:"First name",validators:[o.validators.required]},null,8,["validators"]),l(d,{class:"mt3",required:"",label:"Last name",validators:[o.validators.required]},null,8,["validators"]),l(d,{class:"mt3",disabled:"",label:"User name"}),l(V,{class:"mt4",wrap:"","align-center":"","justify-end":""},{default:s(()=>[l(S,{required:"",validators:[o.validators.consent]},{default:s(()=>e[58]||(e[58]=[n("I agree to the terms & conditions")])),_:1,__:[58]},8,["validators"]),e[61]||(e[61]=t("div",{class:"spacer"},null,-1)),l(f,{class:"my1 mr2","bg-color":"warning",type:"reset",onClick:e[5]||(e[5]=u=>o.form6.submitted=o.form6.sent=!1)},{default:s(()=>e[59]||(e[59]=[n("Reset")])),_:1,__:[59]}),l(f,{class:"my1",type:"submit",disabled:o.form6.valid===!1,loading:o.form6.submitted&&!o.form6.sent},{default:s(()=>e[60]||(e[60]=[n("Validate")])),_:1,__:[60]},8,["disabled","loading"])]),_:1,__:[61]})]),_:1},8,["modelValue","errors-count","onValidate","onSuccess"]),l(A,{modelValue:o.form6.sent,"onUpdate:modelValue":e[8]||(e[8]=u=>o.form6.sent=u),success:"",transition:"bounce",absolute:"",plain:"",round:"",bottom:""},{default:s(()=>e[62]||(e[62]=[n("The form was sent successfully!")])),_:1,__:[62]},8,["modelValue"])]),_:1},8,["class"])]),_:1}),l(i,{h2:""},{default:s(()=>e[67]||(e[67]=[n("Disabled & readonly form")])),_:1,__:[67]}),e[91]||(e[91]=t("p",null,[n("You can add the "),t("code",null,"disabled"),n(" or "),t("code",null,"readonly"),n(" prop on the "),t("strong",{class:"code"},"w-form"),n(` tag to
...
`)])),default:s(()=>[l(f,{outline:!o.form7.disabled,onClick:e[9]||(e[9]=u=>{o.form7.readonly=!1,o.form7.disabled=!o.form7.disabled})},{default:s(()=>e[69]||(e[69]=[n("Form disabled")])),_:1,__:[69]},8,["outline"]),l(f,{class:"ml2",outline:!o.form7.readonly,onClick:e[10]||(e[10]=u=>{o.form7.disabled=!1,o.form7.readonly=!o.form7.readonly})},{default:s(()=>e[70]||(e[70]=[n("Form readonly")])),_:1,__:[70]},8,["outline"]),l(p,{class:"mt4",modelValue:o.form7.valid,"onUpdate:modelValue":e[11]||(e[11]=u=>o.form7.valid=u),disabled:o.form7.disabled,readonly:o.form7.readonly},{default:s(()=>[l(d,{label:"First name",validators:[o.validators.required,o.validators.alphabetical]},null,8,["validators"]),l(d,{class:"mt3",label:"Last name",validators:[o.validators.required]},null,8,["validators"]),l(V,{class:"mt4","justify-end":""},{default:s(()=>[l(f,{type:"reset","bg-color":"warning"},{default:s(()=>e[71]||(e[71]=[n("Reset")])),_:1,__:[71]}),l(f,{class:"ml2",type:"submit",disabled:o.form7.valid===!1},{default:s(()=>e[72]||(e[72]=[n("Validate")])),_:1,__:[72]},8,["disabled"])]),_:1})]),_:1},8,["modelValue","disabled","readonly"])]),_:1}),l(i,{h2:""},{default:s(()=>e[76]||(e[76]=[n("Asynchronous validations")])),_:1,__:[76]}),e[92]||(e[92]=t("p",null,"You may want to validate a field on server side, for this you can use an asynchronous validator.",-1)),l(m,{tip:""},{default:s(()=>e[77]||(e[77]=[n("You should first be familiar with Promises and "),t("span",{class:"code"},"async",-1),n("/"),t("span",{class:"code"},"await",-1),n(`.
If you're not you can read about it
`),t("a",{href:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function",target:"_blank"},"here",-1),n(".")])),_:1,__:[77]}),e[93]||(e[93]=t("p",null,[n(`This example presents a common case: checking if a username is already in use from a user
