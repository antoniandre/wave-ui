import{N as e,W as t,bt as n,c as r,d as i,g as a,h as o,k as s}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as c}from"./plugin-vue_export-helper-B80Cc4Ui.js";import{F as l,h as u}from"./index-BhRaCC4I.js";var d={class:`mt2`},f={class:`mt2`};function p(c,l,u,p,m,h){let g=e(`title-link`),_=e(`w-rating`),v=e(`example`);return s(),i(`div`,null,[a(g,{h2:``},{default:t(()=>[...l[2]||=[o(`Default`,-1)]]),_:1}),a(v,null,{pug:t(()=>[...l[3]||=[o(`w-rating`,-1)]]),html:t(()=>[...l[4]||=[o(`<w-rating></w-rating>
