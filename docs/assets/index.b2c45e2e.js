import{r as l,o as u,e as h,f as n,w as t,g as e,i as o,N as k}from"./vendor.e64646cc.js";import{_,i as b}from"./index.90e40c3f.js";const A=e("ul",null,[e("li",{class:"title4"},[o("The purpose of the "),e("strong",{class:"code"},"w-confirm"),o(` component is to quickly set up a
...
`),q=o("Icon button"),B=o('w-confirm(icon="mdi mdi-delete")'),$=o(`<w-confirm icon="mdi mdi-delete">
  Delete
</w-confirm>
`),j=o("Colors"),S=k(`<p>The <code>bg-color</code> &amp; <code>color</code> props apply to the button you first see.<br>
To apply colors (or other props) to the menu or the buttons inside the menu, you can do it via:</p><ul><li><code>menu</code> <small class="grey">E.g. <code class="grey">:menu=&quot;{ bgColor: &#39;green&#39; }&quot;</code></small></li><li><code>cancel</code> <small class="grey">E.g. <code class="grey">:cancel=&quot;{ bgColor: &#39;green&#39; }&quot;</code></small></li><li><code>confirm</code> <small class="grey">E.g. <code class="grey">:confirm=&quot;{ bgColor: &#39;green&#39; }&quot;</code></small></li></ul>`,2),N=o("Ask for confirm"),R=o("Ask for confirm"),P=o("Ask for confirm"),L=o(`w-confirm.mb2(bg-color="success") Ask for confirm
...
`),to=o("Vertical"),no=o("Left, align top"),eo=o("Left, align center"),io=o("Left, align bottom"),so=o("Right, align top"),co=o("Right, align center"),lo=o("Right, align bottom"),ro=o(`w-flex.text-center(justify-center)
  div
  ...
  div
    ...
    w-confirm.ma2(right align-bottom) Right, align bottom`),ao=o(`<w-flex justify-center class="text-center">
  <div>
...
`)],-1),xo=o("Using the "),vo=e("code",null,"question",-1),Co=o(" prop"),To=o("Ask for confirm"),qo=o(`w-confirm(question="Are you sure you want to delete this?").
  Ask for confirm`),Bo=o(`<w-confirm question="Are you sure you want to delete this?">
  Ask for confirm
</w-confirm>
`),$o=o("Using the "),jo=e("code",null,"#question",-1),So=o(" slot"),No=o("Ask for confirm"),Ro=o("Are you sure you want to delete this?"),Po=o(`w-confirm
  | Ask for confirm
...
You can disable the arrow via the `),e("code",null,"no-arrow"),o(" option.")],-1),lt=o("Bottom"),rt=o("Right"),at=o("No position"),mt=o(`w-confirm.ma2(no-arrow :menu="{ bgColor: 'blue-light5' }") Bottom
