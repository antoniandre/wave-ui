import{o as m,g as b,a as r,w as o,b as t,d as w,e as s,n as P,q as D,v as C,h as $,r as d,_ as g,M as O}from"./index.708fd280.js";const V=s("p",null,[t("The "),s("strong",{class:"code"},"w-drawer"),t(` component can be placed in a deeper structure than the root of
...
The pushable content should be provided via the <code>pushable</code> slot.</p>`,1),j={class:"py12 w-flex column align-center justify-center"},R=s("p",{class:"mb3"},"Pushable content",-1),B=s("div",{class:"ma2"},"Drawer content",-1),L={class:"py12 w-flex column align-center justify-center"},M=s("p",{class:"mb3"},"Pushable content",-1),_=s("div",{class:"ma2"},"Drawer content",-1),U=s("span",null,"Open top drawer with a:",-1),I=s("p",{class:"mt4"},[s("strong",null,"Note:"),t(` with no overlay the underneath content will be clickable and the drawer
will not close.
...
anything until you accept.`,-1),H={class:"w-flex pa2 align-center wrap"},W={class:"w-flex align-center py1"},q=s("div",{class:"spacer"},null,-1),Y=s("p",null,`You can then store the result of the acceptation in the localStorage when the user clicks
the button.`,-1),x={class:"w-flex align-center justify-center fill-height"},F=s("div",{class:"w-flex fill-height align-center justify-center black"},"You can customize the background color as well.",-1);function J(e,n,f,v,k,u){const i=d("title-link"),l=d("w-button"),p=d("example"),c=d("w-drawer"),T=d("w-card"),y=d("w-icon"),h=d("ssh-pre");return m(),b("div",null,[r(i,{h2:""},{default:o(()=>[t("Basic")]),_:1}),r(p,{"content-class":"w-flex align-center wrap"},{pug:o(()=>[t(`w-button(@click="openDrawer = true" outline) Open drawer
...
`)]),default:o(()=>[N,r(l,{onClick:n[7]||(n[7]=a=>{e.bottomDrawerHeight="60px",e.openBottomDrawer=!0}),outline:""},{default:o(()=>[t("Open drawer")]),_:1})]),_:1}),r(i,{h2:""},{default:o(()=>[t("Push content")]),_:1}),A,r(p,{"content-class":"relative pa0","app-props-string":"","blank-codepen":["css"]},{pug:o(()=>[t(`w-drawer(
  v-model="openDrawer"
  push-content
...
`)]),default:o(()=>[r(c,{modelValue:e.openPushContentRightDrawer,"onUpdate:modelValue":n[9]||(n[9]=a=>e.openPushContentRightDrawer=a),"push-content":"","overlay-opacity":.15,width:"160px"},{pushable:o(()=>[s("div",j,[R,r(l,{onClick:n[8]||(n[8]=a=>e.openPushContentRightDrawer=!0),outline:""},{default:o(()=>[t("Open drawer")]),_:1})])]),default:o(()=>[B]),_:1},8,["modelValue","overlay-opacity"])]),_:1}),r(p,{"content-class":"relative pa0","app-props-string":"","blank-codepen":["css"]},{pug:o(()=>[t(`w-drawer(
  v-model="openDrawer"
  push-content
  :overlay-opacity="0.15"
  left
...
To continue browsing this site you must agree.`,2)]),q,r(l,{sm:"",onClick:n[17]||(n[17]=a=>e.showCookieNotice=!1)},{default:o(()=>[r(y,{class:"mr2"},{default:o(()=>[t("mdi mdi-check")]),_:1}),t("I agree")]),_:1})])]),_:1},8,["modelValue"])]),_:1}),Y,D(r(h,{dark:e.$store.state.darkMode,language:"html-vue",label:"Template"},{default:o(()=>[t(`<w-button
  class="ml-auto"
  @click="acceptCookies"
  sm
  absolute>
