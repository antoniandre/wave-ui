...
`,-1)])),default:n(()=>[l(s,{data:o.tree2},null,8,["data"])]),_:1}),l(d,{h2:""},{default:n(()=>e[11]||(e[11]=[t("Icons",-1)])),_:1,__:[11]}),e[73]||(e[73]=f("<p>You can provide different icons for the expand button and tree items.</p><p>You can also provide icons for each item. Depending on the type of item:</p><ul><li><code>expand-icon</code>: for the expand icon.</li><li><code>expand-open-icon</code>: for the expand icon when open (if different than the <code>expand-icon</code>).</li><li><code>branch-icon</code>: if the item has children.</li><li><code>branch-open-icon</code>: if the item has children and it is open.</li><li><code>leaf-icon</code>: for items which don&#39;t contain anything.</li></ul>",3)),l(i,null,{pug:n(()=>e[12]||(e[12]=[t(`w-tree.size--md(
  ...
  leaf-icon="mdi mdi-file-outline")`,-1)])),html:n(()=>e[13]||(e[13]=[t(`<w-tree
  :data="tree"
  expand-icon="mdi mdi-plus"
  expand-open-icon="mdi mdi-minus"
  branch-icon="mdi mdi-folder-outline"
  ...
  class="size--md">
</w-tree>`,-1)])),js:n(()=>e[14]||(e[14]=[t(`data: () => ({
  tree: [
    {
      label: 'src',
      children: [
...
`,-1)])),default:n(()=>[l(s,{class:"size--md",data:o.tree2,"expand-icon":"mdi mdi-plus","expand-open-icon":"mdi mdi-minus","branch-icon":"mdi mdi-folder-outline","branch-open-icon":"mdi mdi-folder-open-outline","leaf-icon":"mdi mdi-file-outline"},null,8,["data"])]),_:1}),l(d,{h3:""},{default:n(()=>e[15]||(e[15]=[t("Different icon per item",-1)])),_:1,__:[15]}),e[74]||(e[74]=f(`<p>It is possible to set a specific icon in any/each item of the tree.<br>
...
but you can override that with the <code>item-icon-color-key</code> prop.</p>`,2)),l(i,null,{pug:n(()=>e[16]||(e[16]=[t(`w-tree.size--md(
  ...
  branch-icon="mdi mdi-folder-outline"
  branch-open-icon="mdi mdi-folder-open-outline"
  leaf-icon="mdi mdi-file-outline")`,-1)])),html:n(()=>e[17]||(e[17]=[t(`<w-tree
  :data="tree"
  expand-icon="mdi mdi-plus"
  expand-open-icon="mdi mdi-minus"
  branch-icon="mdi mdi-folder-outline"
  branch-open-icon="mdi mdi-folder-open-outline"
  leaf-icon="mdi mdi-file-outline"
  class="size--md"></w-tree>`,-1)])),js:n(()=>e[18]||(e[18]=[t(`data: () => ({
  tree: [
    {
      label: 'src',
...
`,-1)])),default:n(()=>[l(s,{class:"size--md",data:o.tree6,"icon-color":"blue-dark1"},null,8,["data"])]),_:1}),l(d,{h3:""},{default:n(()=>e[19]||(e[19]=[t("No expand button",-1)])),_:1,__:[19]}),l(i,null,{pug:n(()=>e[20]||(e[20]=[t('w-tree(:data="tree" :expand-icon="false")',-1)])),html:n(()=>e[21]||(e[21]=[t('<w-tree :data="tree" :expand-icon="false"></w-tree>',-1)])),js:n(()=>e[22]||(e[22]=[t(`data: () => ({
  tree: [
    {
      label: 'src',
      children: [
...
`,-1)])),default:n(()=>[l(s,{data:o.tree2,"expand-icon":!1},null,8,["data"])]),_:1}),l(d,{h2:""},{default:n(()=>e[23]||(e[23]=[t("Selectable",-1)])),_:1,__:[23]}),l(i,null,{pug:n(()=>e[24]||(e[24]=[t('w-tree(:data="tree" selectable)',-1)])),html:n(()=>e[25]||(e[25]=[t('<w-tree :data="tree" selectable></w-tree>',-1)])),js:n(()=>e[26]||(e[26]=[t(`data: () => ({
  data: () => ({
  tree: [
    {
      label: 'Branch 1',
...
`,-1)])),default:n(()=>[l(s,{data:o.tree1,selectable:""},null,8,["data"])]),_:1}),l(d,{h2:""},{default:n(()=>e[27]||(e[27]=[t("Counts",-1)])),_:1,__:[27]}),l(i,null,{pug:n(()=>e[28]||(e[28]=[t('w-tree(:data="tree" counts)',-1)])),html:n(()=>e[29]||(e[29]=[t('<w-tree :data="tree" counts></w-tree>',-1)])),js:n(()=>e[30]||(e[30]=[t(`data: () => ({
  tree: [
    {
      label: 'Branch 1',
      children: [
...
`,-1)])),default:n(()=>[l(s,{data:o.tree1,counts:""},null,8,["data"])]),_:1}),l(d,{h2:""},{default:n(()=>e[31]||(e[31]=[t("No transition",-1)])),_:1,__:[31]}),l(i,null,{pug:n(()=>e[32]||(e[32]=[t('w-tree(:data="tree" no-transition)',-1)])),html:n(()=>e[33]||(e[33]=[t('<w-tree :data="tree" no-transition></w-tree>',-1)])),js:n(()=>e[34]||(e[34]=[t(`data: () => ({
  data: () => ({
  tree: [
    {
      label: 'Branch 1',
...
`,-1)])),default:n(()=>[l(s,{data:o.tree1,"no-transition":""},null,8,["data"])]),_:1}),l(d,{h2:""},{default:n(()=>e[35]||(e[35]=[t("Unexpandable empty branches",-1)])),_:1,__:[35]}),l(i,null,{pug:n(()=>e[39]||(e[39]=[t('w-tree(:data="tree" unexpandable-empty)',-1)])),html:n(()=>e[40]||(e[40]=[t('<w-tree :data="tree" unexpandable-empty></w-tree>',-1)])),js:n(()=>e[41]||(e[41]=[t(`data: () => ({
  tree: [
    {
      label: 'Branch 1',
      children: [
...
`,-1)])),default:n(()=>[a("div",A,[a("div",null,[e[36]||(e[36]=a("div",{class:"title3"},"Normal",-1)),l(s,{data:o.tree1},null,8,["data"])]),l(p,{class:"grey-light3 mx12",rotate90a:"",xl:""},{default:n(()=>e[37]||(e[37]=[t("wi-arrow-down",-1)])),_:1,__:[37]}),a("div",null,[e[38]||(e[38]=a("div",{class:"title3"},"unexpandable-empty",-1)),l(s,{data:o.tree1,"unexpandable-empty":""},null,8,["data"])])])]),_:1}),l(d,{h2:""},{default:n(()=>e[42]||(e[42]=[t("V-model",-1)])),_:1,__:[42]}),e[75]||(e[75]=a("p",null,[t("When the tree is "),a("code",null,"selectable"),t(", you can use the "),a("code",null,"v-model"),t(" to get the selected item.")],-1)),e[76]||(e[76]=a("p",null,"Click on a tree item to select it.",-1)),l(i,null,{pug:n(()=>e[44]||(e[44]=[t('w-tree(v-model="selection" :data="tree" selectable)',-1)])),html:n(()=>e[45]||(e[45]=[t('<w-tree v-model="selection" :data="tree" selectable></w-tree>',-1)])),js:n(()=>e[46]||(e[46]=[t(`data: () => ({
  tree: [
    {
      label: 'Branch 1',
      children: [
...
`,-1)])),default:n(()=>[l(s,{modelValue:o.selection,"onUpdate:modelValue":e[0]||(e[0]=r=>o.selection=r),data:o.tree1,selectable:""},null,8,["modelValue","data"]),a("div",E,[e[43]||(e[43]=a("strong",{class:"mr3"},"Selection:",-1)),a("pre",{class:L(["pa2",o.$store.state.darkMode?"grey-dark6--bg":"orange-light6--bg"])},h(o.selection),3)])]),_:1}),l(d,{h2:""},{default:n(()=>e[47]||(e[47]=[t("Events",-1)])),_:1,__:[47]}),e[77]||(e[77]=f('<p>Multiple events are fired from the <strong class="code">w-tree</strong> component:</p><ul class="lh0"><li><code>before-open</code>: fired as soon as the user clicks a tree item that is expandable and before the subitems are revealed.</li><li class="mt1"><code>open</code>: fired after a user clicks a tree item that is expandable, and after the expand animation.</li><li class="mt1"><code>before-close</code>: fired as soon as the user clicks a tree item to close its subtree.</li><li class="mt1"><code>close</code>: fired after a user clicks a tree item to close its subtree, and after the collapse animation.</li><li class="mt1"><code>click</code>: fired when the user clicks any tree item.</li><li class="mt1"><code>select</code>: fired when the user selects any selectable tree item. The <code>selectable</code> option must be set to true.</li><li class="mt1"><code>update:model-value</code>: (or <code>input</code> in Vue 2.x) fired when the user selects any selectable tree item. The <code>selectable</code> option must be set to true.</li></ul>',2)),l(i,null,{pug:n(()=>e[48]||(e[48]=[t(`w-tree(
  :data="tree"
  ...
  selectable)`,-1)])),html:n(()=>e[49]||(e[49]=[t(`<w-tree
  :data="tree"
  @before-open="log('@before-open', $event)"
  @open="log('@open', $event)"
  @before-close="log('@before-close', $event)"
  ...
  @select="log('@select', $event)"
  selectable>
</w-tree>`,-1)])),js:n(()=>e[50]||(e[50]=[t(`data: () => ({
  tree: [
    {
      label: 'src',
      children: [
...
}`,-1)])),default:n(()=>[l(s,{data:o.tree3,onClick:c.renameLeafItem,"deep-reactivity":""},null,8,["data","onClick"])]),_:1}),l(S,{tip:""},{default:n(()=>[e[61]||(e[61]=a("strong",{class:"black"},"Note on reactivity",-1)),a("p",B,[e[57]||(e[57]=t(`By default the tree items key-value pairs will not be watched as this is a more expensive
operation. This means that if you want to have reactivity when you modify a key or value,
like the label, you will need to add the `,-1)),e[58]||(e[58]=a("code",null,"deep-reactivity",-1)),e[59]||(e[59]=t(" option.",-1)),e[60]||(e[60]=a("br",null,null,-1)),a("a",T,[e[56]||(e[56]=t("Read on deep watchers on the Vue.js official documentation",-1)),l(p,{class:"ml1"},{default:n(()=>e[55]||(e[55]=[t("mdi mdi-open-in-new",-1)])),_:1,__:[55]})])])]),_:1,__:[61]}),l(d,{h2:""},{default:n(()=>e[62]||(e[62]=[t("Custom item (icon + label)",-1)])),_:1,__:[62]}),e[78]||(e[78]=a("p",null,[t("If you need to customize the layout of the item label and/or icon, you can use the "),a("code",null,"#item"),t(" slot.")],-1)),l(i,null,{pug:n(()=>e[66]||(e[66]=[t(`w-tree.lh5(:data="tree")
  template(#item="{ item, open }")
    ...
    w-icon.ml1(v-else-if="item.status === 'syncing'" bg-color="warning" xs) mdi mdi-clock-outline`,-1)])),html:n(()=>e[67]||(e[67]=[t(`<w-tree :data="tree">
  <template #item="{ item, open }">
...
</w-tree>`,-1)])),js:n(()=>e[68]||(e[68]=[t(`data: () => ({
  tree: [
    {
      label: 'Item 1',
      children: [
...
`,-1)])),default:n(()=>[l(s,{class:"lh5",data:o.tree4},{item:n(({item:r,open:H})=>[a("span",null,h(r.label),1),r.status==="error"?(b(),g(p,{key:0,class:"ml1","bg-color":"error",xs:""},{default:n(()=>e[63]||(e[63]=[t("mdi mdi-close",-1)])),_:1,__:[63]})):r.status==="success"?(b(),g(p,{key:1,class:"ml1","bg-color":"success",xs:""},{default:n(()=>e[64]||(e[64]=[t("mdi mdi-check",-1)])),_:1,__:[64]})):r.status==="syncing"?(b(),g(p,{key:2,class:"ml1","bg-color":"warning",xs:""},{default:n(()=>e[65]||(e[65]=[t("mdi mdi-clock-outline",-1)])),_:1,__:[65]})):I("",!0)]),_:1},8,["data"])]),_:1}),l(d,{h2:""},{default:n(()=>e[69]||(e[69]=[t("Expand all, by default",-1)])),_:1,__:[69]}),l(i,null,{pug:n(()=>e[70]||(e[70]=[t('w-tree(:data="tree" expand-all)',-1)])),html:n(()=>e[71]||(e[71]=[t('<w-tree :data="tree" expand-all></w-tree>',-1)])),js:n(()=>e[72]||(e[72]=[t(`data: () => ({
  tree: [
      {
        label: 'Item 1',
        children: [
