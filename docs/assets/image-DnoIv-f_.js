import{N as e,U as t,c as n,d as r,g as i,h as a,k as o,l as s,u as c,yt as l}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as u}from"./_plugin-vue_export-helper-S3RvzygF.js";import{T as d}from"./index-BJr8b_n6.js";var f={class:`w-card w-flex mdu-row basis-zero pa4 gap4`},p={class:`mr5`},m={class:`w-flex wrap justify-center align-center`},h={class:`mr4 my2`},g={class:`w-flex gap6`};function _(u,d,_,v,y,b){let x=e(`title-link`),S=e(`w-divider`),C=e(`alert`),w=e(`w-image`),T=e(`example`),E=e(`w-card`),D=e(`w-radios`),O=e(`w-button`),k=e(`w-alert`);return o(),r(`div`,null,[i(x,{h2:``},{default:t(()=>[...d[2]||=[a(`Why using w-image and not a simple <img>`,-1)]]),_:1}),n(`div`,f,[d[4]||=n(`div`,null,[n(`div`,{class:`title3`},`A simple <img>`),n(`p`,null,[a(`will display when loaded, and will take the dimensions of the actual image.`),n(`br`),a(`
...
The second example sets a width and height of 500x150, which is also cropping it.`)],-1),i(T,{"content-class":`text-center w-flex justify-space-around wrap`},{pug:t(()=>[...d[17]||=[a('w-image.mr5(:src="`${baseUrl}images/japanese-wave.png`" :width="150" :height="150")\n\nw-image(:src="`${baseUrl}images/japanese-wave.png`" :width="500" :height="150")',-1)]]),html:t(()=>[...d[18]||=[a(`<w-image
  class="mr5"
...
<w-image
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  :width="400">
</w-image>`,-1)]]),js:t(()=>[...d[25]||=[a(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})
`,-1)]]),default:t(()=>[n(`div`,null,[i(w,{src:`${u.baseUrl}images/japanese-wave.png`,width:200},null,8,[`src`]),d[21]||=n(`div`,{class:`caption text-center`},`Real size: 1900x443. Given size: width=200.`,-1)]),n(`div`,null,[i(w,{src:`${u.baseUrl}images/japanese-wave.png`,width:400},null,8,[`src`]),d[22]||=n(`div`,{class:`caption text-center`},`Real size: 1900x443. Given size: width=400.`,-1)])]),_:1}),i(x,{h3:``},{default:t(()=>[...d[26]||=[a(`Given fixed height only`,-1)]]),_:1}),d[115]||=n(`p`,null,`If the height is all you provide, the real ratio of the image will be computed and used.
In result, the image will have the given fixed height and will display in full: it will not be cropped
and will not grow or shrink with constraints.`,-1),i(T,{"content-class":`text-center w-flex column`},{pug:t(()=>[...d[29]||=[a('w-image.mr5(:src="`${baseUrl}images/japanese-wave.png`" :height="70")\n\nw-image(:src="`${baseUrl}images/japanese-wave.png`" :height="120")',-1)]]),html:t(()=>[...d[30]||=[a(`<w-image
  class="mr5"
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  :height="70">
</w-image>
...
resizing your browser width and height to observe the rendering!`)])],-1),i(T,{"content-class":`text-center w-flex column gap5`},{pug:t(()=>[...d[36]||=[a('w-image(:src="`${baseUrl}images/japanese-wave.png`" width="100%")\n\nw-card(content-class="pa0" style="height: 100px")\n  w-image(:src="`${baseUrl}images/japanese-wave.png`" height="100%")',-1)]]),html:t(()=>[...d[37]||=[a(`<w-image
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  width="100%">
</w-image>
...
<w-image
  ...
  width="30vw"
  height="10vh">
</w-image>`,-1)]]),js:t(()=>[...d[38]||=[a(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})
`,-1)]]),default:t(()=>[n(`div`,null,[i(w,{src:`${u.baseUrl}images/japanese-wave.png`,width:`100%`},null,8,[`src`]),d[33]||=n(`div`,{class:`caption text-center`},`Real size: 1900x443. Given size: width=100%.`,-1)]),n(`div`,null,[i(E,{"content-class":`pa0`,style:{height:`100px`}},{default:t(()=>[i(w,{src:`${u.baseUrl}images/japanese-wave.png`,height:`100%`},null,8,[`src`])]),_:1}),d[34]||=n(`div`,{class:`caption text-center`},`Real size: 1900x443. Given size: height=100%.`,-1)]),n(`div`,null,[i(w,{src:`${u.baseUrl}images/japanese-wave.png`,width:`30vw`,height:`10vh`},null,8,[`src`]),d[35]||=n(`div`,{class:`caption text-center`},`Real size: 1900x443. Given size: width=30vw, height=10vh.`,-1)])]),_:1}),i(x,{h2:``},{default:t(()=>[...d[39]||=[a(`Image ratio`,-1)]]),_:1}),d[118]||=n(`p`,{class:`grey`},`The ratio prop purpose is to maintain a specific image ratio while resizing with constraints.`,-1),d[119]||=n(`p`,null,[a(`Usually you don't need to set a ratio since Wave UI computes the original image ratio and already
...
`)],-1),i(x,{h3:``},{default:t(()=>[...d[40]||=[a(`Intrinsic image ratio`,-1)]]),_:1}),d[120]||=n(`p`,{class:`grey`},`Image ratio equal to the exact width and height of the image (width / height).`,-1),d[121]||=n(`p`,null,[a(`This is the most common case: the image is visible in full, and scales with its container with
preserved ratio.`),n(`br`),a(`
Note that Wave UI will add a width of 100% if neither of width and height are provided.`)],-1),i(C,{class:`mt2`,tip:``},{default:t(()=>[...d[41]||=[a(`In this case, you can obtain the same result by just setting a width of 100%.`,-1)]]),_:1}),i(T,{"content-class":`text-center`},{pug:t(()=>[...d[42]||=[a('w-image(:src="`${baseUrl}images/japanese-wave.png`" :ratio="1900 / 443")',-1)]]),html:t(()=>[...d[43]||=[a(`<w-image
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  :ratio="1900 / 443">
</w-image>`,-1)]]),js:t(()=>[...d[44]||=[a(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})
`,-1)]]),default:t(()=>[i(w,{src:`${u.baseUrl}images/japanese-wave.png`,ratio:1900/443},null,8,[`src`]),d[45]||=n(`div`,{class:`caption text-center`},`Real size: 1900x443. Given ratio: 1900 / 443.`,-1)]),_:1}),i(x,{h3:``},{default:t(()=>[...d[46]||=[a(`Custom ratio`,-1)]]),_:1}),d[122]||=n(`p`,{class:`grey`},`Setting a different ratio than the actual image one.`,-1),d[123]||=n(`p`,{class:`mb0`},`In this case, the image will be cropped on purpose, but still scaling with its container with
preserved ratio. 👍`,-1),d[124]||=n(`div`,{class:`caption`},`A drop shadow is added around the images to help visualizing the edges of the image.`,-1),i(T,{"content-class":`text-center`},{pug:t(()=>[...d[49]||=[a('w-image.sh1(:src="`${baseUrl}images/japanese-wave.png`" :ratio="1000 / 443")\n\nw-image.sh1.mt6(:src="`${baseUrl}images/japanese-wave.png`" :ratio="3000 / 443")',-1)]]),html:t(()=>[...d[50]||=[a(`<w-image
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  :ratio="1000 / 443"
  class="sh1">
</w-image>
...
outcome with just a width + height, or just a ratio + width, or ratio + height.`)],-1),i(T,{"content-class":`text-center`},{pug:t(()=>[...d[53]||=[a('p Ratio + width\nw-image.sh1(:src="`${baseUrl}images/japanese-wave.png`" :ratio="1" width="50%")\n\np.mt4 Ratio + height\nw-image.sh1(:src="`${baseUrl}images/japanese-wave.png`" :ratio="1900 / 443" height="100")\n\np.mt4 Ratio + width + height (pointless)\nw-image(:src="`${baseUrl}images/japanese-wave.png`" :ratio="1" width="400" height="100")',-1)]]),html:t(()=>[...d[54]||=[a(`<p>Ratio + width</p>
<w-image
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  :ratio="1"
  width="50%">
...
`)],-1),i(C,{info:``},{default:t(()=>[d[64]||=n(`p`,null,`Note that by design, setting both a width and height with the <img> tag, will still allow you
to achieve image stretching, loosing the aspect ratio. This may be a desired effect or not.`,-1),i(T,{"content-class":`text-center w-flex justify-space-around wrap`},{default:t(()=>[i(w,{src:`${u.baseUrl}images/japanese-wave.png`,tag:`img`,width:`100%`,height:`100px`},null,8,[`src`]),d[63]||=n(`div`,{class:`caption text-center`},`Real size: 1900x443, given width: 100%, given height: 100px.`,-1)]),_:1})]),_:1}),i(T,{"content-class":`text-center`},{pug:t(()=>[...d[65]||=[a('w-image(:src="`${baseUrl}images/japanese-wave.png`" tag="img" width="100%" max-width="700px")',-1)]]),html:t(()=>[...d[66]||=[a(`<w-image
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  tag="img"
  width="100%"
  max-width="700px">
</w-image>`,-1)]]),js:t(()=>[...d[67]||=[a(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})
`,-1)]]),default:t(()=>[i(w,{src:`${u.baseUrl}images/japanese-wave.png`,tag:`img`,width:`100%`,"max-width":`700px`},null,8,[`src`])]),_:1}),i(x,{h2:``},{default:t(()=>[...d[68]||=[a(`Figure with or without caption`,-1)]]),_:1}),d[128]||=n(`ul`,null,[n(`li`,null,[a(`You can tell the w-image component to use the native HTML `),n(`span`,{class:`code`},`<figure>`),a(` tag. In
...
using the `),n(`span`,{class:`code`},`<figure>`),a(` tag along with `),n(`span`,{class:`code`},`<figcaption>`),a(`.`)])],-1),i(T,{"content-class":`text-center`},{pug:t(()=>[...d[69]||=[a(`w-image(
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  tag="figure"
  max-width="700")
...
w-image.pa2.sh2.base-color--bg(
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  caption="The Great Wave Off Kanagawa - Hokusai"
  max-width="700")`,-1)]]),html:t(()=>[...d[70]||=[a(`<w-image
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  tag="figure"
  max-width="700">
</w-image>
...
<w-image
  ...
  caption="The Great Wave Off Kanagawa - Hokusai"
  max-width="700">
</w-image>`,-1)]]),js:t(()=>[...d[71]||=[a(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})
`,-1)]]),default:t(()=>[d[72]||=n(`p`,null,`Figure without caption.`,-1),i(w,{src:`${u.baseUrl}images/japanese-wave.png`,tag:`figure`,"max-width":`700`},null,8,[`src`]),d[73]||=n(`p`,{class:`mt8`},`Figure with caption.`,-1),i(w,{src:`${u.baseUrl}images/japanese-wave.png`,caption:`The Great Wave Off Kanagawa - Hokusai`,"max-width":`700`},null,8,[`src`]),d[74]||=n(`p`,{class:`mt8`},[a(`With some quick styles adding these classes: `),n(`code`,null,`.pa2.sh2.base-color--bg`),a(`:`)],-1),i(w,{class:`pa2 sh2 base-color--bg`,src:`${u.baseUrl}images/japanese-wave.png`,caption:`The Great Wave Off Kanagawa - Hokusai`,"max-width":`700`},null,8,[`src`]),d[75]||=n(`div`,{class:`caption mt3`},`Real size: 1900x443. Given max-width: 700.`,-1)]),_:1}),i(x,{h2:``},{default:t(()=>[...d[76]||=[a(`Loading spinner`,-1)]]),_:1}),d[129]||=n(`p`,null,`This image is very big, so that you have time to see the spinner while loading.
Refresh the page if you haven't seen it (or enable dev tools throttling if your connection is too fast)!`,-1),i(T,{"content-class":`text-center`},{pug:t(()=>[...d[77]||=[a('w-image(:src="`${baseUrl}images/spirit-island--alberta.png`" :ratio="5098 / 2550")',-1)]]),html:t(()=>[...d[78]||=[a(`<w-image
  :src="\`\${baseUrl}images/spirit-island--alberta.png\`"
  :ratio="5098 / 2550">
</w-image>`,-1)]]),js:t(()=>[...d[79]||=[a(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})`,-1)]]),default:t(()=>[i(w,{src:`${u.baseUrl}images/spirit-island--alberta.png`,ratio:5098/2550},null,8,[`src`]),d[80]||=n(`div`,{class:`caption`},`Real size: 5098x2550. Given ratio: 5098 / 2550.`,-1)]),_:1}),i(C,{tip:``},{default:t(()=>[...d[81]||=[n(`strong`,null,`Dev notes:`,-1),a(` disabling the browser cache will prevent you from seeing the transition.`,-1),n(`br`,null,null,-1),a(`
...
`,-1)]]),_:1}),i(x,{h2:``},{default:t(()=>[...d[82]||=[a(`Transitions`,-1)]]),_:1}),d[130]||=n(`p`,null,`Once the image is fully loaded, it will display in one piece with a fade transition by default.
You can customize the transition.`,-1),i(T,null,{pug:t(()=>[...d[86]||=[a(`w-flex(wrap justify-center align-center)
  div.mr4.my2
  ...
  w-image(:src="img.src" :width="500" :height="250" :transition="img.transition")`,-1)]]),html:t(()=>[...d[87]||=[a(`<w-flex wrap justify-center align-center>
  <div class="mr4 my2">
...
}`,-1)]]),default:t(()=>[n(`div`,m,[n(`div`,h,[d[84]||=n(`div`,{class:`title3 mb2`},`Transition names`,-1),i(D,{modelValue:u.img.transition,"onUpdate:modelValue":d[0]||=e=>u.img.transition=e,items:u.transitions,"item-value-key":`label`},{label:t(({item:e})=>[n(`code`,null,l(e.label),1)]),_:1},8,[`modelValue`,`items`]),i(O,{class:`mt2`,onClick:b.reload},{default:t(()=>[...d[83]||=[a(`Reload image`,-1)]]),_:1},8,[`onClick`])]),n(`div`,null,[i(w,{src:u.img.src,width:500,height:250,transition:u.img.transition},null,8,[`src`,`transition`]),d[85]||=n(`div`,{class:`caption`},`Real size: 5098x2550. Given size: 500x250.`,-1)])])]),_:1}),i(C,{tip:``},{default:t(()=>[...d[89]||=[n(`strong`,null,`Dev notes:`,-1),a(` disabling the browser cache will prevent you from seeing the transition.`,-1),n(`br`,null,null,-1),a(`
The reason for it is that the image first loads in the `,-1),n(`strong`,{class:`code`},`w-image`,-1),a(` component, then
once it's fully loaded, the image src is filled (or background url) and the image would load again
if you disable the cache. On big images, you would then see a truncated image until completely
loaded, just like a standard <img>.
`,-1)]]),_:1}),i(x,{h2:``},{default:t(()=>[...d[90]||=[a(`Error handling & Fallback`,-1)]]),_:1}),n(`div`,g,[i(T,{class:`mt0 no-grow`,"content-class":`text-center px6`},{pug:t(()=>[...d[91]||=[a(`w-image.bd1(src="/images/broken.png" width="100" height="100")`,-1)]]),html:t(()=>[...d[92]||=[a(`<w-image
  class="bd1"
  src="/images/broken.png"
  width="100"
  height="100">
</w-image>`,-1)]]),default:t(()=>[i(w,{class:`bd1`,src:`/images/broken.png`,width:`100`,height:`100`}),d[93]||=n(`div`,{class:`caption`},[a(`Given size: 100x100.`),n(`br`),a(`Border added for visualization.`)],-1)]),_:1}),d[94]||=n(`p`,null,[a(`If for some reason the image would not load, the default fallback is a blank 1x1 transparent gif
...
`)],-1)]),i(x,{h3:``},{default:t(()=>[...d[95]||=[a(`Fallback & Error handling`,-1)]]),_:1}),d[131]||=n(`ul`,null,[n(`li`,null,`For instance, in a e-boutique you may try to load the image of an item without knowing if this item
...
`)])],-1),i(T,{"content-class":`text-center`},{pug:t(()=>[...d[97]||=[a('w-image(\n  :src="`${baseUrl}images/broken.png`"\n  :fallback="`${baseUrl}images/not-found.jpg`"\n  @error="showError = true")\n\nw-alert(v-if="showError" error) Oops. The image could not load!',-1)]]),html:t(()=>[...d[98]||=[a(`<w-image
  :src="\`\${baseUrl}images/broken.png\`"
  :fallback="\`\${baseUrl}images/not-found.jpg\`"
  @error="showError = true">
</w-image>
...
</w-alert>`,-1)]]),js:t(()=>[...d[99]||=[a(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/',
  showError: false
})
`,-1)]]),default:t(()=>[i(w,{src:`${u.baseUrl}images/broken.png`,fallback:`${u.baseUrl}images/not-found.jpg`,onError:d[1]||=e=>u.showError=!0},null,8,[`src`,`fallback`]),u.showError?(o(),s(k,{key:0,error:``},{default:t(()=>[...d[96]||=[a(`Oops. The image could not load!`,-1)]]),_:1})):c(``,!0)]),_:1}),i(x,{h2:``},{default:t(()=>[...d[100]||=[a(`Lazy`,-1)]]),_:1}),d[132]||=n(`p`,null,[a(`By using the lazy attribute, it is possible to load the image only when it is in the viewport.`),n(`br`),a(`
Wave UI internally uses an `),n(`span`,{class:`code`},`IntersectionObserver`),a(` and will only start loading the image
when it is visible.`)],-1),i(T,null,{pug:t(()=>[...d[101]||=[a('w-image(:src="`${baseUrl}images/spirit-island--alberta.png`" lazy :ratio="5098 / 2550")',-1)]]),html:t(()=>[...d[102]||=[a(`<w-image
  :src="\`\${baseUrl}images/spirit-island--alberta.png\`"
  lazy
  :ratio="5098 / 2550">
</w-image>`,-1)]]),js:t(()=>[...d[103]||=[a(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})
`,-1)]]),default:t(()=>[i(w,{src:`${u.baseUrl}images/spirit-island--alberta.png?v1`,lazy:``,ratio:5098/2550},null,8,[`src`]),d[104]||=n(`div`,{class:`caption`},`Real size: 5098x2550.`,-1)]),_:1}),i(x,{h2:``,slug:`content`},{default:t(()=>[...d[105]||=[a(`Content - via default slot`,-1)]]),_:1}),d[133]||=n(`p`,null,[a(`In some cases, it can be convenient to have some content on top of the image.`),n(`br`),a(`
