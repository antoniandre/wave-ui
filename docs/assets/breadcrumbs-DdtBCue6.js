import{N as e,W as t,c as n,d as r,g as i,h as a,k as o}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as s}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{L as c}from"./index-DQ7e6RHF.js";function l(s,c,l,u,d,f){let p=e(`title-link`),m=e(`w-breadcrumbs`),h=e(`example`),g=e(`w-tag`);return o(),r(`div`,null,[i(p,{h2:``},{default:t(()=>[...c[0]||=[a(`Default`,-1)]]),_:1}),c[34]||=n(`p`,null,[a(`By default, each item except the last one will be a link providing that a route attribute is found
