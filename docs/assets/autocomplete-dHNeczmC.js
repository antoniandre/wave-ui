import{N as e,W as t,c as n,d as r,g as i,h as a,k as o,m as s}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as c}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{V as l}from"./index-D3Rumh9E.js";import{t as u}from"./chunk-NAVWDHVN-Dcet8MEw.js";function d(c,l,u,d,f,p){let m=e(`alert`),h=e(`title-link`),g=e(`w-autocomplete`),_=e(`example`);return o(),r(`div`,null,[i(m,{info:``},{default:t(()=>[...l[0]||=[n(`div`,{class:`title3`},`Caveat:`,-1),n(`p`,null,[a(`The `),n(`strong`,{class:`code`},`w-autocomplete`),a(` component is mounted in place in the DOM. At the moment
...
`)],-1)]]),_:1}),i(h,{h2:``},{default:t(()=>[...l[1]||=[a(`Default`,-1)]]),_:1}),l[9]||=s(`<p>In this example we can look for a chemical element in the list and select it.</p><p>One obvious advantage of the Wave UI autocomplete is the fact that you can provide a different
...
app.use(WaveUI)
app.mount('#app')
`,-1)]]),default:t(()=>[i(g,{class:`mb12`,items:c.chemicalElement},null,8,[`items`])]),_:1}),i(h,{h2:``},{default:t(()=>[...l[5]||=[a(`Placeholder`,-1)]]),_:1}),i(_,{"content-class":`py12`,"blank-codepen":[`js`]},{pug:t(()=>[...l[6]||=[a(`w-autocomplete.mb12(:items="chemicalElement" placeholder="select an element")`,-1)]]),html:t(()=>[...l[7]||=[a(`<w-autocomplete
  :items="chemicalElement"
  placeholder="select an element"
  class="mb12">
</w-autocomplete>`,-1)]]),js:t(()=>[...l[8]||=[a(`import { faker } from '@faker-js/faker'
