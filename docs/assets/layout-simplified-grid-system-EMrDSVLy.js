import{A as e,G as t,M as n,P as r,c as i,d as a,g as o,h as s,r as c}from"./runtime-core.esm-bundler-CLfruy3s.js";import{t as l}from"./_plugin-vue_export-helper-B80Cc4Ui.js";var u={class:`box`},d={class:`box`},f={class:`box`};function p(l,p){let m=r(`title-link`),h=r(`router-link`),g=r(`alert`),_=r(`w-grid`),v=r(`example`);return e(),a(`main`,null,[o(m,{class:`mt4`,h1:``},{default:t(()=>[...p[0]||=[s(`Simplified grid system (CSS grids)`,-1)]]),_:1}),o(g,{info:``},{default:t(()=>[p[2]||=s(`The 12-cell based flexbox grid system works well and for most cases, but it has
