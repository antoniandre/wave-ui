import{r as i,o as c,f as r,a as t,w as n,b as s,e,M as h}from"./vendor.c30f2c6c.js";import{_ as d}from"./index.67df9d80.js";const g=e("Spaces"),p=e("Content spacing"),m=h(`<p>Margins and paddings are incrementable from 0 to 12 using this syntax: <code>ma[number]</code>,
...
`),I=e("Negative margin"),A=s("p",null,[e(`Sometimes you may need negative margins, Wave UI also provides 12 negative increments for this
purpose.`),s("br"),e(`
...
</div>`);function H(K,O){const a=i("title-link"),l=i("router-link"),o=i("example");return c(),r("main",null,[t(a,{class:"mt4",h1:""},{default:n(()=>[g]),_:1}),t(a,{h2:""},{default:n(()=>[p]),_:1}),m,t(o,null,{pug:n(()=>[B,M,j]),html:n(()=>[E]),default:n(()=>[s("div",_,[s("div",u,[x,b,f,v,w,y,T,z,S,t(l,{to:"customization"},{default:n(()=>[k]),_:1}),C,N]),V])]),_:1}),t(a,{h3:""},{default:n(()=>[I]),_:1}),A,t(o,null,{pug:n(()=>[U]),html:n(()=>[W]),default:n(()=>[L,R]),_:1}),t(a,{h3:""},{default:n(()=>[Y]),_:1}),q,t(o,null,{pug:n(()=>[F]),html:n(()=>[G]),default:n(()=>[D]),_:1})])}const J={};var X=d(J,[["render",H]]);export{X as default};
