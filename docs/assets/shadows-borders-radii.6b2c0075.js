import{r as t,o as i,f as r,a as o,w as n,b as e,X as h,aK as _,e as s,h as a,i as y,n as u,_ as j,c4 as Y}from"./index.6ab5ca13.js";const k=s("shadows, borders & border radii"),S=e("p",null,[s("Wave UI offers a few CSS helper classes to control the drop shadow, borders and border radii."),e("br"),s(`
...
whereas positive values will produce an outter drop shodow. `),e("code",null,".sh0"),s(" will remove any shadow.")],-1),N={class:"w-flex wrap"},E={class:"code"},T=s(`.w-flex.wrap
  .box.sh-6 .sh-6
  .box.sh-5 .sh-5
  .box.sh-4 .sh-4
  .box.sh-3 .sh-3
...
</w-flex>`),A=s(".box {\n  width: 80px;\n  height: 80px;\n  margin: 4px; /* You could use the class `ma1`. */\n  background-color: #e3f2fd; /* You could use the class `blue-light5--bg`. */\n  display: flex; /* You could use the class `d-flex`. */\n  align-items: center; /* You could use the class `align-center`. */\n  justify-content: center; /* You could use the class `justify-center`. */\n}\n"),q=s("Borders"),z=e("p",null,[s("Element borders range from "),e("code",null,"0"),s(" to "),e("code",null,"6"),s(`, corresponding to the same number of pixels (for
the `),e("span",{class:"code"},"border-width"),s(") on all the sides. "),e("code",null,".bd0"),s(" will remove any border.")],-1),D={class:"w-flex wrap"},R={class:"code"},W=s(`.w-flex.wrap
  .box.bd0 .bd0
  .box.bd1 .bd1
  .box.bd2 .bd2
  .box.bd3 .bd3
...
</w-flex>`),H=s(".box {\n  width: 80px;\n  height: 80px;\n  margin: 4px; /* You could use the class `ma1`. */\n  background-color: #e3f2fd; /* You could use the class `blue-light5--bg`. */\n  display: flex; /* You could use the class `d-flex`. */\n  align-items: center; /* You could use the class `align-center`. */\n  justify-content: center; /* You could use the class `justify-center`. */\n}\n"),K=s("Border radii"),L=y(`<p>The border radii range from <code>0</code> to <code>6</code>, and are incremented by the <code>$base-increment</code>
...
radius, <code>.bdrsm</code> will produce a <strong>max</strong> border radius (<span class="code">100%</span>).</p>`,1),M=s("Here is the difference between "),O=e("code",null,".bdrsr",-1),X=s(" and "),G=e("code",null,".bdrsm",-1),J=s(" (only visible on non-square elements):"),P=e("div",{class:"w-flex"},[e("div",{class:"box box--rect blue-light5--bg ma4 d-flex align-center justify-center bdrsr"},[e("span",{class:"code"},".bdrsr")]),e("div",{class:"box box--rect blue-light5--bg ma4 d-flex align-center justify-center bdrsm"},[e("span",{class:"code"},".bdrsm")])],-1),Q={class:"w-flex wrap"},Z={class:"code"},ss=e("div",{class:"box blue-light5--bg ma4 d-flex align-center justify-center bdrsr"},[e("span",{class:"code"},".bdrsr")],-1),es=e("div",{class:"box blue-light5--bg ma4 d-flex align-center justify-center bdrsm"},[e("span",{class:"code"},".bdrsm")],-1),ns=s(`.w-flex.wrap
  .box.bdrs0 .bdrs0
  .box.bdrs1 .bdrs1
  .box.bdrs2 .bdrs2
  .box.bdrs3 .bdrs3
...
In this case you need to style them from your CSS.`);function Es(m,Vs,As,qs,zs,Ds){const c=t("title-link"),b=t("alert"),l=t("example"),w=t("w-divider"),p=t("w-image"),x=t("w-flex"),f=t("w-switch"),g=t("w-card"),v=t("w-accordion");return i(),r("main",null,[o(c,{class:"mt4",h1:""},{default:n(()=>[k]),_:1}),S,o(b,{tip:""},{default:n(()=>[C,$,I]),_:1}),o(c,{h2:""},{default:n(()=>[U]),_:1}),B,o(l,null,{pug:n(()=>[T]),html:n(()=>[V]),css:n(()=>[A]),default:n(()=>[e("div",N,[(i(),r(h,null,_(13,d=>e("div",{class:u(["box blue-light5--bg ma4 d-flex align-center justify-center",`sh${d-7}`]),key:d},[e("span",E,".sh"+a(d-7),1)],2)),64))])]),_:1}),o(c,{h2:""},{default:n(()=>[q]),_:1}),z,o(l,null,{pug:n(()=>[W]),html:n(()=>[F]),css:n(()=>[H]),default:n(()=>[e("div",D,[(i(),r(h,null,_(7,d=>e("div",{class:u(["box blue-light5--bg ma4 d-flex align-center justify-center",`bd${d-1}`]),key:d},[e("span",R,".bd"+a(d-1),1)],2)),64))])]),_:1}),o(c,{h2:""},{default:n(()=>[K]),_:1}),L,o(b,{tip:""},{default:n(()=>[M,O,X,G,J,P]),_:1}),o(l,null,{pug:n(()=>[ns]),html:n(()=>[os]),css:n(()=>[ds]),default:n(()=>[e("div",Q,[(i(),r(h,null,_(7,d=>e("div",{class:u(["box blue-light5--bg ma4 d-flex align-center justify-center",`bdrs${d-1}`]),key:d},[e("span",Z,".bdrs"+a(d-1),1)],2)),64)),ss,es])]),_:1}),o(w,{class:"my12"}),o(c,{h2:""},{default:n(()=>[ts]),_:1}),as,o(l,null,{pug:n(()=>[_s]),html:n(()=>[us]),js:n(()=>[xs]),default:n(()=>[o(x,{"align-center":"","justify-space-around":"",wrap:""},{default:n(()=>[o(x,{class:"no-grow",column:"","align-center":"","justify-center":""},{default:n(()=>[o(p,{class:"bd1 sh1 bdrsr d-block",src:`${m.baseUrl}images/japanese-wave.png`,width:100,height:100},null,8,["src"]),cs]),_:1}),o(f,{class:"bdrs1 my4 caption","model-value":!0},{default:n(()=>[ls,is,rs,bs,hs]),_:1})]),_:1})]),_:1}),o(l,{class:"mt8"},{pug:n(()=>[ps,fs,gs,vs,ys,js,Ys,ks,Ss,Cs,$s,Is,Us]),html:n(()=>[Bs]),default:n(()=>[o(g,{class:"bdrs4 bd0 sh2","bg-color":"orange-light5"},{default:n(()=>[ms]),_:1}),o(v,{class:"mt8 bdrs2 bd1",items:2},{"item-title":n(({index:d})=>[ws]),"item-title.2":n(({index:d})=>[s("Item "+a(d),1)]),"item-content":n(({index:d})=>[s("Content "+a(d),1)]),_:1})]),_:1}),o(b,{info:""},{default:n(()=>[Ns]),_:1})])}const Ts={data:()=>({colors:Y,horizontal:!1,baseUrl:"/wave-ui/"})};var Ws=j(Ts,[["render",Es]]);export{Ws as default};
