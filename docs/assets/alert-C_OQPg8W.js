import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,l as s,u as c,xt as l}from"./runtime-core.esm-bundler-BuLlhxCm.js";import{t as u}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{V as d}from"./index-CsKLTiYy.js";var f={style:{"max-width":`1000px`}};function p(u,d,p,m,h,g){let _=n(`title-link`),v=n(`w-alert`),y=n(`example`),b=n(`w-button`),x=n(`w-transition-expand`);return e(),i(`div`,f,[a(_,{h2:``},{default:t(()=>[...d[5]||=[o(`Basic`,-1)]]),_:1}),d[95]||=r(`p`,null,[o(`The alert is commonly used to emphasize some content.`),r(`br`),o(`
...
Like in this example you can add a transition to animate its apparition.`)],-1),a(y,{"content-class":`pt5`},{pug:t(()=>[o(`w-button(@click="showAlert = !showAlert" outline) `+l(u.showAlert?`Hide`:`Show`)+` alert
...
`,-1)]]),default:t(()=>[a(b,{onClick:d[0]||=e=>u.showAlert=!u.showAlert,outline:``},{default:t(()=>[o(l(u.showAlert?`Hide`:`Show`)+` alert`,1)]),_:1}),a(x,{y:``},{default:t(()=>[u.showAlert?(e(),s(v,{key:0,color:`success`},{default:t(()=>[...d[12]||=[o(`The alert is now visible.`,-1)]]),_:1})):c(``,!0)]),_:1})]),_:1}),a(_,{h2:``},{default:t(()=>[...d[14]||=[o(`Colors`,-1)]]),_:1}),d[97]||=r(`p`,null,[o(`Like in most components, you can apply a color to the text with the `),r(`code`,null,`color`),o(` attribute,
