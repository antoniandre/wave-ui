...
whether you use a multiple or single select list.`)],-1),me={key:1,class:"px2"},de={class:"ml1"},re=n("div",{class:"title4 mb2"},"Label outside",-1),ue=n("div",{class:"title4 mt6 mb2"},"Label inside",-1),be=n("strong",{class:"mr1"},"Note:",-1),he=n("code",null,"disabled: true",-1);function pe(s,m,_,y,I,f){const u=r("alert"),o=r("title-link"),i=r("w-select"),a=r("example"),w=r("w-flex"),h=r("w-icon"),k=r("w-tag");return b(),p("div",null,[l(u,{info:""},{default:t(()=>[e("The "),A,e(` component can be placed in a hidden overflow container and the dropdown
...
object under the `),R,e(" name."),U,e(`
If this is a constraint, you can use the option `),$,e(` to specify the name of another
...
`)]),default:t(()=>[l(i,{items:s.items1,outline:""},{default:t(()=>[e("Label")]),_:1},8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Colors")]),_:1}),C,l(o,{h3:"",slug:"default-style"},{default:t(()=>[e("Default style (Underline)")]),_:1}),l(a,null,{pug:t(()=>[e(`w-select(:items="items" color="blue") Label
...
`)]),default:t(()=>[x,l(i,{items:s.items1,shadow:""},{default:t(()=>[e("Label")]),_:1},8,["items"]),B,l(i,{items:s.items1,outline:"",shadow:""},{default:t(()=>[e("Label")]),_:1},8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Tile & round")]),_:1}),l(a,null,{pug:t(()=>[e(`.title4 Default style (Underline)
...
`)]),default:t(()=>[l(i,{items:s.items1,"label-position":"inside",outline:""},{default:t(()=>[l(h,{class:"orange"},{default:t(()=>[e("mdi mdi-arrow-right")]),_:1}),ie,l(h,{class:"orange"},{default:t(()=>[e("mdi mdi-arrow-left")]),_:1})]),_:1},8,["items"]),l(i,{class:"mt4",items:s.items1,"label-position":"left",outline:""},{default:t(()=>[oe,l(h,{class:"orange"},{default:t(()=>[e("mdi mdi-arrow-right")]),_:1})]),_:1},8,["items"]),l(i,{class:"mt4",items:s.items1,"label-position":"right",outline:""},{default:t(()=>[l(h,{class:"orange"},{default:t(()=>[e("mdi mdi-arrow-left")]),_:1}),ae]),_:1},8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Custom selection string")]),_:1}),ce,l(a,null,{pug:t(()=>[e(`w-select(:items="items" v-model="selection" multiple)
...
`)]),default:t(()=>[l(i,{items:s.items3,modelValue:s.customSelection,"onUpdate:modelValue":m[3]||(m[3]=d=>s.customSelection=d),multiple:""},{selection:t(({item:d})=>[(b(!0),p(T,null,D(d,(g,L)=>(b(),S(k,{class:"mr2",key:L,"bg-color":"grey-light4"},{default:t(()=>[e(c(g.label),1)]),_:2},1024))),128))]),_:1},8,["items","modelValue"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Custom list items")]),_:1}),l(a,null,{pug:t(()=>[e(`w-select(:items="items")
