...
In this case you need to style them from your CSS.`)])],1)},c=[function(){var s=this,n=s.$createElement,e=s._self._c||n;return e("p",[s._v("Wave UI offers a few CSS helper classes to control the drop shadow, borders and border radii."),e("br"),s._v(`
...
whereas positive values will produce an outter drop shodow. `),e("code",[s._v(".sh0")]),s._v(" will remove any shadow.")])},function(){var s=this,n=s.$createElement,e=s._self._c||n;return e("p",[s._v("Element borders range from "),e("code",[s._v("0")]),s._v(" to "),e("code",[s._v("6")]),s._v(`, corresponding to the same number of pixels (for
...
radius, `),e("code",[s._v(".bdrsm")]),s._v(" will produce a "),e("strong",[s._v("max")]),s._v(" border radius ("),e("span",{staticClass:"code"},[s._v("100%")]),s._v(").")])}];const l={data:()=>({colors:i,horizontal:!1,baseUrl:"/wave-ui/"})},r={};var b=d(l,o,c,!1,v,null,null,null);function v(s){for(let n in r)this[n]=r[n]}var _=function(){return b.exports}();export{_ as default};
