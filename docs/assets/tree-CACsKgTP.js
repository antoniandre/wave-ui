import{H as e,N as t,c as n,d as r,g as i,h as a,ht as o,k as s,l as c,m as l,u,vt as d}from"./runtime-core.esm-bundler-DPe36P4s.js";import{t as f}from"./_plugin-vue_export-helper-S3RvzygF.js";import{t as p}from"./index-D1jKshrg.js";var m={class:`w-flex wrap align-center`},h={class:`w-flex mt6`},g=[`innerHTML`],_={class:`black mt2`},v={href:`https://vuejs.org/guide/essentials/watchers.html#deep-watchers`,target:`_blank`};function y(f,p,y,b,x,S){let C=t(`title-link`),w=t(`w-tree`),T=t(`example`),E=t(`w-icon`),D=t(`w-card`),O=t(`w-flex`),k=t(`alert`);return s(),r(`div`,null,[i(C,{h2:``},{default:e(()=>[...p[7]||=[a(`Default`,-1)]]),_:1}),i(T,null,{pug:e(()=>[...p[8]||=[a(`w-tree(:data="tree")`,-1)]]),html:e(()=>[...p[9]||=[a(`<w-tree :data="tree"></w-tree>`,-1)]]),js:e(()=>[...p[10]||=[a(`data: () => ({
  tree: [
    {
      label: 'src',
      children: [
...
`,-1)]]),default:e(()=>[i(w,{data:f.tree2},null,8,[`data`])]),_:1}),i(C,{h2:``},{default:e(()=>[...p[11]||=[a(`Icons`,-1)]]),_:1}),p[73]||=l(`<p>You can provide different icons for the expand button and tree items.</p><p>You can also provide icons for each item. Depending on the type of item:</p><ul><li><code>expand-icon</code>: for the expand icon.</li><li><code>expand-open-icon</code>: for the expand icon when open (if different than the <code>expand-icon</code>).</li><li><code>branch-icon</code>: if the item has children.</li><li><code>branch-open-icon</code>: if the item has children and it is open.</li><li><code>leaf-icon</code>: for items which don&#39;t contain anything.</li></ul>`,3),i(T,null,{pug:e(()=>[...p[12]||=[a(`w-tree.size--md(
  ...
  leaf-icon="mdi mdi-file-outline")`,-1)]]),html:e(()=>[...p[13]||=[a(`<w-tree
  :data="tree"
  expand-icon="mdi mdi-plus"
  expand-open-icon="mdi mdi-minus"
  branch-icon="mdi mdi-folder-outline"
...
`,-1)]]),default:e(()=>[i(w,{class:`size--md`,data:f.tree2,"expand-icon":`mdi mdi-plus`,"expand-open-icon":`mdi mdi-minus`,"branch-icon":`mdi mdi-folder-outline`,"branch-open-icon":`mdi mdi-folder-open-outline`,"leaf-icon":`mdi mdi-file-outline`},null,8,[`data`])]),_:1}),i(C,{h3:``},{default:e(()=>[...p[15]||=[a(`Different icon per item`,-1)]]),_:1}),p[74]||=l(`<p>It is possible to set a specific icon in any/each item of the tree.<br>
...
but you can override that with the <code>item-icon-color-key</code> prop.</p>`,2),i(T,null,{pug:e(()=>[...p[16]||=[a(`w-tree.size--md(
  :data="tree"
  expand-icon="mdi mdi-plus"
  expand-open-icon="mdi mdi-minus"
  branch-icon="mdi mdi-folder-outline"
  branch-open-icon="mdi mdi-folder-open-outline"
  leaf-icon="mdi mdi-file-outline")`,-1)]]),html:e(()=>[...p[17]||=[a(`<w-tree
  :data="tree"
  expand-icon="mdi mdi-plus"
  expand-open-icon="mdi mdi-minus"
  branch-icon="mdi mdi-folder-outline"
  branch-open-icon="mdi mdi-folder-open-outline"
  leaf-icon="mdi mdi-file-outline"
  class="size--md"></w-tree>`,-1)]]),js:e(()=>[...p[18]||=[a(`data: () => ({
  tree: [
    {
      label: 'src',
...
`,-1)]]),default:e(()=>[i(w,{class:`size--md`,data:f.tree6,"icon-color":`blue-dark1`},null,8,[`data`])]),_:1}),i(C,{h3:``},{default:e(()=>[...p[19]||=[a(`No expand button`,-1)]]),_:1}),i(T,null,{pug:e(()=>[...p[20]||=[a(`w-tree(:data="tree" :expand-icon="false")`,-1)]]),html:e(()=>[...p[21]||=[a(`<w-tree :data="tree" :expand-icon="false"></w-tree>`,-1)]]),js:e(()=>[...p[22]||=[a(`data: () => ({
  tree: [
    {
      label: 'src',
      children: [
...
`,-1)]]),default:e(()=>[i(w,{data:f.tree2,"expand-icon":!1},null,8,[`data`])]),_:1}),i(C,{h2:``},{default:e(()=>[...p[23]||=[a(`Selectable`,-1)]]),_:1}),i(T,null,{pug:e(()=>[...p[24]||=[a(`w-tree(:data="tree" selectable)`,-1)]]),html:e(()=>[...p[25]||=[a(`<w-tree :data="tree" selectable></w-tree>`,-1)]]),js:e(()=>[...p[26]||=[a(`data: () => ({
  data: () => ({
  tree: [
    {
      label: 'Branch 1',
...
`,-1)]]),default:e(()=>[i(w,{data:f.tree1,selectable:``},null,8,[`data`])]),_:1}),i(C,{h2:``},{default:e(()=>[...p[27]||=[a(`Counts`,-1)]]),_:1}),i(T,null,{pug:e(()=>[...p[28]||=[a(`w-tree(:data="tree" counts)`,-1)]]),html:e(()=>[...p[29]||=[a(`<w-tree :data="tree" counts></w-tree>`,-1)]]),js:e(()=>[...p[30]||=[a(`data: () => ({
  tree: [
    {
      label: 'Branch 1',
      children: [
...
`,-1)]]),default:e(()=>[i(w,{data:f.tree1,counts:``},null,8,[`data`])]),_:1}),i(C,{h2:``},{default:e(()=>[...p[31]||=[a(`No transition`,-1)]]),_:1}),i(T,null,{pug:e(()=>[...p[32]||=[a(`w-tree(:data="tree" no-transition)`,-1)]]),html:e(()=>[...p[33]||=[a(`<w-tree :data="tree" no-transition></w-tree>`,-1)]]),js:e(()=>[...p[34]||=[a(`data: () => ({
  data: () => ({
  tree: [
    {
      label: 'Branch 1',
...
`,-1)]]),default:e(()=>[i(w,{data:f.tree1,"no-transition":``},null,8,[`data`])]),_:1}),i(C,{h2:``},{default:e(()=>[...p[35]||=[a(`Unexpandable empty branches`,-1)]]),_:1}),i(T,null,{pug:e(()=>[...p[39]||=[a(`w-tree(:data="tree" unexpandable-empty)`,-1)]]),html:e(()=>[...p[40]||=[a(`<w-tree :data="tree" unexpandable-empty></w-tree>`,-1)]]),js:e(()=>[...p[41]||=[a(`data: () => ({
  tree: [
    {
      label: 'Branch 1',
      children: [
...
`,-1)]]),default:e(()=>[n(`div`,m,[n(`div`,null,[p[36]||=n(`div`,{class:`title3`},`Normal`,-1),i(w,{data:f.tree1},null,8,[`data`])]),i(E,{class:`grey-light3 mx12`,rotate90a:``,xl:``},{default:e(()=>[...p[37]||=[a(`wi-arrow-down`,-1)]]),_:1}),n(`div`,null,[p[38]||=n(`div`,{class:`title3`},`unexpandable-empty`,-1),i(w,{data:f.tree1,"unexpandable-empty":``},null,8,[`data`])])])]),_:1}),i(C,{h2:``},{default:e(()=>[...p[42]||=[a(`V-model`,-1)]]),_:1}),p[75]||=n(`p`,null,[a(`When the tree is `),n(`code`,null,`selectable`),a(`, you can use the `),n(`code`,null,`v-model`),a(` to get the selected item.`)],-1),p[76]||=n(`p`,null,`Click on a tree item to select it.`,-1),i(T,null,{pug:e(()=>[...p[44]||=[a(`w-tree(v-model="selection" :data="tree" selectable)`,-1)]]),html:e(()=>[...p[45]||=[a(`<w-tree v-model="selection" :data="tree" selectable></w-tree>`,-1)]]),js:e(()=>[...p[46]||=[a(`data: () => ({
  tree: [
    {
      label: 'Branch 1',
      children: [
...
`,-1)]]),default:e(()=>[i(w,{modelValue:f.selection,"onUpdate:modelValue":p[0]||=e=>f.selection=e,data:f.tree1,selectable:``},null,8,[`modelValue`,`data`]),n(`div`,h,[p[43]||=n(`strong`,{class:`mr3`},`Selection:`,-1),n(`pre`,{class:o([`pa2`,f.$store.state.darkMode?`grey-dark6--bg`:`orange-light6--bg`])},d(f.selection),3)])]),_:1}),i(C,{h2:``},{default:e(()=>[...p[47]||=[a(`Events`,-1)]]),_:1}),p[77]||=l(`<p>Multiple events are fired from the <strong class="code">w-tree</strong> component:</p><ul class="lh0"><li><code>before-open</code>: fired as soon as the user clicks a tree item that is expandable and before the subitems are revealed.</li><li class="mt1"><code>open</code>: fired after a user clicks a tree item that is expandable, and after the expand animation.</li><li class="mt1"><code>before-close</code>: fired as soon as the user clicks a tree item to close its subtree.</li><li class="mt1"><code>close</code>: fired after a user clicks a tree item to close its subtree, and after the collapse animation.</li><li class="mt1"><code>click</code>: fired when the user clicks any tree item.</li><li class="mt1"><code>select</code>: fired when the user selects any selectable tree item. The <code>selectable</code> option must be set to true.</li><li class="mt1"><code>update:model-value</code>: (or <code>input</code> in Vue 2.x) fired when the user selects any selectable tree item. The <code>selectable</code> option must be set to true.</li></ul>`,2),i(T,null,{pug:e(()=>[...p[48]||=[a(`w-tree(
  :data="tree"
  ...
  selectable)`,-1)]]),html:e(()=>[...p[49]||=[a(`<w-tree
  :data="tree"
  @before-open="log('@before-open', $event)"
  @open="log('@open', $event)"
  @before-close="log('@before-close', $event)"
...
`,-1)]]),default:e(()=>[i(O,{gap:`12`},{default:e(()=>[i(w,{data:f.tree2,onBeforeOpen:p[1]||=e=>S.log(`@before-open`,e),onOpen:p[2]||=e=>S.log(`@open`,e),onBeforeClose:p[3]||=e=>S.log(`@before-close`,e),onClose:p[4]||=e=>S.log(`@close`,e),onClick:p[5]||=e=>S.log(`@click`,e),onSelect:p[6]||=e=>S.log(`@select`,e),selectable:``},null,8,[`data`]),i(D,{"bg-color":f.$store.state.darkMode?`grey-dark6`:`amber-light6`,title:`Event log`,"title-class":f.$store.state.darkMode?`grey-dark5--bg`:`amber-light5--bg`},{default:e(()=>[n(`pre`,{innerHTML:f.logs},null,8,g)]),_:1},8,[`bg-color`,`title-class`])]),_:1})]),_:1}),i(C,{h3:``},{default:e(()=>[...p[51]||=[a(`Real-case scenario: Renaming a leaf item on click`,-1)]]),_:1}),i(T,null,{pug:e(()=>[...p[52]||=[a(`w-tree(:data="tree3" @click="renameLeafItem" deep-reactivity)`,-1)]]),html:e(()=>[...p[53]||=[a(`<w-tree
  :data="tree"
  @click="renameLeafItem"
  deep-reactivity>
</w-tree>`,-1)]]),js:e(()=>[...p[54]||=[a(`data: () => ({
  tree: [
    {
      label: 'Item 1',
      children: [
...
}`,-1)]]),default:e(()=>[i(w,{data:f.tree3,onClick:S.renameLeafItem,"deep-reactivity":``},null,8,[`data`,`onClick`])]),_:1}),i(k,{tip:``},{default:e(()=>[p[61]||=n(`strong`,{class:`black`},`Note on reactivity`,-1),n(`p`,_,[p[57]||=a(`By default the tree items key-value pairs will not be watched as this is a more expensive
operation. This means that if you want to have reactivity when you modify a key or value,
like the label, you will need to add the `,-1),p[58]||=n(`code`,null,`deep-reactivity`,-1),p[59]||=a(` option.`,-1),p[60]||=n(`br`,null,null,-1),n(`a`,v,[p[56]||=a(`Read on deep watchers on the Vue.js official documentation`,-1),i(E,{class:`ml1`},{default:e(()=>[...p[55]||=[a(`mdi mdi-open-in-new`,-1)]]),_:1})])])]),_:1}),i(C,{h2:``},{default:e(()=>[...p[62]||=[a(`Custom item (icon + label)`,-1)]]),_:1}),p[78]||=n(`p`,null,[a(`If you need to customize the layout of the item label and/or icon, you can use the `),n(`code`,null,`#item`),a(` slot.`)],-1),i(T,null,{pug:e(()=>[...p[66]||=[a(`w-tree.lh5(:data="tree")
  template(#item="{ item, open }")
    ...
    w-icon.ml1(v-else-if="item.status === 'syncing'" bg-color="warning" xs) mdi mdi-clock-outline`,-1)]]),html:e(()=>[...p[67]||=[a(`<w-tree :data="tree">
  <template #item="{ item, open }">
...
`,-1)]]),default:e(()=>[i(w,{class:`lh5`,data:f.tree4},{item:e(({item:t,open:r})=>[n(`span`,null,d(t.label),1),t.status===`error`?(s(),c(E,{key:0,class:`ml1`,"bg-color":`error`,xs:``},{default:e(()=>[...p[63]||=[a(`mdi mdi-close`,-1)]]),_:1})):t.status===`success`?(s(),c(E,{key:1,class:`ml1`,"bg-color":`success`,xs:``},{default:e(()=>[...p[64]||=[a(`mdi mdi-check`,-1)]]),_:1})):t.status===`syncing`?(s(),c(E,{key:2,class:`ml1`,"bg-color":`warning`,xs:``},{default:e(()=>[...p[65]||=[a(`mdi mdi-clock-outline`,-1)]]),_:1})):u(``,!0)]),_:1},8,[`data`])]),_:1}),i(C,{h2:``},{default:e(()=>[...p[69]||=[a(`Expand all, by default`,-1)]]),_:1}),i(T,null,{pug:e(()=>[...p[70]||=[a(`w-tree(:data="tree" expand-all)`,-1)]]),html:e(()=>[...p[71]||=[a(`<w-tree :data="tree" expand-all></w-tree>`,-1)]]),js:e(()=>[...p[72]||=[a(`data: () => ({
  tree: [
      {
        label: 'Item 1',
        children: [
