import{r as u,g as f,o as p,a as n,b as s,w as l,e as t,t as d,F as M,j as D,c as j,_ as y,a2 as L,E as A}from"./index-eD21R81v.js";const P={class:"ml2"},O={class:"ml2"},V={class:"ml2"},E={key:1,class:"px2"},R={class:"ml1"};function U(i,e,h,I,k,w){const b=u("alert"),m=u("title-link"),o=u("w-select"),a=u("example"),g=u("w-flex"),c=u("w-icon"),S=u("w-tag");return p(),f("div",null,[n(b,{info:""},{default:l(()=>e[4]||(e[4]=[t("The "),s("span",{class:"code"},"w-select",-1),t(` component can be placed in a hidden overflow container and the dropdown
