import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,m as s,vt as c,w as l,xt as u}from"./runtime-core.esm-bundler-BuLlhxCm.js";import{t as d}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{I as f}from"./index-CsKLTiYy.js";function p(d,f,p,m,h,g){let _=n(`title-link`),v=n(`w-button`),y=n(`w-flex`),b=n(`example`),x=n(`w-icon`);return e(),i(`div`,null,[a(_,{h2:``},{default:t(()=>[...f[2]||=[o(`Default`,-1)]]),_:1}),f[112]||=r(`p`,null,[o(`By default (if no `),r(`code`,null,`color`),o(` or `),r(`code`,null,`bg-color`),o(` is applied) the primary color will be applied.`)],-1),a(v,{class:`ma1`},{default:t(()=>[...f[3]||=[o(`default`,-1)]]),_:1}),a(_,{h2:``},{default:t(()=>[...f[4]||=[o(`Colors`,-1)]]),_:1}),f[113]||=s(`<p>Setting colors on buttons is quite straightforward:
...
`,-1)]]),default:t(()=>[a(v,{class:`ma1`,"bg-color":`success`,color:`yellow-light2`},{default:t(()=>[...f[14]||=[o(`success`,-1)]]),_:1}),a(v,{class:`ma1`,"bg-color":`error`,color:`amber-light2`},{default:t(()=>[...f[15]||=[o(`error`,-1)]]),_:1}),a(v,{class:`ma1`,"bg-color":`primary`,color:`success-light2`},{default:t(()=>[...f[16]||=[o(`warning`,-1)]]),_:1})]),_:1}),f[116]||=s(`<h3>Dark / Light</h3><p>By default the <code>primary</code> color is considered dark as well as the four status colors:
...
`,-1)]]),default:t(()=>[a(v,{class:`ma1`,"bg-color":d.$store.state.darkMode?`primary-dark3`:`primary-light3`},{default:t(()=>[...f[19]||=[o(`normal`,-1)]]),_:1},8,[`bg-color`]),a(x,{class:c([`mx6`,d.$store.state.darkMode?`grey-dark3`:`grey-light3`]),size:`2.5em`},{default:t(()=>[...f[20]||=[o(`mdi mdi-arrow-right`,-1)]]),_:1},8,[`class`]),a(v,l({class:`ma1`,"bg-color":d.$store.state.darkMode?`primary-dark3`:`primary-light3`},{[`${d.$store.state.darkMode?`light`:`dark`}`]:!0}),{default:t(()=>[o(u(d.$store.state.darkMode?`light`:`dark`),1)]),_:1},16,[`bg-color`])]),_:1}),a(_,{h2:``},{default:t(()=>[...f[23]||=[o(`Sizes`,-1)]]),_:1}),f[117]||=s(`<p>The button size can be controlled via the preset sizes <code>xs</code>, <code>sm</code>, <code>md</code>,
...
`,-1)]]),default:t(()=>[a(v,{class:`ma1`,loading:d.button1loading,onClick:f[0]||=e=>g.buttonDoLoading(1)},{default:t(()=>[a(x,{class:`mr1`},{default:t(()=>[...f[90]||=[o(`wi-check`,-1)]]),_:1}),f[91]||=o(`Save`,-1)]),_:1},8,[`loading`]),a(v,{class:`ma1 px4`,loading:d.button2loading,onClick:f[1]||=e=>g.buttonDoLoading(2)},{loading:t(()=>[...f[93]||=[o(`Loading...`,-1)]]),default:t(()=>[a(x,{class:`mr1`},{default:t(()=>[...f[92]||=[o(`wi-check`,-1)]]),_:1}),f[94]||=o(`Save`,-1)]),_:1},8,[`loading`])]),_:1}),a(_,{h2:``},{default:t(()=>[...f[98]||=[o(`Links`,-1)]]),_:1}),f[123]||=s(`<p>If you are using Vue Router, all the links will automatically be <strong class="code">router-link</strong>s
