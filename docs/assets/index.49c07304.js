import{r as p,o as h,f as m,a as r,w as e,b as t,d as s,l as D,v as k,i as O,_ as b,K as C}from"./index.bf306805.js";const T=s("p",null,[t("The "),s("strong",{class:"code"},"w-drawer"),t(` component can be placed in a deeper structure than the root of
...
</p>`,2),V=s("p",{class:"mb4"},"Open a blue 60px-height bottom drawer",-1),N=O(`<p>The <code>push-content</code> prop can be used on <code>left</code> and <code>right</code> positions.
...
The pushable content should be provided via the <code>pushable</code> slot.</p>`,1),S={class:"py12 w-flex column align-center justify-center"},_=s("p",{class:"mb3"},"Pushable content",-1),A=s("div",{class:"ma2"},"Drawer content",-1),j={class:"py12 w-flex column align-center justify-center"},R=s("p",{class:"mb3"},"Pushable content",-1),B=s("div",{class:"ma2"},"Drawer content",-1),L=s("span",null,"Open top drawer with a:",-1),x=s("p",{class:"mt4"},[s("strong",null,"Note:"),t(` with no overlay the underneath content will be clickable and the drawer
will not close.
...
`)]),default:e(()=>[V,r(l,{onClick:o[7]||(o[7]=a=>{n.bottomDrawerHeight="60px",n.openBottomDrawer=!0}),outline:""},{default:e(()=>[t("Open drawer")]),_:1})]),_:1}),r(i,{h2:""},{default:e(()=>[t("Push content")]),_:1}),N,r(c,{"content-class":"relative pa0","app-props-string":"","blank-codepen":["css"]},{pug:e(()=>[t(`w-drawer(
  v-model="openDrawer"
  push-content
...
`)]),default:e(()=>[r(u,{modelValue:n.openPushContentRightDrawer,"onUpdate:modelValue":o[9]||(o[9]=a=>n.openPushContentRightDrawer=a),"push-content":"","overlay-opacity":.15,width:"160px"},{pushable:e(()=>[s("div",S,[_,r(l,{onClick:o[8]||(o[8]=a=>n.openPushContentRightDrawer=!0),outline:""},{default:e(()=>[t("Open drawer")]),_:1})])]),default:e(()=>[A]),_:1},8,["modelValue","overlay-opacity"])]),_:1}),r(c,{"content-class":"relative pa0","app-props-string":"","blank-codepen":["css"]},{pug:e(()=>[t(`w-drawer(
  v-model="openDrawer"
  push-content
  :overlay-opacity="0.15"
  left
