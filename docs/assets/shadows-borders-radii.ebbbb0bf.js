import{r as t,o as i,f as r,a as o,w as n,b as e,F as h,s as _,e as s,h as a,i as y,n as u,_ as j,ah as Y}from"./index.aa69c406.js";const k=s("shadows, borders & border radii"),S=e("p",null,[s("Wave UI offers a few CSS helper classes to control the drop shadow, borders and border radii."),e("br"),s(`
...
the `),e("span",{class:"code"},"border-width"),s(") on all the sides. "),e("code",null,".bd0"),s(" will remove any border.")],-1),D={class:"w-flex wrap"},F={class:"code"},R=s(`.w-flex.wrap
  .box.bd0 .bd0
  .box.bd1 .bd1
  .box.bd2 .bd2
  .box.bd3 .bd3
...
</w-flex>`),H=s(".box {\n  width: 80px;\n  height: 80px;\n  margin: 4px; /* You could use the class `ma1`. */\n  background-color: #e3f2fd; /* You could use the class `blue-light5--bg`. */\n  display: flex; /* You could use the class `d-flex`. */\n  align-items: center; /* You could use the class `align-center`. */\n  justify-content: center; /* You could use the class `justify-center`. */\n}\n"),L=s("Border radii"),M=y(`<p>The border radii range from <code>0</code> to <code>6</code>, and are incremented by the <code>$base-increment</code>
