import{C as e,N as t,R as n,U as r,c as i,d as a,g as o,h as s,k as c,yt as l}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as u}from"./_plugin-vue_export-helper-S3RvzygF.js";import{n as d}from"./index-BJr8b_n6.js";var f={class:`tooltips-demo`},p={class:`d-iblock my2 mx6`},m={class:`mt4`},h={class:`text-center py6`},g={class:`another-container text-center green-light5--bg pa6`},_={class:`w-flex wrap align-start gap6`};function v(u,d,v,y,b,x){let S=t(`alert`),C=t(`title-link`),w=t(`w-icon`),T=t(`w-tooltip`),E=t(`example`),D=t(`w-button`),O=t(`w-switch`),k=t(`w-flex`),A=t(`w-radios`),j=t(`w-tag`),M=t(`w-card`);return c(),a(`div`,f,[o(S,{tip:``},{default:r(()=>[...d[12]||=[i(`strong`,null,`Important notes`,-1),i(`br`,null,null,-1),s(`
