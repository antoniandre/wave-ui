...
`)])),default:l(()=>[n(o,{items:i.items3,modelValue:i.customSelection,"onUpdate:modelValue":e[3]||(e[3]=r=>i.customSelection=r),multiple:""},{selection:l(({item:r})=>[(p(!0),f(D,null,M(r,(v,T)=>(p(),j(S,{class:"mr2",key:T,"bg-color":"grey-light4"},{default:l(()=>[t(d(v.label),1)]),_:2},1024))),128))]),_:1},8,["items","modelValue"])]),_:1}),n(m,{h2:""},{default:l(()=>e[99]||(e[99]=[t("Custom list items")])),_:1}),n(a,null,{pug:l(()=>e[101]||(e[101]=[t(`w-select(:items="items")
