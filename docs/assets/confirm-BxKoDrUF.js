import{H as e,N as t,c as n,d as r,g as i,h as a,ht as o,k as s,m as c,u as l,vt as u}from"./runtime-core.esm-bundler-DPe36P4s.js";import{t as d}from"./_plugin-vue_export-helper-S3RvzygF.js";import{M as f}from"./index-CmUoOmTq.js";var p={class:`w-flex wrap`},m={class:`w-flex align-center my4`},h={class:`w-flex justify-end align-center`};function g(d,f,g,_,v,y){let b=t(`alert`),x=t(`title-link`),S=t(`w-confirm`),C=t(`example`),w=t(`w-flex`),T=t(`w-icon`),E=t(`w-input`),D=t(`w-transition-slide-fade`),O=t(`w-card`);return s(),r(`div`,null,[i(b,{info:``},{default:e(()=>[...f[5]||=[n(`ul`,null,[n(`li`,null,[a(`The purpose of the `),n(`strong`,{class:`code`},`w-confirm`),a(` component is to quickly set up a
