import{r as a,o as p,g as d,a as r,w as s,b as t,d as o,_ as b,z as y}from"./index-D5hdT684.js";function h(l,e,f,w,g,u){const i=a("title-link"),n=a("w-breadcrumbs"),m=a("example"),c=a("w-tag");return p(),d("div",null,[r(i,{h2:""},{default:s(()=>e[0]||(e[0]=[t("Default")])),_:1}),e[34]||(e[34]=o("p",null,[t(`By default, each item except the last one will be a link providing that a route attribute is found
...
`)])),default:s(()=>[r(n,{items:l.items},null,8,["items"])]),_:1}),r(i,{h2:""},{default:s(()=>e[4]||(e[4]=[t("Colors")])),_:1}),e[36]||(e[36]=o("p",null,[t("Like in most components, you can set a "),o("code",null,"color"),t(` for the component texts.
...
`)])),default:s(()=>[r(n,{items:l.items,color:"orange"},null,8,["items"])]),_:1}),r(i,{h3:""},{default:s(()=>e[8]||(e[8]=[t("Separator color")])),_:1}),r(m,null,{pug:s(()=>e[9]||(e[9]=[t('w-breadcrumbs(:items="items" separator-color="orange")')])),html:s(()=>e[10]||(e[10]=[t('<w-breadcrumbs :items="items" separator-color="orange" />')])),js:s(()=>e[11]||(e[11]=[t(`data: () => ({
  items: [
    { label: 'Sitemap', route: '/sitemap' },
    { label: 'Home', route: '/' },
    { label: 'Current page', route: '/w-breadcrumbs' }
...
`)])),default:s(()=>[r(n,{items:l.items,"separator-color":"orange"},null,8,["items"])]),_:1}),r(i,{h2:""},{default:s(()=>e[12]||(e[12]=[t("Custom separator")])),_:1}),e[37]||(e[37]=o("p",null,[t("You can customize the separator simply by providing a different icon, or using the "),o("code",null,"separator"),t(`
slot.`)],-1)),r(i,{h3:""},{default:s(()=>e[13]||(e[13]=[t("Icon")])),_:1}),r(m,null,{pug:s(()=>e[14]||(e[14]=[t('w-breadcrumbs(:items="items" icon="mdi mdi-arrow-right")')])),html:s(()=>e[15]||(e[15]=[t('<w-breadcrumbs :items="items" icon="mdi mdi-arrow-right" />')])),js:s(()=>e[16]||(e[16]=[t(`data: () => ({
  items: [
    { label: 'Sitemap', route: '/sitemap' },
    { label: 'Home', route: '/' },
    { label: 'Current page', route: '/w-breadcrumbs' }
...
`)])),default:s(()=>[r(n,{items:l.items,icon:"mdi mdi-arrow-right"},null,8,["items"])]),_:1}),r(i,{h3:""},{default:s(()=>e[17]||(e[17]=[t("Slot")])),_:1}),r(m,null,{pug:s(()=>e[19]||(e[19]=[t(`w-breadcrumbs(:items="items")
...
`)])),default:s(()=>[r(n,{items:l.items},{separator:s(()=>e[18]||(e[18]=[t("//")])),_:1},8,["items"])]),_:1}),r(i,{h2:""},{default:s(()=>e[22]||(e[22]=[t("Custom item template")])),_:1}),e[38]||(e[38]=o("p",null,[t("You can provide a custom template for the items via the "),o("code",null,"item"),t(" slot.")],-1)),r(m,null,{pug:s(()=>e[23]||(e[23]=[t(`w-breadcrumbs(:items="items")
...
`)])),default:s(()=>[r(n,{items:l.items,"link-last-item":""},null,8,["items"])]),_:1}),r(i,{h2:""},{default:s(()=>e[30]||(e[30]=[t("Sizes")])),_:1}),e[40]||(e[40]=o("p",null,[t("The breadcrumbs size can be controlled via the preset sizes "),o("code",null,"xs"),t(", "),o("code",null,"sm"),t(", "),o("code",null,"md"),t(`,
