import{r,o as d,g as u,a as i,w as n,b as e,d as o,t as c,_ as w,ab as C}from"./index-BhQVIzBi.js";function k(l,t,f,g,b,p){const s=r("title-link"),m=r("w-timeline"),a=r("example"),h=r("w-icon"),I=r("w-tag");return d(),u("div",null,[i(s,{h2:""},{default:n(()=>t[0]||(t[0]=[e("Basic")])),_:1}),i(a,null,{pug:n(()=>t[1]||(t[1]=[e('w-timeline(:items="items")')])),html:n(()=>t[2]||(t[2]=[e('<w-timeline :items="items"></w-timeline>')])),js:n(()=>t[3]||(t[3]=[e(`data: () => ({
  items: [
