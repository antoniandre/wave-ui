import{N as e,W as t,_t as n,bt as r,c as i,d as a,g as o,h as s,k as c}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as l}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{H as u,U as d}from"./index-DAkWssgz.js";var f={class:`mt3`},p={class:`ml1`},m={class:`mt3`},h={class:`ml1`},g={class:`mt3`},_={class:`ml1`},v={class:`mt3`},y={class:`ml1`},b={class:`ml1`};function x(l,u,d,x,S,C){let w=e(`alert`),T=e(`title-link`),E=e(`w-accordion`),D=e(`example`),O=e(`w-icon`),k=e(`w-button`),A=e(`w-alert`),j=e(`w-tag`),M=e(`w-list`),N=e(`w-accordion-item`);return c(),a(`div`,null,[o(w,{info:``},{default:t(()=>[...u[7]||=[i(`p`,null,`Two components are available:`,-1),i(`ul`,null,[i(`li`,null,[i(`strong`,{class:`code`},`w-accordion`),s(`: The root accordion component.`)]),i(`li`,{class:`mt2`},[i(`strong`,{class:`code`},`w-accordion-item`),s(`: An optional component if you don't need / prefer not to use
