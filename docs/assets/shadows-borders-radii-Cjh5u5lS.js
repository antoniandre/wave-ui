import{r as t,o as b,g as c,a as o,w as d,b as e,d as n,F as x,k as m,n as w,t as a,h as k,_ as Y}from"./index-D5hdT684.js";const S={class:"w-flex wrap"},C={class:"code"},$={class:"w-flex wrap"},I={class:"code"},U={class:"w-flex wrap"},B={class:"code"};function N(p,s,T,V,A,q){const r=t("title-link"),u=t("alert"),i=t("example"),f=t("w-divider"),g=t("w-image"),h=t("w-flex"),v=t("w-switch"),y=t("w-card"),j=t("w-accordion");return b(),c("main",null,[o(r,{class:"mt4",h1:""},{default:d(()=>s[0]||(s[0]=[e("shadows, borders & border radii")])),_:1}),s[28]||(s[28]=n("p",null,[e("Wave UI offers a few CSS helper classes to control the drop shadow, borders and border radii."),n("br"),e(`
