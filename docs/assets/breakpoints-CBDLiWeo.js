import{N as e,W as t,_t as n,bt as r,c as i,d as a,g as o,h as s,k as c,m as l}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as u}from"./plugin-vue_export-helper-B80Cc4Ui.js";var d={class:`title2 mt0`};function f(u,f){let p=e(`title-link`),m=e(`router-link`),h=e(`w-card`),g=e(`example`),_=e(`ssh-pre`),v=e(`alert`);return c(),a(`main`,null,[o(p,{class:`mt4`,h1:``},{default:t(()=>[...f[0]||=[s(`Breakpoints`,-1)]]),_:1}),o(p,{h2:``},{default:t(()=>[...f[1]||=[s(`What is this for?`,-1)]]),_:1}),f[37]||=i(`p`,null,[s(`If you are not familiar with breakpoints, you should first read about it.`),i(`br`),s(`
