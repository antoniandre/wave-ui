import{N as e,U as t,c as n,d as r,g as i,h as a,k as o,l as s,u as c,yt as l}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as u}from"./_plugin-vue_export-helper-S3RvzygF.js";import{V as d}from"./index-CKcZQ2YR.js";var f={style:{"max-width":`1000px`}};function p(u,d,p,m,h,g){let _=e(`title-link`),v=e(`w-alert`),y=e(`example`),b=e(`w-button`),x=e(`w-transition-expand`);return o(),r(`div`,f,[i(_,{h2:``},{default:t(()=>[...d[5]||=[a(`Basic`,-1)]]),_:1}),d[95]||=n(`p`,null,[a(`The alert is commonly used to emphasize some content.`),n(`br`),a(`
