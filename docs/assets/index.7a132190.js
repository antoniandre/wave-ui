import{r as d,o as h,e as u,f as o,w as t,g as l,i as e,t as s,c as y,j as O,N as k}from"./vendor.e64646cc.js";import{_ as p,J as b}from"./index.f3654a4f.js";const x=e("Default tag & outline"),V=e("tag"),$=e("tag"),A=e(`w-tag.mr4 tag
...
background.`)],-1),z=e("tag"),N=e("tag"),T=e("tag"),W=e(`w-tag.mr4(color="primary") tag
w-tag.mr4(bg-color="primary") tag
w-tag(bg-color="primary" color="yellow") tag`),j=e(`<w-tag class="mr4" color="primary">tag</w-tag>
<w-tag class="mr4" bg-color="primary">tag</w-tag>
<w-tag bg-color="primary" color="yellow">tag</w-tag>
`),U=e("Round, tile & shadow"),D=e("round"),P=e("tile"),E=e("shadow"),I=e(`w-tag.mr4(bg-color="primary" round) round
w-tag.mr4(bg-color="primary" tile) tile
w-tag(color="primary" shadow) shadow`),R=e(`<w-tag
  class="mr4"
  bg-color="primary"
  round>
  round
...
`),F=e("Sizes"),J=k(`<p>The tag size can be controlled via the preset sizes <code>xs</code>, <code>sm</code>, <code>md</code>,
<code>lg</code>, <code>xl</code>, or via the <code>width</code> and <code>height</code> props.</p>`,1),L={class:"w-flex wrap align-center"},Y=e("extra small"),q=e("small"),G=e("medium"),H=e("large"),K=e("extra large"),M=l("div",{class:"title3 my4"},"Custom width and height",-1),Q=e("a bigger tag"),X=e(`.w-flex.wrap.align-center
