import{o as p,g as q,a as s,w as i,b as e,d as l,e as t,r as u,_ as g,C as _}from"./index.0ad1f9e2.js";const w=t("br",null,null,-1),x=t("br",null,null,-1),R=t("br",null,null,-1),L=t("br",null,null,-1),k=t("p",null,[e("When the title is simple you can pass it directly as a prop like in this example."),t("br"),e(`
You can also use the `),t("code",null,"title"),e(` slot to pass more complex data and benefit from the Vue template
compilation.`)],-1),C=t("p",null,[e(`Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rem dolore delectus,
...
`,1)]),default:i(()=>[s(o,{title:"Card title","title-class":n.$store.state.darkMode?"primary-dark3--bg":"blue-light5--bg"},{default:i(()=>[C]),_:1},8,["title-class"])]),_:1}),s(a,{h2:""},{default:i(()=>[e("Colored card with no title and no border")]),_:1}),y,s(r,null,{pug:i(()=>[e(`w-card(bg-color="secondary" no-border)
  p.
    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rem dolore delectus,
    quisquam ipsa laudantium esse consequatur itaque similique et eligendi eum voluptas
    odit dolor labore eveniet at vel sequi nostrum.#[br]#[br]
