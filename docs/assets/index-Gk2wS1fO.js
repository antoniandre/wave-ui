import{r as m,o as g,g as h,a as e,w as o,b as l,t as p,d as r,Z as y,$ as k,_ as w,a0 as _}from"./index-DmbSWeYz.js";const c=n=>(y("data-v-421017b5"),n=n(),k(),n),S=c(()=>r("p",{class:"my4"},"First choose your progress style:",-1)),V=c(()=>r("p",null,[l("Like in most components, you can set a "),r("code",null,"color"),l(" for the text and a "),r("code",null,"bg-color"),l(` for the
background.`),r("br"),l(`
By default, the progress foreground color is `),r("code",null,"primary"),l(".")],-1)),x=c(()=>r("h3",null,"Mixing colors",-1)),$=c(()=>r("p",null,"The value can be given as a number or a string.",-1)),C=c(()=>r("p",null,[l("When the value is "),r("code",null,"undefined"),l(", "),r("code",null,"-1"),l(` or not provided at all, it will be assumed
indeterminate.`)],-1)),A=c(()=>r("h3",null,"Updated value example",-1)),P=c(()=>r("p",null,[l("The default label displays the rounded value without the "),r("code",null,"%"),l(" sign, so it fits in smaller circles.")],-1)),I=c(()=>r("p",null,"You can customize the label to display the value as you wish.",-1)),D=c(()=>r("p",null,"Default label   -   Custom label",-1)),O=c(()=>r("h3",null,"Providing a color for the custom label",-1)),U=c(()=>r("p",null,[l("Like in most components, you can set a "),r("code",null,"color"),l(" for the text and a "),r("code",null,"bg-color"),l(` for the
...
So you are free to decide what is the best color.`)],-1));function j(n,i,v,b,f,d){const t=m("title-link"),s=m("w-progress"),a=m("example"),z=m("w-tabs");return g(),h("div",null,[e(t,{class:"title1",h2:""},{default:o(()=>[l("Circular progress & linear progress")]),_:1}),S,e(z,{items:[{title:"Circular"},{title:"Linear"}],card:"","content-class":"pl6"},{"item-content.1":o(()=>[e(t,{h2:""},{default:o(()=>[l("Default indeterminate progress & colors")]),_:1}),V,e(a,{reactive:""},{pug:o(()=>[l(`w-progress.ma1(circle)
...
`)]),default:o(()=>[e(s,{class:"ma1",circle:""}),e(s,{class:"ma1",circle:"",color:"blue"}),e(s,{class:"ma1",circle:"",color:"green"}),x,e(s,{class:"ma1",circle:"",color:"yellow","bg-color":"cyan"})]),_:1}),e(t,{h2:""},{default:o(()=>[l("Progress value")]),_:1}),$,C,e(a,{reactive:""},{pug:o(()=>[l(`w-progress.ma1(circle :model-value="undefined")
