import{r as d,o as _,e as T,f as n,w as t,g as o,t as i,i as e,B as V}from"./vendor.e64646cc.js";import{_ as w,I as x}from"./index.cb32932c.js";const j=e("Basic"),$=e('w-tabs(:items="tabs")'),B=e('<w-tabs :items="tabs"></w-tabs>'),P=e(`data: () => ({
  tabs: [
...
`),_t=e("Content transitions"),Tt=o("p",null,"Change tab to see the transition.",-1),wt=e(`w-radios.mb3(:items="transitions" v-model="transition")
w-tabs(:items="tabs" :transition="transition")`),ft=e(`<w-radios
  class="mb3"
  :items="transitions"
  v-model="transition">
</w-radios>
