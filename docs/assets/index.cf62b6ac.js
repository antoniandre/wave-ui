import{r,o as b,g as p,a as l,w as t,b as e,t as c,d as n,F as T,k as M,c as S,_ as v,a3 as j,C as D}from"./index.01c96784.js";const A=n("span",{class:"code"},"w-select",-1),P=n("br",null,null,-1),O=n("span",{class:"code"},".w-app",-1),V=n("p",null,[e("This is the most basic use of the "),n("span",{class:"code"},"w-select"),e(" component. No label, no v-model, only items.")],-1),E=n("p",null,[e("The select list can have a label or not and a placeholder or not."),n("br")],-1),R=n("code",null,"label",-1),C=n("br",null,null,-1),U=n("code",null,"item-label-key",-1),$=n("p",{class:"mb4"},[e("Like in most components, you can set a "),n("code",null,"color"),e(" for the text and a "),n("code",null,"bg-color"),e(` for the
background.`),n("br"),e(`
...
`)]),default:t(()=>[l(i,{items:s.items3,modelValue:s.customSelection,"onUpdate:modelValue":m[3]||(m[3]=d=>s.customSelection=d),multiple:""},{selection:t(({item:d})=>[(b(!0),p(T,null,M(d,(g,L)=>(b(),S(k,{class:"mr2",key:L,"bg-color":"grey-light4"},{default:t(()=>[e(c(g.label),1)]),_:2},1024))),128))]),_:1},8,["items","modelValue"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Custom list items")]),_:1}),l(a,null,{pug:t(()=>[e(`w-select(:items="items")
