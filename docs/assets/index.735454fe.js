import{r,o as h,f as p,a as l,w as t,b as e,h as d,d as n,F as L,j as M,c as j,_ as v,a1 as T,C as A}from"./index.bf306805.js";const D=n("span",{class:"code"},"w-select",-1),O=n("br",null,null,-1),P=n("span",{class:"code"},".w-app",-1),V=n("p",null,[e("This is the most basic use of the "),n("span",{class:"code"},"w-select"),e(" component. No label, no v-model, only items.")],-1),E=n("p",null,[e("The select list can have a label or not and a placeholder or not."),n("br")],-1),$=n("code",null,"label",-1),C=n("br",null,null,-1),R=n("code",null,"item-label-key",-1),U=n("p",{class:"mb4"},[e("Like in most components, you can set a "),n("code",null,"color"),e(" for the text and a "),n("code",null,"bg-color"),e(` for the
background.`),n("br"),e(`
By default, the text has the "`),n("span",{class:"code"},"primary"),e('" color.')],-1),B=n("p",null,[e("If an item object contains the key "),n("code",null,"color"),e(`, it will naturally be used by the
`),n("strong",{class:"code"},"w-select"),e(" component to display this list item in this color."),n("br"),e(`
To disable this you can set the `),n("code",null,"item-color-key"),e(" prop to an empty string.")],-1),W=n("div",{class:"title4"},"Default style (Underline)",-1),F=n("div",{class:"title4 mt6"},"Outline style",-1),x=n("div",{class:"title4"},"Default style (Underline)",-1),q=n("div",{class:"title4 mt6"},"Outline style",-1),N=n("span",{class:"code"},"w-select",-1),H=n("code",null,"model-value",-1),K=n("br",null,null,-1),Y=n("code",null,"item-value-key",-1),z=n("span",null,"v-model:",-1),G={class:"ml2"},J=n("p",null,"If no values are provided in the items objects, the labels will be used to identify the selected items.",-1),Q=n("span",null,"v-model:",-1),X={class:"ml2"},Z=n("p",null,[e("If it's more convenient for you, you can ask the "),n("span",{class:"code"},"w-select"),e(` component to return the
...
whether you use a multiple or single select list.`)],-1),me={key:1,class:"px2"},de={class:"ml1"},re=n("div",{class:"title4 mb2"},"Label outside",-1),ue=n("div",{class:"title4 mt6 mb2"},"Label inside",-1);function he(s,c,_,y,I,f){const u=r("alert"),o=r("title-link"),i=r("w-select"),a=r("example"),w=r("w-flex"),b=r("w-icon"),k=r("w-tag");return h(),p("div",null,[l(u,{info:""},{default:t(()=>[e("The "),D,e(` component can be placed in a hidden overflow container and the dropdown
menu will still be fully visible when open.`),O,e(`
This is because the select dropdown menu is placed at the `),P,e(` level in the DOM,
just so you don't have to worry about this annoying case.
`)]),_:1}),l(o,{h2:""},{default:t(()=>[e("Basic")]),_:1}),V,l(a,null,{html:t(()=>[e('<w-select :items="items"></w-select>')]),js:t(()=>[e(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`)]),default:t(()=>[l(i,{items:s.items1},null,8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Label and / or placeholder")]),_:1}),E,l(a,null,{html:t(()=>[e(`<w-select
  :items="items"
  label="Label">
</w-select>
...
object under the `),$,e(" name."),C,e(`
If this is a constraint, you can use the option `),R,e(` to specify the name of another
attribute to be used instead.
`)]),_:1}),l(o,{h2:""},{default:t(()=>[e("Outline")]),_:1}),l(a,null,{html:t(()=>[e('<w-select :items="items" outline>Label</w-select>')]),js:t(()=>[e(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`)]),default:t(()=>[l(i,{items:s.items1,outline:""},{default:t(()=>[e("Label")]),_:1},8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Colors")]),_:1}),U,l(o,{h3:"",slug:"default-style"},{default:t(()=>[e("Default style (Underline)")]),_:1}),l(a,null,{html:t(()=>[e(`<w-select
  :items="items"
  color="blue">
  Label
</w-select>
...
`)]),default:t(()=>[l(i,{items:s.items1,color:"blue"},{default:t(()=>[e("Label")]),_:1},8,["items"]),l(i,{class:"mt4",items:s.items1,"bg-color":"blue-light5",color:"blue-dark3"},{default:t(()=>[e("Label")]),_:1},8,["items"])]),_:1}),l(o,{h3:""},{default:t(()=>[e("Outline style")]),_:1}),l(a,null,{html:t(()=>[e(`<w-select
  :items="items"
  outline
  color="blue">
  Label
...
`)]),default:t(()=>[l(i,{items:s.items1,outline:"",color:"blue"},{default:t(()=>[e("Label")]),_:1},8,["items"]),l(i,{class:"mt4",items:s.items1,outline:"","bg-color":"blue-light5",color:"blue-dark3"},{default:t(()=>[e("Label")]),_:1},8,["items"])]),_:1}),l(o,{h3:""},{default:t(()=>[e("List items colors")]),_:1}),B,l(a,null,{html:t(()=>[e(`<w-select :items="items">
  Pick a color
</w-select>`)]),js:t(()=>[e(`data: () => ({
  items: [
...
`)]),default:t(()=>[l(i,{items:s.items4},{default:t(()=>[e("Pick a color")]),_:1},8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Shadow")]),_:1}),l(a,null,{html:t(()=>[e(`<div class="title4 mb2">
...
`)]),default:t(()=>[W,l(i,{items:s.items1,shadow:""},{default:t(()=>[e("Label")]),_:1},8,["items"]),F,l(i,{items:s.items1,outline:"",shadow:""},{default:t(()=>[e("Label")]),_:1},8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Tile & round")]),_:1}),l(a,null,{html:t(()=>[e(`<div class="title4">
  Default style (Underline)
</div>
...
`)]),default:t(()=>[x,l(i,{items:s.items1,"bg-color":"purple-light5",tile:""},{default:t(()=>[e("Tile")]),_:1},8,["items"]),l(i,{class:"mt4",items:s.items1,"bg-color":"purple-light5",round:""},{default:t(()=>[e("Round")]),_:1},8,["items"]),q,l(i,{items:s.items1,outline:"",tile:""},{default:t(()=>[e("Tile")]),_:1},8,["items"]),l(i,{class:"mt4",items:s.items1,outline:"",round:""},{default:t(()=>[e("Round")]),_:1},8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Multiple selection")]),_:1}),l(a,null,{html:t(()=>[e('<w-select :items="items" multiple></w-select>')]),js:t(()=>[e(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`)]),default:t(()=>[l(i,{items:s.items1,multiple:""},null,8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("V-model")]),_:1}),l(u,{tip:""},{default:t(()=>[e("By default, the "),N,e(" component expects the items to have a "),H,e(" attribute."),K,e(`
...
`)]),default:t(()=>[l(i,{modelValue:s.vModelSelect1,"onUpdate:modelValue":c[0]||(c[0]=m=>s.vModelSelect1=m),items:s.items3,multiple:""},null,8,["modelValue","items"]),l(w,{class:"align-center mt4"},{default:t(()=>[z,n("code",G,d(s.vModelSelect1),1)]),_:1})]),_:1}),l(o,{h3:""},{default:t(()=>[e("Without values (using labels)")]),_:1}),J,l(a,null,{html:t(()=>[e(`<w-select
  v-model="selection"
  :items="items"
  multiple>
</w-select>
...
`)]),default:t(()=>[l(i,{modelValue:s.vModelSelect2,"onUpdate:modelValue":c[1]||(c[1]=m=>s.vModelSelect2=m),items:s.items1,multiple:""},null,8,["modelValue","items"]),l(w,{class:"align-center mt4"},{default:t(()=>[Q,n("code",X,d(s.vModelSelect2),1)]),_:1})]),_:1}),l(o,{h3:""},{default:t(()=>[e("Using full objects in v-model")]),_:1}),Z,ee,l(a,null,{html:t(()=>[e(`<w-select
  v-model="selection"
  :items="items"
  multiple
  return-object>
...
`)]),default:t(()=>[l(i,{modelValue:s.vModelSelect3,"onUpdate:modelValue":c[2]||(c[2]=m=>s.vModelSelect3=m),items:s.items1,multiple:"","return-object":""},null,8,["modelValue","items"]),l(w,{class:"align-center mt4"},{default:t(()=>[te,n("code",le,d(s.vModelSelect3),1)]),_:1})]),_:1}),l(o,{h2:""},{default:t(()=>[e("Label position")]),_:1}),ne,l(a,null,{html:t(()=>[e(`<w-select
  :items="items"
...
`)]),default:t(()=>[l(i,{items:s.items1,label:"Select an item"},null,8,["items"]),l(i,{class:"mt4",items:s.items1,label:"Select an item","label-position":"left"},null,8,["items"]),l(i,{class:"mt4",items:s.items1,label:"Select an item","label-position":"right"},null,8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Custom label")]),_:1}),se,l(a,null,{html:t(()=>[e(`<w-select
  :items="items"
...
`)]),default:t(()=>[l(i,{items:s.items1,"label-position":"inside",outline:""},{default:t(()=>[l(b,{class:"orange"},{default:t(()=>[e("mdi mdi-arrow-right")]),_:1}),ie,l(b,{class:"orange"},{default:t(()=>[e("mdi mdi-arrow-left")]),_:1})]),_:1},8,["items"]),l(i,{class:"mt4",items:s.items1,"label-position":"left",outline:""},{default:t(()=>[oe,l(b,{class:"orange"},{default:t(()=>[e("mdi mdi-arrow-right")]),_:1})]),_:1},8,["items"]),l(i,{class:"mt4",items:s.items1,"label-position":"right",outline:""},{default:t(()=>[l(b,{class:"orange"},{default:t(()=>[e("mdi mdi-arrow-left")]),_:1}),ae]),_:1},8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Custom selection string")]),_:1}),ce,l(a,null,{html:t(()=>[e(`<w-select :items="items" v-model="selection" multiple>
...
`)]),default:t(()=>[l(i,{items:s.items3,modelValue:s.customSelection,"onUpdate:modelValue":c[3]||(c[3]=m=>s.customSelection=m),multiple:""},{selection:t(({item:m})=>[(h(!0),p(L,null,M(m,(g,S)=>(h(),j(k,{class:"mr2",key:S,"bg-color":"grey-light4"},{default:t(()=>[e(d(g.label),1)]),_:2},1024))),128))]),_:1},8,["items","modelValue"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Custom list items")]),_:1}),l(a,null,{html:t(()=>[e(`<w-select :items="items">
...
`)]),default:t(()=>[l(i,{items:s.items3},{item:t(({item:m,selected:g})=>[g?(h(),j(b,{key:0,class:"primary"},{default:t(()=>[e("wi-check")]),_:1})):(h(),p("span",me)),n("span",de,d(m.label),1),l(k,{class:"ml2","bg-color":"grey-light4",xs:""},{default:t(()=>[e(d(m.value),1)]),_:2},1024)]),_:1},8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Inner icons")]),_:1}),l(a,null,{html:t(()=>[e(`<div class="title4 mb2">
  Label outside
</div>
...
`)]),default:t(()=>[re,l(i,{items:s.items1,label:"Select","label-position":"left",outline:"","inner-icon-left":"mdi mdi-star"},null,8,["items"]),l(i,{class:"mt4",items:s.items1,label:"Select","label-position":"right",outline:"","inner-icon-right":"mdi mdi-arrow-down"},null,8,["items"]),ue,l(i,{items:s.items1,label:"Select","label-position":"inside",outline:"","inner-icon-left":"mdi mdi-star"},null,8,["items"]),l(i,{class:"mt4",items:s.items1,label:"Select","label-position":"inside",outline:"","inner-icon-right":"mdi mdi-arrow-down"},null,8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Disabled & readonly")]),_:1}),l(a,null,{html:t(()=>[e(`<w-select
  class="mb4"
  :items="items"
