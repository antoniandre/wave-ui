import{r as c,o as h,f as m,a as r,w as e,b as l,j as _,v as D,e as t,M as k}from"./vendor.c30f2c6c.js";import{_ as b,m as C}from"./index.67df9d80.js";const $=t("Basic"),T=t("Open drawer"),P=t(`w-button(@click="openDrawer = true" outline) Open drawer
...
`),j=t("Positions"),S=t("Open left drawer"),A=t("Open right drawer"),R=t("Open top drawer"),B=t("Open bottom drawer"),L=t(`w-button.ma1(
...
`),q=t("Control width or height"),M=k(`<p>The <strong class="code">w-drawer</strong> component accepts a <span class="code">width</span> or <span class="code">height</span> parameter
...
</p>`,2),F=l("p",{class:"mb4"},"Open a blue 60px-height bottom drawer",-1),J=t("Open drawer"),G=t(`p.mb4 Open a blue 60px-height bottom drawer
...
`),X=t("Push content"),Z=k(`<p>The <code>push-content</code> prop can be used on <code>left</code> and <code>right</code> positions.
...
anything until you accept.`,-1),je=t("Show the cookie notice"),Se={class:"w-flex pa2 align-center wrap"},Ae={class:"w-flex align-center py1"},Re=t("wi-info-circle"),Be=l("span",{class:"grey-dark3"},`Our website uses cookies to give you the best user experience.
