import{f as D}from"./chunk-IHAWQA3S-C2e_0_q3.js";import{r as g,g as c,o as p,a as l,b as n,h as E,w as a,e as t,n as v,t as s,F as R,k as L,c as A,l as H,d as W,_ as B,a8 as P}from"./index-a7oKtucQ.js";const K={class:"w-flex justify-end"},O={class:"w-flex align-center mb2"},U={class:"w-flex wrap mb3"},J={class:"w-flex align-center gap2 pa1"},Y={class:"w-flex gap2 no-grow"},G={class:"mb0"},X={class:"mt4"},Q={class:"ml2"},Z={key:0},$={class:"grey mr2"},_=["onClick"],ee=["onClick"],te=["colspan"],ae={class:"title3"},ne={class:"mr2"};function le(d,e,y,F,i,u){const r=g("title-link"),o=g("w-table"),b=g("example"),f=g("w-button"),I=g("w-icon"),M=g("w-flex"),T=g("ssh-pre"),q=g("w-tag"),j=g("w-radios"),S=g("alert"),z=g("w-input");return p(),c("div",null,[l(r,{h2:""},{default:a(()=>e[12]||(e[12]=[t("Basic")])),_:1}),l(b,null,{pug:a(()=>e[13]||(e[13]=[t('w-table(:headers="table.headers" :items="table.items")')])),html:a(()=>e[14]||(e[14]=[t(`<w-table
...
}`)])),_:1}),e[197]||(e[197]=E(`<p>More details in the <a href="#pagination-prop">API section</a>.</p><p>The pagination is a two-way binding object: if you modify any property inside it, the table
...
one remain selected.
`)],-1)),l(r,{h3:"",slug:"example--row-select"},{default:a(()=>e[136]||(e[136]=[t("The "),n("span",{class:"code"},"@row-select",-1),t(" event")])),_:1}),e[204]||(e[204]=E(`<p>This event is fired each time a row is selected <strong>or unselected</strong> (so you don&#39;t need to listen
...
`)])),default:a(()=>[l(o,{headers:i.table1.headers,"no-headers":"",items:i.table1.items},{"item-cell":a(({item:m,label:h,header:N,index:k})=>[N.key==="id"?(p(),c("small",Z,"#"+s(k),1)):(p(),c(R,{key:1},[n("small",$,s(N.label)+":",1),n("span",null,s(h),1)],64))]),_:1},8,["headers","items"])]),_:1}),l(r,{h3:"",slug:"override-1-particular-item-cell"},{default:a(()=>e[166]||(e[166]=[t("override 1 particular item cell or column cells (inside <td> element)")])),_:1}),e[209]||(e[209]=E(`<p>If you only need to override 1 particular column you can do it via the <code>item-cell.xxx</code> slot,
