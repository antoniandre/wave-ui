import{r as l,g as i,o as b,a as o,b as n,h as k,w as d,e,F as u,k as m,n as x,t as w,_ as Y}from"./index-C780IYji.js";const S={class:"w-flex wrap"},C={class:"code"},$={class:"w-flex wrap"},I={class:"code"},U={class:"w-flex wrap"},B={class:"code"};function N(f,s,T,V,A,q){const a=l("title-link"),c=l("alert"),r=l("example"),g=l("w-divider"),v=l("w-image"),p=l("w-flex"),y=l("w-switch"),j=l("w-card"),h=l("w-accordion-item"),_=l("w-accordion");return b(),i("main",null,[o(a,{class:"mt4",h1:""},{default:d(()=>s[0]||(s[0]=[e("shadows, borders & border radii")])),_:1,__:[0]}),s[31]||(s[31]=n("p",null,[e("Wave UI offers a few CSS helper classes to control the drop shadow, borders and border radii."),n("br"),e(`
