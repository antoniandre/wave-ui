import{N as e,W as t,bt as n,c as r,d as i,g as a,h as o,k as s}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as c}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{n as l}from"./index-DQ7e6RHF.js";var u={class:`tooltips-demo`},d={class:`d-iblock my2 mx6`},f={class:`mt4`},p={class:`text-center py6`},m={class:`another-container text-center green-light5--bg pa6`},h={class:`w-flex wrap align-start gap6`};function g(c,l,g,_,v,y){let b=e(`alert`),x=e(`title-link`),S=e(`w-icon`),C=e(`w-tooltip`),w=e(`example`),T=e(`w-button`),E=e(`w-switch`),D=e(`w-flex`),O=e(`w-radios`),k=e(`w-tag`),A=e(`w-card`);return s(),i(`div`,u,[a(b,{tip:``},{default:t(()=>[...l[12]||=[r(`strong`,null,`Important notes`,-1),r(`br`,null,null,-1),o(`
...
`,-1)]]),default:t(()=>[a(C,{"show-on-click":``,persistent:``,"append-to":`.example-persistent`,tooltip:`Star`},{default:t(()=>[a(S,{xl:``},{default:t(()=>[...l[64]||=[o(`wi-star`,-1)]]),_:1})]),_:1})]),_:1}),a(x,{h2:``},{default:t(()=>[...l[67]||=[o(`Using a v-model`,-1)]]),_:1}),a(x,{h3:``},{default:t(()=>[...l[68]||=[o(`Toggle with v-model`,-1)]]),_:1}),l[141]||=r(`p`,null,`Click the button to toggle the tooltips.`,-1),a(w,{"content-class":`text-center my4`},{pug:t(()=>[...l[73]||=[o(`.text-center
  w-button.my2.mx6(
    ...
    dark
    width="6em")
    | `+n(`{{ showTooltip ? 'Hide' : 'Show' }}`)+` tooltip
...
<div class="mt4">
  The tooltip is `+n(`{{ showTooltip ? 'visible' : 'hidden' }}`)+`.
</div>`,-1)]]),js:t(()=>[...l[80]||=[o(`data: () => ({
  showTooltip: false
})
`,-1)]]),default:t(()=>[a(C,{modelValue:c.showTooltip2,"onUpdate:modelValue":l[6]||=e=>c.showTooltip2=e,"show-on-click":``,right:``,tooltip:`Star`},{default:t(()=>[a(S,{lg:``},{default:t(()=>[...l[77]||=[o(`wi-star`,-1)]]),_:1})]),_:1},8,[`modelValue`]),r(`div`,f,`The tooltip is `+n(c.showTooltip2?`visible`:`hidden`)+`.`,1)]),_:1}),a(x,{h2:``},{default:t(()=>[...l[81]||=[o(`Background color & text color`,-1)]]),_:1}),l[143]||=r(`p`,null,[o(`Like in most components, you can set a `),r(`code`,null,`color`),o(` for the text and a `),r(`code`,null,`bg-color`),o(` for the
