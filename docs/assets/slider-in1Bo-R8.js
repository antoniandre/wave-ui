import{H as e,N as t,c as n,d as r,g as i,h as a,k as o,vt as s}from"./runtime-core.esm-bundler-DPe36P4s.js";import{t as c}from"./_plugin-vue_export-helper-S3RvzygF.js";import{f as l}from"./index-D1jKshrg.js";var u={class:`mt4`},d={class:`ml1`},f={class:`mt4`},p={class:`ml1`},m={class:`mt4`},h={class:`ml1`},g={class:`mt4`},_={class:`ml1`},v={class:`mt4`},y={class:`ml1`};function b(c,l,b,x,S,C){let w=t(`title-link`),T=t(`w-slider`),E=t(`example`),D=t(`w-button`),O=t(`w-flex`),k=t(`w-icon`);return o(),r(`div`,null,[i(w,{h2:``},{default:e(()=>[...l[8]||=[a(`Default`,-1)]]),_:1}),l[47]||=n(`p`,null,[a(`By default the range will have the `),n(`code`,null,`primary`),a(` color.`)],-1),i(E,{"content-class":`pa6`},{html:e(()=>[...l[9]||=[a(`<w-slider :model-value="50"></w-slider>
