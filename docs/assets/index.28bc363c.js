import{n as m,H as c}from"./index.583fb266.js";import"./vendor.4f8da9ec.js";var v=function(){var e=this,a=e.$createElement,t=e._self._c||a;return t("div",[t("title-link",{attrs:{h2:""}},[e._v("Default")]),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-table
...
`)]},proxy:!0}])},[e._v("Toggle columns:"),e._l(e.table6.headers,function(n,s){return t("w-tag",{key:s,staticClass:"ma1",attrs:{"bg-color":n.hidden?"grey-light4":"primary"},on:{click:function(l){l.stopPropagation(),n.hidden=!n.hidden}}},[t("w-icon",{staticClass:"mr2"},[e._v("mdi mdi-eye"+e._s(n.hidden?"-off":""))]),e._v(e._s(n.label))],1)}),t("w-table",{staticClass:"mt2",attrs:{headers:e.table6.headers.filter(function(n){return!n.hidden}),items:e.table6.items}})],2),t("title-link",{attrs:{h2:""}},[e._v("Initial Sorting")]),e._m(4),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-table
  :headers="table.headers"
  :items="table.items"
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table1.headers,items:e.table5.items,"expandable-rows":""},scopedSlots:e._u([{key:"expanded-row",fn:function(n){var s=n.item;return[t("w-icon",{staticClass:"mr2",attrs:{color:["blue","pink"][s.gender]}},[e._v("mdi "+e._s(["mdi-gender-male","mdi-gender-female"][s.gender]))]),e._v(e._s(s.firstName)+" weighs "),t("strong",[e._v(e._s(s.weight)+"kg")]),e._v(" and is "),t("strong",[e._v(e._s(s.height)+"m")]),e._v(" tall.")]}}])})],1),t("title-link",{attrs:{h2:"",slug:"slots"}},[e._v("Headers & cells customization via slots")]),t("p",[e._v("You can customize the headers labels and/or each row cells.")]),t("title-link",{attrs:{h3:""}},[e._v("Headers")]),e._m(13),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-table
  :headers="table.headers"
  :items="table.items">
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table1.headers,items:e.table1.items},scopedSlots:e._u([{key:"header-label",fn:function(n){var s=n.label,l=n.index;return[e._v(e._s(l)+": "+e._s(s)+" \u{1F44C}")]}}])})],1),t("title-link",{attrs:{h3:"",slug:"item-cells"}},[e._v("Item cells (inside <td> element)")]),e._m(14),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-table
  :headers="table.headers"
  no-headers
  :items="table.items">
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table1.headers,"no-headers":"",items:e.table1.items},scopedSlots:e._u([{key:"item-cell",fn:function(n){n.item;var s=n.label,l=n.header,i=n.index;return[l.key==="id"?t("small",[e._v("#"+e._s(i))]):[t("small",{staticClass:"grey mr2"},[e._v(e._s(l.label)+":")]),t("span",[e._v(e._s(s))])]]}}])})],1),t("title-link",{attrs:{h3:"",slug:"override-1-particular-item-cell"}},[e._v("override 1 particular item cell or column cells (inside <td> element)")]),e._m(15),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-table
  :headers="table.headers"
  :items="table.items"
  no-headers>
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table1.headers,items:e.table1.items,"selectable-rows":""},scopedSlots:e._u([{key:"item",fn:function(n){var s=n.item;n.index;var l=n.select,i=n.classes;return[t("tr",{class:i,on:{click:l}},e._l(e.table1.headers,function(o,d){return t("td",{key:d,class:"pa4 text-"+(o.align||"left")},[e._v(e._s(s[o.key]||""))])}),0)]}}])})],1),t("title-link",{attrs:{h3:"",slug:"colspan-on-td"}},[t("span",{staticClass:"code"},[e._v("colspan")]),e._v(" on <td>")]),e._m(17),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-table
  :headers="table.headers"
  :items="table.items"
  no-headers
  selectable-rows>
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table1.headers,items:e.table1.items,"no-headers":"","selectable-rows":""},scopedSlots:e._u([{key:"item",fn:function(n){var s=n.item,l=n.index,i=n.select,o=n.classes;return[t("tr",{class:Object.assign({},o,{"indigo-light5--bg":l%2,"blue-light5--bg":!(l%2)}),on:{click:i}},[t("td",{staticClass:"pa2",attrs:{colspan:e.table1.headers.length}},[t("div",{staticClass:"title3"},[e._v("Row #"+e._s(l))]),t("ul",e._l(e.table1.headers,function(d,f){return t("li",{key:f},[t("strong",{staticClass:"mr2"},[e._v(e._s(d.label)+":")]),e._v(e._s(s[d.key]||""))])}),0)])])]}}])})],1),t("title-link",{attrs:{h2:""}},[e._v("Responsiveness & mobile layout")]),e._m(18),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-table
  :headers="table.headers"
  :items="table.items"
