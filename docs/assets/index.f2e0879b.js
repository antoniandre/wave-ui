import{r as h,o as g,f as b,a as n,w as t,m as a,t as s,e as o,h as _,b as i,_ as f,c3 as k}from"./index.d441c375.js";const H={class:"tooltips-demo"},$=i("strong",null,"Important notes",-1),V=i("br",null,null,-1),M=o(`
By default when you use `),D=i("code",null,"<w-tooltip>",-1),q=o(`, it creates a wrapper around the activator
element and the tooltip is added inside this wrapper.`),B=i("br",null,null,-1),O=o(`
...
You can use the `),U=i("code",null,"appendTo",-1),W=o(` prop to place it elsewhere in the DOM, like in the
`),F=i("a",{href:"#appending-to-a-dom-node"},"Appending to a particular DOM node",-1),N=o(" example."),j=i("br",null,null,-1),z=o(`
...
`),Mo=o("Toggle on click"),Do=o("wi-star"),qo=o("Star"),Bo=o("Star"),Oo=o("wi-star"),Eo=o("Star"),Po=o("Star"),Ro=o(`.text-center
...
prop.`)],-1),Wo=o("wi-star"),Fo=o("Star"),No=o(`w-tooltip(show-on-click persistent)
  template(#activator="{ on }")
...
`),Hn=o("Tile, round and shadow"),$n=o("mdi mdi-square"),Vn=o("Tile"),Mn=o("mdi mdi-circle"),Dn=o("Round"),qn=o("mdi mdi-heart"),Bn=o("Shadow"),On=o(`.text-center.pb8
...
`),Pn=o("Different contents"),Rn=o("wi-star"),In=o("Star"),Ln=o("Lorem ipsum, dolor sit amet consectetur adipisicing elit."),Un=i("br",null,null,-1),Wn=o("Esse quo non, beatae dolore nihil quae ratione dignissimos molestiae hic, tempore blanditiis soluta, quasi officia!"),Fn=i("br",null,null,-1),Nn=i("br",null,null,-1),jn=o("Recusandae distinctio perferendis expedita pariatur fuga."),zn=o(`.text-center
