import{H as e,N as t,U as n,c as r,d as i,g as a,h as o,ht as s,k as c,m as l,vt as u}from"./runtime-core.esm-bundler-DPe36P4s.js";import{s as d}from"./runtime-dom.esm-bundler-Dtklx5Fk.js";import{t as f}from"./_plugin-vue_export-helper-S3RvzygF.js";import{O as p}from"./index-CmUoOmTq.js";var m={class:`py12 w-flex column align-center justify-center`},h={class:`py12 w-flex column align-center justify-center`},g={class:`w-flex pa2 align-center wrap`},_={class:`w-flex align-center py1`},v={class:`w-flex align-center justify-center fill-height`};function y(f,p,y,b,x,S){let C=t(`title-link`),w=t(`w-button`),T=t(`example`),E=t(`w-drawer`),D=t(`w-card`),O=t(`w-icon`),k=t(`ssh-pre`);return c(),i(`div`,null,[a(C,{h2:``},{default:e(()=>[...p[29]||=[o(`Basic`,-1)]]),_:1}),a(T,{"content-class":`w-flex align-center wrap`},{pug:e(()=>[...p[31]||=[o(`w-button(@click="openDrawer = true" outline) Open drawer
