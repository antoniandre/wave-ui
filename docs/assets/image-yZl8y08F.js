import{N as e,U as t,c as n,d as r,g as i,h as a,k as o,l as s,u as c,yt as l}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as u}from"./_plugin-vue_export-helper-S3RvzygF.js";import{T as d}from"./index-CI5qOTMg.js";var f={class:`w-card w-flex mdu-row basis-zero pa4 gap4`},p={class:`mr5`},m={class:`w-flex wrap justify-center align-center`},h={class:`mr4 my2`},g={class:`w-flex gap6`};function _(u,d,_,v,y,b){let x=e(`title-link`),S=e(`w-divider`),C=e(`alert`),w=e(`w-image`),T=e(`example`),E=e(`w-card`),D=e(`w-radios`),O=e(`w-button`),k=e(`w-alert`);return o(),r(`div`,null,[i(x,{h2:``},{default:t(()=>[...d[2]||=[a(`Why using w-image and not a simple <img>`,-1)]]),_:1}),n(`div`,f,[d[4]||=n(`div`,null,[n(`div`,{class:`title3`},`A simple <img>`),n(`p`,null,[a(`will display when loaded, and will take the dimensions of the actual image.`),n(`br`),a(`
