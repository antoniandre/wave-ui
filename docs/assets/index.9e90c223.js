...
background.`)],-1),R=o("success"),W=o("error"),M=o("warning"),j=o(`w-button.ma1(bg-color="success" color="yellow-light2") success
w-button.ma1(bg-color="error" color="amber-light2") error
w-button.ma1(bg-color="primary" color="success-light2") warning`),H=o(`<w-button
  class="ma1"
  bg-color="success"
  color="yellow-light2">
  success
...
`),O=_(`<h3>Dark</h3><p>By default the <code>primary</code> color is considered dark as well as the four status colors:
...
w-button.ma1(color="primary" text disabled) disabled`),Mo=o(`<w-button class="ma1" color="primary" text xs>extra small</w-button>
...
`),jo=o("Round & tile"),Ho=o("round"),Oo=o("round"),qo=o("tile"),Fo=o("tile"),Jo=o(`w-button.ma1(bg-color="primary" round) round
