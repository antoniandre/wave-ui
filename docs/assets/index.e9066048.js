import{r as c,o as h,f as m,a as r,w as e,b as l,k as _,v as k,e as t,i as C,_ as b,M as D}from"./index.f302d8ad.js";const $=t("Basic"),T=t("Open drawer"),P=t(`w-button(@click="openDrawer = true" outline) Open drawer
...
`),q=t("Control width or height"),M=C(`<p>The <strong class="code">w-drawer</strong> component accepts a <span class="code">width</span> or <span class="code">height</span> parameter
...
`),ke=l("p",{class:"mt4"},[l("strong",null,"Note:"),t(` with no overlay the underneath content will be clickable and the drawer
will not close.
To allow closing the drawer when clicking outside of it, you can set a transparent background
on the overlay.
`)],-1),De=t("Persistent drawers"),Ce=l("p",null,"A persistent drawer stays open when clicking outside or pressing the escape key.",-1),Oe=t("Persistent drawer"),$e=t(`w-button(@click="openDrawer = true" outline).
  Persistent drawer
