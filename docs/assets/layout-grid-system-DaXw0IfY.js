import{N as e,W as t,_t as n,bt as r,c as i,d as a,g as o,h as s,j as c,k as l,m as u,r as d,u as f}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as p}from"./_plugin-vue_export-helper-B80Cc4Ui.js";var m={class:`xs12 pa1`},h={class:`xs4 pa1`},g={class:`xs3 pa1`},_={class:`xs2 pa1`},v={class:`title2 mt0`},y={class:`xs12 md6 lg4 xl2 pa1`},b={class:`primary--bg py3`},x={class:`xs12 md6 lg4 xl2 pa1`},S={class:`primary--bg py3`},C={class:`xs12 md6 lg4 xl2 pa1`},w={class:`primary--bg py3`},T={class:`xs12 md6 lg4 xl2 pa1`},E={class:`primary--bg py3`},D={class:`xs12 md6 lg4 xl2 pa1`},O={class:`primary--bg py3`},k={class:`xs12 md6 lg4 xl2 pa1`},A={class:`primary--bg py3`};function j(p,j){let M=e(`title-link`),N=e(`ssh-pre`),P=e(`alert`),F=e(`example`),I=e(`w-card`),L=e(`w-flex`),R=e(`router-link`);return l(),a(`main`,null,[o(M,{class:`mt4`,h1:``},{default:t(()=>[...j[0]||=[s(`Grid system (flexbox)`,-1)]]),_:1}),j[33]||=i(`div`,{class:`title3`},`The grid system (using flexbox) is 12-cell based by default.`,-1),j[34]||=i(`p`,null,[s(`Its purpose is to divide the available width (in percentage)
