import{r as g,g as b,o as h,a,b as i,w as n,e as t,t as u,c as z,d as T,_ as f,Q as U}from"./index-DyPyadtc.js";const R={class:"w-card w-flex mdu-row basis-zero pa4 gap4"},I={class:"mr5"},G={class:"w-flex wrap justify-center align-center"},S={class:"mr4 my2"},W={class:"w-flex gap6"};function E(s,e,v,c,y,m){const o=g("title-link"),d=g("w-divider"),p=g("alert"),l=g("w-image"),r=g("example"),x=g("w-card"),$=g("w-radios"),j=g("w-button"),k=g("w-alert");return h(),b("div",null,[a(o,{h2:""},{default:n(()=>e[2]||(e[2]=[t("Why using w-image and not a simple <img>",-1)])),_:1,__:[2]}),i("div",R,[e[4]||(e[4]=i("div",null,[i("div",{class:"title3"},"A simple <img>"),i("p",null,[t("will display when loaded, and will take the dimensions of the actual image."),i("br"),t(`
...
Which is IMHO, in most cases crappy except for repeated patterns.`)])],-1)),a(d,{class:"no-grow primary",vertical:!s.$waveui.breakpoint.xs&&!s.$waveui.breakpoint.sm},{default:n(()=>e[3]||(e[3]=[t("VS",-1)])),_:1,__:[3]},8,["vertical"]),e[5]||(e[5]=i("div",null,[i("div",{class:"title3"},"The w-image"),i("p",null,[t(`can show a spinner while the image is loading, and display the image all at once with a nice
...
`)])],-1))]),a(p,{tip:""},{default:n(()=>e[6]||(e[6]=[i("div",{class:"title2 mt0 lh1"},[t("The "),i("strong",{class:"code"},"w-image"),t(" in a nutshell")],-1),i("ul",null,[i("li",null,"You can set a width or a height or both. That's all you need."),i("li",null,"The width and height may be fixed (e.g. in pixel) or adaptive (e.g. in percentage)."),i("li",null,"The ratio is not needed, but can be provided to override the intrinsic ratio and crop the image (keeping it responsive if it was)."),i("li",null,"You can choose a tag to use for the image, but don't need to. It can be a <span> (default) or <img>."),i("li",null,"Providing a caption, will use the native HTML <figure> and <figcaption> tags.")],-1)])),_:1,__:[6]}),a(d,{class:"ma12"}),e[110]||(e[110]=i("p",{class:"size--lg"},"Now here comes a ton of concrete examples.",-1)),a(o,{h2:""},{default:n(()=>e[7]||(e[7]=[t("Default",-1)])),_:1,__:[7]}),e[111]||(e[111]=i("p",null,[t("With no given width, height or ratio, the image will be responsive, up to its full-size."),i("br"),t(`
This means a width of 100% is added, as well as the image computed ratio (to preserve it when
scaling down), and a max width equal to the real image width.`)],-1)),a(r,{"content-class":"text-center"},{pug:n(()=>e[8]||(e[8]=[t('w-image(:src="`${baseUrl}images/favicon.png`")',-1)])),html:n(()=>e[9]||(e[9]=[t('<w-image :src="`${baseUrl}images/favicon.png`"></w-image>',-1)])),js:n(()=>e[10]||(e[10]=[t(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})`,-1)])),default:n(()=>[a(l,{src:`${s.baseUrl}images/favicon.png`},null,8,["src"]),e[11]||(e[11]=i("div",{class:"caption text-center"},"Real size: 200x200.",-1))]),_:1,__:[11]}),a(p,{info:""},{default:n(()=>e[12]||(e[12]=[i("p",null,[t("In the "),i("code",null,"src"),t(" attribute, it's a good idea to use the "),i("code",null,"BASE_URL"),t(` environment variable to point to the
...
from just `),i("code",null,"/"),t(" which would point to "),i("code",null,"https://antoniandre.github.io/"),t("."),i("br")],-1),i("ul",null,[i("li",null,[t("With Vite, you can use "),i("code",null,u("import")+".meta.env.BASE_URL"),t(" to refer to your public app root URL.")]),i("li",null,[t("With Vue CLI or Webpack, you can also use "),i("code",null,u("process")+".env.BASE_URL"),t(".")])],-1)])),_:1,__:[12]}),a(o,{h2:""},{default:n(()=>e[13]||(e[13]=[t("Given dimensions",-1)])),_:1,__:[13]}),e[112]||(e[112]=i("p",null,[i("strong",null,[t("You can set a width, a height, or both."),i("br")]),t("If the actual image is bigger than the given width or height, it will be cropped."),i("br"),t(`
But if you prefer it to be resized maintaining the ratio, then you can set a ratio.`)],-1)),a(o,{h3:""},{default:n(()=>e[14]||(e[14]=[t("Given both fixed width and height",-1)])),_:1,__:[14]}),e[113]||(e[113]=i("p",null,[t(`In both examples the image will always have the same fixed size regardless of the viewport or
constraints.`),i("br"),t(`
...
`)],-1)),a(o,{h3:""},{default:n(()=>e[40]||(e[40]=[t("Intrinsic image ratio",-1)])),_:1,__:[40]}),e[120]||(e[120]=i("p",{class:"grey"},"Image ratio equal to the exact width and height of the image (width / height).",-1)),e[121]||(e[121]=i("p",null,[t(`This is the most common case: the image is visible in full, and scales with its container with
preserved ratio.`),i("br"),t(`
Note that Wave UI will add a width of 100% if neither of width and height are provided.`)],-1)),a(p,{class:"mt2",tip:""},{default:n(()=>e[41]||(e[41]=[t("In this case, you can obtain the same result by just setting a width of 100%.",-1)])),_:1,__:[41]}),a(r,{"content-class":"text-center"},{pug:n(()=>e[42]||(e[42]=[t('w-image(:src="`${baseUrl}images/japanese-wave.png`" :ratio="1900 / 443")',-1)])),html:n(()=>e[43]||(e[43]=[t('<w-image\n  :src="`${baseUrl}images/japanese-wave.png`"\n  :ratio="1900 / 443">\n</w-image>',-1)])),js:n(()=>e[44]||(e[44]=[t(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})
`,-1)])),default:n(()=>[a(l,{src:`${s.baseUrl}images/japanese-wave.png`,ratio:1900/443},null,8,["src"]),e[45]||(e[45]=i("div",{class:"caption text-center"},"Real size: 1900x443. Given ratio: 1900 / 443.",-1))]),_:1,__:[45]}),a(o,{h3:""},{default:n(()=>e[46]||(e[46]=[t("Custom ratio",-1)])),_:1,__:[46]}),e[122]||(e[122]=i("p",{class:"grey"},"Setting a different ratio than the actual image one.",-1)),e[123]||(e[123]=i("p",{class:"mb0"},`In this case, the image will be cropped on purpose, but still scaling with its container with
preserved ratio. 👍`,-1)),e[124]||(e[124]=i("div",{class:"caption"},"A drop shadow is added around the images to help visualizing the edges of the image.",-1)),a(r,{"content-class":"text-center"},{pug:n(()=>e[49]||(e[49]=[t('w-image.sh1(:src="`${baseUrl}images/japanese-wave.png`" :ratio="1000 / 443")\n\nw-image.sh1.mt6(:src="`${baseUrl}images/japanese-wave.png`" :ratio="3000 / 443")',-1)])),html:n(()=>e[50]||(e[50]=[t(`<w-image
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  :ratio="1000 / 443"
  class="sh1">
</w-image>
...
to achieve image stretching, loosing the aspect ratio. This may be a desired effect or not.`,-1)),a(r,{"content-class":"text-center w-flex justify-space-around wrap"},{default:n(()=>[a(l,{src:`${s.baseUrl}images/japanese-wave.png`,tag:"img",width:"100%",height:"100px"},null,8,["src"]),e[63]||(e[63]=i("div",{class:"caption text-center"},"Real size: 1900x443, given width: 100%, given height: 100px.",-1))]),_:1,__:[63]})]),_:1,__:[64]}),a(r,{"content-class":"text-center"},{pug:n(()=>e[65]||(e[65]=[t('w-image(:src="`${baseUrl}images/japanese-wave.png`" tag="img" width="100%" max-width="700px")',-1)])),html:n(()=>e[66]||(e[66]=[t(`<w-image
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  tag="img"
  width="100%"
  max-width="700px">
</w-image>`,-1)])),js:n(()=>e[67]||(e[67]=[t(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})
`,-1)])),default:n(()=>[a(l,{src:`${s.baseUrl}images/japanese-wave.png`,tag:"img",width:"100%","max-width":"700px"},null,8,["src"])]),_:1}),a(o,{h2:""},{default:n(()=>e[68]||(e[68]=[t("Figure with or without caption",-1)])),_:1,__:[68]}),e[128]||(e[128]=i("ul",null,[i("li",null,[t("You can tell the w-image component to use the native HTML "),i("span",{class:"code"},"<figure>"),t(` tag. In
...
w-image.pa2.sh2.base-color--bg(
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  caption="The Great Wave Off Kanagawa - Hokusai"
  max-width="700")`,-1)])),html:n(()=>e[70]||(e[70]=[t(`<w-image
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  tag="figure"
  max-width="700">
</w-image>
...
<w-image
  ...
  caption="The Great Wave Off Kanagawa - Hokusai"
  max-width="700">
</w-image>`,-1)])),js:n(()=>e[71]||(e[71]=[t(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})
`,-1)])),default:n(()=>[e[72]||(e[72]=i("p",null,"Figure without caption.",-1)),a(l,{src:`${s.baseUrl}images/japanese-wave.png`,tag:"figure","max-width":"700"},null,8,["src"]),e[73]||(e[73]=i("p",{class:"mt8"},"Figure with caption.",-1)),a(l,{src:`${s.baseUrl}images/japanese-wave.png`,caption:"The Great Wave Off Kanagawa - Hokusai","max-width":"700"},null,8,["src"]),e[74]||(e[74]=i("p",{class:"mt8"},[t("With some quick styles adding these classes: "),i("code",null,".pa2.sh2.base-color--bg"),t(":")],-1)),a(l,{class:"pa2 sh2 base-color--bg",src:`${s.baseUrl}images/japanese-wave.png`,caption:"The Great Wave Off Kanagawa - Hokusai","max-width":"700"},null,8,["src"]),e[75]||(e[75]=i("div",{class:"caption mt3"},"Real size: 1900x443. Given max-width: 700.",-1))]),_:1,__:[72,73,74,75]}),a(o,{h2:""},{default:n(()=>e[76]||(e[76]=[t("Loading spinner",-1)])),_:1,__:[76]}),e[129]||(e[129]=i("p",null,`This image is very big, so that you have time to see the spinner while loading.
Refresh the page if you haven't seen it (or enable dev tools throttling if your connection is too fast)!`,-1)),a(r,{"content-class":"text-center"},{pug:n(()=>e[77]||(e[77]=[t('w-image(:src="`${baseUrl}images/spirit-island--alberta.png`" :ratio="5098 / 2550")',-1)])),html:n(()=>e[78]||(e[78]=[t('<w-image\n  :src="`${baseUrl}images/spirit-island--alberta.png`"\n  :ratio="5098 / 2550">\n</w-image>',-1)])),js:n(()=>e[79]||(e[79]=[t(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})`,-1)])),default:n(()=>[a(l,{src:`${s.baseUrl}images/spirit-island--alberta.png`,ratio:5098/2550},null,8,["src"]),e[80]||(e[80]=i("div",{class:"caption"},"Real size: 5098x2550. Given ratio: 5098 / 2550.",-1))]),_:1,__:[80]}),a(p,{tip:""},{default:n(()=>e[81]||(e[81]=[i("strong",null,"Dev notes:",-1),t(" disabling the browser cache will prevent you from seeing the transition.",-1),i("br",null,null,-1),t(`
The reason for it is that the image first loads in the `,-1),i("strong",{class:"code"},"w-image",-1),t(` component, then
...
`,-1)])),_:1,__:[81]}),a(o,{h2:""},{default:n(()=>e[82]||(e[82]=[t("Transitions",-1)])),_:1,__:[82]}),e[130]||(e[130]=i("p",null,`Once the image is fully loaded, it will display in one piece with a fade transition by default.
You can customize the transition.`,-1)),a(r,null,{pug:n(()=>e[86]||(e[86]=[t(`w-flex(wrap justify-center align-center)
  ...
  w-image(:src="img.src" :width="500" :height="250" :transition="img.transition")`,-1)])),html:n(()=>e[87]||(e[87]=[t(`<w-flex wrap justify-center align-center>
  <div class="mr4 my2">
...
</w-flex>`,-1)])),js:n(()=>e[88]||(e[88]=[t(`data: () => ({
  img: {
...
}`,-1)])),default:n(()=>[i("div",G,[i("div",S,[e[84]||(e[84]=i("div",{class:"title3 mb2"},"Transition names",-1)),a($,{modelValue:s.img.transition,"onUpdate:modelValue":e[0]||(e[0]=w=>s.img.transition=w),items:s.transitions,"item-value-key":"label"},{label:n(({item:w})=>[i("code",null,u(w.label),1)]),_:1},8,["modelValue","items"]),a(j,{class:"mt2",onClick:m.reload},{default:n(()=>e[83]||(e[83]=[t("Reload image",-1)])),_:1,__:[83]},8,["onClick"])]),i("div",null,[a(l,{src:s.img.src,width:500,height:250,transition:s.img.transition},null,8,["src","transition"]),e[85]||(e[85]=i("div",{class:"caption"},"Real size: 5098x2550. Given size: 500x250.",-1))])])]),_:1}),a(p,{tip:""},{default:n(()=>e[89]||(e[89]=[i("strong",null,"Dev notes:",-1),t(" disabling the browser cache will prevent you from seeing the transition.",-1),i("br",null,null,-1),t(`
The reason for it is that the image first loads in the `,-1),i("strong",{class:"code"},"w-image",-1),t(` component, then
once it's fully loaded, the image src is filled (or background url) and the image would load again
if you disable the cache. On big images, you would then see a truncated image until completely
loaded, just like a standard <img>.
`,-1)])),_:1,__:[89]}),a(o,{h2:""},{default:n(()=>e[90]||(e[90]=[t("Error handling & Fallback",-1)])),_:1,__:[90]}),i("div",W,[a(r,{class:"mt0 no-grow","content-class":"text-center px6"},{pug:n(()=>e[91]||(e[91]=[t('w-image.bd1(src="/images/broken.png" width="100" height="100")',-1)])),html:n(()=>e[92]||(e[92]=[t(`<w-image
  class="bd1"
  src="/images/broken.png"
  width="100"
  height="100">
</w-image>`,-1)])),default:n(()=>[a(l,{class:"bd1",src:"/images/broken.png",width:"100",height:"100"}),e[93]||(e[93]=i("div",{class:"caption"},[t("Given size: 100x100."),i("br"),t("Border added for visualization.")],-1))]),_:1,__:[93]}),e[94]||(e[94]=i("p",null,[t(`If for some reason the image would not load, the default fallback is a blank 1x1 transparent gif
...
`)],-1))]),a(o,{h3:""},{default:n(()=>e[95]||(e[95]=[t("Fallback & Error handling",-1)])),_:1,__:[95]}),e[131]||(e[131]=i("ul",null,[i("li",null,`For instance, in a e-boutique you may try to load the image of an item without knowing if this item
...
</w-alert>`,-1)])),js:n(()=>e[99]||(e[99]=[t(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/',
  showError: false
})
`,-1)])),default:n(()=>[a(l,{src:`${s.baseUrl}images/broken.png`,fallback:`${s.baseUrl}images/not-found.jpg`,onError:e[1]||(e[1]=w=>s.showError=!0)},null,8,["src","fallback"]),s.showError?(h(),z(k,{key:0,error:""},{default:n(()=>e[96]||(e[96]=[t("Oops. The image could not load!",-1)])),_:1,__:[96]})):T("",!0)]),_:1}),a(o,{h2:""},{default:n(()=>e[100]||(e[100]=[t("Lazy",-1)])),_:1,__:[100]}),e[132]||(e[132]=i("p",null,[t("By using the lazy attribute, it is possible to load the image only when it is in the viewport."),i("br"),t(`
Wave UI internally uses an `),i("span",{class:"code"},"IntersectionObserver"),t(` and will only start loading the image
when it is visible.`)],-1)),a(r,null,{pug:n(()=>e[101]||(e[101]=[t('w-image(:src="`${baseUrl}images/spirit-island--alberta.png`" lazy :ratio="5098 / 2550")',-1)])),html:n(()=>e[102]||(e[102]=[t(`<w-image
  :src="\`\${baseUrl}images/spirit-island--alberta.png\`"
  lazy
  :ratio="5098 / 2550">
</w-image>`,-1)])),js:n(()=>e[103]||(e[103]=[t(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})
`,-1)])),default:n(()=>[a(l,{src:`${s.baseUrl}images/spirit-island--alberta.png?v1`,lazy:"",ratio:5098/2550},null,8,["src"]),e[104]||(e[104]=i("div",{class:"caption"},"Real size: 5098x2550.",-1))]),_:1,__:[104]}),a(o,{h2:"",slug:"content"},{default:n(()=>e[105]||(e[105]=[t("Content - via default slot",-1)])),_:1,__:[105]}),e[133]||(e[133]=i("p",null,[t("In some cases, it can be convenient to have some content on top of the image."),i("br"),t(`
