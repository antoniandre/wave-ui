import{r,o as b,f as g,a as i,w as t,b as e,h as l,d as n,n as k,_ as f,q as _}from"./index.bf306805.js";const C=n("p",{class:"grey-light2 my4"},`Now that you've seen the default accordion in real context, all the examples of this page will have a
light blue background and accordions a white background to help visualize where they end.
`,-1),S={class:"mt3"},T={class:"ml1"},j=n("p",null,[e(`You can expand one or multiple panes by default by providing a v-model array of booleans:
`),n("span",{class:"code"},"true"),e(" to expand, "),n("span",{class:"code"},"false"),e(" to collapse the item.")],-1),A={class:"mt3"},E={class:"ml1"},D=n("p",null,[e("Specify which pane should be disabled - expanded or collapsed - by adding the "),n("span",{class:"code"},"disabled"),e(` property
directly in the object.`)],-1),V=n("p",null,[e("Like in most components, you can set a "),n("code",null,"color"),e(" for the text and a "),n("code",null,"bg-color"),e(` for the
background.`),n("br"),e(`
...
`),n("code",null,"item-color-key"),e(" prop.")],-1),U={class:"mt3"},$={class:"ml1"},B={class:"mt3"},L={class:"ml1"},R=n("p",null,[e("Customize all the tab items titles and/or content via the single slot "),n("code",null,"item-title"),e(`, and/or
all the tab items content via the single slot `),n("code",null,"item-content"),e(".")],-1),N=n("p",null,[e("No problem, Wave UI's got you covered."),n("br"),e(`
If you don't need data objects at all, you can simply define a number of items: `),n("code",null,':items="3"'),e(`.
`)],-1),Q=n("p",null,[e("Here is an example of 3 totally diferent pane titles and contents using more lines of code."),n("br"),e(`
This time, an array of object is defined to show you can also do a mix of contents coming from the
the component's data or directly in the template.`)],-1),Y=n("p",null,"This content has a checklist.",-1),G=n("div",{class:"title4"},"To do",-1),H=n("em",null,"This is the 2nd item",-1),z=n("p",null,"The full content here is custom and completely distinct and independent from the other items.",-1),O={class:"ml1"},W=n("strong",null,"This is the 3rd item",-1),K=n("p",null,"Do you want to check the project on Github?",-1),M=n("div",{class:"title4"},"1 custom icon (only expand)",-1),F=n("div",{class:"title4 mt6"},"2 custom icons (expand & collapse)",-1),J=n("div",{class:"title4 mt6"},"No icon",-1),X=n("div",{class:"title4 mt6"},"Icon on the right",-1);function Z(o,c,v,w,x,u){const m=r("title-link"),a=r("w-accordion"),d=r("example"),h=r("w-button"),p=r("w-icon"),y=r("w-alert"),q=r("w-tag"),I=r("w-list");return b(),g("div",null,[i(m,{h2:""},{default:t(()=>[e("Basic")]),_:1}),i(a,{class:"white--bg",items:o.items},null,8,["items"]),C,i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`w-accordion(v-model="accordion" :items="items")

div.mt3
  | v-model:
  code.ml1 `+l("{{ accordion }}"))]),html:t(()=>[e(`<w-accordion v-model="accordion" :items="items" />
...
`)]),default:t(()=>[i(a,{class:"white--bg",modelValue:o.accordion1,"onUpdate:modelValue":c[0]||(c[0]=s=>o.accordion1=s),items:o.items},null,8,["modelValue","items"]),n("div",S,[e("v-model:"),n("code",T,l(o.accordion1),1)])]),_:1}),i(m,{h2:""},{default:t(()=>[e("Expanded by default")]),_:1}),j,i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`w-accordion(v-model="accordion" :items="items")
...
`)]),default:t(()=>[i(a,{class:"white--bg",modelValue:o.accordion2,"onUpdate:modelValue":c[1]||(c[1]=s=>o.accordion2=s),items:o.items},null,8,["modelValue","items"]),n("div",A,[e("v-model:"),n("code",E,l(o.accordion2),1)])]),_:1}),i(m,{h2:""},{default:t(()=>[e("Disabled pane")]),_:1}),D,i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e('w-accordion(v-model="accordion" :items="items")')]),html:t(()=>[e('<w-accordion v-model="accordion" :items="items" />')]),js:t(()=>[e(`data: () => ({
  items: [
...
`)]),default:t(()=>[i(a,{class:"white--bg",modelValue:o.accordion3,"onUpdate:modelValue":c[2]||(c[2]=s=>o.accordion3=s),items:o.itemsDisabled},null,8,["modelValue","items"])]),_:1}),i(m,{h2:""},{default:t(()=>[e("Shadow")]),_:1}),i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e('w-accordion(:items="items" shadow)')]),html:t(()=>[e('<w-accordion :items="items" shadow />')]),js:t(()=>[e(`data: () => ({
  items: [
    {
      title: 'Item 1',
      content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi ut neque enim beatae autem iure, velit labore aut ipsa voluptatem aliquam distinctio harum. Possimus aliquid voluptatum facere incidunt dolor a.'
...
`)]),default:t(()=>[i(a,{class:"white--bg",items:o.items,shadow:""},null,8,["items"])]),_:1}),i(m,{h2:""},{default:t(()=>[e("Color & background color")]),_:1}),V,i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`w-accordion(:items="items" color="amber-dark1")

w-accordion.mt6(:items="items" bg-color="yellow-light5")`)]),html:t(()=>[e(`<w-accordion :items="items" color="amber-dark1"></w-accordion>

<w-accordion class="mt6" :items="items" bg-color="yellow-light5"></w-accordion>`)]),js:t(()=>[e(`data: () => ({
  items: [
    {
      title: 'Item 1',
      content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi ut neque enim beatae autem iure, velit labore aut ipsa voluptatem aliquam distinctio harum. Possimus aliquid voluptatum facere incidunt dolor a.'
...
`)]),default:t(()=>[i(a,{class:"white--bg",items:o.items,color:"amber-dark1"},null,8,["items"]),i(a,{class:"mt6",items:o.items,"bg-color":"yellow-light5"},null,8,["items"])]),_:1}),i(m,{h3:""},{default:t(()=>[e("Different color per item")]),_:1}),P,i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e('w-accordion(:items="items")')]),html:t(()=>[e('<w-accordion :items="items" />')]),js:t(()=>[e(`data: () => ({
  items: [
...
`)]),default:t(()=>[i(a,{class:"white--bg",items:o.items2},null,8,["items"])]),_:1}),i(m,{h2:""},{default:t(()=>[e("Expand a single item at a time")]),_:1}),i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`w-accordion(v-model="accordion" :items="items" expand-single)

div.mt3
  | v-model:
  code.ml1 `+l("{{ accordion }}"))]),html:t(()=>[e(`<w-accordion
  v-model="accordion"
  :items="items"
  expand-single>
</w-accordion>
...
`)]),default:t(()=>[i(a,{class:"white--bg",modelValue:o.accordion4,"onUpdate:modelValue":c[3]||(c[3]=s=>o.accordion4=s),items:o.items,"expand-single":""},null,8,["modelValue","items"]),n("div",U,[e("v-model:"),n("code",$,l(o.accordion4),1)])]),_:1}),i(m,{h2:""},{default:t(()=>[e("External control")]),_:1}),i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`w-button.mr2(@click="accordion = Array&#40;3&#41;.fill&#40;true&#41;" sm) Expand all
...
div.mt3
  | v-model:
  code.ml1 `+l("{{ accordion }}"))]),html:t(()=>[e(`<w-button
  class="mr2"
...
`)]),default:t(()=>[i(h,{class:"mr2",onClick:c[4]||(c[4]=s=>o.accordion5=Array(3).fill(!0)),sm:""},{default:t(()=>[e("Expand all")]),_:1}),i(h,{onClick:c[5]||(c[5]=s=>o.accordion5=Array(3).fill(!1)),sm:""},{default:t(()=>[e("Collapse all")]),_:1}),i(a,{class:"mt4 white--bg",modelValue:o.accordion5,"onUpdate:modelValue":c[6]||(c[6]=s=>o.accordion5=s),items:o.items},null,8,["modelValue","items"]),n("div",B,[e("v-model:"),n("code",L,l(o.accordion5),1)])]),_:1}),i(m,{h2:"",slug:"custom-rendering"},{default:t(()=>[e("Custom rendering (via slots)")]),_:1}),R,i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`w-accordion(:items="items" content-class="pa0")
...
`)]),default:t(()=>[i(a,{class:"white--bg",items:o.items,"content-class":"pa0"},{"item-title":t(({item:s})=>[i(p,{lg:"",color:s.itemColor},{default:t(()=>[e(l(s.icon),1)]),_:2},1032,["color"]),n("div",{class:k(["title3 my0 ml2",s.itemColor])},l(s.title),3)]),"item-content":t(({item:s})=>[i(y,{class:"my0 pb3","border-left":"",tile:"",color:s.itemColor,innerHTML:s.content},null,8,["color","innerHTML"])]),_:1},8,["items"])]),_:1}),i(m,{h2:""},{default:t(()=>[e("Do you (really) need even more flexibility?")]),_:1}),N,i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`w-accordion(:items="3")
...
`)]),default:t(()=>[i(a,{class:"white--bg",items:3},{"item-title.1":t(()=>[e("Item title 1")]),"item-content.1":t(()=>[e("Item content 1")]),"item-title.2":t(()=>[e("Item title 2")]),"item-content.2":t(()=>[e("Item content 2")]),"item-title.3":t(()=>[e("Item title 3")]),"item-content.3":t(()=>[e("Item content 3")]),_:1})]),_:1}),Q,i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`w-accordion(:items="items")
...
`)]),default:t(()=>[i(a,{class:"white--bg",items:o.itemsCustom},{"item-title.item1":t(()=>[e("This is the 1st item"),i(q,{class:"ml2",color:"red",sm:"",outline:""},{default:t(()=>[e("HOT")]),_:1})]),"item-content.item1":t(()=>[Y,G,i(I,{checklist:"",color:"primary",items:[{label:"do this"},{label:"do that next"}]})]),"item-title.item2":t(()=>[i(p,{class:"mr1",md:"",color:"amber"},{default:t(()=>[e("mdi mdi-emoticon-excited-outline")]),_:1}),H]),"item-content.item2":t(({item:s})=>[z,n("p",null,[e("You also have access to the item's data if you need:"),n("code",O,l(s),1)])]),"item-title.item3":t(()=>[W,i(p,{class:"ml1",md:"",color:"pink"},{default:t(()=>[e("mdi mdi-emoticon-kiss-outline")]),_:1})]),"item-content.item3":t(()=>[K,i(h,{class:"mt1","bg-color":"primary",route:"https://github.com/antoniandre/wave-ui"},{default:t(()=>[e("Github"),i(p,{class:"ml2",sm:""},{default:t(()=>[e("mdi mdi-open-in-new")]),_:1})]),_:1})]),_:1},8,["items"])]),_:1}),i(m,{h2:""},{default:t(()=>[e("Toggle icon options")]),_:1}),i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`.title4 1 custom icon (only expand)
