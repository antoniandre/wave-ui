import{r,o as g,g as v,a as e,w as i,b as t,d as n,t as s,f as E,l as N,v as T,m as V,_,N as b,S as C}from"./index-CjrszJjX.js";const B=n("div",{class:"title3 my6"},"You have the choice to use one or the other, or both.",-1),H=n("p",null,[t("The built-in notification manager can be used via "),n("code",null,"this.$waveui.notify()"),t(" from any component.")],-1),U=n("div",{class:"title3"},"Pros",-1),x=n("div",{class:"title3 mt4"},"Cons",-1),D=n("strong",{class:"code mx1"},"w-notification",-1),j=n("p",null,"The notify method takes up to 3 parameters, here is the syntax:",-1),z=n("p",null,[t("The default type is "),n("code",null,"info"),t(" and the default timeout is "),n("code",null,"4000"),t("."),n("br"),t(`
...
notification from the template using this code for instance:`)],-1),Y=n("p",null,[n("code",null,s("{{ $waveui.notify('test') }}"))],-1),R=n("p",{class:"mt4"},`Indeed, if you write the above expression directly in a component's template without condition
...
`,-1),L=n("p",null,`The global configuration allows you to override the default side and transition of the
notification manager.`,-1),q=n("p",null,[t("Change the value of the "),n("strong",{class:"code"},"align"),t(" option, in the above global config, to "),n("code",null,"left"),t(`
or `),n("code",null,"right"),t(".")],-1),G=n("p",null,[t("The default transition is "),n("code",null,"slide-left"),t(` when the notification manager is on the right and
`),n("code",null,"slide-right"),t(` when it's on the left.
`)],-1),J=n("div",{class:"title4"},"Pick a transition",-1),K={class:"w-flex align-center"},Q={class:"xs6 md4 lg3"},X={class:"ml2"},Z={key:0,class:"ml2"},tt={class:"mt4"},ot=n("strong",{class:"code"},"transition",-1),it={class:"ml1",href:"https://vuejs.org/v2/guide/transitions.html"},nt=n("p",null,[t("By default, the notification manager is 280px-wide and all the notifications will inherit this width."),n("br"),t(`
You can override this via CSS. For instance:`)],-1),et=n("span",{class:"code"},"w-notification",-1),at=n("span",{class:"code"},"w-notification",-1),st=n("span",{class:"code"},"w-alert",-1),lt=n("br",null,null,-1),rt=n("span",{class:"code"},"w-alert",-1),ct=n("p",null,"Notifications have a fixed position by default (positioned relative to the viewport).",-1),dt=n("p",null,"Notifications have no timeout by default. But you can add one to hide the notification by itself after some time.",-1),ft=n("p",null,[t("Setting the timeout to "),n("code",null,"0"),t(" as a number or a string will cancel the timeout and the notification will stay visible.")],-1),ut=n("span",{class:"ml2"},"ms",-1),mt={class:"ml2"},ht=n("div",{class:"title4 mt3"},"Notification position",-1);function pt(o,a,k,S,$,f){const u=r("w-list"),c=r("title-link"),m=r("ssh-pre"),d=r("w-button"),p=r("example"),w=r("alert"),h=r("w-radios"),M=r("w-icon"),y=r("w-notification"),A=r("w-input"),I=r("w-flex"),P=r("w-tabs");return g(),v("div",null,[B,e(P,{class:"mt4",items:2,"content-class":"pl4"},{"item-title.1":i(()=>[t("Notification manager")]),"item-content.1":i(()=>[H,U,e(u,{icon:"wi-check",items:2},{"item.1":i(()=>[t("Very convenient and fast to use")]),"item.2":i(()=>[t("Handles the stacking of simultaneous notifications")]),_:1}),x,e(u,{icon:"wi-minus",items:1},{"item.1":i(()=>[t("Less flexible than "),D,t(` in terms of layout (no slot available)
...
`)]),default:i(()=>[e(d,{onClick:f.notify,"bg-color":"info"},{default:i(()=>[t("Notify custom")]),_:1},8,["onClick"])]),_:1}),e(w,{class:"mt12",warning:""},{default:i(()=>[F,Y,R]),_:1}),e(c,{h2:""},{default:i(()=>[t("Notification manager tweaking")]),_:1}),L,e(m,{language:"js",dark:o.$store.state.darkMode},{default:i(()=>[t(`new WaveUI({
  notificationManager: {
    align: 'right', // Or 'left'.
    transition: 'default' // Sliding from the side by default.
  }
})
`)]),_:1},8,["dark"]),e(c,{h3:""},{default:i(()=>[t("Align to the left or right")]),_:1}),q,e(d,{onClick:f.switchNotificationManagerSide},{default:i(()=>[t("Change side & notify")]),_:1},8,["onClick"]),e(w,{tip:""},{default:i(()=>[t(`After switching side, you can also test the different notifications from the above examples.
`)]),_:1}),e(c,{h3:""},{default:i(()=>[t("Different transitions")]),_:1}),G,J,n("div",K,[n("div",Q,[e(h,{class:"ma1",modelValue:o.notifManagerTransition,"onUpdate:modelValue":a[4]||(a[4]=l=>o.notifManagerTransition=l),items:o.transitionsForManager,onInput:f.switchNotifMgrTransition},{item:i(({item:l})=>[n("code",X,s(l.value||(l.value===!1?"false":"''")),1),l.value?E("",!0):(g(),v("span",Z,"("+s(l.label)+")",1))]),_:1},8,["modelValue","items","onInput"])]),e(d,{class:"ma1",onClick:a[5]||(a[5]=l=>o.$waveui.notify("Test"))},{default:i(()=>[t("Notify")]),_:1})]),n("p",tt,[t("Change the value of the "),ot,t(` option, in the above global config,
to `),n("code",null,s(o.notifManagerTransition?`'${o.notifManagerTransition}'`:o.notifManagerTransition),1),t(".")]),e(w,{tip:""},{default:i(()=>[t("You could even"),n("a",it,[t("create your own transition"),e(M,{class:"ml1",md:""},{default:i(()=>[t("mdi mdi-open-in-new")]),_:1})]),t(".")]),_:1}),e(c,{h3:""},{default:i(()=>[t("Styling")]),_:1}),nt,e(m,{language:"css",dark:o.$store.state.darkMode},{default:i(()=>[t(`.w-notification-manager {width: 100%;max-width: 500px;}
`)]),_:1},8,["dark"])]),"item-title.2":i(()=>[et]),"item-content.2":i(()=>[e(w,{info:""},{default:i(()=>[t("The "),at,t(" component is pretty much a wrapper around the "),st,t(`
component with added functionalities.`),lt,t(`
it accepts all the parameters of the `),rt,t(` component, plus positioning,
transitioning & timeout options.
`)]),_:1}),e(c,{h2:""},{default:i(()=>[t("Notification position")]),_:1}),ct,e(p,{"content-class":"mt2"},{pug:i(()=>[t(`w-button.mr6(
