import{n,K as r}from"./index.601dd7c5.js";import"./vendor.4f8da9ec.js";var i=function(){var t=this,a=t.$createElement,e=t._self._c||a;return e("div",[e("title-link",{attrs:{h2:""}},[t._v("Default tag & outline")]),e("example",{attrs:{"content-class":"w-flex align-center"},scopedSlots:t._u([{key:"html",fn:function(){return[t._v(`<w-tag class="mr4">tag</w-tag>
...
`)]},proxy:!0}])},[e("w-tag",{attrs:{color:t.tagOn1?"primary":"grey",lg:"",round:"",outline:"",width:"5.5em"},model:{value:t.tagOn1,callback:function(o){t.tagOn1=o},expression:"tagOn1"}},[t.tagOn1?e("w-icon",{staticClass:"ml-1 mr1"},[t._v("wi-check")]):t._e(),t._v(t._s(t.tagOn1?"active":"inactive"))],1),e("span",{staticClass:"ml4"},[t._v("Value:"),e("code",{staticClass:"ml1"},[t._v(t._s(t.tagOn1))])])],1),e("h3",[t._v("Closable tag")]),e("example",{attrs:{"content-class":"w-flex align-center"},scopedSlots:t._u([{key:"html",fn:function(){return[t._v(`<w-tag
  ...
  tagOn: true
})`)]},proxy:!0}])},[e("w-tag",{attrs:{closable:"",lg:"",outline:t.tagOn2,color:"primary",width:145},model:{value:t.tagOn2,callback:function(o){t.tagOn2=o},expression:"tagOn2"}},[t._v("v-model & close")])],1)],1)},d=[function(){var t=this,a=t.$createElement,e=t._self._c||a;return e("p",[t._v("Like in most components, you can set a "),e("code",[t._v("color")]),t._v(" for the text and a "),e("code",[t._v("bg-color")]),t._v(` for the
