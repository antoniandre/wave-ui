import{A as e,G as t,M as n,P as r,c as i,d as a,g as o,h as s,l as c,m as l,r as u,u as d,vt as f,xt as p}from"./runtime-core.esm-bundler-CLfruy3s.js";import{t as m}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{Q as h,s as g}from"./index-I7dyuwKt.js";import{t as _}from"./chunk-NAVWDHVN-BVtaLd4J.js";var v={class:`w-flex justify-end`},y={class:`w-flex align-center mb2`},b={class:`w-flex wrap mb3`},x={class:`w-flex align-center gap2 pa1`},S={class:`w-flex gap2 no-grow`},C={class:`mb0`},w={class:`mt4`},T={class:`ml2`},E={key:0},D={class:`grey mr2`},O=[`onClick`],k=[`onClick`],A=[`colspan`],j={class:`title3`},M={class:`mr2`};function N(m,g,_,N,P,F){let I=r(`title-link`),L=r(`w-table`),R=r(`example`),z=r(`w-button`),B=r(`w-icon`),V=r(`w-flex`),H=r(`ssh-pre`),U=r(`w-tag`),W=r(`w-radios`),G=r(`alert`),K=r(`w-input`);return e(),a(`div`,null,[o(I,{h2:``},{default:t(()=>[...g[12]||=[s(`Basic`,-1)]]),_:1}),g[180]||=i(`p`,null,[s(`Providing an array of items will automatically create a table row for each item.`),i(`br`),s(`
...
`)],-1),i(`div`,v,[o(z,{onClick:g[0]||=e=>P.table3.fixedFooter=!P.table3.fixedFooter,outline:!P.table3.fixedFooter,round:``},{default:t(()=>[i(`span`,{class:f([`code`,P.table3.fixedFooter?`contrast-color`:`primary`])},`fixed-footer`,2)]),_:1},8,[`outline`])]),o(R,null,{pug:t(()=>[...g[39]||=[s(`w-table(
  ref="table"
  :headers="table.headers"
  :items="table.items"
  ...
  template(#footer)
    w-flex(justify-space-between)
      ...
      div
        strong.mr2 Total:
        | `+p(`{{ table.items.length }}`)+` persons`,-1)]]),html:t(()=>[...g[40]||=[s(`<w-table
  ref="table"
  :headers="table.headers"
  :items="table.items"
  :fixed-footer="table.fixedFooter"
  ...
  template(#footer-row)
    tr
      th.py1(
        ...
        | `+p(`{{ header.label }}`),-1)]]),html:t(()=>[...g[44]||=[s(`<w-table
  :headers="table.headers"
  no-headers
  :items="table.items"
  fixed-footer
...
code as it is a frequent use case.`,-1),o(R,null,{pug:t(()=>[s(`w-tag.ma1(
  ...
  :key="index"
  :bg-color="header.hidden ? `+p(m.$store.state.darkMode?`grey-dark4`:`grey-light4`)+` : 'primary'"
...
`,-1)]]),default:t(()=>[g[58]||=s(`Toggle columns:`,-1),(e(!0),a(u,null,n(P.table6.headers,(n,r)=>(e(),c(U,{class:`ma1`,key:r,"bg-color":n.hidden?m.$store.state.darkMode?`grey-dark4`:`grey-light4`:`primary`,onClick:h(e=>n.hidden=!n.hidden,[`stop`])},{default:t(()=>[o(B,{class:`mr2`},{default:t(()=>[s(`mdi mdi-eye`+p(n.hidden?`-off`:``),1)]),_:2},1024),s(p(n.label),1)]),_:2},1032,[`bg-color`,`onClick`]))),128)),o(L,{class:`mt2`,headers:P.table6.headers.filter(e=>!e.hidden),items:P.table6.items},null,8,[`headers`,`items`])]),_:1}),o(I,{h2:``},{default:t(()=>[...g[59]||=[s(`Sticky columns`,-1)]]),_:1}),g[190]||=i(`p`,null,[s(`To make a column sticky, you only need to add `),i(`code`,null,`sticky: true`),s(` to the header of that
column.`),i(`br`),s(`
...
`,-1)]]),default:t(()=>[i(`div`,y,[g[60]||=s(`Sticky columns:`,-1),o(W,{class:`ml1 mr4`,modelValue:P.table9.stickyColumn,"onUpdate:modelValue":g[1]||=e=>P.table9.stickyColumn=e,items:P.table9.stickyColumnOptions,onChange:F.toggleStickyColumn,inline:``},null,8,[`modelValue`,`items`,`onChange`]),o(z,{onClick:g[2]||=e=>P.table9.fixedHeaders=!P.table9.fixedHeaders,outline:!P.table9.fixedHeaders,round:``},{default:t(()=>[i(`span`,{class:f([`code`,P.table9.fixedHeaders?`contrast-color`:`primary`])},`fixed-headers`,2)]),_:1},8,[`outline`])]),o(L,{class:`base-color--bg`,headers:P.table9.headers,items:P.table9.items,"fixed-layout":``,"fixed-headers":P.table9.fixedHeaders,style:{"max-width":`500px`,height:`200px`}},null,8,[`headers`,`items`,`fixed-headers`])]),_:1}),o(I,{h2:``},{default:t(()=>[...g[65]||=[s(`Sorting`,-1)]]),_:1}),g[192]||=i(`p`,null,[s(`To make the sorting API very easy to use and remember (and avoid complex array or object structures),
...
}`,-1)]]),_:1}),g[198]||=l(`<p>More details in the <a href="#pagination-prop">API section</a>.</p><p>The pagination is a two-way binding object: if you modify any property inside it, the table
    ...
    .w-flex.align-center.gap2.pa1
      .w-flex.gap2.no-grow
        ...
        w-button(
          ...
          xs)
      p `+p(`{{ range }}`)+` of `+p(`{{ total }}`)+`.`,-1)]]),html:t(()=>[...g[127]||=[s(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
...
app.mount('#app')
`,-1)]]),default:t(()=>[o(L,{headers:P.table11.headers,items:P.table11.items,"fixed-headers":``,"fixed-footer":``,pagination:P.table11.pagination,style:{"max-height":`500px`}},{pagination:t(({range:r,total:l,page:d,pagesCount:f,goToPage:m})=>[i(`div`,x,[i(`div`,S,[o(z,{onClick:e=>m(`-1`),disabled:d===1,icon:`wi-chevron-left`,xs:``},null,8,[`onClick`,`disabled`]),(e(!0),a(u,null,n(f,n=>(e(),c(z,{key:n,onClick:e=>n!==d&&m(n),outline:d===n,round:``,xs:``},{default:t(()=>[s(p(n),1)]),_:2},1032,[`onClick`,`outline`]))),128)),o(z,{onClick:e=>m(`+1`),disabled:d===f,icon:`wi-chevron-right`,xs:``},null,8,[`onClick`,`disabled`])]),i(`p`,C,p(r)+` of `+p(l)+`.`,1)])]),_:1},8,[`headers`,`items`,`pagination`])]),_:1}),o(I,{h3:``},{default:t(()=>[...g[129]||=[s(`Initing the pagination with a certain state`,-1)]]),_:1}),o(R,{"blank-codepen":[`js`]},{pug:t(()=>[...g[130]||=[s(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
...
one remain selected.
`)],-1),o(I,{h3:``,slug:`example--row-select`},{default:t(()=>[...g[136]||=[s(`The `,-1),i(`span`,{class:`code`},`@row-select`,-1),s(` event`,-1)]]),_:1}),g[205]||=l(`<p>This event is fired each time a row is selected <strong>or unselected</strong> (so you don&#39;t need to listen
...
pre `+p(`{{ selectionInfo }}`),-1)]]),html:t(()=>[...g[140]||=[s(`<w-flex wrap class="mb4">
  <w-radios
...
<pre>`+p(`{{ selectionInfo }}`)+`</pre>`,-1)]]),js:t(()=>[...g[141]||=[s(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
.mt4
  | Selected rows:
  code.ml2 `+p(`{{ table.selectedRows }}`),-1)]]),html:t(()=>[...g[147]||=[s(`<w-table
  :headers="table.headers"
  :items="table.items"
  selectable-rows
  v-model:selected-rows="table.selectedRows">
...
`,-1)]]),_:1}),o(I,{h2:``,slug:`example--expandable-rows`},{default:t(()=>[...g[150]||=[s(`Expandable rows`,-1)]]),_:1}),o(G,{warning:``},{default:t(()=>[...g[151]||=[s(`This feature is in progress.`,-1)]]),_:1}),o(R,null,{pug:t(()=>[...g[154]||=[s(`w-table(:headers="table.headers" :items="table.items" expandable-rows)
  template(#row-expansion="{ item }")
    ...
    | `+p(`{{ item.firstName }}`)+` weighs `,-1),i(`strong`,null,p(`{{ item.weight }}`)+`kg`,-1),s(` and is `,-1),i(`strong`,null,p(`{{ item.height }}`)+`m`,-1),s(` tall.`,-1)]]),html:t(()=>[...g[155]||=[s(`<w-table
  :headers="table.headers"
  :items="table.items"
  expandable-rows>
  <template #row-expansion="{ item }">
    ...
    `+p(`{{ item.firstName }}`)+` weighs `,-1),i(`strong`,null,p(`{{ item.weight }}`)+`kg`,-1),s(` and is `,-1),i(`strong`,null,p(`{{ item.height }}`)+`m`,-1),s(` tall.
  </template>
...
`,-1)]]),default:t(()=>[o(L,{headers:P.table1.headers,items:P.table1.items},{"header-label":t(({label:e,index:t})=>[s(p(t)+`: `+p(e)+` 👌`,1)]),_:1},8,[`headers`,`items`])]),_:1}),o(I,{h3:``,slug:`item-cells`},{default:t(()=>[...g[162]||=[s(`Item cells (inside <td> element)`,-1)]]),_:1}),g[209]||=i(`p`,null,[s(`In this example, only the items cells are customized via the `),i(`code`,null,`item`),s(` slot
(and the headers are hidden).`)],-1),o(R,null,{pug:t(()=>[...g[163]||=[s(`w-table(:headers="table.headers" no-headers :items="table.items")
  template(#item-cell="{ item, label, header, index }")
    ...
    span `+p(`{{ label }}`),-1)]]),html:t(()=>[...g[164]||=[s(`<w-table
  :headers="table.headers"
  no-headers
  :items="table.items">
  <template #item-cell="{ item, label, header, index }">
...
`,-1)]]),default:t(()=>[o(L,{headers:P.table1.headers,"no-headers":``,items:P.table1.items},{"item-cell":t(({item:t,label:n,header:r,index:o})=>[r.key===`id`?(e(),a(`small`,E,`#`+p(o),1)):(e(),a(u,{key:1},[i(`small`,D,p(r.label)+`:`,1),i(`span`,null,p(n),1)],64))]),_:1},8,[`headers`,`items`])]),_:1}),o(I,{h3:``,slug:`override-1-particular-item-cell`},{default:t(()=>[...g[166]||=[s(`override 1 particular item cell or column cells (inside <td> element)`,-1)]]),_:1}),g[210]||=l(`<p>If you only need to override 1 particular column you can do it via the <code>item-cell.xxx</code> slot,
...
where <code>i</code> is a an integer starting at 1.</p>`,1),o(R,null,{pug:t(()=>[s(`w-table(:headers="table.headers" :items="table.items" no-headers)
  template(#item-cell.id="{ item, label, header, index }")
    div.px2.text-center.`+p(m.$store.state.darkMode?`green-dark5--bg`:`green-light5--bg`)+`.text-bold `+p(`{{ label }}`),1)]),html:t(()=>[s(`<w-table
  :headers="table.headers"
  :items="table.items"
  no-headers>
  <template #item-cell.id="{ item, label, header, index }">
    <div class="px2 text-center `+p(m.$store.state.darkMode?`green-dark5--bg`:`green-light5--bg`)+` text-bold">
      `+p(`{{ label }}`)+`
    </div>
  </template>
  ...
  template(#item="{ item, index, select, classes }")
    tr(:class="classes" @click="select")
      td(
        ...
        | `+p(`{{ item[header.key] || '' }}`),-1)]]),html:t(()=>[...g[170]||=[s(`<w-table
  :headers="table.headers"
  :items="table.items"
  selectable-rows>
  <template #item="{ item, index, select, classes }">
...
`,-1)]]),default:t(()=>[o(L,{headers:P.table1.headers,items:P.table1.items,"selectable-rows":``},{item:t(({item:t,index:r,select:o,classes:s})=>[i(`tr`,{class:f(s),onClick:o},[(e(!0),a(u,null,n(P.table1.headers,(n,r)=>(e(),a(`td`,{key:r,class:f(`pa4 text-${n.align||`left`}`)},p(t[n.key]||``),3))),128))],10,O)]),_:1},8,[`headers`,`items`])]),_:1}),o(I,{h3:``,slug:`colspan-on-td`},{default:t(()=>[...g[172]||=[i(`span`,{class:`code`},`colspan`,-1),s(` on <td>`,-1)]]),_:1}),g[212]||=i(`p`,null,[s(`This example is showcasing another useful case: handling a colspan attribute.`),i(`br`),s(`
All the cells of all the rows are `),i(`code`,null,`colspan`),s(`'d to one, and a custom row layout is applied.`)],-1),o(R,null,{pug:t(()=>[s(`w-table(
  ...
  template(#item="{ item, index, select, classes }")
    tr(
      :class="{ ...classes, 'indigo-`+p(m.$store.state.darkMode?`dark`:`light`)+`5--bg': index % 2, 'blue-`+p(m.$store.state.darkMode?`dark`:`light`)+`5--bg': !(index % 2) }"
      @click="select")
      td.pa2(:colspan="table.headers.length")
        ...
        ul
          li(v-for="(header, i) in table.headers" :key="i")
            ...
            | `+p(`{{ item[header.key] || '' }}`),1)]),html:t(()=>[s(`<w-table
  :headers="table.headers"
  :items="table.items"
  no-headers
  selectable-rows>
  <template #item="{ item, index, select, classes }">
    <tr
      :class="{
        ...classes,
        'indigo-`+p(m.$store.state.darkMode?`dark`:`light`)+`5--bg': index % 2,
        'blue-`+p(m.$store.state.darkMode?`dark`:`light`)+`5--bg': !(index % 2)
      }"
      @click="select">
...
`,-1)]]),default:t(()=>[o(L,{headers:P.table1.headers,items:P.table1.items,"no-headers":``,"selectable-rows":``},{item:t(({item:t,index:r,select:o,classes:c})=>[i(`tr`,{class:f({...c,[`indigo-${m.$store.state.darkMode?`dark`:`light`}5--bg`]:r%2,[`blue-${m.$store.state.darkMode?`dark`:`light`}5--bg`]:!(r%2)}),onClick:o},[i(`td`,{class:`pa2`,colspan:P.table1.headers.length},[i(`div`,j,`Row #`+p(r),1),i(`ul`,null,[(e(!0),a(u,null,n(P.table1.headers,(n,r)=>(e(),a(`li`,{key:r},[i(`strong`,M,p(n.label)+`:`,1),s(p(t[n.key]||``),1)]))),128))])],8,A)],10,k)]),_:1},8,[`headers`,`items`])]),_:1}),o(I,{h2:``},{default:t(()=>[...g[174]||=[s(`Responsiveness & mobile layout`,-1)]]),_:1}),g[213]||=i(`p`,null,[s(`In addition to the full responsiveness, the `),i(`code`,null,`w-table`),s(` can be presented in a mobile friendly layout,
