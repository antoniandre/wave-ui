...
`)],-1)])),_:1,__:[0]}),o(l,{h2:""},{default:n(()=>e[1]||(e[1]=[s("Default",-1)])),_:1,__:[1]}),e[9]||(e[9]=g(`<p>In this example we can look for a chemical element in the list and select it.</p><p>One obvious advantage of the Wave UI autocomplete is the fact that you can provide a different
...
app.use(WaveUI)
app.mount('#app')
`,-1)])),default:n(()=>[o(c,{class:"mb12",items:t.chemicalElement},null,8,["items"])]),_:1}),o(l,{h2:""},{default:n(()=>e[5]||(e[5]=[s("Placeholder",-1)])),_:1,__:[5]}),o(b,{"content-class":"py12","blank-codepen":["js"]},{pug:n(()=>e[6]||(e[6]=[s('w-autocomplete.mb12(:items="chemicalElement" placeholder="select an element")',-1)])),html:n(()=>e[7]||(e[7]=[s(`<w-autocomplete
  :items="chemicalElement"
  placeholder="select an element"
  class="mb12">
</w-autocomplete>`,-1)])),js:n(()=>e[8]||(e[8]=[s(`import { faker } from '@faker-js/faker'
