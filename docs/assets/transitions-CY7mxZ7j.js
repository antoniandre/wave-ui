import{r as s,g as r,o as d,a as o,h as S,b as a,w as t,e as i,p as y,v as k,t as l,d as p,c as $,_ as D}from"./index-BYWTcKdY.js";const R={class:"w-flex"},V={key:0,class:"transition-box"},H={key:0,class:"transition-box"},N={key:0,class:"transition-box"},j={key:0,class:"transition-box"},A={key:0,class:"transition-box"},I={key:0,class:"transition-box text-nowrap"},L={key:0,class:"transition-box"},M={key:0,class:"transition-box text-nowrap"},P={key:0,class:"transition-box text-nowrap"},U={key:0,class:"transition-box text-nowrap"},W={key:0,class:"transition-box pa6 ma10 yellow-light5--bg",style:{width:"auto"}},J={style:{height:"90px",overflow:"hidden",padding:"4px"}},q={class:"ml1",href:"https://github.com/vuejs/core/issues/994"};function z(e,n,K,O,Q,Z){const f=s("title-link"),b=s("ssh-pre"),m=s("alert"),g=s("w-button"),E=s("w-transition-fade"),w=s("w-flex"),F=s("w-transition-scale"),Y=s("w-transition-scale-fade"),X=s("w-transition-bounce"),h=s("w-transition-twist"),x=s("w-transition-expand"),v=s("w-transition-slide-fade"),c=s("example"),C=s("w-card"),T=s("w-transition-slide"),B=s("w-icon");return d(),r("main",null,[o(f,{class:"mt4",h1:""},{default:t(()=>[...n[12]||(n[12]=[i("Transitions",-1)])]),_:1}),n[53]||(n[53]=S('<p>Here is a list of all the available transition components.</p><ul><li><code>w-transition-fade</code></li><li class="mt1"><code>w-transition-scale</code></li><li class="mt1"><code>w-transition-scale-fade</code></li><li class="mt1"><code>w-transition-bounce</code></li><li class="mt1"><code>w-transition-twist</code></li><li class="mt1"><code>w-transition-expand</code></li><li class="mt1"><code>w-transition-slide</code></li><li class="mt1"><code>w-transition-slide-fade</code></li></ul>',2)),o(m,{info:""},{default:t(()=>[n[15]||(n[15]=i(`The transitions (based on
...
work with element toggling using `,-1)),n[18]||(n[18]=a("code",null,"v-if",-1)),n[19]||(n[19]=i(" or ",-1)),n[20]||(n[20]=a("code",null,"v-show",-1)),n[21]||(n[21]=i(".",-1)),n[22]||(n[22]=a("br",null,null,-1)),n[23]||(n[23]=i("Simple example (with ",-1)),n[24]||(n[24]=a("code",null,"show",-1)),n[25]||(n[25]=i(" a boolean variable):",-1)),a("div",R,[y(o(b,{class:"mb0",dark:e.$store.state.darkMode,language:"pug"},{default:t(()=>[...n[13]||(n[13]=[i(`w-transition-fade
  span(v-if="show") Hello!`,-1)])]),_:1},8,["dark"]),[[k,e.$store.state.usePug]]),y(o(b,{class:"mb0",dark:e.$store.state.darkMode,language:"html-vue"},{default:t(()=>[...n[14]||(n[14]=[i(`<w-transition-fade>
  <span v-if="show">Hello!</span>
</w-transition-fade>
`,-1)])]),_:1},8,["dark"]),[[k,!e.$store.state.usePug]])])]),_:1}),o(f,{h2:""},{default:t(()=>[...n[26]||(n[26]=[i("Transitions showcase",-1)])]),_:1}),o(c,null,{pug:t(()=>[...n[27]||(n[27]=[i(`w-flex(align-center)
...
<span class="code">right</span>, <span class="code">up</span>, <span class="code">down</span> and defaults to <span class="code">down</span>.</p>`,1)),o(f,{h2:"",slug:"the-expand-transition"},{default:t(()=>[...n[31]||(n[31]=[i("The ",-1),a("span",{class:"code"},"expand",-1),i(" transition",-1)])]),_:1}),n[55]||(n[55]=a("p",null,`The great thing with Wave UI's expand transition is that it also animates any margin or padding on the
...
`,-1)])]),_:1}),o(f,{h2:"",slug:"the-slide-transition"},{default:t(()=>[...n[36]||(n[36]=[i("The ",-1),a("span",{class:"code"},"slide",-1),i(" transition",-1)])]),_:1}),n[56]||(n[56]=a("p",null,[i(`The slide transition is only designed for elements sliding from outside the view into the view or
...
`,-1)])]),default:t(()=>[a("div",J,[o(g,{class:"mb2",onClick:n[11]||(n[11]=u=>e.showCard=!e.showCard)},{default:t(()=>[i(l(e.showCard?"Hide":"Show")+" Card",1)]),_:1}),o(T,{left:""},{default:t(()=>[e.showCard?(d(),$(C,{key:0,class:"primary-light3--bg white sliding-card"},{default:t(()=>[...n[37]||(n[37]=[a("div",{class:"title3 mb0"},"A sliding card.",-1)])]),_:1})):p("",!0)]),_:1})])]),_:1}),o(f,{h2:""},{default:t(()=>[...n[41]||(n[41]=[i("Transition duration",-1)])]),_:1}),n[57]||(n[57]=a("p",null,[i(`You can easily override the default transition/animation duration by setting an explicit
