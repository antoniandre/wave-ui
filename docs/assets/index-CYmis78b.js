import{r as m,g as p,o as c,a as e,b as o,w as l,e as t,t as d,_ as b,a1 as y,G as h}from"./index-Tdht9LZF.js";const x={class:"mt2"},k={class:"mt2"};function V(a,n,v,w,f,u){const s=m("title-link"),r=m("w-rating"),i=m("example");return c(),p("div",null,[e(s,{h2:""},{default:l(()=>n[2]||(n[2]=[t("Default")])),_:1}),e(i,null,{pug:l(()=>n[3]||(n[3]=[t("w-rating")])),html:l(()=>n[4]||(n[4]=[t(`<w-rating></w-rating>
