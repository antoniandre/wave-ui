var D=Object.defineProperty;var T=Object.getOwnPropertySymbols;var O=Object.prototype.hasOwnProperty,V=Object.prototype.propertyIsEnumerable;var S=(s,a,d)=>a in s?D(s,a,{enumerable:!0,configurable:!0,writable:!0,value:d}):s[a]=d,v=(s,a)=>{for(var d in a||(a={}))O.call(a,d)&&S(s,d,a[d]);if(T)for(var d of T(a))V.call(a,d)&&S(s,d,a[d]);return s};import{r,o as b,e as _,f as l,w as t,g as n,t as u,i as e,F as P,z as E,c as L}from"./vendor.e64646cc.js";import{_ as y,B as M,F as $}from"./index.f3654a4f.js";const R=e("The "),U=n("span",{class:"code"},"w-select",-1),B=e(` component can be placed in a hidden overflow container and the dropdown
menu will still be fully visible when open.`),C=n("br",null,null,-1),F=e(`
This is because the select dropdown menu is placed at the `),W=n("span",{class:"code"},".w-app",-1),x=e(` level in the DOM,
just so you don't have to worry about this annoying case.
`),q=e("Basic"),N=n("p",null,[e("This is the most basic use of the "),n("span",{class:"code"},"w-select"),e(" component. No label, no v-model, only items.")],-1),H=e('<w-select :items="items"></w-select>'),K=e(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`),Q=e(`The items of the select list should have a label, which is by default expected in each item
object under the `),X=n("code",null,"label",-1),Z=e(" name."),ee=n("br",null,null,-1),te=e(`
...
`),Ve=e("Tile & round"),Pe=n("div",{class:"title4"},"Default style (Underline)",-1),Ee=e("Tile"),$e=e("Round"),Re=n("div",{class:"title4 mt6"},"Outline style",-1),Ue=e("Tile"),Be=e("Round"),Ce=e(`<div class="title4">
  Default style (Underline)
</div>
...
`),We=e("Multiple selection"),xe=e('<w-select :items="items" multiple></w-select>'),qe=e(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`),Ne=e("V-model"),He=e("By default, the "),Ke=n("span",{class:"code"},"w-select",-1),ze=e(" component expects the items to have a "),Ye=n("code",null,"model-value",-1),Ge=e(" attribute."),Je=n("br",null,null,-1),Qe=e(`
If this is a constraint, you can use the option `),Xe=n("code",null,"item-value-key",-1),Ze=e(` to specify the name of another
...
`),Vt=e("Custom selection string"),Pt=n("p",null,[e("The selection string is customizable through the "),n("code",null,"selection"),e(" slot."),n("br"),e(`
...
`),$t=e("Custom list items"),Rt=e("wi-check"),Ut={key:1,class:"px2"},Bt={class:"ml1"},Ct=e(`data: () => ({
  items: [
    { label: 'Item 1', value: 1 },
    { label: 'Item 2', value: 2 },
    { label: 'Item 3', value: 3 }
...
`),Ft=e("Inner icons"),Wt=n("div",{class:"title4 mb2"},"Label outside",-1),xt=n("div",{class:"title4 mt6 mb2"},"Label inside",-1),qt=e(`<div class="title4 mb2">
  Label outside
</div>
...
`),Ht=e("Disabled & readonly"),Kt=e(`<w-select
  class="mb4"
  :items="items"
...
})`);function Yt(s,a,d,I,k,f){const h=r("alert"),i=r("title-link"),o=r("w-select"),c=r("example"),w=r("w-flex"),p=r("w-icon"),j=r("w-tag");return b(),_("div",null,[l(h,{info:""},{default:t(()=>[R,U,B,C,F,W,x]),_:1}),l(i,{h2:""},{default:t(()=>[q]),_:1}),N,l(c,null,{html:t(()=>[H]),js:t(()=>[K]),default:t(()=>[l(o,{items:s.items1},null,8,["items"])]),_:1}),l(i,{h2:""},{default:t(()=>[z]),_:1}),Y,l(c,null,{html:t(()=>[G]),js:t(()=>[J]),default:t(()=>[l(o,{items:s.items1,label:"Label"},null,8,["items"]),l(o,{class:"mt4",items:s.items1,placeholder:"Placeholder"},null,8,["items"]),l(o,{class:"mt4",items:s.items1,label:"Label",placeholder:"Placeholder"},null,8,["items"])]),_:1}),l(h,{tip:""},{default:t(()=>[Q,X,Z,ee,te,le,se]),_:1}),l(i,{h2:""},{default:t(()=>[ne]),_:1}),l(c,null,{html:t(()=>[ie]),js:t(()=>[ae]),default:t(()=>[l(o,{items:s.items1,outline:""},{default:t(()=>[oe]),_:1},8,["items"])]),_:1}),l(i,{h2:""},{default:t(()=>[ce]),_:1}),de,l(i,{h3:"",slug:"default-style"},{default:t(()=>[me]),_:1}),l(c,null,{html:t(()=>[he]),js:t(()=>[be]),default:t(()=>[l(o,{items:s.items1,color:"blue"},{default:t(()=>[re]),_:1},8,["items"]),l(o,{class:"mt4",items:s.items1,"bg-color":"blue-light5",color:"blue-dark3"},{default:t(()=>[ue]),_:1},8,["items"])]),_:1}),l(i,{h3:""},{default:t(()=>[pe]),_:1}),l(c,null,{html:t(()=>[we]),js:t(()=>[ge]),default:t(()=>[l(o,{items:s.items1,outline:"",color:"blue"},{default:t(()=>[_e]),_:1},8,["items"]),l(o,{class:"mt4",items:s.items1,outline:"","bg-color":"blue-light5",color:"blue-dark3"},{default:t(()=>[fe]),_:1},8,["items"])]),_:1}),l(i,{h3:""},{default:t(()=>[ve]),_:1}),ye,l(c,null,{html:t(()=>[ke]),js:t(()=>[je]),default:t(()=>[l(o,{items:s.items4},{default:t(()=>[Ie]),_:1},8,["items"])]),_:1}),l(i,{h2:""},{default:t(()=>[Te]),_:1}),l(c,null,{html:t(()=>[De]),js:t(()=>[Oe]),default:t(()=>[Se,l(o,{items:s.items1,shadow:""},{default:t(()=>[Le]),_:1},8,["items"]),Me,l(o,{items:s.items1,outline:"",shadow:""},{default:t(()=>[Ae]),_:1},8,["items"])]),_:1}),l(i,{h2:""},{default:t(()=>[Ve]),_:1}),l(c,null,{html:t(()=>[Ce]),js:t(()=>[Fe]),default:t(()=>[Pe,l(o,{items:s.items1,"bg-color":"purple-light5",tile:""},{default:t(()=>[Ee]),_:1},8,["items"]),l(o,{class:"mt4",items:s.items1,"bg-color":"purple-light5",round:""},{default:t(()=>[$e]),_:1},8,["items"]),Re,l(o,{items:s.items1,outline:"",tile:""},{default:t(()=>[Ue]),_:1},8,["items"]),l(o,{class:"mt4",items:s.items1,outline:"",round:""},{default:t(()=>[Be]),_:1},8,["items"])]),_:1}),l(i,{h2:""},{default:t(()=>[We]),_:1}),l(c,null,{html:t(()=>[xe]),js:t(()=>[qe]),default:t(()=>[l(o,{items:s.items1,multiple:""},null,8,["items"])]),_:1}),l(i,{h2:""},{default:t(()=>[Ne]),_:1}),l(h,{tip:""},{default:t(()=>[He,Ke,ze,Ye,Ge,Je,Qe,Xe,Ze]),_:1}),l(c,null,{html:t(()=>[lt]),js:t(()=>[st]),default:t(()=>[l(o,{modelValue:s.vModelSelect1,"onUpdate:modelValue":a[0]||(a[0]=m=>s.vModelSelect1=m),items:s.items3,multiple:""},null,8,["modelValue","items"]),l(w,{class:"align-center mt4"},{default:t(()=>[et,n("code",tt,u(s.vModelSelect1),1)]),_:1})]),_:1}),l(i,{h3:""},{default:t(()=>[nt]),_:1}),ot,l(c,null,{html:t(()=>[ct]),js:t(()=>[dt]),default:t(()=>[l(o,{modelValue:s.vModelSelect2,"onUpdate:modelValue":a[1]||(a[1]=m=>s.vModelSelect2=m),items:s.items1,multiple:""},null,8,["modelValue","items"]),l(w,{class:"align-center mt4"},{default:t(()=>[it,n("code",at,u(s.vModelSelect2),1)]),_:1})]),_:1}),l(i,{h3:""},{default:t(()=>[mt]),_:1}),rt,ut,l(c,null,{html:t(()=>[pt]),js:t(()=>[_t]),default:t(()=>[l(o,{modelValue:s.vModelSelect3,"onUpdate:modelValue":a[2]||(a[2]=m=>s.vModelSelect3=m),items:s.items1,multiple:"","return-object":""},null,8,["modelValue","items"]),l(w,{class:"align-center mt4"},{default:t(()=>[ht,n("code",bt,u(s.vModelSelect3),1)]),_:1})]),_:1}),l(i,{h2:""},{default:t(()=>[ft]),_:1}),wt,l(c,null,{html:t(()=>[gt]),js:t(()=>[vt]),default:t(()=>[l(o,{items:s.items1,label:"Select an item"},null,8,["items"]),l(o,{class:"mt4",items:s.items1,label:"Select an item","label-position":"left"},null,8,["items"]),l(o,{class:"mt4",items:s.items1,label:"Select an item","label-position":"right"},null,8,["items"])]),_:1}),l(i,{h2:""},{default:t(()=>[yt]),_:1}),It,l(c,null,{html:t(()=>[Dt]),js:t(()=>[Ot]),default:t(()=>[l(o,{items:s.items1,"label-position":"inside",outline:""},{default:t(()=>[l(p,{class:"orange"},{default:t(()=>[kt]),_:1}),jt,l(p,{class:"orange"},{default:t(()=>[Tt]),_:1})]),_:1},8,["items"]),l(o,{class:"mt4",items:s.items1,"label-position":"left",outline:""},{default:t(()=>[St,l(p,{class:"orange"},{default:t(()=>[Lt]),_:1})]),_:1},8,["items"]),l(o,{class:"mt4",items:s.items1,"label-position":"right",outline:""},{default:t(()=>[l(p,{class:"orange"},{default:t(()=>[Mt]),_:1}),At]),_:1},8,["items"])]),_:1}),l(i,{h2:""},{default:t(()=>[Vt]),_:1}),Pt,l(c,null,{html:t(()=>[e(`<w-select :items="items" v-model="selection" multiple>
...
</w-select>`,1)]),js:t(()=>[Et]),default:t(()=>[l(o,{items:s.items3,modelValue:s.customSelection,"onUpdate:modelValue":a[3]||(a[3]=m=>s.customSelection=m),multiple:""},{selection:t(({item:m})=>[(b(!0),_(P,null,E(m,(g,A)=>(b(),L(j,{class:"mr2",key:A,"bg-color":"grey-light4"},{default:t(()=>[e(u(g.label),1)]),_:2},1024))),128))]),_:1},8,["items","modelValue"])]),_:1}),l(i,{h2:""},{default:t(()=>[$t]),_:1}),l(c,null,{html:t(()=>[e(`<w-select :items="items">
