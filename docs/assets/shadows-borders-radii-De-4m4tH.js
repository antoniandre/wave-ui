import{r as l,g as i,o as b,a as o,b as n,h as k,w as d,e,F as u,k as m,n as x,t as w,_ as Y}from"./index-CrSk8JxI.js";const S={class:"w-flex wrap"},C={class:"code"},$={class:"w-flex wrap"},I={class:"code"},U={class:"w-flex wrap"},B={class:"code"};function N(f,s,T,V,A,q){const a=l("title-link"),c=l("alert"),r=l("example"),g=l("w-divider"),v=l("w-image"),p=l("w-flex"),y=l("w-switch"),j=l("w-card"),h=l("w-accordion-item"),_=l("w-accordion");return b(),i("main",null,[o(a,{class:"mt4",h1:""},{default:d(()=>s[0]||(s[0]=[e("shadows, borders & border radii")])),_:1,__:[0]}),s[31]||(s[31]=n("p",null,[e("Wave UI offers a few CSS helper classes to control the drop shadow, borders and border radii."),n("br"),e(`
...
`)])),_:1,__:[1]}),o(a,{h2:""},{default:d(()=>s[2]||(s[2]=[e("Shadows")])),_:1,__:[2]}),s[32]||(s[32]=n("p",null,[e("Element shadows range from "),n("code",null,"-6"),e(" to "),n("code",null,"6"),e(`. Negative values will produce an inset shadow,
...
</w-flex>`)])),css:d(()=>s[9]||(s[9]=[e(".box {\n  width: 80px;\n  height: 80px;\n  margin: 4px; /* You could use the class `ma1`. */\n  background-color: #e3f2fd; /* You could use the class `blue-light5--bg`. */\n  display: flex; /* You could use the class `d-flex`. */\n  align-items: center; /* You could use the class `align-center`. */\n  justify-content: center; /* You could use the class `justify-center`. */\n}\n")])),default:d(()=>[n("div",$,[(b(),i(u,null,m(7,t=>n("div",{class:x(["box blue-light5--bg ma4 d-flex align-center justify-center",`bd${t-1}`]),key:t},[n("span",I,".bd"+w(t-1),1)],2)),64))])]),_:1}),o(a,{h2:""},{default:d(()=>s[10]||(s[10]=[e("Border radii")])),_:1,__:[10]}),s[34]||(s[34]=k(`<p>The border radii range from <code>0</code> to <code>6</code>, and are incremented by the <code>$base-increment</code>
...
</w-flex>`)])),css:d(()=>s[16]||(s[16]=[e(".box {\n  width: 80px;\n  height: 80px;\n  margin: 4px; /* You could use the class `ma1`. */\n  background-color: #e3f2fd; /* You could use the class `blue-light5--bg`. */\n  display: flex; /* You could use the class `d-flex`. */\n  align-items: center; /* You could use the class `align-center`. */\n  justify-content: center; /* You could use the class `justify-center`. */\n}\n")])),default:d(()=>[n("div",U,[(b(),i(u,null,m(7,t=>n("div",{class:x(["box blue-light5--bg ma4 d-flex align-center justify-center",`bdrs${t-1}`]),key:t},[n("span",B,".bdrs"+w(t-1),1)],2)),64)),s[12]||(s[12]=n("div",{class:"box blue-light5--bg ma4 d-flex align-center justify-center bdrsr"},[n("span",{class:"code"},".bdrsr")],-1)),s[13]||(s[13]=n("div",{class:"box blue-light5--bg ma4 d-flex align-center justify-center bdrsm"},[n("span",{class:"code"},".bdrsm")],-1))])]),_:1}),o(g,{class:"my12"}),o(a,{h2:""},{default:d(()=>s[17]||(s[17]=[e("Examples of use on UI components")])),_:1,__:[17]}),s[35]||(s[35]=n("p",null,"Below are a few examples of components which accept the presented classes.",-1)),o(r,null,{pug:d(()=>s[20]||(s[20]=[e('w-flex(align-center justify-space-around wrap)\n  w-flex.no-grow(column align-center justify-center)\n    w-image.bd1.sh1.bdrsr.d-block(\n      :src="`${baseUrl}images/japanese-wave.png`"\n      :width="100"\n      :height="100")\n    span.mt3 w-image with `.bd1`, `.bdrsr` and `.sh1` classes.\n  w-switch.bdrs1.my4(:model-value="true") a w-switch with a `.bdrs1` class.')])),html:d(()=>s[21]||(s[21]=[e(`<w-flex align-center justify-space-around wrap>
...
`)])),default:d(()=>[o(j,{class:"bdrs4 bd0 sh2","bg-color":"orange-light5"},{default:d(()=>s[23]||(s[23]=[n("div",{class:"caption"},[e("a "),n("strong",{class:"code mx1"},"w-card"),e(" with "),n("code",{class:"mx1"},".bd0"),e(", "),n("code",{class:"mx1"},".bdrs4"),e(" and "),n("code",{class:"mx1"},".sh2"),e(" classes.")],-1)])),_:1,__:[23]}),o(_,{class:"mt8 bdrs2 bd1"},{default:d(()=>[o(h,null,{title:d(()=>s[24]||(s[24]=[n("div",{class:"title5 mb0"},[e("Accordion with "),n("code",{class:"mx1"},".bd1"),e(" and "),n("code",{class:"mx1"},".bdrs2"),e(" classes.")],-1)])),content:d(()=>s[25]||(s[25]=[e("Content 1")])),_:1}),o(h,null,{title:d(()=>s[26]||(s[26]=[e("Item 2")])),content:d(()=>s[27]||(s[27]=[e("Content 2")])),_:1})]),_:1})]),_:1}),o(c,{info:""},{default:d(()=>s[30]||(s[30]=[e(`Some of the UI components that have wrappers won't work nicely with the border and shadow classes.
In this case you need to style them from your CSS.`)])),_:1,__:[30]})])}const E={data:()=>({baseUrl:"/wave-ui/"})},F=Y(E,[["render",N]]);export{F as default};
