...
w-table(
  :headers="table.headers"
  :items="table.items"
  :filter="table.filters[table.activeFilter]")`),Ke=e(`<div class="w-flex wrap mb3">
  <w-button
    class="mr2 mb1"
    @click="table.activeFilter = 0"
    round
...
`),Ge=e("Global filter"),Xe=a("p",null,[e("You could also apply a filter globally, which looks into all the columns at once."),a("br"),e(`
Here is one cool way to do it.`)],-1),Ze=e(`w-input.mb3(
...
w-table(
  :headers="table.headers"
  :items="table.items"
  :filter="table.keywordFilter&#40;table.keyword&#41;")`),Qe=e(`<w-input
  v-model="table.keyword"
  placeholder="Search anything..."
  inner-icon-left="wi-search"
  class="mb3">
...
one remain selected.
`)],-1),Ot=e("The "),Ut=a("span",{class:"code"},"@row-select",-1),Kt=e(" event"),Jt=z(`<p>This event is fired each time a row is selected <strong>or unselected</strong> (so you don&#39;t need to listen
...
information such as:</p><ul><li><code>item</code>: the clicked row object</li><li><code>selected</code>: a boolean telling if the row is being selected or unselected</li><li><code>selectedRows</code>: an array of all the selected rows objects</li></ul>`,2),Gt=e("wi-check"),Xt=e("Force selection"),Zt=a("div",{class:"mt4 title4"},"Selection info:",-1),Qt=e(`w-flex.mb4(wrap)
...
`),Va=e("override 1 particular item cell or column cells (inside <td> element)"),Ma=z(`<p>If you only need to override 1 particular column you can do it via the <code>item-cell.xxx</code> slot,
...
`),Ua=a("span",{class:"code"},"colspan",-1),Ka=e(" on <td>"),Ja=a("p",null,[e("This example is showcasing another useful case: handling a colspan attribute."),a("br"),e(`
All the cells of all the rows are `),a("code",null,"colspan"),e("'d to one, and a custom row layout is applied.")],-1),Ga=["onClick"],Xa=["colspan"],Za={class:"title3"},Qa={class:"mr2"},es=e(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
</w-table>`,1)]),js:t(()=>[Oa]),default:t(()=>[l(d,{headers:s.table1.headers,items:s.table1.items,"selectable-rows":""},{item:t(({item:o,index:u,select:p,classes:g})=>[a("tr",{class:I(g),onClick:p},[(b(!0),f(F,null,R(s.table1.headers,(k,S)=>(b(),f("td",{key:S,class:I(`pa4 text-${k.align||"left"}`)},n(o[k.key]||""),3))),128))],10,Pa)]),_:1},8,["headers","items"])]),_:1}),l(r,{h3:"",slug:"colspan-on-td"},{default:t(()=>[Ua,Ka]),_:1}),Ja,l(m,null,{pug:t(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
  no-headers
  selectable-rows)
