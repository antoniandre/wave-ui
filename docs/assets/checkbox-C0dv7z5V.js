...
<w-flex class="align-center">
  ...
  <span class="ml6">
    v-model:
    <code class="ml1">`+c(`{{ selection1 }}`)+`</code>
  </span>
</w-flex>
...
<w-flex class="align-center">
  ...
  <span class="ml6">
    v-model:
    <code class="ml1">`+c(`{{ selection2 }}`)+`</code>
  </span>
</w-flex>`,-1)]]),js:t(()=>[...u[25]||=[o(`data: () => ({
  selection1: false,
  selection2: [false, false, false]
})
`,-1)]]),default:t(()=>[u[26]||=r(`div`,{class:`title4 mb2`},`Basic use`,-1),a(A,null,{default:t(()=>[...u[17]||=[o(`Single option`,-1)]]),_:1}),u[27]||=r(`div`,{class:`title4 mt8 mb2`},`Using v-model on a single checkbox`,-1),a(N,{class:`align-center`},{default:t(()=>[a(A,{modelValue:l.selection1,"onUpdate:modelValue":u[0]||=e=>l.selection1=e},{default:t(()=>[...u[18]||=[o(`Single option`,-1)]]),_:1},8,[`modelValue`]),r(`span`,g,[u[19]||=o(`v-model:`,-1),r(`code`,_,c(l.selection1),1)])]),_:1}),u[28]||=r(`div`,{class:`title4 mt8 mb2`},`Using an array of v-model for multiple checkboxes`,-1),a(N,{class:`align-center`},{default:t(()=>[a(A,{class:`mr2`,modelValue:l.selection2[0],"onUpdate:modelValue":u[1]||=e=>l.selection2[0]=e},{default:t(()=>[...u[20]||=[o(`Option 1`,-1)]]),_:1},8,[`modelValue`]),a(A,{class:`mr2`,modelValue:l.selection2[1],"onUpdate:modelValue":u[2]||=e=>l.selection2[1]=e},{default:t(()=>[...u[21]||=[o(`Option 2`,-1)]]),_:1},8,[`modelValue`]),a(A,{modelValue:l.selection2[2],"onUpdate:modelValue":u[3]||=e=>l.selection2[2]=e},{default:t(()=>[...u[22]||=[o(`Option 3`,-1)]]),_:1},8,[`modelValue`]),r(`span`,v,[u[23]||=o(`v-model:`,-1),r(`code`,y,c(l.selection2),1)])]),_:1})]),_:1}),a(F,{info:``},{default:t(()=>[...u[29]||=[o(`Unlike the radio buttons, checkboxes don't need the `,-1),r(`code`,null,`name`,-1),o(` prop in addition to the `,-1),r(`code`,null,`v-model`,-1),o(`
...
If no value is set, the choice's label will be returned instead.`,-1)]]),_:1}),a(P,null,{html:t(()=>[...u[42]||=[o(`<div class="w-flex align-center">
  ...
  <div class="title3 ml8">v-model: `+c(`{{ selection || '[]' }}`)+`</div>
...
`,-1)]]),default:t(()=>[r(`div`,b,[a(k,{modelValue:l.selection1b,"onUpdate:modelValue":u[4]||=e=>l.selection1b=e,items:l.checkboxes1},null,8,[`modelValue`,`items`]),r(`div`,x,[u[41]||=o(`v-model:`,-1),r(`code`,S,c(l.selection1b||`[]`),1)])])]),_:1}),u[84]||=r(`p`,null,`The v-model can also be preset, or updated externally.`,-1),a(P,null,{html:t(()=>[...u[46]||=[o(`<div class="w-flex align-center">
  <div>
    <w-checkboxes v-model="selection" :items="checkboxes"></w-checkboxes>
  ...
  <div class="title3 ml8">
    v-model:
    <code class="ml1">`+c(`{{ selection || '[]' }}`)+`</code>
  </div>
...
`,-1)]]),default:t(()=>[u[51]||=r(`div`,{class:`title4 mb2`},`Default column layout`,-1),a(k,{items:l.checkboxes1},null,8,[`items`]),u[52]||=r(`div`,{class:`title4 mt6 mb2`},`Inline layout`,-1),a(k,{items:l.checkboxes1,inline:``},null,8,[`items`])]),_:1}),a(M,{h2:``},{default:t(()=>[...u[53]||=[o(`Custom label content`,-1)]]),_:1}),u[85]||=r(`p`,null,[r(`span`,{class:`code`},`w-checkboxes`),o(` provides a slot to customize the label of each checkbox button: `),r(`code`,null,`item`),o(`.`)],-1),a(P,null,{html:t(()=>[...u[54]||=[o(`<w-checkboxes :items="checkboxes" color="green">
  <template #item="{ item }">
    ...
    <w-icon class="deep-purple">`+c(`{{ item.icon }}`)+`</w-icon>
  </template>
...
`,-1)]]),default:t(()=>[a(k,{items:l.checkboxes3,color:`green`},{item:t(({item:e})=>[r(`span`,E,c(e.label),1),a(I,{class:`deep-purple`},{default:t(()=>[o(c(e.icon),1)]),_:2},1024)]),_:1},8,[`items`])]),_:1}),u[86]||=r(`div`,{class:`w-divider grey-light5 my12`},null,-1),a(M,{h2:``},{default:t(()=>[...u[56]||=[o(`Round checkboxes`,-1)]]),_:1}),a(P,{"content-class":`mt3`},{html:t(()=>[...u[57]||=[o(`<w-checkboxes
  v-model="selection"
  :items="checkboxes"
  round
  inline>
