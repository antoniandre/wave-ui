import{r as d,o as m,g as b,a as r,w as o,b as t,t as w,d as s,n as P,p as D,v as C,h as $,_ as f,M as O}from"./index-DmbSWeYz.js";const V=s("p",null,[t("The "),s("strong",{class:"code"},"w-drawer"),t(` component can be placed in a deeper structure than the root of
...
The pushable content should be provided via the <code>pushable</code> slot.</p>`,1),j={class:"py12 w-flex column align-center justify-center"},R=s("p",{class:"mb3"},"Pushable content",-1),B=s("div",{class:"ma2"},"Drawer content",-1),L={class:"py12 w-flex column align-center justify-center"},M=s("p",{class:"mb3"},"Pushable content",-1),U=s("div",{class:"ma2"},"Drawer content",-1),I=s("span",null,"Open top drawer with a:",-1),E=s("p",{class:"mt4"},[s("strong",null,"Note:"),t(` with no overlay the underneath content will be clickable and the drawer
will not close.
...
`)]),default:o(()=>[r(l,{onClick:n[15]||(n[15]=a=>{e.persistent=!0,e.openBottomDrawer=!0}),outline:""},{default:o(()=>[t("Persistent drawer")]),_:1})]),_:1}),r(i,{h2:""},{default:o(()=>[t("Cookie notice example")]),_:1}),H,r(p,{"content-class":"w-flex align-center"},{pug:o(()=>[t(`w-button(@click="showCookieNotice = true" outline).
