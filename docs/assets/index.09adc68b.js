import{o as h,g as w,a as e,w as t,b as l,d as o,e as i,r as d,_ as p,a9 as g,E as y}from"./index.4be49e41.js";const V={class:"title3 mb0"},$={class:"ml2"},A=i("p",null,[l("You can easily add some custom content in the switch track via the "),i("code",null,"#track"),l(" slot."),i("br")],-1),x=i("strong",{class:"code"},"w-switch",-1),D=i("div",{class:"w-switch--custom-track"},".w-switch--custom-track .w-switch__input {width: 55px;}",-1),E=i("p",null,[l("It is possible to add an icon or any kind of content in the switch thumb via the "),i("code",null,"#thumb"),l(`
slot.`),i("br"),l(`
You can also fit and style the element with minimum CSS.`)],-1),T=i("p",null,`If a number is given it will be the value of the progress. If true is given, the progress will
...
`)]),default:t(()=>[e(a,{class:"ma4",modelValue:n.value2,"onUpdate:modelValue":s[1]||(s[1]=u=>n.value2=u)},{track:t(()=>[i("small",null,o(n.value2?"on":"off"),1)]),_:1},8,["modelValue"]),e(a,{class:"w-switch--wide ma4",modelValue:n.value2,"onUpdate:modelValue":s[2]||(s[2]=u=>n.value2=u)},{track:t(()=>[i("strong",null,o(n.value2?"on":"off"),1)]),_:1},8,["modelValue"])]),_:1}),e(c,{h2:""},{default:t(()=>[l("Thumb slot")]),_:1}),E,e(r,{"content-class":"pt5"},{pug:t(()=>[l(`w-switch.ma4(v-model="value" label="On")
  template(#thumb)
    small `+o("{{ value ? 'on' : 'off' }}")+`
...
`)]),default:t(()=>[e(a,{class:"ma4",modelValue:n.value3,"onUpdate:modelValue":s[3]||(s[3]=u=>n.value3=u)},{thumb:t(()=>[i("small",null,o(n.value3?"on":"off"),1)]),_:1},8,["modelValue"]),e(a,{class:"ma4",modelValue:n.value3,"onUpdate:modelValue":s[4]||(s[4]=u=>n.value3=u),label:"Dark theme"},{thumb:t(()=>[e(O,null,{default:t(()=>[l(o(n.value3?"mdi mdi-weather-night":"mdi mdi-white-balance-sunny"),1)]),_:1})]),_:1},8,["modelValue"])]),_:1}),e(c,{h2:""},{default:t(()=>[l("Loading")]),_:1}),T,e(r,{"content-class":"pt4"},{pug:t(()=>[l(`w-switch.ma2(:model-value="true" :loading="43")
