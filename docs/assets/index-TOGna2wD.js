...
one remain selected.
`)],-1),Be=a("span",{class:"code"},"@row-select",-1),Me=E(`<p>This event is fired each time a row is selected <strong>or unselected</strong> (so you don&#39;t need to listen
...
information such as:</p><ul><li><code>item</code>: the clicked row object</li><li><code>selected</code>: a boolean telling if the row is being selected or unselected</li><li><code>selectedRows</code>: an array of all the selected rows objects</li></ul>`,2),je=a("div",{class:"mt4 title4"},"Selection info:",-1),Pe=a("p",null,`Wave UI offers a convenient way to provide an array of selected rows and keeping your array in sync
with the selected rows after user interaction.`,-1),Ve=a("ul",null,[a("li",null,[a("strong",null,"In Vue 2"),e(", you can do 2-way binding on any variable other than the "),a("strong",{class:"code"},"v-model"),e(" using the "),a("code",null,".sync"),e(" modifier.")]),a("li",null,[a("strong",null,"In Vue 3"),e(", multiple "),a("strong",{class:"code"},"v-model"),e(" are supported in order to achieve 2-way binding. So you don't need "),a("code",null,".sync"),e(".")])],-1),qe={class:"mt4"},ze={class:"ml2"},He=a("br",null,null,-1),We=a("code",null,"id",-1),Ke=a("code",null,"uid-key",-1),Oe=a("strong",null,i("{{ item.weight }}")+"kg",-1),Ue=a("strong",null,i("{{ item.height }}")+"m",-1),Je=a("strong",null,i("{{ item.weight }}")+"kg",-1),Ye=a("strong",null,i("{{ item.height }}")+"m",-1),Ge=a("p",null,"You can customize the headers labels and/or each row cells.",-1),Xe=a("p",null,[e("In this example, only the headers are customized via the "),a("code",null,"header-label"),e(" slot.")],-1),Qe=a("p",null,[e("In this example, only the items cells are customized via the "),a("code",null,"item"),e(` slot
(and the headers are hidden).`)],-1),Ze={key:0},$e={class:"grey mr2"},et=E(`<p>If you only need to override 1 particular column you can do it via the <code>item-cell.xxx</code> slot,
...
where <code>i</code> is a an integer starting at 1.</p>`,1),tt=a("p",null,[e(`In this example, the full <tr> DOM element is customized, so you can add your own classes
...
code to write.`)],-1),at=["onClick"],nt=a("span",{class:"code"},"colspan",-1),lt=a("p",null,[e("This example is showcasing another useful case: handling a colspan attribute."),a("br"),e(`
All the cells of all the rows are `),a("code",null,"colspan"),e("'d to one, and a custom row layout is applied.")],-1),it=["onClick"],st=["colspan"],ot={class:"title3"},rt={class:"mr2"},dt=a("p",null,[e("In addition to the full responsiveness, the "),a("code",null,"w-table"),e(` can be presented in a mobile friendly layout,
...
`)],-1),mt=a("p",null,[e("To stay lean and efficient, the minimum JavaScript behavior is added to the "),a("code",null,"w-table"),e(`
component.`),a("br"),e(`
...
`)],-1);function ht(d,s,g,_,l,c){const o=p("title-link"),r=p("w-table"),h=p("example"),b=p("w-button"),F=p("w-icon"),B=p("w-flex"),L=p("ssh-pre"),V=p("w-tag"),M=p("w-radios"),I=p("alert"),q=p("w-input");return f(),N("div",null,[n(o,{h2:""},{default:t(()=>[e("Basic")]),_:1}),n(h,null,{pug:t(()=>[e('w-table(:headers="table.headers" :items="table.items")')]),html:t(()=>[e(`<w-table
...
`)]),default:t(()=>[n(r,{headers:l.table3.headers,items:l.table3.items,"fixed-headers":"",style:{height:"250px"}},null,8,["headers","items"])]),_:1}),n(o,{h2:"",slug:"example--footer"},{default:t(()=>[e("Footer")]),_:1}),n(o,{h3:"",slug:"example--footer-slot"},{default:t(()=>[e("Footer slot")]),_:1}),J,a("div",Y,[n(b,{onClick:s[0]||(s[0]=m=>l.table3.fixedFooter=!l.table3.fixedFooter),outline:!l.table3.fixedFooter,round:""},{default:t(()=>[a("span",{class:v(["code",l.table3.fixedFooter?"contrast-color":"primary"])},"fixed-footer",2)]),_:1},8,["outline"])]),n(h,null,{pug:t(()=>[e(`w-table(
  ...
  template(#footer)
    w-flex(justify-space-between)
      ...
      div
        strong.mr2 Total:
        | `+i("{{ table.items.length }}")+" persons")]),html:t(()=>[e(`<w-table
  ref="table"
  :headers="table.headers"
  :items="table.items"
  :fixed-footer="table.fixedFooter"
  ...
  template(#footer-row)
    tr
      th.py1(
        ...
        | `+i("{{ header.label }}"))]),html:t(()=>[e(`<w-table
  :headers="table.headers"
  no-headers
  :items="table.items"
  fixed-footer
...
.mt4
  | Selected rows:
  code.ml2 `+i("{{ table.selectedRows }}"))]),html:t(()=>[e(`<w-table
  :headers="table.headers"
  :items="table.items"
  selectable-rows
  v-model:selected-rows="table.selectedRows">
...
`)]),_:1}),n(o,{h2:"",slug:"example--expandable-rows"},{default:t(()=>[e("Expandable rows")]),_:1}),n(I,{warning:""},{default:t(()=>[e("This feature is in progress.")]),_:1}),n(h,null,{pug:t(()=>[e(`w-table(:headers="table.headers" :items="table.items" expandable-rows)
  template(#row-expansion="{ item }")
    ...
    | `+i("{{ item.firstName }}")+" weighs "),Oe,e(" and is "),Ue,e(" tall.")]),html:t(()=>[e(`<w-table
  :headers="table.headers"
  :items="table.items"
  expandable-rows>
  <template #row-expansion="{ item }">
    ...
    `+i("{{ item.firstName }}")+" weighs "),Je,e(" and is "),Ye,e(` tall.
  </template>
</w-table>`)]),js:t(()=>[e(`data: () => ({
  table: {
    headers: [
...
`)]),default:t(()=>[n(r,{headers:l.table1.headers,items:l.table1.items},{"header-label":t(({label:m,index:u})=>[e(i(u)+": "+i(m)+" 👌",1)]),_:1},8,["headers","items"])]),_:1}),n(o,{h3:"",slug:"item-cells"},{default:t(()=>[e("Item cells (inside <td> element)")]),_:1}),Qe,n(h,null,{pug:t(()=>[e(`w-table(:headers="table.headers" no-headers :items="table.items")
  template(#item-cell="{ item, label, header, index }")
    small.grey.mr2 `+i("{{ header.label }}")+`:
    span `+i("{{ label }}"))]),html:t(()=>[e(`<w-table
  :headers="table.headers"
  no-headers
  :items="table.items">
  <template #item-cell="{ item, label, header, index }">
...
`)]),default:t(()=>[n(r,{headers:l.table1.headers,"no-headers":"",items:l.table1.items},{"item-cell":t(({item:m,label:u,header:y,index:k})=>[y.key==="id"?(f(),N("small",Ze,"#"+i(k),1)):(f(),N(S,{key:1},[a("small",$e,i(y.label)+":",1),a("span",null,i(u),1)],64))]),_:1},8,["headers","items"])]),_:1}),n(o,{h3:"",slug:"override-1-particular-item-cell"},{default:t(()=>[e("override 1 particular item cell or column cells (inside <td> element)")]),_:1}),et,n(h,null,{pug:t(()=>[e(`w-table(:headers="table.headers" :items="table.items" no-headers)
  ...
  template(#item="{ item, index, select, classes }")
    tr(:class="classes" @click="select")
      td(
        ...
        | `+i("{{ item[header.key] || '' }}"))]),html:t(()=>[e(`<w-table
  :headers="table.headers"
  :items="table.items"
  selectable-rows>
  <template #item="{ item, index, select, classes }">
...
`)]),default:t(()=>[n(r,{headers:l.table1.headers,items:l.table1.items,"selectable-rows":""},{item:t(({item:m,index:u,select:y,classes:k})=>[a("tr",{class:v(k),onClick:y},[(f(!0),N(S,null,D(l.table1.headers,(x,w)=>(f(),N("td",{key:w,class:v(`pa4 text-${x.align||"left"}`)},i(m[x.key]||""),3))),128))],10,at)]),_:1},8,["headers","items"])]),_:1}),n(o,{h3:"",slug:"colspan-on-td"},{default:t(()=>[nt,e(" on <td>")]),_:1}),lt,n(h,null,{pug:t(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
  no-headers
  selectable-rows)
...
`)]),default:t(()=>[n(r,{headers:l.table1.headers,items:l.table1.items,"no-headers":"","selectable-rows":""},{item:t(({item:m,index:u,select:y,classes:k})=>[a("tr",{class:v({...k,[`indigo-${d.$store.state.darkMode?"dark":"light"}5--bg`]:u%2,[`blue-${d.$store.state.darkMode?"dark":"light"}5--bg`]:!(u%2)}),onClick:y},[a("td",{class:"pa2",colspan:l.table1.headers.length},[a("div",ot,"Row #"+i(u),1),a("ul",null,[(f(!0),N(S,null,D(l.table1.headers,(x,w)=>(f(),N("li",{key:w},[a("strong",rt,i(x.label)+":",1),e(i(m[x.key]||""),1)]))),128))])],8,st)],10,it)]),_:1},8,["headers","items"])]),_:1}),n(o,{h2:""},{default:t(()=>[e("Responsiveness & mobile layout")]),_:1}),dt,n(h,null,{pug:t(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
