import{r as d,o as m,g as b,a as r,w as o,b as t,t as w,d as s,n as P,l as D,v as C,h as $,_ as f,L as O}from"./index-DFgXq0tg.js";const V=s("p",null,[t("The "),s("strong",{class:"code"},"w-drawer"),t(` component can be placed in a deeper structure than the root of
...
The pushable content should be provided via the <code>pushable</code> slot.</p>`,1),j={class:"py12 w-flex column align-center justify-center"},R=s("p",{class:"mb3"},"Pushable content",-1),L=s("div",{class:"ma2"},"Drawer content",-1),B={class:"py12 w-flex column align-center justify-center"},M=s("p",{class:"mb3"},"Pushable content",-1),U=s("div",{class:"ma2"},"Drawer content",-1),I=s("span",null,"Open top drawer with a:",-1),E=s("p",{class:"mt4"},[s("strong",null,"Note:"),t(` with no overlay the underneath content will be clickable and the drawer
will not close.
To allow closing the drawer when clicking outside of it, you can set a transparent background
on the overlay.
`)],-1),z=s("p",null,"A persistent drawer stays open when clicking outside or pressing the escape key.",-1),H=s("p",null,`The cookie notice is a good use case of a persistent drawer, it will not let you click
anything until you accept.`,-1),W={class:"w-flex pa2 align-center wrap"},_={class:"w-flex align-center py1"},Y=s("div",{class:"spacer"},null,-1),q=s("p",null,`You can then store the result of the acceptation in the localStorage when the user clicks
the button.`,-1),F={class:"w-flex align-center justify-center fill-height"},J=s("div",{class:"w-flex fill-height align-center justify-center black"},"You can customize the background color as well.",-1);function x(e,n,g,v,k,u){const i=d("title-link"),l=d("w-button"),c=d("example"),p=d("w-drawer"),T=d("w-card"),y=d("w-icon"),h=d("ssh-pre");return m(),b("div",null,[r(i,{h2:""},{default:o(()=>[t("Basic")]),_:1}),r(c,{"content-class":"w-flex align-center wrap"},{pug:o(()=>[t(`w-button(@click="openDrawer = true" outline) Open drawer
...
`)]),default:o(()=>[r(l,{onClick:n[0]||(n[0]=a=>e.openRightDrawer=!e.openRightDrawer),outline:""},{default:o(()=>[t("Open drawer")]),_:1})]),_:1}),r(i,{h2:""},{default:o(()=>[t("Positions")]),_:1}),r(c,{"content-class":"w-flex align-center wrap"},{pug:o(()=>[t(`w-button.ma1(
...
`)]),default:o(()=>[r(T,{class:"ma6 grow text-center","bg-color":e.$store.state.darkMode?"grey-dark6":"amber-light5",title:"w-card"},{default:o(()=>[r(l,{class:"my12",onClick:n[5]||(n[5]=a=>e.openAbsoluteDrawer=!0),text:""},{default:o(()=>[t("Open drawer")]),_:1}),r(p,{modelValue:e.openAbsoluteDrawer,"onUpdate:modelValue":n[6]||(n[6]=a=>e.openAbsoluteDrawer=a),absolute:"",width:"160px"},null,8,["modelValue"])]),_:1},8,["bg-color"])]),_:1}),r(i,{h2:""},{default:o(()=>[t("Control width or height")]),_:1}),S,r(c,null,{pug:o(()=>[t(`p.mb4 Open a blue 60px-height bottom drawer
...
`)]),default:o(()=>[N,r(l,{onClick:n[7]||(n[7]=a=>{e.bottomDrawerHeight="60px",e.openBottomDrawer=!0}),outline:""},{default:o(()=>[t("Open drawer")]),_:1})]),_:1}),r(i,{h2:""},{default:o(()=>[t("Push content")]),_:1}),A,r(c,{"content-class":"relative pa0","blank-codepen":["css"]},{pug:o(()=>[t(`w-drawer(
  v-model="openDrawer"
  push-content
...
`)]),default:o(()=>[r(p,{modelValue:e.openPushContentRightDrawer,"onUpdate:modelValue":n[9]||(n[9]=a=>e.openPushContentRightDrawer=a),"push-content":"","overlay-opacity":.15,width:"160px"},{pushable:o(()=>[s("div",j,[R,r(l,{onClick:n[8]||(n[8]=a=>e.openPushContentRightDrawer=!0),outline:""},{default:o(()=>[t("Open drawer")]),_:1})])]),default:o(()=>[L]),_:1},8,["modelValue"])]),_:1}),r(c,{"content-class":"relative pa0","blank-codepen":["css"]},{pug:o(()=>[t(`w-drawer(
  v-model="openDrawer"
  push-content
  :overlay-opacity="0.15"
  left
...
`)]),default:o(()=>[r(p,{modelValue:e.openPushContentLeftDrawer,"onUpdate:modelValue":n[11]||(n[11]=a=>e.openPushContentLeftDrawer=a),"push-content":"","overlay-opacity":.15,left:"",width:"160px"},{pushable:o(()=>[s("div",B,[M,r(l,{onClick:n[10]||(n[10]=a=>e.openPushContentLeftDrawer=!0),outline:""},{default:o(()=>[t("Open drawer")]),_:1})])]),default:o(()=>[U]),_:1},8,["modelValue"])]),_:1}),r(i,{h2:""},{default:o(()=>[t("No overlay & custom color overlay")]),_:1}),r(c,{"content-class":"w-flex align-center wrap"},{pug:o(()=>[t(`span Open top drawer with a:
...
`)]),default:o(()=>[r(l,{onClick:n[15]||(n[15]=a=>{e.persistent=!0,e.openBottomDrawer=!0}),outline:""},{default:o(()=>[t("Persistent drawer")]),_:1})]),_:1}),r(i,{h2:""},{default:o(()=>[t("Cookie notice example")]),_:1}),H,r(c,{"content-class":"w-flex align-center"},{pug:o(()=>[t(`w-button(@click="showCookieNotice = true" outline).
