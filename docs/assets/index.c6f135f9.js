import{n as o,b as a}from"./index.e31dd236.js";var c=function(){var e=this,n=e.$createElement,t=e._self._c||n;return t("div",[t("div",{staticClass:"title2 red"},[e._v("Required in Wave UI "),t("w-tag",{staticClass:"error--bg",attrs:{round:""}},[e._v("< 3.0")]),e._v(", removed in "),t("w-tag",{staticClass:"error--bg",attrs:{round:""}},[e._v("3.0")]),e._v(".")],1),e._m(0),t("div",{staticClass:"caption grey-light1"},[e._v(`There should only be one <w-app> in your whole app.
`)]),t("ssh-pre",{attrs:{language:"html-vue",dark:e.$store.state.darkMode}},[e._v(`<w-app>
...
`)]},proxy:!0}])},[t("fieldset",{staticClass:"app w-flex column"},[t("legend",[e._v("w-app")]),t("section",{staticClass:"header"},[e._v("Header")]),t("div",{staticClass:"w-flex grow"},[t("section",{staticClass:"nav-menu block"},[e._v("Nav menu")]),t("section",{staticClass:"content block grow"},[e._v("Main content")])]),t("section",{staticClass:"footer"},[e._v("Footer")])])])],1),t("w-badge",{attrs:{"bg-color":"orange",color:"white",overlap:"",value:2}},[t("example",{staticClass:"ma0 grow",attrs:{"content-class":"pa0","blank-codepen":["html","pug","css"]},scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-app#app(row)
  ...
  w-flex(grow)
    header Header
    main.grow Main content
    footer Footer`)]},proxy:!0},{key:"html",fn:function(){return[e._v(`<div id="app" class="row">
  <aside>Nav menu</aside>
  <w-flex column>
    <header>Header</header>
    <main class="grow">Main content</main>
...
</div>`)]},proxy:!0},{key:"css",fn:function(){return[e._v(`/* Demo styles - can be discarded. */
.w-app {padding: 4px;background-color: #fffeed;}
header, footer, aside, main {
  margin: 4px;
  padding: 12px;
...
`),t("router-link",{staticClass:"mx1",attrs:{to:"/layout--flex"}},[e._v("Layout > Flex")]),e._v(" knowledge base page.")],1)],1)],1)},l=[function(){var e=this,n=e.$createElement,t=e._self._c||n;return t("p",{staticClass:"mt6"},[e._v("This tag is required in your app for Wave UI proper functioning."),t("br"),e._v(`
