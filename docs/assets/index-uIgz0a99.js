...
so the slider width adapts to the number of characters on the current tab's title.`)],-1);function Y(a,b,g,v,k,m){const c=d("title-link"),l=d("w-tabs"),r=d("example"),_=d("w-switch"),y=d("alert"),x=d("w-radios"),u=d("w-button"),S=d("w-flex"),p=d("w-icon"),$=d("w-input");return T(),w("div",null,[n(c,{h2:""},{default:t(()=>[e("Basic")]),_:1}),n(r,null,{pug:t(()=>[e('w-tabs(:items="tabs")')]),html:t(()=>[e('<w-tabs :items="tabs"></w-tabs>')]),js:t(()=>[e(`data: () => ({
  tabs: [
...
`)]),default:t(()=>[n(_,{class:"mb3",modelValue:a.tabs2.fillBar,"onUpdate:modelValue":b[0]||(b[0]=s=>a.tabs2.fillBar=s)},{default:t(()=>[e("Fill bar")]),_:1},8,["modelValue"]),n(l,{items:a.tabs2.items,"fill-bar":a.tabs2.fillBar},null,8,["items","fill-bar"])]),_:1}),n(c,{h2:""},{default:t(()=>[e("V-model")]),_:1}),n(y,{warning:""},{default:t(()=>[V,e(", the v-model/value only accepts a numeric tab index (previously an array of boolean).")]),_:1}),A,n(r,null,{pug:t(()=>[e(`w-tabs(v-model="activeTab" :items="tabs")
strong
  | v-model:
...
the navigation to the tab that you are deleting!`)]),_:1}),n(r,null,{pug:t(()=>[e(`w-tabs(:items="tabs" card)
  template(#item-title="{ item, index }")
    ...
    w-button.ml1.mr-1(
      ...
      icon="wi-cross"
      outline
      xs)`)]),html:t(()=>[e(`<w-tabs :items="tabs" card>
  <template #item-title="{ item, index }">
    `+i("{{ item.title }}")+`
    <w-button
      class="ml1 mr-1"
...
`)]),default:t(()=>[n(l,{items:a.tabs6.items,card:""},{"item-title":t(({item:s,index:h})=>[e(i(s.title),1),n(u,{class:"ml1 mr-1",onClick:j(at=>a.tabs6.items.splice(h-1,1),["stop"]),icon:"wi-cross",outline:"",xs:""},null,8,["onClick"])]),_:1},8,["items"]),n(u,{class:"mt4","bg-color":"primary",onClick:b[6]||(b[6]=s=>a.tabs6.items=a.tabs6.originals.slice(0)),disabled:a.tabs6.items.length===3},{default:t(()=>[e("Reset tabs")]),_:1},8,["disabled"])]),_:1}),n(c,{h2:""},{default:t(()=>[e("Customizing the tabs title & contents")]),_:1}),n(r,null,{pug:t(()=>[e(`w-tabs(:items="tabs" card)
  ...
  template(#item-content.1="{ item }")
    ...
    div(v-html="item.content")`)]),html:t(()=>[e(`<w-tabs :items="tabs" card>
  <template #item-title="{ item }">
