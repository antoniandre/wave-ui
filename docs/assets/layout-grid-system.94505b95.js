import{r as o,o as t,f as a,a as p,w as n,F as l,s as m,e as s,h,b as e,d,i as y,_ as w}from"./index.372af10f.js";const k=s("Grid system (flexbox)"),f=e("div",{class:"title3"},"The grid system (using flexbox) is 12-cell based by default.",-1),$=e("p",null,[s(`Its purpose is to divide the available width (in percentage)
...
`),I=e("strong",{class:"code"},"w-flex",-1),G=s(" component or "),R=e("code",null,".w-flex",-1),q=s(` CSS class.
`),L=e("div",{class:"xs12 pa1"},[e("div",{class:"primary-dark1--bg py3"},"xs12")],-1),W=e("div",{class:"xs6 pa1"},[e("div",{class:"primary--bg py3"},"xs6")],-1),j=e("div",{class:"xs6 pa1"},[e("div",{class:"primary--bg py3"},"xs6")],-1),D={class:"xs4 pa1"},E=e("div",{class:"primary-light1--bg white py3"},"xs4",-1),H=[E],O={class:"xs3 pa1"},Y=e("div",{class:"primary-light2--bg white py3"},"xs3",-1),A=[Y],J={class:"xs2 pa1"},K=e("div",{class:"primary-light3--bg py3"},"xs2",-1),M=[K],P=e("div",{class:"blue-light4--bg py3"},"xs1",-1),Q=[P],X=s(`w-flex.text-center(wrap)
  .xs12.pa1
...
`),ce=s("Operating with breakpoints"),me={class:"title2 mt0"},xe=s("Current breakpoint: "),ge=e("em",{class:"grey mt1"},"Resizing your browser will update the current breakpoint.",-1),he=e("p",null,"For this example, resize your browser and observe the different layout when crossing a breakpoint.",-1),be={class:"xs12 md6 lg4 xl2 pa1"},_e={class:"primary-light3--bg py3"},ue=s("xs12"),ye=s("md6"),we=s("lg4"),ke=s("xl2"),fe={class:"xs12 md6 lg4 xl2 pa1"},$e={class:"primary-light3--bg py3"},Ce=s("xs12"),Se=s("md6"),Te=s("lg4"),Ne=s("xl2"),Ue={class:"xs12 md6 lg4 xl2 pa1"},Ve={class:"primary-light3--bg py3"},ze=s("xs12"),Be=s("md6"),Fe=s("lg4"),Ie=s("xl2"),Ge={class:"xs12 md6 lg4 xl2 pa1"},Re={class:"primary-light3--bg py3"},qe=s("xs12"),Le=s("md6"),We=s("lg4"),je=s("xl2"),De={class:"xs12 md6 lg4 xl2 pa1"},Ee={class:"primary-light3--bg py3"},He=s("xs12"),Oe=s("md6"),Ye=s("lg4"),Ae=s("xl2"),Je={class:"xs12 md6 lg4 xl2 pa1"},Ke={class:"primary-light3--bg py3"},Me=s("xs12"),Pe=s("md6"),Qe=s("lg4"),Xe=s("xl2"),Ze=s(`w-flex.text-center(wrap)
