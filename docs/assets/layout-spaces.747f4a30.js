import{n as s}from"./index.6bc87caa.js";import"./vendor.748d1766.js";var i=function(){var e=this,a=e.$createElement,t=e._self._c||a;return t("main",[t("title-link",{staticClass:"mt4",attrs:{h1:""}},[e._v("Spaces")]),t("title-link",{attrs:{h2:""}},[e._v("Content spacing")]),e._m(0),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`.orange-light4--bg.pa12
...
The syntax for it is `),t("code",[e._v("m[side]a")])])}];const o={},n={};var l=s(o,i,r,!1,c,null,null,null);function c(e){for(let a in n)this[a]=n[a]}var g=function(){return l.exports}();export{g as default};
