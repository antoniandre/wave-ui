import{N as e,W as t,_t as n,bt as r,c as i,d as a,g as o,h as s,k as c}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as l}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{H as u,U as d}from"./index-CRFKPP-0.js";var f={class:`mt3`},p={class:`ml1`},m={class:`mt3`},h={class:`ml1`},g={class:`mt3`},_={class:`ml1`},v={class:`mt3`},y={class:`ml1`},b={class:`ml1`};function x(l,u,d,x,S,C){let w=e(`alert`),T=e(`title-link`),E=e(`w-accordion`),D=e(`example`),O=e(`w-icon`),k=e(`w-button`),A=e(`w-alert`),j=e(`w-tag`),M=e(`w-list`),N=e(`w-accordion-item`);return c(),a(`div`,null,[o(w,{info:``},{default:t(()=>[...u[7]||=[i(`p`,null,`Two components are available:`,-1),i(`ul`,null,[i(`li`,null,[i(`strong`,{class:`code`},`w-accordion`),s(`: The root accordion component.`)]),i(`li`,{class:`mt2`},[i(`strong`,{class:`code`},`w-accordion-item`),s(`: An optional component if you don't need / prefer not to use
the `),i(`code`,null,`items`),s(` prop.`)])],-1)]]),_:1}),o(T,{h2:``},{default:t(()=>[...u[8]||=[s(`Basic`,-1)]]),_:1}),o(E,{items:l.items},null,8,[`items`]),u[106]||=i(`p`,{class:`grey-light2 my4`},`Now that you've seen the default accordion in real context, all the accordions of this page will have a
...
`,-1)]]),default:t(()=>[o(E,{class:`discrete--bg`,modelValue:l.accordion1,"onUpdate:modelValue":u[0]||=e=>l.accordion1=e,items:l.items},null,8,[`modelValue`,`items`]),i(`div`,f,[u[9]||=s(`v-model:`,-1),i(`code`,p,r(l.accordion1),1)])]),_:1}),o(T,{h2:``},{default:t(()=>[...u[13]||=[s(`Expanded by default`,-1)]]),_:1}),u[107]||=i(`p`,null,[s(`You can expand one or multiple panes by default by providing a v-model array of booleans:
...
`,-1)]]),default:t(()=>[o(E,{class:`discrete--bg`,modelValue:l.accordion2,"onUpdate:modelValue":u[1]||=e=>l.accordion2=e,items:l.items},null,8,[`modelValue`,`items`]),i(`div`,m,[u[14]||=s(`v-model:`,-1),i(`code`,h,r(l.accordion2),1)])]),_:1}),o(T,{h2:``},{default:t(()=>[...u[18]||=[s(`Disabled pane`,-1)]]),_:1}),u[108]||=i(`p`,null,[s(`Specify which pane should be disabled - expanded or collapsed - by adding the `),i(`span`,{class:`code`},`disabled`),s(` property
...
`,-1)]]),default:t(()=>[o(E,{class:`discrete--bg`,items:l.items,shadow:``},null,8,[`items`])]),_:1}),o(T,{h2:``},{default:t(()=>[...u[26]||=[s(`Color & background color`,-1)]]),_:1}),u[109]||=i(`p`,null,[s(`Like in most components, you can set a `),i(`code`,null,`color`),s(` for the text and a `),i(`code`,null,`bg-color`),s(` for the
background.`),i(`br`),s(`
...
`,-1)]]),default:t(()=>[o(E,{class:`discrete--bg`,items:l.items,color:`amber-dark1`},null,8,[`items`]),o(E,{class:`mt6`,items:l.items,"bg-color":l.$store.state.darkMode?`indigo-dark6`:`yellow-light5`},null,8,[`items`,`bg-color`])]),_:1}),o(T,{h3:``},{default:t(()=>[...u[28]||=[s(`Different color per item`,-1)]]),_:1}),u[110]||=i(`p`,null,[s(`The colors are set in the data in each item object.`),i(`br`),s(`
...
div.mt3
  | v-model:
  code.ml1 `+r(`{{ accordion }}`),-1)]]),html:t(()=>[...u[44]||=[s(`<w-button
  class="mr2"
...
`,-1)]]),default:t(()=>[o(k,{class:`mr2`,onClick:u[4]||=e=>l.accordion5=[,,,].fill(!0),"bg-color":`success`,sm:``},{default:t(()=>[o(O,{class:`mr1`},{default:t(()=>[...u[38]||=[s(`wi-plus`,-1)]]),_:1}),u[39]||=s(`Expand all`,-1)]),_:1}),o(k,{onClick:u[5]||=e=>l.accordion5=[,,,].fill(!1),"bg-color":`error`,sm:``},{default:t(()=>[o(O,{class:`mr1`},{default:t(()=>[...u[40]||=[s(`wi-minus`,-1)]]),_:1}),u[41]||=s(`Collapse all`,-1)]),_:1}),o(E,{class:`mt4 discrete--bg`,modelValue:l.accordion5,"onUpdate:modelValue":u[6]||=e=>l.accordion5=e,items:l.items},null,8,[`modelValue`,`items`]),i(`div`,v,[u[42]||=s(`v-model:`,-1),i(`code`,y,r(l.accordion5),1)])]),_:1}),o(T,{h2:``},{default:t(()=>[...u[46]||=[s(`Custom rendering via slots`,-1)]]),_:1}),u[111]||=i(`p`,null,[s(`Customize all the tab items titles and/or content via the single slot `),i(`code`,null,`item-title`),s(`, and/or
all the tab items content via the single slot `),i(`code`,null,`item-content`),s(`.`)],-1),o(D,{"content-class":`pa4`},{pug:t(()=>[...u[47]||=[s(`w-accordion(:items="items" content-class="pa0")
  template(#item-title="{ item }")
    w-icon(lg :color="item.itemColor") `+r(`{{ item.icon }}`)+`
    .title3.my0.ml2(:class="item.itemColor") `+r(`{{ item.title }}`)+`
  template(#item-content="{ item }")
    w-alert.my0.pb3(border-left tile :color="item.itemColor" v-html="item.content")`,-1)]]),html:t(()=>[...u[48]||=[s(`<w-accordion :items="items" content-class="pa0">
  <template #item-title="{ item }">
...
`,-1)]]),default:t(()=>[o(E,{class:`discrete--bg`,items:l.items,"content-class":`pa0`},{"item-title":t(({item:e})=>[o(O,{lg:``,color:e.itemColor},{default:t(()=>[s(r(e.icon),1)]),_:2},1032,[`color`]),i(`div`,{class:n([`title3 my0 ml2`,e.itemColor])},r(e.title),3)]),"item-content":t(({item:e})=>[o(A,{class:`my0 pb3`,"border-left":``,tile:``,color:e.itemColor,innerHTML:e.content},null,8,[`color`,`innerHTML`])]),_:1},8,[`items`])]),_:1}),o(T,{h3:``,slug:`slots--different-title-and-content`},{default:t(()=>[...u[50]||=[s(`Different title and content layouts per item`,-1)]]),_:1}),u[112]||=i(`p`,null,[s(`Here is a more complex example using slots to render 3 totally diferent pane titles and contents.`),i(`br`),s(`
This time, an array of object is defined to show you can also do a mix of contents coming from the
the component's data or directly in the template.`)],-1),o(D,{"content-class":`pa4`},{pug:t(()=>[...u[64]||=[s(`w-accordion(:items="items")
  ...
  template(#item-content.item3)
    ...
    w-button.mt1(bg-color="primary" route="https://github.com/antoniandre/wave-ui")
      | Github
      w-icon.ml2(sm) mdi mdi-open-in-new`,-1)]]),html:t(()=>[...u[65]||=[s(`<w-accordion :items="items">
  <template #item-title.item1>
    This is the 1st item
...
</w-accordion>`,-1)]]),js:t(()=>[...u[66]||=[s(`data: () => ({
  items: [
    { id: 'item1' },
    { id: 'item2' },
    { id: 'item3' }
...
`,-1)]]),default:t(()=>[o(E,{class:`discrete--bg`,items:l.itemsCustom},{"item-title.item1":t(()=>[u[52]||=s(`This is the 1st item`,-1),o(j,{class:`ml2`,color:`red`,sm:``,outline:``},{default:t(()=>[...u[51]||=[s(`HOT`,-1)]]),_:1})]),"item-content.item1":t(()=>[u[53]||=i(`p`,null,`This content has a checklist.`,-1),u[54]||=i(`div`,{class:`title4`},`To do`,-1),o(M,{checklist:``,color:`primary`,items:[{label:`do this`},{label:`do that next`}]})]),"item-title.item2":t(()=>[o(O,{class:`mr1`,md:``,color:`amber`},{default:t(()=>[...u[55]||=[s(`mdi mdi-emoticon-excited-outline`,-1)]]),_:1}),u[56]||=i(`em`,null,`This is the 2nd item`,-1)]),"item-content.item2":t(({item:e})=>[u[58]||=i(`p`,null,`The full content here is custom and completely distinct and independent from the other items.`,-1),i(`p`,null,[u[57]||=s(`You also have access to the item's data if you need:`,-1),i(`code`,b,r(e),1)])]),"item-title.item3":t(()=>[u[60]||=i(`strong`,null,`This is the 3rd item`,-1),o(O,{class:`ml1`,md:``,color:`pink`},{default:t(()=>[...u[59]||=[s(`mdi mdi-emoticon-kiss-outline`,-1)]]),_:1})]),"item-content.item3":t(()=>[u[63]||=i(`p`,null,`Do you want to check the project on Github?`,-1),o(k,{class:`mt1`,"bg-color":`primary`,route:`https://github.com/antoniandre/wave-ui`},{default:t(()=>[u[62]||=s(`Github`,-1),o(O,{class:`ml2`,sm:``},{default:t(()=>[...u[61]||=[s(`mdi mdi-open-in-new`,-1)]]),_:1})]),_:1})]),_:1},8,[`items`])]),_:1}),o(T,{h2:``,slug:`w-accordion-item`},{default:t(()=>[...u[67]||=[s(`Custom rendering via `,-1),i(`span`,{class:`code`},`w-accordion-item`,-1)]]),_:1}),u[113]||=i(`p`,null,[s(`If you don't need data objects at all and all the items layouts will be different,
using the `),i(`strong`,{class:`code`},`w-accordion-item`),s(` component is a more flexible and straightforward approach.
`)],-1),o(D,{"content-class":`pa4`},{pug:t(()=>[...u[74]||=[s(`w-accordion
  w-accordion-item
  ...
  w-accordion-item
    ...
    template(#content) Item content 3`,-1)]]),html:t(()=>[...u[75]||=[s(`<w-accordion>
  <w-accordion-item>
...
`,-1)]]),default:t(()=>[o(E,{class:`discrete--bg`},{default:t(()=>[o(N,null,{title:t(()=>[...u[68]||=[s(`Item title 1`,-1)]]),content:t(()=>[...u[69]||=[s(`Item content 1`,-1)]]),_:1}),o(N,null,{title:t(()=>[...u[70]||=[s(`Item title 2`,-1)]]),content:t(()=>[...u[71]||=[s(`Item content 2`,-1)]]),_:1}),o(N,null,{title:t(()=>[...u[72]||=[s(`Item title 3`,-1)]]),content:t(()=>[...u[73]||=[s(`Item content 3`,-1)]]),_:1})]),_:1})]),_:1}),o(T,{h3:``,slug:`w-accordion-item--different-title-and-content`},{default:t(()=>[...u[76]||=[s(`Different title and content layouts per item`,-1)]]),_:1}),u[114]||=i(`p`,null,[s(`Same example as `),i(`a`,{href:`#slots--different-title-and-content`},`above`),s(` but using the `),i(`strong`,{class:`code`},`w-accordion-item`),s(` component.`)],-1),o(D,{"content-class":`pa4`},{pug:t(()=>[...u[89]||=[s(`w-accordion(:items="items")
  w-accordion-item
    template(#title)
      | This is the 1st item
      w-tag.ml2(color="red" sm outline) HOT
  ...
  w-accordion-item
    ...
    template(#content)
      ...
      w-button.mt1(bg-color="primary" route="https://github.com/antoniandre/wave-ui")
        | Github
        w-icon.ml2(sm) mdi mdi-open-in-new`,-1)]]),html:t(()=>[...u[90]||=[s(`<w-accordion>
  <w-accordion-item>
    <template #title>
      This is the 1st item
      <w-tag class="ml2" color="red" sm outline>HOT</w-tag>
...
`,-1)]]),default:t(()=>[o(E,{class:`discrete--bg`},{default:t(()=>[o(N,null,{title:t(()=>[u[78]||=s(`This is the 1st item`,-1),o(j,{class:`ml2`,color:`red`,sm:``,outline:``},{default:t(()=>[...u[77]||=[s(`HOT`,-1)]]),_:1})]),content:t(()=>[u[79]||=i(`p`,null,`This content has a checklist.`,-1),u[80]||=i(`div`,{class:`title4`},`To do`,-1),o(M,{checklist:``,color:`primary`,items:[{label:`do this`},{label:`do that next`}]})]),_:1}),o(N,null,{title:t(()=>[o(O,{class:`mr1`,md:``,color:`amber`},{default:t(()=>[...u[81]||=[s(`mdi mdi-emoticon-excited-outline`,-1)]]),_:1}),u[82]||=i(`em`,null,`This is the 2nd item`,-1)]),content:t(()=>[...u[83]||=[i(`p`,null,`The full content here is custom and completely distinct and independent from the other items.`,-1)]]),_:1}),o(N,null,{title:t(()=>[u[85]||=i(`strong`,null,`This is the 3rd item`,-1),o(O,{class:`ml1`,md:``,color:`pink`},{default:t(()=>[...u[84]||=[s(`mdi mdi-emoticon-kiss-outline`,-1)]]),_:1})]),content:t(()=>[u[88]||=i(`p`,null,`Do you want to check the project on Github?`,-1),o(k,{class:`mt1`,"bg-color":`primary`,route:`https://github.com/antoniandre/wave-ui`},{default:t(()=>[u[87]||=s(`Github`,-1),o(O,{class:`ml2`,sm:``},{default:t(()=>[...u[86]||=[s(`mdi mdi-open-in-new`,-1)]]),_:1})]),_:1})]),_:1})]),_:1})]),_:1}),o(T,{h2:``},{default:t(()=>[...u[91]||=[s(`Toggle icon options`,-1)]]),_:1}),o(T,{h3:``},{default:t(()=>[...u[92]||=[s(`Alternative style`,-1)]]),_:1}),u[115]||=i(`p`,null,[s(`With the option `),i(`code`,null,`icon-rotate90`),s(`, the icon will initially point to the left and will
rotate 90 degrees clockwise when expanding.`)],-1),o(D,{"content-class":`pa4`},{pug:t(()=>[...u[93]||=[s(`.title4 Icon on the left
w-accordion(:items="items" icon-rotate90)

.title4.mt6 Icon on the right
w-accordion(:items="items" icon-rotate90 expand-icon-right)`,-1)]]),html:t(()=>[...u[94]||=[s(`<div class="title4">
  Icon on the left
</div>
<w-accordion
  :items="items"
...
<w-accordion
  ...
  icon-rotate90
  expand-icon-right>
</w-accordion>`,-1)]]),js:t(()=>[...u[95]||=[s(`data: () => ({
  items: [
...
`,-1)]]),default:t(()=>[u[96]||=i(`div`,{class:`title4`},`Icon on the left`,-1),o(E,{class:`discrete--bg`,items:l.items,"expand-icon-rotate90":``},null,8,[`items`]),u[97]||=i(`div`,{class:`title4 mt6`},`Icon on the right`,-1),o(E,{class:`discrete--bg`,items:l.items,"expand-icon-rotate90":``,"expand-icon-right":``},null,8,[`items`])]),_:1}),o(T,{h3:``},{default:t(()=>[...u[98]||=[s(`More options`,-1)]]),_:1}),o(D,{"content-class":`pa4`},{pug:t(()=>[...u[99]||=[s(`.title4 1 custom icon (only expand)
...
.title4.mt6 Icon on the right
w-accordion(:items="items" expand-icon-right)`,-1)]]),html:t(()=>[...u[100]||=[s(`<div class="title4 mb2">
...
<w-accordion
  :items="items"
  expand-icon-right>
</w-accordion>`,-1)]]),js:t(()=>[...u[101]||=[s(`data: () => ({
  items: [
    {
      title: 'Item 1',
      content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi ut neque enim beatae autem iure, velit labore aut ipsa voluptatem aliquam distinctio harum. Possimus aliquid voluptatum facere incidunt dolor a.'
