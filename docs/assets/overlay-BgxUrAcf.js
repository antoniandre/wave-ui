import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,vt as s,xt as c}from"./runtime-core.esm-bundler-BuLlhxCm.js";import{t as l}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{b as u}from"./index-DQuwyAuI.js";var d={class:`code inherit`},f={class:`code inherit`};function p(l,u,p,m,h,g){let _=n(`title-link`),v=n(`w-button`),y=n(`w-divider`),b=n(`w-switch`),x=n(`w-input`),S=n(`w-flex`),C=n(`w-icon`),w=n(`w-overlay`),T=n(`example`),E=n(`ssh-pre`);return e(),i(`div`,null,[u[32]||=r(`p`,null,[o(`By default the overlay has a `),r(`span`,{class:`code`},`0.3`),o(` opacity with a black color and a z-index
