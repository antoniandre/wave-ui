import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,l as s,u as c,xt as l}from"./runtime-core.esm-bundler-BuLlhxCm.js";import{t as u}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{V as d}from"./index-DR7O6uV_.js";var f={style:{"max-width":`1000px`}};function p(u,d,p,m,h,g){let _=n(`title-link`),v=n(`w-alert`),y=n(`example`),b=n(`w-button`),x=n(`w-transition-expand`);return e(),i(`div`,f,[a(_,{h2:``},{default:t(()=>[...d[5]||=[o(`Basic`,-1)]]),_:1}),d[95]||=r(`p`,null,[o(`The alert is commonly used to emphasize some content.`),r(`br`),o(`
