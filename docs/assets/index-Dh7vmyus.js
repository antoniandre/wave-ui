...
the following transition name.`)],-1),R={class:"w-flex"},_={class:"w-flex wrap"},z={class:"ma2"},G=a("div",{class:"title3 mb2"},"Transition names",-1),J={class:"ma2"},K=a("div",{class:"title3 mb2"},"Slide transitions for fullscreen",-1),Y=a("p",null,[n("The overlay can be customized via the "),a("code",null,"overlay-opacity"),n(` - if you use the default color
- and `),a("code",null,"overlay-color"),n(" props.")],-1),H=a("div",{class:"spacer"},null,-1);function Q(e,l,q,k,C,u){const r=d("title-link"),s=d("w-button"),g=d("w-icon"),w=d("w-checkbox"),f=d("w-radios"),c=d("w-dialog"),m=d("example"),h=d("w-radio");return b(),v("div",null,[t(r,{h2:""},{default:o(()=>[n("Global demo")]),_:1}),T,t(m,{"content-class":"pt5"},{pug:o(()=>[n(`w-button.px4(@click="dialog.show = true") Open dialog
...
w-dialog(
  ...
  w-button.my6(@click="dialog.show = false" bg-color="error") Close`)]),html:o(()=>[n(`<div class="w-flex">
  <w-button
    class="px4 mr6"
