import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,xt as s}from"./runtime-core.esm-bundler-BuLlhxCm.js";import{t as c}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{i as l}from"./index-BazmI9KH.js";function u(c,l,u,d,f,p){let m=n(`title-link`),h=n(`w-timeline`),g=n(`example`),_=n(`w-icon`),v=n(`w-tag`);return e(),i(`div`,null,[a(m,{h2:``},{default:t(()=>[...l[0]||=[o(`Basic`,-1)]]),_:1}),a(g,null,{pug:t(()=>[...l[1]||=[o(`w-timeline(:items="items")`,-1)]]),html:t(()=>[...l[2]||=[o(`<w-timeline :items="items"></w-timeline>`,-1)]]),js:t(()=>[...l[3]||=[o(`data: () => ({
  items: [
