import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,m as s}from"./runtime-core.esm-bundler-BuLlhxCm.js";import{t as c}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{d as l}from"./index-DQuwyAuI.js";function u(c,l,u,d,f,p){let m=n(`title-link`),h=n(`w-spinner`),g=n(`example`),_=n(`w-button`);return e(),i(`div`,null,[l[21]||=r(`p`,null,[o(`If you want a different style than the `),r(`span`,{class:`code`},`w-progress`),o(` component, the spinner is a light
