import{n as o,L as r}from"./index.e31dd236.js";var d=function(){var t=this,a=t.$createElement,e=t._self._c||a;return e("div",[e("title-link",{attrs:{h2:""}},[t._v("Basic")]),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v('w-tabs(:items="tabs")')]},proxy:!0},{key:"html",fn:function(){return[t._v('<w-tabs :items="tabs"></w-tabs>')]},proxy:!0},{key:"js",fn:function(){return[t._v(`data: () => ({
  tabs: [
...
`)]},proxy:!0}])},[e("w-tabs",{attrs:{items:t.tabs1}})],1),e("title-link",{attrs:{h2:""}},[t._v("Align center and right")]),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v(`w-tabs(:items="tabs" center)
br
w-tabs(:items="tabs" right)`)]},proxy:!0},{key:"html",fn:function(){return[t._v(`<w-tabs :items="tabs" center></w-tabs>
<br />
...
`)]},proxy:!0}])},[e("w-tabs",{attrs:{items:t.tabs4.items,center:""}}),e("w-tabs",{staticClass:"mt4",attrs:{items:t.tabs4.items,right:""}})],1),e("title-link",{attrs:{h2:""}},[t._v("Fill bar & disabled items")]),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v(`w-switch.mb3(v-model="fillBar") Fill bar
w-tabs(:items="tabs" :fill-bar="fillBar")`)]},proxy:!0},{key:"html",fn:function(){return[t._v(`<w-switch v-model="fillBar" class="mb3">
  Fill bar
</w-switch>
...
`)]},proxy:!0}])},[e("w-switch",{staticClass:"mb3",model:{value:t.tabs2.fillBar,callback:function(n){t.$set(t.tabs2,"fillBar",n)},expression:"tabs2.fillBar"}},[t._v("Fill bar")]),e("w-tabs",{attrs:{items:t.tabs2.items,"fill-bar":t.tabs2.fillBar}})],1),e("title-link",{attrs:{h2:""}},[t._v("V-model")]),e("alert",{attrs:{warning:""}},[e("strong",[t._v("Since version 1.21.0")]),t._v(", the v-model/value only accepts a numeric tab index (previously an array of boolean).")]),t._m(0),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v(`w-tabs(v-model="activeTab" :items="tabs")
strong
  | v-model:
  code.ml2 `+t._s("{{ activeTab }}"))]},proxy:!0},{key:"html",fn:function(){return[t._v(`<w-tabs v-model="activeTab" :items="tabs"></w-tabs>
...
`)]},proxy:!0}])},[e("w-tabs",{attrs:{items:t.tabs2.items,color:"blue","bg-color":"indigo-light5"}})],1),e("div",{staticClass:"title3 mt4"},[t._v("Slider color")]),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v('w-tabs(:items="tabs" slider-color="blue-light2")')]},proxy:!0},{key:"html",fn:function(){return[t._v(`<w-tabs
  :items="tabs"
...
`)]},proxy:!0}])},[e("w-tabs",{attrs:{items:t.tabs2.items,"slider-color":"blue-light2"}})],1),e("div",{staticClass:"title3"},[t._v("Active class")]),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v(`w-tabs(
  :items="tabs"
  color="blue"
  active-class="pink"
  slider-color="pink")`)]},proxy:!0},{key:"html",fn:function(){return[t._v(`<w-tabs
  :items="tabs"
  color="blue"
  active-class="pink"
  slider-color="pink">
...
`)]},proxy:!0}])},[e("w-tabs",{attrs:{items:t.tabs2.items,color:"blue","active-class":"pink","slider-color":"pink"}})],1),e("title-link",{attrs:{h2:""}},[t._v("Pill slider")]),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v('w-tabs(:items="tabs" pill-slider)')]},proxy:!0},{key:"html",fn:function(){return[t._v('<w-tabs :items="tabs" pill-slider></w-tabs>')]},proxy:!0},{key:"js",fn:function(){return[t._v(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3', content: 'Tab 3 content.' },
...
})`)]},proxy:!0}])},[e("w-tabs",{attrs:{items:t.tabs2.items,"pill-slider":""}})],1),e("title-link",{attrs:{h3:""}},[t._v("Example of a different style, involving some external CSS")]),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v('w-tabs(:items="tabs" pill-slider)')]},proxy:!0},{key:"html",fn:function(){return[t._v('<w-tabs :items="tabs" pill-slider></w-tabs>')]},proxy:!0},{key:"js",fn:function(){return[t._v(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3', content: 'Tab 3 content.' },
...
})`)]},proxy:!0},{key:"css",fn:function(){return[t._v(`.w-app .w-tabs {border: none;}
.w-app .w-tabs__bar {
  display: inline-flex;
  margin-bottom: 12px;
  padding: 0;
...
`)]},proxy:!0}])},[e("w-tabs",{staticClass:"macos-tabs",attrs:{items:t.tabs2.items,"pill-slider":""}})],1),e("title-link",{attrs:{h2:""}},[t._v("No slider")]),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v(`w-switch.mb3(v-model="tabsSlider") Slider
w-tabs(:items="tabs" :no-slider="!tabsSlider" active-class="pink")`)]},proxy:!0},{key:"html",fn:function(){return[t._v(`<w-switch class="mb3" v-model="tabsSlider">
  Slider
</w-switch>
...
too many, a scrollbar will allow navigation to all the tabs.`)]),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v(`w-flex.mb3(align-center)
  | Number of tabs:
...
w-tabs(:items="tabsCount")
  ...
  template(#item-content="{ index }") Content `+t._s("{{ index }}"))]},proxy:!0},{key:"html",fn:function(){return[t._v(`<w-flex class="mb3" align-center>
  Number of tabs:
  <w-button
    class="mx2"
    icon="wi-minus"
...
`)]},proxy:!0}])},[e("w-flex",{staticClass:"mb3",attrs:{"align-center":""}},[t._v("Number of tabs:"),e("w-button",{staticClass:"mx2",attrs:{icon:"wi-minus",sm:""},on:{click:function(n){t.tabs3.tabsCount-=t.tabs3.tabsCount<1?0:1}}}),e("code",[t._v(t._s(t.tabs3.tabsCount))]),e("w-button",{staticClass:"mx2",attrs:{icon:"wi-plus",sm:""},on:{click:function(n){t.tabs3.tabsCount++}}})],1),e("w-tabs",{attrs:{items:t.tabs3.tabsCount},scopedSlots:t._u([{key:"item-title",fn:function(n){var i=n.index;return[t._v("Tab "+t._s(i))]}},{key:"item-content",fn:function(n){var i=n.index;return[t._v("Content "+t._s(i))]}}])})],1),e("title-link",{attrs:{h2:""}},[t._v("Card style tabs")]),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v('w-tabs(:items="tabs" card)')]},proxy:!0},{key:"html",fn:function(){return[t._v('<w-tabs :items="tabs" card></w-tabs>')]},proxy:!0},{key:"js",fn:function(){return[t._v(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3 has a long title', content: 'Tab 3 content.' }
...
the navigation to the tab that you are deleting!`)]),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v(`w-tabs(:items="tabs" card)
  template(#item-title="{ item, index }")
    ...
    w-button.ml1.mr-1(
      ...
      icon="wi-cross"
      outline
      xs)`)]},proxy:!0},{key:"html",fn:function(){return[t._v(`<w-tabs :items="tabs" card>
  <template #item-title="{ item, index }">
    `+t._s("{{ item.title }}")+`
    <w-button
      class="ml1 mr-1"
...
`)]},proxy:!0}])},[e("w-tabs",{attrs:{items:t.tabs6.items,card:""},scopedSlots:t._u([{key:"item-title",fn:function(n){var i=n.item,s=n.index;return[t._v(t._s(i.title)),e("w-button",{staticClass:"ml1 mr-1",attrs:{icon:"wi-cross",outline:"",xs:""},on:{click:function(u){return u.stopPropagation(),t.tabs6.items.splice(s-1,1)}}})]}}])}),e("w-button",{staticClass:"mt4",attrs:{"bg-color":"primary",disabled:t.tabs6.items.length===3},on:{click:function(n){t.tabs6.items=t.tabs6.originals.slice(0)}}},[t._v("Reset tabs")])],1),e("title-link",{attrs:{h2:""}},[t._v("Customizing the tabs title & contents")]),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v(`w-tabs(:items="tabs" card)
  ...
  template(#item-content.1="{ item }")
    ...
    div(v-html="item.content")`)]},proxy:!0},{key:"html",fn:function(){return[t._v(`<w-tabs :items="tabs" card>
  <template #item-title="{ item }">
...
`)]},proxy:!0}])},[e("w-tabs",{attrs:{items:t.tabs5,card:""},scopedSlots:t._u([{key:"item-title",fn:function(n){var i=n.item;return[e("w-icon",{staticClass:"mr1 green"},[t._v("mdi mdi-star")]),e("span",{staticClass:"green"},[t._v(t._s(i.title))])]}},{key:"item-title.3",fn:function(n){var i=n.item;return[e("w-icon",{staticClass:"pink"},[t._v("mdi mdi-heart")]),e("span",{staticClass:"pink mx1"},[t._v(t._s(i.title))]),e("w-icon",{staticClass:"pink"},[t._v("mdi mdi-heart")])]}},{key:"item-content.1",fn:function(n){var i=n.item;return[e("div",{staticClass:"title3"},[t._v("This is a custom tab content.")]),e("div",{domProps:{innerHTML:t._s(i.content)}})]}}])})],1),e("title-link",{attrs:{h2:""}},[t._v("Adding a tabs bar extra element")]),t._m(2),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v(`w-tabs(:items="tabs.tabsCount" v-model="tabs.currentTab")
  template(#item-title="{ index }") Item title `+t._s("{{ index }}")+`
  template(#item-content="{ index }") Item content `+t._s("{{ index }}")+`
  template(#tabs-bar-extra)
    w-button.bdrsr.mr2(
      icon="wi-plus"
      @click="tabs.tabsCount++;$nextTick(() => tabs.currentTab = tabs.tabsCount - 1)")`)]},proxy:!0},{key:"html",fn:function(){return[t._v(`<w-tabs
...
`)]},proxy:!0}])},[e("w-tabs",{attrs:{items:t.tabs7.tabsCount},scopedSlots:t._u([{key:"item-title",fn:function(n){var i=n.index;return[t._v("Item title "+t._s(i))]}},{key:"item-content",fn:function(n){var i=n.index;return[t._v("Item content "+t._s(i))]}},{key:"tabs-bar-extra",fn:function(){return[e("w-button",{staticClass:"bdrsr mr2",attrs:{icon:"wi-plus"},on:{click:function(n){t.tabs7.tabsCount++,t.$nextTick(function(){return t.tabs7.currentTab=t.tabs7.tabsCount-1})}}})]},proxy:!0}]),model:{value:t.tabs7.currentTab,callback:function(n){t.$set(t.tabs7,"currentTab",n)},expression:"tabs7.currentTab"}})],1),e("title-link",{attrs:{h2:""}},[t._v("Refreshing the slider width or position")]),t._m(3),e("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v(`w-tabs(ref="tabs" :items="tabs")
  template(#item-content="{ item }")
    w-input.my6(v-model="item.title" label="Tab title" @keyup="onTitleChange")`)]},proxy:!0},{key:"html",fn:function(){return[t._v(`<w-tabs ref="tabs" :items="tabs">
  <template #item-content="{ item }">
    <w-input
      v-model="item.title"
      class="my6"
...
}`)]},proxy:!0}])},[e("w-tabs",{ref:"tabs",attrs:{items:t.tabs8},scopedSlots:t._u([{key:"item-content",fn:function(n){var i=n.item;return[e("w-input",{staticClass:"my6",attrs:{label:"Tab title"},on:{keyup:t.onTitleChange},model:{value:i.title,callback:function(s){t.$set(i,"title",s)},expression:"item.title"}})]}}])})],1)],1)},m=[function(){var t=this,a=t.$createElement,e=t._self._c||a;return e("p",[t._v("It is possible to open a particular tab programmatically via "),e("code",[t._v("v-model")]),t._v(" or "),e("code",[t._v("value")]),t._v(".")])},function(){var t=this,a=t.$createElement,e=t._self._c||a;return e("p",[t._v("Like in most components, you can set a "),e("code",[t._v("color")]),t._v(" for the text and a "),e("code",[t._v("bg-color")]),t._v(` for the
background. You can also set a `),e("code",[t._v("slider-color")]),t._v(" and an "),e("code",[t._v("active-class")]),t._v(`.
`)])},function(){var t=this,a=t.$createElement,e=t._self._c||a;return e("p",[t._v("You can add extra elements at the right of the tabs title bar via the "),e("code",[t._v("tabs-bar-extra")]),t._v(" slot."),e("br"),t._v(`
Once the tabs are updated (in the next Vue tick), you can open the newly added tab.`)])},function(){var t=this,a=t.$createElement,e=t._self._c||a;return e("p",[t._v("By default there is no data watcher on the tabs title to recalculate the slider width or position."),e("br"),t._v(`
