import{C as e,N as t,R as n,W as r,bt as i,c as a,d as o,g as s,h as c,k as l}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as u}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{S as d}from"./index-D3Rumh9E.js";var f={class:`mt4`},p={class:`ml1`};function m(u,d,m,h,g,_){let v=t(`title-link`),y=t(`w-button`),b=t(`w-menu`),x=t(`example`),S=t(`w-switch`),C=t(`w-flex`),w=t(`w-toolbar`),T=t(`w-card`),E=t(`w-list`),D=t(`alert`);return l(),o(`div`,null,[s(v,{h2:``},{default:r(()=>[...d[15]||=[c(`Basic`,-1)]]),_:1}),s(x,{class:`example1`,"content-class":`text-center pt5`,"app-classes-string":`align-center`},{pug:r(()=>[...d[18]||=[c(`w-menu
