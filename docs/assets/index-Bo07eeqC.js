import{r as a,o as m,g as u,d as i,b as s,a as n,w as o,h as b,_ as f,a4 as v}from"./index-BhQVIzBi.js";function h(l,e,c,w,g,d){const r=a("title-link"),t=a("w-spinner"),p=a("example"),x=a("w-button");return m(),u("div",null,[e[21]||(e[21]=i("p",null,[s("If you want a different style than the "),i("span",{class:"code"},"w-progress"),s(` component, the spinner is a light
alternative that you can easily use anywhere.
`)],-1)),n(r,{h2:""},{default:o(()=>e[1]||(e[1]=[s("Three dots (default)")])),_:1}),n(p,{"content-class":"w-flex justify-center"},{pug:o(()=>e[2]||(e[2]=[s("w-spinner")])),html:o(()=>e[3]||(e[3]=[s(`<w-spinner />
`)])),default:o(()=>[n(t)]),_:1}),n(r,{h2:""},{default:o(()=>e[4]||(e[4]=[s("Fade")])),_:1}),n(p,{"content-class":"w-flex justify-center"},{pug:o(()=>e[5]||(e[5]=[s("w-spinner(fade)")])),html:o(()=>e[6]||(e[6]=[s(`<w-spinner fade />
`)])),default:o(()=>[n(t,{fade:""})]),_:1}),n(r,{h2:""},{default:o(()=>e[7]||(e[7]=[s("Bounce")])),_:1}),n(p,{"content-class":"w-flex justify-center"},{pug:o(()=>e[8]||(e[8]=[s("w-spinner(bounce)")])),html:o(()=>e[9]||(e[9]=[s(`<w-spinner bounce />
`)])),default:o(()=>[n(t,{bounce:""})]),_:1}),n(r,{h2:""},{default:o(()=>e[10]||(e[10]=[s("Model-value or v-model")])),_:1}),e[22]||(e[22]=i("p",null,[s("Both the "),i("code",null,"model-value"),s(" (or "),i("code",null,"value"),s(" for Vue 2) and "),i("code",null,"v-model"),s(` will control the spinner visibility, but there is not
...
`)])),default:o(()=>[n(x,{class:"mr4",onClick:e[0]||(e[0]=C=>l.showSpinner=!l.showSpinner)},{default:o(()=>e[11]||(e[11]=[s("Toggle spinner")])),_:1}),n(t,{"model-value":l.showSpinner},null,8,["model-value"])]),_:1}),n(r,{h2:""},{default:o(()=>e[15]||(e[15]=[s("Sizes")])),_:1}),e[23]||(e[23]=b(`<p>The spinner size can be controlled via the preset sizes <code>xs</code>, <code>sm</code>, <code>md</code>,
