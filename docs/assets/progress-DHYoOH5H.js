...
w-progress.ma1(circle v-model="progress" size="5em")
  strong `+s(`{{ progress }}`)+`%`,-1)]]),html:t(()=>[...l[21]||=[o(`<p>Default label - Custom label</p>
...
`,-1)]]),default:t(()=>[l[23]||=r(`p`,null,`Default label \xA0 - \xA0 Custom label`,-1),a(h,{class:`ma1 mr8`,circle:``,modelValue:c.progress1,"onUpdate:modelValue":l[0]||=e=>c.progress1=e,size:`5em`,label:``},null,8,[`modelValue`]),a(h,{class:`ma1`,circle:``,modelValue:c.progress1,"onUpdate:modelValue":l[1]||=e=>c.progress1=e,size:`5em`},{default:t(()=>[r(`strong`,null,s(c.progress1)+`%`,1)]),_:1},8,[`modelValue`])]),_:1}),l[35]||=r(`h3`,null,`Providing a color for the custom label`,-1),a(g,{reactive:``},{pug:t(()=>[...l[24]||=[o(`w-progress.ma1(
  circle
  model-value="38"
  size="3em"
  label
...
`,-1)]]),default:t(()=>[a(h,{modelValue:c.progress1,"onUpdate:modelValue":l[2]||=e=>c.progress1=e,size:`1.3em`,round:``,color:`primary`,label:``},null,8,[`modelValue`]),a(h,{class:`mt4`,modelValue:c.progress1,"onUpdate:modelValue":l[3]||=e=>c.progress1=e,size:`1.3em`,outline:``,round:``,label:``},null,8,[`modelValue`])]),_:1}),l[66]||=r(`h3`,null,`Custom label`,-1),a(g,{reactive:``},{pug:t(()=>[...l[56]||=[o(`w-progress(v-model="progress" size="1.5em" outline round)
  strong `+s(`{{ progress }}`)+`%`,-1)]]),html:t(()=>[...l[57]||=[o(`<w-progress v-model="progress" size="1.5em" outline round>
  <strong>`+s(`{{ progress }}`)+`%</strong>
</w-progress>`,-1)]]),js:t(()=>[...l[58]||=[o(`data: () => ({
  progress: 37.86
})
`,-1)]]),default:t(()=>[a(h,{class:`mt3`,modelValue:c.progress1,"onUpdate:modelValue":l[4]||=e=>c.progress1=e,size:`1.5em`,outline:``,round:``},{default:t(()=>[r(`strong`,null,s(c.progress1)+`%`,1)]),_:1},8,[`modelValue`])]),_:1}),l[67]||=r(`h3`,null,`Providing a color for the custom label`,-1),l[68]||=r(`p`,null,[o(`The color of the label should be readable on both the progress and the background.`),r(`br`),o(`
