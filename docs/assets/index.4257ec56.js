import{n as o,b as a}from"./index.583eb76b.js";import"./vendor.4f8da9ec.js";var l=function(){var e=this,n=e.$createElement,t=e._self._c||n;return t("div",[e._m(0),t("div",{staticClass:"caption grey-light1"},[e._v(`There should only be one <w-app> in your whole app.
...
`)]},proxy:!0}])},[t("fieldset",{staticClass:"app w-flex column"},[t("legend",[e._v("w-app")]),t("section",{staticClass:"header"},[e._v("Header")]),t("div",{staticClass:"w-flex grow"},[t("section",{staticClass:"nav-menu block"},[e._v("Nav menu")]),t("section",{staticClass:"content block grow"},[e._v("Main content")])]),t("section",{staticClass:"footer"},[e._v("Footer")])])])],1),t("w-badge",{attrs:{"bg-color":"orange",color:"white",overlap:"",value:2}},[t("example",{staticClass:"ma0 grow",attrs:{"content-class":"pa0","blank-codepen":["html","pug","css"]},scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-app#app
  aside Nav menu
  w-flex(grow)
    header Header
    main.grow Main content
    footer Footer`)]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-app id="app" class="w-flex row">
  <aside>Nav menu</aside>
  <w-flex column>
    <header>Header</header>
    <main class="grow">Main content</main>
...
`),t("router-link",{staticClass:"mx1",attrs:{to:"/layout--flex"}},[e._v("Layout > Flex")]),e._v(" knowledge base page.")],1)],1)],1)},i=[function(){var e=this,n=e.$createElement,t=e._self._c||n;return t("p",[e._v("This tag is required in your app for Wave UI proper functioning."),t("br"),e._v(`
...
It can also be helpful to open it in a Codepen to quickly tweak it before you integrate it in your app. :)`)])}];const p={},r={};var d=o(p,l,i,!1,u,null,null,null);function u(e){for(let n in r)this[n]=r[n]}var f=function(){return d.exports}(),v=function(){var e=this,n=e.$createElement,t=e._self._c||n;return t("div",[t("div",{staticClass:"w-divider my12"}),t("title-link",{staticClass:"title1",attrs:{h2:""}},[e._v("API")]),t("component-api",{staticClass:"mt0",attrs:{items:e.props,descriptions:e.propsDescs,title:"Props"}}),t("component-api",{attrs:{items:e.slots,title:"Slots"}}),t("component-api",{attrs:{items:e.events,title:"Events"}})],1)},_=[];const m={block:"Sets the layout to <code>display: block</code>. By default the layout is: <code>display: flex</code>, <code>flex-direction: column</code>.",dark:!1},h={default:{description:"The content of the app."}},g={},w={data:()=>({propsDescs:m,slots:h}),computed:{props(){return a.props},events(){return(a.emits||[]).reduce((e,n)=>(e[n]={description:g[n]||""})&&e,{})}}},s={};var b=o(w,v,_,!1,x,null,null,null);function x(e){for(let n in s)this[n]=s[n]}var y=function(){return b.exports}(),k=function(){var e=this,n=e.$createElement,t=e._self._c||n;return t("main",[t("ui-component-title",[e._v("w-app")]),t("examples"),t("api")],1)},C=[];const $={components:{Examples:f,Api:y}},c={};var F=o($,k,C,!1,M,null,null,null);function M(e){for(let n in c)this[n]=c[n]}var I=function(){return F.exports}();export{I as default};
