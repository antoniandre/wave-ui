import{r as t,o as i,g as r,a as d,w as n,b as s,d as e,F as h,l as u,n as x,t as a,h as y,_ as j}from"./index-DmbSWeYz.js";const Y=e("p",null,[s("Wave UI offers a few CSS helper classes to control the drop shadow, borders and border radii."),e("br"),s(`
You can use these classes on any component and any DOM element, even if the element is not part of
Wave UI.`),e("br")],-1),k=e("br",null,null,-1),S=e("p",null,[s("Element shadows range from "),e("code",null,"-6"),s(" to "),e("code",null,"6"),s(`. Negative values will produce an inset shadow,
...
radius, <code>.bdrsm</code> will produce a <strong>max</strong> border radius (<span class="code">100%</span>).</p>`,1),E=e("code",null,".bdrsr",-1),T=e("code",null,".bdrsm",-1),V=e("div",{class:"w-flex"},[e("div",{class:"box box--rect blue-light5--bg ma4 d-flex align-center justify-center bdrsr"},[e("span",{class:"code"},".bdrsr")]),e("div",{class:"box box--rect blue-light5--bg ma4 d-flex align-center justify-center bdrsm"},[e("span",{class:"code"},".bdrsm")])],-1),A={class:"w-flex wrap"},q={class:"code"},D=e("div",{class:"box blue-light5--bg ma4 d-flex align-center justify-center bdrsr"},[e("span",{class:"code"},".bdrsr")],-1),F=e("div",{class:"box blue-light5--bg ma4 d-flex align-center justify-center bdrsm"},[e("span",{class:"code"},".bdrsm")],-1),W=e("p",null,"Below are a few examples of components which accept the presented classes.",-1),z=e("span",{class:"caption mt3"},[e("strong",{class:"code"},"w-image"),s(" with "),e("code",{class:"mx1"},".bd1"),s(", "),e("code",{class:"mx1"},".bdrsr"),s(" and "),e("code",{class:"mx1"},".sh1"),s(" classes.")],-1),H=e("strong",{class:"code mx1"},"w-switch",-1),L=e("code",{class:"mx1"},".bdrs1",-1),M=e("div",{class:"caption"},[s("a "),e("strong",{class:"code mx1"},"w-card"),s(" with "),e("code",{class:"mx1"},".bd0"),s(", "),e("code",{class:"mx1"},".bdrs4"),s(" and "),e("code",{class:"mx1"},".sh2"),s(" classes.")],-1),O=e("div",{class:"title5 mb0"},[s("Accordion with "),e("code",{class:"mx1"},".bd1"),s(" and "),e("code",{class:"mx1"},".bdrs2"),s(" classes.")],-1),R=e("strong",{class:"code mx1"},"w-card",-1),G=e("code",{class:"mx1"},".bd0",-1),J=e("code",{class:"mx1"},".bdrs4",-1),K=e("code",{class:"mx1"},".sh2",-1),P=e("code",{class:"mx1"},".bd1",-1),Q=e("code",{class:"mx1"},".bdrs2",-1);function X(w,ss,es,ns,ds,os){const l=t("title-link"),b=t("alert"),c=t("example"),p=t("w-divider"),f=t("w-image"),m=t("w-flex"),_=t("w-switch"),g=t("w-card"),v=t("w-accordion");return i(),r("main",null,[d(l,{class:"mt4",h1:""},{default:n(()=>[s("shadows, borders & border radii")]),_:1}),Y,d(b,{tip:""},{default:n(()=>[s(`The following offered classes are targeting the common use cases: there isn't a CSS class for
anything you want to accomplish. It's of course a trade-off to keep the library lean.`),k,s(`
...
</w-flex>`)]),css:n(()=>[s(".box {\n  width: 80px;\n  height: 80px;\n  margin: 4px; /* You could use the class `ma1`. */\n  background-color: #e3f2fd; /* You could use the class `blue-light5--bg`. */\n  display: flex; /* You could use the class `d-flex`. */\n  align-items: center; /* You could use the class `align-center`. */\n  justify-content: center; /* You could use the class `justify-center`. */\n}\n")]),default:n(()=>[e("div",A,[(i(),r(h,null,u(7,o=>e("div",{class:x(["box blue-light5--bg ma4 d-flex align-center justify-center",`bdrs${o-1}`]),key:o},[e("span",q,".bdrs"+a(o-1),1)],2)),64)),D,F])]),_:1}),d(p,{class:"my12"}),d(l,{h2:""},{default:n(()=>[s("Examples of use on UI components")]),_:1}),W,d(c,null,{pug:n(()=>[s('w-flex(align-center justify-space-around wrap)\n  w-flex.no-grow(column align-center justify-center)\n    w-image.bd1.sh1.bdrsr.d-block(\n      :src="`${baseUrl}images/japanese-wave.png`"\n      :width="100"\n      :height="100")\n    span.mt3 w-image with `.bd1`, `.bdrsr` and `.sh1` classes.\n  w-switch.bdrs1.my4(:model-value="true") a w-switch with a `.bdrs1` class.')]),html:n(()=>[s(`<w-flex align-center justify-space-around wrap>
