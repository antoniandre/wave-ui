import{N as e,W as t,bt as n,c as r,d as i,g as a,h as o,k as s}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as c}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{B as l,f as u}from"./index-CRFKPP-0.js";var d={class:`mt4`},f={class:`ml1`},p={class:`mt4`},m={class:`ml1`},h={class:`mt4`},g={class:`ml1`},_={class:`mt4`},v={class:`ml1`},y={class:`mt4`},b={class:`ml1`};function x(c,l,u,x,S,C){let w=e(`title-link`),T=e(`w-slider`),E=e(`example`),D=e(`w-button`),O=e(`w-flex`),k=e(`w-icon`);return s(),i(`div`,null,[a(w,{h2:``},{default:t(()=>[...l[8]||=[o(`Default`,-1)]]),_:1}),l[47]||=r(`p`,null,[o(`By default the range will have the `),r(`code`,null,`primary`),o(` color.`)],-1),a(E,{"content-class":`pa6`},{html:t(()=>[...l[9]||=[o(`<w-slider :model-value="50"></w-slider>
