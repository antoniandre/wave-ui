import{N as e,U as t,W as n,c as r,d as i,g as a,gt as o,h as s,k as c,m as l,yt as u}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{s as d}from"./runtime-dom.esm-bundler-Cc0sF0om.js";import{t as f}from"./_plugin-vue_export-helper-S3RvzygF.js";import{O as p}from"./index-CKcZQ2YR.js";var m={class:`py12 w-flex column align-center justify-center`},h={class:`py12 w-flex column align-center justify-center`},g={class:`w-flex pa2 align-center wrap`},_={class:`w-flex align-center py1`},v={class:`w-flex align-center justify-center fill-height`};function y(f,p,y,b,x,S){let C=e(`title-link`),w=e(`w-button`),T=e(`example`),E=e(`w-drawer`),D=e(`w-card`),O=e(`w-icon`),k=e(`ssh-pre`);return c(),i(`div`,null,[a(C,{h2:``},{default:t(()=>[...p[29]||=[s(`Basic`,-1)]]),_:1}),a(T,{"content-class":`w-flex align-center wrap`},{pug:t(()=>[...p[31]||=[s(`w-button(@click="openDrawer = true" outline) Open drawer
