import{r as l,g as i,o as b,a as o,b as n,h as Y,w as d,e,F as u,k as m,n as x,t as w,_ as S}from"./index-CAQLAca3.js";const C={class:"w-flex wrap"},$={class:"code"},I={class:"w-flex wrap"},U={class:"code"},B={class:"w-flex wrap"},N={class:"code"};function E(f,s,V,A,q,D){const a=l("title-link"),c=l("alert"),r=l("example"),g=l("w-divider"),v=l("w-image"),p=l("w-flex"),y=l("w-switch"),j=l("w-card"),h=l("w-accordion-item"),k=l("w-accordion");return b(),i("main",null,[o(a,{class:"mt4",h1:""},{default:d(()=>s[0]||(s[0]=[e("shadows, borders & border radii")])),_:1}),s[31]||(s[31]=n("p",null,[e("Wave UI offers a few CSS helper classes to control the drop shadow, borders and border radii."),n("br"),e(`
