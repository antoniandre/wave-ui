...
but you can override that with the <code>item-icon-color-key</code> prop.</p>`,2),$={class:"w-flex wrap align-center"},B=t("div",{class:"title3"},"Normal",-1),A=t("div",{class:"title3"},"unexpandable-empty",-1),N=t("p",null,[n("When the tree is "),t("code",null,"selectable"),n(", you can use the "),t("code",null,"v-model"),n(" to get the selected item.")],-1),D=t("p",null,"Click on a tree item to select it.",-1),V={class:"w-flex mt6"},M=t("strong",{class:"mr3"},"Selection:",-1),R=w('<p>Multiple events are fired from the <strong class="code">w-tree</strong> component:</p><ul class="lh0"><li><code>before-open</code>: fired as soon as the user clicks a tree item that is expandable and before the subitems are revealed.</li><li class="mt1"><code>open</code>: fired after a user clicks a tree item that is expandable, and after the expand animation.</li><li class="mt1"><code>before-close</code>: fired as soon as the user clicks a tree item to close its subtree.</li><li class="mt1"><code>close</code>: fired after a user clicks a tree item to close its subtree, and after the collapse animation.</li><li class="mt1"><code>click</code>: fired when the user clicks any tree item.</li><li class="mt1"><code>select</code>: fired when the user selects any selectable tree item. The <code>selectable</code> option must be set to true.</li><li class="mt1"><code>update:model-value</code>: (or <code>input</code> in Vue 2.x) fired when the user selects any selectable tree item. The <code>selectable</code> option must be set to true.</li></ul>',2),T=["innerHTML"],P=t("strong",{class:"black"},"Note on reactivity",-1),z={class:"black mt2"},O=t("code",null,"deep-reactivity",-1),H=t("br",null,null,-1),K={href:"https://vuejs.org/guide/essentials/watchers.html#deep-watchers",target:"_blank"},W=t("p",null,[n("If you need to customize the layout of the item label and/or icon, you can use the "),t("code",null,"#item"),n(" slot.")],-1);function q(a,o,h,y,k,m){const r=d("title-link"),s=d("w-tree"),i=d("example"),u=d("w-icon"),j=d("w-card"),x=d("w-flex"),C=d("alert");return b(),g("div",null,[l(r,{h2:""},{default:e(()=>[n("Default")]),_:1}),l(i,null,{pug:e(()=>[n('w-tree(:data="tree")')]),html:e(()=>[n('<w-tree :data="tree"></w-tree>')]),js:e(()=>[n(`data: () => ({
  tree: [
    {
      label: 'src',
      children: [
...
`)]),default:e(()=>[l(s,{data:a.tree2},null,8,["data"])]),_:1}),l(r,{h2:""},{default:e(()=>[n("Icons")]),_:1}),I,l(i,null,{pug:e(()=>[n(`w-tree.size--md(
  :data="tree"
...
`)]),default:e(()=>[l(s,{class:"size--md",data:a.tree2,"expand-icon":"mdi mdi-plus","expand-open-icon":"mdi mdi-minus","branch-icon":"mdi mdi-folder-outline","branch-open-icon":"mdi mdi-folder-open-outline","leaf-icon":"mdi mdi-file-outline"},null,8,["data"])]),_:1}),l(r,{h3:""},{default:e(()=>[n("Different icon per item")]),_:1}),E,l(i,null,{pug:e(()=>[n(`w-tree.size--md(
  :data="tree"
  expand-icon="mdi mdi-plus"
  expand-open-icon="mdi mdi-minus"
  branch-icon="mdi mdi-folder-outline"
...
`)]),default:e(()=>[t("div",$,[t("div",null,[B,l(s,{data:a.tree1},null,8,["data"])]),l(u,{class:"grey-light3 mx12",rotate90a:"",xl:""},{default:e(()=>[n("wi-arrow-down")]),_:1}),t("div",null,[A,l(s,{data:a.tree1,"unexpandable-empty":""},null,8,["data"])])])]),_:1}),l(r,{h2:""},{default:e(()=>[n("V-model")]),_:1}),N,D,l(i,null,{pug:e(()=>[n('w-tree(v-model="selection" :data="tree" selectable)')]),html:e(()=>[n('<w-tree v-model="selection" :data="tree" selectable></w-tree>')]),js:e(()=>[n(`data: () => ({
  tree: [
    {
      label: 'Branch 1',
      children: [
...
`)]),default:e(()=>[l(s,{modelValue:a.selection,"onUpdate:modelValue":o[0]||(o[0]=c=>a.selection=c),data:a.tree1,selectable:""},null,8,["modelValue","data"]),t("div",V,[M,t("pre",{class:S(["pa2",a.$store.state.darkMode?"grey-dark6--bg":"orange-light6--bg"])},p(a.selection),3)])]),_:1}),l(r,{h2:""},{default:e(()=>[n("Events")]),_:1}),R,l(i,null,{pug:e(()=>[n(`w-tree(
  :data="tree"
...
`)]),default:e(()=>[l(x,{gap:"12"},{default:e(()=>[l(s,{data:a.tree2,onBeforeOpen:o[1]||(o[1]=c=>m.log("@before-open",c)),onOpen:o[2]||(o[2]=c=>m.log("@open",c)),onBeforeClose:o[3]||(o[3]=c=>m.log("@before-close",c)),onClose:o[4]||(o[4]=c=>m.log("@close",c)),onClick:o[5]||(o[5]=c=>m.log("@click",c)),onSelect:o[6]||(o[6]=c=>m.log("@select",c)),selectable:""},null,8,["data"]),l(j,{"bg-color":a.$store.state.darkMode?"grey-dark6":"amber-light6",title:"Event log","title-class":a.$store.state.darkMode?"grey-dark5--bg":"amber-light5--bg"},{default:e(()=>[t("pre",{innerHTML:a.logs},null,8,T)]),_:1},8,["bg-color","title-class"])]),_:1})]),_:1}),l(r,{h3:""},{default:e(()=>[n("Real-case scenario: Renaming a leaf item on click")]),_:1}),l(i,null,{pug:e(()=>[n('w-tree(:data="tree3" @click="renameLeafItem" deep-reactivity)')]),html:e(()=>[n(`<w-tree
  :data="tree"
...
like the label, you will need to add the `),O,n(" option."),H,t("a",K,[n("Read on deep watchers on the Vue.js official documentation"),l(u,{class:"ml1"},{default:e(()=>[n("mdi mdi-open-in-new")]),_:1})])])]),_:1}),l(r,{h2:""},{default:e(()=>[n("Custom item (icon + label)")]),_:1}),W,l(i,null,{pug:e(()=>[n(`w-tree.lh5(:data="tree")
...
`)]),default:e(()=>[l(s,{class:"lh5",data:a.tree4},{item:e(({item:c,open:ae})=>[t("span",null,p(c.label),1),c.status==="error"?(b(),f(u,{key:0,class:"ml1","bg-color":"error",xs:""},{default:e(()=>[n("mdi mdi-close")]),_:1})):c.status==="success"?(b(),f(u,{key:1,class:"ml1","bg-color":"success",xs:""},{default:e(()=>[n("mdi mdi-check")]),_:1})):c.status==="syncing"?(b(),f(u,{key:2,class:"ml1","bg-color":"warning",xs:""},{default:e(()=>[n("mdi mdi-clock-outline")]),_:1})):L("",!0)]),_:1},8,["data"])]),_:1}),l(r,{h2:""},{default:e(()=>[n("Expand all, by default")]),_:1}),l(i,null,{pug:e(()=>[n('w-tree(:data="tree" expand-all)')]),html:e(()=>[n('<w-tree :data="tree" expand-all></w-tree>')]),js:e(()=>[n(`data: () => ({
  tree: [
      {
        label: 'Item 1',
        children: [
