...
`)])),default:s(()=>[e[30]||(e[30]=n("div",{class:"w-flex justify-space-between smd-column"},[n("span",null,"Some text on the left."),n("span",null,"Some text in the center."),n("span",null,"Some text on the right.")],-1))]),_:1,__:[30]}),l(p,{tip:""},{default:s(()=>[e[32]||(e[32]=t(`If you'd rather not have these CSS layout classes, you can disable them via the
...
})`)])),_:1,__:[36]},8,["dark"])])}const v={},h=c(v,[["render",w]]);export{h as default};
