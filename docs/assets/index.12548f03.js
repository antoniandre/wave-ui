import{r,o as b,f as _,a as i,w as t,b as o,h as l,e,n as k,_ as g,br as x}from"./index.6bc90973.js";const C=e("Basic"),S=o("p",{class:"grey-light2 my4"},`Now that you've seen the default accordion in real context, all the examples of this page will have a
light blue background and accordions a white background to help visualize where they end.
`,-1),T={class:"mt3"},j=e("v-model:"),A={class:"ml1"},E=e(`w-accordion(v-model="accordion" :items="items")
...
directly in the object.`)],-1),H=e('w-accordion(v-model="accordion" :items="items")'),z=e('<w-accordion v-model="accordion" :items="items" />'),O=e(`data: () => ({
  items: [
...
`),W=e("Shadow"),K=e('w-accordion(:items="items" shadow)'),M=e('<w-accordion :items="items" shadow />'),F=e(`data: () => ({
  items: [
    {
      title: 'Item 1',
      content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi ut neque enim beatae autem iure, velit labore aut ipsa voluptatem aliquam distinctio harum. Possimus aliquid voluptatum facere incidunt dolor a.'
...
`),Ce=e("Do you (really) need even more flexibility?"),Se=o("p",null,[e("No problem, Wave UI's got you covered."),o("br"),e(`
If you don't need data objects at all, you can simply define a number of items: `),o("code",null,':items="3"'),e(`.
`)],-1),Te=e("Item title 1"),je=e("Item content 1"),Ae=e("Item title 2"),Ee=e("Item content 2"),De=e("Item title 3"),Ve=e("Item content 3"),Pe=e(`w-accordion(:items="3")
