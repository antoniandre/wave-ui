import{r as a,g as p,o as d,a as r,b as o,w as s,e as t,_ as b,A as y}from"./index-zBoFSzBL.js";function h(l,e,f,w,g,u){const i=a("title-link"),n=a("w-breadcrumbs"),m=a("example"),c=a("w-tag");return d(),p("div",null,[r(i,{h2:""},{default:s(()=>e[0]||(e[0]=[t("Default")])),_:1,__:[0]}),e[34]||(e[34]=o("p",null,[t(`By default, each item except the last one will be a link providing that a route attribute is found
