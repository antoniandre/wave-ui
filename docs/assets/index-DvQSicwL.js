import{r,g as w,o as h,a as i,b as o,w as n,e,t as s,n as S,_ as v,s as k}from"./index-BkivclCA.js";const j={class:"mt3"},A={class:"ml1"},D={class:"mt3"},E={class:"ml1"},P={class:"mt3"},V={class:"ml1"},$={class:"mt3"},U={class:"ml1"},B={class:"ml1"};function R(a,t,x,y,q,g){const b=r("alert"),l=r("title-link"),m=r("w-accordion"),c=r("example"),f=r("w-button"),u=r("w-icon"),C=r("w-alert"),I=r("w-tag"),T=r("w-list"),p=r("w-accordion-item");return h(),w("div",null,[i(b,{info:""},{default:n(()=>t[7]||(t[7]=[o("p",null,"Two components are available:",-1),o("ul",null,[o("li",null,[o("strong",{class:"code"},"w-accordion"),e(": The root accordion component.")]),o("li",{class:"mt2"},[o("strong",{class:"code"},"w-accordion-item"),e(`: An optional component if you don't need / prefer not to use
the `),o("code",null,"items"),e(" prop.")])],-1)])),_:1,__:[7]}),i(l,{h2:""},{default:n(()=>t[8]||(t[8]=[e("Basic")])),_:1,__:[8]}),i(m,{items:a.items},null,8,["items"]),t[104]||(t[104]=o("p",{class:"grey-light2 my4"},`Now that you've seen the default accordion in real context, all the accordions of this page will have a
...
`)])),default:n(()=>[i(m,{class:"discrete--bg",items:a.items,shadow:""},null,8,["items"])]),_:1}),i(l,{h2:""},{default:n(()=>t[26]||(t[26]=[e("Color & background color")])),_:1,__:[26]}),t[107]||(t[107]=o("p",null,[e("Like in most components, you can set a "),o("code",null,"color"),e(" for the text and a "),o("code",null,"bg-color"),e(` for the
background.`),o("br"),e(`
...
`)])),default:n(()=>[i(m,{class:"discrete--bg",items:a.items2},null,8,["items"])]),_:1}),i(l,{h2:""},{default:n(()=>t[32]||(t[32]=[e("Expand a single item at a time")])),_:1,__:[32]}),i(c,{"content-class":"pa4"},{pug:n(()=>t[34]||(t[34]=[e(`w-accordion(v-model="accordion" :items="items" expand-single)
