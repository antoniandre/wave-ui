import{N as e,U as t,c as n,d as r,g as i,h as a,k as o,yt as s}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as c}from"./_plugin-vue_export-helper-S3RvzygF.js";import{t as l}from"./form-elements-dhQrrM2Q.js";import{_ as u,g as d}from"./index-CKcZQ2YR.js";var f={class:`w-flex wrap my1`},p={class:`w-flex wrap my1`},m={class:`w-flex align-center`},h={class:`title3 ml10`},g={class:`pr2`};function _(c,l,u,d,_,v){let y=e(`w-radios`),b=e(`w-radio`),x=e(`w-card`),S=e(`title-link`),C=e(`alert`),w=e(`example`),T=e(`w-icon`),E=e(`w-tag`);return o(),r(`div`,null,[i(x,{"bg-color":c.$store.state.darkMode?`grey-dark5`:`blue-light5`},{default:t(()=>[l[15]||=n(`p`,{class:`mb3`},`What it looks like:`,-1),i(y,{modelValue:c.selection1,"onUpdate:modelValue":l[0]||=e=>c.selection1=e,items:c.radios1,inline:``},null,8,[`modelValue`,`items`]),l[16]||=n(`div`,{class:`title4 mt4`},`States`,-1),n(`div`,null,[n(`div`,f,[i(b,{class:`mr3 mb1`,"model-value":!0,label:`Checked`}),i(b,{class:`mr3 mb1`,"model-value":!0,disabled:``,label:`Checked &amp; disabled`}),i(b,{class:`mr3 mb1`,"model-value":!0,readonly:``,label:`Checked &amp; readonly`})]),n(`div`,p,[i(b,{class:`mr3 mb1`,"model-value":!1,label:`Unchecked`}),i(b,{class:`mr3 mb1`,"model-value":!1,disabled:``,label:`Unchecked &amp; disabled`}),i(b,{class:`mr3 mb1`,"model-value":!1,readonly:``,label:`Unchecked &amp; readonly`})])])]),_:1},8,[`bg-color`]),l[68]||=n(`p`,{class:`mt12`},[a(`There are 2 components: `),n(`span`,{class:`code`},`w-radio`),a(` & `),n(`span`,{class:`code`},`w-radios`),a(`.
The later is a group of radio buttons for convenience.`)],-1),l[69]||=n(`p`,null,`Let's start with the basic component.`,-1),i(S,{class:`title1 mt12`,h2:``,slug:`w-radio`},{default:t(()=>[...l[17]||=[a(`<w-radio>`,-1)]]),_:1}),l[70]||=n(`div`,{class:`w-divider`},null,-1),i(C,{tip:``},{default:t(()=>[...l[18]||=[n(`div`,{class:`title3`},`Important notes`,-1),n(`strong`,{class:`title5`},`Name attribute`,-1),n(`p`,{class:`mb4`},[a(`With individual radio buttons (using `),n(`span`,{class:`code`},`<w-radio>`),a(`), the `),n(`code`,null,`name`),a(` prop is
...
component.
`)],-1)]]),_:1}),i(w,null,{html:t(()=>[...l[28]||=[a(`<div class="title4 mb2">1. Here is a single radio button</div>
...
<w-radio
  ...
  return-value="option 3">
  Option 3
</w-radio>`,-1)]]),js:t(()=>[...l[29]||=[a(`data: () => ({
  radio2: false,
  radio3: false
})
`,-1)]]),default:t(()=>[l[30]||=n(`div`,{class:`title4 mb2`},`1. Here is a single radio button`,-1),i(b,null,{default:t(()=>[...l[19]||=[a(`I am single - not very useful`,-1)]]),_:1}),l[31]||=n(`div`,{class:`title4 mt8 mb2`},`2. Here is a duo`,-1),i(b,{class:`mr2`,name:`radio1`},{default:t(()=>[...l[20]||=[a(`Option 1`,-1)]]),_:1}),i(b,{name:`radio1`},{default:t(()=>[...l[21]||=[a(`Option 2`,-1)]]),_:1}),l[32]||=n(`div`,{class:`title4 mt8 mb2`},`3. A trio using v-model`,-1),i(b,{class:`mr2`,modelValue:c.radio2,"onUpdate:modelValue":l[1]||=e=>c.radio2=e,"return-value":`option 1`},{default:t(()=>[...l[22]||=[a(`Option 1`,-1)]]),_:1},8,[`modelValue`]),i(b,{class:`mr2`,modelValue:c.radio2,"onUpdate:modelValue":l[2]||=e=>c.radio2=e,"return-value":`option 2`},{default:t(()=>[...l[23]||=[a(`Option 2`,-1)]]),_:1},8,[`modelValue`]),i(b,{modelValue:c.radio2,"onUpdate:modelValue":l[3]||=e=>c.radio2=e,"return-value":`option 3`},{default:t(()=>[...l[24]||=[a(`Option 3`,-1)]]),_:1},8,[`modelValue`]),l[33]||=n(`div`,{class:`title4 mt8 mb2`},`4. A trio using v-model and a set name`,-1),i(b,{class:`mr2`,modelValue:c.radio3,"onUpdate:modelValue":l[4]||=e=>c.radio3=e,name:`radio3`,"return-value":`option 1`},{default:t(()=>[...l[25]||=[a(`Option 1`,-1)]]),_:1},8,[`modelValue`]),i(b,{class:`mr2`,modelValue:c.radio3,"onUpdate:modelValue":l[5]||=e=>c.radio3=e,name:`radio3`,"return-value":`option 2`},{default:t(()=>[...l[26]||=[a(`Option 2`,-1)]]),_:1},8,[`modelValue`]),i(b,{modelValue:c.radio3,"onUpdate:modelValue":l[6]||=e=>c.radio3=e,name:`radio3`,"return-value":`option 3`},{default:t(()=>[...l[27]||=[a(`Option 3`,-1)]]),_:1},8,[`modelValue`])]),_:1}),l[71]||=n(`p`,null,[a(`The above example (case 3 & 4) shows that the radio buttons work without the name attribute,
...
(Keyboard arrows navigation is a browser choice, Safari doesn't have it)`),n(`br`),n(`strong`,null,[a(`Note that when you use the `),n(`span`,{class:`code`},`w-radios`),a(` component, a shared unique `),n(`code`,null,`name`),a(` (and stable per-radio `),n(`code`,null,`id`),a(` values) are set by default so you don't
have to worry about them if you don't need to override them.
`)])],-1),i(S,{h2:``},{default:t(()=>[...l[34]||=[a(`Custom label in w-radio`,-1)]]),_:1}),l[72]||=n(`p`,null,[n(`span`,{class:`code`},`w-radio`),a(` provides a default slot to customize the content.`)],-1),i(w,{"content-class":`mt3`},{html:t(()=>[...l[39]||=[a(`<w-radio class="mr5" name="radio1">
...
</w-radio>`,-1)]]),default:t(()=>[i(b,{class:`mr5`,name:`radio4`},{default:t(()=>[l[36]||=n(`span`,{class:`pr1`},`Choice 1 has an icon`,-1),i(T,{md:``},{default:t(()=>[...l[35]||=[a(`mdi mdi-star`,-1)]]),_:1})]),_:1}),i(b,{name:`radio4`},{default:t(()=>[i(E,{"bg-color":`green-light5`,color:`green-dark2`},{default:t(()=>[l[38]||=a(`Choice 2 is a tag`,-1),i(T,{class:`ml1`},{default:t(()=>[...l[37]||=[a(`mdi mdi-heart`,-1)]]),_:1})]),_:1})]),_:1})]),_:1}),i(C,{tip:``},{default:t(()=>[...l[40]||=[a(`As seen in this example, the `,-1),n(`span`,{class:`code`},`w-radio`,-1),a(` component allows you to have complete freedom
...
much faster.
`,-1)]]),_:1}),i(S,{class:`title1 mt12`,h2:``,slug:`w-radios`},{default:t(()=>[...l[41]||=[a(`<w-radios>`,-1)]]),_:1}),l[73]||=n(`div`,{class:`w-divider`},null,-1),l[74]||=n(`p`,{class:`my5`},[a(`The `),n(`span`,{class:`code`},`w-radios`),a(` component allows a fast and easy rendering of
...
`)],-1),i(S,{class:`title2 primary`,h3:``},{default:t(()=>[...l[42]||=[a(`V-model`,-1)]]),_:1}),i(C,{info:``},{default:t(()=>[...l[43]||=[a(`If a value is set in the choice's data, it will be returned through the v-model when selected.`,-1),n(`br`,null,null,-1),a(`
If no value is set, the choice's label will be returned instead.`,-1)]]),_:1}),l[75]||=n(`p`,null,`The v-model can also be preset, or updated externally.`,-1),i(w,null,{html:t(()=>[...l[45]||=[a(`<div class="w-flex align-center">
  <w-radios
    v-model="selection"
    :items="radioItems">
  </w-radios>
...
`,-1)]]),default:t(()=>[n(`div`,m,[i(y,{modelValue:c.selection1,"onUpdate:modelValue":l[7]||=e=>c.selection1=e,items:c.radios1},null,8,[`modelValue`,`items`]),n(`div`,h,[l[44]||=a(`v-model: `,-1),n(`code`,null,s(c.selection1||`null`),1)])])]),_:1}),i(S,{h2:``},{default:t(()=>[...l[47]||=[a(`Inline layout`,-1)]]),_:1}),i(w,{"content-class":`mt3`},{html:t(()=>[...l[48]||=[a(`<w-radios :items="radioItems" inline></w-radios>`,-1)]]),js:t(()=>[...l[49]||=[a(`data: () => ({
  radioItems: [
    { label: 'Choice 1' },
    { label: 'Choice 2' },
    { label: 'Choice 3' }
...
`,-1)]]),default:t(()=>[i(y,{items:c.radios2,inline:``},null,8,[`items`])]),_:1}),i(S,{h2:``},{default:t(()=>[...l[50]||=[a(`Custom label content`,-1)]]),_:1}),l[76]||=n(`p`,null,[n(`span`,{class:`code`},`w-radios`),a(` also provides a slot to customize the label of each radio button: `),n(`code`,null,`item`),a(`.`)],-1),l[77]||=n(`p`,null,`The great thing is that you can access any custom data from this slot!`,-1),i(w,null,{html:t(()=>[...l[51]||=[a(`<w-radios
  v-model="selection"
  :items="radioItems"
  color="green">
  <template #item="{ item }">
...
`,-1)]]),default:t(()=>[i(y,{modelValue:c.selection5,"onUpdate:modelValue":l[8]||=e=>c.selection5=e,items:c.radios3,color:`green`},{item:t(({item:e})=>[n(`span`,g,s(e.label),1),i(T,{class:`success`},{default:t(()=>[a(s(e.icon),1)]),_:2},1024)]),_:1},8,[`modelValue`,`items`])]),_:1}),l[78]||=n(`div`,{class:`w-divider grey-light5 my12`},null,-1),i(S,{h2:``},{default:t(()=>[...l[53]||=[a(`Color`,-1)]]),_:1}),l[79]||=n(`p`,null,[a(`By default the `),n(`span`,{class:`code`},`w-radio`),a(` & `),n(`span`,{class:`code`},`w-radios`),a(` components will use the
...
`)],-1),i(S,{h3:``,slug:`w-radios--colors`},{default:t(()=>[...l[54]||=[n(`span`,{class:`code`},`w-radios`,-1),a(` colors`,-1)]]),_:1}),i(w,null,{html:t(()=>[...l[57]||=[a(`<w-radios
  class="mr2"
  v-model="selection1"
  :items="radios1"
  color="purple">
...
`,-1)]]),default:t(()=>[i(y,{class:`mr2`,modelValue:c.selection6,"onUpdate:modelValue":l[9]||=e=>c.selection6=e,items:c.radios1,color:`purple`},{default:t(()=>[...l[55]||=[a(`Option 1`,-1)]]),_:1},8,[`modelValue`,`items`]),l[59]||=n(`div`,{class:`title4 mt8 mb2`},`Different color per item`,-1),i(y,{modelValue:c.selection7,"onUpdate:modelValue":l[10]||=e=>c.selection7=e,items:c.radios4},{default:t(()=>[...l[56]||=[a(`Option 2`,-1)]]),_:1},8,[`modelValue`,`items`])]),_:1}),i(S,{h3:``,slug:`w-radio--colors`},{default:t(()=>[...l[60]||=[n(`span`,{class:`code`},`w-radio`,-1),a(` colors`,-1)]]),_:1}),i(w,null,{html:t(()=>[...l[65]||=[a(`<w-radio
  class="mr2"
  v-model="selection1"
  name="radio1"
  color="teal-light1"
