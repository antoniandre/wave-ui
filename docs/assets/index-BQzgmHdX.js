import{r as m,g as p,o as c,a as e,b as o,w as l,e as t,t as d,_ as b,a1 as y,G as h}from"./index-DyPyadtc.js";const x={class:"mt2"},k={class:"mt2"};function V(a,n,v,w,f,u){const s=m("title-link"),r=m("w-rating"),i=m("example");return c(),p("div",null,[e(s,{h2:""},{default:l(()=>n[2]||(n[2]=[t("Default",-1)])),_:1,__:[2]}),e(i,null,{pug:l(()=>n[3]||(n[3]=[t("w-rating",-1)])),html:l(()=>n[4]||(n[4]=[t(`<w-rating></w-rating>
`,-1)])),default:l(()=>[e(r)]),_:1}),e(s,{h2:""},{default:l(()=>n[5]||(n[5]=[t("V-model",-1)])),_:1,__:[5]}),e(i,null,{pug:l(()=>n[8]||(n[8]=[t(`w-rating(v-model="rating1")
div.mt2
  strong.mr2 v-model:
  code `+d("{{ rating1 }}")+`
...
div.mt2
  strong.mr2 v-model:
  code `+d("{{ rating2 }}"),-1)])),html:l(()=>n[9]||(n[9]=[t(`<w-rating v-model="rating1"></w-rating>
<div class="mt2">
...
<div class="mt2">
  <strong class="mr2">v-model:</strong>
  <code>`+d("{{ rating2 }}")+`</code>
</div>`,-1)])),js:l(()=>n[10]||(n[10]=[t(`data: () => ({
  rating1: 3,
  rating2: 3.42
})
`,-1)])),default:l(()=>[e(r,{modelValue:a.rating1,"onUpdate:modelValue":n[0]||(n[0]=g=>a.rating1=g)},null,8,["modelValue"]),o("div",x,[n[6]||(n[6]=o("strong",{class:"mr2"},"v-model:",-1)),o("code",null,d(a.rating1),1)]),e(r,{class:"mt4",modelValue:a.rating2,"onUpdate:modelValue":n[1]||(n[1]=g=>a.rating2=g)},null,8,["modelValue"]),o("div",k,[n[7]||(n[7]=o("strong",{class:"mr2"},"v-model:",-1)),o("code",null,d(a.rating2),1)])]),_:1}),e(s,{h2:""},{default:l(()=>n[11]||(n[11]=[t("Color",-1)])),_:1,__:[11]}),n[34]||(n[34]=o("p",null,[t("Like in most components, you can set a "),o("code",null,"color"),t(" for the foreground icons (when on) and a "),o("code",null,"bg-color"),t(` for the
...
br
w-rating.my2(bg-color="light-green" color="yellow")`,-1)])),html:l(()=>n[13]||(n[13]=[t(`<w-rating
  class="my2"
  color="green">
</w-rating>
...
`,-1)])),default:l(()=>[e(r,{class:"my2",color:"green"}),n[14]||(n[14]=o("br",null,null,-1)),e(r,{class:"my2","bg-color":"light-green",color:"yellow"})]),_:1,__:[14]}),e(s,{h2:""},{default:l(()=>n[15]||(n[15]=[t("Custom Icons",-1)])),_:1,__:[15]}),e(i,null,{pug:l(()=>n[16]||(n[16]=[t(`w-rating.my2(icon="mdi mdi-heart" :model-value="3.4")
br
w-rating.my2(icon="mdi mdi-heart-outline" :model-value="3.4")`,-1)])),html:l(()=>n[17]||(n[17]=[t(`<w-rating
  class="my2"
  icon="mdi mdi-heart"
  :model-value="3.4">
</w-rating>
...
`,-1)])),default:l(()=>[e(r,{class:"my2",icon:"mdi mdi-heart","model-value":3}),n[18]||(n[18]=o("br",null,null,-1)),e(r,{class:"my2",icon:"mdi mdi-heart-outline","model-value":3.4})]),_:1,__:[18]}),e(s,{h2:"",slug:"max"},{default:l(()=>n[19]||(n[19]=[t("Max (number of buttons)",-1)])),_:1,__:[19]}),n[35]||(n[35]=o("p",null,[t("The number of buttons is set via the "),o("code",null,"max"),t(" prop."),o("br"),t(`
...
br
w-rating.my2(:model-value="6" :max="10")`,-1)])),html:l(()=>n[21]||(n[21]=[t(`<w-rating
  :model-value="2"
  class="my2"
  :max="3">
</w-rating>
...
`,-1)])),default:l(()=>[e(r,{class:"my2","model-value":2,max:3}),n[22]||(n[22]=o("br",null,null,-1)),e(r,{class:"my2","model-value":6,max:10})]),_:1,__:[22]}),e(s,{h2:""},{default:l(()=>n[23]||(n[23]=[t("Sizes",-1)])),_:1,__:[23]}),n[36]||(n[36]=o("p",null,[t("The rating component's size can be controlled via the preset sizes "),o("code",null,"xs"),t(", "),o("code",null,"sm"),t(`,
...
w-rating.my2(lg)
br
w-rating.my2(xl)`,-1)])),html:l(()=>n[25]||(n[25]=[t(`<w-rating class="my2" xs></w-rating>
<br />
