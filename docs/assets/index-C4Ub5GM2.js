import{r as m,g as w,o as f,a,b as l,w as e,e as n,t as s,l as V,_ as g,a9 as x}from"./index-DyPyadtc.js";const A={class:"ml2"},B={class:"green"},I={class:"pink mx1"},M=["innerHTML"];function P(i,t,v,h,k,u){const r=m("title-link"),b=m("w-tabs"),d=m("example"),y=m("w-switch"),C=m("alert"),S=m("w-radios"),p=m("w-button"),$=m("w-flex"),c=m("w-icon"),j=m("w-input");return f(),w("div",null,[a(r,{h2:""},{default:e(()=>t[9]||(t[9]=[n("Basic",-1)])),_:1,__:[9]}),a(d,null,{pug:e(()=>t[10]||(t[10]=[n('w-tabs(:items="tabs")',-1)])),html:e(()=>t[11]||(t[11]=[n('<w-tabs :items="tabs"></w-tabs>',-1)])),js:e(()=>t[12]||(t[12]=[n(`data: () => ({
  tabs: [
...
`,-1)])),default:e(()=>[a(b,{items:i.tabs1},null,8,["items"])]),_:1}),a(r,{h2:""},{default:e(()=>t[13]||(t[13]=[n("Align center and right",-1)])),_:1,__:[13]}),a(d,null,{pug:e(()=>t[14]||(t[14]=[n(`w-tabs(:items="tabs" center)
br
w-tabs(:items="tabs" right)`,-1)])),html:e(()=>t[15]||(t[15]=[n(`<w-tabs :items="tabs" center></w-tabs>
<br />
<w-tabs :items="tabs" right></w-tabs>`,-1)])),js:e(()=>t[16]||(t[16]=[n(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
...
`,-1)])),default:e(()=>[a(b,{items:i.tabs4.items,center:""},null,8,["items"]),a(b,{class:"mt4",items:i.tabs4.items,right:""},null,8,["items"])]),_:1}),a(r,{h2:""},{default:e(()=>t[17]||(t[17]=[n("Fill bar & disabled items",-1)])),_:1,__:[17]}),a(d,null,{pug:e(()=>t[19]||(t[19]=[n(`w-switch.mb3(v-model="fillBar") Fill bar
w-tabs(:items="tabs" :fill-bar="fillBar")`,-1)])),html:e(()=>t[20]||(t[20]=[n(`<w-switch v-model="fillBar" class="mb3">
  Fill bar
</w-switch>

<w-tabs :items="tabs" :fill-bar="fillBar"></w-tabs>`,-1)])),js:e(()=>t[21]||(t[21]=[n(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3', content: 'Tab 3 content.' },
...
`,-1)])),default:e(()=>[a(y,{class:"mb3",modelValue:i.tabs2.fillBar,"onUpdate:modelValue":t[0]||(t[0]=o=>i.tabs2.fillBar=o)},{default:e(()=>t[18]||(t[18]=[n("Fill bar",-1)])),_:1,__:[18]},8,["modelValue"]),a(b,{items:i.tabs2.items,"fill-bar":i.tabs2.fillBar},null,8,["items","fill-bar"])]),_:1}),a(r,{h2:""},{default:e(()=>t[22]||(t[22]=[n("V-model",-1)])),_:1,__:[22]}),a(C,{warning:""},{default:e(()=>t[23]||(t[23]=[l("strong",null,"Since version 1.21.0",-1),n(", the v-model/value only accepts a numeric tab index (previously an array of boolean).",-1)])),_:1,__:[23]}),t[84]||(t[84]=l("p",null,[n("It is possible to open a particular tab programmatically via "),l("code",null,"v-model"),n(" or "),l("code",null,"model-value"),n(".")],-1)),a(d,null,{pug:e(()=>t[25]||(t[25]=[n(`w-tabs(v-model="activeTab" :items="tabs")
strong
  | v-model:
  code.ml2 `+s("{{ activeTab }}"),-1)])),html:e(()=>t[26]||(t[26]=[n(`<w-tabs v-model="activeTab" :items="tabs"></w-tabs>
...
</strong>`,-1)])),js:e(()=>t[27]||(t[27]=[n(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3', content: 'Tab 3 content.' },
...
`,-1)])),default:e(()=>[a(b,{class:"mb2",modelValue:i.tabs2.active,"onUpdate:modelValue":t[1]||(t[1]=o=>i.tabs2.active=o),items:i.tabs2.items},null,8,["modelValue","items"]),l("strong",null,[t[24]||(t[24]=n("v-model:",-1)),l("code",A,s(i.tabs2.active),1)])]),_:1}),a(r,{h2:""},{default:e(()=>t[28]||(t[28]=[n("Colors",-1)])),_:1,__:[28]}),t[85]||(t[85]=l("p",null,[n("Like in most components, you can set a "),l("code",null,"color"),n(" for the text and a "),l("code",null,"bg-color"),n(` for the
...
`,-1)])),default:e(()=>[a(b,{items:i.tabs2.items,color:"blue","bg-color":i.$store.state.darkMode?"indigo-dark6":"indigo-light5"},null,8,["items","bg-color"])]),_:1}),t[87]||(t[87]=l("div",{class:"title3 mt4"},"Slider color",-1)),a(d,null,{pug:e(()=>t[30]||(t[30]=[n('w-tabs(:items="tabs" slider-color="blue-light2")',-1)])),html:e(()=>t[31]||(t[31]=[n(`<w-tabs
  :items="tabs"
  slider-color="blue-light2">
</w-tabs>`,-1)])),js:e(()=>t[32]||(t[32]=[n(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3', content: 'Tab 3 content.' },
...
`,-1)])),default:e(()=>[a(b,{items:i.tabs2.items,"slider-color":"blue-light2"},null,8,["items"])]),_:1}),t[88]||(t[88]=l("div",{class:"title3"},"Active class",-1)),a(d,null,{pug:e(()=>t[33]||(t[33]=[n(`w-tabs(
  :items="tabs"
  color="blue"
  active-class="pink"
  slider-color="pink")`,-1)])),html:e(()=>t[34]||(t[34]=[n(`<w-tabs
  :items="tabs"
  color="blue"
  active-class="pink"
  slider-color="pink">
</w-tabs>`,-1)])),js:e(()=>t[35]||(t[35]=[n(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3', content: 'Tab 3 content.' },
...
`,-1)])),default:e(()=>[a(b,{items:i.tabs2.items,color:"blue","active-class":"pink","slider-color":"pink"},null,8,["items"])]),_:1}),a(r,{h2:""},{default:e(()=>t[36]||(t[36]=[n("Pill slider",-1)])),_:1,__:[36]}),a(d,null,{pug:e(()=>t[37]||(t[37]=[n('w-tabs(:items="tabs" pill-slider)',-1)])),html:e(()=>t[38]||(t[38]=[n('<w-tabs :items="tabs" pill-slider></w-tabs>',-1)])),js:e(()=>t[39]||(t[39]=[n(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3', content: 'Tab 3 content.' },
...
})`,-1)])),default:e(()=>[a(b,{items:i.tabs2.items,"pill-slider":""},null,8,["items"])]),_:1}),a(r,{h3:""},{default:e(()=>t[40]||(t[40]=[n("Example of a different style, involving some external CSS",-1)])),_:1,__:[40]}),a(d,{reactive:""},{pug:e(()=>t[41]||(t[41]=[n('w-tabs(:items="tabs" pill-slider)',-1)])),html:e(()=>t[42]||(t[42]=[n('<w-tabs :items="tabs" pill-slider></w-tabs>',-1)])),js:e(()=>t[43]||(t[43]=[n(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3', content: 'Tab 3 content.' },
...
})`,-1)])),css:e(()=>[n(`.w-app .w-tabs {border: none;}
.w-app .w-tabs__bar {
  display: inline-flex;
  margin-bottom: 12px;
  padding: 0;
...
`,1)]),default:e(()=>[a(b,{class:"macos-tabs",items:i.tabs2.items,"pill-slider":""},null,8,["items"])]),_:1}),a(r,{h2:""},{default:e(()=>t[44]||(t[44]=[n("No slider",-1)])),_:1,__:[44]}),a(d,null,{pug:e(()=>t[46]||(t[46]=[n(`w-switch.mb3(v-model="tabsSlider") Slider
w-tabs(:items="tabs" :no-slider="!tabsSlider" active-class="pink")`,-1)])),html:e(()=>t[47]||(t[47]=[n(`<w-switch class="mb3" v-model="tabsSlider">
  Slider
</w-switch>
...
<w-tabs
  ...
  active-class="pink">
</w-tabs>`,-1)])),js:e(()=>t[48]||(t[48]=[n(`data: () => ({
  tabsSlider: false,
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
...
`,-1)])),default:e(()=>[a(y,{class:"mb3",modelValue:i.tabs2.slider,"onUpdate:modelValue":t[2]||(t[2]=o=>i.tabs2.slider=o)},{default:e(()=>t[45]||(t[45]=[n("Slider",-1)])),_:1,__:[45]},8,["modelValue"]),a(b,{items:i.tabs2.items,"no-slider":!i.tabs2.slider,"active-class":"pink"},null,8,["items","no-slider"])]),_:1}),a(r,{h2:""},{default:e(()=>t[49]||(t[49]=[n("Content transitions",-1)])),_:1,__:[49]}),t[89]||(t[89]=l("p",null,"Change tab to see the transition.",-1)),a(d,null,{pug:e(()=>t[50]||(t[50]=[n(`w-radios.mb3(:items="transitions" v-model="transition")
w-tabs(:items="tabs" :transition="transition")`,-1)])),html:e(()=>t[51]||(t[51]=[n(`<w-radios
  class="mb3"
  :items="transitions"
  v-model="transition">
</w-radios>
...
</w-tabs>`,-1)])),js:e(()=>t[52]||(t[52]=[n(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3', content: 'Tab 3 content.' }
...
w-tabs(:items="tabsCount")
  ...
  template(#item-content="{ index }") Content `+s("{{ index }}"),-1)])),html:e(()=>t[56]||(t[56]=[n(`<w-flex class="mb3" align-center>
  Number of tabs:
  <w-button
    class="mx2"
    icon="wi-minus"
...
</w-tabs>`,-1)])),js:e(()=>t[57]||(t[57]=[n(`data: () => ({
  tabsCount: 3
})
`,-1)])),default:e(()=>[a($,{class:"mb3","align-center":""},{default:e(()=>[t[54]||(t[54]=n("Number of tabs:",-1)),a(p,{class:"mx2",icon:"wi-minus",sm:"",onClick:t[4]||(t[4]=o=>i.tabs3.tabsCount-=i.tabs3.tabsCount<1?0:1)}),l("code",null,s(i.tabs3.tabsCount),1),a(p,{class:"mx2",icon:"wi-plus",sm:"",onClick:t[5]||(t[5]=o=>i.tabs3.tabsCount++)})]),_:1,__:[54]}),a(b,{items:i.tabs3.tabsCount},{"item-title":e(({index:o})=>[n("Tab "+s(o),1)]),"item-content":e(({index:o})=>[n("Content "+s(o),1)]),_:1},8,["items"])]),_:1}),a(r,{h2:""},{default:e(()=>t[58]||(t[58]=[n("Card style tabs",-1)])),_:1,__:[58]}),a(d,null,{pug:e(()=>t[59]||(t[59]=[n('w-tabs(:items="tabs" card)',-1)])),html:e(()=>t[60]||(t[60]=[n('<w-tabs :items="tabs" card></w-tabs>',-1)])),js:e(()=>t[61]||(t[61]=[n(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3 has a long title', content: 'Tab 3 content.' }
...
`,-1)])),default:e(()=>[a(b,{items:i.tabs1,card:""},null,8,["items"])]),_:1}),a(r,{h2:""},{default:e(()=>t[62]||(t[62]=[n("Close button",-1)])),_:1,__:[62]}),a(C,{tip:""},{default:e(()=>t[63]||(t[63]=[n("When using a close button, don't forget to stop the click propagation ",-1),l("code",null,"@click.stop",-1),n(` to prevent
the navigation to the tab that you are deleting!`,-1)])),_:1,__:[63]}),a(d,null,{pug:e(()=>t[65]||(t[65]=[n(`w-tabs(:items="tabs" card)
  template(#item-title="{ item, index }")
    ...
    w-button.ml1.mr-1(
      ...
      icon="wi-cross"
      outline
      xs)`,-1)])),html:e(()=>t[66]||(t[66]=[n(`<w-tabs :items="tabs" card>
  <template #item-title="{ item, index }">
    `+s("{{ item.title }}")+`
    <w-button
      class="ml1 mr-1"
...
</w-tabs>`,-1)])),js:e(()=>t[67]||(t[67]=[n(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3', content: 'Tab 3 content.' }
...
`,-1)])),default:e(()=>[a(b,{items:i.tabs6.items,card:""},{"item-title":e(({item:o,index:T})=>[n(s(o.title),1),a(p,{class:"ml1 mr-1",onClick:V(Y=>i.tabs6.items.splice(T-1,1),["stop"]),icon:"wi-cross",outline:"",xs:""},null,8,["onClick"])]),_:1},8,["items"]),a(p,{class:"mt4","bg-color":"primary",onClick:t[6]||(t[6]=o=>i.tabs6.items=i.tabs6.originals.slice(0)),disabled:i.tabs6.items.length===3},{default:e(()=>t[64]||(t[64]=[n("Reset tabs",-1)])),_:1,__:[64]},8,["disabled"])]),_:1}),a(r,{h2:""},{default:e(()=>t[68]||(t[68]=[n("Customizing the tabs title & contents",-1)])),_:1,__:[68]}),a(d,null,{pug:e(()=>t[73]||(t[73]=[n(`w-tabs(:items="tabs" card)
  ...
  template(#item-content.1="{ item }")
    ...
    div(v-html="item.content")`,-1)])),html:e(()=>t[74]||(t[74]=[n(`<w-tabs :items="tabs" card>
  <template #item-title="{ item }">
...
</w-tabs>`,-1)])),js:e(()=>t[75]||(t[75]=[n(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3', content: 'Tab 3 content.' }
...
`,-1)])),default:e(()=>[a(b,{items:i.tabs5,card:""},{"item-title":e(({item:o})=>[a(c,{class:"mr1 green"},{default:e(()=>t[69]||(t[69]=[n("mdi mdi-star",-1)])),_:1,__:[69]}),l("span",B,s(o.title),1)]),"item-title.3":e(({item:o})=>[a(c,{class:"pink"},{default:e(()=>t[70]||(t[70]=[n("mdi mdi-heart",-1)])),_:1,__:[70]}),l("span",I,s(o.title),1),a(c,{class:"pink"},{default:e(()=>t[71]||(t[71]=[n("mdi mdi-heart",-1)])),_:1,__:[71]})]),"item-content.1":e(({item:o})=>[t[72]||(t[72]=l("div",{class:"title3"},"This is a custom tab content.",-1)),l("div",{innerHTML:o.content},null,8,M)]),_:1},8,["items"])]),_:1}),a(r,{h2:""},{default:e(()=>t[76]||(t[76]=[n("Adding a tabs bar extra element",-1)])),_:1,__:[76]}),t[91]||(t[91]=l("p",null,[n("You can add extra elements at the right of the tabs title bar via the "),l("code",null,"tabs-bar-extra"),n(" slot."),l("br"),n(`
Once the tabs are updated (in the next Vue tick), you can open the newly added tab.`)],-1)),a(d,null,{pug:e(()=>t[77]||(t[77]=[n(`w-tabs(:items="tabs.tabsCount" v-model="tabs.currentTab")
  ...
  template(#tabs-bar-extra)
    w-button.bdrsr.mr2(
      icon="wi-plus"
      @click="tabs.tabsCount++;$nextTick(() => tabs.currentTab = tabs.tabsCount - 1)")`,-1)])),html:e(()=>t[78]||(t[78]=[n(`<w-tabs
...
so the slider width adapts to the number of characters on the current tab's title.`)],-1)),a(d,null,{pug:e(()=>t[81]||(t[81]=[n(`w-tabs(ref="tabs" :items="tabs")
  template(#item-content="{ item }")
    w-input.my6(v-model="item.title" label="Tab title" @keyup="onTitleChange")`,-1)])),html:e(()=>t[82]||(t[82]=[n(`<w-tabs ref="tabs" :items="tabs">
  <template #item-content="{ item }">
    <w-input
      v-model="item.title"
      class="my6"
...
</w-tabs>`,-1)])),js:e(()=>t[83]||(t[83]=[n(`data: () => ({
  tabs: [
    { title: 'Tab 1' },
    { title: 'Tab 2' },
    { title: 'Tab 3' }
