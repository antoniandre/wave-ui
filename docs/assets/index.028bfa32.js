import{r,o as h,f as p,a as l,w as t,b as s,h as m,e,X as L,aK as M,c as j,_ as g,bU as T,bz as A}from"./index.6bc90973.js";const D=e("The "),O=s("span",{class:"code"},"w-select",-1),P=e(` component can be placed in a hidden overflow container and the dropdown
menu will still be fully visible when open.`),V=s("br",null,null,-1),E=e(`
This is because the select dropdown menu is placed at the `),$=s("span",{class:"code"},".w-app",-1),U=e(` level in the DOM,
just so you don't have to worry about this annoying case.
`),C=e("Basic"),R=s("p",null,[e("This is the most basic use of the "),s("span",{class:"code"},"w-select"),e(" component. No label, no v-model, only items.")],-1),B=e('<w-select :items="items"></w-select>'),W=e(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`),x=e("Label and / or placeholder"),F=s("p",null,[e("The select list can have a label or not and a placeholder or not."),s("br")],-1),q=e(`<w-select
  :items="items"
  label="Label">
</w-select>
...
`),K=e(`The items of the select list should have a label, which is by default expected in each item
object under the `),H=s("code",null,"label",-1),z=e(" name."),Y=s("br",null,null,-1),G=e(`
If this is a constraint, you can use the option `),X=s("code",null,"item-label-key",-1),J=e(` to specify the name of another
attribute to be used instead.
`),Q=e("Outline"),Z=e("Label"),ee=e('<w-select :items="items" outline>Label</w-select>'),te=e(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`),$e=e("Multiple selection"),Ue=e('<w-select :items="items" multiple></w-select>'),Ce=e(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`),Re=e("V-model"),Be=e("By default, the "),We=s("span",{class:"code"},"w-select",-1),xe=e(" component expects the items to have a "),Fe=s("code",null,"model-value",-1),qe=e(" attribute."),Ne=s("br",null,null,-1),Ke=e(`
If this is a constraint, you can use the option `),He=s("code",null,"item-value-key",-1),ze=e(` to specify the name of another
attribute to be used instead (must have a unique value), like an id for instance.`),Ye=s("span",null,"v-model:",-1),Ge={class:"ml2"},Xe=e(`<w-select
  v-model="selection"
  :items="items"
  multiple>
</w-select>
...
`),Qe=e("Without values (using labels)"),Ze=s("p",null,"If no values are provided in the items objects, the labels will be used to identify the selected items.",-1),et=s("span",null,"v-model:",-1),tt={class:"ml2"},lt=e(`<w-select
  v-model="selection"
  :items="items"
  multiple>
</w-select>
...
`),Et=e("Inner icons"),$t=s("div",{class:"title4 mb2"},"Label outside",-1),Ut=s("div",{class:"title4 mt6 mb2"},"Label inside",-1),Ct=e(`<div class="title4 mb2">
  Label outside
</div>
