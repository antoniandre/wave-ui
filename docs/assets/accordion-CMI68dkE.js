import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,vt as s,xt as c}from"./runtime-core.esm-bundler-BuLlhxCm.js";import{t as l}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{H as u,U as d}from"./index-DR7O6uV_.js";var f={class:`mt3`},p={class:`ml1`},m={class:`mt3`},h={class:`ml1`},g={class:`mt3`},_={class:`ml1`},v={class:`mt3`},y={class:`ml1`},b={class:`ml1`};function x(l,u,d,x,S,C){let w=n(`alert`),T=n(`title-link`),E=n(`w-accordion`),D=n(`example`),O=n(`w-icon`),k=n(`w-button`),A=n(`w-alert`),j=n(`w-tag`),M=n(`w-list`),N=n(`w-accordion-item`);return e(),i(`div`,null,[a(w,{info:``},{default:t(()=>[...u[7]||=[r(`p`,null,`Two components are available:`,-1),r(`ul`,null,[r(`li`,null,[r(`strong`,{class:`code`},`w-accordion`),o(`: The root accordion component.`)]),r(`li`,{class:`mt2`},[r(`strong`,{class:`code`},`w-accordion-item`),o(`: An optional component if you don't need / prefer not to use
