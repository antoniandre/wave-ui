import{r as i,o as v,f as w,a as o,w as n,b as s,h as c,d as r,n as B,_ as h,S as _}from"./index.bf306805.js";const V=r("p",null,[s("By default the overlay has a "),r("span",{class:"code"},"0.3"),s(` opacity with a black color and a z-index
...
`)],-1),N=r("span",{class:"code"},"persistent",-1),S=r("p",null,"When the overlay is persistent, it will not close on click and on escape key.",-1),C=r("p",null,"When persistent is set to false and by default, the escape key will also close the overlay.",-1),E=r("div",{class:"title4"},"Options",-1),H={class:"code white"},x={class:"code white"},U=r("p",null,[s(`The backdrop filter is
`),r("a",{href:"https://caniuse.com/css-backdrop-filter",target:"_blank"},"not supported on all the browsers"),s(`
yet but very nice.`)],-1);function W(e,t,b,f,k,d){const p=i("title-link"),a=i("w-button"),u=i("w-divider"),O=i("w-input"),$=i("w-flex"),m=i("w-icon"),y=i("w-overlay"),g=i("example"),A=i("ssh-pre");return v(),w("div",null,[V,o(p,{h2:""},{default:n(()=>[s("Overlay with custom opacity and control on "),N]),_:1}),S,C,o(g,null,{pug:n(()=>[s(`w-flex(wrap)
