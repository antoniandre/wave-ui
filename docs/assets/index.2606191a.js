...
`),A=t("Label and / or placeholder"),E=t("Label"),S=t(`<w-textarea>Label</w-textarea>
...
`),P=t("v-model"),V=l("p",null,[t("The value of the textarea can be provided via the "),l("code",null,"model-value"),t(" attribute (or "),l("code",null,"value"),t(`
...
`),O=t("No autogrow & resizable"),I=t("Textarea label"),R=t("Textarea label"),B=t(`<w-textarea
  no-autogrow
  rows="6">
  Textarea label
</w-textarea>
...
`),j=t("Outline"),z=t("Textarea label"),H=t(`<w-textarea outline>Textarea label</w-textarea>
`),C=t("Shadow"),N=t("Textarea label"),W=t("Textarea label"),F=t(`<w-textarea shadow>
  Textarea label
</w-textarea>
...
`),U=t("Tile"),G=t("Textarea label"),K=t("Textarea label"),J=t(`<w-textarea tile>
  Textarea label
</w-textarea>
...
<w-textarea
  ...
  outline
  readonly>
</w-textarea>`);function Le(s,i){const n=d("title-link"),o=d("w-textarea"),r=d("example"),c=d("w-icon");return p(),b("div",null,[e(n,{h2:""},{default:a(()=>[L]),_:1}),k,e(r,null,{html:a(()=>[M]),default:a(()=>[e(o,null,{default:a(()=>[D]),_:1})]),_:1}),e(n,{h2:""},{default:a(()=>[A]),_:1}),e(r,null,{html:a(()=>[S]),default:a(()=>[e(o,null,{default:a(()=>[E]),_:1}),e(o,{class:"mt4",placeholder:"Placeholder"}),e(o,{class:"mt4",label:"Label",placeholder:"Placeholder"})]),_:1}),e(n,{h2:""},{default:a(()=>[P]),_:1}),V,e(r,null,{html:a(()=>[$]),default:a(()=>[e(o,{"model-value":`Lorem, ipsum dolor sit amet consectetur adipisicing elit.
