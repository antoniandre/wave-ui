import{r as d,g as l,o as t,a as r,b as i,h as c,w as p,e as a,n as g,F as n,k as b,t as y,d as v,_ as h}from"./index-DyPyadtc.js";const C={class:"xs12 pa1"},T={class:"xs4 pa1"},z={class:"xs3 pa1"},M={class:"xs2 pa1"},N={class:"title2 mt0"},S={class:"xs12 md6 lg4 xl2 pa1"},U={class:"primary--bg py3"},V={class:"xs12 md6 lg4 xl2 pa1"},B={class:"primary--bg py3"},F={class:"xs12 md6 lg4 xl2 pa1"},I={class:"primary--bg py3"},R={class:"xs12 md6 lg4 xl2 pa1"},q={class:"primary--bg py3"},G={class:"xs12 md6 lg4 xl2 pa1"},L={class:"primary--bg py3"},W={class:"xs12 md6 lg4 xl2 pa1"},j={class:"primary--bg py3"};function D(s,e){const o=d("title-link"),w=d("ssh-pre"),u=d("alert"),m=d("example"),f=d("w-card"),$=d("w-flex"),k=d("router-link");return t(),l("main",null,[r(o,{class:"mt4",h1:""},{default:p(()=>e[0]||(e[0]=[a("Grid system (flexbox)",-1)])),_:1,__:[0]}),e[33]||(e[33]=i("div",{class:"title3"},"The grid system (using flexbox) is 12-cell based by default.",-1)),e[34]||(e[34]=i("p",null,[a(`Its purpose is to divide the available width (in percentage)
...
or whatever you want via the global Wave UI options:`,-1)),r(w,{class:"mb0",language:"js",dark:s.$store.state.darkMode},{default:p(()=>e[1]||(e[1]=[a(`new WaveUI({
  css: {
    grid: 24
  }
})
`,-1)])),_:1,__:[1]},8,["dark"])]),_:1,__:[2]}),r(o,{h2:""},{default:p(()=>e[3]||(e[3]=[a("How to use",-1)])),_:1,__:[3]}),r(u,{info:""},{default:p(()=>e[4]||(e[4]=[a("For this flexbox layout, you need to:",-1),i("ol",null,[i("li",null,[a("Use the "),i("strong",{class:"code"},"w-flex"),a(` component or class on the parent in order to set the
...
`,-1),i("strong",{class:"code"},"w-flex",-1),a(" component or ",-1),i("code",null,".w-flex",-1),a(` CSS class.
`,-1)])),_:1,__:[6]}),r(m,null,{pug:p(()=>e[13]||(e[13]=[a(`w-flex.text-center(wrap)
  .xs12.pa1
  ...
  .xs1.pa1(v-for="i in 12" :key="i")
    .primary-light5--bg.black.py3 xs1`,-1)])),html:p(()=>e[14]||(e[14]=[a(`<w-flex wrap class="text-center">
  <div class="xs12 pa1">
...
`,-1)])),default:p(()=>[i("div",{class:g(["w-flex wrap text-center",s.$store.state.darkMode?"black":"white"])},[i("div",C,[i("div",{class:g(["primary-dark1--bg py3",{white:!s.$store.state.darkMode}])},"xs12",2)]),e[11]||(e[11]=i("div",{class:"xs6 pa1"},[i("div",{class:"primary--bg py3"},"xs6")],-1)),e[12]||(e[12]=i("div",{class:"xs6 pa1"},[i("div",{class:"primary--bg py3"},"xs6")],-1)),(t(),l(n,null,b(3,x=>i("div",T,e[7]||(e[7]=[i("div",{class:"primary-light1--bg py3"},"xs4",-1)]))),64)),(t(),l(n,null,b(4,x=>i("div",z,e[8]||(e[8]=[i("div",{class:"primary-light2--bg py3"},"xs3",-1)]))),64)),(t(),l(n,null,b(6,x=>i("div",M,e[9]||(e[9]=[i("div",{class:"primary-light3--bg py3 black"},"xs2",-1)]))),64)),(t(),l(n,null,b(12,x=>i("div",{class:"xs1 pa1",key:x},e[10]||(e[10]=[i("div",{class:"primary-light5--bg py3 black"},"xs1",-1)]))),64))],2)]),_:1}),r(m,{class:"mt8"},{pug:p(()=>e[16]||(e[16]=[a(`w-flex.text-center(wrap)
  .xs1.pa1
  ...
  .xs7.pa1
    .primary-light3--bg.py3 xs7`,-1)])),html:p(()=>e[17]||(e[17]=[a(`<w-flex wrap class="text-center">
  <div class="xs1 pa1">
...
`,-1)])),default:p(()=>[i("div",{class:g(["w-flex wrap text-center",s.$store.state.darkMode?"black":"white"])},e[15]||(e[15]=[i("div",{class:"xs1 pa1"},[i("div",{class:"primary-dark1--bg py3"},"xs1")],-1),i("div",{class:"xs11 pa1"},[i("div",{class:"primary-dark1--bg py3"},"xs11")],-1),i("div",{class:"xs2 pa1"},[i("div",{class:"primary--bg py3"},"xs2")],-1),i("div",{class:"xs10 pa1"},[i("div",{class:"primary--bg py3"},"xs10")],-1),i("div",{class:"xs3 pa1"},[i("div",{class:"primary-light1--bg py3"},"xs3")],-1),i("div",{class:"xs9 pa1"},[i("div",{class:"primary-light1--bg py3"},"xs9")],-1),i("div",{class:"xs4 pa1"},[i("div",{class:"primary-light2--bg py3"},"xs4")],-1),i("div",{class:"xs8 pa1"},[i("div",{class:"primary-light2--bg py3"},"xs8")],-1),i("div",{class:"xs5 pa1"},[i("div",{class:"primary-light3--bg py3"},"xs5")],-1),i("div",{class:"xs7 pa1"},[i("div",{class:"primary-light3--bg py3"},"xs7")],-1)]),2)]),_:1}),r(o,{h2:""},{default:p(()=>e[18]||(e[18]=[a("Operating with breakpoints",-1)])),_:1,__:[18]}),r(m,null,{pug:p(()=>e[21]||(e[21]=[a(`w-card.blue-light5--bg
  .title2.black
    | Current breakpoint:
    code `+y("{{ $waveui.breakpoint.name }}")+`
  em.grey.mt1 Resizing your browser will update the current breakpoint.`,-1)])),html:p(()=>e[22]||(e[22]=[a(`<w-card class="blue-light5--bg">
...
`,-1)])),default:p(()=>[r(f,{class:g(s.$store.state.darkMode?"grey-dark4--bg":"blue-light5--bg")},{default:p(()=>[i("div",N,[e[19]||(e[19]=a("Current breakpoint: ",-1)),i("code",null,y(s.$waveui.breakpoint.name),1)]),e[20]||(e[20]=i("em",{class:"grey mt1"},"Resizing your browser will update the current breakpoint.",-1))]),_:1,__:[20]},8,["class"])]),_:1}),e[37]||(e[37]=i("p",null,"For this example, resize your browser and observe the different layout when crossing a breakpoint.",-1)),r(m,null,{pug:p(()=>e[23]||(e[23]=[a(`w-flex.text-center(wrap)
  ...
  .xs12.md6.lg4.xl2.pa1
    .primary--bg.py3
      ...
      template(v-else-if="$waveui.breakpoint.md") md6
      template(v-else-if="$waveui.breakpoint.lg") lg4
      template(v-else-if="$waveui.breakpoint.xl") xl2`,-1)])),html:p(()=>e[24]||(e[24]=[a(`<w-flex wrap class="text-center">
