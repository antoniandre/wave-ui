import{r as c,o as a,e as d,f as l,w as e,g as s,F as r,z as x,i as n,N as f}from"./vendor.e64646cc.js";import{_ as g}from"./index.2577f3ac.js";const v=n("Flex layout classes"),w=s("span",{class:"code"},"w-flex",-1),m=n(" component & helper classes"),y=f(`<p>the <code>w-flex</code> component and the <code>.w-flex</code> class both allow a flex layout that you can
...
(E.g. `),on=s("code",null,".xs6",-1),cn=n(", etc.) when the boxes stay on a single line."),an=s("div",{class:"box xs3 code"},".xs3",-1),dn=s("div",{class:"box xs3 code"},".xs3",-1),rn=s("div",{class:"box xs6 code"},".xs6",-1),xn=n(`w-flex(gap="3")
  ...
  padding: 12px 0;
  text-align: center;
}`),fn=n("Caveat"),un=n("The "),hn=s("code",null,"gap",-1),bn=n(" option will not work with both wrap ("),gn=s("code",null,"flex-wrap: wrap",-1),vn=n(`) and the
