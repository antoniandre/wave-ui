import{a as S}from"./index.0235ccf1.js";import{r,o as g,f as y,a as t,w as n,b as e,d as l,h as c,i as v,_,P as F,C as L}from"./index.59a44df4.js";const R=l("p",null,[e("By default the "),l("span",{class:"code"},"w-input"),e(` component has a label inside the input field, that moves up
...
`,1)]),default:n(()=>[t(T,{onSuccess:u.onFormSuccess},{default:n(()=>[t(i,{type:"file",modelValue:o.files5,"onUpdate:modelValue":d[4]||(d[4]=p=>o.files5=p),validators:[()=>o.files5.length||"Please add a file"]},{default:n(()=>[e("File")]),_:1},8,["modelValue","validators"]),t(I,{class:"d-flex mla mt4",type:"submit",loading:o.loading},{default:n(()=>[e("Send")]),_:1},8,["loading"])]),_:1},8,["onSuccess"])]),_:1}),t(s,{class:"mt8",h4:""},{default:n(()=>[e("2nd example")]),_:1}),he,t(P,{language:"js",label:"JavaScript"},{default:n(()=>[e(`import axios from 'axios'
...
`)]),_:1}),be,t(P,{language:"php",label:"PHP"},{default:n(()=>[e(`<?php
...
?>
`)]),_:1}),t(s,{h3:""},{default:n(()=>[e("Loading state")]),_:1}),fe,t(a,null,{pug:n(()=>[e(`w-input(type="file"
  v-model="files"
