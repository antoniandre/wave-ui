import{n as m,I as c}from"./index.d288a6b4.js";import"./vendor.4f8da9ec.js";var p=function(){var e=this,a=e.$createElement,t=e._self._c||a;return t("div",[t("title-link",{attrs:{h2:""}},[e._v("Default")]),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v('w-table(:headers="table.headers" :items="table.items")')]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-table
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table2.headers,items:e.table2.items}})],1),t("title-link",{attrs:{h2:""}},[e._v("No headers")]),e._m(2),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v('w-table(:items="table.items" :headers="table.headers" no-headers)')]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-table
  :items="table.items"
  :headers="table.headers"
  no-headers>
</w-table>`)]},proxy:!0},{key:"js",fn:function(){return[e._v(`data: () => ({
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table7.headers,items:e.table7.items,"resizable-columns":""}})],1),t("title-link",{attrs:{h3:""}},[e._v("Storing the table layout in localStorage")]),e._m(4),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-table(
  :headers="table.headers"
  :items="table.items"
  resizable-columns
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table1.headers,items:e.table1.items,sort:e.table1.sort},on:{"update:sort":function(n){return e.$set(e.table1,"sort",n)}}})],1),t("title-link",{attrs:{h2:""}},[e._v("Filter")]),e._m(6),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`.w-flex.wrap.mb3
  w-button.mr2.mb1(
...
`)]},proxy:!0}])},[e._v("Coming soon.")]),t("title-link",{attrs:{h2:""}},[e._v("Rows selection")]),t("p",[e._v("Click a row to see it highlighted and get information about the selected item.")]),e._m(9),t("title-link",{attrs:{h3:"",slug:"selectable-rows"}},[e._v("The "),t("span",{staticClass:"code"},[e._v("selectable-rows")]),e._v(" prop")]),e._m(10),t("title-link",{attrs:{h3:"",slug:"force-selection"}},[e._v("The "),t("span",{staticClass:"code"},[e._v("force-selection")]),e._v(" prop")]),e._m(11),t("title-link",{attrs:{h3:"",slug:"row-select"}},[e._v("The "),t("span",{staticClass:"code"},[e._v("@row-select")]),e._v(" event")]),e._m(12),e._m(13),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-flex.mb4(wrap)
...
`)]),t("title-link",{attrs:{h2:""}},[e._v("Expandable rows")]),t("alert",{attrs:{warning:""}},[e._v("This feature is in progress.")]),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-table(:headers="table.headers" :items="table.items" expandable-rows)
  template(#expanded-row="{ item }")
    w-icon.mr2(:color="['blue', 'pink'][item.gender]") mdi `+e._s(["mdi-gender-male","mdi-gender-female"][e.item.gender])+`
    | `+e._s(e.item.firstName)+" weighs "),t("strong",[e._v(e._s(e.item.weight)+"kg")]),e._v(" and is "),t("strong",[e._v(e._s(e.item.height)+"m")]),e._v(" tall.")]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-table
  :headers="table.headers"
  :items="table.items"
  expandable-rows>
  <template #expanded-row="{ item }">
