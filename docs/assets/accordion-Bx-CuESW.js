import{N as e,U as t,c as n,d as r,g as i,gt as a,h as o,k as s,yt as c}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as l}from"./_plugin-vue_export-helper-S3RvzygF.js";import{H as u}from"./index-BJr8b_n6.js";var d={class:`mt3`},f={class:`ml1`},p={class:`mt3`},m={class:`ml1`},h={class:`mt3`},g={class:`ml1`},_={class:`mt3`},v={class:`ml1`},y={class:`ml1`};function b(l,u,b,x,S,C){let w=e(`alert`),T=e(`title-link`),E=e(`w-accordion`),D=e(`example`),O=e(`w-button`),k=e(`w-icon`),A=e(`w-alert`),j=e(`w-tag`),M=e(`w-list`),N=e(`w-accordion-item`);return s(),r(`div`,null,[i(w,{info:``},{default:t(()=>[...u[7]||=[n(`p`,null,`Two components are available:`,-1),n(`ul`,null,[n(`li`,null,[n(`strong`,{class:`code`},`w-accordion`),o(`: The root accordion component.`)]),n(`li`,{class:`mt2`},[n(`strong`,{class:`code`},`w-accordion-item`),o(`: An optional component if you don't need / prefer not to use
the `),n(`code`,null,`items`),o(` prop.`)])],-1)]]),_:1}),i(T,{h2:``},{default:t(()=>[...u[8]||=[o(`Basic`,-1)]]),_:1}),i(E,{items:l.items},null,8,[`items`]),u[104]||=n(`p`,{class:`grey-light2 my4`},`Now that you've seen the default accordion in real context, all the accordions of this page will have a
light blue background in order to help visualize their edges.
`,-1),i(D,{"content-class":`pa4`},{pug:t(()=>[...u[10]||=[o(`w-accordion(v-model="accordion" :items="items")
...
`,-1)]]),default:t(()=>[i(E,{class:`discrete--bg`,modelValue:l.accordion1,"onUpdate:modelValue":u[0]||=e=>l.accordion1=e,items:l.items},null,8,[`modelValue`,`items`]),n(`div`,d,[u[9]||=o(`v-model:`,-1),n(`code`,f,c(l.accordion1),1)])]),_:1}),i(T,{h2:``},{default:t(()=>[...u[13]||=[o(`Expanded by default`,-1)]]),_:1}),u[105]||=n(`p`,null,[o(`You can expand one or multiple panes by default by providing a v-model array of booleans:
`),n(`span`,{class:`code`},`true`),o(` to expand, `),n(`span`,{class:`code`},`false`),o(` to collapse the item.`)],-1),i(D,{"content-class":`pa4`},{pug:t(()=>[...u[15]||=[o(`w-accordion(v-model="accordion" :items="items")
...
`,-1)]]),default:t(()=>[i(E,{class:`discrete--bg`,modelValue:l.accordion2,"onUpdate:modelValue":u[1]||=e=>l.accordion2=e,items:l.items},null,8,[`modelValue`,`items`]),n(`div`,p,[u[14]||=o(`v-model:`,-1),n(`code`,m,c(l.accordion2),1)])]),_:1}),i(T,{h2:``},{default:t(()=>[...u[18]||=[o(`Disabled pane`,-1)]]),_:1}),u[106]||=n(`p`,null,[o(`Specify which pane should be disabled - expanded or collapsed - by adding the `),n(`span`,{class:`code`},`disabled`),o(` property
directly in the object.`)],-1),i(D,{"content-class":`pa4`},{pug:t(()=>[...u[19]||=[o(`w-accordion(v-model="accordion" :items="items")`,-1)]]),html:t(()=>[...u[20]||=[o(`<w-accordion v-model="accordion" :items="items" />`,-1)]]),js:t(()=>[...u[21]||=[o(`data: () => ({
  items: [
...
`,-1)]]),default:t(()=>[i(E,{class:`discrete--bg`,modelValue:l.accordion3,"onUpdate:modelValue":u[2]||=e=>l.accordion3=e,items:l.itemsDisabled},null,8,[`modelValue`,`items`])]),_:1}),i(T,{h2:``},{default:t(()=>[...u[22]||=[o(`Shadow`,-1)]]),_:1}),i(D,{"content-class":`pa4`},{pug:t(()=>[...u[23]||=[o(`w-accordion(:items="items" shadow)`,-1)]]),html:t(()=>[...u[24]||=[o(`<w-accordion :items="items" shadow />`,-1)]]),js:t(()=>[...u[25]||=[o(`data: () => ({
  items: [
    {
      title: 'Item 1',
      content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi ut neque enim beatae autem iure, velit labore aut ipsa voluptatem aliquam distinctio harum. Possimus aliquid voluptatum facere incidunt dolor a.'
...
`,-1)]]),default:t(()=>[i(E,{class:`discrete--bg`,items:l.items,shadow:``},null,8,[`items`])]),_:1}),i(T,{h2:``},{default:t(()=>[...u[26]||=[o(`Color & background color`,-1)]]),_:1}),u[107]||=n(`p`,null,[o(`Like in most components, you can set a `),n(`code`,null,`color`),o(` for the text and a `),n(`code`,null,`bg-color`),o(` for the
background.`),n(`br`),o(`
No background color is set by default and the text color is inherited.`)],-1),i(D,{"content-class":`pa4`},{pug:t(()=>[o(`w-accordion(:items="items" color="amber-dark1")
...
`,-1)]]),default:t(()=>[i(E,{class:`discrete--bg`,items:l.items,color:`amber-dark1`},null,8,[`items`]),i(E,{class:`mt6`,items:l.items,"bg-color":l.$store.state.darkMode?`indigo-dark6`:`yellow-light5`},null,8,[`items`,`bg-color`])]),_:1}),i(T,{h3:``},{default:t(()=>[...u[28]||=[o(`Different color per item`,-1)]]),_:1}),u[108]||=n(`p`,null,[o(`The colors are set in the data in each item object.`),n(`br`),o(`
the default mapping for the color is the `),n(`code`,null,`color`),o(` key, but you can customize it with the
`),n(`code`,null,`item-color-key`),o(` prop.`)],-1),i(D,{"content-class":`pa4`},{pug:t(()=>[...u[29]||=[o(`w-accordion(:items="items")`,-1)]]),html:t(()=>[...u[30]||=[o(`<w-accordion :items="items" />`,-1)]]),js:t(()=>[...u[31]||=[o(`data: () => ({
  items: [
...
`,-1)]]),default:t(()=>[i(E,{class:`discrete--bg`,items:l.items2},null,8,[`items`])]),_:1}),i(T,{h2:``},{default:t(()=>[...u[32]||=[o(`Expand a single item at a time`,-1)]]),_:1}),i(D,{"content-class":`pa4`},{pug:t(()=>[...u[34]||=[o(`w-accordion(v-model="accordion" :items="items" expand-single)
...
`,-1)]]),default:t(()=>[i(E,{class:`discrete--bg`,modelValue:l.accordion4,"onUpdate:modelValue":u[3]||=e=>l.accordion4=e,items:l.items,"expand-single":``},null,8,[`modelValue`,`items`]),n(`div`,h,[u[33]||=o(`v-model:`,-1),n(`code`,g,c(l.accordion4),1)])]),_:1}),i(T,{h2:``},{default:t(()=>[...u[37]||=[o(`External control`,-1)]]),_:1}),i(D,{"content-class":`pa4`},{pug:t(()=>[...u[41]||=[o(`w-button.mr2(@click="accordion = Array&#40;3&#41;.fill&#40;true&#41;" sm) Expand all
...
div.mt3
  | v-model:
  code.ml1 `+c(`{{ accordion }}`),-1)]]),html:t(()=>[...u[42]||=[o(`<w-button
  class="mr2"
...
`,-1)]]),default:t(()=>[i(O,{class:`mr2`,onClick:u[4]||=e=>l.accordion5=[,,,].fill(!0),sm:``},{default:t(()=>[...u[38]||=[o(`Expand all`,-1)]]),_:1}),i(O,{onClick:u[5]||=e=>l.accordion5=[,,,].fill(!1),sm:``},{default:t(()=>[...u[39]||=[o(`Collapse all`,-1)]]),_:1}),i(E,{class:`mt4 discrete--bg`,modelValue:l.accordion5,"onUpdate:modelValue":u[6]||=e=>l.accordion5=e,items:l.items},null,8,[`modelValue`,`items`]),n(`div`,_,[u[40]||=o(`v-model:`,-1),n(`code`,v,c(l.accordion5),1)])]),_:1}),i(T,{h2:``},{default:t(()=>[...u[44]||=[o(`Custom rendering via slots`,-1)]]),_:1}),u[109]||=n(`p`,null,[o(`Customize all the tab items titles and/or content via the single slot `),n(`code`,null,`item-title`),o(`, and/or
all the tab items content via the single slot `),n(`code`,null,`item-content`),o(`.`)],-1),i(D,{"content-class":`pa4`},{pug:t(()=>[...u[45]||=[o(`w-accordion(:items="items" content-class="pa0")
  template(#item-title="{ item }")
    w-icon(lg :color="item.itemColor") `+c(`{{ item.icon }}`)+`
    .title3.my0.ml2(:class="item.itemColor") `+c(`{{ item.title }}`)+`
  template(#item-content="{ item }")
    w-alert.my0.pb3(border-left tile :color="item.itemColor" v-html="item.content")`,-1)]]),html:t(()=>[...u[46]||=[o(`<w-accordion :items="items" content-class="pa0">
  <template #item-title="{ item }">
...
`,-1)]]),default:t(()=>[i(E,{class:`discrete--bg`,items:l.items,"content-class":`pa0`},{"item-title":t(({item:e})=>[i(k,{lg:``,color:e.itemColor},{default:t(()=>[o(c(e.icon),1)]),_:2},1032,[`color`]),n(`div`,{class:a([`title3 my0 ml2`,e.itemColor])},c(e.title),3)]),"item-content":t(({item:e})=>[i(A,{class:`my0 pb3`,"border-left":``,tile:``,color:e.itemColor,innerHTML:e.content},null,8,[`color`,`innerHTML`])]),_:1},8,[`items`])]),_:1}),i(T,{h3:``,slug:`slots--different-title-and-content`},{default:t(()=>[...u[48]||=[o(`Different title and content layouts per item`,-1)]]),_:1}),u[110]||=n(`p`,null,[o(`Here is a more complex example using slots to render 3 totally diferent pane titles and contents.`),n(`br`),o(`
This time, an array of object is defined to show you can also do a mix of contents coming from the
the component's data or directly in the template.`)],-1),i(D,{"content-class":`pa4`},{pug:t(()=>[...u[62]||=[o(`w-accordion(:items="items")
  ...
  template(#item-content.item3)
    ...
    w-button.mt1(bg-color="primary" route="https://github.com/antoniandre/wave-ui")
      | Github
      w-icon.ml2(sm) mdi mdi-open-in-new`,-1)]]),html:t(()=>[...u[63]||=[o(`<w-accordion :items="items">
  <template #item-title.item1>
    This is the 1st item
...
</w-accordion>`,-1)]]),js:t(()=>[...u[64]||=[o(`data: () => ({
  items: [
    { id: 'item1' },
    { id: 'item2' },
    { id: 'item3' }
...
`,-1)]]),default:t(()=>[i(E,{class:`discrete--bg`,items:l.itemsCustom},{"item-title.item1":t(()=>[u[50]||=o(`This is the 1st item`,-1),i(j,{class:`ml2`,color:`red`,sm:``,outline:``},{default:t(()=>[...u[49]||=[o(`HOT`,-1)]]),_:1})]),"item-content.item1":t(()=>[u[51]||=n(`p`,null,`This content has a checklist.`,-1),u[52]||=n(`div`,{class:`title4`},`To do`,-1),i(M,{checklist:``,color:`primary`,items:[{label:`do this`},{label:`do that next`}]})]),"item-title.item2":t(()=>[i(k,{class:`mr1`,md:``,color:`amber`},{default:t(()=>[...u[53]||=[o(`mdi mdi-emoticon-excited-outline`,-1)]]),_:1}),u[54]||=n(`em`,null,`This is the 2nd item`,-1)]),"item-content.item2":t(({item:e})=>[u[56]||=n(`p`,null,`The full content here is custom and completely distinct and independent from the other items.`,-1),n(`p`,null,[u[55]||=o(`You also have access to the item's data if you need:`,-1),n(`code`,y,c(e),1)])]),"item-title.item3":t(()=>[u[58]||=n(`strong`,null,`This is the 3rd item`,-1),i(k,{class:`ml1`,md:``,color:`pink`},{default:t(()=>[...u[57]||=[o(`mdi mdi-emoticon-kiss-outline`,-1)]]),_:1})]),"item-content.item3":t(()=>[u[61]||=n(`p`,null,`Do you want to check the project on Github?`,-1),i(O,{class:`mt1`,"bg-color":`primary`,route:`https://github.com/antoniandre/wave-ui`},{default:t(()=>[u[60]||=o(`Github`,-1),i(k,{class:`ml2`,sm:``},{default:t(()=>[...u[59]||=[o(`mdi mdi-open-in-new`,-1)]]),_:1})]),_:1})]),_:1},8,[`items`])]),_:1}),i(T,{h2:``,slug:`w-accordion-item`},{default:t(()=>[...u[65]||=[o(`Custom rendering via `,-1),n(`span`,{class:`code`},`w-accordion-item`,-1)]]),_:1}),u[111]||=n(`p`,null,[o(`If you don't need data objects at all and all the items layouts will be different,
using the `),n(`strong`,{class:`code`},`w-accordion-item`),o(` component is a more flexible and straightforward approach.
`)],-1),i(D,{"content-class":`pa4`},{pug:t(()=>[...u[72]||=[o(`w-accordion
  w-accordion-item
  ...
  w-accordion-item
    ...
    template(#content) Item content 3`,-1)]]),html:t(()=>[...u[73]||=[o(`<w-accordion>
  <w-accordion-item>
...
`,-1)]]),default:t(()=>[i(E,{class:`discrete--bg`},{default:t(()=>[i(N,null,{title:t(()=>[...u[66]||=[o(`Item title 1`,-1)]]),content:t(()=>[...u[67]||=[o(`Item content 1`,-1)]]),_:1}),i(N,null,{title:t(()=>[...u[68]||=[o(`Item title 2`,-1)]]),content:t(()=>[...u[69]||=[o(`Item content 2`,-1)]]),_:1}),i(N,null,{title:t(()=>[...u[70]||=[o(`Item title 3`,-1)]]),content:t(()=>[...u[71]||=[o(`Item content 3`,-1)]]),_:1})]),_:1})]),_:1}),i(T,{h3:``,slug:`w-accordion-item--different-title-and-content`},{default:t(()=>[...u[74]||=[o(`Different title and content layouts per item`,-1)]]),_:1}),u[112]||=n(`p`,null,[o(`Same example as `),n(`a`,{href:`#slots--different-title-and-content`},`above`),o(` but using the `),n(`strong`,{class:`code`},`w-accordion-item`),o(` component.`)],-1),i(D,{"content-class":`pa4`},{pug:t(()=>[...u[87]||=[o(`w-accordion(:items="items")
  w-accordion-item
    template(#title)
      | This is the 1st item
      w-tag.ml2(color="red" sm outline) HOT
  ...
  w-accordion-item
    ...
    template(#content)
      ...
      w-button.mt1(bg-color="primary" route="https://github.com/antoniandre/wave-ui")
        | Github
        w-icon.ml2(sm) mdi mdi-open-in-new`,-1)]]),html:t(()=>[...u[88]||=[o(`<w-accordion>
  <w-accordion-item>
    <template #title>
      This is the 1st item
      <w-tag class="ml2" color="red" sm outline>HOT</w-tag>
...
`,-1)]]),default:t(()=>[i(E,{class:`discrete--bg`},{default:t(()=>[i(N,null,{title:t(()=>[u[76]||=o(`This is the 1st item`,-1),i(j,{class:`ml2`,color:`red`,sm:``,outline:``},{default:t(()=>[...u[75]||=[o(`HOT`,-1)]]),_:1})]),content:t(()=>[u[77]||=n(`p`,null,`This content has a checklist.`,-1),u[78]||=n(`div`,{class:`title4`},`To do`,-1),i(M,{checklist:``,color:`primary`,items:[{label:`do this`},{label:`do that next`}]})]),_:1}),i(N,null,{title:t(()=>[i(k,{class:`mr1`,md:``,color:`amber`},{default:t(()=>[...u[79]||=[o(`mdi mdi-emoticon-excited-outline`,-1)]]),_:1}),u[80]||=n(`em`,null,`This is the 2nd item`,-1)]),content:t(()=>[...u[81]||=[n(`p`,null,`The full content here is custom and completely distinct and independent from the other items.`,-1)]]),_:1}),i(N,null,{title:t(()=>[u[83]||=n(`strong`,null,`This is the 3rd item`,-1),i(k,{class:`ml1`,md:``,color:`pink`},{default:t(()=>[...u[82]||=[o(`mdi mdi-emoticon-kiss-outline`,-1)]]),_:1})]),content:t(()=>[u[86]||=n(`p`,null,`Do you want to check the project on Github?`,-1),i(O,{class:`mt1`,"bg-color":`primary`,route:`https://github.com/antoniandre/wave-ui`},{default:t(()=>[u[85]||=o(`Github`,-1),i(k,{class:`ml2`,sm:``},{default:t(()=>[...u[84]||=[o(`mdi mdi-open-in-new`,-1)]]),_:1})]),_:1})]),_:1})]),_:1})]),_:1}),i(T,{h2:``},{default:t(()=>[...u[89]||=[o(`Toggle icon options`,-1)]]),_:1}),i(T,{h3:``},{default:t(()=>[...u[90]||=[o(`Alternative style`,-1)]]),_:1}),u[113]||=n(`p`,null,[o(`With the option `),n(`code`,null,`icon-rotate90`),o(`, the icon will initially point to the left and will
rotate 90 degrees clockwise when expanding.`)],-1),i(D,{"content-class":`pa4`},{pug:t(()=>[...u[91]||=[o(`.title4 Icon on the left
w-accordion(:items="items" icon-rotate90)

.title4.mt6 Icon on the right
w-accordion(:items="items" icon-rotate90 expand-icon-right)`,-1)]]),html:t(()=>[...u[92]||=[o(`<div class="title4">
  Icon on the left
</div>
<w-accordion
  :items="items"
...
<w-accordion
  ...
  icon-rotate90
  expand-icon-right>
</w-accordion>`,-1)]]),js:t(()=>[...u[93]||=[o(`data: () => ({
  items: [
...
`,-1)]]),default:t(()=>[u[94]||=n(`div`,{class:`title4`},`Icon on the left`,-1),i(E,{class:`discrete--bg`,items:l.items,"expand-icon-rotate90":``},null,8,[`items`]),u[95]||=n(`div`,{class:`title4 mt6`},`Icon on the right`,-1),i(E,{class:`discrete--bg`,items:l.items,"expand-icon-rotate90":``,"expand-icon-right":``},null,8,[`items`])]),_:1}),i(T,{h3:``},{default:t(()=>[...u[96]||=[o(`More options`,-1)]]),_:1}),i(D,{"content-class":`pa4`},{pug:t(()=>[...u[97]||=[o(`.title4 1 custom icon (only expand)
...
.title4.mt6 Icon on the right
w-accordion(:items="items" expand-icon-right)`,-1)]]),html:t(()=>[...u[98]||=[o(`<div class="title4 mb2">
...
<w-accordion
  :items="items"
  expand-icon-right>
</w-accordion>`,-1)]]),js:t(()=>[...u[99]||=[o(`data: () => ({
  items: [
    {
      title: 'Item 1',
      content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi ut neque enim beatae autem iure, velit labore aut ipsa voluptatem aliquam distinctio harum. Possimus aliquid voluptatum facere incidunt dolor a.'
