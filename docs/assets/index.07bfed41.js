import{r as i,o as v,e as h,f as o,w as n,g as r,A as B,t as p,i as s}from"./vendor.e64646cc.js";import{_ as w,v as g}from"./index.f3654a4f.js";const V=r("p",null,[s("By default the overlay has a "),r("span",{class:"code"},"0.3"),s(` opacity with a black color and a z-index
...
`)],-1),N=s("Overlay with custom opacity and control on "),C=r("span",{class:"code"},"persistent",-1),S=r("p",null,"When the overlay is persistent, it will not close on click and on escape key.",-1),E=r("p",null,"When persistent is set to false and by default, the escape key will also close the overlay.",-1),x=s("Show overlay"),H=r("div",{class:"title4"},"Options",-1),U={class:"code white"},W={class:"code white"},D=s("wi-cross"),T=s("Hide overlay"),j=s(`w-flex(wrap)
...
`),P=s("Overlay with custom background color"),M=s("Show a blue overlay"),R=s("wi-cross"),q=s("Hide overlay"),F=s(`w-button(bg-color="primary" dark @click="showOverlay = true") Show a blue overlay
