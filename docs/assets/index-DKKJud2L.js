import{r,o as m,g as p,a as t,w as a,b as e,t as s,d as i,c as S,f as j,h as y,_ as u,P as _}from"./index-Cfi-V_jV.js";const E=y(`<div class="title3">A simple &lt;img&gt;</div><p>will display when loaded, and will take the dimensions of the actual image.<br>
...
</p>`,4),L=i("p",null,"With no given width, height or ratio, the image is loaded full-size.",-1),x=i("p",null,[e(`You may want to have a responsive image. By setting an image ratio (height / width) and a width
...
You can customize the transition.`,-1),V={class:"w-flex wrap justify-center align-center"},C={class:"mr4 my2"},z=i("div",{class:"title3 mb2"},"Transition names",-1),D=i("strong",null,"Dev notes:",-1),O=i("br",null,null,-1),P=i("strong",{class:"code"},"w-image",-1),N=i("p",null,[e(`The default fallback is a blank 1x1 transparent gif. So if the image can't load, a transparent
...
`)]),_:1}),t(l,{h2:""},{default:a(()=>[e("Transitions")]),_:1}),I,t(d,null,{pug:a(()=>[e(`w-flex(wrap justify-center align-center)
  ...
  w-image(:src="img.src" :width="500" :height="250" :transition="img.transition")`)]),html:a(()=>[e(`<w-flex wrap justify-center align-center>
  <div class="mr4 my2">
...
The reason for it is that the image first loads in the `),P,e(` component, then
once it's fully loaded, the image src is filled (or background url) and the image would load again
if you disable the cache. On big images, you would then see a truncated image until completely
loaded, just like a standard <img>.
`)]),_:1}),t(l,{h2:""},{default:a(()=>[e("Fallback")]),_:1}),N,t(d,{"content-class":"text-center"},{pug:a(()=>[e('w-image(\n  :src="`${baseUrl}images/broken.png`"\n  :fallback="`${baseUrl}images/not-found.jpg`"\n  @error="showError = true")\n\nw-alert(v-if="showError" error) Oops. The image could not load!')]),html:a(()=>[e(`<w-image
  :src="\`\${baseUrl}images/broken.png\`"
  :fallback="\`\${baseUrl}images/not-found.jpg\`"
  @error="showError = true">
</w-image>
