import{N as e,W as t,c as n,d as r,g as i,h as a,k as o}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as s}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{B as c,a as l}from"./index-DAkWssgz.js";function u(s,c){let l=e(`alert`),u=e(`title-link`),d=e(`w-textarea`),f=e(`example`),p=e(`w-icon`);return o(),r(`div`,null,[i(l,{info:``},{default:t(()=>[...c[0]||=[n(`div`,{class:`title4`},`Good to know`,-1),n(`p`,{class:`body`},[a(`Any HTML attribute or JavaScript event listeners attached to the component will be applied to the
