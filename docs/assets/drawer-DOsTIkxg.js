import{G as e,N as t,W as n,_t as r,bt as i,c as a,d as o,g as s,h as c,k as l,m as u}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as d}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{O as f,X as p}from"./index-BQVpTp7r.js";var m={class:`py12 w-flex column align-center justify-center`},h={class:`py12 w-flex column align-center justify-center`},g={class:`w-flex pa2 align-center wrap`},_={class:`w-flex align-center py1`},v={class:`w-flex align-center justify-center fill-height`};function y(d,f,y,b,x,S){let C=t(`title-link`),w=t(`w-button`),T=t(`example`),E=t(`w-drawer`),D=t(`w-card`),O=t(`w-icon`),k=t(`ssh-pre`);return l(),o(`div`,null,[s(C,{h2:``},{default:n(()=>[...f[29]||=[c(`Basic`,-1)]]),_:1}),s(T,{"content-class":`w-flex align-center wrap`},{pug:n(()=>[...f[31]||=[c(`w-button(@click="openDrawer = true" outline) Open drawer
