import{r as d,g as l,o as t,a as r,b as i,h as c,w as p,e as a,n as g,F as n,j as b,t as y,d as v,_ as h}from"./index-eD21R81v.js";const C={class:"xs12 pa1"},T={class:"xs4 pa1"},z={class:"xs3 pa1"},M={class:"xs2 pa1"},N={class:"title2 mt0"},S={class:"xs12 md6 lg4 xl2 pa1"},U={class:"primary--bg py3"},V={class:"xs12 md6 lg4 xl2 pa1"},B={class:"primary--bg py3"},F={class:"xs12 md6 lg4 xl2 pa1"},I={class:"primary--bg py3"},R={class:"xs12 md6 lg4 xl2 pa1"},j={class:"primary--bg py3"},q={class:"xs12 md6 lg4 xl2 pa1"},G={class:"primary--bg py3"},L={class:"xs12 md6 lg4 xl2 pa1"},W={class:"primary--bg py3"};function D(s,e){const o=d("title-link"),w=d("ssh-pre"),u=d("alert"),m=d("example"),f=d("w-card"),$=d("w-flex"),k=d("router-link");return t(),l("main",null,[r(o,{class:"mt4",h1:""},{default:p(()=>e[0]||(e[0]=[a("Grid system (flexbox)")])),_:1}),e[33]||(e[33]=i("div",{class:"title3"},"The grid system (using flexbox) is 12-cell based by default.",-1)),e[34]||(e[34]=i("p",null,[a(`Its purpose is to divide the available width (in percentage)
