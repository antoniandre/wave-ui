import{n as i,P as d}from"./index.bd0b62cc.js";import"./vendor.4f8da9ec.js";var c=function(){var s=this,a=s.$createElement,e=s._self._c||a;return e("main",[e("title-link",{staticClass:"mt4",attrs:{h1:""}},[s._v("shadows, borders & border radii")]),s._m(0),e("alert",{attrs:{tip:""}},[s._v(`The following offered classes are targetting the common use cases: there isn't a CSS class for
...
In this case you need to style them from your CSS.`)])],1)},l=[function(){var s=this,a=s.$createElement,e=s._self._c||a;return e("p",[s._v("Wave UI offers a few CSS helper classes to control the drop shadow, borders and border radii."),e("br"),s._v(`
...
radius, `),e("code",[s._v(".bdrsm")]),s._v(" will produce a "),e("strong",[s._v("max")]),s._v(" border radius ("),e("span",{staticClass:"code"},[s._v("100%")]),s._v(").")])}];const o={data:()=>({colors:d,horizontal:!1,baseUrl:"/wave-ui/"})},r={};var v=i(o,c,l,!1,b,null,null,null);function b(s){for(let a in r)this[a]=r[a]}var h=function(){return v.exports}();export{h as default};
