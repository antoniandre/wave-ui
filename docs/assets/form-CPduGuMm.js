...
The v-model on the `),i(`span`,{class:`code`},`w-form`),s(` gets updated with the form status.`)],-1),o(P,null,{pug:t(()=>[...p[28]||=[s(`w-form(v-model="valid")
  ...
  .text-right.mt6
    ...
    w-button(type="submit" bg-color="success" :disabled="valid === false") Validate`,-1)]]),html:t(()=>[...p[29]||=[s(`<w-form v-model="valid">
  <w-input
    label="First name"
...
data will be submitted to the URL set in the <code>action</code> attribute.</p><p class="mt2">In this example, the form data will be submitted in another tab to a fake <span class="code">test.php</span>.
  ...
  w-input.mt3(label="Last name" :validators="[validators.required]")
  .text-right.mt6
    w-button(type="submit" bg-color="success") Validate`,-1)]]),html:t(()=>[...p[36]||=[s(`<w-form
  action="test.php"
  method="post"
  target="_blank"
  allow-submit>
...
with <code>no-keyup-validation</code> and <code>no-blur-validation</code>.</p>`,1),o(P,null,{pug:t(()=>[...p[41]||=[s(`w-form(no-keyup-validation no-blur-validation)
  ...
  w-input.mt3(label="Last name" :validators="[validators.required]")
  .text-right.mt6
    w-button(type="submit" bg-color="success") Validate`,-1)]]),html:t(()=>[...p[42]||=[s(`<w-form no-keyup-validation no-blur-validation>
  <w-input
    label="First name"
    :validators="[validators.required]">
  </w-input>
...
value (or v-model) to `),i(`code`,null,`null`),s(`, like pristine.`)],-1),o(P,null,{pug:t(()=>[...p[47]||=[s(`w-form(v-model="valid")
  ...
  .text-right.mt6
    ...
    w-button.my1(type="submit" bg-color="success") Validate`,-1)]]),html:t(()=>[...p[48]||=[s(`<w-form v-model="valid">
  <w-input
    label="First name"
    :validators="[validators.required]">
  </w-input>
...
`,-1)]]),default:t(()=>[o(N,{modelValue:T.form4.valid,"onUpdate:modelValue":p[1]||=e=>T.form4.valid=e},{default:t(()=>[o(j,{label:`First name`,validators:[T.validators.required]},null,8,[`validators`]),o(j,{class:`mt3`,label:`Last name`,validators:[T.validators.required]},null,8,[`validators`]),i(`div`,b,[o(M,{class:`my1 mr2`,"bg-color":`warning`,type:`reset`},{default:t(()=>[...p[45]||=[s(`Reset`,-1)]]),_:1}),o(M,{class:`my1`,type:`submit`,"bg-color":`success`},{default:t(()=>[...p[46]||=[s(`Validate`,-1)]]),_:1})])]),_:1},8,[`modelValue`])]),_:1}),o(O,{h2:``},{default:t(()=>[...p[50]||=[s(`On validate, on success & on error events`,-1)]]),_:1}),p[88]||=u(`<p class="title5">These events are fired on submit.</p><ul><li class="mt1"><code>before-validate</code> is always fired as soon as a submission is attempted (e.g. submit
...
w-form(
  ...
  .text-right.mt6
    w-button(type="submit" bg-color="success") Validate`,-1)]]),html:t(()=>[...p[54]||=[s(`<w-alert
  :success="success"
  :error="error"
  :info="!success && !error">
  `+r(`{{ !success && !error ? 'The form is still pristine' : (success ? 'Success' : 'Error') }}`)+`
...
w-form.mt4(v-model="form.valid" :disabled="form.disabled" :readonly="form.readonly")
  ...
  w-flex.mt4(justify-end)
    ...
    w-button.ml2(type="submit" bg-color="success" :disabled="form.valid === false") Validate`,-1)]]),html:t(()=>[...p[74]||=[s(`<w-button
  :outline="!form.disabled"
