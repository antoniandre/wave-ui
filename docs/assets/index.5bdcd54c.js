import{r,o as p,f as m,a as e,w as s,b as n,d as l,i as g,_ as u,a3 as _}from"./index.cc5eb951.js";const x=l("p",null,[n("If you want a different style than the "),l("span",{class:"code"},"w-progress"),n(` component, the spinner is a light
...
much point in using a `),l("code",null,"v-model"),n(" here as the spinner will never emit a value update.")],-1),S=g(`<p>The spinner size can be controlled via the preset sizes <code>xs</code>, <code>sm</code>, <code>md</code>,
<code>lg</code>, <code>xl</code>, or explicit <code>size</code> prop.</p>`,1),y=l("p",null,[n("Like in most components, you can set a "),l("code",null,"color"),n(" for the spinner.")],-1);function $(t,c,f,h,w,d){const a=r("title-link"),o=r("w-spinner"),i=r("example"),v=r("w-button");return p(),m("div",null,[x,e(a,{h2:""},{default:s(()=>[n("Three dots (default)")]),_:1}),e(i,{"content-class":"w-flex justify-center"},{pug:s(()=>[n("w-spinner")]),html:s(()=>[n(`<w-spinner />
...
`)]),default:s(()=>[e(v,{class:"mr4",onClick:c[0]||(c[0]=I=>t.showSpinner=!t.showSpinner)},{default:s(()=>[n("Toggle spinner")]),_:1}),e(o,{"model-value":t.showSpinner},null,8,["model-value"])]),_:1}),e(a,{h2:""},{default:s(()=>[n("Sizes")]),_:1}),S,e(i,{"content-class":"w-flex justify-center"},{pug:s(()=>[n(`w-flex(align-center justify-center)
