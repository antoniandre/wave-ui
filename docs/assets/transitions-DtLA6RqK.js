import{r as s,g as r,o as d,a as o,h as S,b as a,w as t,e as i,p as y,v as k,t as l,d as p,c as $,_ as D}from"./index-CAQLAca3.js";const R={class:"w-flex"},V={key:0,class:"transition-box"},H={key:0,class:"transition-box"},N={key:0,class:"transition-box"},j={key:0,class:"transition-box"},A={key:0,class:"transition-box"},I={key:0,class:"transition-box text-nowrap"},L={key:0,class:"transition-box"},M={key:0,class:"transition-box text-nowrap"},P={key:0,class:"transition-box text-nowrap"},U={key:0,class:"transition-box text-nowrap"},W={key:0,class:"transition-box pa6 ma10 yellow-light5--bg",style:{width:"auto"}},J={style:{height:"90px",overflow:"hidden",padding:"4px"}},q={class:"ml1",href:"https://github.com/vuejs/core/issues/994"};function z(e,n,K,O,Q,Z){const f=s("title-link"),b=s("ssh-pre"),m=s("alert"),g=s("w-button"),E=s("w-transition-fade"),w=s("w-flex"),F=s("w-transition-scale"),Y=s("w-transition-scale-fade"),X=s("w-transition-bounce"),h=s("w-transition-twist"),x=s("w-transition-expand"),v=s("w-transition-slide-fade"),c=s("example"),C=s("w-card"),T=s("w-transition-slide"),B=s("w-icon");return d(),r("main",null,[o(f,{class:"mt4",h1:""},{default:t(()=>n[12]||(n[12]=[i("Transitions")])),_:1}),n[53]||(n[53]=S('<p>Here is a list of all the available transition components.</p><ul><li><code>w-transition-fade</code></li><li class="mt1"><code>w-transition-scale</code></li><li class="mt1"><code>w-transition-scale-fade</code></li><li class="mt1"><code>w-transition-bounce</code></li><li class="mt1"><code>w-transition-twist</code></li><li class="mt1"><code>w-transition-expand</code></li><li class="mt1"><code>w-transition-slide</code></li><li class="mt1"><code>w-transition-slide-fade</code></li></ul>',2)),o(m,{info:""},{default:t(()=>[n[15]||(n[15]=i(`The transitions (based on
...
`)])),default:t(()=>[a("div",J,[o(g,{class:"mb2",onClick:n[11]||(n[11]=u=>e.showCard=!e.showCard)},{default:t(()=>[i(l(e.showCard?"Hide":"Show")+" Card",1)]),_:1}),o(T,{left:""},{default:t(()=>[e.showCard?(d(),$(C,{key:0,class:"primary-light3--bg white sliding-card"},{default:t(()=>n[37]||(n[37]=[a("div",{class:"title3 mb0"},"A sliding card.",-1)])),_:1})):p("",!0)]),_:1})])]),_:1}),o(f,{h2:""},{default:t(()=>n[41]||(n[41]=[i("Transition duration")])),_:1}),n[57]||(n[57]=a("p",null,[i(`You can easily override the default transition/animation duration by setting an explicit
