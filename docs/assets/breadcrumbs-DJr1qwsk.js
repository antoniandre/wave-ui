import{A as e,G as t,P as n,c as r,d as i,g as a,h as o}from"./runtime-core.esm-bundler-CLfruy3s.js";import{t as s}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{L as c}from"./index-I7dyuwKt.js";function l(s,c,l,u,d,f){let p=n(`title-link`),m=n(`w-breadcrumbs`),h=n(`example`),g=n(`w-tag`);return e(),i(`div`,null,[a(p,{h2:``},{default:t(()=>[...c[0]||=[o(`Default`,-1)]]),_:1}),c[34]||=r(`p`,null,[o(`By default, each item except the last one will be a link providing that a route attribute is found
