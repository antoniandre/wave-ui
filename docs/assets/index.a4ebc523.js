import{r as i,o as v,f,a as o,w as l,d as t,b as e,h as r,_ as x,B as V,C,D as T}from"./index.f7552e6c.js";const E=t("p",{class:"mb3"},"What it looks like:",-1),P=t("div",{class:"title4 mt4"},"States",-1),$={class:"w-flex wrap"},j=t("p",{class:"mt12"},[e("There are 2 components: "),t("span",{class:"code"},"w-checkbox"),e(" & "),t("span",{class:"code"},"w-checkboxes"),e(`.
...
`)],-1),S=t("div",{class:"w-divider"},null,-1),M=t("div",{class:"title4 mb2"},"Basic use",-1),q=t("div",{class:"title4 mt8 mb2"},"Using v-model on a single checkbox",-1),B={class:"ml6"},L={class:"ml1"},W=t("div",{class:"title4 mt8 mb2"},"Using an array of v-model for multiple checkboxes",-1),H={class:"ml6"},N={class:"ml1"},z=t("code",null,"name",-1),K=t("code",null,"v-model",-1),R=t("kbd",null,"tab",-1),F=t("kbd",null,"space",-1),Y=t("kbd",null,"enter",-1),G=t("br",null,null,-1),J=t("strong",{class:"title5"},"Form validation",-1),Q=t("p",null,[e("When a validation is needed on checkboxes, each individual checkbox ("),t("span",{class:"code"},"w-checkbox"),e(`) has a
