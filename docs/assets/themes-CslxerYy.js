import{G as e,N as t,W as n,bt as r,c as i,d as a,g as o,h as s,k as c,m as l}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as u}from"./plugin-vue_export-helper-B80Cc4Ui.js";import{Y as d}from"./index-BhRaCC4I.js";var f={class:`title2`},p={class:`title2`},m={class:`title2`},h={class:`mt6`},g={class:`mt6`},_={class:`w-flex align-center`},v={class:`mt6`},y={class:`w-flex align-center`},b={class:`mt6`};function x(u,x,S,C,w,T){let E=t(`title-link`),D=t(`ssh-pre`),O=t(`w-icon`),k=t(`w-flex`),A=t(`example`),j=t(`w-button`),M=t(`alert`);return c(),a(`main`,null,[o(E,{class:`mt4`,h1:``},{default:n(()=>[...x[2]||=[s(`Themes`,-1)]]),_:1}),x[43]||=i(`p`,null,`Wave UI offers a light theme (by default) and a dark theme.`,-1),o(E,{h2:``},{default:n(()=>[...x[3]||=[s(`Setting an initial theme`,-1)]]),_:1}),x[44]||=i(`p`,null,`You can set a theme at Wave UI's initialization, with:`,-1),o(D,{language:`js`,dark:u.$store.state.darkMode},{default:n(()=>[...x[4]||=[s(`app.use(WaveUI, {
