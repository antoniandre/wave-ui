import{r as c,o as a,f as d,a as l,w as e,b as s,F as r,z as x,e as n,M as f}from"./vendor.c30f2c6c.js";import{_ as g}from"./index.67df9d80.js";const v=n("Flex layout classes"),w=s("span",{class:"code"},"w-flex",-1),m=n(" component & helper classes"),y=f(`<p>the <code>w-flex</code> component and the <code>.w-flex</code> class both allow a flex layout that you can
...
`),U=s("div",{class:"title3"},"w-flex, column direction",-1),G={class:"grow mx1"},J=s("p",{class:"code mb1"},".justify-start (default)",-1),M=s("div",{class:"box"},null,-1),Y=s("div",{class:"box"},null,-1),H=s("div",{class:"box"},null,-1),K={class:"grow mx1"},O=s("p",{class:"code mb1"},".justify-center",-1),P=s("div",{class:"box"},null,-1),Q=s("div",{class:"box"},null,-1),X=s("div",{class:"box"},null,-1),Z={class:"grow mx1"},$=s("p",{class:"code mb1"},".justify-space-between",-1),ss=s("div",{class:"box"},null,-1),es=s("div",{class:"box"},null,-1),ns=s("div",{class:"box"},null,-1),ls={class:"grow mx1"},ts=s("p",{class:"code mb1"},".justify-end",-1),os=s("div",{class:"box"},null,-1),is=s("div",{class:"box"},null,-1),cs=s("div",{class:"box"},null,-1),as=n(`w-flex(basis-zero wrap)
  .grow.mx1
...
.wrapper {
  ...
  padding: 12px;
  height: 140px;
}`),Ue=s("div",{class:"shrink mx2 xs-hide"},null,-1),Ge=s("div",{class:"box shrink"},null,-1),Je=s("div",{class:"box shrink"},null,-1),Me=s("div",{class:"spacer"},null,-1),Ye=s("div",{class:"box shrink"},null,-1),He=n(`w-flex.wrapper(column)
  .box.shrink
  .box.shrink
  .spacer
  .box.shrink`),Ke=n(`<w-flex column class="wrapper">
...
`),En=s("p",{class:"mt4"},[s("strong",null,"Solution:"),n(" there are a couple of ways to bypass this limitation.")],-1),In=s("h4",null,"1. Wrap children in padded boxes & apply equivalent negative margin on parent",-1),Ln={class:"yellow-light5--bg bd1"},Rn={class:"xs6 pa2"},Un=s("div",{class:"box d-flex justify-center code"},".xs6",-1),Gn=[Un],Jn=n(`.yellow-light5--bg.bd1
  w-flex.ma-2(wrap)
    .xs6.pa2(v-for="i in 4")
      .box .xs6`),Mn=n(`<div class="yellow-light5--bg bd1">
...
`),Hn=s("h4",null,[n("2. Use the "),s("strong",{class:"code"},"w-grid"),n(" component instead")],-1),Kn={class:"yellow-light5--bg bd1"},On=s("div",{class:"box code"},"<div>",-1),Pn=s("div",{class:"box code"},"<div>",-1),Qn=s("div",{class:"box code"},"<div>",-1),Xn=s("div",{class:"box code"},"<div>",-1),Zn=n(`.yellow-light5--bg.bd1
