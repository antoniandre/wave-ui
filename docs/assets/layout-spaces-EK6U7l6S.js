import{r as o,o as r,g as c,a as s,w as a,b as e,d as n,h,_ as d}from"./index-Dfa3vTvi.js";const g=h(`<p>Margins and paddings are incrementable from 0 to 12 using this syntax: <code>ma[number]</code>,
...
</p>`,1),p={class:"orange-light4--bg pa12 grey-dark5"},m={class:"yellow-light5--bg pa3"},u=n("span",{class:"code inherit"},"pa12",-1),x=n("br",null,null,-1),b=n("span",{class:"code inherit"},"pax",-1),f=n("span",{class:"code inherit"},"max",-1),_=n("br",null,null,-1),v=n("div",{class:"green-light4--bg mt8 pa3"},[e("This green container has a "),n("span",{class:"code inherit"},"mt8"),e(` class which results in a top margin of: 8 x 4 x
...
orange container.`)],-1),T=n("div",{class:"orange-light4--bg pa8"},null,-1),z=n("div",{class:"green-light4--bg mt-8 mx8 pa3 grey-dark5"},[e("This green container has a "),n("span",{class:"code inherit"},"mt-8"),e(` class which results in a negative top margin of: -8 x 4 x
...
`),s(l,{to:"customization"},{default:a(()=>[e("customization")]),_:1}),e(" page."),_]),v])]),_:1}),s(t,{h3:""},{default:a(()=>[e("Negative margin")]),_:1}),y,s(i,null,{pug:a(()=>[e(`.orange-light4--bg.pa8
