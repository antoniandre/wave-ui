import{r,o as m,f as p,a as t,w as a,b as e,h as s,d as i,c as S,e as j,i as y,_ as u,O as _}from"./index.bf306805.js";const E=y(`<div class="title3">A simple &lt;img&gt;</div><p>will display when loaded, and will take the dimensions of the actual image.<br>
...
</p>`,1),R=i("p",null,`This image is very big, so that you have time to see the spinner while loading.
Refresh the page if you haven't seen it!`,-1),B=i("strong",null,"Dev notes:",-1),W=i("br",null,null,-1),A=i("strong",{class:"code"},"w-image",-1),I=i("p",null,`Once the image is fully loaded, it will display in one piece with a fade transition by default.
...
`)]),default:a(()=>[t(o,{src:`${n.baseUrl}images/japanese-wave.png`,width:"100%",tag:"img",style:{"max-width":"700px"}},null,8,["src"])]),_:1}),t(l,{h2:""},{default:a(()=>[e("Loading spinner")]),_:1}),R,t(d,{"content-class":"text-center"},{pug:a(()=>[e('w-image(:src="`${baseUrl}images/spirit-island--alberta.png`" width="100%" :ratio="1 / 2")')]),html:a(()=>[e(`<w-image
  ...
  // if the image is in the public/ folder.
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})`)]),default:a(()=>[t(o,{src:`${n.baseUrl}images/spirit-island--alberta.png`,width:"100%",ratio:1/2},null,8,["src"])]),_:1}),t(v,{tip:""},{default:a(()=>[B,e(" disabling the browser cache will prevent you from seeing the transition."),W,e(`
