import{r as i,o as p,f as m,a as e,w as s,b as l,e as n,i as g,_ as h,bW as w}from"./index.5f88aff1.js";const x=l("p",null,[n("If you want a different style than the "),l("span",{class:"code"},"w-progress"),n(` component, the spinner is a light
...
much point in using a `),l("code",null,"v-model"),n(" here as the spinner will never emit a value update.")],-1),C=n("Toggle spinner"),N=n(`w-button.mr4(@click="showSpinner = !showSpinner") Toggle spinner
...
<code>lg</code>, <code>xl</code>, or explicit <code>size</code> prop.</p>`,1),W=n(`w-flex(align-center justify-center)
...
`),L=n("Colors"),M=l("p",null,[n("Like in most components, you can set a "),l("code",null,"color"),n(" for the spinner.")],-1),q=n(`w-spinner.ma1(fade color="green")
