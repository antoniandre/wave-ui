import{r as d,o as u,e as h,f as l,w as t,g as i,i as e,t as o,j as k,N as x}from"./vendor.e64646cc.js";import{_ as v,s as y}from"./index.90e40c3f.js";const j={class:"lists-demo"},V=i("p",null,[e("The "),i("span",{class:"code"},"w-list"),e(" component has multiple uses:")],-1),A=e("Simple list with or without icons"),S=e("Checklists"),$=e("Navigation menus"),T=e("List of selectable items"),E=e("Basic lists"),D={class:"w-flex wrap"},U={class:"grow"},W=i("div",{class:"title3"},"Most basic",-1),N={class:"grow"},P=i("div",{class:"title3"},"With icons",-1),z=e(`.w-flex.wrap
  .grow
    .title3 Most basic
    w-list(:items="items")
  .grow
    .title3 With icons
    w-list(:items="items" icon="wi-check")`),M=e(`<w-flex wrap>
  <div class="grow">
...
`),R=e("Color & hoverable"),B=i("p",null,[e("Like in most components, you can set a "),i("code",null,"color"),e(" for the text and a "),i("code",null,"bg-color"),e(` for the
background.`)],-1),K=i("br",null,null,-1),L=e(`w-list(:items="items" color="pink" hover)
br
...
<div class="title3 mt2">
  ...
  selection: 2,
  itemClicked: null
})`),Ie=i("p",null,[e("Note: you can get the list selection from the v-model, or by listening to the "),i("span",{class:"code"},"input"),e(" event.")],-1),Ce=e("Checklists"),xe={class:"grow"},je=i("div",{class:"title3 mb4"},"Default",-1),Ve={class:"grow"},Ae=i("div",{class:"title3 mb4"},"Round checkboxes",-1),Se={class:"grow"},$e=i("div",{class:"title3 mb4"},"Custom rendering, default styles",-1),Te=i("div",{class:"spacer"},null,-1),Ee={class:"grow"},De=i("div",{class:"title3 mb4"},"Custom rendering & styles",-1),Ue=i("div",{class:"spacer"},null,-1),We=e(`data: () => ({
  listItems1: [
    { label: 'Item 1', value: 1 },
    { label: 'Item 2', value: 2 },
    { label: 'Item 3', value: 3 },
...
`),Pe=e("Checklist colors"),ze=i("p",null,"A checklist can have all the color options that the normal list can have, even a different color per item.",-1),Me=e('w-list(v-model="selection5" :items="items" checklist)'),Oe=e(`<w-list
  v-model="selection"
  :items="items"
  checklist>
</w-list>`),Re=e(`data: () => ({
...
`),Be=e("Navigation lists"),Ke=i("p",null,[e("The navigation list expects a "),i("code",null,"route"),e(" attribute in the items that are links."),i("br"),e(`
...
</w-flex>`,1)]),js:t(()=>[We]),css:t(()=>[Ne]),default:t(()=>[l(w,{wrap:"","basis-zero":"",gap:3},{default:t(()=>[i("div",xe,[je,l(c,{modelValue:s.selection3,"onUpdate:modelValue":a[3]||(a[3]=n=>s.selection3=n),items:s.listItems1,checklist:"",color:"green"},null,8,["modelValue","items"])]),i("div",Ve,[Ae,l(c,{modelValue:s.selection4,"onUpdate:modelValue":a[4]||(a[4]=n=>s.selection4=n),items:s.listItems1,checklist:"","round-checkboxes":"",color:"green"},null,8,["modelValue","items"])])]),_:1}),l(w,{class:"mt4",wrap:"","basis-zero":"",gap:3},{default:t(()=>[i("div",Se,[$e,l(c,{modelValue:s.selection6,"onUpdate:modelValue":a[5]||(a[5]=n=>s.selection6=n),items:s.listItems2,"item-value-key":"id",checklist:"",color:"primary"},{item:t(({item:n})=>[i("span",null,o(n.label),1),Te,l(b,{md:""},{default:t(()=>[e(o(n.icon),1)]),_:2},1024)]),_:1},8,["modelValue","items"])]),i("div",Ee,[De,l(c,{class:"custom",modelValue:s.selection7,"onUpdate:modelValue":a[6]||(a[6]=n=>s.selection7=n),items:s.listItems2,"item-value-key":"id",checklist:"",color:"primary"},{item:t(({item:n})=>[i("span",null,o(n.label),1),Ue,l(b,{md:""},{default:t(()=>[e(o(n.icon),1)]),_:2},1024)]),_:1},8,["modelValue","items"])])]),_:1})]),_:1}),l(m,{h3:""},{default:t(()=>[Pe]),_:1}),ze,l(r,null,{pug:t(()=>[Me]),html:t(()=>[Oe]),js:t(()=>[Re]),default:t(()=>[l(c,{modelValue:s.selection5,"onUpdate:modelValue":a[7]||(a[7]=n=>s.selection5=n),items:s.listItems5,checklist:""},null,8,["modelValue","items"])]),_:1}),l(m,{h2:""},{default:t(()=>[Be]),_:1}),Ke,Le,l(r,null,{pug:t(()=>[e(`w-list(:items="items" nav color="primary")
  template(#item="{ item }")
    span `+o("{{ item.label }")+`}
    .spacer
