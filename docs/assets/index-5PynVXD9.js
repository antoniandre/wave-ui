import{r as c,o as b,g as f,a as n,w as i,b as e,d as o,t as l,n as C,_ as v,q as y}from"./index-Bpc6IslX.js";const T={class:"mt3"},S={class:"ml1"},j={class:"mt3"},A={class:"ml1"},E={class:"mt3"},V={class:"ml1"},D={class:"mt3"},P={class:"ml1"},$={class:"ml1"};function U(a,t,w,h,x,u){const r=c("title-link"),s=c("w-accordion"),d=c("example"),g=c("w-button"),p=c("w-icon"),q=c("w-alert"),I=c("w-tag"),k=c("w-list");return b(),f("div",null,[n(r,{h2:""},{default:i(()=>t[7]||(t[7]=[e("Basic")])),_:1}),n(s,{items:a.items},null,8,["items"]),t[87]||(t[87]=o("p",{class:"grey-light2 my4"},`Now that you've seen the default accordion in real context, all the accordions of this page will have a
