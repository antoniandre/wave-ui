import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,xt as s}from"./runtime-core.esm-bundler-BuLlhxCm.js";import{t as c}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{i as l}from"./index-DcVDxcA5.js";function u(c,l,u,d,f,p){let m=n(`title-link`),h=n(`w-timeline`),g=n(`example`),_=n(`w-icon`),v=n(`w-tag`);return e(),i(`div`,null,[a(m,{h2:``},{default:t(()=>[...l[0]||=[o(`Basic`,-1)]]),_:1}),a(g,null,{pug:t(()=>[...l[1]||=[o(`w-timeline(:items="items")`,-1)]]),html:t(()=>[...l[2]||=[o(`<w-timeline :items="items"></w-timeline>`,-1)]]),js:t(()=>[...l[3]||=[o(`data: () => ({
  items: [
...
`,-1)]]),default:t(()=>[a(h,{items:c.items3,color:`primary`},null,8,[`items`])]),_:1}),a(m,{h2:``},{default:t(()=>[...l[20]||=[o(`Custom item template`,-1)]]),_:1}),a(g,null,{pug:t(()=>[...l[23]||=[o(`w-timeline(:items="items")
  template(#item="{ item, index }")
    ...
    w-tag.white.grey-light2--bg `+s(`{{ index }}`),-1)]]),html:t(()=>[...l[24]||=[o(`<w-timeline :items="items">
  <template #item="{ item, index }">
...
`,-1)]]),default:t(()=>[a(h,{items:c.items1},{item:t(({item:e,index:n})=>[a(_,null,{default:t(()=>[...l[21]||=[o(`wi-check`,-1)]]),_:1}),l[22]||=r(`span`,{class:`mx2`},`This is the custom item`,-1),a(v,{class:`white grey-light2--bg`},{default:t(()=>[o(s(n),1)]),_:2},1024)]),_:1},8,[`items`])]),_:1}),a(m,{h3:``},{default:t(()=>[...l[26]||=[o(`Different custom template per item`,-1)]]),_:1}),a(g,null,{pug:t(()=>[...l[29]||=[o(`w-timeline(:items="items")
  template(#item.3)
