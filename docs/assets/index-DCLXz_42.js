import{r as c,o as w,g,a as e,w as o,b as t,m as _,n as v,t as S,d as a,h as b,_ as h,B as x}from"./index-DmbSWeYz.js";const $=a("p",null,[t("By default (if no "),a("code",null,"color"),t(" or "),a("code",null,"bg-color"),t(" is applied) the primary color will be applied.")],-1),D=b(`<p>Setting colors on buttons is quite straightforward:
...
You can override this color with <code>.w-app .primary--bg {color: #000;}</code>.</li></ul></p>`,2),C=a("h3",null,"Mix background and text colors",-1),L=a("p",null,[t("Like in most components, you can set a "),a("code",null,"color"),t(" for the text and a "),a("code",null,"bg-color"),t(` for the
background.`)],-1),B=b(`<h3>Dark / Light</h3><p>By default the <code>primary</code> color is considered dark as well as the four status colors:
...
For the rest you can use the <code>dark</code> prop or set the <code>color</code> prop to \`white\`.</p>`,2),T=b(`<p>The button size can be controlled via the preset sizes <code>xs</code>, <code>sm</code>, <code>md</code>,
<code>lg</code>, <code>xl</code> or via the <code>width</code> and <code>height</code> props.</p>`,1),z=a("br",null,null,-1),A=a("br",null,null,-1),I=a("h3",null,"Stretch to the available space",-1),P=a("ul",null,[a("li",null,[t("In a flex content, you can add the "),a("code",null,"grow"),t(" class.")]),a("li",null,[t("In a block context, you can add the "),a("code",null,"fill-width"),t(" class.")])],-1),W=a("br",null,null,-1),M=a("h3",null,"Custom width and height",-1),H=a("p",null,[t("Even though you can easily override the dimensions via CSS, a "),a("code",null,"width"),t(" and "),a("code",null,"height"),t(` props
are available on the `),a("span",{class:"code"},"w-button"),t(" component.")],-1),E=a("p",null,"Icon buttons are rounded by default.",-1),G=a("code",null,"icon-props",-1),N=b(`<p>If you are using Vue Router, all the links will automatically be <strong class="code">router-link</strong>s
...
link in a new tab.
</p>`,1),V=a("p",null,[t("We often need a tooltip on a button. Especially on the ones that only have an icons."),a("br"),t(`
That's why from version 2.45.0, the w-button component ships with an integrated w-tooltip,
if you need it.`)],-1);function R(l,i,p,f,y,d){const r=c("title-link"),n=c("w-button"),m=c("w-flex"),s=c("example"),u=c("w-icon");return w(),g("div",null,[e(r,{h2:""},{default:o(()=>[t("Default")]),_:1}),$,e(n,{class:"ma1"},{default:o(()=>[t("default")]),_:1}),e(r,{h2:""},{default:o(()=>[t("Colors")]),_:1}),D,e(s,null,{pug:o(()=>[t(`w-flex.wrap
...
`)]),default:o(()=>[e(n,{class:"ma1","bg-color":"success",color:"yellow-light2"},{default:o(()=>[t("success")]),_:1}),e(n,{class:"ma1","bg-color":"error",color:"amber-light2"},{default:o(()=>[t("error")]),_:1}),e(n,{class:"ma1","bg-color":"primary",color:"success-light2"},{default:o(()=>[t("warning")]),_:1})]),_:1}),B,e(s,null,{pug:o(()=>[t(`w-button.ma1(bg-color="primary-light3") normal
...
w-button.ma1(bg-color="primary" xl) extra large`)]),html:o(()=>[t(`<w-button class="ma1" bg-color="secondary" xs>extra small</w-button>
...
`)]),default:o(()=>[e(n,{class:"ma1","bg-color":"secondary",xs:""},{default:o(()=>[t("extra small")]),_:1}),e(n,{class:"ma1","bg-color":"secondary",sm:""},{default:o(()=>[t("small")]),_:1}),e(n,{class:"ma1","bg-color":"secondary",md:""},{default:o(()=>[t("medium")]),_:1}),e(n,{class:"ma1","bg-color":"secondary",lg:""},{default:o(()=>[t("large")]),_:1}),e(n,{class:"ma1","bg-color":"secondary",xl:""},{default:o(()=>[t("extra large")]),_:1}),z,A,e(n,{class:"ma1","bg-color":"primary",xs:""},{default:o(()=>[t("extra small")]),_:1}),e(n,{class:"ma1","bg-color":"primary",sm:""},{default:o(()=>[t("small")]),_:1}),e(n,{class:"ma1","bg-color":"primary",md:""},{default:o(()=>[t("medium")]),_:1}),e(n,{class:"ma1","bg-color":"primary",lg:""},{default:o(()=>[t("large")]),_:1}),e(n,{class:"ma1","bg-color":"primary",xl:""},{default:o(()=>[t("extra large")]),_:1})]),_:1}),I,P,e(s,null,{pug:o(()=>[t(`w-flex
...
`)]),default:o(()=>[e(n,{icon:"wi-spinner","icon-props":{spin:!0}},{default:o(()=>[t("default")]),_:1})]),_:1}),e(r,{h2:""},{default:o(()=>[t("Loading spinner & custom loader")]),_:1}),e(s,{"content-class":"w-flex"},{pug:o(()=>[t(`w-button.ma1(
...
`)]),default:o(()=>[e(n,{class:"ma1",loading:l.button1loading,onClick:i[0]||(i[0]=k=>d.buttonDoLoading(1))},{default:o(()=>[e(u,{class:"mr1"},{default:o(()=>[t("wi-check")]),_:1}),t("Save")]),_:1},8,["loading"]),e(n,{class:"ma1 px4",loading:l.button2loading,onClick:i[1]||(i[1]=k=>d.buttonDoLoading(2))},{loading:o(()=>[t("Loading...")]),default:o(()=>[e(u,{class:"mr1"},{default:o(()=>[t("wi-check")]),_:1}),t("Save")]),_:1},8,["loading"])]),_:1}),e(r,{h2:""},{default:o(()=>[t("Links")]),_:1}),N,e(s,{"content-class":"w-flex"},{pug:o(()=>[t(`w-button.ma1(route="/getting-started")
  | Getting started
...
`)]),default:o(()=>[e(n,{class:"ma1",route:"/getting-started"},{default:o(()=>[t("Getting started"),e(u,{class:"ml1"},{default:o(()=>[t("wi-chevron-right")]),_:1})]),_:1}),e(n,{class:"ma1",route:"https://github.com/antoniandre/wave-ui",target:"_blank"},{default:o(()=>[t("Github"),e(u,{class:"ml2",sm:""},{default:o(()=>[t("mdi mdi-open-in-new")]),_:1})]),_:1}),e(n,{class:"ma1",route:"https://github.com/antoniandre/wave-ui",target:"_blank",disabled:""},{default:o(()=>[t("Disabled button with link"),e(u,{class:"ml2",sm:""},{default:o(()=>[t("mdi mdi-open-in-new")]),_:1})]),_:1})]),_:1}),e(r,{h2:""},{default:o(()=>[t("Integrated tooltip")]),_:1}),V,e(s,{"content-class":"w-flex wrap"},{pug:o(()=>[t(`w-button.ma6(tooltip="Thank you!") Hover me please
w-button.ma6(
  tooltip="Woohoo!"
