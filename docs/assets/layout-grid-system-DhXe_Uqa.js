import{r,o as s,g as t,a as p,w as n,b as i,F as l,k as c,d as e,t as b,n as w,f as d,h as k,_ as f}from"./index-BeTS4uV_.js";const _=e("div",{class:"title3"},"The grid system (using flexbox) is 12-cell based by default.",-1),$=e("p",null,[i(`Its purpose is to divide the available width (in percentage)
...
`,1)]),default:n(()=>[p(y,{class:w(a.$store.state.darkMode?"grey-dark4--bg":"blue-light5--bg")},{default:n(()=>[e("div",ee,[i("Current breakpoint: "),e("code",null,b(a.$waveui.breakpoint.name),1)]),ie]),_:1},8,["class"])]),_:1}),ae,p(v,{class:"hue-on-dark"},{pug:n(()=>[i(`w-flex.text-center(wrap)
