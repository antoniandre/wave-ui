import{r as l,o as b,e as g,f as n,w as s,g as t,t as v,i as e,c as k,j as L,N as y}from"./vendor.e64646cc.js";import{_ as q,n as C}from"./index.f3654a4f.js";const I=t("ul",null,[t("li",{class:"title5"},[e("The "),t("span",{class:"code"},"w-form"),e(" component is used for validation.")]),t("li",null,[e("A "),t("span",{class:"code"},"w-form"),e(` is invisible and has no style by default. You can put it in a
...
})`),Y={class:"mt6 title4"},N=e("Wrap the field in a "),P=t("span",{class:"code"},"w-form",-1),W=e(" and add a submit button"),J=e(`<w-form>
...
</p>`,2),fe={class:"text-right mt6"},he=e("Validate"),ve=e(`<w-form
  action="test.php"
  method="post"
  target="_blank"
  allow-submit>
...
with <code>no-keyup-validation</code> and <code>no-blur-validation</code>.</p>`,1),xe={class:"text-right mt6"},Ve=e("Validate"),ke=e(`<w-form no-keyup-validation no-blur-validation>
  <w-input
    label="First name"
    :validators="[validators.required]">
  </w-input>
...
`),Se=e("Reset the form"),Ae=t("p",null,[e("Once the form is invalid, you can reset it with a basic HTML reset button, like in this example."),t("br"),e(`
Alternatively, you can programmatically reset the form and all its element by setting the form
value (or v-model) to `),t("code",null,"null"),e(", like pristine.")],-1),Fe={class:"text-right mt6"},je=e("Reset"),Ue=e("Validate"),Le=e(`<w-form v-model="valid">
  <w-input
    label="First name"
    :validators="[validators.required]">
  </w-input>
...
You can show an error message from this hook.</li></ul>`,2),De=e("The form status is always accurate (through the "),Oe=t("span",{class:"code"},"v-model",-1),Be=e("), and the "),Me=t("code",null,"error",-1),Ye=e(` &
`),Ne=t("code",null,"success",-1),Pe=e(" events return the "),We=t("span",{class:"code"},"errorsCount",-1),Je=e("."),He=t("br",null,null,-1),ze=e(`
...
a notification.`)],-1),lt={class:"message-box"},it=e("The form is valid, ready to send it!"),rt=e("I agree to the terms & conditions"),dt=t("div",{class:"spacer"},null,-1),ut=e("Reset"),ct=e("Validate"),mt=e("The form was sent successfully!"),ft=e(`data: () => ({
  form: {
    valid: null,
    submitted: false,
    sent: false,
...
}`),ht=e(`.message-box {min-height: 35px;}
...
`),Vt=e("Asynchronous validations"),kt=t("p",null,"You may want to validate a field on server side, for this you can use an asynchronous validator.",-1),Ct=e("You should first be familiar with Promises and "),St=t("span",{class:"code"},"async",-1),At=e("/"),Ft=t("span",{class:"code"},"await",-1),jt=e(`.
If you're not you can read about it
`),Ut=t("a",{href:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function",target:"_blank"},"here",-1),Lt=e("."),It=t("p",null,[e(`This example presents a common case: checking if a username is already in use from a user
...
Example with `),t("code",null,'progress-color="cyan"'),e(":")],-1);function Bt(u,a,T,x,o,p){const c=l("alert"),i=l("title-link"),_=l("ssh-pre"),S=l("w-divider"),r=l("w-input"),m=l("w-button"),f=l("w-form"),h=l("example"),w=l("w-alert"),A=l("w-transition-fade"),F=l("w-checkbox"),V=l("w-flex"),j=l("w-notification"),U=l("w-card");return b(),g("div",null,[n(c,{class:"mt6",tip:""},{default:s(()=>[I]),_:1}),n(i,{h2:""},{default:s(()=>[E]),_:1}),R,t("ol",null,[t("li",D,[O,n(_,{class:"body",language:"html-vue",label:"Vue template"},{default:s(()=>[B]),_:1}),n(_,{class:"body",language:"js",label:"Javascript"},{default:s(()=>[M]),_:1})]),t("li",Y,[N,P,W,n(_,{class:"body",language:"html-vue",label:"Vue template"},{default:s(()=>[J]),_:1})]),H]),n(c,{tip:""},{default:s(()=>[z,X]),_:1}),n(i,{class:"mt10",h3:""},{default:s(()=>[K]),_:1}),G,n(_,{language:"js",label:"Javascript"},{default:s(()=>[Q]),_:1}),n(S,{class:"mt12"}),n(i,{h2:""},{default:s(()=>[Z]),_:1}),$,n(h,null,{html:s(()=>[oe]),js:s(()=>[ae]),default:s(()=>[n(f,{modelValue:o.form1.valid,"onUpdate:modelValue":a[0]||(a[0]=d=>o.form1.valid=d)},{default:s(()=>[n(r,{label:"First name",validators:[o.validators.required,o.validators.alphabetical]},null,8,["validators"]),n(r,{class:"mt3",label:"Last name",validators:[o.validators.required]},null,8,["validators"]),t("div",ee,[te,t("code",ne,v(o.form1.valid===!1?"false":o.form1.valid||"null"),1),n(m,{type:"submit",disabled:o.form1.valid===!1},{default:s(()=>[se]),_:1},8,["disabled"])])]),_:1},8,["modelValue"])]),_:1}),n(c,{warning:""},{default:s(()=>[le,ie]),_:1}),n(c,{success:""},{default:s(()=>[re,de,ue]),_:1}),n(i,{h2:""},{default:s(()=>[ce]),_:1}),me,n(h,null,{html:s(()=>[ve]),js:s(()=>[pe]),default:s(()=>[n(f,{action:"test.php",method:"post",target:"_blank","allow-submit":""},{default:s(()=>[n(r,{label:"First name",validators:[o.validators.required]},null,8,["validators"]),n(r,{class:"mt3",label:"Last name",validators:[o.validators.required]},null,8,["validators"]),t("div",fe,[n(m,{type:"submit"},{default:s(()=>[he]),_:1})])]),_:1})]),_:1}),n(c,{tip:""},{default:s(()=>[_e,be,we,ge,ye]),_:1}),n(i,{h2:""},{default:s(()=>[qe]),_:1}),Te,n(h,null,{html:s(()=>[ke]),js:s(()=>[Ce]),default:s(()=>[n(f,{"no-keyup-validation":"","no-blur-validation":""},{default:s(()=>[n(r,{label:"First name",validators:[o.validators.required]},null,8,["validators"]),n(r,{class:"mt3",label:"Last name",validators:[o.validators.required]},null,8,["validators"]),t("div",xe,[n(m,{type:"submit"},{default:s(()=>[Ve]),_:1})])]),_:1})]),_:1}),n(i,{h2:""},{default:s(()=>[Se]),_:1}),Ae,n(h,null,{html:s(()=>[Le]),js:s(()=>[Ie]),default:s(()=>[n(f,{modelValue:o.form4.valid,"onUpdate:modelValue":a[1]||(a[1]=d=>o.form4.valid=d)},{default:s(()=>[n(r,{label:"First name",validators:[o.validators.required]},null,8,["validators"]),n(r,{class:"mt3",label:"Last name",validators:[o.validators.required]},null,8,["validators"]),t("div",Fe,[n(m,{class:"my1 mr2","bg-color":"warning",type:"reset"},{default:s(()=>[je]),_:1}),n(m,{class:"my1",type:"submit"},{default:s(()=>[Ue]),_:1})])]),_:1},8,["modelValue"])]),_:1}),n(i,{h2:""},{default:s(()=>[Ee]),_:1}),Re,n(c,{tip:""},{default:s(()=>[De,Oe,Be,Me,Ye,Ne,Pe,We,Je,He,ze,Xe,Ke,Ge,Qe,Ze,$e]),_:1}),n(h,null,{html:s(()=>[e(`<w-alert
  :success="success"
  :error="error"
  :info="!success && !error">
...
</w-card>`,1)]),js:s(()=>[ft]),css:s(()=>[ht]),default:s(()=>[n(U,{class:"white--bg","content-class":"pa0"},{default:s(()=>[t("div",lt,[n(A,null,{default:s(()=>[o.form6.submitted?(b(),k(w,{key:0,class:"my0 text-light",success:"","no-border":""},{default:s(()=>[it]),_:1})):o.form6.valid===!1?(b(),k(w,{key:1,class:"my0 text-light",error:"","no-border":""},{default:s(()=>[e("The form has "+v(o.form6.errorsCount)+" errors.",1)]),_:1})):L("",!0)]),_:1})]),n(f,{class:"px8 pt2 pb12",modelValue:o.form6.valid,"onUpdate:modelValue":a[6]||(a[6]=d=>o.form6.valid=d),"errors-count":o.form6.errorsCount,"onUpdate:errors-count":a[7]||(a[7]=d=>o.form6.errorsCount=d),onValidate:p.onValidate,onSuccess:p.onSuccess},{default:s(()=>[n(r,{required:"",label:"First name",validators:[o.validators.required]},null,8,["validators"]),n(r,{class:"mt3",required:"",label:"Last name",validators:[o.validators.required]},null,8,["validators"]),n(r,{class:"mt3",disabled:"",label:"User name"}),n(V,{class:"mt4",wrap:"","align-center":"","justify-end":""},{default:s(()=>[n(F,{required:"",validators:[o.validators.consent]},{default:s(()=>[rt]),_:1},8,["validators"]),dt,n(m,{class:"my1 mr2","bg-color":"warning",type:"reset",onClick:a[5]||(a[5]=d=>o.form6.submitted=o.form6.sent=!1)},{default:s(()=>[ut]),_:1}),n(m,{class:"my1",type:"submit",disabled:o.form6.valid===!1,loading:o.form6.submitted&&!o.form6.sent},{default:s(()=>[ct]),_:1},8,["disabled","loading"])]),_:1})]),_:1},8,["modelValue","errors-count","onValidate","onSuccess"]),n(j,{modelValue:o.form6.sent,"onUpdate:modelValue":a[8]||(a[8]=d=>o.form6.sent=d),success:"",transition:"bounce",absolute:"",plain:"",round:"",bottom:""},{default:s(()=>[mt]),_:1},8,["modelValue"])]),_:1})]),_:1}),n(i,{h2:""},{default:s(()=>[vt]),_:1}),pt,n(c,{warning:""},{default:s(()=>[_t,bt]),_:1}),n(h,null,{html:s(()=>[Tt]),js:s(()=>[xt]),default:s(()=>[n(m,{outline:!o.form7.disabled,onClick:a[9]||(a[9]=d=>{o.form7.readonly=!1,o.form7.disabled=!o.form7.disabled})},{default:s(()=>[wt]),_:1},8,["outline"]),n(m,{class:"ml2",outline:!o.form7.readonly,onClick:a[10]||(a[10]=d=>{o.form7.disabled=!1,o.form7.readonly=!o.form7.readonly})},{default:s(()=>[gt]),_:1},8,["outline"]),n(f,{class:"mt4",modelValue:o.form7.valid,"onUpdate:modelValue":a[11]||(a[11]=d=>o.form7.valid=d),disabled:o.form7.disabled,readonly:o.form7.readonly},{default:s(()=>[n(r,{label:"First name",validators:[o.validators.required,o.validators.alphabetical]},null,8,["validators"]),n(r,{class:"mt3",label:"Last name",validators:[o.validators.required]},null,8,["validators"]),n(V,{class:"mt4","justify-end":""},{default:s(()=>[n(m,{type:"reset","bg-color":"warning"},{default:s(()=>[yt]),_:1}),n(m,{class:"ml2",type:"submit",disabled:o.form7.valid===!1},{default:s(()=>[qt]),_:1},8,["disabled"])]),_:1})]),_:1},8,["modelValue","disabled","readonly"])]),_:1}),n(i,{h2:""},{default:s(()=>[Vt]),_:1}),kt,n(c,{tip:""},{default:s(()=>[Ct,St,At,Ft,jt,Ut,Lt]),_:1}),It,n(h,{"content-class":"pa6"},{html:s(()=>[Et]),js:s(()=>[Rt]),default:s(()=>[n(f,{"error-placeholders":""},{default:s(()=>[n(r,{label:"Username",validators:[o.validators.required,o.validators.username],"inner-icon-right":o.form1.loading?"mdi mdi-autorenew w-icon--spin":"",loading:o.form1.loading,autocomplete:"off"},null,8,["validators","inner-icon-right","loading"])]),_:1})]),_:1}),n(i,{h3:""},{default:s(()=>[Dt]),_:1}),Ot,n(r,{class:"mt5",label:"Username",loading:!0,"progress-color":"cyan",autocomplete:"off"})])}const Mt={data(){return{form1:{valid:null,loading:!1},form2:{valid:null},form3:{valid:null},form4:{valid:null},form5:{valid:null,error:null,success:null,validated:0},form6:{valid:null,submitted:!1,sent:!1,errorsCount:0},form7:{valid:null,disabled:!1,readonly:!1},validators:{username:async u=>(this.form1.loading=!0,await new Promise(a=>setTimeout(a,800)),this.form1.loading=!1,u!=="waveui"||"This username is already in use"),required:u=>!!u||"This field is required",alphabetical:u=>/^[a-z \-']+$/i.test(u)||"This field only accepts letters.",consent:u=>!!u||"You must agree"}}},methods:{onSuccess(){setTimeout(()=>this.form6.sent=!0,2e3)},onValidate(){this.form6.sent=!1,this.form6.submitted=this.form6.errorsCount===0}}};var Yt=q(Mt,[["render",Bt]]);const Nt=t("div",{class:"w-divider my12"},null,-1),Pt=e("API");function Wt(u,a,T,x,o,p){const c=l("title-link"),i=l("component-api");return b(),g("div",null,[Nt,n(c,{class:"title1",h2:""},{default:s(()=>[Pt]),_:1}),n(i,{class:"mt0",items:p.props,descriptions:u.propsDescs,title:"Props"},null,8,["items","descriptions"]),n(i,{items:u.slots,title:"Slots"},null,8,["items"]),n(i,{items:p.events,title:"Events"},null,8,["items"])])}const Jt={modelValue:'<strong class="error"><code>value</code> in Vue 2.</strong><br>Contains the status of the form validity at all times. Three values are possible: <code>null</code> when pristine (untouched), <code>false</code> when invalid, <code>true</code> when valid.<br>This value gets updated every time a validation is triggered on a single field or on all the fields at once on form submit.<br>Setting this value to <code>null</code> will reset the form.',allowSubmit:"Native HTML submits the form to the server when all the form elements are valid.<br>Usually and by default, the form submission is prevented and an AJAX call is made from the front end. This is completely up to the developer.",noKeyupValidation:"Prevents the form element validation on keyup (happening by default).",noBlurValidation:"Prevents the form element validation on blur (happening by default).",errorPlaceholders:"Reserves a space under all the form elements so that triggering an error and showing the error message will not change the height of the form.",disabled:"Disables all the form fields all at once, making them unreactive to user interactions.",readonly:"Set all the form fields to readonly all at once. The fields will still look interactive but their value will not be editable by user interaction."},Ht={default:{description:"The form content."}},zt={submit:{description:"Emitted on form submit.",params:{"[DOM event object]":"The associated reset DOM event."}},"before-validate":{description:"Emitted before validation, every time a validation is triggered."},validate:{description:"Emitted on form validate, every time a validation is triggered.<br>Returns a single object containing:",params:{e:"The associated DOM event.",errorsCount:"An integer representing the number of errors in the form."}},success:{description:"Emitted on form success, when there is no error in the form and the validation is successful.<br>Returns a single object containing:",params:{e:"The associated DOM event.",errorsCount:"An integer representing the number of errors in the form."}},error:{description:"Emitted on form error, when there is at least one error in the form and the validation fails.<br>Returns a single object containing:",params:{e:"The associated DOM event.",errorsCount:"An integer representing the number of errors in the form."}},reset:{description:"Emitted on form reset. A reset can be triggered by setting the v-model value to null or by clicking on a reset button.",params:{"[DOM event object]":"The associated reset DOM event."}},input:{description:"Emitted every time the form status changes.<br>Updates the v-model value in Vue 2.x only.",params:{"[Boolean, Null]":"The new status of the form: one of <code>null</code> when pristine, <code>false</code> when invalid, <code>true</code> when valid."}},"update:modelValue":{description:"Emitted every time the form status changes.<br>Updates the v-model value in Vue 3 only.",params:{"[Boolean, Null]":"The new status of the form: one of <code>null</code> when pristine, <code>false</code> when invalid, <code>true</code> when valid."}},"update:errorsCount":{description:"Emitted every time the errorsCount changes. To be used with <code>:errors-count.sync</code> in Vue 2 or <code>v-model:errors-count</code> in Vue 3.",params:{"[Integer]":"The number of errors in the form."}}},Xt={data:()=>({propsDescs:Jt,slots:Ht}),computed:{props(){return C.props},events(){return C.emits.reduce((u,a)=>(u[a]=zt[a]||{})&&u,{})}}};var Kt=q(Xt,[["render",Wt]]);const Gt=e("w-form");function Qt(u,a,T,x,o,p){const c=l("ui-component-title"),i=l("examples"),_=l("api");return b(),g("main",null,[n(c,null,{default:s(()=>[Gt]),_:1}),n(i),n(_)])}const Zt={components:{Examples:Yt,Api:Kt}};var tn=q(Zt,[["render",Qt]]);export{tn as default};
