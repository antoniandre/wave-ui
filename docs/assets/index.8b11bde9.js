import{r as i,o as k,f as v,a as o,w as s,b as t,h,e,_ as f,by as V,bz as C,bA as T}from"./index.6bc90973.js";const D=t("p",{class:"mb3"},"What it looks like:",-1),E=t("div",{class:"title4 mt4"},"States",-1),P={class:"w-flex wrap"},j=t("p",{class:"mt12"},[e("There are 2 components: "),t("span",{class:"code"},"w-checkbox"),e(" & "),t("span",{class:"code"},"w-checkboxes"),e(`.
...
`)],-1),S=e("<w-checkbox>"),M=t("div",{class:"w-divider"},null,-1),q=t("div",{class:"title4 mb2"},"Basic use",-1),B=e("Single option"),L=t("div",{class:"title4 mt8 mb2"},"Using v-model on a single checkbox",-1),W=e("Single option"),H={class:"ml6"},N=e("v-model:"),z={class:"ml1"},K=t("div",{class:"title4 mt8 mb2"},"Using an array of v-model for multiple checkboxes",-1),R=e("Option 1"),F=e("Option 2"),Y=e("Option 3"),G={class:"ml6"},J=e("v-model:"),Q={class:"ml1"},X=e(`<div class="title4 mb2">Basic use</div>
...
But because in most cases you won't need that, the `),Ae=t("span",{class:"code"},"w-checkboxes",-1),Ue=e(` component will make you
go much faster.
`),Oe=e("<w-checkboxes>"),$e=t("div",{class:"w-divider"},null,-1),De=t("p",{class:"my5"},[e("The "),t("span",{class:"code"},"w-checkboxes"),e(` component allows a fast and easy rendering of
...
`),He=t("p",null,"The v-model can also be preset, or updated externally.",-1),Ne={class:"w-flex align-center"},ze=e("Toggle checkbox 2"),Ke={class:"title3 ml8"},Re=e("v-model:"),Fe={class:"ml1"},Ye=e(`<div class="w-flex align-center">
  <div>
    <w-checkboxes v-model="selection" :items="checkboxes"></w-checkboxes>
