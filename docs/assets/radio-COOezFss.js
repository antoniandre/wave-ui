...
`,-1)]]),default:t(()=>[r(`div`,h,[a(b,{modelValue:l.selection1,"onUpdate:modelValue":u[7]||=e=>l.selection1=e,items:l.radios1},null,8,[`modelValue`,`items`]),r(`div`,g,[u[44]||=o(`v-model: `,-1),r(`code`,null,n(l.selection1||`null`),1)])])]),_:1}),a(C,{h2:``},{default:t(()=>[...u[47]||=[o(`Inline layout`,-1)]]),_:1}),a(T,{"content-class":`mt3`},{html:t(()=>[...u[48]||=[o(`<w-radios :items="radioItems" inline></w-radios>`,-1)]]),js:t(()=>[...u[49]||=[o(`data: () => ({
  radioItems: [
    { label: 'Choice 1' },
    { label: 'Choice 2' },
    { label: 'Choice 3' }
...
`,-1)]]),default:t(()=>[a(b,{modelValue:l.selection5,"onUpdate:modelValue":u[8]||=e=>l.selection5=e,items:l.radios3,color:`green`},{item:t(({item:e})=>[r(`span`,_,n(e.label),1),a(E,{class:`success`},{default:t(()=>[o(n(e.icon),1)]),_:2},1024)]),_:1},8,[`modelValue`,`items`])]),_:1}),u[84]||=r(`div`,{class:`w-divider grey-light5 my12`},null,-1),a(C,{h2:``},{default:t(()=>[...u[53]||=[o(`Color`,-1)]]),_:1}),u[85]||=r(`p`,null,[o(`By default the `),r(`span`,{class:`code`},`w-radio`),o(` & `),r(`span`,{class:`code`},`w-radios`),o(` components will use the
