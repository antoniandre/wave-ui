...
If it doesn't, you probably have a style that applies a background with a higher priority.`)],-1),q={class:"mt6"},L=t("br",null,null,-1),O=t("code",null,"rgba(var(--w-base-bg-color-rgb), 0.3)",-1),R=t("br",null,null,-1),z={class:"mt6"},E={class:"w-flex align-center"},G={class:"mt6"},F={class:"w-flex align-center"},H=k(`<li class="mt6">Locate the ugly elements using the dev tools and replace their color/background-color with
...
<a href="/colors#colors-and-themes">Colors and themes section of the colors page</a>.</p></li>`,1),J={class:"mt6"};function K(n,d,X,Z,x,ee){const r=l("title-link"),s=l("ssh-pre"),h=l("w-icon"),w=l("w-flex"),c=l("example"),u=l("w-button"),f=l("alert");return _(),p("main",null,[o(r,{class:"mt4",h1:""},{default:a(()=>[e("Themes")]),_:1}),y,o(r,{h2:""},{default:a(()=>[e("Setting an initial theme")]),_:1}),$,o(s,{language:"js",dark:n.$store.state.darkMode},{default:a(()=>[e(`app.use(WaveUI, {
...
variables.`)]),_:1}),o(r,{h3:""},{default:a(()=>[e("Triggering an action on theme change")]),_:1}),D,N,o(s,{language:"js",dark:n.$store.state.darkMode},{default:a(()=>[e(`watch: {
  '$waveui.preferredTheme' (theme) {
    // Trigger an action.
  }
}
`)]),_:1},8,["dark"]),o(r,{h2:"",slug:"adding-themes-in-your-wave-ui-app"},{default:a(()=>[e("Adding themes in your Wave UI app that never had themes")]),_:1}),Y,t("ol",null,[P,V,t("li",q,[e("Optionally, you can override these Wave UI defaults if you don't like them."),L,e(`
...
(e.g. `),O,e(")! \u{1F609}"),R,o(s,{language:"css",dark:n.$store.state.darkMode},{default:a(()=>[e(`:root[data-theme=light] {
