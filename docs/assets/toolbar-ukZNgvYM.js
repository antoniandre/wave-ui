import{H as e,N as t,c as n,d as r,g as i,h as a,k as o}from"./runtime-core.esm-bundler-DPe36P4s.js";import{t as s}from"./_plugin-vue_export-helper-S3RvzygF.js";import{r as c}from"./index-CmUoOmTq.js";function l(s,c){let l=t(`title-link`),u=t(`w-toolbar`),d=t(`w-icon`),f=t(`w-button`),p=t(`example`),m=t(`w-card`),h=t(`w-flex`),g=t(`w-divider`);return o(),r(`div`,null,[i(l,{h2:``},{default:e(()=>[...c[0]||=[a(`Simple toolbar with shadow`,-1)]]),_:1}),i(p,{"content-class":`pa4`},{pug:e(()=>[...c[5]||=[a(`w-toolbar(shadow)
  .title2 Title
  .spacer
  span.ml2 Item 1
  span.ml2 Item 2
