import{n as r,m as a}from"./index.e31dd236.js";var c=function(){var e=this,o=e.$createElement,t=e._self._c||o;return t("div",[t("title-link",{attrs:{h2:""}},[e._v("Basic")]),t("example",{attrs:{"content-class":"w-flex align-center wrap"},scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-button(@click="openDrawer = true" outline) Open drawer
...
`)]},proxy:!0}])},[t("w-button",{staticClass:"ma1",attrs:{outline:""},on:{click:function(n){e.openLeftDrawer=!e.openLeftDrawer}}},[e._v("Open left drawer")]),t("w-button",{staticClass:"ma1",attrs:{outline:""},on:{click:function(n){e.openRightDrawer=!e.openRightDrawer}}},[e._v("Open right drawer")]),t("w-button",{staticClass:"ma1",attrs:{outline:""},on:{click:function(n){e.noOverlay=!1,e.openTopDrawer=!e.openTopDrawer}}},[e._v("Open top drawer")]),t("w-button",{staticClass:"ma1",attrs:{outline:""},on:{click:function(n){e.openBottomDrawer=!e.openBottomDrawer}}},[e._v("Open bottom drawer")])],1),t("title-link",{attrs:{h3:""}},[e._v("Absolute position")]),e._m(0),t("example",{attrs:{"content-class":"relative justify-center d-flex"},scopedSlots:e._u([{key:"pug",fn:function(){return[e._v('w-card.ma6.grow.text-center(bg-color="'+e._s(e.$store.state.darkMode?"grey-dark6":"amber-light5")+`" title="w-card")
  ...
  bg-color="`+e._s(e.$store.state.darkMode?"grey-dark6":"amber-light5")+`"
  title="w-card">
...
w-drawer(
  ...
  w-flex.pa3(align-center wrap)
    ...
    w-button(@click="showCookieNotice = false")
      | I agree
      w-icon.ml2 mdi mdi-arrow-right`)]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-button
  ...
  <div class="w-flex pa3 align-center wrap">
    <div class="w-flex align-center">
      <w-icon class="mr2 primary" xl>
        ...
        <span class="`+e._s(e.$store.state.darkMode?"grey-light4":"grey-dark3")+`">
        Our website uses cookies to give you the best user experience.
        To continue browsing this site you must agree.
      </span>
    </div>
...
`)]},proxy:!0}])},[t("w-button",{attrs:{outline:""},on:{click:function(n){e.showCookieNotice=!0}}},[e._v("Show the cookie notice")]),t("w-drawer",{attrs:{"content-class":"cookie-notice","overlay-color":"transparent",persistent:"","fit-content":"",bottom:""},model:{value:e.showCookieNotice,callback:function(n){e.showCookieNotice=n},expression:"showCookieNotice"}},[t("div",{staticClass:"w-flex pa3 align-center wrap"},[t("div",{staticClass:"w-flex align-center py1"},[t("w-icon",{staticClass:"primary mr2",attrs:{xl:""}},[e._v("mdi mdi-cookie")]),t("span",{staticClass:"grey-dark3"},[e._v(`Our website uses cookies to give you the best user experience.
To continue browsing this site you must agree.`)])],1),t("div",{staticClass:"spacer"}),t("w-button",{on:{click:function(n){e.showCookieNotice=!1}}},[e._v("I agree"),t("w-icon",{staticClass:"ml2"},[e._v("mdi mdi-arrow-right")])],1)],1)])],1),t("p",[e._v(`You can then store the result of the acceptation in the localStorage when the user clicks
the button.`)]),t("ssh-pre",{directives:[{name:"show",rawName:"v-show",value:!e.$store.state.usePug,expression:"!$store.state.usePug"}],attrs:{dark:e.$store.state.darkMode,language:"html-vue",label:"Template"}},[e._v(`<w-button
  class="ml-auto"
  @click="acceptCookies"
  sm
  absolute>
...
`)]),t("ssh-pre",{directives:[{name:"show",rawName:"v-show",value:e.$store.state.usePug,expression:"$store.state.usePug"}],attrs:{dark:e.$store.state.darkMode,language:"pug",label:"Template"}},[e._v(`w-button.ml-auto(@click="acceptCookies" sm absolute)
  w-icon.mr2 wi-check
  | I agree
`)]),t("ssh-pre",{attrs:{language:"js",label:"Javascript",dark:e.$store.state.darkMode}},[e._v(`acceptCookies () {
