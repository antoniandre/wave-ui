import{N as e,W as t,bt as n,c as r,d as i,g as a,h as o,k as s,m as c}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as l}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{B as u,l as d}from"./index-C4VjH_oM.js";var f={class:`title3 mb0`},p={class:`ml2`};function m(l,u,d,m,h,g){let _=e(`title-link`),v=e(`w-switch`),y=e(`example`),b=e(`ssh-pre`),x=e(`alert`),S=e(`w-icon`);return s(),i(`div`,null,[a(_,{h2:``,slug:`on-off-and-disabled`},{default:t(()=>[...u[5]||=[o(`On, off & disabled`,-1)]]),_:1}),a(y,{"content-class":`pt4`},{pug:t(()=>[...u[6]||=[]]),html:t(()=>[...u[7]||=[o(`<w-switch
  class="ma2"
  :model-value="true"
  label="On">
</w-switch>
...
span.title3.mb0
  | v-model value:
  code.ml2 `+n(l.value),1)]),html:t(()=>[...u[10]||=[o(`<w-switch class="mr6" v-model="value"></w-switch>
...
`,-1)]]),default:t(()=>[a(v,{class:`mr6`,modelValue:l.value,"onUpdate:modelValue":u[0]||=e=>l.value=e},null,8,[`modelValue`]),r(`span`,f,[u[9]||=o(`v-model value:`,-1),r(`code`,p,n(l.value),1)])]),_:1}),a(_,{h2:``},{default:t(()=>[...u[12]||=[o(`Colors`,-1)]]),_:1}),a(y,{"content-class":`pt4`},{pug:t(()=>[...u[13]||=[o(`w-switch.ma2(:model-value="true" color="pink")
...
w-switch.w-switch--wide.ma4(v-model="value")
  template(#track)
    strong `+n(`{{ value ? 'on' : 'off' }}`),-1)]]),html:t(()=>[...u[24]||=[o(`<w-switch v-model="value" class="ma4">
  <template #track>
...
w-switch.ma4(v-model="value" label="Dark theme")
  template(#thumb)
    w-icon `+n(`{{ value ? 'mdi mdi-weather-night' : 'mdi mdi-white-balance-sunny' }}`),-1)]]),html:t(()=>[...u[29]||=[o(`<w-switch v-model="value" class="ma4">
  <template #thumb>
    <small>`+n(`{{ value ? 'on' : 'off' }}`)+`</small>
  </template>
</w-switch>
...
`,-1)]]),default:t(()=>[a(v,{class:`ma4`,modelValue:l.value3,"onUpdate:modelValue":u[3]||=e=>l.value3=e},{thumb:t(()=>[r(`small`,null,n(l.value3?`on`:`off`),1)]),_:1},8,[`modelValue`]),a(v,{class:`ma4`,modelValue:l.value3,"onUpdate:modelValue":u[4]||=e=>l.value3=e,label:`Dark theme`},{thumb:t(()=>[a(S,null,{default:t(()=>[o(n(l.value3?`mdi mdi-weather-night`:`mdi mdi-white-balance-sunny`),1)]),_:1})]),_:1},8,[`modelValue`])]),_:1}),a(_,{h2:``},{default:t(()=>[...u[31]||=[o(`Loading`,-1)]]),_:1}),u[39]||=r(`p`,null,`If a number is given it will be the value of the progress. If true is given, the progress will
...
`,-1)]]),default:t(()=>[a(v,{class:`ma2`,"model-value":!0,loading:43}),a(v,{class:`ma2`,"model-value":!0,loading:``})]),_:1}),a(_,{h2:``},{default:t(()=>[...u[34]||=[o(`Sizes`,-1)]]),_:1}),u[40]||=c(`<p>The switch size can be controlled with the preset size props <code>xs</code>, <code>sm</code>, <code>md</code>,
