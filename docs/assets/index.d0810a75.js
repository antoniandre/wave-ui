import{r as l,o as b,f as g,a as n,w as s,b as t,h as v,e,c as V,d as I,i as y,_ as q,bG as A}from"./index.4ab4194a.js";const j=t("ul",null,[t("li",{class:"title5"},[e("The "),t("span",{class:"code"},"w-form"),e(" component is used for validation.")]),t("li",null,[e("A "),t("span",{class:"code"},"w-form"),e(` is invisible and has no style by default. You can put it in a
...
re-run.
`)],-1),G=e("Creating a validator function"),K=t("p",null,[e(`A validator is a custom function that tells Wave UI if the field is valid or invalid when the
...
submission attempts (if you need it) since a `),Xe=t("span",{class:"code"},"keyup",-1),Ge=e(" or "),Ke=t("span",{class:"code"},"blur",-1),Qe=e(` event may trigger
