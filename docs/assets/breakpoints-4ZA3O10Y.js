import{r as i,g,o as b,a as l,b as n,h as u,w as s,e as t,n as y,t as f,_ as c}from"./index-Tdht9LZF.js";const k={class:"title2 mt0"};function w(a,e){const o=i("title-link"),m=i("router-link"),x=i("w-card"),r=i("example"),d=i("ssh-pre"),p=i("alert");return b(),g("main",null,[l(o,{class:"mt4",h1:""},{default:s(()=>e[0]||(e[0]=[t("Breakpoints")])),_:1}),l(o,{h2:""},{default:s(()=>e[1]||(e[1]=[t("What is this for?")])),_:1}),e[37]||(e[37]=n("p",null,[t("If you are not familiar with breakpoints, you should first read about it."),n("br"),t(`
