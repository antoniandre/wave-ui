...
background.`)],-1),B=i("br",null,null,-1),K=e(`w-list(:items="items" color="pink" hover)
br
...
`),Pe=e("Checklist colors"),ze=i("p",null,"A checklist can have all the color options that the normal list can have, even a different color per item.",-1),Le=e('w-list(v-model="selection5" :items="items" checklist)'),Me=e(`<w-list
  v-model="selection"
  :items="items"
  checklist>
</w-list>`),Oe=e(`data: () => ({
...
If you are using Vue Router, all the links will automatically be `),i("strong",{class:"code"},"router-link"),e("s."),i("br")],-1),Ke=i("p",null,[e("It is possible to disable a link with a "),i("code",null,"disabled: true"),e(" attribute in the item.")],-1),Ye=i("div",{class:"spacer"},null,-1),qe=e(`data: () => ({
  items: [
