import{a as S}from"./axios.b29be18e.js";import{r,o as g,g as y,a as t,w as n,b as e,e as l,d as c,h as v,_,P as F,C as L}from"./index.bd0064a0.js";const R=l("p",null,[e("By default the "),l("span",{class:"code"},"w-input"),e(` component has a label inside the input field, that moves up
...
You can also show a self-updated progress bar with the `),l("code",null,"show-progress"),e(" prop.")],-1),we={class:"my4"},ge={class:"ml2"},ye=l("p",null,[e("Resetting the "),l("code",null,'input type="file"'),e(" is as easy as setting its value to null (native HTML way).")],-1),ve=l("p",null,[e('The default type is "'),l("span",{class:"code"},"text"),e('" but the types below are also supported.')],-1),_e=l("p",null,[e("On desktop you will not notice the difference between the fields "),l("span",{class:"code"},"email"),e(", "),l("span",{class:"code"},"tel"),e(`,
`),l("span",{class:"code"},"url"),e(`, and the default text type. But on touch devices, the keyboard is adapted to the
type of input.`)],-1),xe=l("h3",null,"Textual inputs",-1),Pe={class:"input-types"},ke=l("div",{class:"code mb1"},'type="date"',-1),Se={class:"mt4"},Fe=l("div",{class:"code mb1"},'type="email"',-1),Ie={class:"mt4"},Te=l("div",{class:"code mb1"},'type="number"',-1),Le={class:"mt4"},Re=l("div",{class:"code mb1"},'type="password"',-1),Oe={class:"mt4"},$e=l("div",{class:"code mb1"},'type="search"',-1),Ae={class:"mt4"},je=l("div",{class:"code mb1"},'type="tel"',-1),De={class:"mt4"},Ue=l("div",{class:"code mb1"},'type="text"',-1),Me={class:"mt4"},Ve=l("div",{class:"code mb1"},'type="time"',-1),qe={class:"mt4"},Ee=l("div",{class:"code mb1"},'type="url"',-1),He={class:"mt4"},Ce=l("span",{class:"code mb1 mr2"},'type="hidden"',-1),Be=l("span",{class:"code"},"w-input",-1),Ne=l("h3",null,"Other types of inputs",-1),We=l("p",null,"For all the other types of input listed below, a specific Wave UI component should be used instead:",-1),Ye={class:"other-input-types"},ze=v('<li class="mt1"><span class="code mr2">type=&quot;button&quot;</span><span class="grey">use <code>w-button</code> instead</span></li><li class="mt1"><span class="code mr2">type=&quot;checkbox&quot;</span><span class="grey">use <code>w-checkbox</code> instead</span></li>',2),Je={class:"mt1"},Ge=l("span",{class:"code mr2"},'type="color"',-1),Xe=l("span",{class:"grey"},[e("use "),l("code",null,"w-color-picker"),e(" instead")],-1),Ke=v('<li class="mt1"><span class="code mr2">type=&quot;image&quot;</span><span class="grey">use the <code>img</code> HTML tag instead</span></li><li class="mt1"><span class="code mr2">type=&quot;radio&quot;</span><span class="grey">use <code>w-radio</code> instead</span></li><li class="mt1"><span class="code mr2">type=&quot;range&quot;</span><span class="grey">use <code>w-slider</code> instead</span></li><li class="mt1"><span class="code mr2">type=&quot;reset&quot;</span><span class="grey">use <code>w-button</code> instead</span></li><li class="mt1"><span class="code mr2">type=&quot;submit&quot;</span><span class="grey">use <code>w-button</code> instead</span></li>',5),Qe={class:"mt1"},Ze=l("span",{class:"code mr2"},'type="time"',-1),en=l("span",{class:"grey"},[e("use "),l("code",null,"w-time-picker"),e(" instead")],-1);function nn(o,d,m,h,x,u){const s=r("title-link"),i=r("w-input"),a=r("example"),f=r("w-flex"),w=r("alert"),b=r("w-icon"),I=r("w-button"),T=r("w-form"),P=r("ssh-pre"),k=r("w-tag");return g(),y("div",null,[t(s,{h2:""},{default:n(()=>[e("Default")]),_:1}),R,t(a,null,{pug:n(()=>[e("w-input Label")]),html:n(()=>[e(`<w-input>Label</w-input>
...
`)]),default:n(()=>[t(i,{type:"file",label:"File",accept:".jpg, .jpeg, .png, .gif, .svg",multiple:""})]),_:1}),t(s,{h3:""},{default:n(()=>[e("Clearing the field")]),_:1}),ye,t(s,{h2:""},{default:n(()=>[e("Types")]),_:1}),ve,_e,xe,t(a,null,{pug:n(()=>[e(`<ul.input-types>
  <li>
    <.code.mb1 type="date"<
