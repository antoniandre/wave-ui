import{r,o as m,f as p,a,w as t,e,h as s,b as i,c as S,d as j,M as v}from"./vendor.c30f2c6c.js";import{_ as u,q as y}from"./index.76d51146.js";const E=e("Why using w-image and not a simple <img>"),x=v(`<div class="title3">A simple &lt;img&gt;</div><p>will display when loaded, and will take the dimensions of the actual image.<br>
...
`),M=e("Using the <img> tag"),Y=v(`<p>You can choose which tag the <strong class="code">w-image</strong> should use.<br>
...
</p>`,1),F=e('w-image(:src="`${baseUrl}images/japanese-wave.png`" width="100%" tag="img" style="max-width: 700px")'),q=e(`<w-image
  :src="\`\${baseUrl}images/japanese-wave.png\`"
  width="100%"
  tag="img"
