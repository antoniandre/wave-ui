...
but you can override that with the <code>item-icon-color-key</code> prop.</p>`,2),$={class:"w-flex wrap align-center"},B=t("div",{class:"title3"},"Normal",-1),A=t("div",{class:"title3"},"unexpandable-empty",-1),N=t("p",null,[n("When the tree is "),t("code",null,"selectable"),n(", you can use the "),t("code",null,"v-model"),n(" to get the selected item.")],-1),D=t("p",null,"Click on a tree item to select it.",-1),V={class:"w-flex mt6"},M=t("strong",{class:"mr3"},"Selection:",-1),R=w('<p>Multiple events are fired from the <strong class="code">w-tree</strong> component:</p><ul class="lh0"><li><code>before-open</code>: fired as soon as the user clicks a tree item that is expandable and before the subitems are revealed.</li><li class="mt1"><code>open</code>: fired after a user clicks a tree item that is expandable, and after the expand animation.</li><li class="mt1"><code>before-close</code>: fired as soon as the user clicks a tree item to close its subtree.</li><li class="mt1"><code>close</code>: fired after a user clicks a tree item to close its subtree, and after the collapse animation.</li><li class="mt1"><code>click</code>: fired when the user clicks any tree item.</li><li class="mt1"><code>select</code>: fired when the user selects any selectable tree item. The <code>selectable</code> option must be set to true.</li><li class="mt1"><code>update:model-value</code>: (or <code>input</code> in Vue 2.x) fired when the user selects any selectable tree item. The <code>selectable</code> option must be set to true.</li></ul>',2),T=["innerHTML"],P=t("strong",{class:"black"},"Note on reactivity",-1),z={class:"black mt2"},K=t("code",null,"deep-reactivity",-1),O=t("br",null,null,-1),H={href:"https://vuejs.org/guide/essentials/watchers.html#deep-watchers",target:"_blank"},W=t("p",null,[n("If you need to customize the layout of the item label and/or icon, you can use the "),t("code",null,"#item"),n(" slot.")],-1);function q(a,o,h,y,k,m){const r=d("title-link"),s=d("w-tree"),i=d("example"),u=d("w-icon"),j=d("w-card"),x=d("w-flex"),C=d("alert");return b(),g("div",null,[l(r,{h2:""},{default:e(()=>[n("Default")]),_:1}),l(i,null,{pug:e(()=>[n('w-tree(:data="tree")')]),html:e(()=>[n('<w-tree :data="tree"></w-tree>')]),js:e(()=>[n(`data: () => ({
  tree: [
    {
      label: 'src',
      children: [
...
like the label, you will need to add the `),K,n(" option."),O,t("a",H,[n("Read on deep watchers on the Vue.js official documentation"),l(u,{class:"ml1"},{default:e(()=>[n("mdi mdi-open-in-new")]),_:1})])])]),_:1}),l(r,{h2:""},{default:e(()=>[n("Custom item (icon + label)")]),_:1}),W,l(i,null,{pug:e(()=>[n(`w-tree.lh5(:data="tree")
