...
notification from the template using this code for instance:`)],-1),Y=n("p",{class:"mt4"},`Indeed, if you write the above expression directly in a component's template without condition
...
`)]),default:i(()=>[e(d,{onClick:f.notify,"bg-color":"info"},{default:i(()=>[t("Notify custom")]),_:1},8,["onClick"])]),_:1}),e(w,{class:"mt12",warning:""},{default:i(()=>[F,n("p",null,[n("code",null,s("{{ $waveui.notify('test') }}"),1)]),Y]),_:1}),e(c,{h2:""},{default:i(()=>[t("Notification manager tweaking")]),_:1}),R,e(m,{language:"js",dark:o.$store.state.darkMode},{default:i(()=>[t(`new WaveUI({
  notificationManager: {
    align: 'right', // Or 'left'.
