import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,vt as s,xt as c}from"./runtime-core.esm-bundler-CLfruy3s.js";import{t as l}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{b as u}from"./index-I7dyuwKt.js";var d={class:`code inherit`},f={class:`code inherit`};function p(l,u,p,m,h,g){let _=n(`title-link`),v=n(`w-button`),y=n(`w-divider`),b=n(`w-switch`),x=n(`w-input`),S=n(`w-flex`),C=n(`w-icon`),w=n(`w-overlay`),T=n(`example`),E=n(`ssh-pre`);return e(),i(`div`,null,[u[32]||=r(`p`,null,[o(`By default the overlay has a `),r(`span`,{class:`code`},`0.3`),o(` opacity with a black color and a z-index
...
`)],-1),a(_,{h2:``},{default:t(()=>[...u[12]||=[o(`Overlay with custom opacity and control on `,-1),r(`span`,{class:`code`},`persistent`,-1)]]),_:1}),u[33]||=r(`p`,null,[o(`When the overlay is persistent, it will not close on backdrop click or `),r(`kbd`,null,`Escape`),o(`.`)],-1),u[34]||=r(`p`,null,[o(`When persistent is false (default), `),r(`kbd`,null,`Escape`),o(` closes the overlay while it is open,
even when focus is on content inside (e.g. a field in a `),r(`code`,null,`w-dialog`),o(`).
Backdrop click still only closes when clicking the dimmed area.`)],-1),a(T,null,{pug:t(()=>[...u[17]||=[o(`w-flex(wrap)
