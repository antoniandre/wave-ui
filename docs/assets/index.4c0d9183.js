...
With the option `),d("code",null,"round"),a(" you can force it to be round.")],-1),W=d("span",{class:"size--sm"},"11",-1),U=d("span",{class:"size--sm"},"11",-1),j=d("p",null,[a("The default transition is "),d("code",null,"fade"),a(".")],-1),L={class:"w-flex align-center wrap"},M=d("span",{class:"mb2"},"Toggle with this transition effect:",-1),q={class:"w-flex grow"},G=d("div",{class:"xs2"},null,-1),H={class:"xs10"};function J(i,l,f,z,_,w){const s=g("title-link"),t=g("w-icon"),m=g("w-button"),n=g("w-badge"),c=g("example"),b=g("w-flex");return u(),p("div",null,[o(s,{h2:""},{default:e(()=>[a("Default")]),_:1}),x,o(c,{"content-class":"mt2"},{pug:e(()=>[a(`w-badge
  template(#badge) 3
