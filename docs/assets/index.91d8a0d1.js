...
but you can override that with the <code>item-icon-color-key</code> prop.</p>`,2),E={class:"w-flex wrap align-center"},$=a("div",{class:"title3"},"Normal",-1),B=a("div",{class:"title3"},"unexpandable-empty",-1),T=a("p",null,[n("When the tree is "),a("code",null,"selectable"),n(", you can use the "),a("code",null,"v-model"),n(" to get the selected item.")],-1),N=a("p",null,"Click on a tree item to select it.",-1),D={class:"w-flex mt6"},V=a("strong",{class:"mr3"},"Selection:",-1),M=w('<p>Multiple events are fired from the <strong class="code">w-tree</strong> component:</p><ul class="lh0"><li><code>before-open</code>: fired as soon as the user clicks a tree item that is expandable and before the subitems are revealed.</li><li class="mt1"><code>open</code>: fired after a user clicks a tree item that is expandable, and after the expand animation.</li><li class="mt1"><code>before-close</code>: fired as soon as the user clicks a tree item to close its subtree.</li><li class="mt1"><code>close</code>: fired after a user clicks a tree item to close its subtree, and after the collapse animation.</li><li class="mt1"><code>click</code>: fired when the user clicks any tree item.</li><li class="mt1"><code>select</code>: fired when the user selects any selectable tree item. The <code>selectable</code> option must be set to true.</li><li class="mt1"><code>update:model-value</code>: (or <code>input</code> in Vue 2.x) fired when the user selects any selectable tree item. The <code>selectable</code> option must be set to true.</li></ul>',2),R=["innerHTML"],P=a("strong",{class:"black"},"Note on reactivity",-1),z={class:"black mt2"},K=a("code",null,"deep-reactivity",-1),O=a("br",null,null,-1),F={href:"https://vuejs.org/guide/essentials/watchers.html#deep-watchers",target:"_blank"},H=a("p",null,[n("If you need to customize the layout of the item label and/or icon, you can use the "),a("code",null,"#item"),n(" slot.")],-1);function W(l,o,p,y,k,m){const c=d("title-link"),s=d("w-tree"),i=d("example"),h=d("w-icon"),j=d("w-card"),x=d("w-flex"),C=d("alert");return b(),g("div",null,[t(c,{h2:""},{default:e(()=>[n("Default")]),_:1}),t(i,null,{pug:e(()=>[n('w-tree(:data="tree")')]),html:e(()=>[n('<w-tree :data="tree"></w-tree>')]),js:e(()=>[n(`data: () => ({
  tree: [
    {
      label: 'src',
      children: [
...
`)]),default:e(()=>[t(s,{data:l.tree2},null,8,["data"])]),_:1}),t(c,{h2:""},{default:e(()=>[n("Icons")]),_:1}),L,t(i,null,{pug:e(()=>[n(`w-tree.size--md(
  :data="tree"
...
`)]),default:e(()=>[t(s,{class:"size--md",data:l.tree2,"expand-icon":"mdi mdi-plus","expand-open-icon":"mdi mdi-minus","branch-icon":"mdi mdi-folder-outline","branch-open-icon":"mdi mdi-folder-open-outline","leaf-icon":"mdi mdi-file-outline"},null,8,["data"])]),_:1}),t(c,{h3:""},{default:e(()=>[n("Different icon per item")]),_:1}),I,t(i,null,{pug:e(()=>[n(`w-tree.size--md(
  :data="tree"
  expand-icon="mdi mdi-plus"
  expand-open-icon="mdi mdi-minus"
  branch-icon="mdi mdi-folder-outline"
...
}`)]),default:e(()=>[t(s,{data:l.tree3,onClick:m.renameLeafItem,"deep-reactivity":""},null,8,["data","onClick"])]),_:1}),t(C,{tip:""},{default:e(()=>[P,a("p",z,[n(`By default the tree items key-value pairs will not be watched as this is a more expensive
operation. This means that if you want to have reactivity when you modify a key or value,
like the label, you will need to add the `),K,n(" option."),O,a("a",F,[n("Read on deep watchers on the Vue.js official documentation"),t(h,{class:"ml1"},{default:e(()=>[n("mdi mdi-open-in-new")]),_:1})])])]),_:1}),t(c,{h2:""},{default:e(()=>[n("Custom item (icon + label)")]),_:1}),H,t(i,null,{pug:e(()=>[n(`w-tree.lh5(:data="tree")
...
`)]),default:e(()=>[t(s,{class:"lh5",data:l.tree4},{item:e(({item:r,open:le})=>[a("span",null,u(r.label),1),r.status==="error"?(b(),f(h,{key:0,class:"ml1","bg-color":"error",xs:""},{default:e(()=>[n("mdi mdi-close")]),_:1})):r.status==="success"?(b(),f(h,{key:1,class:"ml1","bg-color":"success",xs:""},{default:e(()=>[n("mdi mdi-check")]),_:1})):r.status==="syncing"?(b(),f(h,{key:2,class:"ml1","bg-color":"warning",xs:""},{default:e(()=>[n("mdi mdi-clock-outline")]),_:1})):A("",!0)]),_:1},8,["data"])]),_:1}),t(c,{h2:""},{default:e(()=>[n("Expand all, by default")]),_:1}),t(i,null,{pug:e(()=>[n('w-tree(:data="tree" expand-all)')]),html:e(()=>[n('<w-tree :data="tree" expand-all></w-tree>')]),js:e(()=>[n(`data: () => ({
  tree: [
      {
        label: 'Item 1',
        children: [
