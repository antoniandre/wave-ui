import{r as p,o as f,g,a as r,w as o,b as t,d as s,t as m,h as D,n as P,l as C,v as O,_ as c,L as $}from"./index-DM46aIYM.js";const V={class:"py12 w-flex column align-center justify-center"},S={class:"py12 w-flex column align-center justify-center"},N={class:"w-flex pa2 align-center wrap"},A={class:"w-flex align-center py1"},j={class:"w-flex align-center justify-center fill-height"};function R(n,e,v,h,k,w){const i=p("title-link"),a=p("w-button"),d=p("example"),u=p("w-drawer"),T=p("w-card"),y=p("w-icon"),b=p("ssh-pre");return f(),g("div",null,[r(i,{h2:""},{default:o(()=>e[29]||(e[29]=[t("Basic")])),_:1}),r(d,{"content-class":"w-flex align-center wrap"},{pug:o(()=>e[31]||(e[31]=[t(`w-button(@click="openDrawer = true" outline) Open drawer
