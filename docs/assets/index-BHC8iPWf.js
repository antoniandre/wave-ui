import{r,o as w,g as y,a as s,w as n,b as e,d as t,t as f,n as j,c as V,f as I,h as _,_ as q,M as F}from"./index-CjrszJjX.js";const E=t("ul",null,[t("li",{class:"title5"},[e("The "),t("span",{class:"code"},"w-form"),e(" component is used for validation.")]),t("li",null,[e("A "),t("span",{class:"code"},"w-form"),e(` is invisible and has no style by default. You can put it in a
...
Pristine represents the moment where the form is still untouched, neither valid, nor invalid.`)],-1),G=t("code",null,"$refs",-1),Q=_(`<p class="mt6">The <span class="code">w-form</span> prevents the form submission by default - for modern usage where an AJAX
...
</p>`,2),Z={class:"text-right mt6"},$=t("code",null,"action",-1),ee=t("code",null,"method",-1),te=_(`<p>By default the validation happens on <span class="code">keyup</span>, on <span class="code">blur</span> and on
...
value (or v-model) to `),t("code",null,"null"),e(", like pristine.")],-1),ae={class:"text-right mt6"},oe=_(`<p class="title5">These events are fired on submit.</p><ul><li class="mt1"><code>before-validate</code> is always fired as soon as a submission is attempted (e.g. submit
...
disable all the fields or set them all to readonly.`)],-1),ye=t("strong",null,"Attention",-1),_e=t("div",null,[e("Wave UI will not reset the validity of the fields when you toggle the "),t("code",null,"disabled"),e(`
...
`)]),default:n(()=>[s(g,{success:a.form5.success,error:a.form5.error,info:!a.form5.success&&!a.form5.error},{default:n(()=>[e(f(!a.form5.success&&!a.form5.error?"The form is still pristine":a.form5.success?"Success":"Error"),1)]),_:1},8,["success","error","info"]),t("p",null,"The form has been validated "+f(a.form5.validated)+" time(s).",1),s(v,{onValidate:o[2]||(o[2]=u=>{a.form5.validated++,a.form5.success=a.form5.error=!1}),onSuccess:o[3]||(o[3]=u=>a.form5.success=!0),onError:o[4]||(o[4]=u=>a.form5.error=!0)},{default:n(()=>[s(d,{label:"First name",validators:[a.validators.required]},null,8,["validators"]),s(d,{class:"mt3",label:"Last name",validators:[a.validators.required]},null,8,["validators"]),t("div",ve,[s(c,{type:"submit"},{default:n(()=>[e("Validate")]),_:1})])]),_:1})]),_:1}),s(i,{h2:"",slug:"advanced-validation"},{default:n(()=>[e("Advanced validation with everything")]),_:1}),pe,he,s(p,null,{pug:n(()=>[e(`w-card(content-class="pa0")
  ...
  w-notification(
    ...
    plain
    round
    bottom) The form was sent successfully!`)]),html:n(()=>[e(`<w-card content-class="pa0">
