import{a as S}from"./index.0235ccf1.js";import{o as g,g as y,a as t,w as n,b as e,e as l,d as c,h as v,r,_,R as F,E as L}from"./index.56666bbf.js";const R=l("p",null,[e("By default the "),l("span",{class:"code"},"w-input"),e(` component has a label inside the input field, that moves up
...
`)],-1),A={class:"grow mb4",style:{"min-width":"200px"}},j=l("div",{class:"title4 mb2"},"Underline style (default)",-1),D={class:"grow mb4",style:{"min-width":"200px"}},U=l("div",{class:"title4 mb2"},"Outline style",-1),M=l("p",{class:"mb4"},[e("Like in most components, you can set a "),l("code",null,"color"),e(" for the text and a "),l("code",null,"bg-color"),e(` for the
background.`),l("br"),e(`
By default, the text has the "`),l("span",{class:"code"},"primary"),e('" color.')],-1),V={class:"grow mb4",style:{"min-width":"200px"}},E=l("div",{class:"title4 mb2"},"Underline style (default)",-1),H={class:"grow mb4",style:{"min-width":"200px"}},q=l("div",{class:"title4 mb2"},"Outline style",-1),B=l("p",null,[e('The default label position is "'),l("span",{class:"code"},"inside"),e('", but it can also be "'),l("span",{class:"code"},"left"),e('" or "'),l("span",{class:"code"},"right"),e('".')],-1),C=l("span",{class:"code"},"w-input",-1),N=l("span",{class:"code"},"w-input",-1),W=l("br",null,null,-1),Y=l("span",{class:"code"},"label",-1),z=l("p",null,[e("It is convenient to have the label inside the "),l("span",{class:"code"},"w-input"),e(` component to let it handle
...
It is possible to set a custom icon instead.`)],-1),oe=l("p",null,"You could even compute a variable to show a different icon per detected file type.",-1),se=l("p",null,`On the frontend, you can read all the file details and contents on input when the user selects
a file, or you can provide a files array that you keep in sync with Wave UI.`,-1),ae={class:"mt3"},de=l("p",null,[e("The v-model can be used to access the files added by the user."),l("br")],-1),re=l("strong",null,"Important",-1),ce=l("br",null,null,-1),pe={class:"mt3"},ue=v(`<p>There are different ways you can do this. The 2 most common ways would be to:</p><ul><li>Use Axios or other AJAX library to send the file on <strong class="code">w-form</strong> <code>@success</code> (emitted upon successful validation).</li><li>Use the <code>allow-submit</code> option on the <strong class="code">w-form</strong> as well as
...
set this up.</p>`,3),me=l("p",null,[e("In this example, the file is uploaded to "),l("a",{href:"https://filebin.net",target:"_blank"},"Filebin"),e(`.
...
expectation of the Filebin API.`)],-1),he=l("p",null,[e("In this example (more common case) the file is transferred as "),l("code",null,"multipart/form-data"),e(` with
the use of `),l("code",null,"FormData"),e(" and using the same HTML as the previous example.")],-1),be=l("p",null,`Here is an example of a very minimalist way to receive and display the file on server side
with PHP. Of course you should add more checks, and move the temporary uploaded file when all
the checks are passed.`,-1),fe=l("p",null,[e(`If you try to upload a very large file, you will see the progress value of the file transfer will
be updated as the transfer goes on (e.g. :loading="overallProgress").`),l("br"),e(`
You can also show a self-updated progress bar with the `),l("code",null,"show-progress"),e(" prop.")],-1),we={class:"my4"},ge={class:"ml2"},ye=l("p",null,[e('The default type is "'),l("span",{class:"code"},"text"),e('" but the types below are also supported.')],-1),ve=l("p",null,[e("On desktop you will not notice the difference between the fields "),l("span",{class:"code"},"email"),e(", "),l("span",{class:"code"},"tel"),e(`,
`),l("span",{class:"code"},"url"),e(`, and the default text type. But on touch devices, the keyboard is adapted to the
type of input.`)],-1),_e=l("h3",null,"Textual inputs",-1),xe={class:"input-types"},Pe=l("div",{class:"code mb1"},'type="date"',-1),ke={class:"mt4"},Se=l("div",{class:"code mb1"},'type="email"',-1),Fe={class:"mt4"},Ie=l("div",{class:"code mb1"},'type="number"',-1),Te={class:"mt4"},Le=l("div",{class:"code mb1"},'type="password"',-1),Re={class:"mt4"},Oe=l("div",{class:"code mb1"},'type="search"',-1),$e={class:"mt4"},Ae=l("div",{class:"code mb1"},'type="tel"',-1),je={class:"mt4"},De=l("div",{class:"code mb1"},'type="text"',-1),Ue={class:"mt4"},Me=l("div",{class:"code mb1"},'type="time"',-1),Ve={class:"mt4"},Ee=l("div",{class:"code mb1"},'type="url"',-1),He={class:"mt4"},qe=l("span",{class:"code mb1 mr2"},'type="hidden"',-1),Be=l("span",{class:"code"},"w-input",-1),Ce=l("h3",null,"Other types of inputs",-1),Ne=l("p",null,"For all the other types of input listed below, a specific Wave UI component should be used instead:",-1),We={class:"other-input-types"},Ye=v('<li class="mt1"><span class="code mr2">type=&quot;button"</span><span class="grey">use <code>w-button</code> instead</span></li><li class="mt1"><span class="code mr2">type=&quot;checkbox"</span><span class="grey">use <code>w-checkbox</code> instead</span></li>',2),ze={class:"mt1"},Je=l("span",{class:"code mr2"},'type="color"',-1),Ge=l("span",{class:"grey"},[e("use "),l("code",null,"w-color-picker"),e(" instead")],-1),Xe=v('<li class="mt1"><span class="code mr2">type=&quot;image"</span><span class="grey">use the <code>img</code> HTML tag instead</span></li><li class="mt1"><span class="code mr2">type=&quot;radio"</span><span class="grey">use <code>w-radio</code> instead</span></li><li class="mt1"><span class="code mr2">type=&quot;range"</span><span class="grey">use <code>w-slider</code> instead</span></li><li class="mt1"><span class="code mr2">type=&quot;reset"</span><span class="grey">use <code>w-button</code> instead</span></li><li class="mt1"><span class="code mr2">type=&quot;submit"</span><span class="grey">use <code>w-button</code> instead</span></li>',5),Ke={class:"mt1"},Qe=l("span",{class:"code mr2"},'type="time"',-1),Ze=l("span",{class:"grey"},[e("use "),l("code",null,"w-time-picker"),e(" instead")],-1);function en(o,d,m,h,x,u){const s=r("title-link"),i=r("w-input"),a=r("example"),f=r("w-flex"),w=r("alert"),b=r("w-icon"),I=r("w-button"),T=r("w-form"),P=r("ssh-pre"),k=r("w-tag");return g(),y("div",null,[t(s,{h2:""},{default:n(()=>[e("Default")]),_:1}),R,t(a,null,{pug:n(()=>[e("w-input Label")]),html:n(()=>[e(`<w-input>Label</w-input>
...
`)]),default:n(()=>[t(f,{wrap:"",gap:2},{default:n(()=>[l("div",A,[j,t(i,{class:"mb1",label:"Round",round:""}),t(i,{class:"mb1",label:"Round and shadow",round:"",shadow:""}),t(i,{label:"Tile",tile:""})]),l("div",D,[U,t(i,{class:"mb1",label:"Round",round:"",outline:""}),t(i,{class:"mb1",label:"Round and shadow",round:"",outline:"",shadow:""}),t(i,{class:"mb1",label:"Tile",tile:"",outline:""})])]),_:1})]),_:1}),t(s,{h2:""},{default:n(()=>[e("Colors")]),_:1}),M,t(a,null,{pug:n(()=>[e(`w-flex(wrap :gap="2")
  .grow.mb4(style="min-width: 200px")
    .title4.mb2 Underline style (default)
...
`)]),default:n(()=>[t(f,{wrap:"",gap:2},{default:n(()=>[l("div",V,[E,t(i,{class:"mb1","model-value":"Some content"}),t(i,{class:"mb1",color:"red","model-value":"Some content"}),t(i,{class:"mb1","bg-color":"red-light5","model-value":"Some content"}),t(i,{class:"mb1",color:"red-dark1","bg-color":"red-light5","model-value":"Some content"}),t(i,{class:"mb1",color:"orange-dark1","bg-color":"orange-light5","model-value":"Some content"})]),l("div",H,[q,t(i,{class:"mb1","model-value":"Some content",outline:""}),t(i,{class:"mb1",color:"red","model-value":"Some content",outline:""}),t(i,{class:"mb1","bg-color":"red-light5","model-value":"Some content",outline:""}),t(i,{class:"mb1",color:"red-dark1","bg-color":"red-light5","model-value":"Some content",outline:""}),t(i,{class:"mb1",color:"orange-dark1","bg-color":"orange-light5","model-value":"Some content",outline:""})])]),_:1})]),_:1}),t(s,{h2:""},{default:n(()=>[e("Label position")]),_:1}),B,t(w,{tip:""},{default:n(()=>[e("You could also set a label outside of the "),C,e(` and display it nicely with flex.
...
`)]),default:n(()=>[t(i,{type:"file",preview:"mdi mdi-star"},{default:n(()=>[e("File")]),_:1})]),_:1}),oe,t(a,null,{pug:n(()=>[e(`w-input(
  type="file"
  v-model="files"
  :preview="!!files.length && filePreviewIcon") File`)]),html:n(()=>[e(`<w-input
  type="file"
  v-model="files"
...
`)]),default:n(()=>[t(i,{type:"file",modelValue:o.files3,"onUpdate:modelValue":d[2]||(d[2]=p=>o.files3=p),preview:!!o.files3.length&&u.filePreviewIcon},{default:n(()=>[e("File")]),_:1},8,["modelValue","preview"])]),_:1}),t(s,{h3:""},{default:n(()=>[e("Reading the files")]),_:1}),se,t(s,{class:"mt6",h4:""},{default:n(()=>[e("Via @input")]),_:1}),t(a,null,{pug:n(()=>[e(`w-input(type="file" @input="onFileInput") File

pre.mt3 `+c("{{ files }}"))]),html:n(()=>[e(`<w-input type="file" @input="onFileInput>File</w-input>

<pre class="mt3">`+c("{{ files }}")+"</pre>")]),js:n(()=>[e(`data: () => ({
  files: []
}),
...
`)]),default:n(()=>[t(i,{type:"file",onInput:u.onFileInput},{default:n(()=>[e("File")]),_:1},8,["onInput"]),l("pre",ae,c(o.files1),1)]),_:1}),t(s,{class:"mt6 mb2",h4:""},{default:n(()=>[e("Via v-model")]),_:1}),de,t(w,{warning:""},{default:n(()=>[re,ce,e(`Even if a v-model is allowing a two-way binding,
there is no way to prefill an input type file:
that would be a security breach and is therefore not allowed in HTML.`)]),_:1}),t(a,null,{pug:n(()=>[e(`w-input(type="file" v-model="files") File

pre.mt3 `+c("{{ files }}"))]),html:n(()=>[e(`<w-input type="file" v-model="files">File</w-input>

<pre class="mt3">`+c("{{ files }}")+"</pre>")]),js:n(()=>[e(`data: () => ({
  files: []
})
`)]),default:n(()=>[t(i,{type:"file",modelValue:o.files2,"onUpdate:modelValue":d[3]||(d[3]=p=>o.files2=p)},{default:n(()=>[e("File")]),_:1},8,["modelValue"]),l("pre",pe,c(o.files2),1)]),_:1}),t(s,{h3:""},{default:n(()=>[e("Uploading the file to a backend server")]),_:1}),ue,t(s,{class:"mt8",h4:""},{default:n(()=>[e("1st example")]),_:1}),me,t(a,{reactive:"","external-js":"https://cdnjs.cloudflare.com/ajax/libs/axios/0.25.0/axios.min.js"},{pug:n(()=>[e(`w-form(@success="onFormSuccess")
  w-input(
    type="file"
    v-model="files"
  ...
  async onFormSuccess () {
    ...
    const binURL = 'https://filebin.net/waveui-`+c(o.todayFormatted)+c(o.userIP)+`'
...
`,1)]),default:n(()=>[t(T,{onSuccess:u.onFormSuccess},{default:n(()=>[t(i,{type:"file",modelValue:o.files5,"onUpdate:modelValue":d[4]||(d[4]=p=>o.files5=p),validators:[()=>o.files5.length||"Please add a file"]},{default:n(()=>[e("File")]),_:1},8,["modelValue","validators"]),t(I,{class:"d-flex mla mt4",type:"submit",loading:o.loading},{default:n(()=>[e("Send")]),_:1},8,["loading"])]),_:1},8,["onSuccess"])]),_:1}),t(s,{class:"mt8",h4:""},{default:n(()=>[e("2nd example")]),_:1}),he,t(P,{language:"js",label:"JavaScript",dark:o.$store.state.darkMode},{default:n(()=>[e(`import axios from 'axios'
...
`)]),_:1},8,["dark"]),be,t(P,{language:"php",label:"PHP",dark:o.$store.state.darkMode},{default:n(()=>[e(`<?php
...
?>
`)]),_:1},8,["dark"]),t(s,{h3:""},{default:n(()=>[e("Loading state")]),_:1}),fe,t(a,null,{pug:n(()=>[e(`w-input(type="file"
  v-model="files"
...
w-flex
  | Files:
  pre.ml2 `+c("{{ files }}"))]),html:n(()=>[e(`<w-input type="file"
  v-model="files4"
  v-model:overall-progress="overallProgress"
  show-progress
...
`)]),default:n(()=>[t(i,{type:"file",modelValue:o.files4,"onUpdate:modelValue":d[5]||(d[5]=p=>o.files4=p),"overall-progress":o.overallProgress,"onUpdate:overall-progress":d[6]||(d[6]=p=>o.overallProgress=p),"show-progress":"","progress-color":"green"},{default:n(()=>[e("File")]),_:1},8,["modelValue","overall-progress"]),l("div",we,"Overall progress: "+c(o.overallProgress),1),t(f,null,{default:n(()=>[e("Files:"),l("pre",ge,c(o.files4),1)]),_:1})]),_:1}),t(s,{h3:""},{default:n(()=>[e("Accepting specific file extensions")]),_:1}),t(a,null,{pug:n(()=>[e('w-input(type="file" label="File" accept=".jpg, .jpeg, .png, .gif, .svg")')]),html:n(()=>[e(`<w-input
  type="file"
  label="File"
  accept=".jpg, .jpeg, .png, .gif, .svg">
</w-input>
`)]),default:n(()=>[t(i,{type:"file",label:"File",accept:".jpg, .jpeg, .png, .gif, .svg"})]),_:1}),t(s,{h3:""},{default:n(()=>[e("Multiple files upload")]),_:1}),t(a,null,{pug:n(()=>[e('w-input(type="file" label="File" accept=".jpg, .jpeg, .png, .gif, .svg" multiple)')]),html:n(()=>[e(`<w-input
  type="file"
  label="File"
  accept=".jpg, .jpeg, .png, .gif, .svg"
  multiple>
</w-input>
`)]),default:n(()=>[t(i,{type:"file",label:"File",accept:".jpg, .jpeg, .png, .gif, .svg",multiple:""})]),_:1}),t(s,{h2:""},{default:n(()=>[e("Types")]),_:1}),ye,ve,_e,t(a,null,{pug:n(()=>[e(`<ul.input-types>
  <li>
    <.code.mb1 type="date"<
