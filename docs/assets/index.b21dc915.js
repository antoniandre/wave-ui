import{r as h,o as u,f as b,a as n,w as a,b as e,d as t,n as k,h as i,F,j as R,c as M,k as A,e as $,i as q,_ as C,a7 as V}from"./index.8b2cb3df.js";const z=t("p",null,[e("When there is no data, a default text will be displayed. You can override it via the "),t("code",null,"no-data"),e(" slot.")],-1),H=t("br",null,null,-1),P=t("p",null,[e("You can align the columns contents separately by adding an "),t("code",null,"align"),e(` key in each header
definition (`),t("code",null,"left"),e(", "),t("code",null,"center"),e(" or "),t("code",null,"right"),e(")."),t("br"),e(`
If you don't define any, `),t("code",null,"left"),e(` will be implicit.
`)],-1),W=t("p",null,[e("Even with the "),t("code",null,"no-headers"),e(" option, the "),t("code",null,"headers"),e(` are still required for various
reasons, like getting the number of columns and sorting/filtering keys.`)],-1),J=t("p",null,[e("A table footer can be added via the "),t("code",null,"footer"),e(` slot. If present, the footer will span on
all the columns by default.
`)],-1),K={class:"w-flex justify-end"},U=t("strong",{class:"mr2"},"Total:",-1),O=t("p",null,[e("The "),t("code",null,"footer-row"),e(" slot will give you more flexibility as it lets you define the whole table row.")],-1),Y=t("p",null,"It can be useful if you want to keep the columns alignments in the footer.",-1),G=t("p",null,[e("You can resize the columns by dragging their edges left or right."),t("br"),e(`
If you want the whole cell content to be on a single line and truncated with the ellipsis
(`),t("code",null,"..."),e("), you can apply this CSS.")],-1),X=t("p",null,[e(`In some apps, it makes sense to save the prefered table layout of the user, and reapply it
every time this table is loaded. Here is a demo of how to do so.`),t("br"),e(`
To test it, first resize the columns, then refresh the page to see the same layout.`)],-1),Q=t("p",null,`This is completely external to Wave UI, but this example shows you a way to do it in your
code as it is a frequent use case.`,-1),Z=t("p",null,[e("To make a column sticky, you only need to add "),t("code",null,"sticky: true"),e(` to the header of that
column.`),t("br"),e(`
The sticky mechanism is done via CSS (position: sticky). So if you set multiple sticky
columns, one will overlap the previous one as you scroll.`)],-1),ee=t("p",{class:"grey"},"Scroll the table horizontally to observe the behavior.",-1),ae={class:"w-flex align-center mb2"},te=t("p",null,[e(`To make the sorting API very easy to use and remember (and avoid complex array or object structures),
the `),t("strong",{class:"code"},"w-table"),e("'s sorting is defined with a header key string preceded by a "),t("code",null,"+"),e(` for ASC,
or a `),t("code",null,"-"),e(" for DESC. For instance, in this example: "),t("code",null,"'+firstName'"),e(`.
`)],-1),le=t("p",null,[e(`When dealing with a lot of table entries, you will most likely need the sorting to be done
in the backend.`),t("br"),e(`
For this you can use the asynchronous sorting and update the table rows from outside Wave UI.`)],-1),ne=t("p",null,[e(`Filtering the table rows is very straightforward: you only need to provide your filtering function to the
`),t("strong",{class:"code"},"w-table"),e(" component and it will be applied to the table."),t("br"),e(`
Setting the filter to `),t("code",null,"null"),e(" or "),t("code",null,"false"),e(" or "),t("code",null,"undefined"),e(" will remove any previous filter.")],-1),ie={class:"w-flex wrap mb3"},se=t("p",null,[e("You could also apply a filter globally, which looks into all the columns at once."),t("br"),e(`
Here is one cool way to do it.`)],-1),re=t("strong",null,[e(`If you don't need the RegExp power, you can simply return
`),t("code",null,"allTheColumns.toLowerCase().includes(keyword)"),e(` instead.
`)],-1),oe=t("br",null,null,-1),de=t("br",null,null,-1),me=t("code",null,"|",-1),he=t("br",null,null,-1),ce=t("code",null,"new RegExp(keyword, 'i')",-1),ue=t("code",null,"new RegExp(`\\\\b${keyword}\\\\b`, 'i')",-1),be=t("code",null,"floretta",-1),fe=t("code",null,"florett",-1),pe=t("p",null,[e("When the table content is not ready straight away, you can use the "),t("code",null,"loading"),e(` prop to display
a progress bar while loading.`)],-1),Ne=t("p",null,"Click a row to see it highlighted and get information about the selected item.",-1),ye=t("p",null,[e("By default, the selection will use the "),t("code",null,"primary"),e(" color and apply an opacity of "),t("code",null,"0.2"),e(`.
If this is not what you want, you can override it via CSS (`),t("code",null,".w-table__row--selected td:before"),e(`).
`)],-1),ge=t("span",{class:"code"},"selectable-rows",-1),we=t("p",null,[e("You can enable the rows selection by adding the "),t("code",null,"selectable-rows"),e(` prop, or disable it by
removing it (by default) - and this is the same as passing a boolean - but you can also set it to `),t("code",null,"1"),e(`
to allow a single selection only.
`)],-1),ke=t("span",{class:"code"},"force-selection",-1),ve=t("p",null,[e("Eventually, you can use the "),t("code",null,"force-selection"),e(` prop to prevent unselecting a row when only
one remain selected.
`)],-1),xe=t("span",{class:"code"},"@row-select",-1),_e=q(`<p>This event is fired each time a row is selected <strong>or unselected</strong> (so you don&#39;t need to listen
...
information such as:</p><ul><li><code>item</code>: the clicked row object</li><li><code>selected</code>: a boolean telling if the row is being selected or unselected</li><li><code>selectedRows</code>: an array of all the selected rows objects</li></ul>`,2),Fe=t("div",{class:"mt4 title4"},"Selection info:",-1),Se=t("p",null,`Wave UI offers a convenient way to provide an array of selected rows and keeping your array in sync
with the selected rows after user interaction.`,-1),Re=t("ul",null,[t("li",null,[t("strong",null,"In Vue 2"),e(", you can do 2-way binding on any variable other than the "),t("strong",{class:"code"},"v-model"),e(" using the "),t("code",null,".sync"),e(" modifier.")]),t("li",null,[t("strong",null,"In Vue 3"),e(", multiple "),t("strong",{class:"code"},"v-model"),e(" are supported in order to achieve 2-way binding. So you don't need "),t("code",null,".sync"),e(".")])],-1),Ie={class:"mt4"},Ce={class:"ml2"},De=t("br",null,null,-1),Le=t("code",null,"id",-1),Ee=t("code",null,"uid-key",-1),Be=t("p",null,"You can customize the headers labels and/or each row cells.",-1),Te=t("p",null,[e("In this example, only the headers are customized via the "),t("code",null,"header-label"),e(" slot.")],-1),Me=t("p",null,[e("In this example, only the items cells are customized via the "),t("code",null,"item"),e(` slot
...
where <code>i</code> is a an integer starting at 1.</p>`,1),Ae={class:"px2 text-center green-light5--bg text-bold"},$e=t("p",null,[e(`In this example, the full <tr> DOM element is customized, so you can add your own classes
and full layout.`),t("br"),e(`
As you notice, the `),t("code",null,"item"),e(` slot gives you full flexibility, but the drawback is that's more
code to write.`)],-1),ze=["onClick"],He=t("span",{class:"code"},"colspan",-1),Pe=t("p",null,[e("This example is showcasing another useful case: handling a colspan attribute."),t("br"),e(`
All the cells of all the rows are `),t("code",null,"colspan"),e("'d to one, and a custom row layout is applied.")],-1),We=["onClick"],Je=["colspan"],Ke={class:"title3"},Ue={class:"mr2"},Oe=t("p",null,[e("In addition to the full responsiveness, the "),t("code",null,"w-table"),e(` can be presented in a mobile friendly layout,
if the data it contains would not fit on mobile.`),t("br"),e(`
You can decide to trigger the mobile layout or not on each table, individually, via the `),t("code",null,"mobile-breakpoint"),e(`
parameter.`),t("br"),e(`
It can be very useful when multiple tables of data are presented, with more or less content, which
should be displayed differently.`),t("br"),t("br"),e(`
For this example, resize your browser to 700px or less to trigger the mobile layout.
`)],-1),Ye=t("p",null,[e("To stay lean and efficient, the minimum JavaScript behavior is added to the "),t("code",null,"w-table"),e(`
component.`),t("br"),e(`
One thing that is not calculated on the mobile layout is the labels column width (default: 6.5em).`),t("br"),e(`
You can override it to set the width you want via:
`)],-1);function Ge(l,r,f,S,D,p){const o=h("title-link"),d=h("w-table"),m=h("example"),N=h("w-button"),g=h("w-icon"),L=h("w-flex"),E=h("ssh-pre"),B=h("w-tag"),T=h("w-radios"),j=h("w-input"),x=h("alert");return u(),b("div",null,[n(o,{h2:""},{default:a(()=>[e("Basic")]),_:1}),n(m,null,{pug:a(()=>[e('w-table(:headers="table.headers" :items="table.items")')]),html:a(()=>[e(`<w-table
...
`)]),default:a(()=>[n(d,{headers:l.table1.headers,items:l.table1.items},null,8,["headers","items"])]),_:1}),n(o,{h2:""},{default:a(()=>[e("When there is no data")]),_:1}),z,n(m,null,{pug:a(()=>[e(`w-table(:headers="table.headers" :items="[]")
br
...
`)]),default:a(()=>[n(d,{headers:l.table1.headers,items:[]},null,8,["headers"]),H,n(d,{headers:l.table1.headers,items:[]},{"no-data":a(()=>[e("\u{1F44C} There is no data! \u{1F44C}")]),_:1},8,["headers"])]),_:1}),n(o,{h2:""},{default:a(()=>[e("Alignments")]),_:1}),P,n(m,null,{pug:a(()=>[e('w-table(:headers="table.headers" :items="table.items")')]),html:a(()=>[e(`<w-table
  :headers="table.headers"
  :items="table.items">
</w-table>`)]),js:a(()=>[e(`data: () => ({
  table: {
...
`)]),default:a(()=>[n(d,{headers:l.table2.headers,items:l.table2.items},null,8,["headers","items"])]),_:1}),n(o,{h2:"",slug:"example--no-headers"},{default:a(()=>[e("No headers")]),_:1}),W,n(m,null,{pug:a(()=>[e('w-table(:items="table.items" :headers="table.headers" no-headers)')]),html:a(()=>[e(`<w-table
  :items="table.items"
  :headers="table.headers"
  no-headers>
</w-table>`)]),js:a(()=>[e(`data: () => ({
...
`)]),default:a(()=>[n(d,{headers:l.table1.headers,items:l.table1.items,"no-headers":""},null,8,["headers","items"])]),_:1}),n(o,{h2:"",slug:"example--fixed-headers"},{default:a(()=>[e("Fixed headers")]),_:1}),n(m,null,{pug:a(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
...
`)]),default:a(()=>[n(d,{headers:l.table3.headers,items:l.table3.items,"fixed-headers":"",style:{height:"250px"}},null,8,["headers","items"])]),_:1}),n(o,{h2:"",slug:"example--footer"},{default:a(()=>[e("Footer")]),_:1}),n(o,{h3:"",slug:"example--footer-slot"},{default:a(()=>[e("Footer slot")]),_:1}),J,t("div",K,[n(N,{onClick:r[0]||(r[0]=s=>l.table3.fixedFooter=!l.table3.fixedFooter),outline:!l.table3.fixedFooter,round:""},{default:a(()=>[t("span",{class:k(["code",l.table3.fixedFooter?"white":"primary"])},"fixed-footer",2)]),_:1},8,["outline"])]),n(m,null,{pug:a(()=>[e(`w-table(
  ref="table"
  :headers="table.headers"
  :items="table.items"
...
`)]),default:a(()=>[n(d,{ref:"table",headers:l.table3.headers,items:l.table3.items,"fixed-footer":l.table3.fixedFooter,style:{height:"250px"}},{footer:a(()=>[n(L,{"justify-space-between":""},{default:a(()=>[n(N,{round:"",sm:"",onClick:p.addRow},{default:a(()=>[n(g,{class:"mr1"},{default:a(()=>[e("wi-plus")]),_:1}),e("add person")]),_:1},8,["onClick"]),t("div",null,[U,e(i(l.table3.items.length)+" persons",1)])]),_:1})]),_:1},8,["headers","items","fixed-footer"])]),_:1}),n(o,{h3:"",slug:"example--footer-slot"},{default:a(()=>[e("Footer-row slot")]),_:1}),O,Y,n(m,null,{pug:a(()=>[e(`w-table(
  ref="table"
  :headers="table.headers"
  no-headers
  :items="table.items"
...
`)]),default:a(()=>[n(d,{ref:"table",headers:l.table3.headers,"no-headers":"",items:l.table3.items,"fixed-footer":l.table3.fixedFooter,style:{height:"250px"}},{"footer-row":a(()=>[t("tr",null,[(u(!0),b(F,null,R(l.table3.headers,(s,c)=>(u(),b("th",{class:k(["py1",`${c?"px1":"px2"} text-${s.align||"left"}`]),key:c},i(s.label),3))),128))])]),_:1},8,["headers","items","fixed-footer"])]),_:1}),n(o,{h2:""},{default:a(()=>[e("Built-in column resizing")]),_:1}),G,n(E,{language:"css"},{default:a(()=>[e(`.w-table__cell {
  white-space: nowrap;
}
`)]),_:1}),n(m,null,{pug:a(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
...
`)]),default:a(()=>[n(d,{headers:l.table7.headers,items:l.table7.items,"resizable-columns":""},null,8,["headers","items"])]),_:1}),n(o,{h3:""},{default:a(()=>[e("Saving the table layout in localStorage")]),_:1}),X,n(m,null,{pug:a(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
  resizable-columns
...
`)]),default:a(()=>[n(d,{headers:l.table8.headers,items:l.table8.items,"resizable-columns":"",onColumnResize:p.onColumnResize},null,8,["headers","items","onColumnResize"])]),_:1}),n(o,{h2:""},{default:a(()=>[e("Toggling column visibility")]),_:1}),Q,n(m,null,{pug:a(()=>[e(`w-tag.ma1(
...
`)]),default:a(()=>[e("Toggle columns:"),(u(!0),b(F,null,R(l.table6.headers,(s,c)=>(u(),M(B,{class:"ma1",key:c,"bg-color":s.hidden?"grey-light4":"primary",onClick:A(y=>s.hidden=!s.hidden,["stop"])},{default:a(()=>[n(g,{class:"mr2"},{default:a(()=>[e("mdi mdi-eye"+i(s.hidden?"-off":""),1)]),_:2},1024),e(i(s.label),1)]),_:2},1032,["bg-color","onClick"]))),128)),n(d,{class:"mt2",headers:l.table6.headers.filter(s=>!s.hidden),items:l.table6.items},null,8,["headers","items"])]),_:1}),n(o,{h2:""},{default:a(()=>[e("Sticky columns")]),_:1}),Z,ee,n(m,null,{pug:a(()=>[e(`w-table(
:headers="table.headers"
:items="table.items"
fixed-layout
...
`)]),default:a(()=>[t("div",ae,[e("Sticky columns:"),n(T,{class:"ml1 mr4",modelValue:l.table9.stickyColumn,"onUpdate:modelValue":r[1]||(r[1]=s=>l.table9.stickyColumn=s),items:l.table9.stickyColumnOptions,onChange:p.toggleStickyColumn,inline:""},null,8,["modelValue","items","onChange"]),n(N,{onClick:r[2]||(r[2]=s=>l.table9.fixedHeaders=!l.table9.fixedHeaders),outline:!l.table9.fixedHeaders,round:""},{default:a(()=>[t("span",{class:k(["code",l.table9.fixedHeaders?"white":"primary"])},"fixed-headers",2)]),_:1},8,["outline"])]),n(d,{class:"white--bg",headers:l.table9.headers,items:l.table9.items,"fixed-layout":"","fixed-headers":l.table9.fixedHeaders,style:{"max-width":"500px",height:"200px"}},null,8,["headers","items","fixed-headers"])]),_:1}),n(o,{h2:""},{default:a(()=>[e("Sorting")]),_:1}),te,n(o,{h3:""},{default:a(()=>[e("Initial Sorting")]),_:1}),n(m,null,{pug:a(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
...
`)]),default:a(()=>[n(d,{headers:l.table1.headers,items:l.table1.items,sort:l.table1.sort,"onUpdate:sort":r[3]||(r[3]=s=>l.table1.sort=s)},null,8,["headers","items","sort"])]),_:1}),n(o,{h3:""},{default:a(()=>[e("Asynchronous Sorting")]),_:1}),le,n(m,{"blank-codepen":["js"]},{html:a(()=>[e(`<w-table
  :headers="table.headers"
  :items="table.items"
...
app.mount('#app')
`)]),default:a(()=>[n(d,{class:"my6",headers:l.table10.headers,items:l.table10.items,"sort-function":p.sortFunction,loading:l.table10.loading,style:{height:"140px"}},{pug:a(()=>[e(`w-table.my6(
:headers="table.headers"
:items="table.items"
:sort-function="sortFunction"
:loading="table.loading"
...
`)]),default:a(()=>[t("div",ie,[n(N,{class:"mr2 mb1",onClick:r[4]||(r[4]=s=>l.table3.activeFilter=0),round:"",outline:l.table3.activeFilter!==0},{default:a(()=>[e("No filter")]),_:1},8,["outline"]),n(N,{class:"mr2 mb1",onClick:r[5]||(r[5]=s=>l.table3.activeFilter=1),round:"",outline:l.table3.activeFilter!==1},{default:a(()=>[e("Last name starting with 'M'")]),_:1},8,["outline"]),n(N,{class:"mr2 mb1",onClick:r[6]||(r[6]=s=>l.table3.activeFilter=2),round:"",outline:l.table3.activeFilter!==2},{default:a(()=>[e("ID >= 10")]),_:1},8,["outline"])]),n(d,{headers:l.table3.headers,items:l.table3.items,filter:l.table3.filters[l.table3.activeFilter]},null,8,["headers","items","filter"])]),_:1}),n(o,{h3:""},{default:a(()=>[e("Global filter")]),_:1}),se,n(m,null,{pug:a(()=>[e(`w-input.mb3(
...
})`)]),default:a(()=>[n(j,{class:"mb3",modelValue:l.table4.keyword,"onUpdate:modelValue":r[7]||(r[7]=s=>l.table4.keyword=s),placeholder:"Search anything...","inner-icon-left":"wi-search"},null,8,["modelValue"]),n(d,{headers:l.table4.headers,items:l.table4.items,filter:l.table4.keywordFilter(l.table4.keyword)},null,8,["headers","items","filter"])]),_:1}),n(x,{tip:""},{default:a(()=>[re,oe,de,e(`But the real power of using a regular expression
`),n(g,{class:"red mr1",size:"0.9em"},{default:a(()=>[e("mdi mdi-heart")]),_:1}),e(` in this example's match, is that the user
...
but not `),fe,e(" for instance).")]),_:1}),n(o,{h2:""},{default:a(()=>[e("Loading state")]),_:1}),pe,n(N,{class:"mb2",disabled:!!l.table1.loading,onClick:p.reload},{default:a(()=>[n(g,{class:"mr1"},{default:a(()=>[e("mdi mdi-sync")]),_:1}),e("reload")]),_:1},8,["disabled","onClick"]),n(o,{h3:""},{default:a(()=>[e("Simple table - no set height")]),_:1}),n(m,null,{pug:a(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
...
`)]),default:a(()=>[n(d,{headers:l.table1.headers,items:l.table1.items,loading:l.table1.loading},null,8,["headers","items","loading"])]),_:1}),n(o,{h3:"",slug:"loading-with-fixed-header"},{default:a(()=>[e("Table with fixed header & set height of 200px")]),_:1}),n(m,null,{pug:a(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  :loading="loading"
...
`)]),default:a(()=>[n(d,{headers:l.table1.headers,items:l.table3.items,"fixed-headers":"",loading:l.table1.loading,style:{height:"200px"}},null,8,["headers","items","loading"])]),_:1}),n(o,{h2:"",slug:"pagination"},{default:a(()=>[e("Pagination"),n(B,{class:"ml2 text-bold",round:"",color:"warning",outline:"",sm:""},{default:a(()=>[e("COMING SOON")]),_:1})]),_:1}),n(m,null,{pug:a(()=>[]),js:a(()=>[e(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`)]),default:a(()=>[e("Coming soon.")]),_:1}),n(o,{h2:""},{default:a(()=>[e("Rows selection")]),_:1}),Ne,ye,n(o,{h3:"",slug:"example--selectable-rows"},{default:a(()=>[e("The "),ge,e(" prop")]),_:1}),we,n(o,{h3:"",slug:"example--force-selection"},{default:a(()=>[e("The "),ke,e(" prop")]),_:1}),ve,n(o,{h3:"",slug:"example--row-select"},{default:a(()=>[e("The "),xe,e(" event")]),_:1}),_e,n(m,null,{pug:a(()=>[e(`w-flex.mb4(wrap)
...
`)]),default:a(()=>[n(L,{class:"mb4",wrap:""},{default:a(()=>[n(T,{class:"mr6",modelValue:l.table1.selectableRows,"onUpdate:modelValue":r[8]||(r[8]=s=>l.table1.selectableRows=s),items:l.selectableRowsOptions},null,8,["modelValue","items"]),n(N,{class:"my3",onClick:r[9]||(r[9]=s=>l.table1.forceSelection=!l.table1.forceSelection),round:"",outline:!l.table1.forceSelection},{default:a(()=>[l.table1.forceSelection?(u(),M(g,{key:0,class:"mr2"},{default:a(()=>[e("wi-check")]),_:1})):$("",!0),e("Force selection")]),_:1},8,["outline"])]),_:1}),n(d,{headers:l.table1.headers,items:l.table1.items,"selectable-rows":l.table1.selectableRows,"force-selection":l.table1.forceSelection,onRowSelect:r[10]||(r[10]=s=>l.selectionInfo=s)},null,8,["headers","items","selectable-rows","force-selection"]),Fe,t("pre",null,i(l.selectionInfo),1)]),_:1}),n(o,{h3:""},{default:a(()=>[e("Updating the selected rows programmatically")]),_:1}),Se,n(x,{tip:""},{default:a(()=>[Re]),_:1}),n(m,null,{pug:a(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
  selectable-rows
...
})`)]),default:a(()=>[n(d,{headers:l.table1.headers,items:l.table1.items,"selectable-rows":"","selected-rows":l.table1.selectedRows,"onUpdate:selected-rows":r[11]||(r[11]=s=>l.table1.selectedRows=s)},null,8,["headers","items","selected-rows"]),t("div",Ie,[e("Selected rows:"),t("code",Ce,i(l.table1.selectedRows),1)])]),_:1}),n(x,{info:""},{default:a(()=>[e("In order to keep the same row selected after sorting or filtering, each row is assigned a unique identifier."),De,e(`
...
`)]),_:1}),n(o,{h2:"",slug:"example--expandable-rows"},{default:a(()=>[e("Expandable rows")]),_:1}),n(x,{warning:""},{default:a(()=>[e("This feature is in progress.")]),_:1}),n(m,null,{pug:a(()=>[e(`w-table(:headers="table.headers" :items="table.items" expandable-rows)
  template(#row-expansion="{ item }")
    w-icon.mr2(:color="['blue', 'pink'][item.gender]")
      | mdi `+i("{{ ['mdi-gender-male', 'mdi-gender-female'][item.gender] }}")+`
    | `+i("{{ item.firstName }}")+" weighs ",1),t("strong",null,i("{{ item.weight }}")+"kg",1),e(" and is "),t("strong",null,i("{{ item.height }}")+"m",1),e(" tall.")]),html:a(()=>[e(`<w-table
  :headers="table.headers"
  :items="table.items"
  expandable-rows>
  <template #row-expansion="{ item }">
    ...
    `+i("{{ item.firstName }}")+" weighs ",1),t("strong",null,i("{{ item.weight }}")+"kg",1),e(" and is "),t("strong",null,i("{{ item.height }}")+"m",1),e(` tall.
  </template>
</w-table>`)]),js:a(()=>[e(`data: () => ({
  table: {
    headers: [
...
`)]),default:a(()=>[n(d,{headers:l.table5.headers,items:l.table5.items,"expandable-rows":""},{"row-expansion":a(({item:s})=>[n(g,{class:"mr2",color:["blue","pink"][s.gender]},{default:a(()=>[e("mdi "+i(["mdi-gender-male","mdi-gender-female"][s.gender]),1)]),_:2},1032,["color"]),e(i(s.firstName)+" weighs ",1),t("strong",null,i(s.weight)+"kg",1),e(" and is "),t("strong",null,i(s.height)+"m",1),e(" tall.")]),_:1},8,["headers","items"])]),_:1}),n(o,{h2:"",slug:"slots"},{default:a(()=>[e("Headers & cells customization via slots")]),_:1}),Be,n(o,{h3:""},{default:a(()=>[e("Headers")]),_:1}),Te,n(m,null,{pug:a(()=>[e(`w-table(:headers="table.headers" :items="table.items")
...
`)]),default:a(()=>[n(d,{headers:l.table1.headers,items:l.table1.items},{"header-label":a(({label:s,index:c})=>[e(i(c)+": "+i(s)+" \u{1F44C}",1)]),_:1},8,["headers","items"])]),_:1}),n(o,{h3:"",slug:"item-cells"},{default:a(()=>[e("Item cells (inside <td> element)")]),_:1}),Me,n(m,null,{pug:a(()=>[e(`w-table(:headers="table.headers" no-headers :items="table.items")
...
`)]),default:a(()=>[n(d,{headers:l.table1.headers,"no-headers":"",items:l.table1.items},{"item-cell":a(({item:s,label:c,header:y,index:w})=>[y.key==="id"?(u(),b("small",Ve,"#"+i(w),1)):(u(),b(F,{key:1},[t("small",qe,i(y.label)+":",1),t("span",null,i(c),1)],64))]),_:1},8,["headers","items"])]),_:1}),n(o,{h3:"",slug:"override-1-particular-item-cell"},{default:a(()=>[e("override 1 particular item cell or column cells (inside <td> element)")]),_:1}),je,n(m,null,{pug:a(()=>[e(`w-table(:headers="table.headers" :items="table.items" no-headers)
  template(#item-cell.id="{ item, label, header, index }")
    div.px2.text-center.green-light5--bg.text-bold `+i("{{ label }}"))]),html:a(()=>[e(`<w-table
  :headers="table.headers"
  :items="table.items"
  no-headers>
  <template #item-cell.id="{ item, label, header, index }">
...
`)]),default:a(()=>[n(d,{headers:l.table1.headers,items:l.table1.items,"no-headers":""},{"item-cell.id":a(({item:s,label:c,header:y,index:w})=>[t("div",Ae,i(c),1)]),_:1},8,["headers","items"])]),_:1}),n(o,{h2:"",slug:"full-custom-rows"},{default:a(()=>[e("Full custom row (<tr> element itself)")]),_:1}),$e,n(m,null,{pug:a(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
  selectable-rows)
...
`)]),default:a(()=>[n(d,{headers:l.table1.headers,items:l.table1.items,"selectable-rows":""},{item:a(({item:s,index:c,select:y,classes:w})=>[t("tr",{class:k(w),onClick:y},[(u(!0),b(F,null,R(l.table1.headers,(_,I)=>(u(),b("td",{key:I,class:k(`pa4 text-${_.align||"left"}`)},i(s[_.key]||""),3))),128))],10,ze)]),_:1},8,["headers","items"])]),_:1}),n(o,{h3:"",slug:"colspan-on-td"},{default:a(()=>[He,e(" on <td>")]),_:1}),Pe,n(m,null,{pug:a(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
  no-headers
  selectable-rows)
...
`)]),default:a(()=>[n(d,{headers:l.table1.headers,items:l.table1.items,"no-headers":"","selectable-rows":""},{item:a(({item:s,index:c,select:y,classes:w})=>[t("tr",{class:k({...w,"indigo-light5--bg":c%2,"blue-light5--bg":!(c%2)}),onClick:y},[t("td",{class:"pa2",colspan:l.table1.headers.length},[t("div",Ke,"Row #"+i(c),1),t("ul",null,[(u(!0),b(F,null,R(l.table1.headers,(_,I)=>(u(),b("li",{key:I},[t("strong",Ue,i(_.label)+":",1),e(i(s[_.key]||""),1)]))),128))])],8,Je)],10,We)]),_:1},8,["headers","items"])]),_:1}),n(o,{h2:""},{default:a(()=>[e("Responsiveness & mobile layout")]),_:1}),Oe,n(m,null,{pug:a(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
