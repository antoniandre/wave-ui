import{r as s,o as d,f as r,a as e,w as n,b as l,j as b,v,e as o,h as i,d as c,c as T,M as S}from"./vendor.c30f2c6c.js";import{_ as B}from"./index.76d51146.js";const $=o("Transitions"),D=S('<p>Here is a list of all the available transition components.</p><ul><li><code>w-transition-fade</code></li><li class="mt1"><code>w-transition-scale</code></li><li class="mt1"><code>w-transition-scale-fade</code></li><li class="mt1"><code>w-transition-bounce</code></li><li class="mt1"><code>w-transition-twist</code></li><li class="mt1"><code>w-transition-expand</code></li><li class="mt1"><code>w-transition-slide</code></li><li class="mt1"><code>w-transition-slide-fade</code></li></ul>',2),R=o(`The transitions (based on
`),j=l("a",{href:"https://vuejs.org/v2/guide/transitions.html",target:"_blank"},"Vue native transitions",-1),H=o(`)
work with element toggling using `),N=l("code",null,"v-if",-1),V=o(" or "),A=l("code",null,"v-show",-1),P=o("."),I=l("br",null,null,-1),W=o("Simple example (with "),J=l("code",null,"show",-1),L=o(" a boolean variable):"),M={class:"w-flex"},U=o(`w-transition-fade
  span(v-if="show") Hello!`),q=o(`<w-transition-fade>
  <span v-if="show">Hello!</span>
</w-transition-fade>
`),z=o("Transitions showcase"),G={key:0,class:"transition-box"},K={key:0,class:"transition-box"},O={key:0,class:"transition-box"},Q={key:0,class:"transition-box"},Z={key:0,class:"transition-box"},nn={key:0,class:"transition-box text-nowrap"},tn={key:0,class:"transition-box"},en={key:0,class:"transition-box text-nowrap"},on={key:0,class:"transition-box text-nowrap"},an={key:0,class:"transition-box text-nowrap"},ln=o(`w-flex(align-center)
