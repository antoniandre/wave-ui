import{r as i,o as p,f as m,a as e,w as s,b as l,e as n,M as g}from"./vendor.c30f2c6c.js";import{_ as f,D as w}from"./index.67df9d80.js";const x=l("p",null,[n("If you want a different style than the "),l("span",{class:"code"},"w-progress"),n(` component, the spinner is a light
...
much point in using a `),l("code",null,"v-model"),n(" here as the spinner will never emit a value update.")],-1),C=n("Toggle spinner"),D=n(`w-button.mr4(@click="showSpinner = !showSpinner") Toggle spinner
w-spinner(:model-value="showSpinner")`),N=n(`<w-button @click="showSpinner = !showSpinner">Toggle spinner</w-button>
...
<code>lg</code>, <code>xl</code>, or explicit <code>size</code> prop.</p>`,1),M=n(`w-flex(align-center justify-center)
  w-spinner.ma1(fade xs)
  w-spinner.ma1(fade sm)
  w-spinner.ma1(fade md)
  w-spinner.ma1(fade lg)
  w-spinner.ma1(fade xl)
  w-spinner.ma1(fade size="5em")`),F=n(`<w-flex align-center justify-center>
...
`),L=n("Colors"),W=l("p",null,[n("Like in most components, you can set a "),l("code",null,"color"),n(" for the spinner.")],-1),q=n(`w-spinner.ma1(fade color="green")
