import{N as e,W as t,bt as n,c as r,d as i,g as a,h as o,k as s}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as c}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{i as l}from"./index-DQ7e6RHF.js";function u(c,l,u,d,f,p){let m=e(`title-link`),h=e(`w-timeline`),g=e(`example`),_=e(`w-icon`),v=e(`w-tag`);return s(),i(`div`,null,[a(m,{h2:``},{default:t(()=>[...l[0]||=[o(`Basic`,-1)]]),_:1}),a(g,null,{pug:t(()=>[...l[1]||=[o(`w-timeline(:items="items")`,-1)]]),html:t(()=>[...l[2]||=[o(`<w-timeline :items="items"></w-timeline>`,-1)]]),js:t(()=>[...l[3]||=[o(`data: () => ({
  items: [
