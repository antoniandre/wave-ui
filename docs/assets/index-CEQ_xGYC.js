...
`)]),default:t(()=>[e(a,{"model-value":46.3,"thumb-label":"",color:"primary-light3"},{label:t(({value:i})=>[l(c(~~(i*10)/10)+"%",1)]),_:1})]),_:1}),e(d,{h3:""},{default:t(()=>[l("Droplet style label")]),_:1}),z,E,I,N,e(r,{"content-class":"pt12 pl10 pr12"},{html:t(()=>[l(`<w-slider
  class="ma12"
  :model-value="30"
  thumb-label="droplet">
</w-slider>
