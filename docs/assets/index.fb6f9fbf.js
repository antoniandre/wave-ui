import{a as S}from"./index.a0a717ed.js";import{r as c,o as _,f as g,a as t,w as n,b as i,h as r,e,i as y,_ as v,bK as F,bz as L}from"./index.5f88aff1.js";const R=e("Default"),O=i("p",null,[e("By default the "),i("span",{class:"code"},"w-input"),e(` component has a label inside the input field, that moves up
...
`),G=e("Round & Tile"),K={class:"grow mb4",style:{"min-width":"200px"}},X=i("div",{class:"title4 mb2"},"Underline style (default)",-1),Q={class:"grow mb4",style:{"min-width":"200px"}},Z=i("div",{class:"title4 mb2"},"Outline style",-1),ee=e(`w-flex(wrap :gap="2")
...
a preview.`)],-1),Ke=i("p",null,`When uploading a larger file, a spinner will show up to the right of the field until
the file is completely transferred.`,-1),Xe=e("File"),Qe=e('w-input(type="file") File'),Ze=e(`<w-input type="file">File</w-input>
...
You can also show a self-updated progress bar with the `),i("code",null,"show-progress"),e(" prop.")],-1),Gn=e("File"),Kn={class:"my4"},Xn=e("Files:"),Qn={class:"ml2"},Zn=e(`w-input(type="file"
  v-model="files"
