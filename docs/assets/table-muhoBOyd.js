import{H as e,N as t,c as n,d as r,g as i,h as a,ht as o,j as s,k as c,l,m as u,r as d,u as f,vt as p}from"./runtime-core.esm-bundler-DPe36P4s.js";import{l as m}from"./runtime-dom.esm-bundler-Dtklx5Fk.js";import{t as h}from"./_plugin-vue_export-helper-S3RvzygF.js";import{s as g}from"./index-D1jKshrg.js";import{t as _}from"./chunk-NAVWDHVN-DSO01vmb.js";var v={class:`w-flex justify-end`},y={class:`w-flex align-center mb2`},b={class:`w-flex wrap mb3`},x={class:`w-flex align-center gap2 pa1`},S={class:`w-flex gap2 no-grow`},C={class:`mb0`},w={class:`mt4`},T={class:`ml2`},E={key:0},D={class:`grey mr2`},O=[`onClick`],k=[`onClick`],A=[`colspan`],j={class:`title3`},M={class:`mr2`};function N(h,g,_,N,P,F){let I=t(`title-link`),L=t(`w-table`),R=t(`example`),z=t(`w-button`),B=t(`w-icon`),V=t(`w-flex`),H=t(`ssh-pre`),U=t(`w-tag`),W=t(`w-radios`),G=t(`alert`),K=t(`w-input`);return c(),r(`div`,null,[i(I,{h2:``},{default:e(()=>[...g[12]||=[a(`Basic`,-1)]]),_:1}),g[180]||=n(`p`,null,[a(`Providing an array of items will automatically create a table row for each item.`),n(`br`),a(`
Note that the `),n(`code`,null,`class`),a(` key is used to add a custom class to the table row for easy row styling.`)],-1),i(R,null,{pug:e(()=>[...g[13]||=[a(`w-table(:headers="table.headers" :items="table.items")`,-1)]]),html:e(()=>[...g[14]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items">
</w-table>`,-1)]]),js:e(()=>[...g[15]||=[a(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table1.headers,items:P.table1.items},null,8,[`headers`,`items`])]),_:1}),i(I,{h2:``},{default:e(()=>[...g[16]||=[a(`When there is no data`,-1)]]),_:1}),g[181]||=n(`p`,null,[a(`When there is no data, a default text will be displayed. You can override it via the `),n(`code`,null,`no-data`),a(` slot.`)],-1),i(R,null,{pug:e(()=>[...g[18]||=[a(`w-table(:headers="table.headers" :items="[]")
br
w-table(:headers="table.headers" :items="[]")
  template(#no-data) 👌 There is no data! 👌`,-1)]]),html:e(()=>[...g[19]||=[a(`<w-table :headers="table.headers" :items="[]"></w-table>
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table1.headers,items:[]},null,8,[`headers`]),g[21]||=n(`br`,null,null,-1),i(L,{headers:P.table1.headers,items:[]},{"no-data":e(()=>[...g[17]||=[a(`👌 There is no data! 👌`,-1)]]),_:1},8,[`headers`])]),_:1}),i(I,{h2:``},{default:e(()=>[...g[22]||=[a(`Alignments`,-1)]]),_:1}),g[182]||=n(`p`,null,[a(`You can align the columns contents separately by adding an `),n(`code`,null,`align`),a(` key in each header
definition (`),n(`code`,null,`left`),a(`, `),n(`code`,null,`center`),a(` or `),n(`code`,null,`right`),a(`).`),n(`br`),a(`
If you don't define any, `),n(`code`,null,`left`),a(` will be implicit.
`)],-1),i(R,null,{pug:e(()=>[...g[23]||=[a(`w-table(:headers="table.headers" :items="table.items")`,-1)]]),html:e(()=>[...g[24]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items">
</w-table>`,-1)]]),js:e(()=>[...g[25]||=[a(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table2.headers,items:P.table2.items},null,8,[`headers`,`items`])]),_:1}),i(I,{h2:``,slug:`example--no-headers`},{default:e(()=>[...g[26]||=[a(`No headers`,-1)]]),_:1}),g[183]||=n(`p`,null,[a(`Even with the `),n(`code`,null,`no-headers`),a(` option, the `),n(`code`,null,`headers`),a(` are still required for various
reasons, like getting the number of columns and sorting/filtering keys.`)],-1),i(R,null,{pug:e(()=>[...g[27]||=[a(`w-table(:items="table.items" :headers="table.headers" no-headers)`,-1)]]),html:e(()=>[...g[28]||=[a(`<w-table
  :items="table.items"
  :headers="table.headers"
  no-headers>
</w-table>`,-1)]]),js:e(()=>[...g[29]||=[a(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table1.headers,items:P.table1.items,"no-headers":``},null,8,[`headers`,`items`])]),_:1}),i(I,{h2:``,slug:`example--fixed-headers`},{default:e(()=>[...g[30]||=[a(`Fixed headers`,-1)]]),_:1}),i(R,null,{pug:e(()=>[...g[31]||=[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  style="height: 250px")`,-1)]]),html:e(()=>[...g[32]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  style="height: 250px">
</w-table>`,-1)]]),js:e(()=>[...g[33]||=[a(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table3.headers,items:P.table3.items,"fixed-headers":``,style:{height:`250px`}},null,8,[`headers`,`items`])]),_:1}),i(I,{h2:``,slug:`example--footer`},{default:e(()=>[...g[34]||=[a(`Footer`,-1)]]),_:1}),i(I,{h3:``,slug:`example--footer-slot`},{default:e(()=>[...g[35]||=[a(`Footer slot`,-1)]]),_:1}),g[184]||=n(`p`,null,[a(`A table footer can be added via the `),n(`code`,null,`footer`),a(` slot. If present, the footer will span on
all the columns by default.
`)],-1),n(`div`,v,[i(z,{onClick:g[0]||=e=>P.table3.fixedFooter=!P.table3.fixedFooter,outline:!P.table3.fixedFooter,round:``},{default:e(()=>[n(`span`,{class:o([`code`,P.table3.fixedFooter?`contrast-color`:`primary`])},`fixed-footer`,2)]),_:1},8,[`outline`])]),i(R,null,{pug:e(()=>[...g[39]||=[a(`w-table(
  ref="table"
  :headers="table.headers"
  :items="table.items"
  ...
  template(#footer)
    w-flex(justify-space-between)
      ...
      div
        strong.mr2 Total:
        | `+p(`{{ table.items.length }}`)+` persons`,-1)]]),html:e(()=>[...g[40]||=[a(`<w-table
  ref="table"
  :headers="table.headers"
  :items="table.items"
  :fixed-footer="table.fixedFooter"
...
`,-1)]]),default:e(()=>[i(L,{ref:`table`,headers:P.table3.headers,items:P.table3.items,"fixed-footer":P.table3.fixedFooter,style:{height:`250px`}},{footer:e(()=>[i(V,{"justify-space-between":``},{default:e(()=>[i(z,{round:``,sm:``,onClick:F.addRow},{default:e(()=>[i(B,{class:`mr1`},{default:e(()=>[...g[36]||=[a(`wi-plus`,-1)]]),_:1}),g[37]||=a(`add person`,-1)]),_:1},8,[`onClick`]),n(`div`,null,[g[38]||=n(`strong`,{class:`mr2`},`Total:`,-1),a(p(P.table3.items.length)+` persons`,1)])]),_:1})]),_:1},8,[`headers`,`items`,`fixed-footer`])]),_:1}),i(I,{h3:``,slug:`example--footer-slot`},{default:e(()=>[...g[42]||=[a(`Footer-row slot`,-1)]]),_:1}),g[185]||=n(`p`,null,[a(`The `),n(`code`,null,`footer-row`),a(` slot will give you more flexibility as it lets you define the whole table row.`)],-1),g[186]||=n(`p`,null,`It can be useful if you want to keep the columns alignments in the footer.`,-1),i(R,null,{pug:e(()=>[...g[43]||=[a(`w-table(
  :headers="table.headers"
  no-headers
  :items="table.items"
  fixed-footer
  ...
  template(#footer-row)
    tr
      th.py1(
        ...
        | `+p(`{{ header.label }}`),-1)]]),html:e(()=>[...g[44]||=[a(`<w-table
  :headers="table.headers"
  no-headers
  :items="table.items"
  fixed-footer
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table3.headers,"no-headers":``,items:P.table3.items,"fixed-footer":P.table3.fixedFooter,style:{height:`250px`}},{"footer-row":e(()=>[n(`tr`,null,[(c(!0),r(d,null,s(P.table3.headers,(e,t)=>(c(),r(`th`,{class:o([`py1`,`${t?`px1`:`px2`} text-${e.align||`left`}`]),key:t},p(e.label),3))),128))])]),_:1},8,[`headers`,`items`,`fixed-footer`])]),_:1}),i(I,{h2:``},{default:e(()=>[...g[46]||=[a(`Built-in column resizing`,-1)]]),_:1}),g[187]||=n(`p`,null,[a(`You can resize the columns by dragging their edges left or right.`),n(`br`),a(`
If you want the whole cell content to be on a single line and truncated with the ellipsis
(`),n(`code`,null,`...`),a(`), you can apply this CSS.`)],-1),i(H,{language:`css`,dark:h.$store.state.darkMode},{default:e(()=>[...g[47]||=[a(`.w-table__cell {
  white-space: nowrap;
}
`,-1)]]),_:1},8,[`dark`]),i(R,null,{pug:e(()=>[...g[48]||=[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  resizable-columns)`,-1)]]),html:e(()=>[...g[49]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  resizable-columns>
</w-table>`,-1)]]),js:e(()=>[...g[50]||=[a(`data: () => ({
  table: {
    headers: [
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table7.headers,items:P.table7.items,"resizable-columns":``},null,8,[`headers`,`items`])]),_:1}),i(I,{h3:``},{default:e(()=>[...g[51]||=[a(`Saving the table layout in localStorage`,-1)]]),_:1}),g[188]||=n(`p`,null,[a(`In some apps, it makes sense to save the prefered table layout of the user, and reapply it
every time this table is loaded. Here is a demo of how to do so.`),n(`br`),a(`
To test it, first resize the columns, then refresh the page to see the same layout.`)],-1),i(R,null,{pug:e(()=>[...g[52]||=[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  resizable-columns
  @column-resize="onColumnResize")`,-1)]]),html:e(()=>[...g[53]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  resizable-columns
  @column-resize="onColumnResize">
</w-table>`,-1)]]),js:e(()=>[...g[54]||=[a(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id', width: '50' },
      { label: 'Content', key: 'content', width: '70%' },
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table8.headers,items:P.table8.items,"resizable-columns":``,onColumnResize:F.onColumnResize},null,8,[`headers`,`items`,`onColumnResize`])]),_:1}),i(I,{h2:``},{default:e(()=>[...g[55]||=[a(`Toggling column visibility`,-1)]]),_:1}),g[189]||=n(`p`,null,`This is completely external to Wave UI, but this example shows you a way to do it in your
code as it is a frequent use case.`,-1),i(R,null,{pug:e(()=>[a(`w-tag.ma1(
...
w-table.mt2(:headers="table.headers.filter&#40;header => !header.hidden&#41;" :items="table.items")`,1)]),html:e(()=>[...g[56]||=[a(`Toggle columns:
<w-tag
  v-for="(header, index) in table.headers"
  :key="index"
  class="ma1"
...
`,-1)]]),default:e(()=>[g[58]||=a(`Toggle columns:`,-1),(c(!0),r(d,null,s(P.table6.headers,(t,n)=>(c(),l(U,{class:`ma1`,key:n,"bg-color":t.hidden?h.$store.state.darkMode?`grey-dark4`:`grey-light4`:`primary`,onClick:m(e=>t.hidden=!t.hidden,[`stop`])},{default:e(()=>[i(B,{class:`mr2`},{default:e(()=>[a(`mdi mdi-eye`+p(t.hidden?`-off`:``),1)]),_:2},1024),a(p(t.label),1)]),_:2},1032,[`bg-color`,`onClick`]))),128)),i(L,{class:`mt2`,headers:P.table6.headers.filter(e=>!e.hidden),items:P.table6.items},null,8,[`headers`,`items`])]),_:1}),i(I,{h2:``},{default:e(()=>[...g[59]||=[a(`Sticky columns`,-1)]]),_:1}),g[190]||=n(`p`,null,[a(`To make a column sticky, you only need to add `),n(`code`,null,`sticky: true`),a(` to the header of that
column.`),n(`br`),a(`
The sticky mechanism is done via CSS (position: sticky). So if you set multiple sticky
columns, one will overlap the previous one as you scroll.`)],-1),g[191]||=n(`p`,{class:`grey`},`Scroll the table horizontally to observe the behavior.`,-1),i(R,{class:`example--sticky-columns`},{pug:e(()=>[...g[61]||=[a(`w-table(
:headers="table.headers"
:items="table.items"
fixed-layout
:fixed-headers="table.fixedHeaders"
style="max-width: 500px;height: 200px")`,-1)]]),html:e(()=>[...g[62]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-layout
  :fixed-headers="table.fixedHeaders"
  style="max-width: 500px;height: 200px">
</w-table>`,-1)]]),js:e(()=>[...g[63]||=[a(`data: () => ({
  table: {
    fixedHeaders: false,
    headers: [
...
})`,-1)]]),css:e(()=>[...g[64]||=[a(`/* This CSS is not needed. It's only to increase the scroll in the sticky columns demo. */
.w-table {white-space: nowrap;}
.w-table__header, .w-table__cell {padding-left: 20px;padding-right: 20px;}
`,-1)]]),default:e(()=>[n(`div`,y,[g[60]||=a(`Sticky columns:`,-1),i(W,{class:`ml1 mr4`,modelValue:P.table9.stickyColumn,"onUpdate:modelValue":g[1]||=e=>P.table9.stickyColumn=e,items:P.table9.stickyColumnOptions,onChange:F.toggleStickyColumn,inline:``},null,8,[`modelValue`,`items`,`onChange`]),i(z,{onClick:g[2]||=e=>P.table9.fixedHeaders=!P.table9.fixedHeaders,outline:!P.table9.fixedHeaders,round:``},{default:e(()=>[n(`span`,{class:o([`code`,P.table9.fixedHeaders?`contrast-color`:`primary`])},`fixed-headers`,2)]),_:1},8,[`outline`])]),i(L,{class:`base-color--bg`,headers:P.table9.headers,items:P.table9.items,"fixed-layout":``,"fixed-headers":P.table9.fixedHeaders,style:{"max-width":`500px`,height:`200px`}},null,8,[`headers`,`items`,`fixed-headers`])]),_:1}),i(I,{h2:``},{default:e(()=>[...g[65]||=[a(`Sorting`,-1)]]),_:1}),g[192]||=n(`p`,null,[a(`To make the sorting API very easy to use and remember (and avoid complex array or object structures),
the `),n(`strong`,{class:`code`},`w-table`),a(`'s sorting is defined with a header key string preceded by a `),n(`code`,null,`+`),a(` for ASC,
or a `),n(`code`,null,`-`),a(` for DESC. For instance, in this example: `),n(`code`,null,`'+firstName'`),a(`.
`)],-1),i(I,{h3:``},{default:e(()=>[...g[66]||=[a(`Initial Sorting`,-1)]]),_:1}),i(R,null,{pug:e(()=>[...g[67]||=[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  v-model:sort="table.sort")`,-1)]]),html:e(()=>[...g[68]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  v-model:sort="table.sort">
</w-table>`,-1)]]),js:e(()=>[...g[69]||=[a(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
})`,-1)]]),default:e(()=>[i(L,{headers:P.table1.headers,items:P.table1.items,sort:P.table1.sort,"onUpdate:sort":g[3]||=e=>P.table1.sort=e},null,8,[`headers`,`items`,`sort`])]),_:1}),i(G,{tip:``},{default:e(()=>[...g[70]||=[a(`By default any column being sorted is highlighted. You can modify the style of the whole column
with the class `,-1),n(`code`,null,`.w-table__col--highlighted`,-1),a(`.`,-1),n(`br`,null,null,-1),a(`
Also, if you try to target it in the devtools and can't find it, it's in `,-1),n(`code`,null,`table > colgroup`,-1),a(`.
`,-1)]]),_:1}),i(I,{h3:``},{default:e(()=>[...g[71]||=[a(`Asynchronous Sorting`,-1)]]),_:1}),g[193]||=n(`p`,null,[a(`When dealing with a lot of table entries, you will most likely need the sorting to be done
in the backend.`),n(`br`),a(`
For this you can use the asynchronous sorting and update the table rows from outside Wave UI.`)],-1),i(R,{"blank-codepen":[`js`]},{html:e(()=>[...g[73]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  :sort-function="sortFunction"
  :loading="table.loading"
  style="height: 140px">
</w-table>`,-1)]]),js:e(()=>[...g[74]||=[a(`// This object is simulating content coming from the server.
...
app.mount('#app')
`,-1)]]),default:e(()=>[i(L,{class:`my6`,headers:P.table10.headers,items:P.table10.items,"sort-function":F.sortFunction,loading:P.table10.loading,style:{height:`145px`}},{pug:e(()=>[...g[72]||=[a(`w-table.my6(
:headers="table.headers"
:items="table.items"
:sort-function="sortFunction"
:loading="table.loading"
style="height: 140px")`,-1)]]),_:1},8,[`headers`,`items`,`sort-function`,`loading`])]),_:1}),i(I,{h2:``},{default:e(()=>[...g[75]||=[a(`Filtering`,-1)]]),_:1}),g[194]||=n(`p`,null,[a(`Filtering the table rows is very straightforward: you only need to provide your filtering function to the
`),n(`strong`,{class:`code`},`w-table`),a(` component and it will be applied to the table.`),n(`br`),a(`
Setting the filter to `),n(`code`,null,`null`),a(` or `),n(`code`,null,`false`),a(` or `),n(`code`,null,`undefined`),a(` will remove any previous filter.`)],-1),i(R,null,{pug:e(()=>[...g[79]||=[a(`.w-flex.wrap.mb3
  w-button.mr2.mb1(
...
w-table(
  :headers="table.headers"
  :items="table.items"
  :filter="table.filters[table.activeFilter]")`,-1)]]),html:e(()=>[...g[80]||=[a(`<div class="w-flex wrap mb3">
  <w-button
    class="mr2 mb1"
    @click="table.activeFilter = 0"
    round
...
`,-1)]]),default:e(()=>[n(`div`,b,[i(z,{class:`mr2 mb1`,onClick:g[4]||=e=>P.table3.activeFilter=0,round:``,outline:P.table3.activeFilter!==0},{default:e(()=>[...g[76]||=[a(`No filter`,-1)]]),_:1},8,[`outline`]),i(z,{class:`mr2 mb1`,onClick:g[5]||=e=>P.table3.activeFilter=1,round:``,outline:P.table3.activeFilter!==1},{default:e(()=>[...g[77]||=[a(`Last name starting with 'M'`,-1)]]),_:1},8,[`outline`]),i(z,{class:`mr2 mb1`,onClick:g[6]||=e=>P.table3.activeFilter=2,round:``,outline:P.table3.activeFilter!==2},{default:e(()=>[...g[78]||=[a(`ID >= 10`,-1)]]),_:1},8,[`outline`])]),i(L,{headers:P.table3.headers,items:P.table3.items,filter:P.table3.filters[P.table3.activeFilter]},null,8,[`headers`,`items`,`filter`])]),_:1}),i(I,{h3:``},{default:e(()=>[...g[82]||=[a(`Global filter`,-1)]]),_:1}),g[195]||=n(`p`,null,[a(`You could also apply a filter globally, which looks into all the columns at once.`),n(`br`),a(`
Here is one cool way to do it.`)],-1),i(R,null,{pug:e(()=>[...g[83]||=[a(`w-input.mb3(
...
w-table(
  :headers="table.headers"
  :items="table.items"
  :filter="table.keywordFilter&#40;table.keyword&#41;")`,-1)]]),html:e(()=>[...g[84]||=[a(`<w-input
  v-model="table.keyword"
  placeholder="Search anything..."
  inner-icon-left="wi-search"
  class="mb3">
...
})`,-1)]]),default:e(()=>[i(K,{class:`mb3`,modelValue:P.table4.keyword,"onUpdate:modelValue":g[7]||=e=>P.table4.keyword=e,placeholder:`Search anything...`,"inner-icon-left":`wi-search`},null,8,[`modelValue`]),i(L,{headers:P.table4.headers,items:P.table4.items,filter:P.table4.keywordFilter(P.table4.keyword)},null,8,[`headers`,`items`,`filter`])]),_:1}),i(G,{tip:``},{default:e(()=>[g[87]||=n(`strong`,null,[a(`If you don't need the RegExp power, you can simply return
`),n(`code`,null,`allTheColumns.toLowerCase().includes(keyword)`),a(` instead.
`)],-1),g[88]||=n(`br`,null,null,-1),g[89]||=n(`br`,null,null,-1),g[90]||=a(`But the real power of using a regular expression
`,-1),i(B,{class:`red mr1`,size:`0.9em`},{default:e(()=>[...g[86]||=[a(`mdi mdi-heart`,-1)]]),_:1}),g[91]||=a(` in this example's match, is that the user
can benefit from the Regexp engine and use interpreted characters like `,-1),g[92]||=n(`code`,null,`|`,-1),g[93]||=a(` etc.`,-1),g[94]||=n(`br`,null,null,-1),g[95]||=a(`
You could also match only the full words by replacing `,-1),g[96]||=n(`code`,null,`new RegExp(keyword, 'i')`,-1),g[97]||=a(` with
`,-1),g[98]||=n(`code`,null,"new RegExp(`\\\\b${keyword}\\\\b`, 'i')",-1),g[99]||=a(` (it would return a result when typing `,-1),g[100]||=n(`code`,null,`floretta`,-1),g[101]||=a(`
but not `,-1),g[102]||=n(`code`,null,`florett`,-1),g[103]||=a(` for instance).`,-1)]),_:1}),i(I,{h2:``},{default:e(()=>[...g[104]||=[a(`Loading state`,-1)]]),_:1}),g[196]||=n(`p`,null,[a(`When the table content is not ready straight away, you can use the `),n(`code`,null,`loading`),a(` prop to display
a progress bar while loading.`)],-1),i(z,{class:`mb2`,disabled:!!P.table1.loading,onClick:F.reload},{default:e(()=>[i(B,{class:`mr1`},{default:e(()=>[...g[105]||=[a(`mdi mdi-sync`,-1)]]),_:1}),g[106]||=a(`reload`,-1)]),_:1},8,[`disabled`,`onClick`]),i(I,{h3:``},{default:e(()=>[...g[107]||=[a(`Simple table - no set height`,-1)]]),_:1}),i(R,{style:{height:`170px`}},{pug:e(()=>[...g[108]||=[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  :loading="loading")`,-1)]]),html:e(()=>[...g[109]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  :loading="loading">
</w-table>`,-1)]]),js:e(()=>[...g[110]||=[a(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table1.headers,items:P.table1.items,loading:P.table1.loading},null,8,[`headers`,`items`,`loading`])]),_:1}),i(I,{h3:``,slug:`loading-with-fixed-header`},{default:e(()=>[...g[111]||=[a(`Table with fixed header & set height of 200px`,-1)]]),_:1}),i(R,null,{pug:e(()=>[...g[112]||=[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  :loading="loading"
  style="height: 200px")`,-1)]]),html:e(()=>[...g[113]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  :loading="loading"
  style="height: 200px">
</w-table>`,-1)]]),js:e(()=>[...g[114]||=[a(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table1.headers,items:P.table3.items,"fixed-headers":``,loading:P.table1.loading,style:{height:`200px`}},null,8,[`headers`,`items`,`loading`])]),_:1}),i(I,{h2:``},{default:e(()=>[...g[115]||=[a(`Pagination`,-1)]]),_:1}),g[197]||=n(`p`,null,`The pagination can be provided as an object:`,-1),i(H,{language:`js`},{default:e(()=>[...g[116]||=[a(`{
...
</p>`,3),i(I,{h3:``},{default:e(()=>[...g[117]||=[a(`Client-side pagination`,-1)]]),_:1}),i(R,{"blank-codepen":[`js`]},{pug:e(()=>[...g[118]||=[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
  :pagination="table.pagination"
  style="max-height: 500px")`,-1)]]),html:e(()=>[...g[119]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
...
</w-table>`,-1)]]),js:e(()=>[...g[120]||=[a(`// import { faker } from '@faker-js/faker' // With npm.
...
app.mount('#app')
`,-1)]]),default:e(()=>[i(L,{headers:P.table11.headers,items:P.table11.items,"fixed-headers":``,"fixed-footer":``,pagination:P.table11.pagination,style:{"max-height":`500px`}},null,8,[`headers`,`items`,`pagination`])]),_:1}),i(I,{h3:``},{default:e(()=>[...g[121]||=[a(`Server-side pagination`,-1)]]),_:1}),g[199]||=n(`p`,null,`This example showcases an asynchronous pagination with backend fetching of the table items.`,-1),i(R,{"blank-codepen":[`js`]},{pug:e(()=>[...g[122]||=[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
  ...
  :pagination="table.pagination"
  :loading="table.loading"
  style="max-height: 500px")`,-1)]]),html:e(()=>[...g[123]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
  ...
  :loading="table.loading"
  style="max-height: 500px">
</w-table>`,-1)]]),js:e(()=>[...g[124]||=[a(`// import { faker } from '@faker-js/faker' // With npm.
import { faker } from 'https://cdn.skypack.dev/@faker-js/faker'
...
app.mount('#app')
`,-1)]]),default:e(()=>[i(L,{headers:P.table12.headers,items:P.table12.items,"fixed-headers":``,"fixed-footer":``,fetch:P.table12.fetch,pagination:P.table12.pagination,loading:P.table12.loading,style:{"max-height":`500px`}},null,8,[`headers`,`items`,`fetch`,`pagination`,`loading`])]),_:1}),i(I,{h3:``},{default:e(()=>[...g[125]||=[a(`Custom pagination layout`,-1)]]),_:1}),g[200]||=n(`p`,null,[a(`More details about the pagination slot in the `),n(`a`,{href:`#pagination-slot`},`API section`),a(`.`)],-1),i(R,{"blank-codepen":[`js`]},{pug:e(()=>[...g[126]||=[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
    ...
    .w-flex.align-center.gap2.pa1
      .w-flex.gap2.no-grow
        ...
        w-button(
          ...
          xs)
      p `+p(`{{ range }}`)+` of `+p(`{{ total }}`)+`.`,-1)]]),html:e(()=>[...g[127]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
...
</w-table>`,-1)]]),js:e(()=>[...g[128]||=[a(`// import { faker } from '@faker-js/faker' // With npm.
import { faker } from 'https://cdn.skypack.dev/@faker-js/faker'
...
app.mount('#app')
`,-1)]]),default:e(()=>[i(L,{headers:P.table11.headers,items:P.table11.items,"fixed-headers":``,"fixed-footer":``,pagination:P.table11.pagination,style:{"max-height":`500px`}},{pagination:e(({range:t,total:o,page:u,pagesCount:f,goToPage:m})=>[n(`div`,x,[n(`div`,S,[i(z,{onClick:e=>m(`-1`),disabled:u===1,icon:`wi-chevron-left`,xs:``},null,8,[`onClick`,`disabled`]),(c(!0),r(d,null,s(f,t=>(c(),l(z,{key:t,onClick:e=>t!==u&&m(t),outline:u===t,round:``,xs:``},{default:e(()=>[a(p(t),1)]),_:2},1032,[`onClick`,`outline`]))),128)),i(z,{onClick:e=>m(`+1`),disabled:u===f,icon:`wi-chevron-right`,xs:``},null,8,[`onClick`,`disabled`])]),n(`p`,C,p(t)+` of `+p(o)+`.`,1)])]),_:1},8,[`headers`,`items`,`pagination`])]),_:1}),i(I,{h3:``},{default:e(()=>[...g[129]||=[a(`Initing the pagination with a certain state`,-1)]]),_:1}),i(R,{"blank-codepen":[`js`]},{pug:e(()=>[...g[130]||=[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
  ...
  :pagination="table.pagination"
  :loading="table.loading"
  style="max-height: 500px")`,-1)]]),html:e(()=>[...g[131]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
  ...
  :loading="table.loading"
  style="max-height: 500px">
</w-table>`,-1)]]),js:e(()=>[...g[132]||=[a(`// import { faker } from '@faker-js/faker' // With npm.
import { faker } from 'https://cdn.skypack.dev/@faker-js/faker'
...
app.mount('#app')
`,-1)]]),default:e(()=>[i(L,{headers:P.table13.headers,items:P.table13.items,"fixed-headers":``,"fixed-footer":``,fetch:P.table13.fetch,pagination:P.table13.pagination,loading:P.table13.loading,style:{"max-height":`500px`}},null,8,[`headers`,`items`,`fetch`,`pagination`,`loading`])]),_:1}),i(I,{h2:``},{default:e(()=>[...g[133]||=[a(`Rows selection`,-1)]]),_:1}),g[201]||=n(`p`,null,`Click a row to see it highlighted and get information about the selected item.`,-1),g[202]||=n(`p`,null,[a(`By default, the selection will use the `),n(`code`,null,`primary`),a(` color and apply an opacity of `),n(`code`,null,`0.2`),a(`.
If this is not what you want, you can override it via CSS (`),n(`code`,null,`.w-table__row--selected td:before`),a(`).
`)],-1),i(I,{h3:``,slug:`example--selectable-rows`},{default:e(()=>[...g[134]||=[a(`The `,-1),n(`span`,{class:`code`},`selectable-rows`,-1),a(` prop`,-1)]]),_:1}),g[203]||=n(`p`,null,[a(`You can enable the rows selection by adding the `),n(`code`,null,`selectable-rows`),a(` prop, or disable it by
removing it (by default) - and this is the same as passing a boolean - but you can also set it to `),n(`code`,null,`1`),a(`
to allow a single selection only.
`)],-1),i(I,{h3:``,slug:`example--force-selection`},{default:e(()=>[...g[135]||=[a(`The `,-1),n(`span`,{class:`code`},`force-selection`,-1),a(` prop`,-1)]]),_:1}),g[204]||=n(`p`,null,[a(`Eventually, you can use the `),n(`code`,null,`force-selection`),a(` prop to prevent unselecting a row when only
one remain selected.
`)],-1),i(I,{h3:``,slug:`example--row-select`},{default:e(()=>[...g[136]||=[a(`The `,-1),n(`span`,{class:`code`},`@row-select`,-1),a(` event`,-1)]]),_:1}),g[205]||=u(`<p>This event is fired each time a row is selected <strong>or unselected</strong> (so you don&#39;t need to listen
...
information such as:</p><ul><li><code>item</code>: the clicked row object</li><li><code>selected</code>: a boolean telling if the row is being selected or unselected</li><li><code>selectedRows</code>: an array of all the selected rows objects</li></ul>`,2),i(R,null,{pug:e(()=>[...g[139]||=[a(`w-flex.mb4(wrap)
...
pre `+p(`{{ selectionInfo }}`),-1)]]),html:e(()=>[...g[140]||=[a(`<w-flex wrap class="mb4">
  <w-radios
...
<pre>`+p(`{{ selectionInfo }}`)+`</pre>`,-1)]]),js:e(()=>[...g[141]||=[a(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)]]),default:e(()=>[i(V,{class:`mb4`,wrap:``},{default:e(()=>[i(W,{class:`mr6`,modelValue:P.table1.selectableRows,"onUpdate:modelValue":g[8]||=e=>P.table1.selectableRows=e,items:P.selectableRowsOptions},null,8,[`modelValue`,`items`]),i(z,{class:`my3`,onClick:g[9]||=e=>P.table1.forceSelection=!P.table1.forceSelection,round:``,outline:!P.table1.forceSelection},{default:e(()=>[P.table1.forceSelection?(c(),l(B,{key:0,class:`mr2`},{default:e(()=>[...g[137]||=[a(`wi-check`,-1)]]),_:1})):f(``,!0),g[138]||=a(`Force selection`,-1)]),_:1},8,[`outline`])]),_:1}),i(L,{headers:P.table1.headers,items:P.table1.items,"selectable-rows":P.table1.selectableRows,"force-selection":P.table1.forceSelection,onRowSelect:g[10]||=e=>P.selectionInfo=e},null,8,[`headers`,`items`,`selectable-rows`,`force-selection`]),g[142]||=n(`div`,{class:`mt4 title4`},`Selection info:`,-1),n(`pre`,null,p(P.selectionInfo),1)]),_:1}),i(I,{h3:``},{default:e(()=>[...g[143]||=[a(`Updating the selected rows programmatically`,-1)]]),_:1}),g[206]||=n(`p`,null,`Wave UI offers a convenient way to provide an array of selected rows and keeping your array in sync
with the selected rows after user interaction.`,-1),i(G,{tip:``},{default:e(()=>[...g[144]||=[n(`ul`,null,[n(`li`,null,[n(`strong`,null,`In Vue 2`),a(`, you can do 2-way binding on any variable other than the `),n(`strong`,{class:`code`},`v-model`),a(` using the `),n(`code`,null,`.sync`),a(` modifier.`)]),n(`li`,null,[n(`strong`,null,`In Vue 3`),a(`, multiple `),n(`strong`,{class:`code`},`v-model`),a(` are supported in order to achieve 2-way binding. So you don't need `),n(`code`,null,`.sync`),a(`.`)])],-1)]]),_:1}),i(R,null,{pug:e(()=>[...g[146]||=[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  selectable-rows
...
.mt4
  | Selected rows:
  code.ml2 `+p(`{{ table.selectedRows }}`),-1)]]),html:e(()=>[...g[147]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  selectable-rows
  v-model:selected-rows="table.selectedRows">
...
})`,-1)]]),default:e(()=>[i(L,{headers:P.table1.headers,items:P.table1.items,"selectable-rows":``,"selected-rows":P.table1.selectedRows,"onUpdate:selectedRows":g[11]||=e=>P.table1.selectedRows=e},null,8,[`headers`,`items`,`selected-rows`]),n(`div`,w,[g[145]||=a(`Selected rows:`,-1),n(`code`,T,p(P.table1.selectedRows),1)])]),_:1}),i(G,{info:``},{default:e(()=>[...g[149]||=[a(`In order to keep the same row selected after sorting or filtering, each row is assigned a unique identifier.`,-1),n(`br`,null,null,-1),a(`
By default the expanded rows array will use an `,-1),n(`code`,null,`id`,-1),a(` key, if present in the item object,
...
the `,-1),n(`code`,null,`uid-key`,-1),a(` prop, which is set to "id" by default.
`,-1)]]),_:1}),i(I,{h2:``,slug:`example--expandable-rows`},{default:e(()=>[...g[150]||=[a(`Expandable rows`,-1)]]),_:1}),i(G,{warning:``},{default:e(()=>[...g[151]||=[a(`This feature is in progress.`,-1)]]),_:1}),i(R,null,{pug:e(()=>[...g[154]||=[a(`w-table(:headers="table.headers" :items="table.items" expandable-rows)
  template(#row-expansion="{ item }")
    w-icon.mr2(:color="['blue', 'pink'][item.gender]")
      | mdi `+p(`{{ ['mdi-gender-male', 'mdi-gender-female'][item.gender] }}`)+`
    | `+p(`{{ item.firstName }}`)+` weighs `,-1),n(`strong`,null,p(`{{ item.weight }}`)+`kg`,-1),a(` and is `,-1),n(`strong`,null,p(`{{ item.height }}`)+`m`,-1),a(` tall.`,-1)]]),html:e(()=>[...g[155]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  expandable-rows>
  <template #row-expansion="{ item }">
    ...
    `+p(`{{ item.firstName }}`)+` weighs `,-1),n(`strong`,null,p(`{{ item.weight }}`)+`kg`,-1),a(` and is `,-1),n(`strong`,null,p(`{{ item.height }}`)+`m`,-1),a(` tall.
  </template>
</w-table>`,-1)]]),js:e(()=>[...g[156]||=[a(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table5.headers,items:P.table5.items,"expandable-rows":``},{"row-expansion":e(({item:t})=>[i(B,{class:`mr2`,color:[`blue`,`pink`][t.gender]},{default:e(()=>[a(`mdi `+p([`mdi-gender-male`,`mdi-gender-female`][t.gender]),1)]),_:2},1032,[`color`]),a(p(t.firstName)+` weighs `,1),n(`strong`,null,p(t.weight)+`kg`,1),g[152]||=a(` and is `,-1),n(`strong`,null,p(t.height)+`m`,1),g[153]||=a(` tall.`,-1)]),_:1},8,[`headers`,`items`])]),_:1}),i(I,{h2:``,slug:`slots`},{default:e(()=>[...g[157]||=[a(`Headers & cells customization via slots`,-1)]]),_:1}),g[207]||=n(`p`,null,`You can customize the headers labels and/or each row cells.`,-1),i(I,{h3:``},{default:e(()=>[...g[158]||=[a(`Headers`,-1)]]),_:1}),g[208]||=n(`p`,null,[a(`In this example, only the headers are customized via the `),n(`code`,null,`header-label`),a(` slot.`)],-1),i(R,null,{pug:e(()=>[...g[159]||=[a(`w-table(:headers="table.headers" :items="table.items")
  template(#header-label="{ label, index }") `+p(`{{ index }}: {{ label }}`)+` 👌`,-1)]]),html:e(()=>[...g[160]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items">
  <template #header-label="{ label, index }">
    `+p(`{{ index }}: {{ label }}`)+` 👌
  </template>
</w-table>`,-1)]]),js:e(()=>[...g[161]||=[a(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table1.headers,items:P.table1.items},{"header-label":e(({label:e,index:t})=>[a(p(t)+`: `+p(e)+` 👌`,1)]),_:1},8,[`headers`,`items`])]),_:1}),i(I,{h3:``,slug:`item-cells`},{default:e(()=>[...g[162]||=[a(`Item cells (inside <td> element)`,-1)]]),_:1}),g[209]||=n(`p`,null,[a(`In this example, only the items cells are customized via the `),n(`code`,null,`item`),a(` slot
(and the headers are hidden).`)],-1),i(R,null,{pug:e(()=>[...g[163]||=[a(`w-table(:headers="table.headers" no-headers :items="table.items")
  template(#item-cell="{ item, label, header, index }")
    small.grey.mr2 `+p(`{{ header.label }}`)+`:
    span `+p(`{{ label }}`),-1)]]),html:e(()=>[...g[164]||=[a(`<w-table
  :headers="table.headers"
  no-headers
  :items="table.items">
  <template #item-cell="{ item, label, header, index }">
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table1.headers,"no-headers":``,items:P.table1.items},{"item-cell":e(({item:e,label:t,header:i,index:a})=>[i.key===`id`?(c(),r(`small`,E,`#`+p(a),1)):(c(),r(d,{key:1},[n(`small`,D,p(i.label)+`:`,1),n(`span`,null,p(t),1)],64))]),_:1},8,[`headers`,`items`])]),_:1}),i(I,{h3:``,slug:`override-1-particular-item-cell`},{default:e(()=>[...g[166]||=[a(`override 1 particular item cell or column cells (inside <td> element)`,-1)]]),_:1}),g[210]||=u(`<p>If you only need to override 1 particular column you can do it via the <code>item-cell.xxx</code> slot,
...
where <code>i</code> is a an integer starting at 1.</p>`,1),i(R,null,{pug:e(()=>[a(`w-table(:headers="table.headers" :items="table.items" no-headers)
  template(#item-cell.id="{ item, label, header, index }")
    div.px2.text-center.`+p(h.$store.state.darkMode?`green-dark5--bg`:`green-light5--bg`)+`.text-bold `+p(`{{ label }}`),1)]),html:e(()=>[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  no-headers>
  <template #item-cell.id="{ item, label, header, index }">
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table1.headers,items:P.table1.items,"no-headers":``},{"item-cell.id":e(({item:e,label:t,header:r,index:i})=>[n(`div`,{class:o([`px2 text-center text-bold`,h.$store.state.darkMode?`green-dark5--bg`:`green-light5--bg`])},p(t),3)]),_:1},8,[`headers`,`items`])]),_:1}),i(I,{h2:``,slug:`full-custom-rows`},{default:e(()=>[...g[168]||=[a(`Full custom row (<tr> element itself)`,-1)]]),_:1}),g[211]||=n(`p`,null,[a(`In this example, the full <tr> DOM element is customized, so you can add your own classes
and full layout.`),n(`br`),a(`
As you notice, the `),n(`code`,null,`item`),a(` slot gives you full flexibility, but the drawback is that's more
code to write.`)],-1),i(R,null,{pug:e(()=>[...g[169]||=[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  selectable-rows)
  template(#item="{ item, index, select, classes }")
    tr(:class="classes" @click="select")
      td(
        ...
        | `+p(`{{ item[header.key] || '' }}`),-1)]]),html:e(()=>[...g[170]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  selectable-rows>
  <template #item="{ item, index, select, classes }">
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table1.headers,items:P.table1.items,"selectable-rows":``},{item:e(({item:e,index:t,select:i,classes:a})=>[n(`tr`,{class:o(a),onClick:i},[(c(!0),r(d,null,s(P.table1.headers,(t,n)=>(c(),r(`td`,{key:n,class:o(`pa4 text-${t.align||`left`}`)},p(e[t.key]||``),3))),128))],10,O)]),_:1},8,[`headers`,`items`])]),_:1}),i(I,{h3:``,slug:`colspan-on-td`},{default:e(()=>[...g[172]||=[n(`span`,{class:`code`},`colspan`,-1),a(` on <td>`,-1)]]),_:1}),g[212]||=n(`p`,null,[a(`This example is showcasing another useful case: handling a colspan attribute.`),n(`br`),a(`
All the cells of all the rows are `),n(`code`,null,`colspan`),a(`'d to one, and a custom row layout is applied.`)],-1),i(R,null,{pug:e(()=>[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  no-headers
  selectable-rows)
      ...
      td.pa2(:colspan="table.headers.length")
        ...
        ul
          li(v-for="(header, i) in table.headers" :key="i")
            ...
            | `+p(`{{ item[header.key] || '' }}`),1)]),html:e(()=>[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  no-headers
  selectable-rows>
...
`,-1)]]),default:e(()=>[i(L,{headers:P.table1.headers,items:P.table1.items,"no-headers":``,"selectable-rows":``},{item:e(({item:e,index:t,select:i,classes:l})=>[n(`tr`,{class:o({...l,[`indigo-${h.$store.state.darkMode?`dark`:`light`}5--bg`]:t%2,[`blue-${h.$store.state.darkMode?`dark`:`light`}5--bg`]:!(t%2)}),onClick:i},[n(`td`,{class:`pa2`,colspan:P.table1.headers.length},[n(`div`,j,`Row #`+p(t),1),n(`ul`,null,[(c(!0),r(d,null,s(P.table1.headers,(t,i)=>(c(),r(`li`,{key:i},[n(`strong`,M,p(t.label)+`:`,1),a(p(e[t.key]||``),1)]))),128))])],8,A)],10,k)]),_:1},8,[`headers`,`items`])]),_:1}),i(I,{h2:``},{default:e(()=>[...g[174]||=[a(`Responsiveness & mobile layout`,-1)]]),_:1}),g[213]||=n(`p`,null,[a(`In addition to the full responsiveness, the `),n(`code`,null,`w-table`),a(` can be presented in a mobile friendly layout,
if the data it contains would not fit on mobile.`),n(`br`),a(`
You can decide to trigger the mobile layout or not on each table, individually, via the `),n(`code`,null,`mobile-breakpoint`),a(`
parameter.`),n(`br`),a(`
It can be very useful when multiple tables of data are presented, with more or less content, which
should be displayed differently.`),n(`br`),n(`br`),a(`
For this example, resize your browser to 700px or less to trigger the mobile layout.
`)],-1),i(R,null,{pug:e(()=>[...g[175]||=[a(`w-table(
  :headers="table.headers"
  :items="table.items"
  :mobile-breakpoint="700")`,-1)]]),html:e(()=>[...g[176]||=[a(`<w-table
  :headers="table.headers"
  :items="table.items"
  :mobile-breakpoint="700">
</w-table>`,-1)]]),js:e(()=>[...g[177]||=[a(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName', align: 'center' },
