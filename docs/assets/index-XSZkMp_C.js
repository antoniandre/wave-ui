import{f as D}from"./chunk-KZPPZA2C-BtqgzDBU.js";import{r as g,g as c,o as p,a as l,b as n,h as E,w as a,e as t,n as v,t as s,F as R,k as L,c as A,l as H,d as W,_ as B,a8 as P}from"./index-DyPyadtc.js";const K={class:"w-flex justify-end"},O={class:"w-flex align-center mb2"},U={class:"w-flex wrap mb3"},J={class:"w-flex align-center gap2 pa1"},Y={class:"w-flex gap2 no-grow"},G={class:"mb0"},X={class:"mt4"},Q={class:"ml2"},Z={key:0},$={class:"grey mr2"},_=["onClick"],ee=["onClick"],te=["colspan"],ae={class:"title3"},ne={class:"mr2"};function le(d,e,y,F,i,u){const r=g("title-link"),o=g("w-table"),b=g("example"),f=g("w-button"),I=g("w-icon"),M=g("w-flex"),T=g("ssh-pre"),q=g("w-tag"),j=g("w-radios"),S=g("alert"),z=g("w-input");return p(),c("div",null,[l(r,{h2:""},{default:a(()=>e[12]||(e[12]=[t("Basic",-1)])),_:1,__:[12]}),e[180]||(e[180]=n("p",null,[t("Providing an array of items will automatically create a table row for each item."),n("br"),t(`
Note that the `),n("code",null,"class"),t(" key is used to add a custom class to the table row for easy row styling.")],-1)),l(b,null,{pug:a(()=>e[13]||(e[13]=[t('w-table(:headers="table.headers" :items="table.items")',-1)])),html:a(()=>e[14]||(e[14]=[t(`<w-table
  :headers="table.headers"
  :items="table.items">
</w-table>`,-1)])),js:a(()=>e[15]||(e[15]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
...
`,-1)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table1.items},null,8,["headers","items"])]),_:1}),l(r,{h2:""},{default:a(()=>e[16]||(e[16]=[t("When there is no data",-1)])),_:1,__:[16]}),e[181]||(e[181]=n("p",null,[t("When there is no data, a default text will be displayed. You can override it via the "),n("code",null,"no-data"),t(" slot.")],-1)),l(b,null,{pug:a(()=>e[18]||(e[18]=[t(`w-table(:headers="table.headers" :items="[]")
br
w-table(:headers="table.headers" :items="[]")
  template(#no-data) 👌 There is no data! 👌`,-1)])),html:a(()=>e[19]||(e[19]=[t(`<w-table :headers="table.headers" :items="[]"></w-table>
...
</w-table>`,-1)])),js:a(()=>e[20]||(e[20]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)])),default:a(()=>[l(o,{headers:i.table1.headers,items:[]},null,8,["headers"]),e[21]||(e[21]=n("br",null,null,-1)),l(o,{headers:i.table1.headers,items:[]},{"no-data":a(()=>e[17]||(e[17]=[t("👌 There is no data! 👌",-1)])),_:1},8,["headers"])]),_:1,__:[21]}),l(r,{h2:""},{default:a(()=>e[22]||(e[22]=[t("Alignments",-1)])),_:1,__:[22]}),e[182]||(e[182]=n("p",null,[t("You can align the columns contents separately by adding an "),n("code",null,"align"),t(` key in each header
...
`)],-1)),l(b,null,{pug:a(()=>e[23]||(e[23]=[t('w-table(:headers="table.headers" :items="table.items")',-1)])),html:a(()=>e[24]||(e[24]=[t(`<w-table
  :headers="table.headers"
  :items="table.items">
</w-table>`,-1)])),js:a(()=>e[25]||(e[25]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
...
`,-1)])),default:a(()=>[l(o,{headers:i.table2.headers,items:i.table2.items},null,8,["headers","items"])]),_:1}),l(r,{h2:"",slug:"example--no-headers"},{default:a(()=>e[26]||(e[26]=[t("No headers",-1)])),_:1,__:[26]}),e[183]||(e[183]=n("p",null,[t("Even with the "),n("code",null,"no-headers"),t(" option, the "),n("code",null,"headers"),t(` are still required for various
reasons, like getting the number of columns and sorting/filtering keys.`)],-1)),l(b,null,{pug:a(()=>e[27]||(e[27]=[t('w-table(:items="table.items" :headers="table.headers" no-headers)',-1)])),html:a(()=>e[28]||(e[28]=[t(`<w-table
  :items="table.items"
  :headers="table.headers"
  no-headers>
</w-table>`,-1)])),js:a(()=>e[29]||(e[29]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table1.items,"no-headers":""},null,8,["headers","items"])]),_:1}),l(r,{h2:"",slug:"example--fixed-headers"},{default:a(()=>e[30]||(e[30]=[t("Fixed headers",-1)])),_:1,__:[30]}),l(b,null,{pug:a(()=>e[31]||(e[31]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  style="height: 250px")`,-1)])),html:a(()=>e[32]||(e[32]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  style="height: 250px">
</w-table>`,-1)])),js:a(()=>e[33]||(e[33]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)])),default:a(()=>[l(o,{headers:i.table3.headers,items:i.table3.items,"fixed-headers":"",style:{height:"250px"}},null,8,["headers","items"])]),_:1}),l(r,{h2:"",slug:"example--footer"},{default:a(()=>e[34]||(e[34]=[t("Footer",-1)])),_:1,__:[34]}),l(r,{h3:"",slug:"example--footer-slot"},{default:a(()=>e[35]||(e[35]=[t("Footer slot",-1)])),_:1,__:[35]}),e[184]||(e[184]=n("p",null,[t("A table footer can be added via the "),n("code",null,"footer"),t(` slot. If present, the footer will span on
...
`)],-1)),n("div",K,[l(f,{onClick:e[0]||(e[0]=m=>i.table3.fixedFooter=!i.table3.fixedFooter),outline:!i.table3.fixedFooter,round:""},{default:a(()=>[n("span",{class:v(["code",i.table3.fixedFooter?"contrast-color":"primary"])},"fixed-footer",2)]),_:1},8,["outline"])]),l(b,null,{pug:a(()=>e[39]||(e[39]=[t(`w-table(
  ...
  template(#footer)
    w-flex(justify-space-between)
      ...
      div
        strong.mr2 Total:
        | `+s("{{ table.items.length }}")+" persons",-1)])),html:a(()=>e[40]||(e[40]=[t(`<w-table
  ref="table"
  :headers="table.headers"
  :items="table.items"
  :fixed-footer="table.fixedFooter"
...
</w-table>`,-1)])),js:a(()=>e[41]||(e[41]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)])),default:a(()=>[l(o,{ref:"table",headers:i.table3.headers,items:i.table3.items,"fixed-footer":i.table3.fixedFooter,style:{height:"250px"}},{footer:a(()=>[l(M,{"justify-space-between":""},{default:a(()=>[l(f,{round:"",sm:"",onClick:u.addRow},{default:a(()=>[l(I,{class:"mr1"},{default:a(()=>e[36]||(e[36]=[t("wi-plus",-1)])),_:1,__:[36]}),e[37]||(e[37]=t("add person",-1))]),_:1,__:[37]},8,["onClick"]),n("div",null,[e[38]||(e[38]=n("strong",{class:"mr2"},"Total:",-1)),t(s(i.table3.items.length)+" persons",1)])]),_:1})]),_:1},8,["headers","items","fixed-footer"])]),_:1}),l(r,{h3:"",slug:"example--footer-slot"},{default:a(()=>e[42]||(e[42]=[t("Footer-row slot",-1)])),_:1,__:[42]}),e[185]||(e[185]=n("p",null,[t("The "),n("code",null,"footer-row"),t(" slot will give you more flexibility as it lets you define the whole table row.")],-1)),e[186]||(e[186]=n("p",null,"It can be useful if you want to keep the columns alignments in the footer.",-1)),l(b,null,{pug:a(()=>e[43]||(e[43]=[t(`w-table(
  :headers="table.headers"
  no-headers
  :items="table.items"
  fixed-footer
  ...
  template(#footer-row)
    tr
      th.py1(
        ...
        | `+s("{{ header.label }}"),-1)])),html:a(()=>e[44]||(e[44]=[t(`<w-table
  :headers="table.headers"
  no-headers
  :items="table.items"
  fixed-footer
...
</w-table>`,-1)])),js:a(()=>e[45]||(e[45]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)])),_:1,__:[47]},8,["dark"]),l(b,null,{pug:a(()=>e[48]||(e[48]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  resizable-columns)`,-1)])),html:a(()=>e[49]||(e[49]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  resizable-columns>
</w-table>`,-1)])),js:a(()=>e[50]||(e[50]=[t(`data: () => ({
  table: {
    headers: [
...
`,-1)])),default:a(()=>[l(o,{headers:i.table7.headers,items:i.table7.items,"resizable-columns":""},null,8,["headers","items"])]),_:1}),l(r,{h3:""},{default:a(()=>e[51]||(e[51]=[t("Saving the table layout in localStorage",-1)])),_:1,__:[51]}),e[188]||(e[188]=n("p",null,[t(`In some apps, it makes sense to save the prefered table layout of the user, and reapply it
...
To test it, first resize the columns, then refresh the page to see the same layout.`)],-1)),l(b,null,{pug:a(()=>e[52]||(e[52]=[t(`w-table(
  ...
  :items="table.items"
  resizable-columns
  @column-resize="onColumnResize")`,-1)])),html:a(()=>e[53]||(e[53]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  resizable-columns
  @column-resize="onColumnResize">
</w-table>`,-1)])),js:a(()=>e[54]||(e[54]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id', width: '50' },
      { label: 'Content', key: 'content', width: '70%' },
...
`,-1)])),default:a(()=>[l(o,{headers:i.table8.headers,items:i.table8.items,"resizable-columns":"",onColumnResize:u.onColumnResize},null,8,["headers","items","onColumnResize"])]),_:1}),l(r,{h2:""},{default:a(()=>e[55]||(e[55]=[t("Toggling column visibility",-1)])),_:1,__:[55]}),e[189]||(e[189]=n("p",null,`This is completely external to Wave UI, but this example shows you a way to do it in your
...
<w-table
  ...
  :items="table.items"
  class="mt2">
</w-table>`,-1)])),js:a(()=>e[57]||(e[57]=[t(`data: () => ({
  table: {
    headers: [
...
`,-1)])),default:a(()=>[e[58]||(e[58]=t("Toggle columns:",-1)),(p(!0),c(R,null,L(i.table6.headers,(m,h)=>(p(),A(q,{class:"ma1",key:h,"bg-color":m.hidden?d.$store.state.darkMode?"grey-dark4":"grey-light4":"primary",onClick:H(N=>m.hidden=!m.hidden,["stop"])},{default:a(()=>[l(I,{class:"mr2"},{default:a(()=>[t("mdi mdi-eye"+s(m.hidden?"-off":""),1)]),_:2},1024),t(s(m.label),1)]),_:2},1032,["bg-color","onClick"]))),128)),l(o,{class:"mt2",headers:i.table6.headers.filter(m=>!m.hidden),items:i.table6.items},null,8,["headers","items"])]),_:1,__:[58]}),l(r,{h2:""},{default:a(()=>e[59]||(e[59]=[t("Sticky columns",-1)])),_:1,__:[59]}),e[190]||(e[190]=n("p",null,[t("To make a column sticky, you only need to add "),n("code",null,"sticky: true"),t(` to the header of that
column.`),n("br"),t(`
The sticky mechanism is done via CSS (position: sticky). So if you set multiple sticky
columns, one will overlap the previous one as you scroll.`)],-1)),e[191]||(e[191]=n("p",{class:"grey"},"Scroll the table horizontally to observe the behavior.",-1)),l(b,{class:"example--sticky-columns"},{pug:a(()=>e[61]||(e[61]=[t(`w-table(
:headers="table.headers"
:items="table.items"
fixed-layout
:fixed-headers="table.fixedHeaders"
style="max-width: 500px;height: 200px")`,-1)])),html:a(()=>e[62]||(e[62]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-layout
  :fixed-headers="table.fixedHeaders"
  style="max-width: 500px;height: 200px">
</w-table>`,-1)])),js:a(()=>e[63]||(e[63]=[t(`data: () => ({
  table: {
    fixedHeaders: false,
    headers: [
...
`)],-1)),l(r,{h3:""},{default:a(()=>e[66]||(e[66]=[t("Initial Sorting",-1)])),_:1,__:[66]}),l(b,null,{pug:a(()=>e[67]||(e[67]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  v-model:sort="table.sort")`,-1)])),html:a(()=>e[68]||(e[68]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  v-model:sort="table.sort">
</w-table>`,-1)])),js:a(()=>e[69]||(e[69]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
})`,-1)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table1.items,sort:i.table1.sort,"onUpdate:sort":e[3]||(e[3]=m=>i.table1.sort=m)},null,8,["headers","items","sort"])]),_:1}),l(S,{tip:""},{default:a(()=>e[70]||(e[70]=[t(`By default any column being sorted is highlighted. You can modify the style of the whole column
with the class `,-1),n("code",null,".w-table__col--highlighted",-1),t(".",-1),n("br",null,null,-1),t(`
Also, if you try to target it in the devtools and can't find it, it's in `,-1),n("code",null,"table > colgroup",-1),t(`.
`,-1)])),_:1,__:[70]}),l(r,{h3:""},{default:a(()=>e[71]||(e[71]=[t("Asynchronous Sorting",-1)])),_:1,__:[71]}),e[193]||(e[193]=n("p",null,[t(`When dealing with a lot of table entries, you will most likely need the sorting to be done
...
For this you can use the asynchronous sorting and update the table rows from outside Wave UI.`)],-1)),l(b,{"blank-codepen":["js"]},{html:a(()=>e[73]||(e[73]=[t(`<w-table
  ...
  style="height: 140px">
</w-table>`,-1)])),js:a(()=>e[74]||(e[74]=[t(`// This object is simulating content coming from the server.
...
app.mount('#app')
`,-1)])),default:a(()=>[l(o,{class:"my6",headers:i.table10.headers,items:i.table10.items,"sort-function":u.sortFunction,loading:i.table10.loading,style:{height:"145px"}},{pug:a(()=>e[72]||(e[72]=[t(`w-table.my6(
:headers="table.headers"
:items="table.items"
:sort-function="sortFunction"
:loading="table.loading"
style="height: 140px")`,-1)])),_:1},8,["headers","items","sort-function","loading"])]),_:1}),l(r,{h2:""},{default:a(()=>e[75]||(e[75]=[t("Filtering",-1)])),_:1,__:[75]}),e[194]||(e[194]=n("p",null,[t(`Filtering the table rows is very straightforward: you only need to provide your filtering function to the
...
w-table(
  :headers="table.headers"
  :items="table.items"
  :filter="table.filters[table.activeFilter]")`,-1)])),html:a(()=>e[80]||(e[80]=[t(`<div class="w-flex wrap mb3">
  <w-button
    class="mr2 mb1"
    @click="table.activeFilter = 0"
    round
...
</w-table>`,-1)])),js:a(()=>e[81]||(e[81]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)])),default:a(()=>[n("div",U,[l(f,{class:"mr2 mb1",onClick:e[4]||(e[4]=m=>i.table3.activeFilter=0),round:"",outline:i.table3.activeFilter!==0},{default:a(()=>e[76]||(e[76]=[t("No filter",-1)])),_:1,__:[76]},8,["outline"]),l(f,{class:"mr2 mb1",onClick:e[5]||(e[5]=m=>i.table3.activeFilter=1),round:"",outline:i.table3.activeFilter!==1},{default:a(()=>e[77]||(e[77]=[t("Last name starting with 'M'",-1)])),_:1,__:[77]},8,["outline"]),l(f,{class:"mr2 mb1",onClick:e[6]||(e[6]=m=>i.table3.activeFilter=2),round:"",outline:i.table3.activeFilter!==2},{default:a(()=>e[78]||(e[78]=[t("ID >= 10",-1)])),_:1,__:[78]},8,["outline"])]),l(o,{headers:i.table3.headers,items:i.table3.items,filter:i.table3.filters[i.table3.activeFilter]},null,8,["headers","items","filter"])]),_:1}),l(r,{h3:""},{default:a(()=>e[82]||(e[82]=[t("Global filter",-1)])),_:1,__:[82]}),e[195]||(e[195]=n("p",null,[t("You could also apply a filter globally, which looks into all the columns at once."),n("br"),t(`
...
w-table(
  :headers="table.headers"
  :items="table.items"
  :filter="table.keywordFilter&#40;table.keyword&#41;")`,-1)])),html:a(()=>e[84]||(e[84]=[t(`<w-input
  v-model="table.keyword"
  placeholder="Search anything..."
  inner-icon-left="wi-search"
  class="mb3">
...
</w-table>`,-1)])),js:a(()=>e[85]||(e[85]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
})`,-1)])),default:a(()=>[l(z,{class:"mb3",modelValue:i.table4.keyword,"onUpdate:modelValue":e[7]||(e[7]=m=>i.table4.keyword=m),placeholder:"Search anything...","inner-icon-left":"wi-search"},null,8,["modelValue"]),l(o,{headers:i.table4.headers,items:i.table4.items,filter:i.table4.keywordFilter(i.table4.keyword)},null,8,["headers","items","filter"])]),_:1}),l(S,{tip:""},{default:a(()=>[e[87]||(e[87]=n("strong",null,[t(`If you don't need the RegExp power, you can simply return
...
`,-1)),l(I,{class:"red mr1",size:"0.9em"},{default:a(()=>e[86]||(e[86]=[t("mdi mdi-heart",-1)])),_:1,__:[86]}),e[91]||(e[91]=t(` in this example's match, is that the user
can benefit from the Regexp engine and use interpreted characters like `,-1)),e[92]||(e[92]=n("code",null,"|",-1)),e[93]||(e[93]=t(" etc.",-1)),e[94]||(e[94]=n("br",null,null,-1)),e[95]||(e[95]=t(`
You could also match only the full words by replacing `,-1)),e[96]||(e[96]=n("code",null,"new RegExp(keyword, 'i')",-1)),e[97]||(e[97]=t(` with
`,-1)),e[98]||(e[98]=n("code",null,"new RegExp(`\\\\b${keyword}\\\\b`, 'i')",-1)),e[99]||(e[99]=t(" (it would return a result when typing ",-1)),e[100]||(e[100]=n("code",null,"floretta",-1)),e[101]||(e[101]=t(`
but not `,-1)),e[102]||(e[102]=n("code",null,"florett",-1)),e[103]||(e[103]=t(" for instance).",-1))]),_:1,__:[87,88,89,90,91,92,93,94,95,96,97,98,99,100,101,102,103]}),l(r,{h2:""},{default:a(()=>e[104]||(e[104]=[t("Loading state",-1)])),_:1,__:[104]}),e[196]||(e[196]=n("p",null,[t("When the table content is not ready straight away, you can use the "),n("code",null,"loading"),t(` prop to display
a progress bar while loading.`)],-1)),l(f,{class:"mb2",disabled:!!i.table1.loading,onClick:u.reload},{default:a(()=>[l(I,{class:"mr1"},{default:a(()=>e[105]||(e[105]=[t("mdi mdi-sync",-1)])),_:1,__:[105]}),e[106]||(e[106]=t("reload",-1))]),_:1,__:[106]},8,["disabled","onClick"]),l(r,{h3:""},{default:a(()=>e[107]||(e[107]=[t("Simple table - no set height",-1)])),_:1,__:[107]}),l(b,{style:{height:"170px"}},{pug:a(()=>e[108]||(e[108]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  :loading="loading")`,-1)])),html:a(()=>e[109]||(e[109]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  :loading="loading">
</w-table>`,-1)])),js:a(()=>e[110]||(e[110]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table1.items,loading:i.table1.loading},null,8,["headers","items","loading"])]),_:1}),l(r,{h3:"",slug:"loading-with-fixed-header"},{default:a(()=>e[111]||(e[111]=[t("Table with fixed header & set height of 200px",-1)])),_:1,__:[111]}),l(b,null,{pug:a(()=>e[112]||(e[112]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  :loading="loading"
  style="height: 200px")`,-1)])),html:a(()=>e[113]||(e[113]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  :loading="loading"
  style="height: 200px">
</w-table>`,-1)])),js:a(()=>e[114]||(e[114]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table3.items,"fixed-headers":"",loading:i.table1.loading,style:{height:"200px"}},null,8,["headers","items","loading"])]),_:1}),l(r,{h2:""},{default:a(()=>e[115]||(e[115]=[t("Pagination",-1)])),_:1,__:[115]}),e[197]||(e[197]=n("p",null,"The pagination can be provided as an object:",-1)),l(T,{language:"js"},{default:a(()=>e[116]||(e[116]=[t(`{
...
}`,-1)])),_:1,__:[116]}),e[198]||(e[198]=E(`<p>More details in the <a href="#pagination-prop">API section</a>.</p><p>The pagination is a two-way binding object: if you modify any property inside it, the table
...
</p>`,3)),l(r,{h3:""},{default:a(()=>e[117]||(e[117]=[t("Client-side pagination",-1)])),_:1,__:[117]}),l(b,{"blank-codepen":["js"]},{pug:a(()=>e[118]||(e[118]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
  :pagination="table.pagination"
  style="max-height: 500px")`,-1)])),html:a(()=>e[119]||(e[119]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
...
</w-table>`,-1)])),js:a(()=>e[120]||(e[120]=[t(`// import { faker } from '@faker-js/faker' // With npm.
...
app.mount('#app')
`,-1)])),default:a(()=>[l(o,{headers:i.table11.headers,items:i.table11.items,"fixed-headers":"","fixed-footer":"",pagination:i.table11.pagination,style:{"max-height":"500px"}},null,8,["headers","items","pagination"])]),_:1}),l(r,{h3:""},{default:a(()=>e[121]||(e[121]=[t("Server-side pagination",-1)])),_:1,__:[121]}),e[199]||(e[199]=n("p",null,"This example showcases an asynchronous pagination with backend fetching of the table items.",-1)),l(b,{"blank-codepen":["js"]},{pug:a(()=>e[122]||(e[122]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
  ...
  :pagination="table.pagination"
  :loading="table.loading"
  style="max-height: 500px")`,-1)])),html:a(()=>e[123]||(e[123]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
  ...
  :loading="table.loading"
  style="max-height: 500px">
</w-table>`,-1)])),js:a(()=>e[124]||(e[124]=[t(`// import { faker } from '@faker-js/faker' // With npm.
import { faker } from 'https://cdn.skypack.dev/@faker-js/faker'
...
app.mount('#app')
`,-1)])),default:a(()=>[l(o,{headers:i.table12.headers,items:i.table12.items,"fixed-headers":"","fixed-footer":"",fetch:i.table12.fetch,pagination:i.table12.pagination,loading:i.table12.loading,style:{"max-height":"500px"}},null,8,["headers","items","fetch","pagination","loading"])]),_:1}),l(r,{h3:""},{default:a(()=>e[125]||(e[125]=[t("Custom pagination layout",-1)])),_:1,__:[125]}),e[200]||(e[200]=n("p",null,[t("More details about the pagination slot in the "),n("a",{href:"#pagination-slot"},"API section"),t(".")],-1)),l(b,{"blank-codepen":["js"]},{pug:a(()=>e[126]||(e[126]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
    ...
    .w-flex.align-center.gap2.pa1
      .w-flex.gap2.no-grow
        ...
        w-button(
          ...
          xs)
      p `+s("{{ range }}")+" of "+s("{{ total }}")+".",-1)])),html:a(()=>e[127]||(e[127]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
...
</w-table>`,-1)])),js:a(()=>e[128]||(e[128]=[t(`// import { faker } from '@faker-js/faker' // With npm.
import { faker } from 'https://cdn.skypack.dev/@faker-js/faker'
...
app.mount('#app')
`,-1)])),default:a(()=>[l(o,{headers:i.table11.headers,items:i.table11.items,"fixed-headers":"","fixed-footer":"",pagination:i.table11.pagination,style:{"max-height":"500px"}},{pagination:a(({range:m,total:h,page:N,pagesCount:k,goToPage:x})=>[n("div",J,[n("div",Y,[l(f,{onClick:w=>x("-1"),disabled:N===1,icon:"wi-chevron-left",xs:""},null,8,["onClick","disabled"]),(p(!0),c(R,null,L(k,w=>(p(),A(f,{key:w,onClick:ge=>w!==N&&x(w),outline:N===w,round:"",xs:""},{default:a(()=>[t(s(w),1)]),_:2},1032,["onClick","outline"]))),128)),l(f,{onClick:w=>x("+1"),disabled:N===k,icon:"wi-chevron-right",xs:""},null,8,["onClick","disabled"])]),n("p",G,s(m)+" of "+s(h)+".",1)])]),_:1},8,["headers","items","pagination"])]),_:1}),l(r,{h3:""},{default:a(()=>e[129]||(e[129]=[t("Initing the pagination with a certain state",-1)])),_:1,__:[129]}),l(b,{"blank-codepen":["js"]},{pug:a(()=>e[130]||(e[130]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
  ...
  :pagination="table.pagination"
  :loading="table.loading"
  style="max-height: 500px")`,-1)])),html:a(()=>e[131]||(e[131]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
  ...
  :loading="table.loading"
  style="max-height: 500px">
</w-table>`,-1)])),js:a(()=>e[132]||(e[132]=[t(`// import { faker } from '@faker-js/faker' // With npm.
import { faker } from 'https://cdn.skypack.dev/@faker-js/faker'
...
app.mount('#app')
`,-1)])),default:a(()=>[l(o,{headers:i.table13.headers,items:i.table13.items,"fixed-headers":"","fixed-footer":"",fetch:i.table13.fetch,pagination:i.table13.pagination,loading:i.table13.loading,style:{"max-height":"500px"}},null,8,["headers","items","fetch","pagination","loading"])]),_:1}),l(r,{h2:""},{default:a(()=>e[133]||(e[133]=[t("Rows selection",-1)])),_:1,__:[133]}),e[201]||(e[201]=n("p",null,"Click a row to see it highlighted and get information about the selected item.",-1)),e[202]||(e[202]=n("p",null,[t("By default, the selection will use the "),n("code",null,"primary"),t(" color and apply an opacity of "),n("code",null,"0.2"),t(`.
If this is not what you want, you can override it via CSS (`),n("code",null,".w-table__row--selected td:before"),t(`).
`)],-1)),l(r,{h3:"",slug:"example--selectable-rows"},{default:a(()=>e[134]||(e[134]=[t("The ",-1),n("span",{class:"code"},"selectable-rows",-1),t(" prop",-1)])),_:1,__:[134]}),e[203]||(e[203]=n("p",null,[t("You can enable the rows selection by adding the "),n("code",null,"selectable-rows"),t(` prop, or disable it by
...
`)],-1)),l(r,{h3:"",slug:"example--force-selection"},{default:a(()=>e[135]||(e[135]=[t("The ",-1),n("span",{class:"code"},"force-selection",-1),t(" prop",-1)])),_:1,__:[135]}),e[204]||(e[204]=n("p",null,[t("Eventually, you can use the "),n("code",null,"force-selection"),t(` prop to prevent unselecting a row when only
one remain selected.
`)],-1)),l(r,{h3:"",slug:"example--row-select"},{default:a(()=>e[136]||(e[136]=[t("The ",-1),n("span",{class:"code"},"@row-select",-1),t(" event",-1)])),_:1,__:[136]}),e[205]||(e[205]=E(`<p>This event is fired each time a row is selected <strong>or unselected</strong> (so you don&#39;t need to listen
...
pre `+s("{{ selectionInfo }}"),-1)])),html:a(()=>e[140]||(e[140]=[t(`<w-flex wrap class="mb4">
  <w-radios
...
<pre>`+s("{{ selectionInfo }}")+"</pre>",-1)])),js:a(()=>e[141]||(e[141]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)])),default:a(()=>[l(M,{class:"mb4",wrap:""},{default:a(()=>[l(j,{class:"mr6",modelValue:i.table1.selectableRows,"onUpdate:modelValue":e[8]||(e[8]=m=>i.table1.selectableRows=m),items:i.selectableRowsOptions},null,8,["modelValue","items"]),l(f,{class:"my3",onClick:e[9]||(e[9]=m=>i.table1.forceSelection=!i.table1.forceSelection),round:"",outline:!i.table1.forceSelection},{default:a(()=>[i.table1.forceSelection?(p(),A(I,{key:0,class:"mr2"},{default:a(()=>e[137]||(e[137]=[t("wi-check",-1)])),_:1,__:[137]})):W("",!0),e[138]||(e[138]=t("Force selection",-1))]),_:1,__:[138]},8,["outline"])]),_:1}),l(o,{headers:i.table1.headers,items:i.table1.items,"selectable-rows":i.table1.selectableRows,"force-selection":i.table1.forceSelection,onRowSelect:e[10]||(e[10]=m=>i.selectionInfo=m)},null,8,["headers","items","selectable-rows","force-selection"]),e[142]||(e[142]=n("div",{class:"mt4 title4"},"Selection info:",-1)),n("pre",null,s(i.selectionInfo),1)]),_:1,__:[142]}),l(r,{h3:""},{default:a(()=>e[143]||(e[143]=[t("Updating the selected rows programmatically",-1)])),_:1,__:[143]}),e[206]||(e[206]=n("p",null,`Wave UI offers a convenient way to provide an array of selected rows and keeping your array in sync
with the selected rows after user interaction.`,-1)),l(S,{tip:""},{default:a(()=>e[144]||(e[144]=[n("ul",null,[n("li",null,[n("strong",null,"In Vue 2"),t(", you can do 2-way binding on any variable other than the "),n("strong",{class:"code"},"v-model"),t(" using the "),n("code",null,".sync"),t(" modifier.")]),n("li",null,[n("strong",null,"In Vue 3"),t(", multiple "),n("strong",{class:"code"},"v-model"),t(" are supported in order to achieve 2-way binding. So you don't need "),n("code",null,".sync"),t(".")])],-1)])),_:1,__:[144]}),l(b,null,{pug:a(()=>e[146]||(e[146]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  selectable-rows
...
.mt4
  | Selected rows:
  code.ml2 `+s("{{ table.selectedRows }}"),-1)])),html:a(()=>e[147]||(e[147]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  selectable-rows
  v-model:selected-rows="table.selectedRows">
...
})`,-1)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table1.items,"selectable-rows":"","selected-rows":i.table1.selectedRows,"onUpdate:selectedRows":e[11]||(e[11]=m=>i.table1.selectedRows=m)},null,8,["headers","items","selected-rows"]),n("div",X,[e[145]||(e[145]=t("Selected rows:",-1)),n("code",Q,s(i.table1.selectedRows),1)])]),_:1}),l(S,{info:""},{default:a(()=>e[149]||(e[149]=[t("In order to keep the same row selected after sorting or filtering, each row is assigned a unique identifier.",-1),n("br",null,null,-1),t(`
By default the expanded rows array will use an `,-1),n("code",null,"id",-1),t(` key, if present in the item object,
...
the `,-1),n("code",null,"uid-key",-1),t(` prop, which is set to "id" by default.
`,-1)])),_:1,__:[149]}),l(r,{h2:"",slug:"example--expandable-rows"},{default:a(()=>e[150]||(e[150]=[t("Expandable rows",-1)])),_:1,__:[150]}),l(S,{warning:""},{default:a(()=>e[151]||(e[151]=[t("This feature is in progress.",-1)])),_:1,__:[151]}),l(b,null,{pug:a(()=>e[154]||(e[154]=[t(`w-table(:headers="table.headers" :items="table.items" expandable-rows)
  template(#row-expansion="{ item }")
    w-icon.mr2(:color="['blue', 'pink'][item.gender]")
      | mdi `+s("{{ ['mdi-gender-male', 'mdi-gender-female'][item.gender] }}")+`
    | `+s("{{ item.firstName }}")+" weighs ",-1),n("strong",null,s("{{ item.weight }}")+"kg",-1),t(" and is ",-1),n("strong",null,s("{{ item.height }}")+"m",-1),t(" tall.",-1)])),html:a(()=>e[155]||(e[155]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  expandable-rows>
  <template #row-expansion="{ item }">
    ...
    `+s("{{ item.firstName }}")+" weighs ",-1),n("strong",null,s("{{ item.weight }}")+"kg",-1),t(" and is ",-1),n("strong",null,s("{{ item.height }}")+"m",-1),t(` tall.
  </template>
</w-table>`,-1)])),js:a(()=>e[156]||(e[156]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)])),default:a(()=>[l(o,{headers:i.table5.headers,items:i.table5.items,"expandable-rows":""},{"row-expansion":a(({item:m})=>[l(I,{class:"mr2",color:["blue","pink"][m.gender]},{default:a(()=>[t("mdi "+s(["mdi-gender-male","mdi-gender-female"][m.gender]),1)]),_:2},1032,["color"]),t(s(m.firstName)+" weighs ",1),n("strong",null,s(m.weight)+"kg",1),e[152]||(e[152]=t(" and is ",-1)),n("strong",null,s(m.height)+"m",1),e[153]||(e[153]=t(" tall.",-1))]),_:1},8,["headers","items"])]),_:1}),l(r,{h2:"",slug:"slots"},{default:a(()=>e[157]||(e[157]=[t("Headers & cells customization via slots",-1)])),_:1,__:[157]}),e[207]||(e[207]=n("p",null,"You can customize the headers labels and/or each row cells.",-1)),l(r,{h3:""},{default:a(()=>e[158]||(e[158]=[t("Headers",-1)])),_:1,__:[158]}),e[208]||(e[208]=n("p",null,[t("In this example, only the headers are customized via the "),n("code",null,"header-label"),t(" slot.")],-1)),l(b,null,{pug:a(()=>e[159]||(e[159]=[t(`w-table(:headers="table.headers" :items="table.items")
  template(#header-label="{ label, index }") `+s("{{ index }}: {{ label }}")+" 👌",-1)])),html:a(()=>e[160]||(e[160]=[t(`<w-table
  :headers="table.headers"
  :items="table.items">
  <template #header-label="{ label, index }">
    `+s("{{ index }}: {{ label }}")+` 👌
  </template>
</w-table>`,-1)])),js:a(()=>e[161]||(e[161]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table1.items},{"header-label":a(({label:m,index:h})=>[t(s(h)+": "+s(m)+" 👌",1)]),_:1},8,["headers","items"])]),_:1}),l(r,{h3:"",slug:"item-cells"},{default:a(()=>e[162]||(e[162]=[t("Item cells (inside <td> element)",-1)])),_:1,__:[162]}),e[209]||(e[209]=n("p",null,[t("In this example, only the items cells are customized via the "),n("code",null,"item"),t(` slot
(and the headers are hidden).`)],-1)),l(b,null,{pug:a(()=>e[163]||(e[163]=[t(`w-table(:headers="table.headers" no-headers :items="table.items")
  template(#item-cell="{ item, label, header, index }")
    ...
    span `+s("{{ label }}"),-1)])),html:a(()=>e[164]||(e[164]=[t(`<w-table
  :headers="table.headers"
  no-headers
  :items="table.items">
  <template #item-cell="{ item, label, header, index }">
...
</w-table>`,-1)])),js:a(()=>e[165]||(e[165]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)])),default:a(()=>[l(o,{headers:i.table1.headers,"no-headers":"",items:i.table1.items},{"item-cell":a(({item:m,label:h,header:N,index:k})=>[N.key==="id"?(p(),c("small",Z,"#"+s(k),1)):(p(),c(R,{key:1},[n("small",$,s(N.label)+":",1),n("span",null,s(h),1)],64))]),_:1},8,["headers","items"])]),_:1}),l(r,{h3:"",slug:"override-1-particular-item-cell"},{default:a(()=>e[166]||(e[166]=[t("override 1 particular item cell or column cells (inside <td> element)",-1)])),_:1,__:[166]}),e[210]||(e[210]=E(`<p>If you only need to override 1 particular column you can do it via the <code>item-cell.xxx</code> slot,
...
`,-1)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table1.items,"no-headers":""},{"item-cell.id":a(({item:m,label:h,header:N,index:k})=>[n("div",{class:v(["px2 text-center text-bold",d.$store.state.darkMode?"green-dark5--bg":"green-light5--bg"])},s(h),3)]),_:1},8,["headers","items"])]),_:1}),l(r,{h2:"",slug:"full-custom-rows"},{default:a(()=>e[168]||(e[168]=[t("Full custom row (<tr> element itself)",-1)])),_:1,__:[168]}),e[211]||(e[211]=n("p",null,[t(`In this example, the full <tr> DOM element is customized, so you can add your own classes
  ...
  template(#item="{ item, index, select, classes }")
    tr(:class="classes" @click="select")
      td(
        ...
        | `+s("{{ item[header.key] || '' }}"),-1)])),html:a(()=>e[170]||(e[170]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  selectable-rows>
  <template #item="{ item, index, select, classes }">
...
</w-table>`,-1)])),js:a(()=>e[171]||(e[171]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName' },
...
`,-1)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table1.items,"selectable-rows":""},{item:a(({item:m,index:h,select:N,classes:k})=>[n("tr",{class:v(k),onClick:N},[(p(!0),c(R,null,L(i.table1.headers,(x,w)=>(p(),c("td",{key:w,class:v(`pa4 text-${x.align||"left"}`)},s(m[x.key]||""),3))),128))],10,_)]),_:1},8,["headers","items"])]),_:1}),l(r,{h3:"",slug:"colspan-on-td"},{default:a(()=>e[172]||(e[172]=[n("span",{class:"code"},"colspan",-1),t(" on <td>",-1)])),_:1,__:[172]}),e[212]||(e[212]=n("p",null,[t("This example is showcasing another useful case: handling a colspan attribute."),n("br"),t(`
...
`,-1)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table1.items,"no-headers":"","selectable-rows":""},{item:a(({item:m,index:h,select:N,classes:k})=>[n("tr",{class:v({...k,[`indigo-${d.$store.state.darkMode?"dark":"light"}5--bg`]:h%2,[`blue-${d.$store.state.darkMode?"dark":"light"}5--bg`]:!(h%2)}),onClick:N},[n("td",{class:"pa2",colspan:i.table1.headers.length},[n("div",ae,"Row #"+s(h),1),n("ul",null,[(p(!0),c(R,null,L(i.table1.headers,(x,w)=>(p(),c("li",{key:w},[n("strong",ne,s(x.label)+":",1),t(s(m[x.key]||""),1)]))),128))])],8,te)],10,ee)]),_:1},8,["headers","items"])]),_:1}),l(r,{h2:""},{default:a(()=>e[174]||(e[174]=[t("Responsiveness & mobile layout",-1)])),_:1,__:[174]}),e[213]||(e[213]=n("p",null,[t("In addition to the full responsiveness, the "),n("code",null,"w-table"),t(` can be presented in a mobile friendly layout,
...
`)],-1)),l(b,null,{pug:a(()=>e[175]||(e[175]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  :mobile-breakpoint="700")`,-1)])),html:a(()=>e[176]||(e[176]=[t(`<w-table
  :headers="table.headers"
  :items="table.items"
  :mobile-breakpoint="700">
</w-table>`,-1)])),js:a(()=>e[177]||(e[177]=[t(`data: () => ({
  table: {
    headers: [
      { label: 'ID', key: 'id' },
      { label: 'First name', key: 'firstName', align: 'center' },
...
`,-1)])),default:a(()=>[l(o,{headers:i.table2.headers,items:i.table2.items,"mobile-breakpoint":700},null,8,["headers","items"])]),_:1}),l(S,{tip:""},{default:a(()=>[e[179]||(e[179]=n("p",null,[t("To stay lean and efficient, the minimum JavaScript behavior is added to the "),n("code",null,"w-table"),t(`
component.`),n("br"),t(`
