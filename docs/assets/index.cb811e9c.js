import{r,o as f,f as w,a as t,w as a,d as o,b as e,h,_ as g,Z as k,C,$ as O}from"./index.cc5eb951.js";const I=o("p",{class:"mb3"},"What it looks like:",-1),E=o("div",{class:"title4 mt4"},"States",-1),P={class:"w-flex wrap"},$=o("p",{class:"mt12"},[e("There are 2 components: "),o("span",{class:"code"},"w-radio"),e(" & "),o("span",{class:"code"},"w-radios"),e(`.
...
`)])],-1),z=o("p",null,[o("span",{class:"code"},"w-radio"),e(" provides a default slot to customize the content.")],-1),x=o("span",{class:"pr1"},"Choice 1 has an icon",-1),F=o("span",{class:"code"},"w-radio",-1),Y=o("br",null,null,-1),Z=o("span",{class:"code"},"w-radios",-1),G=o("div",{class:"w-divider"},null,-1),J=o("p",{class:"my5"},[e("The "),o("span",{class:"code"},"w-radios"),e(` component allows a fast and easy rendering of
...
But because in most cases you won't need that, the `),Z,e(` component will make you go
much faster.
`)]),_:1}),t(c,{class:"title1 mt12",h2:"",slug:"w-radios"},{default:a(()=>[e("<w-radios>")]),_:1}),G,J,t(c,{class:"title2 primary",h3:""},{default:a(()=>[e("V-model")]),_:1}),t(b,{info:""},{default:a(()=>[e("If a value is set in the choice's data, it will be returned through the v-model when selected."),Q,e(`
If no value is set, the choice's label will be returned instead.`)]),_:1}),X,t(u,null,{html:a(()=>[e(`<div class="w-flex align-center">
  <w-radios
    v-model="selection"
    :items="radioItems">
  </w-radios>
