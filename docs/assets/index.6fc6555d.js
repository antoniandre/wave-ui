import{r as c,o as g,f as _,a as e,w as o,b as n,h as s,d as x,e as t,k as N,v as T,m as V,_ as y,O as b,V as C}from"./index.f302d8ad.js";const E=t("Notification manager"),B=n("p",null,[t("The built-in notification manager can be used via "),n("code",null,"this.$waveui.notify()"),t(" from any component.")],-1),H=n("div",{class:"title3"},"Pros",-1),U=t("Very convenient and fast to use"),D=t("Handles the stacking of simultaneous notifications"),j=n("div",{class:"title3 mt4"},"Cons",-1),z=t("Less flexible than "),O=n("strong",{class:"code mx1"},"w-notification",-1),W=t(` in terms of layout (no slot available)
...
to `),Ct=t("."),At=t("You could even"),Mt={class:"ml1",href:"https://vuejs.org/v2/guide/transitions.html"},It=t("create your own transition"),Pt=t("mdi mdi-open-in-new"),xt=t("."),Et=t("Styling"),Bt=n("p",null,[t("By default, the notification manager is 280px-wide and all the notifications will inherit this width."),n("br"),t(`
You can override this via CSS. For instance:`)],-1),Ht=t(`.w-notification-manager {width: 100%;max-width: 500px;}
`),Ut=n("span",{class:"code"},"w-notification",-1),Dt=t("The "),jt=n("span",{class:"code"},"w-notification",-1),zt=t(" component is pretty much a wrapper around the "),Ot=n("span",{class:"code"},"w-alert",-1),Wt=t(`
