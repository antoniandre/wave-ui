...
`,-1)])]),default:n(()=>[l(s,{class:"size--md",data:o.tree2,"expand-icon":"mdi mdi-plus","expand-open-icon":"mdi mdi-minus","branch-icon":"mdi mdi-folder-outline","branch-open-icon":"mdi mdi-folder-open-outline","leaf-icon":"mdi mdi-file-outline"},null,8,["data"])]),_:1}),l(d,{h3:""},{default:n(()=>[...e[15]||(e[15]=[t("Different icon per item",-1)])]),_:1}),e[74]||(e[74]=f(`<p>It is possible to set a specific icon in any/each item of the tree.<br>
...
`,-1)])]),default:n(()=>[l(s,{class:"size--md",data:o.tree6,"icon-color":"blue-dark1"},null,8,["data"])]),_:1}),l(d,{h3:""},{default:n(()=>[...e[19]||(e[19]=[t("No expand button",-1)])]),_:1}),l(i,null,{pug:n(()=>[...e[20]||(e[20]=[t('w-tree(:data="tree" :expand-icon="false")',-1)])]),html:n(()=>[...e[21]||(e[21]=[t('<w-tree :data="tree" :expand-icon="false"></w-tree>',-1)])]),js:n(()=>[...e[22]||(e[22]=[t(`data: () => ({
  tree: [
    {
      label: 'src',
      children: [
...
`,-1)])]),default:n(()=>[l(s,{data:o.tree2,"expand-icon":!1},null,8,["data"])]),_:1}),l(d,{h2:""},{default:n(()=>[...e[23]||(e[23]=[t("Selectable",-1)])]),_:1}),l(i,null,{pug:n(()=>[...e[24]||(e[24]=[t('w-tree(:data="tree" selectable)',-1)])]),html:n(()=>[...e[25]||(e[25]=[t('<w-tree :data="tree" selectable></w-tree>',-1)])]),js:n(()=>[...e[26]||(e[26]=[t(`data: () => ({
  data: () => ({
  tree: [
    {
      label: 'Branch 1',
...
`,-1)])]),default:n(()=>[l(s,{data:o.tree1,selectable:""},null,8,["data"])]),_:1}),l(d,{h2:""},{default:n(()=>[...e[27]||(e[27]=[t("Counts",-1)])]),_:1}),l(i,null,{pug:n(()=>[...e[28]||(e[28]=[t('w-tree(:data="tree" counts)',-1)])]),html:n(()=>[...e[29]||(e[29]=[t('<w-tree :data="tree" counts></w-tree>',-1)])]),js:n(()=>[...e[30]||(e[30]=[t(`data: () => ({
  tree: [
    {
      label: 'Branch 1',
      children: [
...
`,-1)])]),default:n(()=>[l(s,{data:o.tree1,counts:""},null,8,["data"])]),_:1}),l(d,{h2:""},{default:n(()=>[...e[31]||(e[31]=[t("No transition",-1)])]),_:1}),l(i,null,{pug:n(()=>[...e[32]||(e[32]=[t('w-tree(:data="tree" no-transition)',-1)])]),html:n(()=>[...e[33]||(e[33]=[t('<w-tree :data="tree" no-transition></w-tree>',-1)])]),js:n(()=>[...e[34]||(e[34]=[t(`data: () => ({
  data: () => ({
  tree: [
    {
      label: 'Branch 1',
...
`,-1)])]),default:n(()=>[l(s,{data:o.tree1,"no-transition":""},null,8,["data"])]),_:1}),l(d,{h2:""},{default:n(()=>[...e[35]||(e[35]=[t("Unexpandable empty branches",-1)])]),_:1}),l(i,null,{pug:n(()=>[...e[39]||(e[39]=[t('w-tree(:data="tree" unexpandable-empty)',-1)])]),html:n(()=>[...e[40]||(e[40]=[t('<w-tree :data="tree" unexpandable-empty></w-tree>',-1)])]),js:n(()=>[...e[41]||(e[41]=[t(`data: () => ({
  tree: [
    {
      label: 'Branch 1',
      children: [
...
`,-1)])]),default:n(()=>[l(s,{modelValue:o.selection,"onUpdate:modelValue":e[0]||(e[0]=r=>o.selection=r),data:o.tree1,selectable:""},null,8,["modelValue","data"]),a("div",E,[e[43]||(e[43]=a("strong",{class:"mr3"},"Selection:",-1)),a("pre",{class:L(["pa2",o.$store.state.darkMode?"grey-dark6--bg":"orange-light6--bg"])},h(o.selection),3)])]),_:1}),l(d,{h2:""},{default:n(()=>[...e[47]||(e[47]=[t("Events",-1)])]),_:1}),e[77]||(e[77]=f('<p>Multiple events are fired from the <strong class="code">w-tree</strong> component:</p><ul class="lh0"><li><code>before-open</code>: fired as soon as the user clicks a tree item that is expandable and before the subitems are revealed.</li><li class="mt1"><code>open</code>: fired after a user clicks a tree item that is expandable, and after the expand animation.</li><li class="mt1"><code>before-close</code>: fired as soon as the user clicks a tree item to close its subtree.</li><li class="mt1"><code>close</code>: fired after a user clicks a tree item to close its subtree, and after the collapse animation.</li><li class="mt1"><code>click</code>: fired when the user clicks any tree item.</li><li class="mt1"><code>select</code>: fired when the user selects any selectable tree item. The <code>selectable</code> option must be set to true.</li><li class="mt1"><code>update:model-value</code>: (or <code>input</code> in Vue 2.x) fired when the user selects any selectable tree item. The <code>selectable</code> option must be set to true.</li></ul>',2)),l(i,null,{pug:n(()=>[...e[48]||(e[48]=[t(`w-tree(
  :data="tree"
...
`,-1)])]),default:n(()=>[l(s,{class:"lh5",data:o.tree4},{item:n(({item:r,open:H})=>[a("span",null,h(r.label),1),r.status==="error"?(b(),g(p,{key:0,class:"ml1","bg-color":"error",xs:""},{default:n(()=>[...e[63]||(e[63]=[t("mdi mdi-close",-1)])]),_:1})):r.status==="success"?(b(),g(p,{key:1,class:"ml1","bg-color":"success",xs:""},{default:n(()=>[...e[64]||(e[64]=[t("mdi mdi-check",-1)])]),_:1})):r.status==="syncing"?(b(),g(p,{key:2,class:"ml1","bg-color":"warning",xs:""},{default:n(()=>[...e[65]||(e[65]=[t("mdi mdi-clock-outline",-1)])]),_:1})):I("",!0)]),_:1},8,["data"])]),_:1}),l(d,{h2:""},{default:n(()=>[...e[69]||(e[69]=[t("Expand all, by default",-1)])]),_:1}),l(i,null,{pug:n(()=>[...e[70]||(e[70]=[t('w-tree(:data="tree" expand-all)',-1)])]),html:n(()=>[...e[71]||(e[71]=[t('<w-tree :data="tree" expand-all></w-tree>',-1)])]),js:n(()=>[...e[72]||(e[72]=[t(`data: () => ({
  tree: [
      {
        label: 'Item 1',
        children: [
