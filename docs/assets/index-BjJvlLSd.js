...
the following transition name.`)],-1),R={class:"w-flex"},_={class:"w-flex wrap"},z={class:"ma2"},G=a("div",{class:"title3 mb2"},"Transition names",-1),J={class:"ma2"},Y=a("div",{class:"title3 mb2"},"Slide transitions for fullscreen",-1),H=a("p",null,[n("The overlay can be customized via the "),a("code",null,"overlay-opacity"),n(` - if you use the default color
