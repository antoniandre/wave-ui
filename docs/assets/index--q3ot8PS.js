import{r,g as w,o as h,a as i,b as o,w as n,e,t as s,n as S,_ as v,s as k}from"./index-DyPyadtc.js";const j={class:"mt3"},A={class:"ml1"},D={class:"mt3"},E={class:"ml1"},P={class:"mt3"},V={class:"ml1"},$={class:"mt3"},U={class:"ml1"},B={class:"ml1"};function R(a,t,x,y,q,g){const b=r("alert"),l=r("title-link"),m=r("w-accordion"),c=r("example"),f=r("w-button"),u=r("w-icon"),C=r("w-alert"),I=r("w-tag"),T=r("w-list"),p=r("w-accordion-item");return h(),w("div",null,[i(b,{info:""},{default:n(()=>t[7]||(t[7]=[o("p",null,"Two components are available:",-1),o("ul",null,[o("li",null,[o("strong",{class:"code"},"w-accordion"),e(": The root accordion component.")]),o("li",{class:"mt2"},[o("strong",{class:"code"},"w-accordion-item"),e(`: An optional component if you don't need / prefer not to use
the `),o("code",null,"items"),e(" prop.")])],-1)])),_:1,__:[7]}),i(l,{h2:""},{default:n(()=>t[8]||(t[8]=[e("Basic",-1)])),_:1,__:[8]}),i(m,{items:a.items},null,8,["items"]),t[104]||(t[104]=o("p",{class:"grey-light2 my4"},`Now that you've seen the default accordion in real context, all the accordions of this page will have a
...
div.mt3
  | v-model:
  code.ml1 `+s("{{ accordion }}"),-1)])),html:n(()=>t[11]||(t[11]=[e(`<w-accordion v-model="accordion" :items="items" />

<div class="mt3">
  v-model:
  <code class="ml1">`+s("{{ accordion }}")+`</code>
</div>`,-1)])),js:n(()=>t[12]||(t[12]=[e(`data: () => ({
  items: [
    {
      title: 'Item 1',
...
`,-1)])),default:n(()=>[i(m,{class:"discrete--bg",modelValue:a.accordion1,"onUpdate:modelValue":t[0]||(t[0]=d=>a.accordion1=d),items:a.items},null,8,["modelValue","items"]),o("div",j,[t[9]||(t[9]=e("v-model:",-1)),o("code",A,s(a.accordion1),1)])]),_:1}),i(l,{h2:""},{default:n(()=>t[13]||(t[13]=[e("Expanded by default",-1)])),_:1,__:[13]}),t[105]||(t[105]=o("p",null,[e(`You can expand one or multiple panes by default by providing a v-model array of booleans:
...
div.mt3
  | v-model:
  code.ml1 `+s("{{ accordion }}"),-1)])),html:n(()=>t[16]||(t[16]=[e(`<w-accordion v-model="accordion" :items="items" />

<div class="mt3">
  v-model:
  <code class="ml1">`+s("{{ accordion }}")+`</code>
</div>`,-1)])),js:n(()=>t[17]||(t[17]=[e(`data: () => ({
  items: [
    {
      title: 'Item 1',
      content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi ut neque enim beatae autem iure, velit labore aut ipsa voluptatem aliquam distinctio harum. Possimus aliquid voluptatum facere incidunt dolor a.'
...
`,-1)])),default:n(()=>[i(m,{class:"discrete--bg",modelValue:a.accordion2,"onUpdate:modelValue":t[1]||(t[1]=d=>a.accordion2=d),items:a.items},null,8,["modelValue","items"]),o("div",D,[t[14]||(t[14]=e("v-model:",-1)),o("code",E,s(a.accordion2),1)])]),_:1}),i(l,{h2:""},{default:n(()=>t[18]||(t[18]=[e("Disabled pane",-1)])),_:1,__:[18]}),t[106]||(t[106]=o("p",null,[e("Specify which pane should be disabled - expanded or collapsed - by adding the "),o("span",{class:"code"},"disabled"),e(` property
directly in the object.`)],-1)),i(c,{"content-class":"pa4"},{pug:n(()=>t[19]||(t[19]=[e('w-accordion(v-model="accordion" :items="items")',-1)])),html:n(()=>t[20]||(t[20]=[e('<w-accordion v-model="accordion" :items="items" />',-1)])),js:n(()=>t[21]||(t[21]=[e(`data: () => ({
  items: [
...
`,-1)])),default:n(()=>[i(m,{class:"discrete--bg",modelValue:a.accordion3,"onUpdate:modelValue":t[2]||(t[2]=d=>a.accordion3=d),items:a.itemsDisabled},null,8,["modelValue","items"])]),_:1}),i(l,{h2:""},{default:n(()=>t[22]||(t[22]=[e("Shadow",-1)])),_:1,__:[22]}),i(c,{"content-class":"pa4"},{pug:n(()=>t[23]||(t[23]=[e('w-accordion(:items="items" shadow)',-1)])),html:n(()=>t[24]||(t[24]=[e('<w-accordion :items="items" shadow />',-1)])),js:n(()=>t[25]||(t[25]=[e(`data: () => ({
  items: [
    {
      title: 'Item 1',
      content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi ut neque enim beatae autem iure, velit labore aut ipsa voluptatem aliquam distinctio harum. Possimus aliquid voluptatum facere incidunt dolor a.'
...
`,-1)])),default:n(()=>[i(m,{class:"discrete--bg",items:a.items,shadow:""},null,8,["items"])]),_:1}),i(l,{h2:""},{default:n(()=>t[26]||(t[26]=[e("Color & background color",-1)])),_:1,__:[26]}),t[107]||(t[107]=o("p",null,[e("Like in most components, you can set a "),o("code",null,"color"),e(" for the text and a "),o("code",null,"bg-color"),e(` for the
background.`),o("br"),e(`
...
`,-1)])),default:n(()=>[i(m,{class:"discrete--bg",items:a.items2},null,8,["items"])]),_:1}),i(l,{h2:""},{default:n(()=>t[32]||(t[32]=[e("Expand a single item at a time",-1)])),_:1,__:[32]}),i(c,{"content-class":"pa4"},{pug:n(()=>t[34]||(t[34]=[e(`w-accordion(v-model="accordion" :items="items" expand-single)

div.mt3
  | v-model:
  code.ml1 `+s("{{ accordion }}"),-1)])),html:n(()=>t[35]||(t[35]=[e(`<w-accordion
  v-model="accordion"
  :items="items"
  expand-single>
</w-accordion>
...
`,-1)])),default:n(()=>[i(m,{class:"discrete--bg",modelValue:a.accordion4,"onUpdate:modelValue":t[3]||(t[3]=d=>a.accordion4=d),items:a.items,"expand-single":""},null,8,["modelValue","items"]),o("div",P,[t[33]||(t[33]=e("v-model:",-1)),o("code",V,s(a.accordion4),1)])]),_:1}),i(l,{h2:""},{default:n(()=>t[37]||(t[37]=[e("External control",-1)])),_:1,__:[37]}),i(c,{"content-class":"pa4"},{pug:n(()=>t[41]||(t[41]=[e(`w-button.mr2(@click="accordion = Array&#40;3&#41;.fill&#40;true&#41;" sm) Expand all
...
div.mt3
  | v-model:
  code.ml1 `+s("{{ accordion }}"),-1)])),html:n(()=>t[42]||(t[42]=[e(`<w-button
  class="mr2"
...
`,-1)])),default:n(()=>[i(f,{class:"mr2",onClick:t[4]||(t[4]=d=>a.accordion5=Array(3).fill(!0)),sm:""},{default:n(()=>t[38]||(t[38]=[e("Expand all",-1)])),_:1,__:[38]}),i(f,{onClick:t[5]||(t[5]=d=>a.accordion5=Array(3).fill(!1)),sm:""},{default:n(()=>t[39]||(t[39]=[e("Collapse all",-1)])),_:1,__:[39]}),i(m,{class:"mt4 discrete--bg",modelValue:a.accordion5,"onUpdate:modelValue":t[6]||(t[6]=d=>a.accordion5=d),items:a.items},null,8,["modelValue","items"]),o("div",$,[t[40]||(t[40]=e("v-model:",-1)),o("code",U,s(a.accordion5),1)])]),_:1}),i(l,{h2:""},{default:n(()=>t[44]||(t[44]=[e("Custom rendering via slots",-1)])),_:1,__:[44]}),t[109]||(t[109]=o("p",null,[e("Customize all the tab items titles and/or content via the single slot "),o("code",null,"item-title"),e(`, and/or
all the tab items content via the single slot `),o("code",null,"item-content"),e(".")],-1)),i(c,{"content-class":"pa4"},{pug:n(()=>t[45]||(t[45]=[e(`w-accordion(:items="items" content-class="pa0")
  ...
  template(#item-content="{ item }")
    w-alert.my0.pb3(border-left tile :color="item.itemColor" v-html="item.content")`,-1)])),html:n(()=>t[46]||(t[46]=[e(`<w-accordion :items="items" content-class="pa0">
  <template #item-title="{ item }">
  ...
  <template #item-content="{ item }") />
    <w-alert
      ...
      v-html="item.content" />
  </template>`,-1)])),js:n(()=>t[47]||(t[47]=[e(`data: () => ({
  items: [
    {
      title: 'Item 1',
      content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi ut neque enim beatae autem iure, velit labore aut ipsa voluptatem aliquam distinctio harum. Possimus aliquid voluptatum facere incidunt dolor a.',
...
`,-1)])),default:n(()=>[i(m,{class:"discrete--bg",items:a.items,"content-class":"pa0"},{"item-title":n(({item:d})=>[i(u,{lg:"",color:d.itemColor},{default:n(()=>[e(s(d.icon),1)]),_:2},1032,["color"]),o("div",{class:S(["title3 my0 ml2",d.itemColor])},s(d.title),3)]),"item-content":n(({item:d})=>[i(C,{class:"my0 pb3","border-left":"",tile:"",color:d.itemColor,innerHTML:d.content},null,8,["color","innerHTML"])]),_:1},8,["items"])]),_:1}),i(l,{h3:"",slug:"slots--different-title-and-content"},{default:n(()=>t[48]||(t[48]=[e("Different title and content layouts per item",-1)])),_:1,__:[48]}),t[110]||(t[110]=o("p",null,[e("Here is a more complex example using slots to render 3 totally diferent pane titles and contents."),o("br"),e(`
...
the component's data or directly in the template.`)],-1)),i(c,{"content-class":"pa4"},{pug:n(()=>t[62]||(t[62]=[e(`w-accordion(:items="items")
  ...
  template(#item-content.item3)
    ...
    w-button.mt1(bg-color="primary" route="https://github.com/antoniandre/wave-ui")
      | Github
      w-icon.ml2(sm) mdi mdi-open-in-new`,-1)])),html:n(()=>t[63]||(t[63]=[e(`<w-accordion :items="items">
  <template #item-title.item1>
    This is the 1st item
...
</w-accordion>`,-1)])),js:n(()=>t[64]||(t[64]=[e(`data: () => ({
  items: [
    { id: 'item1' },
    { id: 'item2' },
    { id: 'item3' }
...
`,-1)])),default:n(()=>[i(m,{class:"discrete--bg",items:a.itemsCustom},{"item-title.item1":n(()=>[t[50]||(t[50]=e("This is the 1st item",-1)),i(I,{class:"ml2",color:"red",sm:"",outline:""},{default:n(()=>t[49]||(t[49]=[e("HOT",-1)])),_:1,__:[49]})]),"item-content.item1":n(()=>[t[51]||(t[51]=o("p",null,"This content has a checklist.",-1)),t[52]||(t[52]=o("div",{class:"title4"},"To do",-1)),i(T,{checklist:"",color:"primary",items:[{label:"do this"},{label:"do that next"}]})]),"item-title.item2":n(()=>[i(u,{class:"mr1",md:"",color:"amber"},{default:n(()=>t[53]||(t[53]=[e("mdi mdi-emoticon-excited-outline",-1)])),_:1,__:[53]}),t[54]||(t[54]=o("em",null,"This is the 2nd item",-1))]),"item-content.item2":n(({item:d})=>[t[56]||(t[56]=o("p",null,"The full content here is custom and completely distinct and independent from the other items.",-1)),o("p",null,[t[55]||(t[55]=e("You also have access to the item's data if you need:",-1)),o("code",B,s(d),1)])]),"item-title.item3":n(()=>[t[58]||(t[58]=o("strong",null,"This is the 3rd item",-1)),i(u,{class:"ml1",md:"",color:"pink"},{default:n(()=>t[57]||(t[57]=[e("mdi mdi-emoticon-kiss-outline",-1)])),_:1,__:[57]})]),"item-content.item3":n(()=>[t[61]||(t[61]=o("p",null,"Do you want to check the project on Github?",-1)),i(f,{class:"mt1","bg-color":"primary",route:"https://github.com/antoniandre/wave-ui"},{default:n(()=>[t[60]||(t[60]=e("Github",-1)),i(u,{class:"ml2",sm:""},{default:n(()=>t[59]||(t[59]=[e("mdi mdi-open-in-new",-1)])),_:1,__:[59]})]),_:1,__:[60]})]),_:1},8,["items"])]),_:1}),i(l,{h2:"",slug:"w-accordion-item"},{default:n(()=>t[65]||(t[65]=[e("Custom rendering via ",-1),o("span",{class:"code"},"w-accordion-item",-1)])),_:1,__:[65]}),t[111]||(t[111]=o("p",null,[e(`If you don't need data objects at all and all the items layouts will be different,
...
`)],-1)),i(c,{"content-class":"pa4"},{pug:n(()=>t[72]||(t[72]=[e(`w-accordion
  ...
  w-accordion-item
    ...
    template(#content) Item content 3`,-1)])),html:n(()=>t[73]||(t[73]=[e(`<w-accordion>
  <w-accordion-item>
...
`,-1)])),default:n(()=>[i(m,{class:"discrete--bg"},{default:n(()=>[i(p,null,{title:n(()=>t[66]||(t[66]=[e("Item title 1",-1)])),content:n(()=>t[67]||(t[67]=[e("Item content 1",-1)])),_:1}),i(p,null,{title:n(()=>t[68]||(t[68]=[e("Item title 2",-1)])),content:n(()=>t[69]||(t[69]=[e("Item content 2",-1)])),_:1}),i(p,null,{title:n(()=>t[70]||(t[70]=[e("Item title 3",-1)])),content:n(()=>t[71]||(t[71]=[e("Item content 3",-1)])),_:1})]),_:1})]),_:1}),i(l,{h3:"",slug:"w-accordion-item--different-title-and-content"},{default:n(()=>t[74]||(t[74]=[e("Different title and content layouts per item",-1)])),_:1,__:[74]}),t[112]||(t[112]=o("p",null,[e("Same example as "),o("a",{href:"#slots--different-title-and-content"},"above"),e(" but using the "),o("strong",{class:"code"},"w-accordion-item"),e(" component.")],-1)),i(c,{"content-class":"pa4"},{pug:n(()=>t[87]||(t[87]=[e(`w-accordion(:items="items")
  w-accordion-item
    template(#title)
      | This is the 1st item
      w-tag.ml2(color="red" sm outline) HOT
  ...
  w-accordion-item
    ...
    template(#content)
      ...
      w-button.mt1(bg-color="primary" route="https://github.com/antoniandre/wave-ui")
        | Github
        w-icon.ml2(sm) mdi mdi-open-in-new`,-1)])),html:n(()=>t[88]||(t[88]=[e(`<w-accordion>
  <w-accordion-item>
    <template #title>
      This is the 1st item
      <w-tag class="ml2" color="red" sm outline>HOT</w-tag>
...
w-accordion(:items="items" icon-rotate90 expand-icon-right)`,-1)])),html:n(()=>t[92]||(t[92]=[e(`<div class="title4">
  Icon on the left
</div>
<w-accordion
  :items="items"
...
<w-accordion
  ...
  icon-rotate90
  expand-icon-right>
</w-accordion>`,-1)])),js:n(()=>t[93]||(t[93]=[e(`data: () => ({
  items: [
...
`,-1)])),default:n(()=>[t[94]||(t[94]=o("div",{class:"title4"},"Icon on the left",-1)),i(m,{class:"discrete--bg",items:a.items,"expand-icon-rotate90":""},null,8,["items"]),t[95]||(t[95]=o("div",{class:"title4 mt6"},"Icon on the right",-1)),i(m,{class:"discrete--bg",items:a.items,"expand-icon-rotate90":"","expand-icon-right":""},null,8,["items"])]),_:1,__:[94,95]}),i(l,{h3:""},{default:n(()=>t[96]||(t[96]=[e("More options",-1)])),_:1,__:[96]}),i(c,{"content-class":"pa4"},{pug:n(()=>t[97]||(t[97]=[e(`.title4 1 custom icon (only expand)
...
.title4.mt6 Icon on the right
w-accordion(:items="items" expand-icon-right)`,-1)])),html:n(()=>t[98]||(t[98]=[e(`<div class="title4 mb2">
...
<w-accordion
  :items="items"
  expand-icon-right>
</w-accordion>`,-1)])),js:n(()=>t[99]||(t[99]=[e(`data: () => ({
  items: [
    {
      title: 'Item 1',
      content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi ut neque enim beatae autem iure, velit labore aut ipsa voluptatem aliquam distinctio harum. Possimus aliquid voluptatum facere incidunt dolor a.'
