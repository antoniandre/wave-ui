import{r,o as b,f as g,a as i,w as t,b as e,h as l,d as n,n as k,_ as f,q as _}from"./index.837b2231.js";const C=n("p",{class:"grey-light2 my4"},`Now that you've seen the default accordion in real context, all the examples of this page will have a
...
`)]),default:t(()=>[i(a,{class:"white--bg",modelValue:o.accordion2,"onUpdate:modelValue":c[1]||(c[1]=s=>o.accordion2=s),items:o.items},null,8,["modelValue","items"]),n("div",A,[e("v-model:"),n("code",E,l(o.accordion2),1)])]),_:1}),i(m,{h2:""},{default:t(()=>[e("Disabled pane")]),_:1}),V,i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e('w-accordion(v-model="accordion" :items="items")')]),html:t(()=>[e('<w-accordion v-model="accordion" :items="items" />')]),js:t(()=>[e(`data: () => ({
  items: [
...
`)]),default:t(()=>[i(a,{class:"white--bg",items:o.items,shadow:""},null,8,["items"])]),_:1}),i(m,{h2:""},{default:t(()=>[e("Color & background color")]),_:1}),D,i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`w-accordion(:items="items" color="amber-dark1")
