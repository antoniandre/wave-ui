...
`)])),_:1,__:[4]}),n(m,{h2:""},{default:l(()=>e[5]||(e[5]=[t("Basic")])),_:1,__:[5]}),e[118]||(e[118]=s("p",null,[t("This is the most basic use of the "),s("span",{class:"code"},"w-select"),t(" component. No label, no v-model, only items.")],-1)),n(a,null,{pug:l(()=>e[6]||(e[6]=[t('w-select(:items="items")')])),html:l(()=>e[7]||(e[7]=[t('<w-select :items="items"></w-select>')])),js:l(()=>e[8]||(e[8]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`)])),default:l(()=>[n(o,{items:i.items1},null,8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[9]||(e[9]=[t("Label and / or placeholder")])),_:1,__:[9]}),e[119]||(e[119]=s("p",null,[t("The select list can have a label or not and a placeholder or not."),s("br")],-1)),n(a,null,{pug:l(()=>e[10]||(e[10]=[t(`w-select(:items="items" label="Label")
...
`)])),_:1,__:[13]}),n(m,{h2:""},{default:l(()=>e[14]||(e[14]=[t("Outline")])),_:1,__:[14]}),n(a,null,{pug:l(()=>e[16]||(e[16]=[t('w-select(:items="items" outline) Label')])),html:l(()=>e[17]||(e[17]=[t('<w-select :items="items" outline>Label</w-select>')])),js:l(()=>e[18]||(e[18]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`)])),default:l(()=>[n(o,{items:i.items1,outline:""},{default:l(()=>e[15]||(e[15]=[t("Label")])),_:1,__:[15]},8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[19]||(e[19]=[t("Colors")])),_:1,__:[19]}),e[120]||(e[120]=s("p",{class:"mb4"},[t("Like in most components, you can set a "),s("code",null,"color"),t(" for the text and a "),s("code",null,"bg-color"),t(` for the
background.`),s("br"),t(`
By default, the text has the "`),s("span",{class:"code"},"primary"),t('" color.')],-1)),n(m,{h3:"",slug:"default-style"},{default:l(()=>e[20]||(e[20]=[t("Default style (Underline)")])),_:1,__:[20]}),n(a,null,{pug:l(()=>e[23]||(e[23]=[t(`w-select(:items="items" color="blue") Label
...
`)])),default:l(()=>[n(o,{items:i.items1,color:"blue"},{default:l(()=>e[21]||(e[21]=[t("Label")])),_:1,__:[21]},8,["items"]),n(o,{class:"mt4",items:i.items1,"bg-color":"blue-light5",color:"blue-dark3"},{default:l(()=>e[22]||(e[22]=[t("Label")])),_:1,__:[22]},8,["items"])]),_:1}),n(m,{h3:""},{default:l(()=>e[26]||(e[26]=[t("Outline style")])),_:1,__:[26]}),n(a,null,{pug:l(()=>e[29]||(e[29]=[t(`w-select(:items="items" outline color="blue") Label
...
`)])),default:l(()=>[n(o,{items:i.items1,outline:"",color:"blue"},{default:l(()=>e[27]||(e[27]=[t("Label")])),_:1,__:[27]},8,["items"]),n(o,{class:"mt4",items:i.items1,outline:"","bg-color":"blue-light5",color:"blue-dark3"},{default:l(()=>e[28]||(e[28]=[t("Label")])),_:1,__:[28]},8,["items"])]),_:1}),n(m,{h3:""},{default:l(()=>e[32]||(e[32]=[t("List items colors")])),_:1,__:[32]}),e[121]||(e[121]=s("p",null,[t("If an item object contains the key "),s("code",null,"color"),t(`, it will naturally be used by the
...
`)])),default:l(()=>[n(o,{items:i.items4},{default:l(()=>e[33]||(e[33]=[t("Pick a color")])),_:1,__:[33]},8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[37]||(e[37]=[t("Shadow")])),_:1,__:[37]}),n(a,null,{pug:l(()=>e[40]||(e[40]=[t(`.title4.mb2 Default style (Underline)
...
`)])),default:l(()=>[e[43]||(e[43]=s("div",{class:"title4"},"Default style (Underline)",-1)),n(o,{items:i.items1,shadow:""},{default:l(()=>e[38]||(e[38]=[t("Label")])),_:1,__:[38]},8,["items"]),e[44]||(e[44]=s("div",{class:"title4 mt6"},"Outline style",-1)),n(o,{items:i.items1,outline:"",shadow:""},{default:l(()=>e[39]||(e[39]=[t("Label")])),_:1,__:[39]},8,["items"])]),_:1,__:[43,44]}),n(m,{h2:""},{default:l(()=>e[45]||(e[45]=[t("Tile & round")])),_:1,__:[45]}),n(a,null,{pug:l(()=>e[50]||(e[50]=[t(`.title4 Default style (Underline)
...
`)])),default:l(()=>[e[53]||(e[53]=s("div",{class:"title4"},"Default style (Underline)",-1)),n(o,{items:i.items1,"bg-color":"purple-light5",tile:""},{default:l(()=>e[46]||(e[46]=[t("Tile")])),_:1,__:[46]},8,["items"]),n(o,{class:"mt4",items:i.items1,"bg-color":"purple-light5",round:""},{default:l(()=>e[47]||(e[47]=[t("Round")])),_:1,__:[47]},8,["items"]),e[54]||(e[54]=s("div",{class:"title4 mt6"},"Outline style",-1)),n(o,{items:i.items1,outline:"",tile:""},{default:l(()=>e[48]||(e[48]=[t("Tile")])),_:1,__:[48]},8,["items"]),n(o,{class:"mt4",items:i.items1,outline:"",round:""},{default:l(()=>e[49]||(e[49]=[t("Round")])),_:1,__:[49]},8,["items"])]),_:1,__:[53,54]}),n(m,{h2:""},{default:l(()=>e[55]||(e[55]=[t("Fit to content")])),_:1,__:[55]}),n(a,null,{pug:l(()=>e[57]||(e[57]=[t(`w-select(
  :items="items"
...
`)])),default:l(()=>[n(o,{items:i.items5,placeholder:"Select an item","fit-to-content":""},{default:l(()=>e[56]||(e[56]=[t("Fit to content")])),_:1,__:[56]},8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[60]||(e[60]=[t("Multiple selection")])),_:1,__:[60]}),n(a,null,{pug:l(()=>e[61]||(e[61]=[t('w-select(:items="items" multiple)')])),html:l(()=>e[62]||(e[62]=[t('<w-select :items="items" multiple></w-select>')])),js:l(()=>e[63]||(e[63]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`)])),default:l(()=>[n(o,{items:i.items1,multiple:""},null,8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[64]||(e[64]=[t("V-model")])),_:1,__:[64]}),n(b,{tip:""},{default:l(()=>e[65]||(e[65]=[t("By default, the "),s("span",{class:"code"},"w-select",-1),t(" component expects the items to have a "),s("code",null,"model-value",-1),t(" attribute."),s("br",null,null,-1),t(`
If this is a constraint, you can use the option `),s("code",null,"item-value-key",-1),t(` to specify the name of another
attribute to be used instead (must have a unique value), like an id for instance.`)])),_:1,__:[65]}),n(a,null,{pug:l(()=>e[67]||(e[67]=[t(`w-select(v-model="selection" :items="items" multiple)
...
`)])),default:l(()=>[n(o,{modelValue:i.vModelSelect1,"onUpdate:modelValue":e[0]||(e[0]=r=>i.vModelSelect1=r),items:i.items3,multiple:""},null,8,["modelValue","items"]),n(g,{class:"align-center mt4"},{default:l(()=>[e[66]||(e[66]=s("span",null,"v-model:",-1)),s("code",P,d(i.vModelSelect1),1)]),_:1,__:[66]})]),_:1}),n(m,{h3:""},{default:l(()=>e[70]||(e[70]=[t("Without values (using labels)")])),_:1,__:[70]}),e[122]||(e[122]=s("p",null,"If no values are provided in the items objects, the labels will be used to identify the selected items.",-1)),n(a,null,{pug:l(()=>e[72]||(e[72]=[t(`w-select(v-model="selection" :items="items" multiple)
w-flex.align-center.mt4
  span v-model:
...
`)])),default:l(()=>[n(o,{modelValue:i.vModelSelect3,"onUpdate:modelValue":e[2]||(e[2]=r=>i.vModelSelect3=r),items:i.items1,multiple:"","return-object":""},null,8,["modelValue","items"]),n(g,{class:"align-center mt4"},{default:l(()=>[e[76]||(e[76]=s("span",null,"v-model:",-1)),s("code",V,d(i.vModelSelect3),1)]),_:1,__:[76]})]),_:1}),n(m,{h2:""},{default:l(()=>e[80]||(e[80]=[t("Label position")])),_:1,__:[80]}),e[125]||(e[125]=s("p",null,`By default the label is positioned inside, you can also place it on the left or right outside of
...
`)])),default:l(()=>[n(o,{items:i.items1,"label-position":"inside",outline:""},{default:l(()=>[n(c,{class:"orange"},{default:l(()=>e[85]||(e[85]=[t("mdi mdi-arrow-right")])),_:1,__:[85]}),e[87]||(e[87]=s("span",{class:"purple mx1"},"Inside",-1)),n(c,{class:"orange"},{default:l(()=>e[86]||(e[86]=[t("mdi mdi-arrow-left")])),_:1,__:[86]})]),_:1,__:[87]},8,["items"]),n(o,{class:"mt4",items:i.items1,"label-position":"left",outline:""},{default:l(()=>[e[89]||(e[89]=s("span",{class:"green mr1"},"Left",-1)),n(c,{class:"orange"},{default:l(()=>e[88]||(e[88]=[t("mdi mdi-arrow-right")])),_:1,__:[88]})]),_:1,__:[89]},8,["items"]),n(o,{class:"mt4",items:i.items1,"label-position":"right",outline:""},{default:l(()=>[n(c,{class:"orange"},{default:l(()=>e[90]||(e[90]=[t("mdi mdi-arrow-left")])),_:1,__:[90]}),e[91]||(e[91]=s("span",{class:"red ml1"},"Right",-1))]),_:1,__:[91]},8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[95]||(e[95]=[t("Custom selection string")])),_:1,__:[95]}),e[127]||(e[127]=s("p",null,[t("The selection string is customizable through the "),s("code",null,"selection"),t(" slot."),s("br"),t(`
...
`)])),default:l(()=>[n(o,{items:i.items3},{item:l(({item:r,selected:v})=>[v?(p(),j(c,{key:0,class:"primary"},{default:l(()=>e[100]||(e[100]=[t("wi-check")])),_:1,__:[100]})):(p(),f("span",R)),s("span",E,d(r.label),1),n(S,{class:"ml2","bg-color":"grey-light4",xs:""},{default:l(()=>[t(d(r.value),1)]),_:2},1024)]),_:1},8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[104]||(e[104]=[t("Inner icons")])),_:1,__:[104]}),n(a,null,{pug:l(()=>e[105]||(e[105]=[t(`.title4.mb2 Label outside
...
`)])),default:l(()=>[e[108]||(e[108]=s("div",{class:"title4 mb2"},"Label outside",-1)),n(o,{items:i.items1,label:"Select","label-position":"left",outline:"","inner-icon-left":"mdi mdi-star"},null,8,["items"]),n(o,{class:"mt4",items:i.items1,label:"Select","label-position":"right",outline:"","inner-icon-right":"mdi mdi-arrow-down"},null,8,["items"]),e[109]||(e[109]=s("div",{class:"title4 mt6 mb2"},"Label inside",-1)),n(o,{items:i.items1,label:"Select","label-position":"inside",outline:"","inner-icon-left":"mdi mdi-star"},null,8,["items"]),n(o,{class:"mt4",items:i.items1,label:"Select","label-position":"inside",outline:"","inner-icon-right":"mdi mdi-arrow-down"},null,8,["items"])]),_:1,__:[108,109]}),n(m,{h2:""},{default:l(()=>e[110]||(e[110]=[t("Disabled & readonly")])),_:1,__:[110]}),n(a,null,{pug:l(()=>e[111]||(e[111]=[t(`w-select.mb4(
  :items="items"
