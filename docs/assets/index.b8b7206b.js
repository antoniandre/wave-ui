...
secondary color and a color palette color shade.`)],-1),D=s("p",null,[s("strong",{class:"mr1"},"Note:"),o("The 4 status colors as well as the primary color have a white text by default.")],-1),z=o("success"),A=o("error"),C=o("warning"),T=o("info"),P=o("primary"),I=o("secondary"),B=o("purple-light4"),G=o(`w-flex.wrap
  ...
  w-button.ma1(bg-color="purple-light4") purple-light4`),V=o(`<w-flex class="wrap">
...
`),E=s("h3",null,"Mix background and text colors",-1),N=s("p",null,[o("Like in most components, you can set a "),s("code",null,"color"),o(" for the text and a "),s("code",null,"bg-color"),o(` for the
background.`)],-1),W=o("success"),R=o("error"),H=o("warning"),M=o(`w-button.ma1(bg-color="success" color="yellow-light2") success
w-button.ma1(bg-color="error" color="amber-light2") error
w-button.ma1(bg-color="primary" color="success-light2") warning`),O=o(`<w-button
  class="ma1"
  bg-color="success"
  color="yellow-light2">
  success
...
`),j=g(`<h3>Dark</h3><p>By default the <code>primary</code> color is considered dark as well as the four status colors:
...
For the rest you can use the <code>dark</code> prop or set the <code>color</code> prop to \`white\`.</p>`,2),q=o("normal"),F=o("mdi mdi-arrow-right"),Y=o("dark"),J=o(`w-button.ma1(bg-color="primary-light3") normal
w-icon.mx6.grey-light3(size="2.5em") mdi mdi-arrow-right
w-button.ma1(bg-color="primary-light3" dark) dark`),K=o(`<w-button class="ma1" bg-color="primary-light3">normal</w-button>
...
`),Q=o("Sizes"),U=g(`<p>The button size can be controlled via the preset sizes <code>xs</code>, <code>sm</code>, <code>md</code>,
<code>lg</code>, <code>xl</code> or via the <code>width</code> and <code>height</code> props.</p>`,1),X=o("extra small"),Z=o("small"),oo=o("medium"),to=o("large"),eo=o("extra large"),no=o("disabled"),so=s("br",null,null,-1),ao=s("br",null,null,-1),lo=o("extra small"),ro=o("small"),co=o("medium"),io=o("large"),uo=o("extra large"),mo=o("disabled"),bo=o(`w-button.ma1(bg-color="secondary" xs) extra small
...
w-button.ma1(color="primary" outline disabled) disabled`),Po=o(`<w-button class="ma1" color="primary" outline xs>extra small</w-button>
...
`),Io=o("Text"),Bo=o("extra small"),Go=o("small"),Vo=o("medium"),Eo=o("large"),No=o("extra large"),Wo=o("disabled"),Ro=o(`w-button.ma1(color="primary" text xs) extra small
...
w-button.ma1(color="primary" text disabled) disabled`),Ho=o(`<w-button class="ma1" color="primary" text xs>extra small</w-button>
...
`),Mo=o("Round & tile"),Oo=o("round"),jo=o("round"),qo=o("tile"),Fo=o("tile"),Yo=o(`w-button.ma1(bg-color="primary" round) round
w-button.ma1.mr6(bg-color="secondary" round) round
w-button.ma1(bg-color="primary" tile) tile
w-button.ma1(bg-color="secondary" tile) tile`),Jo=o(`<w-button class="ma1" bg-color="primary" round>round</w-button>
...
`),Ko=o("Shadow"),Qo=o("success"),Uo=o("error"),Xo=o("warning"),Zo=o("info"),ot=o(`w-button.ma1(bg-color="success" shadow) success
