import{r as l,o as h,f as d,a as n,w as e,e as t,h as p,b as i,_,c1 as b}from"./index.6ba25376.js";const y=t("Basic"),k=t('w-timeline(:items="items")'),v=t('<w-timeline :items="items"></w-timeline>'),x=t(`data: () => ({
  items: [
