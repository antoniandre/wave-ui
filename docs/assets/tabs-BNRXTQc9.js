import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,xt as s}from"./runtime-core.esm-bundler-CLfruy3s.js";import{t as c}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{Q as l,c as u}from"./index-I7dyuwKt.js";var d={class:`ml2`},f={class:`green`},p={class:`pink mx1`},m=[`innerHTML`];function h(c,u,h,g,_,v){let y=n(`title-link`),b=n(`w-tabs`),x=n(`example`),S=n(`w-switch`),C=n(`alert`),w=n(`w-radios`),T=n(`w-button`),E=n(`w-flex`),D=n(`w-icon`),O=n(`w-input`);return e(),i(`div`,null,[a(y,{h2:``},{default:t(()=>[...u[9]||=[o(`Basic`,-1)]]),_:1}),a(x,null,{pug:t(()=>[...u[10]||=[o(`w-tabs(:items="tabs")`,-1)]]),html:t(()=>[...u[11]||=[o(`<w-tabs :items="tabs"></w-tabs>`,-1)]]),js:t(()=>[...u[12]||=[o(`data: () => ({
  tabs: [
...
strong
  | v-model:
  code.ml2 `+s(`{{ activeTab }}`),-1)]]),html:t(()=>[...u[26]||=[o(`<w-tabs v-model="activeTab" :items="tabs"></w-tabs>
...
`,-1)]]),default:t(()=>[a(b,{class:`mb2`,modelValue:c.tabs2.active,"onUpdate:modelValue":u[1]||=e=>c.tabs2.active=e,items:c.tabs2.items},null,8,[`modelValue`,`items`]),r(`strong`,null,[u[24]||=o(`v-model:`,-1),r(`code`,d,s(c.tabs2.active),1)])]),_:1}),a(y,{h2:``},{default:t(()=>[...u[28]||=[o(`Colors`,-1)]]),_:1}),u[85]||=r(`p`,null,[o(`Like in most components, you can set a `),r(`code`,null,`color`),o(` for the text and a `),r(`code`,null,`bg-color`),o(` for the
background. You can also set a `),r(`code`,null,`slider-color`),o(` and an `),r(`code`,null,`active-class`),o(`.
`)],-1),u[86]||=r(`div`,{class:`title3`},`Color & bg-color`,-1),a(x,null,{pug:t(()=>[o(`w-tabs(:items="tabs" color="blue" bg-color="`+s(c.$store.state.darkMode?`indigo-dark6`:`indigo-light5`)+`")`,1)]),html:t(()=>[o(`<w-tabs
  :items="tabs"
  color="blue"
  bg-color="`+s(c.$store.state.darkMode?`indigo-dark6`:`indigo-light5`)+`">
...
.w-app .w-tabs__bar {
  ...
  margin-bottom: 12px;
  padding: 0;
  background: `+s(c.$store.state.darkMode?`#181818`:`#eee`)+`;
  border-radius: 6px;
  border: 1px solid `+s(c.$store.state.darkMode?`#222`:`#ddd`)+`;
  z-index: 0;
  overflow: visible;
}
.w-app .w-tabs__slider {
  opacity: 1;
  background-color: `+s(c.$store.state.darkMode?`#2c2c2c`:`#fff`)+`;
  bottom: 0;
  height: 100%;
  border-radius: 6px;
...
.w-app .w-tabs__bar-item:before {
  ...
  border-left: 1px solid `+s(c.$store.state.darkMode?`#262626`:`#d2d2d2`)+`;
  display: block;
  opacity: 1;
}
...
w-tabs(:items="tabsCount")
  ...
  template(#item-content="{ index }") Content `+s(`{{ index }}`),-1)]]),html:t(()=>[...u[56]||=[o(`<w-flex class="mb3" align-center>
  Number of tabs:
  <w-button
    class="mx2"
    icon="wi-minus"
...
`,-1)]]),default:t(()=>[a(E,{class:`mb3`,"align-center":``},{default:t(()=>[u[54]||=o(`Number of tabs:`,-1),a(T,{class:`mx2`,icon:`wi-minus`,sm:``,onClick:u[4]||=e=>c.tabs3.tabsCount-=c.tabs3.tabsCount<1?0:1}),r(`code`,null,s(c.tabs3.tabsCount),1),a(T,{class:`mx2`,icon:`wi-plus`,sm:``,onClick:u[5]||=e=>c.tabs3.tabsCount++})]),_:1}),a(b,{items:c.tabs3.tabsCount},{"item-title":t(({index:e})=>[o(`Tab `+s(e),1)]),"item-content":t(({index:e})=>[o(`Content `+s(e),1)]),_:1},8,[`items`])]),_:1}),a(y,{h2:``},{default:t(()=>[...u[58]||=[o(`Card style tabs`,-1)]]),_:1}),a(x,null,{pug:t(()=>[...u[59]||=[o(`w-tabs(:items="tabs" card)`,-1)]]),html:t(()=>[...u[60]||=[o(`<w-tabs :items="tabs" card></w-tabs>`,-1)]]),js:t(()=>[...u[61]||=[o(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3 has a long title', content: 'Tab 3 content.' }
...
`,-1)]]),default:t(()=>[a(b,{items:c.tabs6.items,card:``},{"item-title":t(({item:e,index:t})=>[o(s(e.title),1),a(T,{class:`ml1 mr-1`,onClick:l(e=>c.tabs6.items.splice(t-1,1),[`stop`]),icon:`wi-cross`,outline:``,xs:``},null,8,[`onClick`])]),_:1},8,[`items`]),a(T,{class:`mt4`,"bg-color":`primary`,onClick:u[6]||=e=>c.tabs6.items=c.tabs6.originals.slice(0),disabled:c.tabs6.items.length===3},{default:t(()=>[...u[64]||=[o(`Reset tabs`,-1)]]),_:1},8,[`disabled`])]),_:1}),a(y,{h2:``},{default:t(()=>[...u[68]||=[o(`Customizing the tabs title & contents`,-1)]]),_:1}),a(x,null,{pug:t(()=>[...u[73]||=[o(`w-tabs(:items="tabs" card)
...
`,-1)]]),default:t(()=>[a(b,{items:c.tabs5,card:``},{"item-title":t(({item:e})=>[a(D,{class:`mr1 green`},{default:t(()=>[...u[69]||=[o(`mdi mdi-star`,-1)]]),_:1}),r(`span`,f,s(e.title),1)]),"item-title.3":t(({item:e})=>[a(D,{class:`pink`},{default:t(()=>[...u[70]||=[o(`mdi mdi-heart`,-1)]]),_:1}),r(`span`,p,s(e.title),1),a(D,{class:`pink`},{default:t(()=>[...u[71]||=[o(`mdi mdi-heart`,-1)]]),_:1})]),"item-content.1":t(({item:e})=>[u[72]||=r(`div`,{class:`title3`},`This is a custom tab content.`,-1),r(`div`,{innerHTML:e.content},null,8,m)]),_:1},8,[`items`])]),_:1}),a(y,{h2:``},{default:t(()=>[...u[76]||=[o(`Adding a tabs bar extra element`,-1)]]),_:1}),u[91]||=r(`p`,null,[o(`You can add extra elements at the right of the tabs title bar via the `),r(`code`,null,`tabs-bar-extra`),o(` slot.`),r(`br`),o(`
