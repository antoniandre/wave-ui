import{r as d,o as m,g as b,a as r,w as o,b as t,t as w,d as s,n as P,l as D,v as C,h as $,_ as f,L as O}from"./index.4a6c6b42.js";const V=s("p",null,[t("The "),s("strong",{class:"code"},"w-drawer"),t(` component can be placed in a deeper structure than the root of
...
The pushable content should be provided via the <code>pushable</code> slot.</p>`,1),j={class:"py12 w-flex column align-center justify-center"},R=s("p",{class:"mb3"},"Pushable content",-1),L=s("div",{class:"ma2"},"Drawer content",-1),B={class:"py12 w-flex column align-center justify-center"},_=s("p",{class:"mb3"},"Pushable content",-1),M=s("div",{class:"ma2"},"Drawer content",-1),U=s("span",null,"Open top drawer with a:",-1),I=s("p",{class:"mt4"},[s("strong",null,"Note:"),t(` with no overlay the underneath content will be clickable and the drawer
will not close.
...
`)]),default:o(()=>[r(c,{modelValue:e.openPushContentRightDrawer,"onUpdate:modelValue":n[9]||(n[9]=a=>e.openPushContentRightDrawer=a),"push-content":"","overlay-opacity":.15,width:"160px"},{pushable:o(()=>[s("div",j,[R,r(l,{onClick:n[8]||(n[8]=a=>e.openPushContentRightDrawer=!0),outline:""},{default:o(()=>[t("Open drawer")]),_:1})])]),default:o(()=>[L]),_:1},8,["modelValue"])]),_:1}),r(p,{"content-class":"relative pa0","blank-codepen":["css"]},{pug:o(()=>[t(`w-drawer(
  v-model="openDrawer"
  push-content
  :overlay-opacity="0.15"
  left
