...
`),G=d(`<p class="mt6">To use them on a particular breakpoint, the syntax is: <code>.[breakpoint][extend]-[class]</code>, with:</p><ul><li><strong class="code">[breakpoint]</strong> one of: <code>xs</code>, <code>sm</code>, <code>md</code>, <code>lg</code>, <code>xl</code>.</li><li><strong class="code">[extend]</strong> one of <code>u</code> (and up), <code>d</code> (and down) and
<strong>no character</strong> to target only this breakpoint.</li><li><strong class="code">[class]</strong> one of the above CSS class name.</li></ul>`,2),J=e("Note that "),M=t("code",null,".xsd-[class]",-1),O=e(" and "),X=t("code",null,".xlu-[class]",-1),H=e(" don't exist since they are the same as "),K=t("code",null,".xs-[class]",-1),P=e(" and "),Q=t("code",null,".xl-[class]",-1),Z=e("."),ee=t("p",{class:"mt6"},[e("In these two examples, resize your browser to less than 900px (default "),t("code",null,"md"),e(`) to see see the
...
})`);function fe(u,ge){const o=l("title-link"),r=l("router-link"),_=l("w-card"),i=l("example"),a=l("ssh-pre"),h=l("alert");return m(),p("main",null,[n(o,{class:"mt4",h1:""},{default:s(()=>[x]),_:1}),n(o,{h2:""},{default:s(()=>[g]),_:1}),b,t("ul",null,[y,t("li",null,[w,n(r,{class:"ml1",to:"/layout--grid-system"},{default:s(()=>[k]),_:1}),v]),t("li",null,[S,j,C,I,N,$,z,n(r,{class:"ml1",to:"/layout--flex"},{default:s(()=>[B]),_:1})])]),n(o,{h2:""},{default:s(()=>[U]),_:1}),L,n(o,{h2:"",slug:"the-wave-ui-breakpoint-object"},{default:s(()=>[R,T,V]),_:1}),W,n(i,null,{pug:s(()=>[e(`w-card.blue-light5--bg
  .title2
    | Current breakpoint:
