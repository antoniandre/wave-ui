import{r,g,o as w,b as o,a as l,e as n,w as t,_ as b,x as c}from"./index-CBPNvwPY.js";const x={class:"title2 red"},v={class:"mt6"},k={class:"mt2"},S={class:"mt2"};function A(a,e){const p=r("w-tag"),f=r("ssh-pre"),u=r("alert"),d=r("title-link"),i=r("example"),s=r("w-badge"),m=r("w-flex"),y=r("router-link");return w(),g("div",null,[o("div",x,[e[2]||(e[2]=n("Required in Wave UI ")),l(p,{class:"error--bg",round:""},{default:t(()=>e[0]||(e[0]=[n("< 3.0")])),_:1,__:[0]}),e[3]||(e[3]=n(", removed in ")),l(p,{class:"error--bg",round:""},{default:t(()=>e[1]||(e[1]=[n("3.0")])),_:1,__:[1]}),e[4]||(e[4]=n("."))]),e[63]||(e[63]=o("p",{class:"mt6"},[n("This tag is required in your app for Wave UI proper functioning."),o("br"),n(`
...
`)])),_:1,__:[5]},8,["dark"]),l(u,{class:"mt8 mb2",info:""},{default:t(()=>e[6]||(e[6]=[n("By default, the "),o("span",{class:"code"},"w-app",-1),n(` wrapper will have a flex layout with a column direction,
and a height of 100% of the full HTML document.`),o("br",null,null,-1)])),_:1,__:[6]}),e[65]||(e[65]=o("p",null,[n(`That will help a faster design in most cases, allowing a footer to always stick at the bottom
...
`)],-1)),l(d,{h2:""},{default:t(()=>e[7]||(e[7]=[n("Examples of common layouts")])),_:1,__:[7]}),e[66]||(e[66]=o("p",null,[n("You can explore the different examples source code and use one of them as a starter kit for your app."),o("br"),n(`
...
`)])),default:t(()=>[e[11]||(e[11]=o("fieldset",{class:"app w-flex column"},[o("legend",null,"w-app"),o("section",{class:"header"},"Header"),o("div",{class:"w-flex grow"},[o("section",{class:"nav-menu block"},"Nav menu"),o("section",{class:"content block grow"},"Main content")]),o("section",{class:"footer"},"Footer")],-1))]),_:1,__:[11]})]),_:1}),l(s,{"bg-color":"orange",color:"white",overlap:"","model-value":2},{default:t(()=>[l(i,{class:"ma0 grow","content-class":"pa0","blank-codepen":["html","pug","css"]},{pug:t(()=>e[12]||(e[12]=[n(`#app.row
  aside Nav menu
  w-flex(column)
    header Header
    main.grow Main content
...
aside {background-color: #fef2ff;}
main {background-color: #efffed;}
`)])),default:t(()=>[e[15]||(e[15]=o("fieldset",{class:"app w-flex column"},[o("legend",null,"w-app"),o("div",{class:"w-flex"},[o("section",{class:"nav-menu block"},"Nav menu"),o("div",{class:"w-flex column"},[o("section",{class:"header"},"Header"),o("section",{class:"content block grow"},"Main content"),o("section",{class:"footer"},"Footer")])])],-1))]),_:1,__:[15]})]),_:1}),l(s,{"bg-color":"orange",color:"white",overlap:"","model-value":3},{default:t(()=>[l(i,{class:"ma0 grow","content-class":"pa0","blank-codepen":["html","pug","css"]},{pug:t(()=>e[16]||(e[16]=[n(`#app
  header Header
  main.grow Main content
...
aside {background-color: #fef2ff;}
main {background-color: #efffed;}
`)])),default:t(()=>[e[19]||(e[19]=o("fieldset",{class:"app w-flex column"},[o("legend",null,"w-app"),o("section",{class:"header"},"Header"),o("section",{class:"content block grow"},"Main content"),o("section",{class:"footer"},"Footer")],-1))]),_:1,__:[19]})]),_:1}),l(s,{"bg-color":"orange",color:"white",overlap:"","model-value":4},{default:t(()=>[l(i,{class:"ma0 grow","content-class":"pa0","blank-codepen":["html","pug","css"]},{pug:t(()=>e[20]||(e[20]=[n(`#app.d-block
  header Header
  w-flex
...
aside {background-color: #fef2ff;}
main {background-color: #efffed;}
`)])),default:t(()=>[e[23]||(e[23]=o("fieldset",{class:"app grow"},[o("legend",null,"w-app"),o("section",{class:"header"},"Header"),o("div",{class:"w-flex"},[o("section",{class:"content block grow"},"Main content"),o("section",{class:"nav-menu block"},"Nav menu")])],-1))]),_:1,__:[23]})]),_:1})]),_:1}),o("ul",v,[o("li",null,[e[24]||(e[24]=n(`In the above cases
