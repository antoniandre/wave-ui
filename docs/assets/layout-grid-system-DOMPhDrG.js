import{r as d,o as l,g as t,a as r,w as p,b as a,d as i,h as $,F as n,k as x,t as y,n as h,f as v,_ as c}from"./index-DJW-wguP.js";const C={class:"xs4 pa1"},T={class:"xs3 pa1"},z={class:"xs2 pa1"},N={class:"title2 mt0"},S={class:"xs12 md6 lg4 xl2 pa1"},U={class:"primary-light3--bg py3"},V={class:"xs12 md6 lg4 xl2 pa1"},B={class:"primary-light3--bg py3"},F={class:"xs12 md6 lg4 xl2 pa1"},I={class:"primary-light3--bg py3"},R={class:"xs12 md6 lg4 xl2 pa1"},q={class:"primary-light3--bg py3"},G={class:"xs12 md6 lg4 xl2 pa1"},L={class:"primary-light3--bg py3"},M={class:"xs12 md6 lg4 xl2 pa1"},W={class:"primary-light3--bg py3"};function j(s,e){const o=d("title-link"),k=d("ssh-pre"),b=d("alert"),u=d("w-flex"),m=d("example"),f=d("w-card"),w=d("router-link");return l(),t("main",null,[r(o,{class:"mt4",h1:""},{default:p(()=>e[0]||(e[0]=[a("Grid system (flexbox)")])),_:1}),e[34]||(e[34]=i("div",{class:"title3"},"The grid system (using flexbox) is 12-cell based by default.",-1)),e[35]||(e[35]=i("p",null,[a(`Its purpose is to divide the available width (in percentage)
