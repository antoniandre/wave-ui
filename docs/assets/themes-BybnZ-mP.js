import{r as i,g as k,o as b,a as l,b as o,w as a,e as t,t as d,h as y,p as w,v as g,_ as $}from"./index-a7oKtucQ.js";const S={class:"title2"},T={class:"title2"},I={class:"title2"},M={class:"mt6"},W={class:"mt6"},c={class:"w-flex align-center"},C={class:"mt6"},U={class:"w-flex align-center"},j={class:"mt6"};function A(n,e,D,N,Y,P){const s=i("title-link"),r=i("ssh-pre"),u=i("w-icon"),f=i("w-flex"),m=i("example"),h=i("w-button"),p=i("alert");return b(),k("main",null,[l(s,{class:"mt4",h1:""},{default:a(()=>e[2]||(e[2]=[t("Themes")])),_:1}),e[43]||(e[43]=o("p",null,"Wave UI offers a light theme (by default) and a dark theme.",-1)),l(s,{h2:""},{default:a(()=>e[3]||(e[3]=[t("Setting an initial theme")])),_:1}),e[44]||(e[44]=o("p",null,"You can set a theme at Wave UI's initialization, with:",-1)),l(r,{language:"js",dark:n.$store.state.darkMode},{default:a(()=>e[4]||(e[4]=[t(`app.use(WaveUI, {
  theme: 'dark' // Or 'light' or 'auto'.
})
`)])),_:1},8,["dark"]),l(s,{h2:""},{default:a(()=>e[5]||(e[5]=[t("Accessing the current theme")])),_:1}),e[45]||(e[45]=o("p",null,[t("You can always read the currently applied theme from: "),o("code",null,"$waveui.theme"),t("."),o("br"),t(`
This means you can render or style elements conditionally based on the current theme.`)],-1)),l(m,null,{default:a(()=>[l(f,{class:"title1 align-center"},{default:a(()=>[t("The theme is: "+d(n.$waveui.theme),1),l(u,{class:"ml2 mt1",color:"yellow"},{default:a(()=>[t("mdi mdi-"+d(n.$waveui.theme==="dark"?"weather-night":"white-balance-sunny"),1)]),_:1})]),_:1})]),_:1}),l(s,{h2:""},{default:a(()=>e[6]||(e[6]=[t("Switching theme")])),_:1}),e[46]||(e[46]=o("p",null,[t("While running, you can still switch the theme very easily with: "),o("code",null,"$waveui.switchTheme('dark')"),t(".")],-1)),l(m,null,{pug:a(()=>e[11]||(e[11]=[t(`w-button(@click="$waveui.switchTheme('light')") Switch theme
`)])),default:a(()=>[l(h,{class:"ma1",onClick:e[0]||(e[0]=v=>(n.$waveui.switchTheme("light"),n.$store.commit("setDarkMode",!1)))},{default:a(()=>[l(u,{class:"mr1",color:"yellow"},{default:a(()=>e[7]||(e[7]=[t("mdi mdi-white-balance-sunny")])),_:1}),e[8]||(e[8]=t("Light theme"))]),_:1}),l(h,{class:"ma1",onClick:e[1]||(e[1]=v=>(n.$waveui.switchTheme("dark"),n.$store.commit("setDarkMode",!0)))},{default:a(()=>[l(u,{class:"mr1",color:"yellow"},{default:a(()=>e[9]||(e[9]=[t("mdi mdi-weather-night")])),_:1}),e[10]||(e[10]=t("Dark theme"))]),_:1})]),_:1}),l(s,{h2:""},{default:a(()=>e[12]||(e[12]=[t("Auto theme")])),_:1}),e[47]||(e[47]=o("p",null,`Wave UI can detect the user preferred theme and apply it without you to need to do anything else
...
variables.`)])),_:1}),l(s,{h3:""},{default:a(()=>e[19]||(e[19]=[t("Triggering an action on theme change")])),_:1}),e[50]||(e[50]=o("p",null,`triggering an action when the user changes the theme is easy because they will do it from one
...
`)])),_:1},8,["dark"]),l(s,{h2:"",slug:"adding-themes-in-your-wave-ui-app"},{default:a(()=>e[21]||(e[21]=[t("Adding themes in your Wave UI app that never had themes")])),_:1}),e[52]||(e[52]=o("p",null,[t(`If you never had 2 themes, you most likely have added colors in your CSS that will not look nice
...
}`)])),_:1},8,["dark"])]),o("li",W,[e[32]||(e[32]=t("If you have defined colors in the Wave UI configuration, define their best equivalent for the other theme:")),o("div",c,[l(r,{language:"js",label:"before",dark:n.$store.state.darkMode},{default:a(()=>e[29]||(e[29]=[t(`colors: {
  primary: '#0e9d39' // A dark green.
}`)])),_:1},8,["dark"]),l(u,{class:"grey ma2",xl:""},{default:a(()=>e[30]||(e[30]=[t("mdi mdi-arrow-right")])),_:1}),l(r,{language:"js",label:"after",dark:n.$store.state.darkMode},{default:a(()=>e[31]||(e[31]=[t(`colors: {
  light: {
    primary: '#0e9d39' // A dark green.
  },
  dark: {
...
$secondary: #666;`)])),_:1},8,["dark"]),l(u,{class:"grey ma2",xl:""},{default:a(()=>e[34]||(e[34]=[t("mdi mdi-arrow-right")])),_:1}),l(r,{language:"css",label:"after",dark:n.$store.state.darkMode},{default:a(()=>e[35]||(e[35]=[t(`$primary: var(--w-primary-color);
...
<a href="/colors#colors-and-themes">Colors and themes section of the colors page</a>.</p></li>`,1)),o("li",j,[e[39]||(e[39]=t("You may want to add a button to let the user switch theme:")),w(l(r,{language:"pug",dark:n.$store.state.darkMode},{default:a(()=>e[37]||(e[37]=[t(`w-button(
  ...
  @click="$waveui.switchTheme($waveui.theme === 'light' ? 'dark' : 'light')")`)])),_:1},8,["dark"]),[[g,n.$store.state.usePug]]),w(l(r,{language:"html-vue",dark:n.$store.state.darkMode},{default:a(()=>e[38]||(e[38]=[t(`<w-button
  fixed
  top
  right
  :icon="\`material-icons \${$waveui.theme === 'dark' ? 'light_mode' : 'dark_mode'}\`"
