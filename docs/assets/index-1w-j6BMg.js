import{r as g,o as h,g as b,a,w as n,b as t,d as i,t as u,c as z,f as T,_ as f,P as U}from"./index-D5hdT684.js";const R={class:"w-card w-flex mdu-row basis-zero pa4 gap4"},I={class:"mr5"},G={class:"w-flex wrap justify-center align-center"},S={class:"mr4 my2"},W={class:"w-flex gap6"};function E(s,e,v,c,y,m){const o=g("title-link"),d=g("w-divider"),p=g("alert"),l=g("w-image"),r=g("example"),x=g("w-card"),$=g("w-radios"),j=g("w-button"),k=g("w-alert");return h(),b("div",null,[a(o,{h2:""},{default:n(()=>e[2]||(e[2]=[t("Why using w-image and not a simple <img>")])),_:1}),i("div",R,[e[4]||(e[4]=i("div",null,[i("div",{class:"title3"},"A simple <img>"),i("p",null,[t("will display when loaded, and will take the dimensions of the actual image."),i("br"),t(`
