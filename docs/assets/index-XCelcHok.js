import{r as c,g as u,o as p,b as s,a as i,h as V,e as t,w as l,t as o,d as y,_ as f,W as I}from"./index-DyPyadtc.js";const j={class:"lists-demo"},A={class:"w-flex wrap"},S={class:"grow"},T={class:"grow"},$={class:"w-flex align-center justify-space-between"},E={key:0},W={class:"code"},D={class:"title3 mt2"},U={key:0,class:"ml2"},N={key:1,class:"ml2"},P={class:"grow"},z={class:"grow"},K={class:"grow"},M={class:"grow"};function O(n,e,h,g,k,b){const m=c("w-list"),r=c("title-link"),d=c("example"),w=c("w-icon"),C=c("w-radios"),v=c("w-flex"),x=c("router-view");return p(),u("div",j,[e[65]||(e[65]=s("p",null,[t("The "),s("span",{class:"code"},"w-list"),t(" component has multiple uses:")],-1)),i(m,{items:4,icon:"wi-check"},{"item.1":l(()=>e[8]||(e[8]=[t("Simple list with or without icons",-1)])),"item.2":l(()=>e[9]||(e[9]=[t("Checklists",-1)])),"item.3":l(()=>e[10]||(e[10]=[t("Navigation menus",-1)])),"item.4":l(()=>e[11]||(e[11]=[t("List of selectable items",-1)])),_:1}),i(r,{h2:""},{default:l(()=>e[12]||(e[12]=[t("Basic lists",-1)])),_:1,__:[12]}),i(d,null,{pug:l(()=>e[15]||(e[15]=[t(`.w-flex.wrap
  .grow
    .title3 Most basic
    w-list(:items="items")
  .grow
    .title3 With icons
    w-list(:items="items" icon="wi-check")`,-1)])),html:l(()=>e[16]||(e[16]=[t(`<w-flex wrap>
  <div class="grow">
...
</w-flex>`,-1)])),js:l(()=>e[17]||(e[17]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' },
...
`,-1)])),default:l(()=>[s("div",A,[s("div",S,[e[13]||(e[13]=s("div",{class:"title3"},"Most basic",-1)),i(m,{items:n.listItems1},null,8,["items"])]),s("div",T,[e[14]||(e[14]=s("div",{class:"title3"},"With icons",-1)),i(m,{items:n.listItems1,icon:"wi-check"},null,8,["items"])])])]),_:1}),i(r,{h2:""},{default:l(()=>e[18]||(e[18]=[t("Color & hoverable",-1)])),_:1,__:[18]}),e[66]||(e[66]=s("p",null,[t("Like in most components, you can set a "),s("code",null,"color"),t(" for the text and a "),s("code",null,"bg-color"),t(` for the
background.`)],-1)),i(d,null,{pug:l(()=>e[19]||(e[19]=[t(`w-list(:items="items" color="pink" hover)
br
w-list(:items="items" bg-color="blue-light5" color="primary" hover)`,-1)])),html:l(()=>e[20]||(e[20]=[t(`<w-list
  :items="items"
  color="pink"
  hover>
</w-list>
...
<w-list
  ...
  color="primary"
  hover>
</w-list>`,-1)])),js:l(()=>e[21]||(e[21]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' },
...
`,-1)])),default:l(()=>[i(m,{items:n.listItems4,color:"pink",hover:""},null,8,["items"]),e[22]||(e[22]=s("br",null,null,-1)),i(m,{items:n.listItems4,"bg-color":"blue-light5",color:"primary",hover:""},null,8,["items"])]),_:1,__:[22]}),i(r,{h3:""},{default:l(()=>e[23]||(e[23]=[t("Different color per item",-1)])),_:1,__:[23]}),i(d,null,{pug:l(()=>e[24]||(e[24]=[t('w-list(:items="items" hover)',-1)])),html:l(()=>e[25]||(e[25]=[t('<w-list :items="items" hover></w-list>',-1)])),js:l(()=>e[26]||(e[26]=[t(`data: () => ({
  items: [
...
`,-1)])),default:l(()=>[i(m,{items:n.listItems5,hover:""},null,8,["items"])]),_:1}),i(r,{h3:""},{default:l(()=>e[27]||(e[27]=[t("Selection-only color",-1)])),_:1,__:[27]}),e[67]||(e[67]=V(`<p class="grey-light1">In addition to the hover effect, the items may also be selectable (as per the
...
<code>selection-color</code> to a falsy value (false, null, or empty string), or another color.</p>`,3)),i(d,null,{pug:l(()=>e[28]||(e[28]=[t(`w-list(
  ...
  multiple)`,-1)])),html:l(()=>e[29]||(e[29]=[t(`<w-list
  :model-value="['Item 2']"
  :items="items"
  selection-color="pink"
  multiple>
</w-list>`,-1)])),js:l(()=>e[30]||(e[30]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' },
...
`,-1)])),default:l(()=>[i(m,{"model-value":["Item 2"],items:n.listItems4,"selection-color":"pink",multiple:""},null,8,["items"])]),_:1}),i(r,{h2:""},{default:l(()=>e[31]||(e[31]=[t("Custom rendering",-1)])),_:1,__:[31]}),e[68]||(e[68]=s("p",null,[t("In this example, we don't use the component's data at all."),s("br"),t(`
...
list item just like in this example.`)],-1)),i(d,null,{pug:l(()=>e[33]||(e[33]=[t(`w-list(:items="5" hover)
  template(#item="{ index }")
    | Item `+o("{{ index }}")+`
  template(#item.3)
    strong This is the great item #3`,-1)])),html:l(()=>e[34]||(e[34]=[t(`<w-list :items="5" hover>
  <template #item="{ index }">`+o("{{ index }}")+`</template>
  <template #item.3>
    <strong>This is the great item #3</strong>
  </template>
</w-list>
`,-1)])),default:l(()=>[i(m,{items:5,hover:""},{item:l(({index:a})=>[t("Item "+o(a),1)]),"item.3":l(()=>e[32]||(e[32]=[s("strong",null,"This is the great item #3",-1)])),_:1})]),_:1}),e[69]||(e[69]=s("p",null,[t("It's up to you to define your your list contents in the component's data or directly in the template."),s("br"),t(`
In this example each item has a different icon stored in the data object.`)],-1)),i(d,null,{pug:l(()=>e[35]||(e[35]=[t(`w-list(:items="items" hover)
  template(#item="{ item }")
    w-flex(align-center justify-space-between)
      | `+o("{{ item.label }}")+`
      w-icon(md) `+o("{{ item.icon }}"),-1)])),html:l(()=>e[36]||(e[36]=[t(`<w-list :items="items" hover>
  <template #item="{ item }">
    <w-flex align-center justify-space-between>
      `+o("{{ item.label }}")+`
...
</w-list>`,-1)])),js:l(()=>e[37]||(e[37]=[t(`data: () => ({
  items: [
...
`,-1)])),default:l(()=>[i(m,{items:n.listItems2,hover:""},{item:l(({item:a})=>[s("div",$,[t(o(a.label),1),i(w,{md:""},{default:l(()=>[t(o(a.icon),1)]),_:2},1024)])]),_:1},8,["items"])]),_:1}),i(r,{h2:""},{default:l(()=>e[38]||(e[38]=[t("Selectable list items",-1)])),_:1,__:[38]}),e[70]||(e[70]=s("p",null,[t("If you provide a "),s("code",null,"v-model"),t(" or a "),s("code",null,"model-value"),t(", the list items become selectable.")],-1)),i(d,null,{pug:l(()=>e[42]||(e[42]=[t(`w-radios.mb6(v-model="multiple" :items="radios" inline)
...
.title3.mt2
  ...
  code.ml2(v-else-if="multiple").
    `+o("{{ selection ? [selection] : '[]' }}"),-1)])),html:l(()=>e[43]||(e[43]=[t(`<w-radios v-model="multiple" :items="radios" inline></w-radios>
...
<div class="title3 mt2">
  ...
  selection: 2,
  itemClicked: null
})`,-1)])),default:l(()=>[i(C,{class:"mb6",modelValue:n.multiple,"onUpdate:modelValue":e[0]||(e[0]=a=>n.multiple=a),items:n.radios,inline:""},null,8,["modelValue","items"]),i(v,{wrap:"","align-center":""},{default:l(()=>[i(m,{class:"grow mr4",modelValue:n.selection1,"onUpdate:modelValue":e[1]||(e[1]=a=>n.selection1=a),items:n.listItems1,color:"deep-purple",multiple:n.multiple,onItemClick:e[2]||(e[2]=a=>n.itemClicked=a)},null,8,["modelValue","items","multiple"]),n.itemClicked?(p(),u("div",E,[e[39]||(e[39]=s("div",{class:"title3"},[t("clicked item ("),s("span",{class:"code"},"item-click"),t(" event):")],-1)),e[40]||(e[40]=s("br",null,null,-1)),s("span",W,o(n.itemClicked),1)])):y("",!0)]),_:1}),s("div",D,[e[41]||(e[41]=t("Selected item:",-1)),!n.multiple||Array.isArray(n.selection1)?(p(),u("code",U,o(n.selection1||"null"),1)):n.multiple?(p(),u("code",N,o(n.selection1?[n.selection1]:"[]"),1)):y("",!0)])]),_:1}),e[71]||(e[71]=s("p",null,[t("Note: you can get the list selection from the v-model, or by listening to the "),s("span",{class:"code"},"input"),t(" event.")],-1)),i(r,{h2:""},{default:l(()=>e[45]||(e[45]=[t("Checklists",-1)])),_:1,__:[45]}),i(d,null,{pug:l(()=>e[52]||(e[52]=[t(`w-flex(wrap basis-zero :gap="3")
  .grow
    .title3.mb4 Default
    w-list(
      v-model="selection1"
  ...
  .grow
    ...
    w-list.custom(
      ...
      template(#item="{ item }")
        span `+o("{{ item.label }}")+`
        .spacer
        w-icon(md) `+o("{{ item.icon }}"),-1)])),html:l(()=>e[53]||(e[53]=[t(`<w-flex wrap basis-zero :gap="3">
  <div class="grow">
...
</w-flex>`,-1)])),js:l(()=>e[54]||(e[54]=[t(`data: () => ({
  listItems1: [
    { label: 'Item 1', value: 1 },
    { label: 'Item 2', value: 2 },
    { label: 'Item 3', value: 3 },
...
})`,-1)])),css:l(()=>e[55]||(e[55]=[t(`.w-list.custom .w-list__item-label:before {display: none;}
...
`,-1)])),default:l(()=>[i(m,{modelValue:n.selection5,"onUpdate:modelValue":e[7]||(e[7]=a=>n.selection5=a),items:n.listItems5,checklist:""},null,8,["modelValue","items"])]),_:1}),i(r,{h2:""},{default:l(()=>e[60]||(e[60]=[t("Navigation lists",-1)])),_:1,__:[60]}),e[73]||(e[73]=s("p",null,[t("The navigation list expects a "),s("code",null,"route"),t(" attribute in the items that are links."),s("br"),t(`
If you are using Vue Router, all the links will automatically be `),s("strong",{class:"code"},"router-link"),t("s."),s("br")],-1)),e[74]||(e[74]=s("p",null,[t("It is possible to disable a link with a "),s("code",null,"disabled: true"),t(" attribute in the item.")],-1)),i(d,null,{pug:l(()=>e[62]||(e[62]=[t(`w-list(:items="items" nav color="primary")
  template(#item="{ item }")
    span `+o("{{ item.label }")+`}
    .spacer
    w-icon(md) `+o("{{ item.icon }}"),-1)])),html:l(()=>e[63]||(e[63]=[t(`<w-list :items="items" nav color="primary">
  <template #item="{ item }">
    <span>`+o("{{ item.label }}")+`</span>
    <div class="spacer"></div>
    <w-icon md>`+o("{{ item.icon }}")+`</w-icon>
  </template>
</w-list>`,-1)])),js:l(()=>e[64]||(e[64]=[t(`data: () => ({
  items: [
