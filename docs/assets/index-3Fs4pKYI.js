import{r,g as h,o as v,b as i,a,w as n,e as o,p as T,t as l,m as V,v as C,d as E,_ as k,O as g,V as A}from"./index-DyPyadtc.js";const B={class:"w-flex align-center"},H={class:"xs6 md4 lg3"},U={class:"ml2"},D={key:0,class:"ml2"},x={class:"mt4"},z={class:"ml1",href:"https://vuejs.org/guide/built-ins/transition.html"},O={class:"ml2"};function W(e,t,$,S,N,p){const u=r("alert"),m=r("w-list"),d=r("title-link"),w=r("ssh-pre"),f=r("w-button"),b=r("example"),c=r("w-radios"),M=r("w-icon"),y=r("w-notification"),I=r("w-input"),P=r("w-flex"),j=r("w-tabs");return v(),h("div",null,[t[86]||(t[86]=i("div",{class:"title3 my6"},"You have the choice to use one or the other, or both.",-1)),a(j,{class:"mt4",items:2,"content-class":"pl4","model-value":"0"},{"item-title.1":n(()=>t[16]||(t[16]=[o("Notification manager",-1)])),"item-content.1":n(()=>[t[54]||(t[54]=i("p",null,[o("The built-in notification manager can be used via "),i("code",null,"$waveui.notify()"),o(" from any component."),i("br")],-1)),a(u,{tip:""},{default:n(()=>t[17]||(t[17]=[o("Note that you can access the ",-1),i("code",null,"$waveui",-1),o(" object with ",-1),i("code",null,"const $waveui = inject('$waveui')",-1),o(" in composition API, or from ",-1),i("code",null,"this",-1),o(" if not using the composition API.",-1)])),_:1,__:[17]}),t[55]||(t[55]=i("div",{class:"title3"},"Pros",-1)),a(m,{icon:"wi-check",items:2},{"item.1":n(()=>t[18]||(t[18]=[o("Very convenient and fast to use",-1)])),"item.2":n(()=>t[19]||(t[19]=[o("Handles the stacking of simultaneous notifications",-1)])),_:1}),t[56]||(t[56]=i("div",{class:"title3 mt4"},"Cons",-1)),a(m,{icon:"wi-minus",items:1},{"item.1":n(()=>t[20]||(t[20]=[o("Less flexible than ",-1),i("strong",{class:"code mx1"},"w-notification",-1),o(` in terms of layout (no slot available)
`,-1)])),_:1}),a(d,{h2:""},{default:n(()=>t[21]||(t[21]=[o("Simple use of the notify method",-1)])),_:1,__:[21]}),t[57]||(t[57]=i("p",null,"The notify method takes up to 3 parameters, here is the syntax:",-1)),a(w,{language:"js",dark:e.$store.state.darkMode},{default:n(()=>t[22]||(t[22]=[o("$waveui.notify({String} message, {String} type?, {Number} timeout?)",-1)])),_:1,__:[22]},8,["dark"]),t[58]||(t[58]=i("p",null,[o("Access "),i("code",null,"$waveui"),o(" in composition API, or from "),i("code",null,"this"),o(" if not using the composition API.")],-1)),a(w,{language:"js",dark:e.$store.state.darkMode},{default:n(()=>t[23]||(t[23]=[o(`import { inject } from 'vue'
const $waveui = inject('$waveui')`,-1)])),_:1,__:[23]},8,["dark"]),t[59]||(t[59]=i("p",null,[o("The default type is "),i("code",null,"info"),o(" and the default timeout is "),i("code",null,"4000"),o("."),i("br"),o(`
...
w-button.ma1(@click="$waveui.notify&#40;'Error :(', 'error', 0&#41;" bg-color="error") Permanent error`,-1)])),html:n(()=>t[29]||(t[29]=[o(`<w-button @click="$waveui.notify('Information.')" bg-color="info">
  Notify info
</w-button>
...
`,-1)])),default:n(()=>[a(f,{class:"ma1",onClick:t[0]||(t[0]=s=>e.$waveui.notify("Information.")),"bg-color":"info"},{default:n(()=>t[24]||(t[24]=[o("Notify info",-1)])),_:1,__:[24]}),a(f,{class:"ma1",onClick:t[1]||(t[1]=s=>e.$waveui.notify("Success!","success")),"bg-color":"success"},{default:n(()=>t[25]||(t[25]=[o("Notify success",-1)])),_:1,__:[25]}),a(f,{class:"ma1",onClick:t[2]||(t[2]=s=>e.$waveui.notify("Warning!","warning")),"bg-color":"warning"},{default:n(()=>t[26]||(t[26]=[o("Notify warning",-1)])),_:1,__:[26]}),a(f,{class:"ma1",onClick:t[3]||(t[3]=s=>e.$waveui.notify("Error :(","error",0)),"bg-color":"error"},{default:n(()=>t[27]||(t[27]=[o("Permanent error",-1)])),_:1,__:[27]})]),_:1}),a(d,{h2:""},{default:n(()=>t[30]||(t[30]=[o("If you need more control",-1)])),_:1,__:[30]}),t[60]||(t[60]=i("p",null,[o("The "),i("code",null,"notify"),o(` method also accepts a single Object parameter which will accept all the options
...
`,-1)])),_:1,__:[31]},8,["dark"]),t[61]||(t[61]=i("p",null,[o("Here is an example of a custom notification using a few different "),i("strong",{class:"code"},"w-alert"),o(` options.
`)],-1)),a(b,null,{pug:n(()=>t[33]||(t[33]=[o('w-button(@click="notify" bg-color="info") Notify custom',-1)])),html:n(()=>t[34]||(t[34]=[o(`<w-button @click="notify" bg-color="info">
  Notify custom
</w-button>`,-1)])),js:n(()=>t[35]||(t[35]=[o(`methods: {
  notify () {
    $waveui.notify({
      message: 'Warning',
      timeout: 6000,
...
`,-1)])),default:n(()=>[a(f,{onClick:p.notify,"bg-color":"info"},{default:n(()=>t[32]||(t[32]=[o("Notify custom",-1)])),_:1,__:[32]},8,["onClick"])]),_:1}),a(u,{class:"mt12",warning:""},{default:n(()=>t[36]||(t[36]=[i("div",{class:"title4"},[i("strong",null,"Caution:"),o(" You could easily cause an "),i("strong",{class:"black"},"infinite loop"),o(` by triggering a
...
`,-1)])),_:1,__:[36]}),a(d,{h2:""},{default:n(()=>t[37]||(t[37]=[o("Notification manager tweaking",-1)])),_:1,__:[37]}),t[62]||(t[62]=i("p",null,`The global configuration allows you to override the default side and transition of the
...
`,-1)])),_:1,__:[38]},8,["dark"]),a(d,{h3:""},{default:n(()=>t[39]||(t[39]=[o("Align to the left or right",-1)])),_:1,__:[39]}),t[63]||(t[63]=i("p",null,[o("Change the value of the "),i("strong",{class:"code"},"align"),o(" option, in the above global config, to "),i("code",null,"left"),o(`
or `),i("code",null,"right"),o(".")],-1)),a(f,{onClick:p.switchNotificationManagerSide},{default:n(()=>t[40]||(t[40]=[o("Change side & notify",-1)])),_:1,__:[40]},8,["onClick"]),a(u,{tip:""},{default:n(()=>t[41]||(t[41]=[o(`After switching side, you can also test the different notifications from the above examples.
`,-1)])),_:1,__:[41]}),a(d,{h3:""},{default:n(()=>t[42]||(t[42]=[o("Different transitions",-1)])),_:1,__:[42]}),t[64]||(t[64]=i("p",null,[o("The default transition is "),i("code",null,"slide-left"),o(` when the notification manager is on the right and
`),i("code",null,"slide-right"),o(` when it's on the left.
`)],-1)),t[65]||(t[65]=i("div",{class:"title4"},"Pick a transition",-1)),i("div",B,[i("div",H,[a(c,{class:"ma1",modelValue:e.notifManagerTransition,"onUpdate:modelValue":t[4]||(t[4]=s=>e.notifManagerTransition=s),items:e.transitionsForManager,onInput:p.switchNotifMgrTransition},{item:n(({item:s})=>[i("code",U,l(s.value||(s.value===!1?"false":"''")),1),s.value?E("",!0):(v(),h("span",D,"("+l(s.label)+")",1))]),_:1},8,["modelValue","items","onInput"])]),a(f,{class:"ma1",onClick:t[5]||(t[5]=s=>e.$waveui.notify("Test"))},{default:n(()=>t[43]||(t[43]=[o("Notify",-1)])),_:1,__:[43]})]),i("p",x,[t[44]||(t[44]=o("Change the value of the ",-1)),t[45]||(t[45]=i("strong",{class:"code"},"transition",-1)),t[46]||(t[46]=o(` option, in the above global config,
to `,-1)),i("code",null,l(e.notifManagerTransition?`'${e.notifManagerTransition}'`:e.notifManagerTransition),1),t[47]||(t[47]=o(".",-1))]),a(u,{tip:""},{default:n(()=>[t[50]||(t[50]=o("You could even",-1)),i("a",z,[t[49]||(t[49]=o("create your own transition",-1)),a(M,{class:"ml1",md:""},{default:n(()=>t[48]||(t[48]=[o("mdi mdi-open-in-new",-1)])),_:1,__:[48]})]),t[51]||(t[51]=o(".",-1))]),_:1,__:[50,51]}),a(d,{h3:""},{default:n(()=>t[52]||(t[52]=[o("Styling",-1)])),_:1,__:[52]}),t[66]||(t[66]=i("p",null,[o("By default, the notification manager is 280px-wide and all the notifications will inherit this width."),i("br"),o(`
...
`,-1)])),_:1,__:[53]},8,["dark"])]),"item-title.2":n(()=>t[67]||(t[67]=[i("span",{class:"code"},"w-notification",-1)])),"item-content.2":n(()=>[a(u,{info:""},{default:n(()=>t[68]||(t[68]=[o("The ",-1),i("span",{class:"code"},"w-notification",-1),o(" component is pretty much a wrapper around the ",-1),i("span",{class:"code"},"w-alert",-1),o(`
component with added functionalities.`,-1),i("br",null,null,-1),o(`
it accepts all the parameters of the `,-1),i("span",{class:"code"},"w-alert",-1),o(` component, plus positioning,
transitioning & timeout options.
`,-1)])),_:1,__:[68]}),a(d,{h2:""},{default:n(()=>t[69]||(t[69]=[o("Notification position",-1)])),_:1,__:[69]}),t[83]||(t[83]=i("p",null,"Notifications have a fixed position by default (positioned relative to the viewport).",-1)),a(b,{"content-class":"mt2"},{pug:n(()=>t[70]||(t[70]=[o(`w-button.mr6(
...
w-notification(
  ...
  | The alert is fixed on `+l("{{ notification.position[0] }}")+" "+l("{{ notification.position[1] }}")+".",-1)])),html:n(()=>t[71]||(t[71]=[o(`<w-button
  class="mr6"
  @click="notification.show = !notification.show"
  color="primary"
  outline
...
</w-notification>`,-1)])),js:n(()=>t[72]||(t[72]=[o(`data: () => ({
  notification: {
    show: false,
    position: ['bottom', 'right']
  }
})
`,-1)])),default:n(()=>[a(f,{class:"mr6",onClick:t[6]||(t[6]=s=>e.notification.show=!e.notification.show),color:"primary",outline:"",width:"8.5em"},{default:n(()=>[o(l(e.notification.show?"Hide":"Show")+" notification",1)]),_:1}),a(c,{class:"my1 mr6",modelValue:e.notification.position[0],"onUpdate:modelValue":t[7]||(t[7]=s=>e.notification.position[0]=s),items:[{label:"top"},{label:"bottom"}],inline:""},null,8,["modelValue"]),a(c,{class:"my1",modelValue:e.notification.position[1],"onUpdate:modelValue":t[8]||(t[8]=s=>e.notification.position[1]=s),items:[{label:"left"},{label:"center"},{label:"right"}],inline:""},null,8,["modelValue"]),T(a(y,V({success:"",plain:"",round:"",shadow:"",transition:"bounce"},{[e.notification.position[0]]:!0,[e.notification.position[1]]:!0}),{default:n(()=>[o("The alert is fixed on "+l(e.notification.position[0])+" "+l(e.notification.position[1])+".",1)]),_:1},16),[[C,e.notification.show]])]),_:1}),a(d,{h2:""},{default:n(()=>t[73]||(t[73]=[o("Notification timeout",-1)])),_:1,__:[73]}),t[84]||(t[84]=i("p",null,"Notifications have no timeout by default. But you can add one to hide the notification by itself after some time.",-1)),t[85]||(t[85]=i("p",null,[o("Setting the timeout to "),i("code",null,"0"),o(" as a number or a string will cancel the timeout and the notification will stay visible.")],-1)),a(b,{"content-class":"mt2 relative ovh"},{pug:n(()=>t[74]||(t[74]=[o(`w-button.mr6(
...
w-notification(
  ...
  absolute)
  | This alert is
  | `+l("{{ parseInt(timeout) ? `auto-hiding after ${timeout} ms` : 'not auto-hiding'}}")+".",-1)])),html:n(()=>t[75]||(t[75]=[o(`<w-button
  class="mr6"
  @click="showNotification = !showNotification"
  color="primary"
  outline
...
w-notification(
  ...
  :[notification.position[0]]="true"
  :[notification.position[1]]="true")
  | The alert is fixed on `+l("{{ notification.position[0] }}")+" "+l("{{ notification.position[1] }}")+".",-1)])),html:n(()=>t[80]||(t[80]=[o(`<w-flex wrap align-center>
  <w-button
    class="mr3"
    @click="notification.show = !notification.show"
    color="primary"
...
<w-notification
  ...
  :[notification.position[1]]="true">
  The alert is fixed on `+l("{{ notification.position[0] }}")+" "+l("{{ notification.position[1] }}")+`.
</w-notification>`,-1)])),js:n(()=>t[81]||(t[81]=[o(`data: () => ({
  notification: {
    show: false,
    position: ['bottom', 'right']
  },
