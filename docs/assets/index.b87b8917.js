import{n as o,J as l}from"./index.601dd7c5.js";import"./vendor.4f8da9ec.js";var d=function(){var t=this,a=t.$createElement,e=t._self._c||a;return e("div",[e("title-link",{attrs:{h2:""}},[t._v("Basic")]),e("example",{scopedSlots:t._u([{key:"html",fn:function(){return[t._v('<w-tabs :items="tabs"></w-tabs>')]},proxy:!0},{key:"js",fn:function(){return[t._v(`data: () => ({
  tabs: [
...
}`)]},proxy:!0}])},[e("w-tabs",{ref:"tabs",attrs:{items:t.tabs8},scopedSlots:t._u([{key:"item-content",fn:function(n){var s=n.item;return[e("w-input",{staticClass:"my6",attrs:{label:"Tab title"},on:{keyup:t.onTitleChange},model:{value:s.title,callback:function(i){t.$set(s,"title",i)},expression:"item.title"}})]}}])})],1)],1)},m=[function(){var t=this,a=t.$createElement,e=t._self._c||a;return e("p",[t._v("It is possible to open a particular tab programmatically via "),e("code",[t._v("v-model")]),t._v(" or "),e("code",[t._v("value")]),t._v(".")])},function(){var t=this,a=t.$createElement,e=t._self._c||a;return e("p",[t._v("Like in most components, you can set a "),e("code",[t._v("color")]),t._v(" for the text and a "),e("code",[t._v("bg-color")]),t._v(` for the
