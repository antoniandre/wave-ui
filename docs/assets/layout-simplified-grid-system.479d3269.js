import{r as t,o as i,e as c,f as s,w as n,F as a,z as _,i as o,g as e}from"./vendor.e64646cc.js";import{_ as f}from"./index.cb32932c.js";const m=o("Simplified grid system (CSS grids)"),g=o(`The 12-cell based flexbox grid system works well and for most cases, but it has
...
.box {
  ...
  border: 1px solid #b2c2f0;
  padding: 12px;
}`);function $(no,eo){const d=t("title-link"),p=t("router-link"),h=t("alert"),l=t("w-grid"),r=t("example");return i(),c("main",null,[s(d,{class:"mt4",h1:""},{default:n(()=>[m]),_:1}),s(h,{info:""},{default:n(()=>[g,s(p,{to:"/layout--flex#caveat"},{default:n(()=>[b]),_:1}),x,w,v,y,k,S,C,T,j,B,G,N,V,F,H,z,D]),_:1}),s(d,{h2:""},{default:n(()=>[E]),_:1}),I,s(r,null,{pug:n(()=>[U]),html:n(()=>[W]),css:n(()=>[q]),default:n(()=>[s(l,{class:"wrapper",columns:"6"},{default:n(()=>[(i(),c(a,null,_(12,u=>e("div",L)),64))]),_:1})]),_:1}),s(d,{h2:""},{default:n(()=>[A]),_:1}),s(r,null,{pug:n(()=>[K]),html:n(()=>[M]),css:n(()=>[O]),default:n(()=>[s(l,{class:"wrapper",columns:"6",gap:"3"},{default:n(()=>[(i(),c(a,null,_(12,u=>e("div",J)),64))]),_:1})]),_:1}),s(d,{h2:""},{default:n(()=>[P]),_:1}),Q,s(r,null,{pug:n(()=>[X]),html:n(()=>[Y]),css:n(()=>[Z]),default:n(()=>[s(l,{class:"wrapper",columns:{xs:1,sm:2,md:3,lg:4,xl:6},gap:"3"},{default:n(()=>[(i(),c(a,null,_(12,u=>e("div",R)),64))]),_:1})]),_:1})])}const oo={};var io=f(oo,[["render",$]]);export{io as default};
