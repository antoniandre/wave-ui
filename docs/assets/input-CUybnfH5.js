import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,m as s,xt as c}from"./runtime-core.esm-bundler-CLfruy3s.js";import{t as l}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{B as u,w as d}from"./index-I7dyuwKt.js";import{t as f}from"./axios-CPQXLuf3.js";var p={class:`grow mb4`,style:{"min-width":`200px`}},m={class:`grow mb4`,style:{"min-width":`200px`}},h={class:`grow mb4`,style:{"min-width":`200px`}},g={class:`grow mb4`,style:{"min-width":`200px`}},_={class:`mt3`},v={class:`mt3`},y={class:`my4`},b={class:`ml2`},x={class:`input-types`},S={class:`mt4`},C={class:`mt4`},w={class:`mt4`},T={class:`mt4`},E={class:`mt4`},D={class:`mt4`},O={class:`mt4`},k={class:`mt4`},A={class:`mt4`},j={class:`other-input-types`},M={class:`mt1`},N={class:`mt1`};function P(l,u,d,f,P,F){let I=n(`title-link`),L=n(`w-input`),R=n(`example`),z=n(`w-flex`),B=n(`alert`),V=n(`w-icon`),H=n(`w-button`),U=n(`w-form`),W=n(`ssh-pre`),G=n(`w-tag`);return e(),i(`div`,null,[a(I,{h2:``},{default:t(()=>[...u[7]||=[o(`Default`,-1)]]),_:1}),u[145]||=r(`p`,null,[o(`By default the `),r(`span`,{class:`code`},`w-input`),o(` component has a label inside the input field, that moves up
...
`,-1)]]),default:t(()=>[a(L,{class:`mb4`,label:`Label`}),a(L,{class:`mb4`,placeholder:`Placeholder`}),a(L,{class:`mb4`,label:`Label`,placeholder:`Placeholder`})]),_:1}),a(I,{h2:``},{default:t(()=>[...u[14]||=[o(`Static label`,-1)]]),_:1}),u[146]||=r(`p`,null,[o(`By default the label is positioned inside and on field focus, it will move up above the field
and shrink.`),r(`br`),o(`
It is possible to keep it inside and disable the animation with the `),r(`code`,null,`static-label`),o(` option.`)],-1),u[147]||=r(`p`,{class:`mt4`},[r(`strong`,null,`Note:`),o(` If this option is set to true and the label is positioned inside when a placeholder is set,
...
`,-1)]]),default:t(()=>[a(L,{type:`file`},{default:t(()=>[...u[58]||=[o(`File`,-1)]]),_:1})]),_:1}),a(I,{h3:``},{default:t(()=>[...u[61]||=[o(`Disabled preview`,-1)]]),_:1}),u[153]||=r(`p`,null,[o(`The file preview can be disabled if not needed by setting the `),r(`code`,null,`preview`),o(` prop to
...
`,-1)]]),default:t(()=>[a(L,{type:`file`,preview:!1},{default:t(()=>[...u[62]||=[o(`File`,-1)]]),_:1})]),_:1}),a(I,{h3:``},{default:t(()=>[...u[65]||=[o(`Custom preview icon`,-1)]]),_:1}),u[154]||=r(`p`,null,[o(`By default, when the file is not an image, the preview will be a generic file icon.`),r(`br`),o(`
...
`,-1)]]),default:t(()=>[a(L,{type:`file`,preview:`mdi mdi-star`},{default:t(()=>[...u[66]||=[o(`File`,-1)]]),_:1})]),_:1}),u[155]||=r(`p`,null,`You could even compute a variable to show a different icon per detected file type.`,-1),a(R,null,{pug:t(()=>[...u[70]||=[o(`w-input(
  type="file"
  v-model="file"
...
pre.mt3 `+c(`{{ file }}`),-1)]]),html:t(()=>[...u[77]||=[o(`<w-input type="file" @input="onFileInput>File</w-input>

<pre class="mt3">`+c(`{{ files }}`)+`</pre>`,-1)]]),js:t(()=>[...u[78]||=[o(`data: () => ({
  file: null
}),
...
pre.mt3 `+c(`{{ file }}`),-1)]]),html:t(()=>[...u[83]||=[o(`<w-input type="file" v-model="file">File</w-input>

<pre class="mt3">`+c(`{{ file }}`)+`</pre>`,-1)]]),js:t(()=>[...u[84]||=[o(`data: () => ({
  file: null
})
`,-1)]]),default:t(()=>[a(L,{type:`file`,modelValue:l.file2,"onUpdate:modelValue":u[3]||=e=>l.file2=e},{default:t(()=>[...u[81]||=[o(`File`,-1)]]),_:1},8,[`modelValue`]),r(`pre`,v,c(l.file2),1)]),_:1}),a(I,{h3:``},{default:t(()=>[...u[85]||=[o(`Uploading the file to a backend server`,-1)]]),_:1}),u[158]||=s(`<p>There are different ways you can do this. The 2 most common ways would be to:</p><ul><li>Use Axios or other AJAX library to send the file on <strong class="code">w-form</strong> <code>@success</code> (emitted upon successful validation).</li><li>Use the <code>allow-submit</code> option on the <strong class="code">w-form</strong> as well as
...
set this up.</p>`,3),a(I,{class:`mt8`,h4:``},{default:t(()=>[...u[86]||=[o(`1st example`,-1)]]),_:1}),u[159]||=r(`p`,null,[o(`In this example, the file is uploaded to `),r(`a`,{href:`https://filebin.net`,target:`_blank`},`Filebin`),o(`.
...
`,1)]),default:t(()=>[a(U,{onSuccess:F.onFormSuccess},{default:t(()=>[a(L,{type:`file`,modelValue:l.file5,"onUpdate:modelValue":u[4]||=e=>l.file5=e,validators:[()=>l.file5||`Please add a file`]},{default:t(()=>[...u[87]||=[o(`File`,-1)]]),_:1},8,[`modelValue`,`validators`]),a(H,{class:`d-flex mla mt4`,type:`submit`,loading:l.loading},{default:t(()=>[...u[88]||=[o(`Send`,-1)]]),_:1},8,[`loading`])]),_:1},8,[`onSuccess`])]),_:1}),a(I,{class:`mt8`,h4:``},{default:t(()=>[...u[91]||=[o(`2nd example`,-1)]]),_:1}),u[160]||=r(`p`,null,[o(`In this example (more common case) the file is transferred as `),r(`code`,null,`multipart/form-data`),o(` with
...
`,-1)]]),_:1},8,[`dark`]),u[161]||=r(`p`,null,`Here is an example of a very minimalist way to receive and display the file on server side
...
`,-1)]]),default:t(()=>[a(L,{type:`file`,label:`File`,accept:`.jpg, .jpeg, .png, .gif, .svg, .webp`})]),_:1}),a(I,{h3:``},{default:t(()=>[...u[97]||=[o(`Multiple files upload`,-1)]]),_:1}),u[162]||=r(`p`,null,`When multiple files are allowed, the v-model will contain an array even if there is a single file.`,-1),a(R,null,{pug:t(()=>[...u[98]||=[o(`w-input(type="file" label="File" multiple)`,-1)]]),html:t(()=>[...u[99]||=[o(`<w-input
  type="file"
  label="File"
  multiple>
</w-input>
`,-1)]]),default:t(()=>[a(L,{type:`file`,label:`File`,multiple:``})]),_:1}),a(I,{h3:``},{default:t(()=>[...u[100]||=[o(`Loading state`,-1)]]),_:1}),u[163]||=r(`p`,null,[o(`If you try to upload a very large file, you will see the progress value of the file transfer will
...
w-flex
  | Files:
  pre.ml2 `+c(`{{ files }}`),-1)]]),html:t(()=>[...u[104]||=[o(`<w-input type="file"
  v-model="files4"
  v-model:overall-progress="overallProgress"
  show-progress
