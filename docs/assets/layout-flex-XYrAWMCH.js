import{r as a,o as r,g as x,a as i,w as n,b as e,d as l,h as g,F as p,k as f,_ as m}from"./index-CCZXtjQr.js";const y={class:"grow mx1"},j={class:"grow mx1"},k={class:"grow mx1"},S={class:"grow mx1"},A={class:"grow mx1 xs12 sm4"},C={class:"grow mx1 xs12 sm4"},z={class:"grow mx1 xs12 sm4"},T={class:"grow mx1 xs12 sm4"},D={class:"grow mx1 xs12 sm4"},B={class:"grow mx1 xs12 sm4"},F={class:"grow mx1"},N={class:"grow mx1"},W={class:"black ml1",href:"https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Box_Alignment/Box_Alignment_in_Flexbox",target:"_blank"},V={class:"box grow"},q={class:"box grow"},E={class:"grow"},I={class:"yellow-light5--bg bd1"},L={class:"box xs6 code"},R={class:"grow"},U={class:"yellow-light5--bg bd1"},G={class:"box xs6 code"},J={class:"yellow-light5--bg bd1"},Y={class:"xs6 pa2"},H={class:"yellow-light5--bg bd1"};function K(O,s){const d=a("title-link"),o=a("example"),t=a("w-flex"),c=a("router-link"),u=a("alert"),v=a("w-icon"),w=a("w-grid");return r(),x("main",null,[i(d,{class:"mt4",h1:""},{default:n(()=>s[0]||(s[0]=[e("Flex layout classes")])),_:1}),i(d,{h2:"",slug:"w-flex-component-and-helper-classes"},{default:n(()=>s[1]||(s[1]=[l("span",{class:"code"},"w-flex",-1),e(" component & helper classes")])),_:1}),s[116]||(s[116]=g(`<p>the <code>w-flex</code> component and the <code>.w-flex</code> class both allow a flex layout that you can
