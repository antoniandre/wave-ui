import{_ as y,O as j}from"./index.67df9d80.js";import{r as t,o as i,f as r,a as o,w as n,b as e,F as h,z as _,e as s,h as a,M as Y,n as u}from"./vendor.c30f2c6c.js";const k=s("shadows, borders & border radii"),S=e("p",null,[s("Wave UI offers a few CSS helper classes to control the drop shadow, borders and border radii."),e("br"),s(`
...
</w-flex>`),z=s(".box {\n  width: 80px;\n  height: 80px;\n  margin: 4px; /* You could use the class `ma1`. */\n  background-color: #e3f2fd; /* You could use the class `blue-light5--bg`. */\n  display: flex; /* You could use the class `d-flex`. */\n  align-items: center; /* You could use the class `align-center`. */\n  justify-content: center; /* You could use the class `justify-center`. */\n}\n"),A=s("Borders"),q=e("p",null,[s("Element borders range from "),e("code",null,"0"),s(" to "),e("code",null,"6"),s(`, corresponding to the same number of pixels (for
the `),e("span",{class:"code"},"border-width"),s(") on all the sides. "),e("code",null,".bd0"),s(" will remove any border.")],-1),D={class:"w-flex wrap"},F={class:"code"},M=s(`.w-flex.wrap
  .box.bd0 .bd0
  .box.bd1 .bd1
  .box.bd2 .bd2
  .box.bd3 .bd3
...
</w-flex>`),R=s(".box {\n  width: 80px;\n  height: 80px;\n  margin: 4px; /* You could use the class `ma1`. */\n  background-color: #e3f2fd; /* You could use the class `blue-light5--bg`. */\n  display: flex; /* You could use the class `d-flex`. */\n  align-items: center; /* You could use the class `align-center`. */\n  justify-content: center; /* You could use the class `justify-center`. */\n}\n"),W=s("Border radii"),H=Y(`<p>The border radii range from <code>0</code> to <code>6</code>, and are incremented by the <code>$base-increment</code>
...
`),ms=e("div",{class:"caption"},[s("a "),e("strong",{class:"code mx1"},"w-card"),s(" with "),e("code",{class:"mx1"},".bd0"),s(", "),e("code",{class:"mx1"},".bdrs4"),s(" and "),e("code",{class:"mx1"},".sh2"),s(" classes.")],-1),ws=e("div",{class:"title5 mb0"},[s("Accordion with "),e("code",{class:"mx1"},".bd1"),s(" and "),e("code",{class:"mx1"},".bdrs2"),s(" classes.")],-1),ps=s(`w-card.bdrs4.bd0.sh2(bg-color="orange-light5")
  .caption a `),fs=e("strong",{class:"code mx1"},"w-card",-1),vs=s(" with "),gs=e("code",{class:"mx1"},".bd0",-1),ys=s(", "),js=e("code",{class:"mx1"},".bdrs4",-1),Ys=s(" and "),ks=e("code",{class:"mx1"},".sh2",-1),Ss=s(` classes.
...
In this case you need to style them from your CSS.`);function Es(m,Vs,zs,As,qs,Ds){const c=t("title-link"),b=t("alert"),l=t("example"),w=t("w-divider"),p=t("w-image"),x=t("w-flex"),f=t("w-switch"),v=t("w-card"),g=t("w-accordion");return i(),r("main",null,[o(c,{class:"mt4",h1:""},{default:n(()=>[k]),_:1}),S,o(b,{tip:""},{default:n(()=>[C,$,I]),_:1}),o(c,{h2:""},{default:n(()=>[U]),_:1}),B,o(l,null,{pug:n(()=>[T]),html:n(()=>[V]),css:n(()=>[z]),default:n(()=>[e("div",N,[(i(),r(h,null,_(13,d=>e("div",{class:u(["box blue-light5--bg ma4 d-flex align-center justify-center",`sh${d-7}`]),key:d},[e("span",E,".sh"+a(d-7),1)],2)),64))])]),_:1}),o(c,{h2:""},{default:n(()=>[A]),_:1}),q,o(l,null,{pug:n(()=>[M]),html:n(()=>[O]),css:n(()=>[R]),default:n(()=>[e("div",D,[(i(),r(h,null,_(7,d=>e("div",{class:u(["box blue-light5--bg ma4 d-flex align-center justify-center",`bd${d-1}`]),key:d},[e("span",F,".bd"+a(d-1),1)],2)),64))])]),_:1}),o(c,{h2:""},{default:n(()=>[W]),_:1}),H,o(b,{tip:""},{default:n(()=>[L,G,J,K,P,Q]),_:1}),o(l,null,{pug:n(()=>[ns]),html:n(()=>[os]),css:n(()=>[ds]),default:n(()=>[e("div",X,[(i(),r(h,null,_(7,d=>e("div",{class:u(["box blue-light5--bg ma4 d-flex align-center justify-center",`bdrs${d-1}`]),key:d},[e("span",Z,".bdrs"+a(d-1),1)],2)),64)),ss,es])]),_:1}),o(w,{class:"my12"}),o(c,{h2:""},{default:n(()=>[ts]),_:1}),as,o(l,null,{pug:n(()=>[_s]),html:n(()=>[us]),js:n(()=>[xs]),default:n(()=>[o(x,{"align-center":"","justify-space-around":"",wrap:""},{default:n(()=>[o(x,{class:"no-grow",column:"","align-center":"","justify-center":""},{default:n(()=>[o(p,{class:"bd1 sh1 bdrsr d-block",src:`${m.baseUrl}images/japanese-wave.png`,width:100,height:100},null,8,["src"]),cs]),_:1}),o(f,{class:"bdrs1 my4 caption","model-value":!0},{default:n(()=>[ls,is,rs,bs,hs]),_:1})]),_:1})]),_:1}),o(l,{class:"mt8"},{pug:n(()=>[ps,fs,vs,gs,ys,js,Ys,ks,Ss,Cs,$s,Is,Us]),html:n(()=>[Bs]),default:n(()=>[o(v,{class:"bdrs4 bd0 sh2","bg-color":"orange-light5"},{default:n(()=>[ms]),_:1}),o(g,{class:"mt8 bdrs2 bd1",items:2},{"item-title":n(({index:d})=>[ws]),"item-title.2":n(({index:d})=>[s("Item "+a(d),1)]),"item-content":n(({index:d})=>[s("Content "+a(d),1)]),_:1})]),_:1}),o(b,{info:""},{default:n(()=>[Ns]),_:1})])}const Ts={data:()=>({colors:j,horizontal:!1,baseUrl:"/wave-ui/"})};var Os=y(Ts,[["render",Es]]);export{Os as default};
