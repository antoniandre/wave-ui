import{r as t,g as e,o as i,a as s,b as r,w as l,e as o,F as a,k as f,_ as w}from"./index-Tdht9LZF.js";const x={class:"box"},v={class:"box"},k={class:"box"};function y(C,n){const d=t("title-link"),g=t("router-link"),b=t("alert"),u=t("w-grid"),p=t("example");return i(),e("main",null,[s(d,{class:"mt4",h1:""},{default:l(()=>n[0]||(n[0]=[o("Simplified grid system (CSS grids)")])),_:1}),s(b,{info:""},{default:l(()=>[n[2]||(n[2]=o(`The 12-cell based flexbox grid system works well and for most cases, but it has
...
`)])),default:l(()=>[s(u,{class:"wrapper",columns:"6"},{default:l(()=>[(i(),e(a,null,f(12,m=>r("div",x)),64))]),_:1})]),_:1}),s(d,{h2:""},{default:l(()=>n[24]||(n[24]=[o("Gap")])),_:1}),s(p,null,{pug:l(()=>n[25]||(n[25]=[o(`w-grid.wrapper(columns="6" gap="3")
...
`)])),default:l(()=>[s(u,{class:"wrapper",columns:"6",gap:"3"},{default:l(()=>[(i(),e(a,null,f(12,m=>r("div",v)),64))]),_:1})]),_:1}),s(d,{h2:""},{default:l(()=>n[28]||(n[28]=[o("Different columns number per breakpoint")])),_:1}),n[33]||(n[33]=r("p",null,[o("The "),r("code",null,"columns"),o(` option also accepts an object in which you can define a number of columns
