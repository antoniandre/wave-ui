import{r,o as b,g as p,a as l,w as t,b as e,t as c,d as n,F as T,k as D,c as S,_ as v,a4 as j,D as M}from"./index-B7uW6kZ3.js";const A=n("span",{class:"code"},"w-select",-1),P=n("br",null,null,-1),O=n("span",{class:"code"},".w-app",-1),V=n("p",null,[e("This is the most basic use of the "),n("span",{class:"code"},"w-select"),e(" component. No label, no v-model, only items.")],-1),R=n("p",null,[e("The select list can have a label or not and a placeholder or not."),n("br")],-1),E=n("code",null,"label",-1),U=n("br",null,null,-1),$=n("code",null,"item-label-key",-1),C=n("p",{class:"mb4"},[e("Like in most components, you can set a "),n("code",null,"color"),e(" for the text and a "),n("code",null,"bg-color"),e(` for the
background.`),n("br"),e(`
By default, the text has the "`),n("span",{class:"code"},"primary"),e('" color.')],-1),x=n("p",null,[e("If an item object contains the key "),n("code",null,"color"),e(`, it will naturally be used by the
...
`)]),default:t(()=>[l(i,{items:s.items1},null,8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Label and / or placeholder")]),_:1}),R,l(a,null,{pug:t(()=>[e(`w-select(:items="items" label="Label")
...
`)]),default:t(()=>[l(i,{items:s.items1,outline:"",color:"blue"},{default:t(()=>[e("Label")]),_:1},8,["items"]),l(i,{class:"mt4",items:s.items1,outline:"","bg-color":"blue-light5",color:"blue-dark3"},{default:t(()=>[e("Label")]),_:1},8,["items"])]),_:1}),l(o,{h3:""},{default:t(()=>[e("List items colors")]),_:1}),x,l(a,null,{pug:t(()=>[e('w-select(:items="items") Pick a color')]),html:t(()=>[e(`<w-select :items="items">
  Pick a color
</w-select>`)]),js:t(()=>[e(`data: () => ({
  items: [
...
`)]),default:t(()=>[l(i,{items:s.items1,"label-position":"inside",outline:""},{default:t(()=>[l(h,{class:"orange"},{default:t(()=>[e("mdi mdi-arrow-right")]),_:1}),ie,l(h,{class:"orange"},{default:t(()=>[e("mdi mdi-arrow-left")]),_:1})]),_:1},8,["items"]),l(i,{class:"mt4",items:s.items1,"label-position":"left",outline:""},{default:t(()=>[oe,l(h,{class:"orange"},{default:t(()=>[e("mdi mdi-arrow-right")]),_:1})]),_:1},8,["items"]),l(i,{class:"mt4",items:s.items1,"label-position":"right",outline:""},{default:t(()=>[l(h,{class:"orange"},{default:t(()=>[e("mdi mdi-arrow-left")]),_:1}),ae]),_:1},8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Custom selection string")]),_:1}),ce,l(a,null,{pug:t(()=>[e(`w-select(:items="items" v-model="selection" multiple)
  template(#selection="{ item }")
    w-tag.mr2(v-for="(item, i) in item" :key="i" bg-color="grey-light4")
      | `+c("{{ item.label }}"))]),html:t(()=>[e(`<w-select :items="items" v-model="selection" multiple>
  <template #selection="{ item }">
    <w-tag
      class="mr2"
...
`)]),default:t(()=>[l(i,{items:s.items3,modelValue:s.customSelection,"onUpdate:modelValue":m[3]||(m[3]=d=>s.customSelection=d),multiple:""},{selection:t(({item:d})=>[(b(!0),p(T,null,D(d,(g,L)=>(b(),S(k,{class:"mr2",key:L,"bg-color":"grey-light4"},{default:t(()=>[e(c(g.label),1)]),_:2},1024))),128))]),_:1},8,["items","modelValue"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Custom list items")]),_:1}),l(a,null,{pug:t(()=>[e(`w-select(:items="items")
  template(#item="{ item, selected }")
    ...
    w-tag.ml2(bg-color="grey-light4" xs) `+c("{{ item.value }}"))]),html:t(()=>[e(`<w-select :items="items">
  <template #item="{ item, selected }">
