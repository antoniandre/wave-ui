import{r,o as b,f as g,a as i,w as t,b as e,h as l,d as n,n as k,_ as f,q as _}from"./index.cc5eb951.js";const C=n("p",{class:"grey-light2 my4"},`Now that you've seen the default accordion in real context, all the examples of this page will have a
...
the component's data or directly in the template.`)],-1),Q=n("p",null,"This content has a checklist.",-1),G=n("div",{class:"title4"},"To do",-1),H=n("em",null,"This is the 2nd item",-1),W=n("p",null,"The full content here is custom and completely distinct and independent from the other items.",-1),O={class:"ml1"},z=n("strong",null,"This is the 3rd item",-1),K=n("p",null,"Do you want to check the project on Github?",-1),M=n("p",null,[e("With the option "),n("code",null,"icon-rotate90"),e(`, the icon will initially point to the left and will
rotate 90 degrees clockwise when expanding.`)],-1),F=n("div",{class:"title4"},"Icon on the left",-1),J=n("div",{class:"title4 mt6"},"Icon on the right",-1),X=n("div",{class:"title4"},"One custom icon (only expand)",-1),Z=n("div",{class:"title4 mt6"},"Two custom icons (expand & collapse)",-1),ee=n("div",{class:"title4 mt6"},"No icon",-1),te=n("div",{class:"title4 mt6"},"Icon on the right",-1);function ie(o,c,w,v,x,u){const m=r("title-link"),a=r("w-accordion"),d=r("example"),h=r("w-button"),p=r("w-icon"),y=r("w-alert"),q=r("w-tag"),I=r("w-list");return b(),g("div",null,[i(m,{h2:""},{default:t(()=>[e("Basic")]),_:1}),i(a,{class:"white--bg",items:o.items},null,8,["items"]),C,i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`w-accordion(v-model="accordion" :items="items")
...
`)]),default:t(()=>[i(a,{class:"white--bg",modelValue:o.accordion1,"onUpdate:modelValue":c[0]||(c[0]=s=>o.accordion1=s),items:o.items},null,8,["modelValue","items"]),n("div",T,[e("v-model:"),n("code",S,l(o.accordion1),1)])]),_:1}),i(m,{h2:""},{default:t(()=>[e("Expanded by default")]),_:1}),j,i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`w-accordion(v-model="accordion" :items="items")
...
`)]),default:t(()=>[i(a,{class:"white--bg",items:3},{"item-title.1":t(()=>[e("Item title 1")]),"item-content.1":t(()=>[e("Item content 1")]),"item-title.2":t(()=>[e("Item title 2")]),"item-content.2":t(()=>[e("Item content 2")]),"item-title.3":t(()=>[e("Item title 3")]),"item-content.3":t(()=>[e("Item content 3")]),_:1})]),_:1}),N,i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`w-accordion(:items="items")
...
`)]),default:t(()=>[F,i(a,{class:"white--bg",items:o.items,"expand-icon-rotate90":""},null,8,["items"]),J,i(a,{class:"white--bg",items:o.items,"expand-icon-rotate90":"","expand-icon-right":""},null,8,["items"])]),_:1}),i(m,{h3:""},{default:t(()=>[e("More options")]),_:1}),i(d,{"content-class":"pa4 aliceblue"},{pug:t(()=>[e(`.title4 1 custom icon (only expand)
