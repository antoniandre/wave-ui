import{N as e,U as t,c as n,d as r,g as i,h as a,k as o}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as s}from"./_plugin-vue_export-helper-S3RvzygF.js";import{t as c}from"./form-elements-dhQrrM2Q.js";import{a as l}from"./index-CKcZQ2YR.js";function u(s,c){let l=e(`w-alert`),u=e(`title-link`),d=e(`w-textarea`),f=e(`example`),p=e(`w-icon`);return o(),r(`div`,null,[i(l,{info:``},{default:t(()=>[...c[0]||=[n(`div`,{class:`title4`},`Good to know`,-1),n(`p`,{class:`body`},[a(`Any HTML attribute or JavaScript event listeners attached to the component will be applied to the
