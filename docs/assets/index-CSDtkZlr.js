import{f as D}from"./chunk-TVFJBHBT-BUrEn1b-.js";import{r as g,g as c,o as p,a as l,b as n,h as E,w as a,e as t,n as v,t as s,F as R,k as L,c as A,l as H,d as W,_ as B,a8 as P}from"./index-C780IYji.js";const K={class:"w-flex justify-end"},O={class:"w-flex align-center mb2"},U={class:"w-flex wrap mb3"},J={class:"w-flex align-center gap2 pa1"},Y={class:"w-flex gap2 no-grow"},G={class:"mb0"},X={class:"mt4"},Q={class:"ml2"},Z={key:0},$={class:"grey mr2"},_=["onClick"],ee=["onClick"],te=["colspan"],ae={class:"title3"},ne={class:"mr2"};function le(d,e,y,F,i,u){const r=g("title-link"),o=g("w-table"),b=g("example"),f=g("w-button"),I=g("w-icon"),M=g("w-flex"),T=g("ssh-pre"),q=g("w-tag"),j=g("w-radios"),S=g("alert"),z=g("w-input");return p(),c("div",null,[l(r,{h2:""},{default:a(()=>e[12]||(e[12]=[t("Basic")])),_:1,__:[12]}),e[180]||(e[180]=n("p",null,[t("Providing an array of items will automatically create a table row for each item."),n("br"),t(`
Note that the `),n("code",null,"class"),t(" key is used to add a custom class to the table row for easy row styling.")],-1)),l(b,null,{pug:a(()=>e[13]||(e[13]=[t('w-table(:headers="table.headers" :items="table.items")')])),html:a(()=>e[14]||(e[14]=[t(`<w-table
...
`)])),default:a(()=>[l(o,{headers:i.table1.headers,items:[]},null,8,["headers"]),e[21]||(e[21]=n("br",null,null,-1)),l(o,{headers:i.table1.headers,items:[]},{"no-data":a(()=>e[17]||(e[17]=[t("👌 There is no data! 👌")])),_:1},8,["headers"])]),_:1,__:[21]}),l(r,{h2:""},{default:a(()=>e[22]||(e[22]=[t("Alignments")])),_:1,__:[22]}),e[182]||(e[182]=n("p",null,[t("You can align the columns contents separately by adding an "),n("code",null,"align"),t(` key in each header
...
`)])),default:a(()=>[l(o,{headers:i.table2.headers,items:i.table2.items},null,8,["headers","items"])]),_:1}),l(r,{h2:"",slug:"example--no-headers"},{default:a(()=>e[26]||(e[26]=[t("No headers")])),_:1,__:[26]}),e[183]||(e[183]=n("p",null,[t("Even with the "),n("code",null,"no-headers"),t(" option, the "),n("code",null,"headers"),t(` are still required for various
...
`)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table1.items,"no-headers":""},null,8,["headers","items"])]),_:1}),l(r,{h2:"",slug:"example--fixed-headers"},{default:a(()=>e[30]||(e[30]=[t("Fixed headers")])),_:1,__:[30]}),l(b,null,{pug:a(()=>e[31]||(e[31]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
...
`)])),default:a(()=>[l(o,{headers:i.table3.headers,items:i.table3.items,"fixed-headers":"",style:{height:"250px"}},null,8,["headers","items"])]),_:1}),l(r,{h2:"",slug:"example--footer"},{default:a(()=>e[34]||(e[34]=[t("Footer")])),_:1,__:[34]}),l(r,{h3:"",slug:"example--footer-slot"},{default:a(()=>e[35]||(e[35]=[t("Footer slot")])),_:1,__:[35]}),e[184]||(e[184]=n("p",null,[t("A table footer can be added via the "),n("code",null,"footer"),t(` slot. If present, the footer will span on
...
`)])),default:a(()=>[l(o,{ref:"table",headers:i.table3.headers,items:i.table3.items,"fixed-footer":i.table3.fixedFooter,style:{height:"250px"}},{footer:a(()=>[l(M,{"justify-space-between":""},{default:a(()=>[l(f,{round:"",sm:"",onClick:u.addRow},{default:a(()=>[l(I,{class:"mr1"},{default:a(()=>e[36]||(e[36]=[t("wi-plus")])),_:1,__:[36]}),e[37]||(e[37]=t("add person"))]),_:1,__:[37]},8,["onClick"]),n("div",null,[e[38]||(e[38]=n("strong",{class:"mr2"},"Total:",-1)),t(s(i.table3.items.length)+" persons",1)])]),_:1})]),_:1},8,["headers","items","fixed-footer"])]),_:1}),l(r,{h3:"",slug:"example--footer-slot"},{default:a(()=>e[42]||(e[42]=[t("Footer-row slot")])),_:1,__:[42]}),e[185]||(e[185]=n("p",null,[t("The "),n("code",null,"footer-row"),t(" slot will give you more flexibility as it lets you define the whole table row.")],-1)),e[186]||(e[186]=n("p",null,"It can be useful if you want to keep the columns alignments in the footer.",-1)),l(b,null,{pug:a(()=>e[43]||(e[43]=[t(`w-table(
  :headers="table.headers"
  no-headers
  :items="table.items"
  fixed-footer
...
`)])),_:1,__:[47]},8,["dark"]),l(b,null,{pug:a(()=>e[48]||(e[48]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
...
`)])),default:a(()=>[l(o,{headers:i.table7.headers,items:i.table7.items,"resizable-columns":""},null,8,["headers","items"])]),_:1}),l(r,{h3:""},{default:a(()=>e[51]||(e[51]=[t("Saving the table layout in localStorage")])),_:1,__:[51]}),e[188]||(e[188]=n("p",null,[t(`In some apps, it makes sense to save the prefered table layout of the user, and reapply it
...
`)])),default:a(()=>[l(o,{headers:i.table8.headers,items:i.table8.items,"resizable-columns":"",onColumnResize:u.onColumnResize},null,8,["headers","items","onColumnResize"])]),_:1}),l(r,{h2:""},{default:a(()=>e[55]||(e[55]=[t("Toggling column visibility")])),_:1,__:[55]}),e[189]||(e[189]=n("p",null,`This is completely external to Wave UI, but this example shows you a way to do it in your
...
`)],-1)),l(r,{h3:""},{default:a(()=>e[66]||(e[66]=[t("Initial Sorting")])),_:1,__:[66]}),l(b,null,{pug:a(()=>e[67]||(e[67]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
...
`)])),_:1,__:[70]}),l(r,{h3:""},{default:a(()=>e[71]||(e[71]=[t("Asynchronous Sorting")])),_:1,__:[71]}),e[193]||(e[193]=n("p",null,[t(`When dealing with a lot of table entries, you will most likely need the sorting to be done
...
:sort-function="sortFunction"
:loading="table.loading"
style="height: 140px")`)])),_:1},8,["headers","items","sort-function","loading"])]),_:1}),l(r,{h2:""},{default:a(()=>e[75]||(e[75]=[t("Filtering")])),_:1,__:[75]}),e[194]||(e[194]=n("p",null,[t(`Filtering the table rows is very straightforward: you only need to provide your filtering function to the
...
`)])),default:a(()=>[n("div",U,[l(f,{class:"mr2 mb1",onClick:e[4]||(e[4]=m=>i.table3.activeFilter=0),round:"",outline:i.table3.activeFilter!==0},{default:a(()=>e[76]||(e[76]=[t("No filter")])),_:1,__:[76]},8,["outline"]),l(f,{class:"mr2 mb1",onClick:e[5]||(e[5]=m=>i.table3.activeFilter=1),round:"",outline:i.table3.activeFilter!==1},{default:a(()=>e[77]||(e[77]=[t("Last name starting with 'M'")])),_:1,__:[77]},8,["outline"]),l(f,{class:"mr2 mb1",onClick:e[6]||(e[6]=m=>i.table3.activeFilter=2),round:"",outline:i.table3.activeFilter!==2},{default:a(()=>e[78]||(e[78]=[t("ID >= 10")])),_:1,__:[78]},8,["outline"])]),l(o,{headers:i.table3.headers,items:i.table3.items,filter:i.table3.filters[i.table3.activeFilter]},null,8,["headers","items","filter"])]),_:1}),l(r,{h3:""},{default:a(()=>e[82]||(e[82]=[t("Global filter")])),_:1,__:[82]}),e[195]||(e[195]=n("p",null,[t("You could also apply a filter globally, which looks into all the columns at once."),n("br"),t(`
...
`)),l(I,{class:"red mr1",size:"0.9em"},{default:a(()=>e[86]||(e[86]=[t("mdi mdi-heart")])),_:1,__:[86]}),e[91]||(e[91]=t(` in this example's match, is that the user
...
but not `)),e[102]||(e[102]=n("code",null,"florett",-1)),e[103]||(e[103]=t(" for instance)."))]),_:1,__:[87,88,89,90,91,92,93,94,95,96,97,98,99,100,101,102,103]}),l(r,{h2:""},{default:a(()=>e[104]||(e[104]=[t("Loading state")])),_:1,__:[104]}),e[196]||(e[196]=n("p",null,[t("When the table content is not ready straight away, you can use the "),n("code",null,"loading"),t(` prop to display
a progress bar while loading.`)],-1)),l(f,{class:"mb2",disabled:!!i.table1.loading,onClick:u.reload},{default:a(()=>[l(I,{class:"mr1"},{default:a(()=>e[105]||(e[105]=[t("mdi mdi-sync")])),_:1,__:[105]}),e[106]||(e[106]=t("reload"))]),_:1,__:[106]},8,["disabled","onClick"]),l(r,{h3:""},{default:a(()=>e[107]||(e[107]=[t("Simple table - no set height")])),_:1,__:[107]}),l(b,{style:{height:"170px"}},{pug:a(()=>e[108]||(e[108]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
...
`)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table1.items,loading:i.table1.loading},null,8,["headers","items","loading"])]),_:1}),l(r,{h3:"",slug:"loading-with-fixed-header"},{default:a(()=>e[111]||(e[111]=[t("Table with fixed header & set height of 200px")])),_:1,__:[111]}),l(b,null,{pug:a(()=>e[112]||(e[112]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  :loading="loading"
...
}`)])),_:1,__:[116]}),e[198]||(e[198]=E(`<p>More details in the <a href="#pagination-prop">API section</a>.</p><p>The pagination is a two-way binding object: if you modify any property inside it, the table
...
</p>`,3)),l(r,{h3:""},{default:a(()=>e[117]||(e[117]=[t("Client-side pagination")])),_:1,__:[117]}),l(b,{"blank-codepen":["js"]},{pug:a(()=>e[118]||(e[118]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
...
app.mount('#app')
`)])),default:a(()=>[l(o,{headers:i.table12.headers,items:i.table12.items,"fixed-headers":"","fixed-footer":"",fetch:i.table12.fetch,pagination:i.table12.pagination,loading:i.table12.loading,style:{"max-height":"500px"}},null,8,["headers","items","fetch","pagination","loading"])]),_:1}),l(r,{h3:""},{default:a(()=>e[125]||(e[125]=[t("Custom pagination layout")])),_:1,__:[125]}),e[200]||(e[200]=n("p",null,[t("More details about the pagination slot in the "),n("a",{href:"#pagination-slot"},"API section"),t(".")],-1)),l(b,{"blank-codepen":["js"]},{pug:a(()=>e[126]||(e[126]=[t(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
...
app.mount('#app')
`)])),default:a(()=>[l(o,{headers:i.table13.headers,items:i.table13.items,"fixed-headers":"","fixed-footer":"",fetch:i.table13.fetch,pagination:i.table13.pagination,loading:i.table13.loading,style:{"max-height":"500px"}},null,8,["headers","items","fetch","pagination","loading"])]),_:1}),l(r,{h2:""},{default:a(()=>e[133]||(e[133]=[t("Rows selection")])),_:1,__:[133]}),e[201]||(e[201]=n("p",null,"Click a row to see it highlighted and get information about the selected item.",-1)),e[202]||(e[202]=n("p",null,[t("By default, the selection will use the "),n("code",null,"primary"),t(" color and apply an opacity of "),n("code",null,"0.2"),t(`.
If this is not what you want, you can override it via CSS (`),n("code",null,".w-table__row--selected td:before"),t(`).
`)],-1)),l(r,{h3:"",slug:"example--selectable-rows"},{default:a(()=>e[134]||(e[134]=[t("The "),n("span",{class:"code"},"selectable-rows",-1),t(" prop")])),_:1,__:[134]}),e[203]||(e[203]=n("p",null,[t("You can enable the rows selection by adding the "),n("code",null,"selectable-rows"),t(` prop, or disable it by
...
`)],-1)),l(r,{h3:"",slug:"example--force-selection"},{default:a(()=>e[135]||(e[135]=[t("The "),n("span",{class:"code"},"force-selection",-1),t(" prop")])),_:1,__:[135]}),e[204]||(e[204]=n("p",null,[t("Eventually, you can use the "),n("code",null,"force-selection"),t(` prop to prevent unselecting a row when only
one remain selected.
`)],-1)),l(r,{h3:"",slug:"example--row-select"},{default:a(()=>e[136]||(e[136]=[t("The "),n("span",{class:"code"},"@row-select",-1),t(" event")])),_:1,__:[136]}),e[205]||(e[205]=E(`<p>This event is fired each time a row is selected <strong>or unselected</strong> (so you don&#39;t need to listen
...
`)])),default:a(()=>[l(M,{class:"mb4",wrap:""},{default:a(()=>[l(j,{class:"mr6",modelValue:i.table1.selectableRows,"onUpdate:modelValue":e[8]||(e[8]=m=>i.table1.selectableRows=m),items:i.selectableRowsOptions},null,8,["modelValue","items"]),l(f,{class:"my3",onClick:e[9]||(e[9]=m=>i.table1.forceSelection=!i.table1.forceSelection),round:"",outline:!i.table1.forceSelection},{default:a(()=>[i.table1.forceSelection?(p(),A(I,{key:0,class:"mr2"},{default:a(()=>e[137]||(e[137]=[t("wi-check")])),_:1,__:[137]})):W("",!0),e[138]||(e[138]=t("Force selection"))]),_:1,__:[138]},8,["outline"])]),_:1}),l(o,{headers:i.table1.headers,items:i.table1.items,"selectable-rows":i.table1.selectableRows,"force-selection":i.table1.forceSelection,onRowSelect:e[10]||(e[10]=m=>i.selectionInfo=m)},null,8,["headers","items","selectable-rows","force-selection"]),e[142]||(e[142]=n("div",{class:"mt4 title4"},"Selection info:",-1)),n("pre",null,s(i.selectionInfo),1)]),_:1,__:[142]}),l(r,{h3:""},{default:a(()=>e[143]||(e[143]=[t("Updating the selected rows programmatically")])),_:1,__:[143]}),e[206]||(e[206]=n("p",null,`Wave UI offers a convenient way to provide an array of selected rows and keeping your array in sync
...
`)])),_:1,__:[149]}),l(r,{h2:"",slug:"example--expandable-rows"},{default:a(()=>e[150]||(e[150]=[t("Expandable rows")])),_:1,__:[150]}),l(S,{warning:""},{default:a(()=>e[151]||(e[151]=[t("This feature is in progress.")])),_:1,__:[151]}),l(b,null,{pug:a(()=>e[154]||(e[154]=[t(`w-table(:headers="table.headers" :items="table.items" expandable-rows)
...
`)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table1.items},{"header-label":a(({label:m,index:h})=>[t(s(h)+": "+s(m)+" 👌",1)]),_:1},8,["headers","items"])]),_:1}),l(r,{h3:"",slug:"item-cells"},{default:a(()=>e[162]||(e[162]=[t("Item cells (inside <td> element)")])),_:1,__:[162]}),e[209]||(e[209]=n("p",null,[t("In this example, only the items cells are customized via the "),n("code",null,"item"),t(` slot
...
`)])),default:a(()=>[l(o,{headers:i.table1.headers,"no-headers":"",items:i.table1.items},{"item-cell":a(({item:m,label:h,header:N,index:k})=>[N.key==="id"?(p(),c("small",Z,"#"+s(k),1)):(p(),c(R,{key:1},[n("small",$,s(N.label)+":",1),n("span",null,s(h),1)],64))]),_:1},8,["headers","items"])]),_:1}),l(r,{h3:"",slug:"override-1-particular-item-cell"},{default:a(()=>e[166]||(e[166]=[t("override 1 particular item cell or column cells (inside <td> element)")])),_:1,__:[166]}),e[210]||(e[210]=E(`<p>If you only need to override 1 particular column you can do it via the <code>item-cell.xxx</code> slot,
...
`)])),default:a(()=>[l(o,{headers:i.table1.headers,items:i.table1.items,"selectable-rows":""},{item:a(({item:m,index:h,select:N,classes:k})=>[n("tr",{class:v(k),onClick:N},[(p(!0),c(R,null,L(i.table1.headers,(x,w)=>(p(),c("td",{key:w,class:v(`pa4 text-${x.align||"left"}`)},s(m[x.key]||""),3))),128))],10,_)]),_:1},8,["headers","items"])]),_:1}),l(r,{h3:"",slug:"colspan-on-td"},{default:a(()=>e[172]||(e[172]=[n("span",{class:"code"},"colspan",-1),t(" on <td>")])),_:1,__:[172]}),e[212]||(e[212]=n("p",null,[t("This example is showcasing another useful case: handling a colspan attribute."),n("br"),t(`
