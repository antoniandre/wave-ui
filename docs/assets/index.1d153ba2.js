import{n as s,o as r}from"./index.e31dd236.js";var d=function(){var e=this,a=e.$createElement,t=e._self._c||a;return t("div",[t("alert",{staticClass:"mt6",attrs:{tip:""}},[t("ul",[t("li",{staticClass:"title5"},[e._v("The "),t("span",{staticClass:"code"},[e._v("w-form")]),e._v(" component is used for validation.")]),t("li",[e._v("A "),t("span",{staticClass:"code"},[e._v("w-form")]),e._v(` is invisible and has no style by default. You can put it in a
...
`)]),t("w-divider",{staticClass:"mt12"}),t("title-link",{attrs:{h2:""}},[e._v("Basic validation")]),e._m(2),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-form(v-model="valid")
  ...
  .text-right.mt6
    strong v-model:
    code.ml2.mr4 `+e._s("{{ valid === false ? 'false' : valid || 'null' }}")+`
    w-button(type="submit" :disabled="valid === false") Validate`)]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-form v-model="valid">
  <w-input
    label="First name"
...
`)]),t("title-link",{attrs:{h2:""}},[e._v("Direct submission to a server")]),e._m(3),e._m(4),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-form(action="test.php" method="post" target="_blank" allow-submit)
  w-input(label="First name" :validators="[validators.required]")
  w-input.mt3(label="Last name" :validators="[validators.required]")
  .text-right.mt6
    w-button(type="submit") Validate`)]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-form
  action="test.php"
  method="post"
  target="_blank"
  allow-submit>
...
`)]),t("title-link",{attrs:{h2:""}},[e._v("Validate on submit, on blur, on keyup")]),e._m(5),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-form(no-keyup-validation no-blur-validation)
  w-input(label="First name" :validators="[validators.required]")
  w-input.mt3(label="Last name" :validators="[validators.required]")
  .text-right.mt6
    w-button(type="submit") Validate`)]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-form no-keyup-validation no-blur-validation>
  <w-input
    label="First name"
    :validators="[validators.required]">
  </w-input>
...
for this purpose.`)]),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-alert(
  :success="success"
  :error="error"
  :info="!success && !error").
  `+e._s("{{ !success && !error ? 'The form is still pristine' : (success ? 'Success' : 'Error') }}")+`
p The form has been validated `+e._s("{{ validated }}")+` time(s).
...
w-form(
  ...
  .text-right.mt6
    w-button(type="submit") Validate`)]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-alert
  :success="success"
  :error="error"
  :info="!success && !error">
  `+e._s("{{ !success && !error ? 'The form is still pristine' : (success ? 'Success' : 'Error') }}")+`
...
`)]},proxy:!0}])},[t("w-alert",{attrs:{success:e.form5.success,error:e.form5.error,info:!e.form5.success&&!e.form5.error}},[e._v(e._s(!e.form5.success&&!e.form5.error?"The form is still pristine":e.form5.success?"Success":"Error"))]),t("p",[e._v("The form has been validated "+e._s(e.form5.validated)+" time(s).")]),t("w-form",{on:{validate:function(n){e.form5.validated++,e.form5.success=e.form5.error=!1},success:function(n){e.form5.success=!0},error:function(n){e.form5.error=!0}}},[t("w-input",{attrs:{label:"First name",validators:[e.validators.required]}}),t("w-input",{staticClass:"mt3",attrs:{label:"Last name",validators:[e.validators.required]}}),t("div",{staticClass:"text-right mt6"},[t("w-button",{attrs:{type:"submit"}},[e._v("Validate")])],1)],1)],1),t("title-link",{attrs:{h2:"",slug:"advanced-validation"}},[e._v("Advanced validation with everything")]),e._m(8),e._m(9),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-card.white--bg(content-class="pa0")
  ...
  w-notification(
    ...
    plain
    round
    bottom) The form was sent successfully!`)]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-card class="white--bg" content-class="pa0">
...
w-form.mt4(v-model="form.valid" :disabled="form.disabled" :readonly="form.readonly")
  ...
  w-flex.mt4(justify-end)
    ...
    w-button.ml2(type="submit" :disabled="form.valid === false") Validate`)]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-button
  :outline="!form.disabled"
...
`),t("a",{attrs:{href:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function",target:"_blank"}},[e._v("here")]),e._v(".")]),e._m(11),t("example",{attrs:{"content-class":"pa6"},scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-form(error-placeholders)
  w-input(
    label="Username"
    :validators="[validators.required, validators.username]"
    :inner-icon-right="loading ? 'mdi mdi-autorenew w-icon--spin' : ''"
    :loading="loading"
    autocomplete="off")`)]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-form error-placeholders>
  <w-input
    label="Username"
    :validators="[validators.required, validators.username]"
    :inner-icon-right="loading ? 'mdi mdi-autorenew w-icon--spin' : ''"
