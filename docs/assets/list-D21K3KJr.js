...
`,-1)]]),default:t(()=>[a(A,{items:u.listItems5,hover:``},null,8,[`items`])]),_:1}),a(j,{h3:``},{default:t(()=>[...d[27]||=[o(`Selection-only color`,-1)]]),_:1}),d[67]||=s(`<p class="grey-light1">In addition to the hover effect, the items may also be selectable (as per the
...
`,-1)]]),default:t(()=>[a(A,{items:5,hover:``},{item:t(({index:e})=>[o(`Item `+l(e),1)]),"item.3":t(()=>[...d[32]||=[r(`strong`,null,`This is the great item #3`,-1)]]),_:1})]),_:1}),d[69]||=r(`p`,null,[o(`It's up to you to define your your list contents in the component's data or directly in the template.`),r(`br`),o(`
In this example each item has a different icon stored in the data object.`)],-1),a(M,null,{pug:t(()=>[...d[35]||=[o(`w-list(:items="items" hover)
  template(#item="{ item }")
    w-flex(align-center justify-space-between)
      | `+l(`{{ item.label }}`)+`
      w-icon(md) `+l(`{{ item.icon }}`),-1)]]),html:t(()=>[...d[36]||=[o(`<w-list :items="items" hover>
  <template #item="{ item }">
    <w-flex align-center justify-space-between>
      `+l(`{{ item.label }}`)+`
...
.title3.mt2
  ...
  code.ml2(v-else-if="multiple").
    `+l(`{{ selection ? [selection] : '[]' }}`),-1)]]),html:t(()=>[...d[43]||=[o(`<w-radios v-model="multiple" :items="radios" inline></w-radios>
...
<div class="title3 mt2">
  ...
  selection: 2,
  itemClicked: null
})`,-1)]]),default:t(()=>[a(P,{class:`mb6`,modelValue:u.multiple,"onUpdate:modelValue":d[0]||=e=>u.multiple=e,items:u.radios,inline:``},null,8,[`modelValue`,`items`]),a(F,{wrap:``,"align-center":``},{default:t(()=>[a(A,{class:`grow mr4`,modelValue:u.selection1,"onUpdate:modelValue":d[1]||=e=>u.selection1=e,items:u.listItems1,color:`deep-purple`,multiple:u.multiple,onItemClick:d[2]||=e=>u.itemClicked=e},null,8,[`modelValue`,`items`,`multiple`]),u.itemClicked?(e(),i(`div`,_,[d[39]||=r(`div`,{class:`title3`},[o(`clicked item (`),r(`span`,{class:`code`},`item-click`),o(` event):`)],-1),d[40]||=r(`br`,null,null,-1),r(`span`,v,l(u.itemClicked),1)])):c(``,!0)]),_:1}),r(`div`,y,[d[41]||=o(`Selected item:`,-1),!u.multiple||Array.isArray(u.selection1)?(e(),i(`code`,b,l(u.selection1||`null`),1)):u.multiple?(e(),i(`code`,x,l(u.selection1?[u.selection1]:`[]`),1)):c(``,!0)])]),_:1}),d[71]||=r(`p`,null,[o(`Note: you can get the list selection from the v-model, or by listening to the `),r(`span`,{class:`code`},`input`),o(` event.`)],-1),a(j,{h2:``},{default:t(()=>[...d[45]||=[o(`Checklists`,-1)]]),_:1}),a(M,null,{pug:t(()=>[...d[52]||=[o(`w-flex(wrap basis-zero :gap="3")
  .grow
    .title3.mb4 Default
    w-list(
      v-model="selection1"
  ...
  .grow
    ...
    w-list.custom(
      ...
      template(#item="{ item }")
        span `+l(`{{ item.label }}`)+`
        .spacer
        w-icon(md) `+l(`{{ item.icon }}`),-1)]]),html:t(()=>[...d[53]||=[o(`<w-flex wrap basis-zero :gap="3">
  <div class="grow">
...
If you are using Vue Router, all the links will automatically be `),r(`strong`,{class:`code`},`router-link`),o(`s.`),r(`br`)],-1),d[74]||=r(`p`,null,[o(`It is possible to disable a link with a `),r(`code`,null,`disabled: true`),o(` attribute in the item.`)],-1),a(M,null,{pug:t(()=>[...d[62]||=[o(`w-list(:items="items" nav color="primary")
  template(#item="{ item }")
    span `+l(`{{ item.label }`)+`}
    .spacer
    w-icon(md) `+l(`{{ item.icon }}`),-1)]]),html:t(()=>[...d[63]||=[o(`<w-list :items="items" nav color="primary">
  <template #item="{ item }">
    <span>`+l(`{{ item.label }}`)+`</span>
    <div class="spacer"></div>
    <w-icon md>`+l(`{{ item.icon }}`)+`</w-icon>
