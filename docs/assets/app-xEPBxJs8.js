import{N as e,U as t,c as n,d as r,g as i,h as a,k as o}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as s}from"./_plugin-vue_export-helper-S3RvzygF.js";import{z as c}from"./index-CKcZQ2YR.js";var l={class:`title2 red`},u={class:`mt6`},d={class:`mt2`},f={class:`mt2`};function p(s,c){let p=e(`w-tag`),m=e(`ssh-pre`),h=e(`alert`),g=e(`title-link`),_=e(`example`),v=e(`w-badge`),y=e(`w-flex`),b=e(`router-link`);return o(),r(`div`,null,[n(`div`,l,[c[2]||=a(`Required in Wave UI `,-1),i(p,{class:`error--bg`,round:``},{default:t(()=>[...c[0]||=[a(`< 3.0`,-1)]]),_:1}),c[3]||=a(`, removed in `,-1),i(p,{class:`error--bg`,round:``},{default:t(()=>[...c[1]||=[a(`3.0`,-1)]]),_:1}),c[4]||=a(`.`,-1)]),c[63]||=n(`p`,{class:`mt6`},[a(`This tag is required in your app for Wave UI proper functioning.`),n(`br`),a(`
