import{r as t,o as e,g as i,a as s,w as l,b as o,d as r,F as a,k as f,_ as w}from"./index-CSsuy43z.js";const x={class:"box"},v={class:"box"},k={class:"box"};function y(C,n){const d=t("title-link"),g=t("router-link"),b=t("alert"),u=t("w-grid"),p=t("example");return e(),i("main",null,[s(d,{class:"mt4",h1:""},{default:l(()=>n[0]||(n[0]=[o("Simplified grid system (CSS grids)")])),_:1}),s(b,{info:""},{default:l(()=>[n[2]||(n[2]=o(`The 12-cell based flexbox grid system works well and for most cases, but it has
