import{N as e,U as t,W as n,c as r,d as i,g as a,h as o,k as s,yt as c}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{o as l}from"./runtime-dom.esm-bundler-Cc0sF0om.js";import{t as u}from"./_plugin-vue_export-helper-S3RvzygF.js";import{A as d}from"./index-CKcZQ2YR.js";var f={class:`w-flex mt6 no-grow`},p={class:`w-flex`},m={class:`w-flex wrap`},h={class:`ma2`},g={class:`ma2`};function _(u,d,_,v,y,b){let x=e(`title-link`),S=e(`w-button`),C=e(`w-icon`),w=e(`w-checkbox`),T=e(`w-radios`),E=e(`w-dialog`),D=e(`example`),O=e(`w-radio`);return s(),i(`div`,null,[a(x,{h2:``},{default:t(()=>[...d[35]||=[o(`Global demo`,-1)]]),_:1}),d[95]||=r(`p`,null,`This dialog contains some basic options for the w-dialog.`,-1),a(D,{"content-class":`pt5`},{pug:t(()=>[...d[43]||=[o(`w-button.px4(@click="dialog.show = true") Open dialog
...
w-dialog(
  ...
  template(#actions)
    .spacer
    w-button(@click="dialog.show = false") Close`,-1)]]),html:t(()=>[...d[44]||=[o(`<w-button class="px4" @click="dialog.show = true">
  Open dialog
</w-button>
...
w-dialog(v-model="showDialog" title="Dialog title").
  ...
  perspiciatis repellendus. Sunt!`,-1)]]),html:t(()=>[...d[50]||=[o(`<w-button class="px4" @click="showDialog = true">
  Open dialog
</w-button>
...
<w-dialog>`,-1)]]),js:t(()=>[...d[51]||=[o(`data: () => ({
  showDialog: false
})
`,-1)]]),default:t(()=>[a(S,{class:`px4`,onClick:d[7]||=e=>u.dialog0.show=!0},{default:t(()=>[...d[47]||=[o(`Open dialog`,-1)]]),_:1}),a(E,{modelValue:u.dialog0.show,"onUpdate:modelValue":d[8]||=e=>u.dialog0.show=e,title:`Dialog title`},{default:t(()=>[...d[48]||=[o(`Lorem ipsum dolor sit amet consectetur adipisicing elit.`,-1),r(`br`,null,null,-1),o(`
Unde eum non necessitatibus quia corporis odio numquam sequi iusto
voluptatum delectus? Excepturi minus iste, provident non totam itaque
...
labore nemo voluptates necessitatibus esse amet voluptatibus modi deleniti
porro officiis ut fugit quidem corporis itaque possimus commodi sint unde
perspiciatis repellendus. Sunt!`,-1)]]),_:1},8,[`modelValue`])]),_:1}),a(x,{h2:``},{default:t(()=>[...d[52]||=[o(`Persistent prompt dialog`,-1)]]),_:1}),a(D,{"content-class":`pt5`},{pug:t(()=>[...d[61]||=[o(`w-button.px4(@click="dialog.show = true") Open dialog
...
w-dialog(
  ...
  template(#actions)
    ...
    w-button(@click="dialog.show = false" bg-color="success") I agree`,-1)]]),html:t(()=>[...d[62]||=[o(`<w-button class="px4" @click="dialog.show = true">
  Open dialog
</w-button>
...
</w-dialog>`,-1)]]),js:t(()=>[...d[63]||=[o(`data: () => ({
  dialog: { show: false }
})
`,-1)]]),default:t(()=>[a(S,{class:`px4`,onClick:d[9]||=e=>u.dialog2.show=!0},{default:t(()=>[...d[53]||=[o(`Open dialog`,-1)]]),_:1}),a(E,{modelValue:u.dialog2.show,"onUpdate:modelValue":d[12]||=e=>u.dialog2.show=e,title:`Terms and conditions`,persistent:``,width:550},{actions:t(()=>[d[56]||=r(`div`,{class:`spacer`},null,-1),a(S,{class:`mr2`,onClick:d[10]||=e=>u.dialog2.show=!1,"bg-color":`error`},{default:t(()=>[...d[54]||=[o(`I disagree`,-1)]]),_:1}),a(S,{onClick:d[11]||=e=>u.dialog2.show=!1,"bg-color":`success`},{default:t(()=>[...d[55]||=[o(`I agree`,-1)]]),_:1})]),default:t(()=>[d[57]||=o(`Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rem dolore delectus,
quisquam ipsa laudantium esse consequatur itaque similique et eligendi eum voluptas
odit dolor labore eveniet at vel sequi nostrum.`,-1),d[58]||=r(`br`,null,null,-1),d[59]||=r(`br`,null,null,-1),d[60]||=o(`
Voluptates, aut distinctio esse quia doloribus commodi minima inventore neque sequi
dolores perspiciatis fugiat. Fuga, reprehenderit sequi veritatis iure magnam excepturi
aliquid dolore quo amet deserunt asperiores placeat maxime perferendis.`,-1)]),_:1},8,[`modelValue`])]),_:1}),a(x,{h2:``},{default:t(()=>[...d[64]||=[o(`Nesting`,-1)]]),_:1}),d[96]||=r(`p`,null,`It is possible to open a dialog inside a dialog.`,-1),a(D,{"content-class":`pt5`},{pug:t(()=>[...d[71]||=[o(`w-button.px4(@click="dialog1.show = true") Open dialog
...
w-dialog(v-model="dialog2.show" :width="250" title="Dialog 2" content-class="text-center")
  w-button.my6(@click="dialog2.show = false" bg-color="error") Close`,-1)]]),html:t(()=>[...d[72]||=[o(`<w-button
  class="px4"
...
</w-dialog>`,-1)]]),js:t(()=>[...d[73]||=[o(`data: () => ({
  dialog1: { show: false },
  dialog2: { show: false }
})
`,-1)]]),default:t(()=>[a(S,{class:`px4`,onClick:d[13]||=e=>u.dialog3.show=!0},{default:t(()=>[...d[65]||=[o(`Open dialog`,-1)]]),_:1}),a(E,{modelValue:u.dialog3.show,"onUpdate:modelValue":d[16]||=e=>u.dialog3.show=e,width:600,title:`Dialog 1`,"content-class":`text-center`},{actions:t(()=>[d[68]||=r(`div`,{class:`spacer`},null,-1),a(S,{onClick:d[15]||=e=>u.dialog3.show=!1,"bg-color":`error`},{default:t(()=>[...d[67]||=[o(`Close`,-1)]]),_:1})]),default:t(()=>[d[69]||=r(`p`,null,`Lorem ipsum, dolor sit amet consectetur adipisicing elit...`,-1),a(S,{class:`mt6`,onClick:d[14]||=e=>u.dialog4.show=!0},{default:t(()=>[...d[66]||=[o(`Open second dialog`,-1)]]),_:1})]),_:1},8,[`modelValue`]),a(E,{modelValue:u.dialog4.show,"onUpdate:modelValue":d[18]||=e=>u.dialog4.show=e,width:250,title:`Dialog 2`,"content-class":`text-center`},{default:t(()=>[a(S,{class:`my6`,onClick:d[17]||=e=>u.dialog4.show=!1,"bg-color":`error`},{default:t(()=>[...d[70]||=[o(`Close`,-1)]]),_:1})]),_:1},8,[`modelValue`])]),_:1}),a(x,{h2:``},{default:t(()=>[...d[74]||=[o(`Transitions`,-1)]]),_:1}),d[97]||=r(`p`,null,[o(`To change the default transition you can use the `),r(`code`,null,`transition`),o(` prop and provide one of
the following transition name.`)],-1),a(D,null,{pug:t(()=>[...d[79]||=[o(`.w-flex
...
w-dialog(
  ...
  w-button.my6(@click="dialog.show = false" bg-color="error") Close`,-1)]]),html:t(()=>[...d[80]||=[o(`<div class="w-flex">
  <w-button
    class="px4 mr6"
...
w-dialog(
  ...
  template(#actions)
    .spacer
    w-button(@click="dialog.show = false" bg-color="error") Close`,-1)]]),html:t(()=>[...d[93]||=[o(`<w-button
  class="px4"
  @click="dialog.show = true">
  Open control panel
</w-button>
