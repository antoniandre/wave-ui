import{r as l,o as p,g as f,a as s,w as n,b as e,d as t,t as r,n as x,h as d,_ as g}from"./index-DdII2_7N.js";const b=t("p",null,[e("If you are not familiar with breakpoints, you should first read about it."),t("br"),e(`
...
All the layout classes presented in: `),s(u,{class:"ml1",to:"/layout--flex"},{default:n(()=>[e("Layout > Flex")]),_:1})])]),s(o,{h2:""},{default:n(()=>[e("Default breakpoints")]),_:1}),v,s(o,{h2:"",slug:"the-wave-ui-breakpoint-object"},{default:n(()=>[e("The "),S,e(" object")]),_:1}),j,s(i,null,{pug:n(()=>[e(`w-card.blue-light5--bg
  ...
  em.grey.mt1 Resizing your browser will update the current breakpoint.`)]),html:n(()=>[e(`<w-card class="blue-light5--bg">
...
`)]),default:n(()=>[s(m,{class:x({"blue-light5--bg":!a.$store.state.darkMode})},{default:n(()=>[t("div",C,[e("Current breakpoint: "),t("code",null,r(a.$waveui.breakpoint.name),1)]),$]),_:1},8,["class"])]),_:1}),s(o,{h2:""},{default:n(()=>[e("breakpoint-specific layout classes")]),_:1}),I,s(c,{language:"css",dark:a.$store.state.darkMode},{default:n(()=>[e(`.show {display: block;}
.hide {display: none;}
...
`),A,e(" option in the global configuration."),s(c,{class:"mb0",language:"js",dark:a.$store.state.darkMode},{default:n(()=>[e(`app.use(WaveUI, {
  css: {
    breakpointLayoutClasses: false
  }
})
`)]),_:1},8,["dark"])]),_:1}),s(o,{h2:""},{default:n(()=>[e("Setting custom breakpoints")]),_:1}),D,s(c,{language:"js",dark:a.$store.state.darkMode},{default:n(()=>[e(`app.use(WaveUI, {
  breakpoints: {
    xs: 600,
    sm: 900,
    md: 1200,
