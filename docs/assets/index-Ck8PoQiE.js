import{r as m,o as w,g,a as e,w as o,d as l,b as t,h as D,t as u,n as E,f as S,_ as b,G as x}from"./index-SAfhmDsO.js";const B={class:"w-flex wrap"},j={class:"w-flex align-center my4"},q={class:"w-flex justify-end align-center"};function N(a,n,h,y,k,f){const c=m("alert"),s=m("title-link"),i=m("w-confirm"),r=m("example"),d=m("w-flex"),v=m("w-icon"),A=m("w-input"),C=m("w-transition-slide-fade"),T=m("w-card");return w(),g("div",null,[e(c,{info:""},{default:o(()=>n[5]||(n[5]=[l("ul",null,[l("li",null,[t("The purpose of the "),l("strong",{class:"code"},"w-confirm"),t(` component is to quickly set up a
