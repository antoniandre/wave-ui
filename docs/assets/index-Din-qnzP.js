import{r as i,o as v,g as w,a as o,w as n,b as s,t as p,d as r,n as B,_ as h,V as _}from"./index-CloZfqX8.js";const V=r("p",null,[s("By default the overlay has a "),r("span",{class:"code"},"0.3"),s(` opacity with a black color and a z-index
...
`)],-1),N=r("span",{class:"code"},"persistent",-1),S=r("p",null,"When the overlay is persistent, it will not close on click and on escape key.",-1),C=r("p",null,"When persistent is set to false and by default, the escape key will also close the overlay.",-1),E=r("div",{class:"title4"},"Options",-1),H={class:"code inherit"},U={class:"code inherit"},W=r("p",null,[s(`The backdrop filter is very recently
`),r("a",{href:"https://caniuse.com/css-backdrop-filter",target:"_blank"},"supported on all the major browsers"),s(`
and very nice.`)],-1);function D(e,t,b,f,k,d){const c=i("title-link"),a=i("w-button"),u=i("w-divider"),O=i("w-input"),$=i("w-flex"),m=i("w-icon"),y=i("w-overlay"),g=i("example"),A=i("ssh-pre");return v(),w("div",null,[V,o(c,{h2:""},{default:n(()=>[s("Overlay with custom opacity and control on "),N]),_:1}),S,C,o(g,null,{pug:n(()=>[s(`w-flex(wrap)
