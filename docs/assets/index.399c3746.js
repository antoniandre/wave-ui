import{r as c,o as g,f as p,a as n,w as o,b as e,h as d,d as t,_ as h,a0 as _,C as f}from"./index.bf306805.js";const y={class:"mt2"},x=t("strong",{class:"mr2"},"v-model:",-1),k={class:"mt2"},V=t("strong",{class:"mr2"},"v-model:",-1),$=t("p",null,[e("Like in most components, you can set a "),t("code",null,"color"),e(" for the foreground icons (when on) and a "),t("code",null,"bg-color"),e(` for the
...
`)],-1),A=t("br",null,null,-1),M=t("br",null,null,-1),C=t("br",null,null,-1),P=t("br",null,null,-1),N=t("p",null,"Use the disabled or readonly options to display a rating but prevent user votes.",-1),O=t("br",null,null,-1);function U(l,s,v,b,w,m){const r=c("title-link"),a=c("w-rating"),i=c("example");return g(),p("div",null,[n(r,{h2:""},{default:o(()=>[e("Default")]),_:1}),n(i,null,{pug:o(()=>[e("w-rating")]),html:o(()=>[e(`<w-rating></w-rating>
...
`)]),default:o(()=>[n(a,{class:"my2",icon:"mdi mdi-heart","model-value":3}),S,n(a,{class:"my2",icon:"mdi mdi-heart-outline","model-value":3.4},null,8,["model-value"])]),_:1}),n(r,{h2:"",slug:"max"},{default:o(()=>[e("Max (number of buttons)")]),_:1}),T,n(i,null,{pug:o(()=>[e(`w-rating.my2(:model-value="2" :max="3")
br
