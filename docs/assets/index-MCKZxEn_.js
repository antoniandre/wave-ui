...
a progress bar while loading.`)],-1),xe=a("p",null,"The pagination can be provided as an object:",-1),ve=E(`<p>More details in the <a href="#pagination">API section</a>.</p><p>The pagination is a two-way binding object: if you modify any property inside it, the table
...
</p>`,3),_e=a("p",null,"This example showcases an asynchronous pagination with backend fetching of the table items.",-1),Fe={class:"w-flex align-center gap2 pa1"},Ie={class:"w-flex gap2 no-grow"},Se={class:"mb0"},Re=a("p",null,"Click a row to see it highlighted and get information about the selected item.",-1),Ce=a("p",null,[e("By default, the selection will use the "),a("code",null,"primary"),e(" color and apply an opacity of "),a("code",null,"0.2"),e(`.
If this is not what you want, you can override it via CSS (`),a("code",null,".w-table__row--selected td:before"),e(`).
`)],-1),De=a("span",{class:"code"},"selectable-rows",-1),Le=a("p",null,[e("You can enable the rows selection by adding the "),a("code",null,"selectable-rows"),e(` prop, or disable it by
...
`)],-1),Te=a("span",{class:"code"},"force-selection",-1),Ee=a("p",null,[e("Eventually, you can use the "),a("code",null,"force-selection"),e(` prop to prevent unselecting a row when only
one remain selected.
`)],-1),Ae=a("span",{class:"code"},"@row-select",-1),Be=E(`<p>This event is fired each time a row is selected <strong>or unselected</strong> (so you don&#39;t need to listen
...
information such as:</p><ul><li><code>item</code>: the clicked row object</li><li><code>selected</code>: a boolean telling if the row is being selected or unselected</li><li><code>selectedRows</code>: an array of all the selected rows objects</li></ul>`,2),je=a("div",{class:"mt4 title4"},"Selection info:",-1),Me=a("p",null,`Wave UI offers a convenient way to provide an array of selected rows and keeping your array in sync
with the selected rows after user interaction.`,-1),Pe=a("ul",null,[a("li",null,[a("strong",null,"In Vue 2"),e(", you can do 2-way binding on any variable other than the "),a("strong",{class:"code"},"v-model"),e(" using the "),a("code",null,".sync"),e(" modifier.")]),a("li",null,[a("strong",null,"In Vue 3"),e(", multiple "),a("strong",{class:"code"},"v-model"),e(" are supported in order to achieve 2-way binding. So you don't need "),a("code",null,".sync"),e(".")])],-1),Ve={class:"mt4"},qe={class:"ml2"},ze=a("br",null,null,-1),He=a("code",null,"id",-1),We=a("code",null,"uid-key",-1),Ke=a("p",null,"You can customize the headers labels and/or each row cells.",-1),Oe=a("p",null,[e("In this example, only the headers are customized via the "),a("code",null,"header-label"),e(" slot.")],-1),Ue=a("p",null,[e("In this example, only the items cells are customized via the "),a("code",null,"item"),e(` slot
(and the headers are hidden).`)],-1),Je={key:0},Ye={class:"grey mr2"},Ge=E(`<p>If you only need to override 1 particular column you can do it via the <code>item-cell.xxx</code> slot,
...
where <code>i</code> is a an integer starting at 1.</p>`,1),Xe=a("p",null,[e(`In this example, the full <tr> DOM element is customized, so you can add your own classes
...
code to write.`)],-1),Qe=["onClick"],Ze=a("span",{class:"code"},"colspan",-1),$e=a("p",null,[e("This example is showcasing another useful case: handling a colspan attribute."),a("br"),e(`
All the cells of all the rows are `),a("code",null,"colspan"),e("'d to one, and a custom row layout is applied.")],-1),et=["onClick"],tt=["colspan"],at={class:"title3"},nt={class:"mr2"},lt=a("p",null,[e("In addition to the full responsiveness, the "),a("code",null,"w-table"),e(` can be presented in a mobile friendly layout,
...
`)],-1),it=a("p",null,[e("To stay lean and efficient, the minimum JavaScript behavior is added to the "),a("code",null,"w-table"),e(`
component.`),a("br"),e(`
...
`)],-1);function st(d,s,g,_,l,c){const o=p("title-link"),r=p("w-table"),h=p("example"),b=p("w-button"),F=p("w-icon"),B=p("w-flex"),L=p("ssh-pre"),j=p("w-tag"),M=p("w-radios"),I=p("alert"),q=p("w-input");return f(),N("div",null,[n(o,{h2:""},{default:t(()=>[e("Basic")]),_:1}),n(h,null,{pug:t(()=>[e('w-table(:headers="table.headers" :items="table.items")')]),html:t(()=>[e(`<w-table
...
`)]),default:t(()=>[n(r,{headers:l.table1.headers,items:l.table3.items,"fixed-headers":"",loading:l.table1.loading,style:{height:"200px"}},null,8,["headers","items","loading"])]),_:1}),n(o,{h2:"",slug:"pagination"},{default:t(()=>[e("Pagination"),n(j,{class:"ml2 text-bold",round:"",color:"warning",outline:"",sm:""},{default:t(()=>[e("IN PROGRESS")]),_:1})]),_:1}),xe,n(L,{language:"js"},{default:t(()=>[e(`{
...
app.mount('#app')
`)]),default:t(()=>[n(r,{headers:l.table12.headers,items:l.table12.items,"fixed-headers":"","fixed-footer":"",fetch:l.table12.fetch,pagination:l.table12.pagination,loading:l.table12.loading,style:{"max-height":"500px"}},null,8,["headers","items","fetch","pagination","loading"])]),_:1}),n(o,{h3:""},{default:t(()=>[e("Custom pagination layout")]),_:1}),n(h,{"blank-codepen":["js"]},{pug:t(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
...
app.mount('#app')
`)]),default:t(()=>[n(r,{headers:l.table11.headers,items:l.table11.items,"fixed-headers":"","fixed-footer":"",pagination:l.table11.pagination,style:{"max-height":"500px"}},{pagination:t(({range:m,total:u,page:y,pagesCount:k,goToPage:x})=>[a("div",Fe,[a("div",Ie,[n(b,{onClick:w=>x("-1"),disabled:y===1,icon:"wi-chevron-left",xs:""},null,8,["onClick","disabled"]),(f(!0),N(S,null,D(k,w=>(f(),T(b,{key:w,onClick:Nt=>w!==y&&x(w),outline:y===w,round:"",xs:""},{default:t(()=>[e(i(w),1)]),_:2},1032,["onClick","outline"]))),128)),n(b,{onClick:w=>x("+1"),disabled:y===k,icon:"wi-chevron-right",xs:""},null,8,["onClick","disabled"])]),a("p",Se,i(m)+" of "+i(u)+".",1)])]),_:1},8,["headers","items","pagination"])]),_:1}),n(o,{h3:""},{default:t(()=>[e("Initing the pagination with a certain state")]),_:1}),n(h,{"blank-codepen":["js"]},{pug:t(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
  fixed-headers
  fixed-footer
...
app.mount('#app')
`)]),default:t(()=>[n(r,{headers:l.table13.headers,items:l.table13.items,"fixed-headers":"","fixed-footer":"",fetch:l.table13.fetch,pagination:l.table13.pagination,loading:l.table13.loading,style:{"max-height":"500px"}},null,8,["headers","items","fetch","pagination","loading"])]),_:1}),n(o,{h2:""},{default:t(()=>[e("Rows selection")]),_:1}),Re,Ce,n(o,{h3:"",slug:"example--selectable-rows"},{default:t(()=>[e("The "),De,e(" prop")]),_:1}),Le,n(o,{h3:"",slug:"example--force-selection"},{default:t(()=>[e("The "),Te,e(" prop")]),_:1}),Ee,n(o,{h3:"",slug:"example--row-select"},{default:t(()=>[e("The "),Ae,e(" event")]),_:1}),Be,n(h,null,{pug:t(()=>[e(`w-flex.mb4(wrap)
...
`)]),default:t(()=>[n(B,{class:"mb4",wrap:""},{default:t(()=>[n(M,{class:"mr6",modelValue:l.table1.selectableRows,"onUpdate:modelValue":s[8]||(s[8]=m=>l.table1.selectableRows=m),items:l.selectableRowsOptions},null,8,["modelValue","items"]),n(b,{class:"my3",onClick:s[9]||(s[9]=m=>l.table1.forceSelection=!l.table1.forceSelection),round:"",outline:!l.table1.forceSelection},{default:t(()=>[l.table1.forceSelection?(f(),T(F,{key:0,class:"mr2"},{default:t(()=>[e("wi-check")]),_:1})):H("",!0),e("Force selection")]),_:1},8,["outline"])]),_:1}),n(r,{headers:l.table1.headers,items:l.table1.items,"selectable-rows":l.table1.selectableRows,"force-selection":l.table1.forceSelection,onRowSelect:s[10]||(s[10]=m=>l.selectionInfo=m)},null,8,["headers","items","selectable-rows","force-selection"]),je,a("pre",null,i(l.selectionInfo),1)]),_:1}),n(o,{h3:""},{default:t(()=>[e("Updating the selected rows programmatically")]),_:1}),Me,n(I,{tip:""},{default:t(()=>[Pe]),_:1}),n(h,null,{pug:t(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
  selectable-rows
...
})`)]),default:t(()=>[n(r,{headers:l.table1.headers,items:l.table1.items,"selectable-rows":"","selected-rows":l.table1.selectedRows,"onUpdate:selectedRows":s[11]||(s[11]=m=>l.table1.selectedRows=m)},null,8,["headers","items","selected-rows"]),a("div",Ve,[e("Selected rows:"),a("code",qe,i(l.table1.selectedRows),1)])]),_:1}),n(I,{info:""},{default:t(()=>[e("In order to keep the same row selected after sorting or filtering, each row is assigned a unique identifier."),ze,e(`
By default the expanded rows array will use an `),He,e(` key, if present in the item object,
...
the `),We,e(` prop, which is set to "id" by default.
...
`)]),default:t(()=>[n(r,{headers:l.table1.headers,items:l.table1.items},{"header-label":t(({label:m,index:u})=>[e(i(u)+": "+i(m)+" 👌",1)]),_:1},8,["headers","items"])]),_:1}),n(o,{h3:"",slug:"item-cells"},{default:t(()=>[e("Item cells (inside <td> element)")]),_:1}),Ue,n(h,null,{pug:t(()=>[e(`w-table(:headers="table.headers" no-headers :items="table.items")
...
`)]),default:t(()=>[n(r,{headers:l.table1.headers,"no-headers":"",items:l.table1.items},{"item-cell":t(({item:m,label:u,header:y,index:k})=>[y.key==="id"?(f(),N("small",Je,"#"+i(k),1)):(f(),N(S,{key:1},[a("small",Ye,i(y.label)+":",1),a("span",null,i(u),1)],64))]),_:1},8,["headers","items"])]),_:1}),n(o,{h3:"",slug:"override-1-particular-item-cell"},{default:t(()=>[e("override 1 particular item cell or column cells (inside <td> element)")]),_:1}),Ge,n(h,null,{pug:t(()=>[e(`w-table(:headers="table.headers" :items="table.items" no-headers)
...
`)]),default:t(()=>[n(r,{headers:l.table1.headers,items:l.table1.items,"selectable-rows":""},{item:t(({item:m,index:u,select:y,classes:k})=>[a("tr",{class:v(k),onClick:y},[(f(!0),N(S,null,D(l.table1.headers,(x,w)=>(f(),N("td",{key:w,class:v(`pa4 text-${x.align||"left"}`)},i(m[x.key]||""),3))),128))],10,Qe)]),_:1},8,["headers","items"])]),_:1}),n(o,{h3:"",slug:"colspan-on-td"},{default:t(()=>[Ze,e(" on <td>")]),_:1}),$e,n(h,null,{pug:t(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
  no-headers
  selectable-rows)
...
`)]),default:t(()=>[n(r,{headers:l.table1.headers,items:l.table1.items,"no-headers":"","selectable-rows":""},{item:t(({item:m,index:u,select:y,classes:k})=>[a("tr",{class:v({...k,[`indigo-${d.$store.state.darkMode?"dark":"light"}5--bg`]:u%2,[`blue-${d.$store.state.darkMode?"dark":"light"}5--bg`]:!(u%2)}),onClick:y},[a("td",{class:"pa2",colspan:l.table1.headers.length},[a("div",at,"Row #"+i(u),1),a("ul",null,[(f(!0),N(S,null,D(l.table1.headers,(x,w)=>(f(),N("li",{key:w},[a("strong",nt,i(x.label)+":",1),e(i(m[x.key]||""),1)]))),128))])],8,tt)],10,et)]),_:1},8,["headers","items"])]),_:1}),n(o,{h2:""},{default:t(()=>[e("Responsiveness & mobile layout")]),_:1}),lt,n(h,null,{pug:t(()=>[e(`w-table(
  :headers="table.headers"
  :items="table.items"
