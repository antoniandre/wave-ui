import{o as m,g as p,a as t,w as a,b as e,d as s,e as i,c as S,f as j,h as y,r,_ as u,Q as _}from"./index.d241780a.js";const E=y(`<div class="title3">A simple &lt;img&gt;</div><p>will display when loaded, and will take the dimensions of the actual image.<br>
...
You can customize the transition.`,-1),V={class:"w-flex wrap justify-center align-center"},C={class:"mr4 my2"},z=i("div",{class:"title3 mb2"},"Transition names",-1),D=i("strong",null,"Dev notes:",-1),O=i("br",null,null,-1),N=i("strong",{class:"code"},"w-image",-1),P=i("p",null,[e(`The default fallback is a blank 1x1 transparent gif. So if the image can't load, a transparent
