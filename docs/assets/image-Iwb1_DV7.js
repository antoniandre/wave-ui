import{N as e,W as t,bt as n,c as r,d as i,g as a,h as o,k as s,l as c,u as l}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as u}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{T as d}from"./index-DQ7e6RHF.js";var f={class:`w-card w-flex mdu-row basis-zero pa4 gap4`},p={class:`mr5`},m={class:`w-flex wrap justify-center align-center`},h={class:`mr4 my2`},g={class:`w-flex gap6`};function _(u,d,_,v,y,b){let x=e(`title-link`),S=e(`w-divider`),C=e(`alert`),w=e(`w-image`),T=e(`example`),E=e(`w-card`),D=e(`w-radios`),O=e(`w-button`),k=e(`w-alert`);return s(),i(`div`,null,[a(x,{h2:``},{default:t(()=>[...d[2]||=[o(`Why using w-image and not a simple <img>`,-1)]]),_:1}),r(`div`,f,[d[4]||=r(`div`,null,[r(`div`,{class:`title3`},`A simple <img>`),r(`p`,null,[o(`will display when loaded, and will take the dimensions of the actual image.`),r(`br`),o(`
