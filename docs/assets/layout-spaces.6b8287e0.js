import{r as i,o as c,e as r,f as t,w as n,g as s,i as e,N as h}from"./vendor.e64646cc.js";import{_ as d}from"./index.f3654a4f.js";const g=e("Spaces"),p=e("Content spacing"),m=h(`<p>Margins and paddings are incrementable from 0 to 12 using this syntax: <code>ma[number]</code>,
...
`),M=e("Negative margin"),A=s("p",null,[e(`Sometimes you may need negative margins, Wave UI also provides 12 negative increments for this
purpose.`),s("br"),e(`
...
orange container.`)],-1),L=s("div",{class:"orange-light4--bg pa8"},null,-1),R=s("div",{class:"green-light4--bg mt-8 mx8 pa3"},[e("This green container has a "),s("span",{class:"code"},"mt-8"),e(` class which results in a negative top margin of: -8 x 4 x
base-font-size pixels.`)],-1),U=e(`.orange-light4--bg.pa8
.green-light4--bg.mt-8.mx8.pa3.
  This green container has a \`mt-8\` class which results in a negative top margin of: -8 x 4 x
  base-font-size pixels.`),W=e(`<div class="orange-light4--bg pa8">
  <div class="green-light4--bg mt-8 mx8 pa3">
    This green container has a \`mt-8\` class which results in a negative top margin of: 8 x 4 x
    base-font-size pixels.
  </div>
</div>
`),Y=e("Margin auto"),q=s("p",null,[e("Last but not least, margin: auto is also possible with the "),s("code",null,"a"),e(" modifier."),s("br"),e(`
...
</div>`);function H(K,O){const a=i("title-link"),l=i("router-link"),o=i("example");return c(),r("main",null,[t(a,{class:"mt4",h1:""},{default:n(()=>[g]),_:1}),t(a,{h2:""},{default:n(()=>[p]),_:1}),m,t(o,null,{pug:n(()=>[B,j,E]),html:n(()=>[I]),default:n(()=>[s("div",_,[s("div",u,[x,b,f,v,w,y,T,z,S,t(l,{to:"customization"},{default:n(()=>[k]),_:1}),C,N]),V])]),_:1}),t(a,{h3:""},{default:n(()=>[M]),_:1}),A,t(o,null,{pug:n(()=>[U]),html:n(()=>[W]),default:n(()=>[L,R]),_:1}),t(a,{h3:""},{default:n(()=>[Y]),_:1}),q,t(o,null,{pug:n(()=>[F]),html:n(()=>[G]),default:n(()=>[D]),_:1})])}const J={};var X=d(J,[["render",H]]);export{X as default};
