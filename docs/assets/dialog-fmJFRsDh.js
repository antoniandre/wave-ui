import{A as e,G as t,K as n,P as r,c as i,d as a,g as o,h as s,xt as c}from"./runtime-core.esm-bundler-CLfruy3s.js";import{t as l}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{A as u,Y as d}from"./index-I7dyuwKt.js";var f={class:`w-flex mt6 no-grow`},p={class:`w-flex`},m={class:`w-flex wrap`},h={class:`ma2`},g={class:`ma2`};function _(l,u,_,v,y,b){let x=r(`title-link`),S=r(`w-button`),C=r(`w-icon`),w=r(`w-checkbox`),T=r(`w-radios`),E=r(`w-dialog`),D=r(`example`),O=r(`w-radio`);return e(),a(`div`,null,[o(x,{h2:``},{default:t(()=>[...u[35]||=[s(`Global demo`,-1)]]),_:1}),u[95]||=i(`p`,null,`This dialog contains some basic options for the w-dialog.`,-1),o(D,{"content-class":`pt5`},{pug:t(()=>[...u[43]||=[s(`w-button.px4(@click="dialog.show = true") Open dialog
...
w-dialog(
  ...
  template(#actions)
    .spacer
    w-button(@click="dialog.show = false") Close`,-1)]]),html:t(()=>[...u[44]||=[s(`<w-button class="px4" @click="dialog.show = true">
  Open dialog
</w-button>
...
`,-1)]]),default:t(()=>[o(S,{class:`px4`,onClick:u[0]||=e=>l.dialog1.show=!0},{default:t(()=>[...u[36]||=[s(`Open dialog`,-1)]]),_:1}),o(E,{modelValue:l.dialog1.show,"onUpdate:modelValue":u[6]||=e=>l.dialog1.show=e,fullscreen:l.dialog1.fullscreen,width:l.dialog1.width,persistent:l.dialog1.persistent,"persistent-no-animation":l.dialog1.persistentNoAnimation,"title-class":`primary-light1--bg white`},{title:t(()=>[o(C,{class:`mr2`},{default:t(()=>[...u[37]||=[s(`mdi mdi-tune`,-1)]]),_:1}),u[38]||=s(`Control panel`,-1)]),actions:t(()=>[u[41]||=i(`div`,{class:`spacer`},null,-1),o(S,{onClick:u[5]||=e=>l.dialog1.show=!1},{default:t(()=>[...u[40]||=[s(`Close`,-1)]]),_:1})]),default:t(()=>[o(w,{class:`d-flex mt2`,modelValue:l.dialog1.fullscreen,"onUpdate:modelValue":u[1]||=e=>l.dialog1.fullscreen=e,label:`Fullscreen`},null,8,[`modelValue`]),o(w,{class:`d-flex mt2`,modelValue:l.dialog1.persistent,"onUpdate:modelValue":u[2]||=e=>l.dialog1.persistent=e,label:`Persistent (try to click outside)`},null,8,[`modelValue`]),o(w,{class:`d-flex mt2`,modelValue:l.dialog1.persistentNoAnimation,"onUpdate:modelValue":u[3]||=e=>l.dialog1.persistentNoAnimation=e,disabled:!l.dialog1.persistent,label:`Persistent with no animation`},null,8,[`modelValue`,`disabled`]),i(`div`,f,[u[39]||=i(`span`,{class:`mr2`},`Width:`,-1),o(T,{modelValue:l.dialog1.width,"onUpdate:modelValue":u[4]||=e=>l.dialog1.width=e,items:[{value:300,label:`300px`},{value:500,label:`500px`}],inline:``},null,8,[`modelValue`])]),u[42]||=i(`div`,{class:`mt4 mb-2 grey-light1`},[s(`The `),i(`span`,{class:`code grey-light1`},`width`),s(` prop is called so for simplicity, but it internally translates to
a `),i(`span`,{class:`code grey-light1`},`max-width`),s(` to fit on small screens.
`)],-1)]),_:1},8,[`modelValue`,`fullscreen`,`width`,`persistent`,`persistent-no-animation`])]),_:1}),o(x,{h2:``},{default:t(()=>[...u[46]||=[s(`Basic`,-1)]]),_:1}),o(D,{"content-class":`pt5`},{pug:t(()=>[...u[49]||=[s(`w-button.px4(@click="showDialog = true") Open dialog
...
w-dialog(v-model="showDialog" title="Dialog title").
  ...
  perspiciatis repellendus. Sunt!`,-1)]]),html:t(()=>[...u[50]||=[s(`<w-button class="px4" @click="showDialog = true">
  Open dialog
</w-button>
...
<w-dialog>`,-1)]]),js:t(()=>[...u[51]||=[s(`data: () => ({
  showDialog: false
})
`,-1)]]),default:t(()=>[o(S,{class:`px4`,onClick:u[7]||=e=>l.dialog0.show=!0},{default:t(()=>[...u[47]||=[s(`Open dialog`,-1)]]),_:1}),o(E,{modelValue:l.dialog0.show,"onUpdate:modelValue":u[8]||=e=>l.dialog0.show=e,title:`Dialog title`},{default:t(()=>[...u[48]||=[s(`Lorem ipsum dolor sit amet consectetur adipisicing elit.`,-1),i(`br`,null,null,-1),s(`
Unde eum non necessitatibus quia corporis odio numquam sequi iusto
voluptatum delectus? Excepturi minus iste, provident non totam itaque
...
labore nemo voluptates necessitatibus esse amet voluptatibus modi deleniti
porro officiis ut fugit quidem corporis itaque possimus commodi sint unde
perspiciatis repellendus. Sunt!`,-1)]]),_:1},8,[`modelValue`])]),_:1}),o(x,{h2:``},{default:t(()=>[...u[52]||=[s(`Persistent prompt dialog`,-1)]]),_:1}),o(D,{"content-class":`pt5`},{pug:t(()=>[...u[61]||=[s(`w-button.px4(@click="dialog.show = true") Open dialog
...
w-dialog(
  ...
  template(#actions)
    ...
    w-button(@click="dialog.show = false" bg-color="success") I agree`,-1)]]),html:t(()=>[...u[62]||=[s(`<w-button class="px4" @click="dialog.show = true">
  Open dialog
</w-button>
...
</w-dialog>`,-1)]]),js:t(()=>[...u[63]||=[s(`data: () => ({
  dialog: { show: false }
})
`,-1)]]),default:t(()=>[o(S,{class:`px4`,onClick:u[9]||=e=>l.dialog2.show=!0},{default:t(()=>[...u[53]||=[s(`Open dialog`,-1)]]),_:1}),o(E,{modelValue:l.dialog2.show,"onUpdate:modelValue":u[12]||=e=>l.dialog2.show=e,title:`Terms and conditions`,persistent:``,width:550},{actions:t(()=>[u[56]||=i(`div`,{class:`spacer`},null,-1),o(S,{class:`mr2`,onClick:u[10]||=e=>l.dialog2.show=!1,"bg-color":`error`},{default:t(()=>[...u[54]||=[s(`I disagree`,-1)]]),_:1}),o(S,{onClick:u[11]||=e=>l.dialog2.show=!1,"bg-color":`success`},{default:t(()=>[...u[55]||=[s(`I agree`,-1)]]),_:1})]),default:t(()=>[u[57]||=s(`Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rem dolore delectus,
quisquam ipsa laudantium esse consequatur itaque similique et eligendi eum voluptas
odit dolor labore eveniet at vel sequi nostrum.`,-1),u[58]||=i(`br`,null,null,-1),u[59]||=i(`br`,null,null,-1),u[60]||=s(`
Voluptates, aut distinctio esse quia doloribus commodi minima inventore neque sequi
dolores perspiciatis fugiat. Fuga, reprehenderit sequi veritatis iure magnam excepturi
aliquid dolore quo amet deserunt asperiores placeat maxime perferendis.`,-1)]),_:1},8,[`modelValue`])]),_:1}),o(x,{h2:``},{default:t(()=>[...u[64]||=[s(`Nesting`,-1)]]),_:1}),u[96]||=i(`p`,null,`It is possible to open a dialog inside a dialog.`,-1),o(D,{"content-class":`pt5`},{pug:t(()=>[...u[71]||=[s(`w-button.px4(@click="dialog1.show = true") Open dialog
...
w-dialog(v-model="dialog2.show" :width="250" title="Dialog 2" content-class="text-center")
  w-button.my6(@click="dialog2.show = false" bg-color="error") Close`,-1)]]),html:t(()=>[...u[72]||=[s(`<w-button
  class="px4"
...
</w-dialog>`,-1)]]),js:t(()=>[...u[73]||=[s(`data: () => ({
  dialog1: { show: false },
  dialog2: { show: false }
})
`,-1)]]),default:t(()=>[o(S,{class:`px4`,onClick:u[13]||=e=>l.dialog3.show=!0},{default:t(()=>[...u[65]||=[s(`Open dialog`,-1)]]),_:1}),o(E,{modelValue:l.dialog3.show,"onUpdate:modelValue":u[16]||=e=>l.dialog3.show=e,width:600,title:`Dialog 1`,"content-class":`text-center`},{actions:t(()=>[u[68]||=i(`div`,{class:`spacer`},null,-1),o(S,{onClick:u[15]||=e=>l.dialog3.show=!1,"bg-color":`error`},{default:t(()=>[...u[67]||=[s(`Close`,-1)]]),_:1})]),default:t(()=>[u[69]||=i(`p`,null,`Lorem ipsum, dolor sit amet consectetur adipisicing elit...`,-1),o(S,{class:`mt6`,onClick:u[14]||=e=>l.dialog4.show=!0},{default:t(()=>[...u[66]||=[s(`Open second dialog`,-1)]]),_:1})]),_:1},8,[`modelValue`]),o(E,{modelValue:l.dialog4.show,"onUpdate:modelValue":u[18]||=e=>l.dialog4.show=e,width:250,title:`Dialog 2`,"content-class":`text-center`},{default:t(()=>[o(S,{class:`my6`,onClick:u[17]||=e=>l.dialog4.show=!1,"bg-color":`error`},{default:t(()=>[...u[70]||=[s(`Close`,-1)]]),_:1})]),_:1},8,[`modelValue`])]),_:1}),o(x,{h2:``},{default:t(()=>[...u[74]||=[s(`Transitions`,-1)]]),_:1}),u[97]||=i(`p`,null,[s(`To change the default transition you can use the `),i(`code`,null,`transition`),s(` prop and provide one of
the following transition name.`)],-1),o(D,null,{pug:t(()=>[...u[79]||=[s(`.w-flex
...
w-dialog(
  ...
  w-button.my6(@click="dialog.show = false" bg-color="error") Close`,-1)]]),html:t(()=>[...u[80]||=[s(`<div class="w-flex">
  <w-button
    class="px4 mr6"
...
w-dialog(
  ...
  template(#actions)
    .spacer
    w-button(@click="dialog.show = false" bg-color="error") Close`,-1)]]),html:t(()=>[...u[93]||=[s(`<w-button
  class="px4"
  @click="dialog.show = true">
  Open control panel
</w-button>
