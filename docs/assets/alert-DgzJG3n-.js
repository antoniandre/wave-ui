import{N as e,W as t,bt as n,c as r,d as i,g as a,h as o,k as s,l as c,u as l}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as u}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{V as d}from"./index-C4VjH_oM.js";var f={style:{"max-width":`1000px`}};function p(u,d,p,m,h,g){let _=e(`title-link`),v=e(`w-alert`),y=e(`example`),b=e(`w-button`),x=e(`w-transition-expand`);return s(),i(`div`,f,[a(_,{h2:``},{default:t(()=>[...d[5]||=[o(`Basic`,-1)]]),_:1}),d[95]||=r(`p`,null,[o(`The alert is commonly used to emphasize some content.`),r(`br`),o(`
