...
</w-card>`)]),default:t(()=>[e(d,{class:"md6 maa text-center"},{default:t(()=>[e(p,{class:"my12"},{default:t(()=>[s("Log in")]),_:1}),e(n,{class:"mx6",color:"pink"},{default:t(()=>[s("OR")]),_:1}),e(p,{class:"my12"},{default:t(()=>[s("Sign in")]),_:1})]),_:1})]),_:1})])}const Q={},W=g(Q,[["render",N]]),j=a("div",{class:"w-divider my12"},null,-1);function H(o,u,r,n,w,l){const d=i("title-link"),c=i("component-api");return h(),f("div",null,[j,e(d,{class:"title1",h2:""},{default:t(()=>[s("API")]),_:1}),e(c,{class:"mt0",items:l.props,descriptions:o.propsDescs,title:"Props"},null,8,["items","descriptions"]),e(c,{items:o.slots,title:"Slots"},null,8,["items"]),e(c,{items:l.events,title:"Events"},null,8,["items"])])}const F={color:'Provide a color for the divider. Accepts all the color names of the color palette, status colors, or custom colors (learn more about all the colors in the <a href="colors">colors</a> knowledge base page).<br>Providing a color hex, rgb(a) or hsl(a) will not work.',vertical:"When set to true, the divider will display vertically."},G={default:{description:"An optional HTML content to display in the middle of the divider."}},J={},K={data:()=>({propsDescs:F,slots:G}),computed:{props(){return x.props},events(){return x.emits.reduce((o,u)=>(o[u]=J[u]||{})&&o,{})}}},U=g(K,[["render",H]]);function X(o,u,r,n,w,l){const d=i("ui-component-title"),c=i("examples"),m=i("api");return h(),f("main",null,[e(d,null,{default:t(()=>[s("w-divider")]),_:1}),e(c),e(m)])}const Y={components:{Examples:W,Api:U}},ee=g(Y,[["render",X]]);export{ee as default};
