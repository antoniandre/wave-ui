...
like the label, you will need to add the `),K,n(" option."),O,a("a",F,[n("Read on deep watchers on the Vue.js official documentation"),t(b,{class:"ml1"},{default:e(()=>[n("mdi mdi-open-in-new")]),_:1})])])]),_:1}),t(c,{h2:""},{default:e(()=>[n("Custom item (icon + label)")]),_:1}),H,t(i,null,{pug:e(()=>[n(`w-tree.lh5(:data="tree")
