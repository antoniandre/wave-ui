import{o as h,g as m,e,b as o,a as t,w as n,r as s,_,y as g}from"./index.0ad1f9e2.js";const b={class:"title2 red"},y=e("p",{class:"mt6"},[o("This tag is required in your app for Wave UI proper functioning."),e("br"),o(`
...
`)]),default:n(()=>[C]),_:1})]),_:1}),t(a,{"bg-color":"orange",color:"white",overlap:"","model-value":2},{default:n(()=>[t(c,{class:"ma0 grow","content-class":"pa0","blank-codepen":["html","pug","css"]},{pug:n(()=>[o(`#app
  w-app(row)
    aside Nav menu
    w-flex(column)
      header Header
...
aside {background-color: #fef2ff;}
main {background-color: #efffed;}
`)]),default:n(()=>[M]),_:1})]),_:1}),t(a,{"bg-color":"orange",color:"white",overlap:"","model-value":4},{default:n(()=>[t(c,{class:"ma0 grow","content-class":"pa0","blank-codepen":["html","pug","css"]},{pug:n(()=>[o(`#app
  w-app(block)
    header Header
    w-flex
