...
`)]},proxy:!0}])},[t("w-list",{attrs:{items:e.listItems5,hover:""}})],1),t("title-link",{attrs:{h3:""}},[e._v("Selection-only color")]),e._m(2),e._m(3),e._m(4),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v('w-list(:value="[]" :items="items" selection-color="pink" multiple)')]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-list
  :value="[]"
  :items="items"
...
`)]},proxy:!0}])},[t("w-list",{attrs:{value:[],items:e.listItems4,"selection-color":"pink",multiple:""}})],1),t("title-link",{attrs:{h2:""}},[e._v("Custom rendering")]),e._m(5),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-list(:items="5" hover)
  template(#item="{ index }")
    | Item `+e._s("{{ index }}")+`
  template(#item.3)
...
`)]},proxy:!0}])},[t("w-list",{attrs:{items:5,hover:""},scopedSlots:e._u([{key:"item",fn:function(l){var s=l.index;return[e._v("Item "+e._s(s))]}},{key:"item.3",fn:function(){return[t("strong",[e._v("This is the great item #3")])]},proxy:!0}])})],1),e._m(6),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-list(:items="items" hover)
  template(#item="{ item }")
...
`)]},proxy:!0}])},[t("w-list",{attrs:{items:e.listItems2,hover:""},scopedSlots:e._u([{key:"item",fn:function(l){var s=l.item;return[t("div",{staticClass:"w-flex align-center justify-space-between"},[e._v(e._s(s.label)),t("w-icon",{attrs:{md:""}},[e._v(e._s(s.icon))])],1)]}}])})],1),t("title-link",{attrs:{h2:""}},[e._v("Selectable list items")]),e._m(7),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-radios.mb6(v-model="multiple" :items="radios" inline)
w-flex(wrap align-center)
  ...
  div(v-if="itemClicked")
    .title3 clicked item (`),t("code",[e._v("item-click")]),e._v(` event):
    br
    span.code `+e._s(e.itemClicked)+`
.title3.mt2
  | Selected item:
  code.ml2(v-if="!multiple || Array.isArray(selection1)") `+e._s(e.selection1||"null")+`
  code.ml2(v-else-if="multiple") `+e._s(e.selection1?[e.selection1]:"[]"))]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-radios v-model="multiple" :items="radios" inline></w-radios>
...
`)]},proxy:!0}])},[t("w-list",{attrs:{items:e.listItems5,checklist:""},model:{value:e.selection5,callback:function(l){e.selection5=l},expression:"selection5"}})],1),t("title-link",{attrs:{h2:""}},[e._v("Navigation lists")]),e._m(9),e._m(10),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-list(:items="listItems2" nav color="primary")
  template(#item="{ item }")
    span `+e._s("{{ item.label }")+`}
    .spacer
...
})`)]},proxy:!0}])},[t("w-list",{attrs:{items:e.listItems2,nav:"",color:"primary"},scopedSlots:e._u([{key:"item",fn:function(l){var s=l.item;return[t("span",[e._v(e._s(s.label))]),t("div",{staticClass:"spacer"}),t("w-icon",{attrs:{md:""}},[e._v(e._s(s.icon))])]}}])})],1),t("router-view")],1)},d=[function(){var e=this,i=e.$createElement,t=e._self._c||i;return t("p",[e._v("The "),t("span",{staticClass:"code"},[e._v("w-list")]),e._v(" component has multiple uses:")])},function(){var e=this,i=e.$createElement,t=e._self._c||i;return t("p",[e._v("Like in most components, you can set a "),t("code",[e._v("color")]),e._v(" for the text and a "),t("code",[e._v("bg-color")]),e._v(` for the
