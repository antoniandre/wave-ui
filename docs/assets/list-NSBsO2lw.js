import{H as e,N as t,c as n,d as r,g as i,h as a,k as o,m as s,u as c,vt as l}from"./runtime-core.esm-bundler-DPe36P4s.js";import{t as u}from"./_plugin-vue_export-helper-S3RvzygF.js";import{C as d}from"./index-D1jKshrg.js";var f={class:`lists-demo`},p={class:`w-flex wrap`},m={class:`grow`},h={class:`grow`},g={class:`w-flex align-center justify-space-between`},_={key:0},v={class:`code`},y={class:`title3 mt2`},b={key:0,class:`ml2`},x={key:1,class:`ml2`},S={class:`grow`},C={class:`grow`},w={class:`grow`},T={class:`grow`};function E(u,d,E,D,O,k){let A=t(`w-list`),j=t(`title-link`),M=t(`example`),N=t(`w-icon`),P=t(`w-radios`),F=t(`w-flex`),I=t(`router-view`);return o(),r(`div`,f,[d[65]||=n(`p`,null,[a(`The `),n(`span`,{class:`code`},`w-list`),a(` component has multiple uses:`)],-1),i(A,{items:4,icon:`wi-check`},{"item.1":e(()=>[...d[8]||=[a(`Simple list with or without icons`,-1)]]),"item.2":e(()=>[...d[9]||=[a(`Checklists`,-1)]]),"item.3":e(()=>[...d[10]||=[a(`Navigation menus`,-1)]]),"item.4":e(()=>[...d[11]||=[a(`List of selectable items`,-1)]]),_:1}),i(j,{h2:``},{default:e(()=>[...d[12]||=[a(`Basic lists`,-1)]]),_:1}),i(M,null,{pug:e(()=>[...d[15]||=[a(`.w-flex.wrap
  .grow
    .title3 Most basic
    w-list(:items="items")
  .grow
    .title3 With icons
    w-list(:items="items" icon="wi-check")`,-1)]]),html:e(()=>[...d[16]||=[a(`<w-flex wrap>
  <div class="grow">
...
`,-1)]]),default:e(()=>[n(`div`,p,[n(`div`,m,[d[13]||=n(`div`,{class:`title3`},`Most basic`,-1),i(A,{items:u.listItems1},null,8,[`items`])]),n(`div`,h,[d[14]||=n(`div`,{class:`title3`},`With icons`,-1),i(A,{items:u.listItems1,icon:`wi-check`},null,8,[`items`])])])]),_:1}),i(j,{h2:``},{default:e(()=>[...d[18]||=[a(`Color & hoverable`,-1)]]),_:1}),d[66]||=n(`p`,null,[a(`Like in most components, you can set a `),n(`code`,null,`color`),a(` for the text and a `),n(`code`,null,`bg-color`),a(` for the
background.`)],-1),i(M,null,{pug:e(()=>[...d[19]||=[a(`w-list(:items="items" color="pink" hover)
br
w-list(:items="items" bg-color="blue-light5" color="primary" hover)`,-1)]]),html:e(()=>[...d[20]||=[a(`<w-list
  :items="items"
  color="pink"
  hover>
</w-list>
...
`,-1)]]),default:e(()=>[i(A,{items:u.listItems4,color:`pink`,hover:``},null,8,[`items`]),d[22]||=n(`br`,null,null,-1),i(A,{items:u.listItems4,"bg-color":`blue-light5`,color:`primary`,hover:``},null,8,[`items`])]),_:1}),i(j,{h3:``},{default:e(()=>[...d[23]||=[a(`Different color per item`,-1)]]),_:1}),i(M,null,{pug:e(()=>[...d[24]||=[a(`w-list(:items="items" hover)`,-1)]]),html:e(()=>[...d[25]||=[a(`<w-list :items="items" hover></w-list>`,-1)]]),js:e(()=>[...d[26]||=[a(`data: () => ({
  items: [
...
`,-1)]]),default:e(()=>[i(A,{items:u.listItems5,hover:``},null,8,[`items`])]),_:1}),i(j,{h3:``},{default:e(()=>[...d[27]||=[a(`Selection-only color`,-1)]]),_:1}),d[67]||=s(`<p class="grey-light1">In addition to the hover effect, the items may also be selectable (as per the
...
<code>selection-color</code> to a falsy value (false, null, or empty string), or another color.</p>`,3),i(M,null,{pug:e(()=>[...d[28]||=[a(`w-list(
  :model-value="['Item 2']"
  :items="items"
  selection-color="pink"
  multiple)`,-1)]]),html:e(()=>[...d[29]||=[a(`<w-list
  :model-value="['Item 2']"
  :items="items"
  selection-color="pink"
  multiple>
</w-list>`,-1)]]),js:e(()=>[...d[30]||=[a(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' },
...
`,-1)]]),default:e(()=>[i(A,{"model-value":[`Item 2`],items:u.listItems4,"selection-color":`pink`,multiple:``},null,8,[`items`])]),_:1}),i(j,{h2:``},{default:e(()=>[...d[31]||=[a(`Custom rendering`,-1)]]),_:1}),d[68]||=n(`p`,null,[a(`In this example, we don't use the component's data at all.`),n(`br`),a(`
You can easily define items directly in the template and have a different custom layout for every
list item just like in this example.`)],-1),i(M,null,{pug:e(()=>[...d[33]||=[a(`w-list(:items="5" hover)
  template(#item="{ index }")
    | Item `+l(`{{ index }}`)+`
  template(#item.3)
    strong This is the great item #3`,-1)]]),html:e(()=>[...d[34]||=[a(`<w-list :items="5" hover>
  <template #item="{ index }">`+l(`{{ index }}`)+`</template>
  <template #item.3>
    <strong>This is the great item #3</strong>
  </template>
</w-list>
`,-1)]]),default:e(()=>[i(A,{items:5,hover:``},{item:e(({index:e})=>[a(`Item `+l(e),1)]),"item.3":e(()=>[...d[32]||=[n(`strong`,null,`This is the great item #3`,-1)]]),_:1})]),_:1}),d[69]||=n(`p`,null,[a(`It's up to you to define your your list contents in the component's data or directly in the template.`),n(`br`),a(`
In this example each item has a different icon stored in the data object.`)],-1),i(M,null,{pug:e(()=>[...d[35]||=[a(`w-list(:items="items" hover)
  template(#item="{ item }")
    w-flex(align-center justify-space-between)
      | `+l(`{{ item.label }}`)+`
      w-icon(md) `+l(`{{ item.icon }}`),-1)]]),html:e(()=>[...d[36]||=[a(`<w-list :items="items" hover>
  <template #item="{ item }">
    <w-flex align-center justify-space-between>
      `+l(`{{ item.label }}`)+`
...
`,-1)]]),default:e(()=>[i(A,{items:u.listItems2,hover:``},{item:e(({item:t})=>[n(`div`,g,[a(l(t.label),1),i(N,{md:``},{default:e(()=>[a(l(t.icon),1)]),_:2},1024)])]),_:1},8,[`items`])]),_:1}),i(j,{h2:``},{default:e(()=>[...d[38]||=[a(`Selectable list items`,-1)]]),_:1}),d[70]||=n(`p`,null,[a(`If you provide a `),n(`code`,null,`v-model`),a(` or a `),n(`code`,null,`model-value`),a(`, the list items become selectable.`)],-1),i(M,null,{pug:e(()=>[...d[42]||=[a(`w-radios.mb6(v-model="multiple" :items="radios" inline)
...
.title3.mt2
  ...
  code.ml2(v-else-if="multiple").
    `+l(`{{ selection ? [selection] : '[]' }}`),-1)]]),html:e(()=>[...d[43]||=[a(`<w-radios v-model="multiple" :items="radios" inline></w-radios>
...
<div class="title3 mt2">
  ...
  selection: 2,
  itemClicked: null
})`,-1)]]),default:e(()=>[i(P,{class:`mb6`,modelValue:u.multiple,"onUpdate:modelValue":d[0]||=e=>u.multiple=e,items:u.radios,inline:``},null,8,[`modelValue`,`items`]),i(F,{wrap:``,"align-center":``},{default:e(()=>[i(A,{class:`grow mr4`,modelValue:u.selection1,"onUpdate:modelValue":d[1]||=e=>u.selection1=e,items:u.listItems1,color:`deep-purple`,multiple:u.multiple,onItemClick:d[2]||=e=>u.itemClicked=e},null,8,[`modelValue`,`items`,`multiple`]),u.itemClicked?(o(),r(`div`,_,[d[39]||=n(`div`,{class:`title3`},[a(`clicked item (`),n(`span`,{class:`code`},`item-click`),a(` event):`)],-1),d[40]||=n(`br`,null,null,-1),n(`span`,v,l(u.itemClicked),1)])):c(``,!0)]),_:1}),n(`div`,y,[d[41]||=a(`Selected item:`,-1),!u.multiple||Array.isArray(u.selection1)?(o(),r(`code`,b,l(u.selection1||`null`),1)):u.multiple?(o(),r(`code`,x,l(u.selection1?[u.selection1]:`[]`),1)):c(``,!0)])]),_:1}),d[71]||=n(`p`,null,[a(`Note: you can get the list selection from the v-model, or by listening to the `),n(`span`,{class:`code`},`input`),a(` event.`)],-1),i(j,{h2:``},{default:e(()=>[...d[45]||=[a(`Checklists`,-1)]]),_:1}),i(M,null,{pug:e(()=>[...d[52]||=[a(`w-flex(wrap basis-zero :gap="3")
  .grow
    .title3.mb4 Default
    w-list(
      v-model="selection1"
  ...
  .grow
    ...
    w-list.custom(
      ...
      template(#item="{ item }")
        span `+l(`{{ item.label }}`)+`
        .spacer
        w-icon(md) `+l(`{{ item.icon }}`),-1)]]),html:e(()=>[...d[53]||=[a(`<w-flex wrap basis-zero :gap="3">
  <div class="grow">
...
})`,-1)]]),css:e(()=>[...d[55]||=[a(`.w-list.custom .w-list__item-label:before {display: none;}
...
`,-1)]]),default:e(()=>[i(F,{wrap:``,"basis-zero":``,gap:3},{default:e(()=>[n(`div`,S,[d[46]||=n(`div`,{class:`title3 mb4`},`Default`,-1),i(A,{modelValue:u.selection3,"onUpdate:modelValue":d[3]||=e=>u.selection3=e,items:u.listItems1,checklist:``,color:`green`},null,8,[`modelValue`,`items`])]),n(`div`,C,[d[47]||=n(`div`,{class:`title3 mb4`},`Round checkboxes`,-1),i(A,{modelValue:u.selection4,"onUpdate:modelValue":d[4]||=e=>u.selection4=e,items:u.listItems1,checklist:``,"round-checkboxes":``,color:`green`},null,8,[`modelValue`,`items`])])]),_:1}),i(F,{class:`mt4`,wrap:``,"basis-zero":``,gap:3},{default:e(()=>[n(`div`,w,[d[49]||=n(`div`,{class:`title3 mb4`},`Custom rendering, default styles`,-1),i(A,{modelValue:u.selection6,"onUpdate:modelValue":d[5]||=e=>u.selection6=e,items:u.listItems2,"item-value-key":`id`,checklist:``,color:`primary`},{item:e(({item:t})=>[n(`span`,null,l(t.label),1),d[48]||=n(`div`,{class:`spacer`},null,-1),i(N,{md:``},{default:e(()=>[a(l(t.icon),1)]),_:2},1024)]),_:1},8,[`modelValue`,`items`])]),n(`div`,T,[d[51]||=n(`div`,{class:`title3 mb4`},`Custom rendering & styles`,-1),i(A,{class:`custom`,modelValue:u.selection7,"onUpdate:modelValue":d[6]||=e=>u.selection7=e,items:u.listItems2,"item-value-key":`id`,checklist:``,color:`primary`},{item:e(({item:t})=>[n(`span`,null,l(t.label),1),d[50]||=n(`div`,{class:`spacer`},null,-1),i(N,{md:``},{default:e(()=>[a(l(t.icon),1)]),_:2},1024)]),_:1},8,[`modelValue`,`items`])])]),_:1})]),_:1}),i(j,{h3:``},{default:e(()=>[...d[56]||=[a(`Checklist colors`,-1)]]),_:1}),d[72]||=n(`p`,null,`A checklist can have all the color options that the normal list can have, even a different color per item.`,-1),i(M,null,{pug:e(()=>[...d[57]||=[a(`w-list(v-model="selection5" :items="items" checklist)`,-1)]]),html:e(()=>[...d[58]||=[a(`<w-list
  v-model="selection"
  :items="items"
  checklist>
</w-list>`,-1)]]),js:e(()=>[...d[59]||=[a(`data: () => ({
  items: [
...
`,-1)]]),default:e(()=>[i(A,{modelValue:u.selection5,"onUpdate:modelValue":d[7]||=e=>u.selection5=e,items:u.listItems5,checklist:``},null,8,[`modelValue`,`items`])]),_:1}),i(j,{h2:``},{default:e(()=>[...d[60]||=[a(`Navigation lists`,-1)]]),_:1}),d[73]||=n(`p`,null,[a(`The navigation list expects a `),n(`code`,null,`route`),a(` attribute in the items that are links.`),n(`br`),a(`
If you are using Vue Router, all the links will automatically be `),n(`strong`,{class:`code`},`router-link`),a(`s.`),n(`br`)],-1),d[74]||=n(`p`,null,[a(`It is possible to disable a link with a `),n(`code`,null,`disabled: true`),a(` attribute in the item.`)],-1),i(M,null,{pug:e(()=>[...d[62]||=[a(`w-list(:items="items" nav color="primary")
  template(#item="{ item }")
    span `+l(`{{ item.label }`)+`}
    .spacer
    w-icon(md) `+l(`{{ item.icon }}`),-1)]]),html:e(()=>[...d[63]||=[a(`<w-list :items="items" nav color="primary">
  <template #item="{ item }">
    <span>`+l(`{{ item.label }}`)+`</span>
    <div class="spacer"></div>
    <w-icon md>`+l(`{{ item.icon }}`)+`</w-icon>
  </template>
</w-list>`,-1)]]),js:e(()=>[...d[64]||=[a(`data: () => ({
  items: [
