import{r as u,g as f,o as p,a as n,b as s,w as l,e as t,t as d,F as M,k as D,c as j,_ as y,a3 as L,G as A}from"./index-DyPyadtc.js";const P={class:"ml2"},O={class:"ml2"},V={class:"ml2"},R={key:1,class:"px2"},E={class:"ml1"};function U(i,e,h,I,k,w){const b=u("alert"),m=u("title-link"),o=u("w-select"),a=u("example"),g=u("w-flex"),c=u("w-icon"),S=u("w-tag");return p(),f("div",null,[n(b,{info:""},{default:l(()=>e[4]||(e[4]=[t("The ",-1),s("span",{class:"code"},"w-select",-1),t(` component can be placed in a hidden overflow container and the dropdown
menu will still be fully visible when open.`,-1),s("br",null,null,-1),t(`
This is because the select dropdown menu is placed at the `,-1),s("span",{class:"code"},".w-app",-1),t(` level in the DOM,
just so you don't have to worry about this annoying case.
`,-1)])),_:1,__:[4]}),n(m,{h2:""},{default:l(()=>e[5]||(e[5]=[t("Basic",-1)])),_:1,__:[5]}),e[118]||(e[118]=s("p",null,[t("This is the most basic use of the "),s("span",{class:"code"},"w-select"),t(" component. No label, no v-model, only items.")],-1)),n(a,null,{pug:l(()=>e[6]||(e[6]=[t('w-select(:items="items")',-1)])),html:l(()=>e[7]||(e[7]=[t('<w-select :items="items"></w-select>',-1)])),js:l(()=>e[8]||(e[8]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`,-1)])),default:l(()=>[n(o,{items:i.items1},null,8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[9]||(e[9]=[t("Label and / or placeholder",-1)])),_:1,__:[9]}),e[119]||(e[119]=s("p",null,[t("The select list can have a label or not and a placeholder or not."),s("br")],-1)),n(a,null,{pug:l(()=>e[10]||(e[10]=[t(`w-select(:items="items" label="Label")
w-select.mt4(:items="items" placeholder="Placeholder")
w-select.mt4(:items="items" label="Label" placeholder="Placeholder")`,-1)])),html:l(()=>e[11]||(e[11]=[t(`<w-select
  :items="items"
  label="Label">
</w-select>
...
`,-1)])),default:l(()=>[n(o,{items:i.items1,label:"Label"},null,8,["items"]),n(o,{class:"mt4",items:i.items1,placeholder:"Placeholder"},null,8,["items"]),n(o,{class:"mt4",items:i.items1,label:"Label",placeholder:"Placeholder"},null,8,["items"])]),_:1}),n(b,{tip:""},{default:l(()=>e[13]||(e[13]=[t(`The items of the select list should have a label, which is by default expected in each item
object under the `,-1),s("code",null,"label",-1),t(" name.",-1),s("br",null,null,-1),t(`
If this is a constraint, you can use the option `,-1),s("code",null,"item-label-key",-1),t(` to specify the name of another
attribute to be used instead.
`,-1)])),_:1,__:[13]}),n(m,{h2:""},{default:l(()=>e[14]||(e[14]=[t("Outline",-1)])),_:1,__:[14]}),n(a,null,{pug:l(()=>e[16]||(e[16]=[t('w-select(:items="items" outline) Label',-1)])),html:l(()=>e[17]||(e[17]=[t('<w-select :items="items" outline>Label</w-select>',-1)])),js:l(()=>e[18]||(e[18]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`,-1)])),default:l(()=>[n(o,{items:i.items1,outline:""},{default:l(()=>e[15]||(e[15]=[t("Label",-1)])),_:1,__:[15]},8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[19]||(e[19]=[t("Colors",-1)])),_:1,__:[19]}),e[120]||(e[120]=s("p",{class:"mb4"},[t("Like in most components, you can set a "),s("code",null,"color"),t(" for the text and a "),s("code",null,"bg-color"),t(` for the
background.`),s("br"),t(`
By default, the text has the "`),s("span",{class:"code"},"primary"),t('" color.')],-1)),n(m,{h3:"",slug:"default-style"},{default:l(()=>e[20]||(e[20]=[t("Default style (Underline)",-1)])),_:1,__:[20]}),n(a,null,{pug:l(()=>e[23]||(e[23]=[t(`w-select(:items="items" color="blue") Label
w-select.mt4(:items="items" bg-color="blue-light5" color="blue-dark3") Label`,-1)])),html:l(()=>e[24]||(e[24]=[t(`<w-select
  :items="items"
  color="blue">
  Label
</w-select>
...
<w-select
  ...
  color="blue-dark3">
  Label
</w-select>`,-1)])),js:l(()=>e[25]||(e[25]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`,-1)])),default:l(()=>[n(o,{items:i.items1,color:"blue"},{default:l(()=>e[21]||(e[21]=[t("Label",-1)])),_:1,__:[21]},8,["items"]),n(o,{class:"mt4",items:i.items1,"bg-color":"blue-light5",color:"blue-dark3"},{default:l(()=>e[22]||(e[22]=[t("Label",-1)])),_:1,__:[22]},8,["items"])]),_:1}),n(m,{h3:""},{default:l(()=>e[26]||(e[26]=[t("Outline style",-1)])),_:1,__:[26]}),n(a,null,{pug:l(()=>e[29]||(e[29]=[t(`w-select(:items="items" outline color="blue") Label
w-select.mt4(:items="items" outline bg-color="blue-light5" color="blue-dark3") Label`,-1)])),html:l(()=>e[30]||(e[30]=[t(`<w-select
  :items="items"
  outline
  color="blue">
  Label
...
<w-select
  ...
  color="blue-dark3">
  Label
</w-select>`,-1)])),js:l(()=>e[31]||(e[31]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`,-1)])),default:l(()=>[n(o,{items:i.items1,outline:"",color:"blue"},{default:l(()=>e[27]||(e[27]=[t("Label",-1)])),_:1,__:[27]},8,["items"]),n(o,{class:"mt4",items:i.items1,outline:"","bg-color":"blue-light5",color:"blue-dark3"},{default:l(()=>e[28]||(e[28]=[t("Label",-1)])),_:1,__:[28]},8,["items"])]),_:1}),n(m,{h3:""},{default:l(()=>e[32]||(e[32]=[t("List items colors",-1)])),_:1,__:[32]}),e[121]||(e[121]=s("p",null,[t("If an item object contains the key "),s("code",null,"color"),t(`, it will naturally be used by the
`),s("strong",{class:"code"},"w-select"),t(" component to display this list item in this color."),s("br"),t(`
To disable this you can set the `),s("code",null,"item-color-key"),t(" prop to an empty string.")],-1)),n(a,null,{pug:l(()=>e[34]||(e[34]=[t('w-select(:items="items") Pick a color',-1)])),html:l(()=>e[35]||(e[35]=[t(`<w-select :items="items">
  Pick a color
</w-select>`,-1)])),js:l(()=>e[36]||(e[36]=[t(`data: () => ({
  items: [
...
`,-1)])),default:l(()=>[n(o,{items:i.items4},{default:l(()=>e[33]||(e[33]=[t("Pick a color",-1)])),_:1,__:[33]},8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[37]||(e[37]=[t("Shadow",-1)])),_:1,__:[37]}),n(a,null,{pug:l(()=>e[40]||(e[40]=[t(`.title4.mb2 Default style (Underline)
w-select(:items="items" shadow) Label

.title4.mt6.mb2 Outline style
w-select(:items="items" outline shadow) Label`,-1)])),html:l(()=>e[41]||(e[41]=[t(`<div class="title4 mb2">
...
<w-select :items="items" outline shadow>
  Label
</w-select>`,-1)])),js:l(()=>e[42]||(e[42]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`,-1)])),default:l(()=>[e[43]||(e[43]=s("div",{class:"title4"},"Default style (Underline)",-1)),n(o,{items:i.items1,shadow:""},{default:l(()=>e[38]||(e[38]=[t("Label",-1)])),_:1,__:[38]},8,["items"]),e[44]||(e[44]=s("div",{class:"title4 mt6"},"Outline style",-1)),n(o,{items:i.items1,outline:"",shadow:""},{default:l(()=>e[39]||(e[39]=[t("Label",-1)])),_:1,__:[39]},8,["items"])]),_:1,__:[43,44]}),n(m,{h2:""},{default:l(()=>e[45]||(e[45]=[t("Tile & round",-1)])),_:1,__:[45]}),n(a,null,{pug:l(()=>e[50]||(e[50]=[t(`.title4 Default style (Underline)
...
w-select.mt4(:items="items" outline round) Round`,-1)])),html:l(()=>e[51]||(e[51]=[t(`<div class="title4">
  Default style (Underline)
</div>
...
`,-1)])),default:l(()=>[e[53]||(e[53]=s("div",{class:"title4"},"Default style (Underline)",-1)),n(o,{items:i.items1,"bg-color":"purple-light5",tile:""},{default:l(()=>e[46]||(e[46]=[t("Tile",-1)])),_:1,__:[46]},8,["items"]),n(o,{class:"mt4",items:i.items1,"bg-color":"purple-light5",round:""},{default:l(()=>e[47]||(e[47]=[t("Round",-1)])),_:1,__:[47]},8,["items"]),e[54]||(e[54]=s("div",{class:"title4 mt6"},"Outline style",-1)),n(o,{items:i.items1,outline:"",tile:""},{default:l(()=>e[48]||(e[48]=[t("Tile",-1)])),_:1,__:[48]},8,["items"]),n(o,{class:"mt4",items:i.items1,outline:"",round:""},{default:l(()=>e[49]||(e[49]=[t("Round",-1)])),_:1,__:[49]},8,["items"])]),_:1,__:[53,54]}),n(m,{h2:""},{default:l(()=>e[55]||(e[55]=[t("Fit to content",-1)])),_:1,__:[55]}),n(a,null,{pug:l(()=>e[57]||(e[57]=[t(`w-select(
  :items="items"
  placeholder="Select an item"
  fit-to-content) Fit to content`,-1)])),html:l(()=>e[58]||(e[58]=[t(`<w-select
  :items="items"
  placeholder="Select an item"
  fit-to-content>
  Fit to content
</w-select>
`,-1)])),js:l(()=>e[59]||(e[59]=[t(`data: () => ({
  items: [
    { label: '1st item' },
    { label: 'Second item' },
...
`,-1)])),default:l(()=>[n(o,{items:i.items5,placeholder:"Select an item","fit-to-content":""},{default:l(()=>e[56]||(e[56]=[t("Fit to content",-1)])),_:1,__:[56]},8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[60]||(e[60]=[t("Multiple selection",-1)])),_:1,__:[60]}),n(a,null,{pug:l(()=>e[61]||(e[61]=[t('w-select(:items="items" multiple)',-1)])),html:l(()=>e[62]||(e[62]=[t('<w-select :items="items" multiple></w-select>',-1)])),js:l(()=>e[63]||(e[63]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`,-1)])),default:l(()=>[n(o,{items:i.items1,multiple:""},null,8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[64]||(e[64]=[t("V-model",-1)])),_:1,__:[64]}),n(b,{tip:""},{default:l(()=>e[65]||(e[65]=[t("By default, the ",-1),s("span",{class:"code"},"w-select",-1),t(" component expects the items to have a ",-1),s("code",null,"model-value",-1),t(" attribute.",-1),s("br",null,null,-1),t(`
If this is a constraint, you can use the option `,-1),s("code",null,"item-value-key",-1),t(` to specify the name of another
attribute to be used instead (must have a unique value), like an id for instance.`,-1)])),_:1,__:[65]}),n(a,null,{pug:l(()=>e[67]||(e[67]=[t(`w-select(v-model="selection" :items="items" multiple)
w-flex.align-center.mt4
  span v-model:
  code.ml2 `+d("{{ selection }}"),-1)])),html:l(()=>e[68]||(e[68]=[t(`<w-select
  v-model="selection"
  :items="items"
  multiple>
</w-select>
...
</w-flex>`,-1)])),js:l(()=>e[69]||(e[69]=[t(`data: () => ({
  items: [
...
`,-1)])),default:l(()=>[n(o,{modelValue:i.vModelSelect1,"onUpdate:modelValue":e[0]||(e[0]=r=>i.vModelSelect1=r),items:i.items3,multiple:""},null,8,["modelValue","items"]),n(g,{class:"align-center mt4"},{default:l(()=>[e[66]||(e[66]=s("span",null,"v-model:",-1)),s("code",P,d(i.vModelSelect1),1)]),_:1,__:[66]})]),_:1}),n(m,{h3:""},{default:l(()=>e[70]||(e[70]=[t("Without values (using labels)",-1)])),_:1,__:[70]}),e[122]||(e[122]=s("p",null,"If no values are provided in the items objects, the labels will be used to identify the selected items.",-1)),n(a,null,{pug:l(()=>e[72]||(e[72]=[t(`w-select(v-model="selection" :items="items" multiple)
w-flex.align-center.mt4
  span v-model:
  code.ml2 `+d("{{ selection }}"),-1)])),html:l(()=>e[73]||(e[73]=[t(`<w-select
  v-model="selection"
  :items="items"
  multiple>
</w-select>
...
<w-flex class="align-center mt4">
  <span>v-model:</span>
  <code class="ml2">`+d("{{ selection }}")+`</code>
</w-flex>`,-1)])),js:l(()=>e[74]||(e[74]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
w-flex.align-center.mt4
  span v-model:
  code.ml2 `+d("{{ selection }}"),-1)])),html:l(()=>e[78]||(e[78]=[t(`<w-select
  v-model="selection"
  :items="items"
  multiple
  return-object>
...
<w-flex class="align-center mt4">
  <span>v-model:</span>
  <code class="ml2">`+d("{{ selection }}")+`</code>
</w-flex>`,-1)])),js:l(()=>e[79]||(e[79]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`,-1)])),default:l(()=>[n(o,{modelValue:i.vModelSelect3,"onUpdate:modelValue":e[2]||(e[2]=r=>i.vModelSelect3=r),items:i.items1,multiple:"","return-object":""},null,8,["modelValue","items"]),n(g,{class:"align-center mt4"},{default:l(()=>[e[76]||(e[76]=s("span",null,"v-model:",-1)),s("code",V,d(i.vModelSelect3),1)]),_:1,__:[76]})]),_:1}),n(m,{h2:""},{default:l(()=>e[80]||(e[80]=[t("Label position",-1)])),_:1,__:[80]}),e[125]||(e[125]=s("p",null,`By default the label is positioned inside, you can also place it on the left or right outside of
...
w-select.mt4(:items="items" label="Select an item" label-position="right")`,-1)])),html:l(()=>e[82]||(e[82]=[t(`<w-select
  :items="items"
...
</w-select>`,-1)])),js:l(()=>e[83]||(e[83]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
w-select.mt4(:items="items" label-position="right" outline)
  w-icon.orange mdi mdi-arrow-left
  span.red.ml1 Right`,-1)])),html:l(()=>e[93]||(e[93]=[t(`<w-select
  :items="items"
...
`,-1)])),default:l(()=>[n(o,{items:i.items1,"label-position":"inside",outline:""},{default:l(()=>[n(c,{class:"orange"},{default:l(()=>e[85]||(e[85]=[t("mdi mdi-arrow-right",-1)])),_:1,__:[85]}),e[87]||(e[87]=s("span",{class:"purple mx1"},"Inside",-1)),n(c,{class:"orange"},{default:l(()=>e[86]||(e[86]=[t("mdi mdi-arrow-left",-1)])),_:1,__:[86]})]),_:1,__:[87]},8,["items"]),n(o,{class:"mt4",items:i.items1,"label-position":"left",outline:""},{default:l(()=>[e[89]||(e[89]=s("span",{class:"green mr1"},"Left",-1)),n(c,{class:"orange"},{default:l(()=>e[88]||(e[88]=[t("mdi mdi-arrow-right",-1)])),_:1,__:[88]})]),_:1,__:[89]},8,["items"]),n(o,{class:"mt4",items:i.items1,"label-position":"right",outline:""},{default:l(()=>[n(c,{class:"orange"},{default:l(()=>e[90]||(e[90]=[t("mdi mdi-arrow-left",-1)])),_:1,__:[90]}),e[91]||(e[91]=s("span",{class:"red ml1"},"Right",-1))]),_:1,__:[91]},8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[95]||(e[95]=[t("Custom selection string",-1)])),_:1,__:[95]}),e[127]||(e[127]=s("p",null,[t("The selection string is customizable through the "),s("code",null,"selection"),t(" slot."),s("br"),t(`
...
whether you use a multiple or single select list.`)],-1)),n(a,null,{pug:l(()=>e[96]||(e[96]=[t(`w-select(:items="items" v-model="selection" multiple)
  template(#selection="{ item }")
    w-tag.mr2(v-for="(item, i) in item" :key="i" bg-color="grey-light4")
      | `+d("{{ item.label }}"),-1)])),html:l(()=>e[97]||(e[97]=[t(`<w-select :items="items" v-model="selection" multiple>
  <template #selection="{ item }">
    <w-tag
      class="mr2"
...
</w-select>`,-1)])),js:l(()=>e[98]||(e[98]=[t(`data: () => ({
  items: [
    { label: 'Item 1', value: 1 },
    { label: 'Item 2', value: 2 },
    { label: 'Item 3', value: 3 }
...
`,-1)])),default:l(()=>[n(o,{items:i.items3,modelValue:i.customSelection,"onUpdate:modelValue":e[3]||(e[3]=r=>i.customSelection=r),multiple:""},{selection:l(({item:r})=>[(p(!0),f(M,null,D(r,(v,T)=>(p(),j(S,{class:"mr2",key:T,"bg-color":"grey-light4"},{default:l(()=>[t(d(v.label),1)]),_:2},1024))),128))]),_:1},8,["items","modelValue"])]),_:1}),n(m,{h2:""},{default:l(()=>e[99]||(e[99]=[t("Custom list items",-1)])),_:1,__:[99]}),n(a,null,{pug:l(()=>e[101]||(e[101]=[t(`w-select(:items="items")
  template(#item="{ item, selected }")
    w-icon.primary(v-if="selected") wi-check
    span.px2(v-else)
    span.ml1 `+d("{{ item.label }}")+`
    w-tag.ml2(bg-color="grey-light4" xs) `+d("{{ item.value }}"),-1)])),html:l(()=>e[102]||(e[102]=[t(`<w-select :items="items">
  <template #item="{ item, selected }">
...
</w-select>`,-1)])),js:l(()=>e[103]||(e[103]=[t(`data: () => ({
  items: [
    { label: 'Item 1', value: 1 },
    { label: 'Item 2', value: 2 },
    { label: 'Item 3', value: 3 }
...
`,-1)])),default:l(()=>[n(o,{items:i.items3},{item:l(({item:r,selected:v})=>[v?(p(),j(c,{key:0,class:"primary"},{default:l(()=>e[100]||(e[100]=[t("wi-check",-1)])),_:1,__:[100]})):(p(),f("span",R)),s("span",E,d(r.label),1),n(S,{class:"ml2","bg-color":"grey-light4",xs:""},{default:l(()=>[t(d(r.value),1)]),_:2},1024)]),_:1},8,["items"])]),_:1}),n(m,{h2:""},{default:l(()=>e[104]||(e[104]=[t("Inner icons",-1)])),_:1,__:[104]}),n(a,null,{pug:l(()=>e[105]||(e[105]=[t(`.title4.mb2 Label outside
...
w-select.mt4(:items="items" label="Select" label-position="inside" outline inner-icon-right="mdi mdi-arrow-down")`,-1)])),html:l(()=>e[106]||(e[106]=[t(`<div class="title4 mb2">
  Label outside
</div>
...
<w-select
  ...
  outline
  inner-icon-right="mdi mdi-arrow-down">
</w-select>`,-1)])),js:l(()=>e[107]||(e[107]=[t(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`,-1)])),default:l(()=>[e[108]||(e[108]=s("div",{class:"title4 mb2"},"Label outside",-1)),n(o,{items:i.items1,label:"Select","label-position":"left",outline:"","inner-icon-left":"mdi mdi-star"},null,8,["items"]),n(o,{class:"mt4",items:i.items1,label:"Select","label-position":"right",outline:"","inner-icon-right":"mdi mdi-arrow-down"},null,8,["items"]),e[109]||(e[109]=s("div",{class:"title4 mt6 mb2"},"Label inside",-1)),n(o,{items:i.items1,label:"Select","label-position":"inside",outline:"","inner-icon-left":"mdi mdi-star"},null,8,["items"]),n(o,{class:"mt4",items:i.items1,label:"Select","label-position":"inside",outline:"","inner-icon-right":"mdi mdi-arrow-down"},null,8,["items"])]),_:1,__:[108,109]}),n(m,{h2:""},{default:l(()=>e[110]||(e[110]=[t("Disabled & readonly",-1)])),_:1,__:[110]}),n(a,null,{pug:l(()=>e[111]||(e[111]=[t(`w-select.mb4(
  :items="items"
...
w-select(
  ...
  outline
  readonly)`,-1)])),html:l(()=>e[112]||(e[112]=[t(`<w-select
  class="mb4"
  :items="items"
  label="Disabled & empty"
  outline
