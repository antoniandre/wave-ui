import{N as e,U as t,c as n,d as r,g as i,h as a,k as o,yt as s}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as c}from"./_plugin-vue_export-helper-S3RvzygF.js";import{t as l}from"./form-elements-DPSP93QK.js";import{f as u}from"./index-BJr8b_n6.js";var d={class:`mt4`},f={class:`ml1`},p={class:`mt4`},m={class:`ml1`},h={class:`mt4`},g={class:`ml1`},_={class:`mt4`},v={class:`ml1`},y={class:`mt4`},b={class:`ml1`};function x(c,l,u,x,S,C){let w=e(`title-link`),T=e(`w-slider`),E=e(`example`),D=e(`w-button`),O=e(`w-flex`),k=e(`w-icon`);return o(),r(`div`,null,[i(w,{h2:``},{default:t(()=>[...l[8]||=[a(`Default`,-1)]]),_:1}),l[47]||=n(`p`,null,[a(`By default the range will have the `),n(`code`,null,`primary`),a(` color.`)],-1),i(E,{"content-class":`pa6`},{html:t(()=>[...l[9]||=[a(`<w-slider :model-value="50"></w-slider>
