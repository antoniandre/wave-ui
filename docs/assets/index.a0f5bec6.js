...
<div class="title3 mt2">
  ...
  selection: 2,
  itemClicked: null
})`),Ie=i("p",null,[e("Note: you can get the list selection from the v-model, or by listening to the "),i("span",{class:"code"},"input"),e(" event.")],-1),Ce=e("Checklists"),xe={class:"grow"},Ve=i("div",{class:"title3 mb4"},"Default",-1),je={class:"grow"},Ae=i("div",{class:"title3 mb4"},"Round checkboxes",-1),Se={class:"grow"},$e=i("div",{class:"title3 mb4"},"Custom rendering, default styles",-1),Te=i("div",{class:"spacer"},null,-1),Ee={class:"grow"},De=i("div",{class:"title3 mb4"},"Custom rendering & styles",-1),Ue=i("div",{class:"spacer"},null,-1),We=e(`data: () => ({
  listItems1: [
    { label: 'Item 1', value: 1 },
    { label: 'Item 2', value: 2 },
    { label: 'Item 3', value: 3 },
