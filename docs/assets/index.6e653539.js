import{o as g,g as h,a as e,w as o,b as l,d as p,e as r,r as m,Z as y,$ as k,_ as w,a0 as _}from"./index.50b18c01.js";const c=n=>(y("data-v-421017b5"),n=n(),k(),n),x=c(()=>r("p",{class:"my4"},"First choose your progress style:",-1)),S=c(()=>r("p",null,[l("Like in most components, you can set a "),r("code",null,"color"),l(" for the text and a "),r("code",null,"bg-color"),l(` for the
background.`),r("br"),l(`
By default, the progress foreground color is `),r("code",null,"primary"),l(".")],-1)),V=c(()=>r("h3",null,"Mixing colors",-1)),$=c(()=>r("p",null,"The value can be given as a number or a string.",-1)),C=c(()=>r("p",null,[l("When the value is "),r("code",null,"undefined"),l(", "),r("code",null,"-1"),l(` or not provided at all, it will be assumed
