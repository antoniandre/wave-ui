import{r,o as m,f as p,a,w as t,e,h as s,b as i,c as S,d as j,i as y,_ as u,Q as v}from"./index.7c0b9523.js";const E=e("Why using w-image and not a simple <img>"),x=y(`<div class="title3">A simple &lt;img&gt;</div><p>will display when loaded, and will take the dimensions of the actual image.<br>
...
`),H=e("Loading spinner"),Q=i("p",null,`This image is very big, so that you have time to see the spinner while loading.
Refresh the page if you haven't seen it!`,-1),J=e('w-image(:src="`${baseUrl}images/spirit-island--alberta.png`" width="100%" :ratio="1 / 2")'),K=e(`<w-image
