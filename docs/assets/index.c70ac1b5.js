...
A timeout of `),i("code",[t._v("0")]),t._v(" will keep the notification visible permanently (until dismissed).")]),i("example",{scopedSlots:t._u([{key:"html",fn:function(){return[t._v(`<w-button @click="$waveui.notify('Information.')" bg-color="info">
  Notify info
</w-button>
...
`)]),i("example",{scopedSlots:t._u([{key:"html",fn:function(){return[t._v(`<w-button @click="notify" bg-color="info">
  Notify custom
...
`)]),i("title-link",{attrs:{h2:""}},[t._v("Notification position")]),i("p",[t._v("Notifications have a fixed position by default (positioned relative to the viewport).")]),i("example",{attrs:{"content-class":"mt2"},scopedSlots:t._u([{key:"html",fn:function(){return[t._v(`<w-button
  class="mr6"
...
`+t._s(~~t.notification2.timeout?"auto-hiding after "+t.notification2.timeout+" ms":"not auto-hiding")+".")])],1),i("title-link",{attrs:{h2:""}},[t._v("Transitions")]),i("example",{scopedSlots:t._u([{key:"html",fn:function(){return[t._v(`<w-flex wrap align-center>
  <w-button
    class="mr3"
    @click="notification.show = !notification.show"
    color="primary"
