import{r as i,o as y,f as h,a as o,w as n,b as r,n as B,h as p,e as s}from"./vendor.c30f2c6c.js";import{_ as w,v as g}from"./index.67df9d80.js";const V=r("p",null,[s("By default the overlay has a "),r("span",{class:"code"},"0.3"),s(` opacity with a black color and a z-index
...
`)],-1),N=s("Overlay with custom opacity and control on "),C=r("span",{class:"code"},"persistent",-1),S=r("p",null,"When the overlay is persistent, it will not close on click and on escape key.",-1),x=r("p",null,"When persistent is set to false and by default, the escape key will also close the overlay.",-1),E=s("Show overlay"),H=r("div",{class:"title4"},"Options",-1),U={class:"code white"},W={class:"code white"},D=s("wi-cross"),T=s("Hide overlay"),j=s(`w-flex(wrap)
...
`),P=s("Overlay with custom background color"),R=s("Show a blue overlay"),M=s("wi-cross"),q=s("Hide overlay"),F=s(`w-button(bg-color="primary" dark @click="showOverlay = true") Show a blue overlay

w-overlay(v-model="showOverlay" bg-color="rgba(35, 71, 129, 0.4)")
  w-button(bg-color="primary" lg dark @click="showOverlay = false")
    w-icon.mr2 wi-cross
    | Hide overlay`),G=s(`<w-button
  bg-color="primary"
  dark
