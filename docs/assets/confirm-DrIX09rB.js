import{N as e,W as t,_t as n,bt as r,c as i,d as a,g as o,h as s,k as c,m as l,u}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as d}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{M as f}from"./index-BQVpTp7r.js";var p={class:`w-flex wrap`},m={class:`w-flex align-center my4`},h={class:`w-flex justify-end align-center`};function g(d,f,g,_,v,y){let b=e(`alert`),x=e(`title-link`),S=e(`w-confirm`),C=e(`example`),w=e(`w-flex`),T=e(`w-icon`),E=e(`w-input`),D=e(`w-transition-slide-fade`),O=e(`w-card`);return c(),a(`div`,null,[o(b,{info:``},{default:t(()=>[...f[5]||=[i(`ul`,null,[i(`li`,null,[s(`The purpose of the `),i(`strong`,{class:`code`},`w-confirm`),s(` component is to quickly set up a
