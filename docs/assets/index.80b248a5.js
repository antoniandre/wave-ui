import{r as l,o as w,f as _,a as s,w as n,b as e,d as t,h as f,c as k,e as j,i as y,_ as q,L as F}from"./index.837b2231.js";const I=t("ul",null,[t("li",{class:"title5"},[e("The "),t("span",{class:"code"},"w-form"),e(" component is used for validation.")]),t("li",null,[e("A "),t("span",{class:"code"},"w-form"),e(` is invisible and has no style by default. You can put it in a
...
disable all the fields or set them all to readonly.`)],-1),ge=t("strong",null,"Attention",-1),_e=t("div",null,[e("Wave UI will not reset the validity of the fields when you toggle the "),t("code",null,"disabled"),e(`
or `),t("code",null,"readonly"),e(" prop on the "),t("strong",{class:"code"},"w-form"),e(`: the field is becoming uneditable but
may contain invalid data.`)],-1),ye=t("p",null,"You may want to validate a field on server side, for this you can use an asynchronous validator.",-1),qe=t("span",{class:"code"},"async",-1),xe=t("span",{class:"code"},"await",-1),Te=t("a",{href:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function",target:"_blank"},"here",-1),Ve=t("p",null,[e(`This example presents a common case: checking if a username is already in use from a user
...
`)],-1),ke=t("p",null,[e("You can provide a custom loading bar color via the prop "),t("code",null,"progress-color"),e("."),t("br"),e(`
Example with `),t("code",null,'progress-color="cyan"'),e(":")],-1);function Fe(u,o,x,T,a,h){const m=l("alert"),i=l("title-link"),b=l("ssh-pre"),L=l("w-divider"),r=l("w-input"),c=l("w-button"),v=l("w-form"),p=l("example"),g=l("w-alert"),C=l("w-transition-fade"),S=l("w-checkbox"),V=l("w-flex"),A=l("w-notification"),U=l("w-card");return w(),_("div",null,[s(m,{class:"mt6",tip:""},{default:n(()=>[I]),_:1}),s(i,{h2:""},{default:n(()=>[e("How it works")]),_:1}),E,t("ol",null,[t("li",R,[e("Add one or more validator functions on the field you want validated"),s(b,{class:"body",language:"html-vue",label:"Vue template"},{default:n(()=>[e('<w-input label="First name" :validators="[validators.required]"></w-input>')]),_:1}),s(b,{class:"body",language:"js",label:"Javascript"},{default:n(()=>[e(`data: () => ({
  validators: {
    required: value => !!value || 'This field is required'
  }
})`)]),_:1})]),t("li",D,[e("Wrap the field in a "),O,e(" and add a submit button"),s(b,{class:"body",language:"html-vue",label:"Vue template"},{default:n(()=>[e(`<w-form>
  <w-input label="First name" :validators="[validators.required]"></w-input>

  <w-button type="submit">Submit</w-button>
</w-form>`)]),_:1})]),B]),s(m,{tip:""},{default:n(()=>[M,P]),_:1}),s(i,{class:"mt10",h3:""},{default:n(()=>[e("Creating a validator function")]),_:1}),Y,s(b,{language:"js",label:"Javascript"},{default:n(()=>[e(`data: () => ({
  validators: {
    required: value => !!value || 'This field is required'
    // Other validators...
  }
})
`)]),_:1}),s(L,{class:"mt12"}),s(i,{h2:""},{default:n(()=>[e("Basic validation")]),_:1}),N,s(p,null,{pug:n(()=>[e(`w-form(v-model="valid")
...
})`)]),default:n(()=>[s(v,{modelValue:a.form1.valid,"onUpdate:modelValue":o[0]||(o[0]=d=>a.form1.valid=d)},{default:n(()=>[s(r,{label:"First name",validators:[a.validators.required,a.validators.alphabetical]},null,8,["validators"]),s(r,{class:"mt3",label:"Last name",validators:[a.validators.required]},null,8,["validators"]),t("div",W,[J,t("code",H,f(a.form1.valid===!1?"false":a.form1.valid||"null"),1),s(c,{type:"submit",disabled:a.form1.valid===!1},{default:n(()=>[e("Validate")]),_:1},8,["disabled"])])]),_:1},8,["modelValue"])]),_:1}),s(m,{warning:""},{default:n(()=>[z,X]),_:1}),s(m,{success:""},{default:n(()=>[e(`Even in the most advanced case, Wave UI's form validation is fairly simple, it doesn't
require you to use `),K,e(`.
`)]),_:1}),s(i,{h2:""},{default:n(()=>[e("Direct submission to a server")]),_:1}),G,s(p,null,{pug:n(()=>[e(`w-form(action="test.php" method="post" target="_blank" allow-submit)
...
`)]),default:n(()=>[s(v,{action:"test.php",method:"post",target:"_blank","allow-submit":""},{default:n(()=>[s(r,{label:"First name",validators:[a.validators.required]},null,8,["validators"]),s(r,{class:"mt3",label:"Last name",validators:[a.validators.required]},null,8,["validators"]),t("div",Q,[s(c,{type:"submit"},{default:n(()=>[e("Validate")]),_:1})])]),_:1})]),_:1}),s(m,{tip:""},{default:n(()=>[e(`To submit a form via the HTML standard way like in this example, you need to add
the `),Z,e(" attribute and optionally a "),$,e(` attribute.
`)]),_:1}),s(i,{h2:""},{default:n(()=>[e("Validate on submit, on blur, on keyup")]),_:1}),ee,s(p,null,{pug:n(()=>[e(`w-form(no-keyup-validation no-blur-validation)
  w-input(label="First name" :validators="[validators.required]")
  w-input.mt3(label="Last name" :validators="[validators.required]")
  .text-right.mt6
...
`)]),default:n(()=>[s(v,{"no-keyup-validation":"","no-blur-validation":""},{default:n(()=>[s(r,{label:"First name",validators:[a.validators.required]},null,8,["validators"]),s(r,{class:"mt3",label:"Last name",validators:[a.validators.required]},null,8,["validators"]),t("div",te,[s(c,{type:"submit"},{default:n(()=>[e("Validate")]),_:1})])]),_:1})]),_:1}),s(i,{h2:""},{default:n(()=>[e("Reset the form")]),_:1}),ne,s(p,null,{pug:n(()=>[e(`w-form(v-model="valid")
  w-input(label="First name" :validators="[validators.required]")
  w-input.mt3(label="Last name" :validators="[validators.required]")
  .text-right.mt6
...
`)]),default:n(()=>[s(v,{modelValue:a.form4.valid,"onUpdate:modelValue":o[1]||(o[1]=d=>a.form4.valid=d)},{default:n(()=>[s(r,{label:"First name",validators:[a.validators.required]},null,8,["validators"]),s(r,{class:"mt3",label:"Last name",validators:[a.validators.required]},null,8,["validators"]),t("div",se,[s(c,{class:"my1 mr2","bg-color":"warning",type:"reset"},{default:n(()=>[e("Reset")]),_:1}),s(c,{class:"my1",type:"submit"},{default:n(()=>[e("Validate")]),_:1})])]),_:1},8,["modelValue"])]),_:1}),s(i,{h2:""},{default:n(()=>[e("On validate, on success & on error events")]),_:1}),ae,s(m,{tip:""},{default:n(()=>[e("The form status is always accurate (through the "),oe,e("), and the "),le,e(` &
...
submission attempts (if you need it) since a `),ue,e(" or "),me,e(` event may trigger
an error or success on that element. The next example introduces the `),ce,e(` syncing
...
w-form(
  ...
  .text-right.mt6
    w-button(type="submit") Validate`,1)]),html:n(()=>[e(`<w-alert
  :success="success"
  :error="error"
  :info="!success && !error">
  `+f("{{ !success && !error ? 'The form is still pristine' : (success ? 'Success' : 'Error') }}")+`
...
`)]),default:n(()=>[s(g,{success:a.form5.success,error:a.form5.error,info:!a.form5.success&&!a.form5.error},{default:n(()=>[e(f(!a.form5.success&&!a.form5.error?"The form is still pristine":a.form5.success?"Success":"Error"),1)]),_:1},8,["success","error","info"]),t("p",null,"The form has been validated "+f(a.form5.validated)+" time(s).",1),s(v,{onValidate:o[2]||(o[2]=d=>{a.form5.validated++,a.form5.success=a.form5.error=!1}),onSuccess:o[3]||(o[3]=d=>a.form5.success=!0),onError:o[4]||(o[4]=d=>a.form5.error=!0)},{default:n(()=>[s(r,{label:"First name",validators:[a.validators.required]},null,8,["validators"]),s(r,{class:"mt3",label:"Last name",validators:[a.validators.required]},null,8,["validators"]),t("div",fe,[s(c,{type:"submit"},{default:n(()=>[e("Validate")]),_:1})])]),_:1})]),_:1}),s(i,{h2:"",slug:"advanced-validation"},{default:n(()=>[e("Advanced validation with everything")]),_:1}),ve,pe,s(p,null,{pug:n(()=>[e(`w-card.white--bg(content-class="pa0")
  .message-box
    w-transition-fade
  ...
  w-notification(
    ...
    plain
    round
    bottom) The form was sent successfully!`,1)]),html:n(()=>[e(`<w-card class="white--bg" content-class="pa0">
...
`)]),default:n(()=>[s(U,{class:"white--bg","content-class":"pa0"},{default:n(()=>[t("div",he,[s(C,null,{default:n(()=>[a.form6.submitted?(w(),k(g,{key:0,class:"my0 text-light",success:"","no-border":""},{default:n(()=>[e("The form is valid, ready to send it!")]),_:1})):a.form6.valid===!1?(w(),k(g,{key:1,class:"my0 text-light",error:"","no-border":""},{default:n(()=>[e("The form has "+f(a.form6.errorsCount)+" errors.",1)]),_:1})):j("",!0)]),_:1})]),s(v,{class:"px8 pt2 pb12",modelValue:a.form6.valid,"onUpdate:modelValue":o[6]||(o[6]=d=>a.form6.valid=d),"errors-count":a.form6.errorsCount,"onUpdate:errors-count":o[7]||(o[7]=d=>a.form6.errorsCount=d),onValidate:h.onValidate,onSuccess:h.onSuccess},{default:n(()=>[s(r,{required:"",label:"First name",validators:[a.validators.required]},null,8,["validators"]),s(r,{class:"mt3",required:"",label:"Last name",validators:[a.validators.required]},null,8,["validators"]),s(r,{class:"mt3",disabled:"",label:"User name"}),s(V,{class:"mt4",wrap:"","align-center":"","justify-end":""},{default:n(()=>[s(S,{required:"",validators:[a.validators.consent]},{default:n(()=>[e("I agree to the terms & conditions")]),_:1},8,["validators"]),be,s(c,{class:"my1 mr2","bg-color":"warning",type:"reset",onClick:o[5]||(o[5]=d=>a.form6.submitted=a.form6.sent=!1)},{default:n(()=>[e("Reset")]),_:1}),s(c,{class:"my1",type:"submit",disabled:a.form6.valid===!1,loading:a.form6.submitted&&!a.form6.sent},{default:n(()=>[e("Validate")]),_:1},8,["disabled","loading"])]),_:1})]),_:1},8,["modelValue","errors-count","onValidate","onSuccess"]),s(A,{modelValue:a.form6.sent,"onUpdate:modelValue":o[8]||(o[8]=d=>a.form6.sent=d),success:"",transition:"bounce",absolute:"",plain:"",round:"",bottom:""},{default:n(()=>[e("The form was sent successfully!")]),_:1},8,["modelValue"])]),_:1})]),_:1}),s(i,{h2:""},{default:n(()=>[e("Disabled & readonly form")]),_:1}),we,s(m,{warning:""},{default:n(()=>[ge,_e]),_:1}),s(p,null,{pug:n(()=>[e(`w-button(
...
`)]),default:n(()=>[s(c,{outline:!a.form7.disabled,onClick:o[9]||(o[9]=d=>{a.form7.readonly=!1,a.form7.disabled=!a.form7.disabled})},{default:n(()=>[e("Form disabled")]),_:1},8,["outline"]),s(c,{class:"ml2",outline:!a.form7.readonly,onClick:o[10]||(o[10]=d=>{a.form7.disabled=!1,a.form7.readonly=!a.form7.readonly})},{default:n(()=>[e("Form readonly")]),_:1},8,["outline"]),s(v,{class:"mt4",modelValue:a.form7.valid,"onUpdate:modelValue":o[11]||(o[11]=d=>a.form7.valid=d),disabled:a.form7.disabled,readonly:a.form7.readonly},{default:n(()=>[s(r,{label:"First name",validators:[a.validators.required,a.validators.alphabetical]},null,8,["validators"]),s(r,{class:"mt3",label:"Last name",validators:[a.validators.required]},null,8,["validators"]),s(V,{class:"mt4","justify-end":""},{default:n(()=>[s(c,{type:"reset","bg-color":"warning"},{default:n(()=>[e("Reset")]),_:1}),s(c,{class:"ml2",type:"submit",disabled:a.form7.valid===!1},{default:n(()=>[e("Validate")]),_:1},8,["disabled"])]),_:1})]),_:1},8,["modelValue","disabled","readonly"])]),_:1}),s(i,{h2:""},{default:n(()=>[e("Asynchronous validations")]),_:1}),ye,s(m,{tip:""},{default:n(()=>[e("You should first be familiar with Promises and "),qe,e("/"),xe,e(`.
If you're not you can read about it
`),Te,e(".")]),_:1}),Ve,s(p,{"content-class":"pa6"},{pug:n(()=>[e(`w-form(error-placeholders)
  w-input(
    label="Username"
...
`)]),default:n(()=>[s(v,{"error-placeholders":""},{default:n(()=>[s(r,{label:"Username",validators:[a.validators.required,a.validators.username],"inner-icon-right":a.form1.loading?"mdi mdi-autorenew w-icon--spin":"",loading:a.form1.loading,autocomplete:"off"},null,8,["validators","inner-icon-right","loading"])]),_:1})]),_:1}),s(i,{h3:""},{default:n(()=>[e("Loading bar color")]),_:1}),ke,s(r,{class:"mt5",label:"Username",loading:!0,"progress-color":"cyan",autocomplete:"off"})])}const Le={data(){return{form1:{valid:null,loading:!1},form2:{valid:null},form3:{valid:null},form4:{valid:null},form5:{valid:null,error:null,success:null,validated:0},form6:{valid:null,submitted:!1,sent:!1,errorsCount:0},form7:{valid:null,disabled:!1,readonly:!1},validators:{username:async u=>(this.form1.loading=!0,await new Promise(o=>setTimeout(o,800)),this.form1.loading=!1,u!=="waveui"||"This username is already in use"),required:u=>!!u||"This field is required",alphabetical:u=>/^[a-z \-']+$/i.test(u)||"This field only accepts letters.",consent:u=>!!u||"You must agree"}}},methods:{onSuccess(){setTimeout(()=>this.form6.sent=!0,2e3)},onValidate(){this.form6.sent=!1,this.form6.submitted=this.form6.errorsCount===0}}},Ce=q(Le,[["render",Fe]]),Se=t("div",{class:"w-divider my12"},null,-1);function Ae(u,o,x,T,a,h){const m=l("title-link"),i=l("component-api");return w(),_("div",null,[Se,s(m,{class:"title1",h2:""},{default:n(()=>[e("API")]),_:1}),s(i,{class:"mt0",items:h.props,descriptions:u.propsDescs,title:"Props"},null,8,["items","descriptions"]),s(i,{items:u.slots,title:"Slots"},null,8,["items"]),s(i,{items:h.events,title:"Events"},null,8,["items"])])}const Ue={modelValue:'<strong class="error"><code>value</code> in Vue 2.</strong><br>Contains the status of the form validity at all times. Three values are possible: <code>null</code> when pristine (untouched), <code>false</code> when invalid, <code>true</code> when valid.<br>This value gets updated every time a validation is triggered on a single field or on all the fields at once on form submit.<br>Setting this value to <code>null</code> will reset the form.',allowSubmit:"Native HTML submits the form to the server when all the form elements are valid.<br>Usually and by default, the form submission is prevented and an AJAX call is made from the front end. This is completely up to the developer.",noKeyupValidation:"Prevents the form element validation on keyup (happening by default).",noBlurValidation:"Prevents the form element validation on blur (happening by default).",errorPlaceholders:"Reserves a space under all the form elements so that triggering an error and showing the error message will not change the height of the form.",disabled:"Disables all the form fields all at once, making them unreactive to user interactions.",readonly:"Set all the form fields to readonly all at once. The fields will still look interactive but their value will not be editable by user interaction.",validationColor:'Applies a specific color to any input field failing the validation.<br>Accepts all the color names of the color palette, status colors, or custom colors (learn more about the colors in the <a href="colors">colors</a> knowledge base page).<br>Providing a color hex, rgb(a) or hsl(a) will not work.'},je={default:{description:"The form content."}},Ie={submit:{description:"Emitted on form submit.",params:{"[DOM event object]":"The associated reset DOM event."}},"before-validate":{description:"Emitted before validation, every time a validation is triggered."},validate:{description:"Emitted on form validate, every time a validation is triggered.<br>Returns a single object containing:",params:{e:"The associated DOM event.",errorsCount:"An integer representing the number of errors in the form."}},success:{description:"Emitted on form success, when there is no error in the form and the validation is successful.<br>Returns a single object containing:",params:{e:"The associated DOM event.",errorsCount:"An integer representing the number of errors in the form."}},error:{description:"Emitted on form error, when there is at least one error in the form and the validation fails.<br>Returns a single object containing:",params:{e:"The associated DOM event.",errorsCount:"An integer representing the number of errors in the form."}},reset:{description:"Emitted on form reset. A reset can be triggered by setting the v-model value to null or by clicking on a reset button.",params:{"[DOM event object]":"The associated reset DOM event."}},input:{description:"Emitted every time the form status changes.<br>Updates the v-model value in Vue 2.x only.",params:{"[Boolean, Null]":"The new status of the form: one of <code>null</code> when pristine, <code>false</code> when invalid, <code>true</code> when valid."}},"update:modelValue":{description:"Emitted every time the form status changes.<br>Updates the v-model value in Vue 3 only.",params:{"[Boolean, Null]":"The new status of the form: one of <code>null</code> when pristine, <code>false</code> when invalid, <code>true</code> when valid."}},"update:errorsCount":{description:"Emitted every time the errorsCount changes. To be used with <code>:errors-count.sync</code> in Vue 2 or <code>v-model:errors-count</code> in Vue 3.",params:{"[Integer]":"The number of errors in the form."}}},Ee={data:()=>({propsDescs:Ue,slots:je}),computed:{props(){return F.props},events(){return F.emits.reduce((u,o)=>(u[o]=Ie[o]||{})&&u,{})}}},Re=q(Ee,[["render",Ae]]);function De(u,o,x,T,a,h){const m=l("ui-component-title"),i=l("examples"),b=l("api");return w(),_("main",null,[s(m,null,{default:n(()=>[e("w-form")]),_:1}),s(i),s(b)])}const Oe={components:{Examples:Ce,Api:Re}},Me=q(Oe,[["render",De]]);export{Me as default};
