import{r as c,g as u,o as p,b as s,a as i,h as V,e as t,w as l,t as o,d as y,_ as f,W as I}from"./index-C780IYji.js";const j={class:"lists-demo"},A={class:"w-flex wrap"},S={class:"grow"},T={class:"grow"},$={class:"w-flex align-center justify-space-between"},E={key:0},W={class:"code"},D={class:"title3 mt2"},U={key:0,class:"ml2"},N={key:1,class:"ml2"},P={class:"grow"},z={class:"grow"},K={class:"grow"},M={class:"grow"};function O(n,e,h,g,k,b){const m=c("w-list"),r=c("title-link"),d=c("example"),w=c("w-icon"),C=c("w-radios"),v=c("w-flex"),x=c("router-view");return p(),u("div",j,[e[65]||(e[65]=s("p",null,[t("The "),s("span",{class:"code"},"w-list"),t(" component has multiple uses:")],-1)),i(m,{items:4,icon:"wi-check"},{"item.1":l(()=>e[8]||(e[8]=[t("Simple list with or without icons")])),"item.2":l(()=>e[9]||(e[9]=[t("Checklists")])),"item.3":l(()=>e[10]||(e[10]=[t("Navigation menus")])),"item.4":l(()=>e[11]||(e[11]=[t("List of selectable items")])),_:1}),i(r,{h2:""},{default:l(()=>e[12]||(e[12]=[t("Basic lists")])),_:1,__:[12]}),i(d,null,{pug:l(()=>e[15]||(e[15]=[t(`.w-flex.wrap
  .grow
    .title3 Most basic
    w-list(:items="items")
  .grow
...
`)])),default:l(()=>[i(m,{items:n.listItems4,color:"pink",hover:""},null,8,["items"]),e[22]||(e[22]=s("br",null,null,-1)),i(m,{items:n.listItems4,"bg-color":"blue-light5",color:"primary",hover:""},null,8,["items"])]),_:1,__:[22]}),i(r,{h3:""},{default:l(()=>e[23]||(e[23]=[t("Different color per item")])),_:1,__:[23]}),i(d,null,{pug:l(()=>e[24]||(e[24]=[t('w-list(:items="items" hover)')])),html:l(()=>e[25]||(e[25]=[t('<w-list :items="items" hover></w-list>')])),js:l(()=>e[26]||(e[26]=[t(`data: () => ({
  items: [
...
`)])),default:l(()=>[i(m,{items:n.listItems5,hover:""},null,8,["items"])]),_:1}),i(r,{h3:""},{default:l(()=>e[27]||(e[27]=[t("Selection-only color")])),_:1,__:[27]}),e[67]||(e[67]=V(`<p class="grey-light1">In addition to the hover effect, the items may also be selectable (as per the
...
`)])),default:l(()=>[i(m,{"model-value":["Item 2"],items:n.listItems4,"selection-color":"pink",multiple:""},null,8,["items"])]),_:1}),i(r,{h2:""},{default:l(()=>e[31]||(e[31]=[t("Custom rendering")])),_:1,__:[31]}),e[68]||(e[68]=s("p",null,[t("In this example, we don't use the component's data at all."),s("br"),t(`
...
`)])),default:l(()=>[i(m,{items:n.listItems2,hover:""},{item:l(({item:a})=>[s("div",$,[t(o(a.label),1),i(w,{md:""},{default:l(()=>[t(o(a.icon),1)]),_:2},1024)])]),_:1},8,["items"])]),_:1}),i(r,{h2:""},{default:l(()=>e[38]||(e[38]=[t("Selectable list items")])),_:1,__:[38]}),e[70]||(e[70]=s("p",null,[t("If you provide a "),s("code",null,"v-model"),t(" or a "),s("code",null,"model-value"),t(", the list items become selectable.")],-1)),i(d,null,{pug:l(()=>e[42]||(e[42]=[t(`w-radios.mb6(v-model="multiple" :items="radios" inline)
...
`)])),default:l(()=>[i(m,{modelValue:n.selection5,"onUpdate:modelValue":e[7]||(e[7]=a=>n.selection5=a),items:n.listItems5,checklist:""},null,8,["modelValue","items"])]),_:1}),i(r,{h2:""},{default:l(()=>e[60]||(e[60]=[t("Navigation lists")])),_:1,__:[60]}),e[73]||(e[73]=s("p",null,[t("The navigation list expects a "),s("code",null,"route"),t(" attribute in the items that are links."),s("br"),t(`
