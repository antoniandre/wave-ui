var k=Object.defineProperty;var f=Object.getOwnPropertySymbols;var $=Object.prototype.hasOwnProperty,V=Object.prototype.propertyIsEnumerable;var y=(s,l,r)=>l in s?k(s,l,{enumerable:!0,configurable:!0,writable:!0,value:r}):s[l]=r,h=(s,l)=>{for(var r in l||(l={}))$.call(l,r)&&y(s,r,l[r]);if(f)for(var r of f(l))V.call(l,r)&&y(s,r,l[r]);return s};import{r as d,o as p,f as _,a as n,w as o,b as t,h as m,e,_ as v,bT as x,bz as z}from"./index.4ab4194a.js";const T=e("Default"),S=e("w-rating"),D=e(`<w-rating></w-rating>
`),E=e("V-model"),A={class:"mt2"},M=t("strong",{class:"mr2"},"v-model:",-1),C={class:"mt2"},P=t("strong",{class:"mr2"},"v-model:",-1),N=e(`w-rating(v-model="rating1")
div.mt2
  strong.mr2 v-model:
  code `+m("{{ rating1 }}")+`
...
`),W=e("Color"),q=t("p",null,[e("Like in most components, you can set a "),t("code",null,"color"),e(" for the foreground icons (when on) and a "),t("code",null,"bg-color"),e(` for the
background icons when off.`),t("br"),e(`
The default background color is grey and the default active color is `),t("code",null,"primary"),e(".")],-1),B=t("br",null,null,-1),I=e(`w-rating.my2(color="green")
br
w-rating.my2(bg-color="light-green" color="yellow")`),L=e(`<w-rating
  class="my2"
  color="green">
</w-rating>
...
`),R=e("Custom Icons"),j=t("br",null,null,-1),H=e(`w-rating.my2(icon="mdi mdi-heart" :model-value="3.4")
br
w-rating.my2(icon="mdi mdi-heart-outline" :model-value="3.4")`),F=e(`<w-rating
  class="my2"
  icon="mdi mdi-heart"
  :model-value="3.4">
</w-rating>
