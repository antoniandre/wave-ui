import{A as e,G as t,P as n,c as r,d as i,g as a,h as o}from"./runtime-core.esm-bundler-BuLlhxCm.js";import{t as s}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{B as c,a as l}from"./index-DR7O6uV_.js";function u(s,c){let l=n(`alert`),u=n(`title-link`),d=n(`w-textarea`),f=n(`example`),p=n(`w-icon`);return e(),i(`div`,null,[a(l,{info:``},{default:t(()=>[...c[0]||=[r(`div`,{class:`title4`},`Good to know`,-1),r(`p`,{class:`body`},[o(`Any HTML attribute or JavaScript event listeners attached to the component will be applied to the
