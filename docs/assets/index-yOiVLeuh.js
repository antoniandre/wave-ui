import{r as g,g as b,o as h,a,b as i,w as n,e as t,t as u,c as z,d as T,_ as f,Q as U}from"./index-CBPNvwPY.js";const R={class:"w-card w-flex mdu-row basis-zero pa4 gap4"},I={class:"mr5"},G={class:"w-flex wrap justify-center align-center"},S={class:"mr4 my2"},W={class:"w-flex gap6"};function E(s,e,v,c,y,m){const o=g("title-link"),d=g("w-divider"),p=g("alert"),l=g("w-image"),r=g("example"),x=g("w-card"),$=g("w-radios"),j=g("w-button"),k=g("w-alert");return h(),b("div",null,[a(o,{h2:""},{default:n(()=>e[2]||(e[2]=[t("Why using w-image and not a simple <img>")])),_:1,__:[2]}),i("div",R,[e[4]||(e[4]=i("div",null,[i("div",{class:"title3"},"A simple <img>"),i("p",null,[t("will display when loaded, and will take the dimensions of the actual image."),i("br"),t(`
...
})`)])),default:n(()=>[a(l,{src:`${s.baseUrl}images/favicon.png`},null,8,["src"]),e[11]||(e[11]=i("div",{class:"caption text-center"},"Real size: 200x200.",-1))]),_:1,__:[11]}),a(p,{info:""},{default:n(()=>e[12]||(e[12]=[i("p",null,[t("In the "),i("code",null,"src"),t(" attribute, it's a good idea to use the "),i("code",null,"BASE_URL"),t(` environment variable to point to the
...
from just `),i("code",null,"/"),t(" which would point to "),i("code",null,"https://antoniandre.github.io/"),t("."),i("br")],-1),i("ul",null,[i("li",null,[t("With Vite, you can use "),i("code",null,u("import")+".meta.env.BASE_URL"),t(" to refer to your public app root URL.")]),i("li",null,[t("With Vue CLI or Webpack, you can also use "),i("code",null,u("process")+".env.BASE_URL"),t(".")])],-1)])),_:1,__:[12]}),a(o,{h2:""},{default:n(()=>e[13]||(e[13]=[t("Given dimensions")])),_:1,__:[13]}),e[112]||(e[112]=i("p",null,[i("strong",null,[t("You can set a width, a height, or both."),i("br")]),t("If the actual image is bigger than the given width or height, it will be cropped."),i("br"),t(`
But if you prefer it to be resized maintaining the ratio, then you can set a ratio.`)],-1)),a(o,{h3:""},{default:n(()=>e[14]||(e[14]=[t("Given both fixed width and height")])),_:1,__:[14]}),e[113]||(e[113]=i("p",null,[t(`In both examples the image will always have the same fixed size regardless of the viewport or
constraints.`),i("br"),t(`
...
`)],-1)),a(o,{h3:""},{default:n(()=>e[40]||(e[40]=[t("Intrinsic image ratio")])),_:1,__:[40]}),e[120]||(e[120]=i("p",{class:"grey"},"Image ratio equal to the exact width and height of the image (width / height).",-1)),e[121]||(e[121]=i("p",null,[t(`This is the most common case: the image is visible in full, and scales with its container with
preserved ratio.`),i("br"),t(`
Note that Wave UI will add a width of 100% if neither of width and height are provided.`)],-1)),a(p,{class:"mt2",tip:""},{default:n(()=>e[41]||(e[41]=[t("In this case, you can obtain the same result by just setting a width of 100%.")])),_:1,__:[41]}),a(r,{"content-class":"text-center"},{pug:n(()=>e[42]||(e[42]=[t('w-image(:src="`${baseUrl}images/japanese-wave.png`" :ratio="1900 / 443")')])),html:n(()=>e[43]||(e[43]=[t('<w-image\n  :src="`${baseUrl}images/japanese-wave.png`"\n  :ratio="1900 / 443">\n</w-image>')])),js:n(()=>e[44]||(e[44]=[t(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})
`)])),default:n(()=>[a(l,{src:`${s.baseUrl}images/japanese-wave.png`,ratio:1900/443},null,8,["src"]),e[45]||(e[45]=i("div",{class:"caption text-center"},"Real size: 1900x443. Given ratio: 1900 / 443.",-1))]),_:1,__:[45]}),a(o,{h3:""},{default:n(()=>e[46]||(e[46]=[t("Custom ratio")])),_:1,__:[46]}),e[122]||(e[122]=i("p",{class:"grey"},"Setting a different ratio than the actual image one.",-1)),e[123]||(e[123]=i("p",{class:"mb0"},`In this case, the image will be cropped on purpose, but still scaling with its container with
...
`)])),default:n(()=>[a(l,{src:`${s.baseUrl}images/japanese-wave.png`,tag:"img",width:"100%","max-width":"700px"},null,8,["src"])]),_:1}),a(o,{h2:""},{default:n(()=>e[68]||(e[68]=[t("Figure with or without caption")])),_:1,__:[68]}),e[128]||(e[128]=i("ul",null,[i("li",null,[t("You can tell the w-image component to use the native HTML "),i("span",{class:"code"},"<figure>"),t(` tag. In
...
Refresh the page if you haven't seen it (or enable dev tools throttling if your connection is too fast)!`,-1)),a(r,{"content-class":"text-center"},{pug:n(()=>e[77]||(e[77]=[t('w-image(:src="`${baseUrl}images/spirit-island--alberta.png`" :ratio="5098 / 2550")')])),html:n(()=>e[78]||(e[78]=[t('<w-image\n  :src="`${baseUrl}images/spirit-island--alberta.png`"\n  :ratio="5098 / 2550">\n</w-image>')])),js:n(()=>e[79]||(e[79]=[t(`data: () => ({
  baseUrl: 'https://antoniandre.github.io/wave-ui/'
})`)])),default:n(()=>[a(l,{src:`${s.baseUrl}images/spirit-island--alberta.png`,ratio:5098/2550},null,8,["src"]),e[80]||(e[80]=i("div",{class:"caption"},"Real size: 5098x2550. Given ratio: 5098 / 2550.",-1))]),_:1,__:[80]}),a(p,{tip:""},{default:n(()=>e[81]||(e[81]=[i("strong",null,"Dev notes:",-1),t(" disabling the browser cache will prevent you from seeing the transition."),i("br",null,null,-1),t(`
...
`)])),_:1,__:[81]}),a(o,{h2:""},{default:n(()=>e[82]||(e[82]=[t("Transitions")])),_:1,__:[82]}),e[130]||(e[130]=i("p",null,`Once the image is fully loaded, it will display in one piece with a fade transition by default.
...
}`)])),default:n(()=>[i("div",G,[i("div",S,[e[84]||(e[84]=i("div",{class:"title3 mb2"},"Transition names",-1)),a($,{modelValue:s.img.transition,"onUpdate:modelValue":e[0]||(e[0]=w=>s.img.transition=w),items:s.transitions,"item-value-key":"label"},{label:n(({item:w})=>[i("code",null,u(w.label),1)]),_:1},8,["modelValue","items"]),a(j,{class:"mt2",onClick:m.reload},{default:n(()=>e[83]||(e[83]=[t("Reload image")])),_:1,__:[83]},8,["onClick"])]),i("div",null,[a(l,{src:s.img.src,width:500,height:250,transition:s.img.transition},null,8,["src","transition"]),e[85]||(e[85]=i("div",{class:"caption"},"Real size: 5098x2550. Given size: 500x250.",-1))])])]),_:1}),a(p,{tip:""},{default:n(()=>e[89]||(e[89]=[i("strong",null,"Dev notes:",-1),t(" disabling the browser cache will prevent you from seeing the transition."),i("br",null,null,-1),t(`
The reason for it is that the image first loads in the `),i("strong",{class:"code"},"w-image",-1),t(` component, then
once it's fully loaded, the image src is filled (or background url) and the image would load again
if you disable the cache. On big images, you would then see a truncated image until completely
loaded, just like a standard <img>.
`)])),_:1,__:[89]}),a(o,{h2:""},{default:n(()=>e[90]||(e[90]=[t("Error handling & Fallback")])),_:1,__:[90]}),i("div",W,[a(r,{class:"mt0 no-grow","content-class":"text-center px6"},{pug:n(()=>e[91]||(e[91]=[t('w-image.bd1(src="/images/broken.png" width="100" height="100")')])),html:n(()=>e[92]||(e[92]=[t(`<w-image
  class="bd1"
  src="/images/broken.png"
  width="100"
  height="100">
</w-image>`)])),default:n(()=>[a(l,{class:"bd1",src:"/images/broken.png",width:"100",height:"100"}),e[93]||(e[93]=i("div",{class:"caption"},[t("Given size: 100x100."),i("br"),t("Border added for visualization.")],-1))]),_:1,__:[93]}),e[94]||(e[94]=i("p",null,[t(`If for some reason the image would not load, the default fallback is a blank 1x1 transparent gif
...
`)],-1))]),a(o,{h3:""},{default:n(()=>e[95]||(e[95]=[t("Fallback & Error handling")])),_:1,__:[95]}),e[131]||(e[131]=i("ul",null,[i("li",null,`For instance, in a e-boutique you may try to load the image of an item without knowing if this item
...
`)])),default:n(()=>[a(l,{src:`${s.baseUrl}images/spirit-island--alberta.png?v1`,lazy:"",ratio:5098/2550},null,8,["src"]),e[104]||(e[104]=i("div",{class:"caption"},"Real size: 5098x2550.",-1))]),_:1,__:[104]}),a(o,{h2:"",slug:"content"},{default:n(()=>e[105]||(e[105]=[t("Content - via default slot")])),_:1,__:[105]}),e[133]||(e[133]=i("p",null,[t("In some cases, it can be convenient to have some content on top of the image."),i("br"),t(`
