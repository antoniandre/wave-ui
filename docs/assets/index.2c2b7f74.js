...
`),M=e("Color & hoverable"),O=i("p",null,[e("Like in most components, you can set a "),i("code",null,"color"),e(" for the text and a "),i("code",null,"bg-color"),e(` for the
background.`)],-1),R=i("br",null,null,-1),B=e(`w-list(:items="items" color="pink" hover)
br
...
`),Pe=e("Checklist colors"),ze=i("p",null,"A checklist can have all the color options that the normal list can have, even a different color per item.",-1),Ke=e('w-list(v-model="selection5" :items="items" checklist)'),Le=e(`<w-list
  v-model="selection"
  :items="items"
  checklist>
</w-list>`),Me=e(`data: () => ({
...
`),Oe=e("Navigation lists"),Re=i("p",null,[e("The navigation list expects a "),i("code",null,"route"),e(" attribute in the items that are links."),i("br"),e(`
If you are using Vue Router, all the links will automatically be `),i("strong",{class:"code"},"router-link"),e("s."),i("br")],-1),Be=i("p",null,[e("It is possible to disable a link with a "),i("code",null,"disabled: true"),e(" attribute in the item.")],-1),Ye=i("div",{class:"spacer"},null,-1),qe=e(`data: () => ({
  items: [
