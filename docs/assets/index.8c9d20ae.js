...
background.`)],-1),D=b(`<h3>Dark / Light</h3><p>By default the <code>primary</code> color is considered dark as well as the four status colors:
...
For the rest you can use the <code>dark</code> prop or set the <code>color</code> prop to \`white\`.</p>`,2),z=b(`<p>The button size can be controlled via the preset sizes <code>xs</code>, <code>sm</code>, <code>md</code>,
<code>lg</code>, <code>xl</code> or via the <code>width</code> and <code>height</code> props.</p>`,1),A=a("br",null,null,-1),P=a("br",null,null,-1),I=a("h3",null,"Stretch to the available space",-1),W=a("h3",null,"Custom width and height",-1),M=a("p",null,[t("Even though you can easily override the dimensions via CSS, a "),a("code",null,"width"),t(" and "),a("code",null,"height"),t(` props
are available on the `),a("span",{class:"code"},"w-button"),t(" component.")],-1),B=a("p",null,"Icon buttons are rounded by default.",-1),H=a("code",null,"icon-props",-1),E=b(`<p>If you are using Vue Router, all the links will automatically be <strong class="code">router-link</strong>s
...
</p>`,1),G=a("p",null,[t("We often need a tooltip on a button. Especially on the ones that only have an icons."),a("br"),t(`
That's why from version 2.45.0, the w-button component ships with an integrated w-tooltip,
if you need it.`)],-1);function V(l,i,h,f,y,d){const r=c("title-link"),n=c("w-button"),m=c("w-flex"),s=c("example"),u=c("w-icon");return g(),w("div",null,[e(r,{h2:""},{default:o(()=>[t("Default")]),_:1}),$,e(n,{class:"ma1"},{default:o(()=>[t("default")]),_:1}),e(r,{h2:""},{default:o(()=>[t("Colors")]),_:1}),C,e(s,null,{pug:o(()=>[t(`w-flex.wrap
...
`)]),default:o(()=>[e(n,{class:"ma1","bg-color":"success",color:"yellow-light2"},{default:o(()=>[t("success")]),_:1}),e(n,{class:"ma1","bg-color":"error",color:"amber-light2"},{default:o(()=>[t("error")]),_:1}),e(n,{class:"ma1","bg-color":"primary",color:"success-light2"},{default:o(()=>[t("warning")]),_:1})]),_:1}),D,e(s,null,{pug:o(()=>[t(`w-button.ma1(bg-color="primary-light3") normal
...
`)]),default:o(()=>[e(n,{class:"ma1","bg-color":"secondary",xs:""},{default:o(()=>[t("extra small")]),_:1}),e(n,{class:"ma1","bg-color":"secondary",sm:""},{default:o(()=>[t("small")]),_:1}),e(n,{class:"ma1","bg-color":"secondary",md:""},{default:o(()=>[t("medium")]),_:1}),e(n,{class:"ma1","bg-color":"secondary",lg:""},{default:o(()=>[t("large")]),_:1}),e(n,{class:"ma1","bg-color":"secondary",xl:""},{default:o(()=>[t("extra large")]),_:1}),e(n,{class:"ma1","bg-color":"secondary",disabled:""},{default:o(()=>[t("disabled")]),_:1}),A,P,e(n,{class:"ma1","bg-color":"primary",xs:""},{default:o(()=>[t("extra small")]),_:1}),e(n,{class:"ma1","bg-color":"primary",sm:""},{default:o(()=>[t("small")]),_:1}),e(n,{class:"ma1","bg-color":"primary",md:""},{default:o(()=>[t("medium")]),_:1}),e(n,{class:"ma1","bg-color":"primary",lg:""},{default:o(()=>[t("large")]),_:1}),e(n,{class:"ma1","bg-color":"primary",xl:""},{default:o(()=>[t("extra large")]),_:1}),e(n,{class:"ma1","bg-color":"primary",disabled:""},{default:o(()=>[t("disabled")]),_:1})]),_:1}),I,e(s,null,{pug:o(()=>[t(`w-flex
  w-button.ma1.grow(bg-color="primary") primary`)]),html:o(()=>[t(`<w-flex>
  <w-button class="ma1 grow" bg-color="primary">primary</w-button>
</w-flex>
`)]),default:o(()=>[e(m,null,{default:o(()=>[e(n,{class:"ma1 grow","bg-color":"primary"},{default:o(()=>[t("primary")]),_:1})]),_:1})]),_:1}),W,M,e(s,{"content-class":"pt6"},{pug:o(()=>[t('w-button.ma1(bg-color="info" width="10em" :height="18") info')]),html:o(()=>[t(`<w-button
  class="ma1 grow"
  bg-color="info"
  width="10em"
  :height="18">
...
`)]),default:o(()=>[e(n,{class:"ma1","bg-color":"error",icon:"wi-cross"}),e(n,{class:"ma1 mr6","bg-color":"success",icon:"wi-check"}),e(n,{class:"ma1","bg-color":"error"},{default:o(()=>[e(u,{class:"mr1"},{default:o(()=>[t("wi-cross")]),_:1}),t("Cancel")]),_:1}),e(n,{class:"ma1","bg-color":"success"},{default:o(()=>[e(u,{class:"mr1"},{default:o(()=>[t("wi-check")]),_:1}),t("Save")]),_:1})]),_:1}),e(r,{h3:"",slug:"more-control-on-icons"},{default:o(()=>[t("More control on icons using the "),H]),_:1}),e(s,{"content-class":"w-flex"},{pug:o(()=>[t('w-button(icon="wi-star" :icon-props="{ spin: true }") default')]),html:o(()=>[t(`<w-button
  icon="wi-star"
...
`)]),default:o(()=>[e(n,{class:"ma1",loading:l.button1loading,onClick:i[0]||(i[0]=k=>d.buttonDoLoading(1))},{default:o(()=>[e(u,{class:"mr1"},{default:o(()=>[t("wi-check")]),_:1}),t("Save")]),_:1},8,["loading"]),e(n,{class:"ma1 px4",loading:l.button2loading,onClick:i[1]||(i[1]=k=>d.buttonDoLoading(2))},{loading:o(()=>[t("Loading...")]),default:o(()=>[e(u,{class:"mr1"},{default:o(()=>[t("wi-check")]),_:1}),t("Save")]),_:1},8,["loading"])]),_:1}),e(r,{h2:""},{default:o(()=>[t("Links")]),_:1}),E,e(s,{"content-class":"w-flex"},{pug:o(()=>[t(`w-button.ma1(route="/getting-started")
  | Getting started
