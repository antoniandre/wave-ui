...
`)]),default:t(()=>[l(c,{items:5,hover:""},{item:t(({index:o})=>[e("Item "+n(o),1)]),"item.3":t(()=>[P]),_:1})]),_:1}),z,l(r,null,{pug:t(()=>[e(`w-list(:items="items" hover)
  template(#item="{ item }")
    w-flex(align-center justify-space-between)
      | `+n("{{ item.label }}")+`
      w-icon(md) `+n("{{ item.icon }}"))]),html:t(()=>[e(`<w-list :items="items" hover>
  <template #item="{ item }">
    <w-flex align-center justify-space-between>
      `+n("{{ item.label }}")+`
...
<div class="title3 mt2">
  ...
  selection: 2,
  itemClicked: null
})`)]),default:t(()=>[l(I,{class:"mb6",modelValue:s.multiple,"onUpdate:modelValue":a[0]||(a[0]=o=>s.multiple=o),items:s.radios,inline:""},null,8,["modelValue","items"]),l(w,{wrap:"","align-center":""},{default:t(()=>[l(c,{class:"grow mr4",modelValue:s.selection1,"onUpdate:modelValue":a[1]||(a[1]=o=>s.selection1=o),items:s.listItems1,color:"deep-purple",multiple:s.multiple,onItemClick:a[2]||(a[2]=o=>s.itemClicked=o)},null,8,["modelValue","items","multiple"]),s.itemClicked?(u(),p("div",O,[R,B,i("span",L,n(s.itemClicked),1)])):y("",!0)]),_:1}),i("div",Y,[e("Selected item:"),!s.multiple||Array.isArray(s.selection1)?(u(),p("code",q,n(s.selection1||"null"),1)):s.multiple?(u(),p("code",F,n(s.selection1?[s.selection1]:"[]"),1)):y("",!0)])]),_:1}),G,l(m,{h2:""},{default:t(()=>[e("Checklists")]),_:1}),l(r,null,{pug:t(()=>[e(`w-flex(wrap basis-zero :gap="3")
  .grow
    .title3.mb4 Default
    w-list(
      v-model="selection1"
  ...
  .grow
    ...
    w-list.custom(
      ...
      template(#item="{ item }")
        span `+n("{{ item.label }}")+`
        .spacer
        w-icon(md) `+n("{{ item.icon }}"))]),html:t(()=>[e(`<w-flex wrap basis-zero :gap="3">
  <div class="grow">
...
`)]),default:t(()=>[l(c,{modelValue:s.selection5,"onUpdate:modelValue":a[7]||(a[7]=o=>s.selection5=o),items:s.listItems5,checklist:""},null,8,["modelValue","items"])]),_:1}),l(m,{h2:""},{default:t(()=>[e("Navigation lists")]),_:1}),oe,ae,l(r,null,{pug:t(()=>[e(`w-list(:items="items" nav color="primary")
  template(#item="{ item }")
    span `+n("{{ item.label }")+`}
    .spacer
    w-icon(md) `+n("{{ item.icon }}"))]),html:t(()=>[e(`<w-list :items="items" nav color="primary">
  <template #item="{ item }">
    <span>`+n("{{ item.label }}")+`</span>
    <div class="spacer"></div>
    <w-icon md>`+n("{{ item.icon }}")+`</w-icon>
