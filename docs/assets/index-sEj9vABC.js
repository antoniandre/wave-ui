import{r,g as v,o as y,a as t,b as a,w as o,e as n,t as g,p as x,J as O,_ as h,K as V}from"./index-DyPyadtc.js";const T={class:"w-flex mt6 no-grow"},$={class:"w-flex"},A={class:"w-flex wrap"},D={class:"ma2"},F={class:"ma2"};function U(l,e,q,k,C,u){const d=r("title-link"),s=r("w-button"),w=r("w-icon"),c=r("w-checkbox"),b=r("w-radios"),m=r("w-dialog"),p=r("example"),f=r("w-radio");return y(),v("div",null,[t(d,{h2:""},{default:o(()=>e[35]||(e[35]=[n("Global demo",-1)])),_:1,__:[35]}),e[95]||(e[95]=a("p",null,"This dialog contains some basic options for the w-dialog.",-1)),t(p,{"content-class":"pt5"},{pug:o(()=>e[43]||(e[43]=[n(`w-button.px4(@click="dialog.show = true") Open dialog
...
w-dialog(
  ...
  template(#actions)
    .spacer
    w-button(@click="dialog.show = false") Close`,-1)])),html:o(()=>e[44]||(e[44]=[n(`<w-button class="px4" @click="dialog.show = true">
  Open dialog
</w-button>
...
</w-dialog>`,-1)])),js:o(()=>e[45]||(e[45]=[n(`data: () => ({
  dialog: {
    show: false,
    fullscreen: false,
    persistent: false,
...
`,-1)])),default:o(()=>[t(s,{class:"px4",onClick:e[0]||(e[0]=i=>l.dialog1.show=!0)},{default:o(()=>e[36]||(e[36]=[n("Open dialog",-1)])),_:1,__:[36]}),t(m,{modelValue:l.dialog1.show,"onUpdate:modelValue":e[6]||(e[6]=i=>l.dialog1.show=i),fullscreen:l.dialog1.fullscreen,width:l.dialog1.width,persistent:l.dialog1.persistent,"persistent-no-animation":l.dialog1.persistentNoAnimation,"title-class":"primary-light1--bg white"},{title:o(()=>[t(w,{class:"mr2"},{default:o(()=>e[37]||(e[37]=[n("mdi mdi-tune",-1)])),_:1,__:[37]}),e[38]||(e[38]=n("Control panel",-1))]),actions:o(()=>[e[41]||(e[41]=a("div",{class:"spacer"},null,-1)),t(s,{onClick:e[5]||(e[5]=i=>l.dialog1.show=!1)},{default:o(()=>e[40]||(e[40]=[n("Close",-1)])),_:1,__:[40]})]),default:o(()=>[t(c,{class:"d-flex mt2",modelValue:l.dialog1.fullscreen,"onUpdate:modelValue":e[1]||(e[1]=i=>l.dialog1.fullscreen=i),label:"Fullscreen"},null,8,["modelValue"]),t(c,{class:"d-flex mt2",modelValue:l.dialog1.persistent,"onUpdate:modelValue":e[2]||(e[2]=i=>l.dialog1.persistent=i),label:"Persistent (try to click outside)"},null,8,["modelValue"]),t(c,{class:"d-flex mt2",modelValue:l.dialog1.persistentNoAnimation,"onUpdate:modelValue":e[3]||(e[3]=i=>l.dialog1.persistentNoAnimation=i),disabled:!l.dialog1.persistent,label:"Persistent with no animation"},null,8,["modelValue","disabled"]),a("div",T,[e[39]||(e[39]=a("span",{class:"mr2"},"Width:",-1)),t(b,{modelValue:l.dialog1.width,"onUpdate:modelValue":e[4]||(e[4]=i=>l.dialog1.width=i),items:[{value:300,label:"300px"},{value:500,label:"500px"}],inline:""},null,8,["modelValue"])]),e[42]||(e[42]=a("div",{class:"mt4 mb-2 grey-light1"},[n("The "),a("span",{class:"code grey-light1"},"width"),n(` prop is called so for simplicity, but it internally translates to
a `),a("span",{class:"code grey-light1"},"max-width"),n(` to fit on small screens.
`)],-1))]),_:1,__:[42]},8,["modelValue","fullscreen","width","persistent","persistent-no-animation"])]),_:1}),t(d,{h2:""},{default:o(()=>e[46]||(e[46]=[n("Basic",-1)])),_:1,__:[46]}),t(p,{"content-class":"pt5"},{pug:o(()=>e[49]||(e[49]=[n(`w-button.px4(@click="showDialog = true") Open dialog
...
w-dialog(v-model="showDialog" title="Dialog title").
  ...
  perspiciatis repellendus. Sunt!`,-1)])),html:o(()=>e[50]||(e[50]=[n(`<w-button class="px4" @click="showDialog = true">
  Open dialog
</w-button>
...
<w-dialog>`,-1)])),js:o(()=>e[51]||(e[51]=[n(`data: () => ({
  showDialog: false
})
`,-1)])),default:o(()=>[t(s,{class:"px4",onClick:e[7]||(e[7]=i=>l.dialog0.show=!0)},{default:o(()=>e[47]||(e[47]=[n("Open dialog",-1)])),_:1,__:[47]}),t(m,{modelValue:l.dialog0.show,"onUpdate:modelValue":e[8]||(e[8]=i=>l.dialog0.show=i),title:"Dialog title"},{default:o(()=>e[48]||(e[48]=[n("Lorem ipsum dolor sit amet consectetur adipisicing elit.",-1),a("br",null,null,-1),n(`
Unde eum non necessitatibus quia corporis odio numquam sequi iusto
voluptatum delectus? Excepturi minus iste, provident non totam itaque
sed ut labore?`,-1),a("br",null,null,-1),a("br",null,null,-1),n(`
Nihil delectus distinctio eveniet quis qui tempora sit,
illum a reprehenderit esse ex ipsam deleniti optio accusantium saepe
cupiditate doloremque dignissimos aliquam aperiam earum soluta pariatur
sapiente, provident sequi? Itaque!Soluta itaque sed, obcaecati ipsum eum
dolores ratione quis hic adipisci atque dolor laudantium quisquam ea vitae
impedit fuga reprehenderit pariatur, reiciendis autem blanditiis excepturi
beatae ex nihil.`,-1),a("br",null,null,-1),n(`
Incidunt, eos? Magnam quaerat enim eum, non fuga excepturi
labore nemo voluptates necessitatibus esse amet voluptatibus modi deleniti
porro officiis ut fugit quidem corporis itaque possimus commodi sint unde
perspiciatis repellendus. Sunt!`,-1)])),_:1,__:[48]},8,["modelValue"])]),_:1}),t(d,{h2:""},{default:o(()=>e[52]||(e[52]=[n("Persistent prompt dialog",-1)])),_:1,__:[52]}),t(p,{"content-class":"pt5"},{pug:o(()=>e[61]||(e[61]=[n(`w-button.px4(@click="dialog.show = true") Open dialog
...
w-dialog(
  ...
  template(#actions)
    ...
    w-button(@click="dialog.show = false" bg-color="success") I agree`,-1)])),html:o(()=>e[62]||(e[62]=[n(`<w-button class="px4" @click="dialog.show = true">
  Open dialog
</w-button>
...
</w-dialog>`,-1)])),js:o(()=>e[63]||(e[63]=[n(`data: () => ({
  dialog: { show: false }
})
`,-1)])),default:o(()=>[t(s,{class:"px4",onClick:e[9]||(e[9]=i=>l.dialog2.show=!0)},{default:o(()=>e[53]||(e[53]=[n("Open dialog",-1)])),_:1,__:[53]}),t(m,{modelValue:l.dialog2.show,"onUpdate:modelValue":e[12]||(e[12]=i=>l.dialog2.show=i),title:"Terms and conditions",persistent:"",width:550},{actions:o(()=>[e[56]||(e[56]=a("div",{class:"spacer"},null,-1)),t(s,{class:"mr2",onClick:e[10]||(e[10]=i=>l.dialog2.show=!1),"bg-color":"error"},{default:o(()=>e[54]||(e[54]=[n("I disagree",-1)])),_:1,__:[54]}),t(s,{onClick:e[11]||(e[11]=i=>l.dialog2.show=!1),"bg-color":"success"},{default:o(()=>e[55]||(e[55]=[n("I agree",-1)])),_:1,__:[55]})]),default:o(()=>[e[57]||(e[57]=n(`Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rem dolore delectus,
quisquam ipsa laudantium esse consequatur itaque similique et eligendi eum voluptas
odit dolor labore eveniet at vel sequi nostrum.`,-1)),e[58]||(e[58]=a("br",null,null,-1)),e[59]||(e[59]=a("br",null,null,-1)),e[60]||(e[60]=n(`
Voluptates, aut distinctio esse quia doloribus commodi minima inventore neque sequi
dolores perspiciatis fugiat. Fuga, reprehenderit sequi veritatis iure magnam excepturi
aliquid dolore quo amet deserunt asperiores placeat maxime perferendis.`,-1))]),_:1,__:[57,58,59,60]},8,["modelValue"])]),_:1}),t(d,{h2:""},{default:o(()=>e[64]||(e[64]=[n("Nesting",-1)])),_:1,__:[64]}),e[96]||(e[96]=a("p",null,"It is possible to open a dialog inside a dialog.",-1)),t(p,{"content-class":"pt5"},{pug:o(()=>e[71]||(e[71]=[n(`w-button.px4(@click="dialog1.show = true") Open dialog
...
w-dialog(v-model="dialog2.show" :width="250" title="Dialog 2" content-class="text-center")
  w-button.my6(@click="dialog2.show = false" bg-color="error") Close`,-1)])),html:o(()=>e[72]||(e[72]=[n(`<w-button
  class="px4"
...
</w-dialog>`,-1)])),js:o(()=>e[73]||(e[73]=[n(`data: () => ({
  dialog1: { show: false },
  dialog2: { show: false }
})
`,-1)])),default:o(()=>[t(s,{class:"px4",onClick:e[13]||(e[13]=i=>l.dialog3.show=!0)},{default:o(()=>e[65]||(e[65]=[n("Open dialog",-1)])),_:1,__:[65]}),t(m,{modelValue:l.dialog3.show,"onUpdate:modelValue":e[16]||(e[16]=i=>l.dialog3.show=i),width:600,title:"Dialog 1","content-class":"text-center"},{actions:o(()=>[e[68]||(e[68]=a("div",{class:"spacer"},null,-1)),t(s,{onClick:e[15]||(e[15]=i=>l.dialog3.show=!1),"bg-color":"error"},{default:o(()=>e[67]||(e[67]=[n("Close",-1)])),_:1,__:[67]})]),default:o(()=>[e[69]||(e[69]=a("p",null,"Lorem ipsum, dolor sit amet consectetur adipisicing elit...",-1)),t(s,{class:"mt6",onClick:e[14]||(e[14]=i=>l.dialog4.show=!0)},{default:o(()=>e[66]||(e[66]=[n("Open second dialog",-1)])),_:1,__:[66]})]),_:1,__:[69]},8,["modelValue"]),t(m,{modelValue:l.dialog4.show,"onUpdate:modelValue":e[18]||(e[18]=i=>l.dialog4.show=i),width:250,title:"Dialog 2","content-class":"text-center"},{default:o(()=>[t(s,{class:"my6",onClick:e[17]||(e[17]=i=>l.dialog4.show=!1),"bg-color":"error"},{default:o(()=>e[70]||(e[70]=[n("Close",-1)])),_:1,__:[70]})]),_:1},8,["modelValue"])]),_:1}),t(d,{h2:""},{default:o(()=>e[74]||(e[74]=[n("Transitions",-1)])),_:1,__:[74]}),e[97]||(e[97]=a("p",null,[n("To change the default transition you can use the "),a("code",null,"transition"),n(` prop and provide one of
...
w-dialog(
  ...
  w-button.my6(@click="dialog.show = false" bg-color="error") Close`,-1)])),html:o(()=>e[80]||(e[80]=[n(`<div class="w-flex">
  <w-button
    class="px4 mr6"
...
</w-dialog>`,-1)])),js:o(()=>e[81]||(e[81]=[n(`data: () => ({
  dialog: {
    show: false,
    fullscreen: false,
    transition: 'fade'
...
w-dialog(
  ...
  template(#actions)
    .spacer
    w-button(@click="dialog.show = false" bg-color="error") Close`,-1)])),html:o(()=>e[93]||(e[93]=[n(`<w-button
  class="px4"
  @click="dialog.show = true">
  Open control panel
</w-button>
