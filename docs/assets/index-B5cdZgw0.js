import{r as c,o as w,g,a as e,w as o,b as t,m as _,n as v,t as S,d as a,h as b,_ as h,A as x}from"./index-DIRMtT9U.js";const $=a("p",null,[t("By default (if no "),a("code",null,"color"),t(" or "),a("code",null,"bg-color"),t(" is applied) the primary color will be applied.")],-1),D=b(`<p>Setting colors on buttons is quite straightforward:
...
background.`)],-1),T=b(`<h3>Dark / Light</h3><p>By default the <code>primary</code> color is considered dark as well as the four status colors:
...
`)]),default:o(()=>[e(n,{class:"ma1","bg-color":"success",color:"yellow-light2"},{default:o(()=>[t("success")]),_:1}),e(n,{class:"ma1","bg-color":"error",color:"amber-light2"},{default:o(()=>[t("error")]),_:1}),e(n,{class:"ma1","bg-color":"primary",color:"success-light2"},{default:o(()=>[t("warning")]),_:1})]),_:1}),T,e(s,null,{pug:o(()=>[t(`w-button.ma1(bg-color="primary-light3") normal
