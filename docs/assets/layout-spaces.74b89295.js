import{n}from"./index.052c2afa.js";import"./vendor.4f8da9ec.js";var i=function(){var e=this,a=e.$createElement,t=e._self._c||a;return t("main",[t("title-link",{staticClass:"mt4",attrs:{h1:""}},[e._v("Spaces")]),t("title-link",{attrs:{h2:""}},[e._v("Content spacing")]),e._m(0),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<div class="orange-light4--bg pa12">
...
base-font-size pixels.`)])])]),t("title-link",{attrs:{h3:""}},[e._v("Negative margin")]),e._m(1),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<div class="orange-light4--bg pa8">
...
base-font-size pixels.`)])]),t("title-link",{attrs:{h3:""}},[e._v("Margin auto")]),e._m(2),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<div class="orange-light4--bg pa8">
...
The syntax for it is `),t("code",[e._v("m[side]a")])])}];const o={},s={};var l=n(o,i,r,!1,v,null,null,null);function v(e){for(let a in s)this[a]=s[a]}var h=function(){return l.exports}();export{h as default};
