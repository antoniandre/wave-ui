import{r as u,g as v,o as f,a as l,b as o,w as s,e as t,t as m,_ as w,a4 as y}from"./index-DyPyadtc.js";const x={class:"mt4"},k={class:"ml1"},$={class:"mt4"},A={class:"ml1"},C={class:"mt4"},D={class:"ml1"},M={class:"mt4"},T={class:"ml1"},L={class:"mt4"},U={class:"ml1"};function z(n,e,g,c,h,p){const d=u("title-link"),i=u("w-slider"),r=u("example"),V=u("w-button"),S=u("w-flex"),b=u("w-icon");return f(),v("div",null,[l(d,{h2:""},{default:s(()=>e[8]||(e[8]=[t("Default",-1)])),_:1,__:[8]}),e[47]||(e[47]=o("p",null,[t("By default the range will have the "),o("code",null,"primary"),t(" color.")],-1)),l(r,{"content-class":"pa6"},{html:s(()=>e[9]||(e[9]=[t(`<w-slider :model-value="50"></w-slider>
`,-1)])),default:s(()=>[l(i,{"model-value":50})]),_:1}),l(d,{h2:""},{default:s(()=>e[10]||(e[10]=[t("V-model & external controls",-1)])),_:1,__:[10]}),l(r,{"content-class":"px6"},{html:s(()=>e[12]||(e[12]=[t(`<w-flex align-center>
  <w-button
    @click="sliderValue -= 5"
    icon="wi-minus"
    bg-color="success"
...
</div>`,-1)])),js:s(()=>e[13]||(e[13]=[t(`data: () => ({
  sliderValue: 50
})
`,-1)])),default:s(()=>[l(S,{"align-center":""},{default:s(()=>[l(V,{onClick:e[0]||(e[0]=a=>n.sliderValue-=5),icon:"wi-minus","bg-color":"success",sm:""}),l(i,{class:"mx3 grow",modelValue:n.sliderValue,"onUpdate:modelValue":e[1]||(e[1]=a=>n.sliderValue=a),color:"green"},null,8,["modelValue"]),l(V,{onClick:e[2]||(e[2]=a=>n.sliderValue+=5),icon:"wi-plus","bg-color":"success",sm:""})]),_:1}),o("div",x,[e[11]||(e[11]=t("v-model:",-1)),o("code",k,m(n.sliderValue),1)])]),_:1}),l(d,{h2:""},{default:s(()=>e[14]||(e[14]=[t("Min & max",-1)])),_:1,__:[14]}),l(r,{"content-class":"px6"},{html:s(()=>e[17]||(e[17]=[t(`<div class="title4 mb4">From 4 to 5</div>
<w-slider
  v-model="sliderValue"
  :min="4"
  :max="5">
...
</div>`,-1)])),js:s(()=>e[18]||(e[18]=[t(`data: () => ({
  sliderValue: 4.5,
  slider2Value: 0
})
`,-1)])),default:s(()=>[e[19]||(e[19]=o("div",{class:"title4 mb4"},"From 4 to 5",-1)),l(i,{modelValue:n.minMaxValue,"onUpdate:modelValue":e[3]||(e[3]=a=>n.minMaxValue=a),min:4,max:5},null,8,["modelValue"]),o("div",$,[e[15]||(e[15]=t("v-model:",-1)),o("code",A,m(n.minMaxValue),1)]),e[20]||(e[20]=o("div",{class:"title4 mt8 mb4"},"From -10 to 10",-1)),l(i,{modelValue:n.minMaxValue2,"onUpdate:modelValue":e[4]||(e[4]=a=>n.minMaxValue2=a),min:-10,max:10},null,8,["modelValue"]),o("div",C,[e[16]||(e[16]=t("v-model:",-1)),o("code",D,m(n.minMaxValue2),1)])]),_:1,__:[19,20]}),l(d,{h2:""},{default:s(()=>e[21]||(e[21]=[t("Disabled & readonly",-1)])),_:1,__:[21]}),l(r,{"content-class":"px6"},{html:s(()=>e[22]||(e[22]=[t(`<w-slider class="mt2" :model-value="50" disabled></w-slider>
<w-slider class="mt8" :model-value="50" readonly></w-slider>
`,-1)])),default:s(()=>[l(i,{class:"mt2","model-value":50,disabled:""}),l(i,{class:"mt8","model-value":50,readonly:""})]),_:1}),l(d,{h2:""},{default:s(()=>e[23]||(e[23]=[t("Labels on the left & right",-1)])),_:1,__:[23]}),l(r,{"content-class":"px6"},{html:s(()=>e[28]||(e[28]=[t(`<w-slider
  class="mt2"
  :model-value="50"
  label-left="0"
  label-right="100">
...
`,-1)])),default:s(()=>[l(i,{class:"mt2","model-value":50,"label-left":"0","label-right":"100"}),l(i,{class:"mt6","model-value":50,"label-left":"Left"}),l(i,{class:"mt6","model-value":50,"label-right":"Right"}),l(i,{class:"mt12","model-value":50},{"label-left":s(()=>[e[25]||(e[25]=o("span",null,"Weight",-1)),l(b,{class:"ml2 green"},{default:s(()=>e[24]||(e[24]=[t("mdi mdi-feather",-1)])),_:1,__:[24]})]),"label-right":s(()=>[l(b,{class:"red"},{default:s(()=>e[26]||(e[26]=[t("mdi mdi-weight",-1)])),_:1,__:[26]}),l(b,{class:"red"},{default:s(()=>e[27]||(e[27]=[t("mdi mdi-weight",-1)])),_:1,__:[27]})]),_:1})]),_:1}),l(d,{h2:""},{default:s(()=>e[29]||(e[29]=[t("Thumb label",-1)])),_:1,__:[29]}),l(r,{"content-class":"pt12 px8"},{html:s(()=>e[30]||(e[30]=[t(`<w-slider
  class="mt12"
  :model-value="24"
  thumb-label
  color="primary-light3">
</w-slider>
`,-1)])),default:s(()=>[l(i,{class:"mb4","model-value":24,"thumb-label":"",color:"primary-light3"})]),_:1}),l(d,{h3:"",slug:"custom-label-with-label-slot"},{default:s(()=>e[31]||(e[31]=[t("Customize the label with the ",-1),o("span",{class:"code"},"label",-1),t(" slot",-1)])),_:1,__:[31]}),l(r,{"content-class":"pt12 pb8 px8"},{html:s(()=>e[32]||(e[32]=[t(`<w-slider
  class="ma12"
  :model-value="46.3"
  thumb-label
  color="primary-light3">
...
</w-slider>`,-1)])),css:s(()=>e[35]||(e[35]=[t(`.big-label {font-size: 1.4em;}
`,-1)])),default:s(()=>[l(i,{class:"mt2 mb12","model-value":30,"thumb-label":"droplet"}),l(i,{class:"big-label mt12 mb4","model-value":60,"thumb-label":"droplet","thumb-label-class":"info--bg"})]),_:1}),l(d,{h2:""},{default:s(()=>e[36]||(e[36]=[t("Steps",-1)])),_:1,__:[36]}),e[52]||(e[52]=o("p",null,[t(`There is no step by default to ensure a very smooth movement while dragging. This also means that
