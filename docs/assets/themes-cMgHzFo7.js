import{r as i,g as k,o as b,a as l,b as o,w as a,e as t,t as d,h as y,p as w,v as g,_ as $}from"./index-BkivclCA.js";const S={class:"title2"},T={class:"title2"},I={class:"title2"},M={class:"mt6"},W={class:"mt6"},c={class:"w-flex align-center"},C={class:"mt6"},U={class:"w-flex align-center"},j={class:"mt6"};function A(n,e,D,N,Y,P){const s=i("title-link"),r=i("ssh-pre"),u=i("w-icon"),f=i("w-flex"),m=i("example"),h=i("w-button"),p=i("alert");return b(),k("main",null,[l(s,{class:"mt4",h1:""},{default:a(()=>e[2]||(e[2]=[t("Themes")])),_:1,__:[2]}),e[43]||(e[43]=o("p",null,"Wave UI offers a light theme (by default) and a dark theme.",-1)),l(s,{h2:""},{default:a(()=>e[3]||(e[3]=[t("Setting an initial theme")])),_:1,__:[3]}),e[44]||(e[44]=o("p",null,"You can set a theme at Wave UI's initialization, with:",-1)),l(r,{language:"js",dark:n.$store.state.darkMode},{default:a(()=>e[4]||(e[4]=[t(`app.use(WaveUI, {
