import{o as i,g as r,a as d,w as n,b as s,e,F as h,p as u,n as x,d as t,h as y,r as a,_ as j}from"./index.708fd280.js";const Y=e("p",null,[s("Wave UI offers a few CSS helper classes to control the drop shadow, borders and border radii."),e("br"),s(`
...
</w-flex>`)]),css:n(()=>[s(".box {\n  width: 80px;\n  height: 80px;\n  margin: 4px; /* You could use the class `ma1`. */\n  background-color: #e3f2fd; /* You could use the class `blue-light5--bg`. */\n  display: flex; /* You could use the class `d-flex`. */\n  align-items: center; /* You could use the class `align-center`. */\n  justify-content: center; /* You could use the class `justify-center`. */\n}\n")]),default:n(()=>[e("div",U,[(i(),r(h,null,u(7,o=>e("div",{class:x(["box blue-light5--bg ma4 d-flex align-center justify-center",`bd${o-1}`]),key:o},[e("span",B,".bd"+t(o-1),1)],2)),64))])]),_:1}),d(l,{h2:""},{default:n(()=>[s("Border radii")]),_:1}),N,d(b,{tip:""},{default:n(()=>[s("Here is the difference between "),E,s(" and "),T,s(" (only visible on non-square elements):"),V]),_:1}),d(c,null,{pug:n(()=>[s(`.w-flex.wrap
  .box.bdrs0 .bdrs0
  .box.bdrs1 .bdrs1
  .box.bdrs2 .bdrs2
  .box.bdrs3 .bdrs3
...
</w-flex>`)]),css:n(()=>[s(".box {\n  width: 80px;\n  height: 80px;\n  margin: 4px; /* You could use the class `ma1`. */\n  background-color: #e3f2fd; /* You could use the class `blue-light5--bg`. */\n  display: flex; /* You could use the class `d-flex`. */\n  align-items: center; /* You could use the class `align-center`. */\n  justify-content: center; /* You could use the class `justify-center`. */\n}\n")]),default:n(()=>[e("div",A,[(i(),r(h,null,u(7,o=>e("div",{class:x(["box blue-light5--bg ma4 d-flex align-center justify-center",`bdrs${o-1}`]),key:o},[e("span",q,".bdrs"+t(o-1),1)],2)),64)),D,F])]),_:1}),d(p,{class:"my12"}),d(l,{h2:""},{default:n(()=>[s("Examples of use on UI components")]),_:1}),R,d(c,null,{pug:n(()=>[s('w-flex(align-center justify-space-around wrap)\n  w-flex.no-grow(column align-center justify-center)\n    w-image.bd1.sh1.bdrsr.d-block(\n      :src="`${baseUrl}images/japanese-wave.png`"\n      :width="100"\n      :height="100")\n    span.mt3 w-image with `.bd1`, `.bdrsr` and `.sh1` classes.\n  w-switch.bdrs1.my4(:model-value="true") a w-switch with a `.bdrs1` class.')]),html:n(()=>[s(`<w-flex align-center justify-space-around wrap>
...
w-accordion.mt8.bdrs2.bd1(:items="2")
  ...
  template(#item-title.2="{ index }") Item `+t("{{ index }}")+`
  template(#item-content="{ index }") Content `+t("{{ index }}"))]),html:n(()=>[s(`<w-card bg-color="orange-light5" class="bdrs4 bd0 sh2">
  <div class="caption">
...
`)]),default:n(()=>[d(g,{class:"bdrs4 bd0 sh2","bg-color":"orange-light5"},{default:n(()=>[L]),_:1}),d(v,{class:"mt8 bdrs2 bd1",items:2},{"item-title":n(({index:o})=>[M]),"item-title.2":n(({index:o})=>[s("Item "+t(o),1)]),"item-content":n(({index:o})=>[s("Content "+t(o),1)]),_:1})]),_:1}),d(b,{info:""},{default:n(()=>[s(`Some of the UI components that have wrappers won't work nicely with the border and shadow classes.
