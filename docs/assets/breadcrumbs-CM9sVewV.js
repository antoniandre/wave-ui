import{N as e,U as t,c as n,d as r,g as i,h as a,k as o}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as s}from"./_plugin-vue_export-helper-S3RvzygF.js";import{L as c}from"./index-BJr8b_n6.js";function l(s,c,l,u,d,f){let p=e(`title-link`),m=e(`w-breadcrumbs`),h=e(`example`),g=e(`w-tag`);return o(),r(`div`,null,[i(p,{h2:``},{default:t(()=>[...c[0]||=[a(`Default`,-1)]]),_:1}),c[34]||=n(`p`,null,[a(`By default, each item except the last one will be a link providing that a route attribute is found
