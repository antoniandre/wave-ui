import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,l as s,u as c,xt as l}from"./runtime-core.esm-bundler-BuLlhxCm.js";import{t as u}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{T as d}from"./index-DcVDxcA5.js";var f={class:`w-card w-flex mdu-row basis-zero pa4 gap4`},p={class:`mr5`},m={class:`w-flex wrap justify-center align-center`},h={class:`mr4 my2`},g={class:`w-flex gap6`};function _(u,d,_,v,y,b){let x=n(`title-link`),S=n(`w-divider`),C=n(`alert`),w=n(`w-image`),T=n(`example`),E=n(`w-card`),D=n(`w-radios`),O=n(`w-button`),k=n(`w-alert`);return e(),i(`div`,null,[a(x,{h2:``},{default:t(()=>[...d[2]||=[o(`Why using w-image and not a simple <img>`,-1)]]),_:1}),r(`div`,f,[d[4]||=r(`div`,null,[r(`div`,{class:`title3`},`A simple <img>`),r(`p`,null,[o(`will display when loaded, and will take the dimensions of the actual image.`),r(`br`),o(`
...
from just `),r(`code`,null,`/`),o(` which would point to `),r(`code`,null,`https://antoniandre.github.io/`),o(`.`),r(`br`)],-1),r(`ul`,null,[r(`li`,null,[o(`With Vite, you can use `),r(`code`,null,l(`import`)+`.meta.env.BASE_URL`),o(` to refer to your public app root URL.`)]),r(`li`,null,[o(`With Vue CLI or Webpack, you can also use `),r(`code`,null,l(`process`)+`.env.BASE_URL`),o(`.`)])],-1)]]),_:1}),a(x,{h2:``},{default:t(()=>[...d[13]||=[o(`Given dimensions`,-1)]]),_:1}),d[112]||=r(`p`,null,[r(`strong`,null,[o(`You can set a width, a height, or both.`),r(`br`)]),o(`If the actual image is bigger than the given width or height, it will be cropped.`),r(`br`),o(`
