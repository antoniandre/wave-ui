import{H as e,N as t,c as n,d as r,g as i,h as a,k as o}from"./runtime-core.esm-bundler-DPe36P4s.js";import{t as s}from"./_plugin-vue_export-helper-S3RvzygF.js";import{t as c}from"./form-elements-Bk29BSHS.js";import{a as l}from"./index-D1jKshrg.js";function u(s,c){let l=t(`w-alert`),u=t(`title-link`),d=t(`w-textarea`),f=t(`example`),p=t(`w-icon`);return o(),r(`div`,null,[i(l,{info:``},{default:e(()=>[...c[0]||=[n(`div`,{class:`title4`},`Good to know`,-1),n(`p`,{class:`body`},[a(`Any HTML attribute or JavaScript event listeners attached to the component will be applied to the
