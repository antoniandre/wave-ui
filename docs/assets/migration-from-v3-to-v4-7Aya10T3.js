import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,vt as s}from"./runtime-core.esm-bundler-CLfruy3s.js";import{t as c}from"./_plugin-vue_export-helper-B80Cc4Ui.js";var l={class:`mt6`},u={class:`mt4`},d={class:`w-flex align-center wrap`},f={class:`mt4`},p={class:`w-flex align-center wrap`},m={class:`mt4`},h={class:`mt4`},g={class:`mt4`},_={class:`mt8`},v={class:`w-flex align-center wrap`},y={class:`w-flex align-center wrap`},b={class:`mt6`},x={class:`mt4`},S={class:`w-flex align-center wrap`},C={class:`mt4`},w={class:`w-flex align-center wrap`},T={class:`mt4`},E={class:`w-flex align-center wrap`},D={class:`w-flex justify-center mt12 pt12`},O={class:`sponsor-card text-center lh1 mt10 ovh`},k={class:`mt2`};function A(c,A,j,M,N,P){let F=n(`title-link`),I=n(`alert`),L=n(`w-icon`),R=n(`ssh-pre`),z=n(`router-link`),B=n(`w-accordion-item`),V=n(`w-accordion`),H=n(`w-button`);return e(),i(`main`,null,[a(F,{class:`mt4`,h1:``},{default:t(()=>[...A[0]||=[o(`Migration strategy from version 3.x to version 4.x`,-1)]]),_:1}),A[56]||=r(`p`,{class:`caption size--lg`},`Two steps to migrate from version 3.x to version 4.x`,-1),a(V,{class:`mt6`,"title-class":`py3`,"expand-icon-rotate90":``,"expand-single":``},{default:t(()=>[a(B,null,{title:t(()=>[a(F,{class:`my0`,h2:``,slug:`css-variable-overrides`},{default:t(()=>[...A[1]||=[o(`1. Replaced SCSS Variables with CSS variables`,-1)]]),_:1})]),content:t(()=>[a(I,{class:`alert--info px5`},{default:t(()=>[...A[2]||=[r(`div`,{class:`title4 text-bold`},`Wave UI 4 moves public style customization from SCSS variables to CSS custom
