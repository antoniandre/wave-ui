import{N as e,U as t,c as n,d as r,g as i,gt as a,h as o,k as s,yt as c}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as l}from"./_plugin-vue_export-helper-S3RvzygF.js";import{b as u}from"./index-CKcZQ2YR.js";var d={class:`code inherit`},f={class:`code inherit`};function p(l,u,p,m,h,g){let _=e(`title-link`),v=e(`w-button`),y=e(`w-divider`),b=e(`w-switch`),x=e(`w-input`),S=e(`w-flex`),C=e(`w-icon`),w=e(`w-overlay`),T=e(`example`),E=e(`ssh-pre`);return s(),r(`div`,null,[u[32]||=n(`p`,null,[o(`By default the overlay has a `),n(`span`,{class:`code`},`0.3`),o(` opacity with a black color and a z-index
