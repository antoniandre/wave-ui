import{n as m,H as c}from"./index.583eb76b.js";import"./vendor.4f8da9ec.js";var v=function(){var e=this,a=e.$createElement,t=e._self._c||a;return t("div",[t("title-link",{attrs:{h2:""}},[e._v("Default")]),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-table
...
`)]},proxy:!0}])},[t("w-table",{staticStyle:{height:"250px"},attrs:{headers:e.table3.headers,items:e.table3.items,"fixed-headers":""}})],1),t("title-link",{attrs:{h2:""}},[e._v("Built-in column resizing")]),t("p",[e._v("You can resize the columns by dragging their edges left or right.")]),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-table
  :headers="table.headers"
  :items="table.items"
  resizable-columns>
</w-table>`)]},proxy:!0},{key:"js",fn:function(){return[e._v(`data: () => ({
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table1.headers,items:e.table1.items,"resizable-columns":""}})],1),t("title-link",{attrs:{h2:""}},[e._v("Toggling column visibility")]),t("p",[e._v(`This is completely external to Wave UI, but this example shows you a way to do it in your
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table1.headers,items:e.table1.items,sort:e.table1.sort},on:{"update:sort":function(n){return e.$set(e.table1,"sort",n)}}})],1),t("title-link",{attrs:{h2:""}},[e._v("Filter")]),e._m(4),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<div class="w-flex wrap mb3">
  <w-button
    class="mr2 mb1"
...
`)]},proxy:!0}])},[e._v("Coming soon.")]),t("title-link",{attrs:{h2:""}},[e._v("Rows selection")]),t("p",[e._v("Click a row to see it highlighted and get information about the selected item.")]),e._m(7),t("title-link",{attrs:{h3:"",slug:"selectable-rows"}},[e._v("The "),t("span",{staticClass:"code"},[e._v("selectable-rows")]),e._v(" prop")]),e._m(8),t("title-link",{attrs:{h3:"",slug:"force-selection"}},[e._v("The "),t("span",{staticClass:"code"},[e._v("force-selection")]),e._v(" prop")]),e._m(9),t("title-link",{attrs:{h3:"",slug:"row-select"}},[e._v("The "),t("span",{staticClass:"code"},[e._v("@row-select")]),e._v(" event")]),e._m(10),e._m(11),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-flex wrap class="mb4">
  <w-radios
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table1.headers,items:e.table5.items,"expandable-rows":""},scopedSlots:e._u([{key:"expanded-row",fn:function(n){var l=n.item;return[t("w-icon",{staticClass:"mr2",attrs:{color:["blue","pink"][l.gender]}},[e._v("mdi "+e._s(["mdi-gender-male","mdi-gender-female"][l.gender]))]),e._v(e._s(l.firstName)+" weighs "),t("strong",[e._v(e._s(l.weight)+"kg")]),e._v(" and is "),t("strong",[e._v(e._s(l.height)+"m")]),e._v(" tall.")]}}])})],1),t("title-link",{attrs:{h2:"",slug:"slots"}},[e._v("Headers & cells customization via slots")]),t("p",[e._v("You can customize the headers labels and/or each row cells.")]),t("title-link",{attrs:{h3:""}},[e._v("Headers")]),e._m(12),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-table
  :headers="table.headers"
  :items="table.items">
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table1.headers,items:e.table1.items},scopedSlots:e._u([{key:"header-label",fn:function(n){var l=n.label,s=n.index;return[e._v(e._s(s)+": "+e._s(l)+" \u{1F44C}")]}}])})],1),t("title-link",{attrs:{h3:"",slug:"item-cells"}},[e._v("Item cells (inside <td> element)")]),e._m(13),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-table
  :headers="table.headers"
  no-headers
  :items="table.items">
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table1.headers,"no-headers":"",items:e.table1.items},scopedSlots:e._u([{key:"item-cell",fn:function(n){n.item;var l=n.label,s=n.header,i=n.index;return[s.key==="id"?t("small",[e._v("#"+e._s(i))]):[t("small",{staticClass:"grey mr2"},[e._v(e._s(s.label)+":")]),t("span",[e._v(e._s(l))])]]}}])})],1),t("title-link",{attrs:{h3:"",slug:"override-1-particular-item-cell"}},[e._v("override 1 particular item cell or column cells (inside <td> element)")]),e._m(14),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-table
  :headers="table.headers"
  :items="table.items"
  no-headers>
...
`)]},proxy:!0}])},[t("w-table",{attrs:{headers:e.table1.headers,items:e.table1.items,"selectable-rows":""},scopedSlots:e._u([{key:"item",fn:function(n){var l=n.item;n.index;var s=n.select,i=n.classes;return[t("tr",{class:i,on:{click:s}},e._l(e.table1.headers,function(o,d){return t("td",{key:d,class:"pa4 text-"+(o.align||"left")},[e._v(e._s(l[o.key]||""))])}),0)]}}])})],1),t("title-link",{attrs:{h3:"",slug:"colspan-on-td"}},[t("span",{staticClass:"code"},[e._v("colspan")]),e._v(" on <td>")]),e._m(16),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-table
  :headers="table.headers"
  :items="table.items"
  no-headers
  selectable-rows>
