import{r,o as g,g as w,d as o,b as n,a as l,w as t,_ as b,u as c}from"./index-DM46aIYM.js";const x={class:"title2 red"},v={class:"mt6"},k={class:"mt2"},S={class:"mt2"};function A(a,e){const p=r("w-tag"),f=r("ssh-pre"),u=r("alert"),d=r("title-link"),i=r("example"),s=r("w-badge"),m=r("w-flex"),y=r("router-link");return g(),w("div",null,[o("div",x,[e[2]||(e[2]=n("Required in Wave UI ")),l(p,{class:"error--bg",round:""},{default:t(()=>e[0]||(e[0]=[n("< 3.0")])),_:1}),e[3]||(e[3]=n(", removed in ")),l(p,{class:"error--bg",round:""},{default:t(()=>e[1]||(e[1]=[n("3.0")])),_:1}),e[4]||(e[4]=n("."))]),e[63]||(e[63]=o("p",{class:"mt6"},[n("This tag is required in your app for Wave UI proper functioning."),o("br"),n(`
