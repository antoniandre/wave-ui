import{r as l,g,o as d,a as i,h as p,b as s,w as t,e,_ as m}from"./index-CAQLAca3.js";const u={class:"orange-light4--bg pa12 grey-dark5"},h={class:"yellow-light5--bg pa3"};function x(f,n){const a=l("title-link"),r=l("router-link"),o=l("example");return d(),g("main",null,[i(a,{class:"mt4",h1:""},{default:t(()=>n[0]||(n[0]=[e("Spaces")])),_:1}),i(a,{h2:""},{default:t(()=>n[1]||(n[1]=[e("Content spacing")])),_:1}),n[26]||(n[26]=p(`<p>Margins and paddings are incrementable from 0 to 12 using this syntax: <code>ma[number]</code>,
