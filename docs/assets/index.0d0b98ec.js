...
be indefinitely spinning.`,-1);function S(n,s,v,f,b,m){const c=d("title-link"),a=d("w-switch"),r=d("example"),g=d("ssh-pre"),k=d("alert"),O=d("w-icon");return h(),w("div",null,[e(c,{h2:"",slug:"on-off-and-disabled"},{default:t(()=>[l("On, off & disabled")]),_:1}),e(r,{"content-class":"pt4"},{pug:t(()=>[]),html:t(()=>[l(`<w-switch
  class="ma2"
  :model-value="true"
  label="On">
</w-switch>
...
`)]),default:t(()=>[e(a,{class:"ma2","model-value":!0,thin:"",label:"On"}),e(a,{class:"ma2","model-value":!1,thin:"",label:"Off"}),e(a,{class:"ma2","model-value":!0,disabled:"",thin:"",label:"On disabled"}),e(a,{class:"ma2","model-value":!1,disabled:"",thin:"",label:"Off disabled"})]),_:1}),e(c,{h2:""},{default:t(()=>[l("Track slot")]),_:1}),x,e(k,{tip:""},{default:t(()=>[l("If the "),A,l(` width is too small for your custom content, it's very easy to
increase its width with CSS like in this example, and the component elements will adapt:`),e(g,{language:"css"},{default:t(()=>[D]),_:1})]),_:1}),e(r,{"content-class":"pt5"},{pug:t(()=>[l(`w-switch.ma4(v-model="value")
  template(#track)
