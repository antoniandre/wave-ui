import{r as d,o as T,f as w,a as n,w as t,b as e,h as l,d as i,k as V,_ as f,a7 as x}from"./index.ffdea089.js";const j=i("strong",null,"Since version 1.21.0",-1),$=i("p",null,[e("It is possible to open a particular tab programmatically via "),i("code",null,"v-model"),e(" or "),i("code",null,"model-value"),e(".")],-1),B={class:"ml2"},P=i("p",null,[e("Like in most components, you can set a "),i("code",null,"color"),e(" for the text and a "),i("code",null,"bg-color"),e(` for the
background. You can also set a `),i("code",null,"slider-color"),e(" and an "),i("code",null,"active-class"),e(`.
`)],-1),I=i("div",{class:"title3"},"Color & bg-color",-1),U=i("div",{class:"title3 mt4"},"Slider color",-1),E=i("div",{class:"title3"},"Active class",-1),N=i("p",null,"Change tab to see the transition.",-1),W=i("p",null,`The tabs will naturally try to fit in the available space. But if they can't fit because there are
too many, a scrollbar will allow navigation to all the tabs.`,-1),F=i("code",null,"@click.stop",-1),K={class:"green"},D={class:"pink mx1"},L=i("div",{class:"title3"},"This is a custom tab content.",-1),M=["innerHTML"],Y=i("p",null,[e("You can add extra elements at the right of the tabs title bar via the "),i("code",null,"tabs-bar-extra"),e(" slot.")],-1),H=i("p",null,[e("By default there is no data watcher on the tabs title to recalculate the slider width or position."),i("br"),e(`
...
`)]),default:t(()=>[n(b,{items:a.tabs1},null,8,["items"])]),_:1}),n(c,{h2:""},{default:t(()=>[e("Align center and right")]),_:1}),n(r,null,{pug:t(()=>[e(`w-tabs(:items="tabs" center)
br
...
`)]),default:t(()=>[n(b,{items:a.tabs4.items,center:""},null,8,["items"]),n(b,{class:"mt4",items:a.tabs4.items,right:""},null,8,["items"])]),_:1}),n(c,{h2:""},{default:t(()=>[e("Fill bar & disabled items")]),_:1}),n(r,null,{pug:t(()=>[e(`w-switch.mb3(v-model="fillBar") Fill bar
...
`)]),default:t(()=>[n(C,{class:"mb3",modelValue:a.tabs2.fillBar,"onUpdate:modelValue":o[0]||(o[0]=s=>a.tabs2.fillBar=s)},{default:t(()=>[e("Fill bar")]),_:1},8,["modelValue"]),n(b,{items:a.tabs2.items,"fill-bar":a.tabs2.fillBar},null,8,["items","fill-bar"])]),_:1}),n(c,{h2:""},{default:t(()=>[e("V-model")]),_:1}),n(k,{warning:""},{default:t(()=>[j,e(", the v-model/value only accepts a numeric tab index (previously an array of boolean).")]),_:1}),$,n(r,null,{pug:t(()=>[e(`w-tabs(v-model="activeTab" :items="tabs")
strong
  | v-model:
...
`)]),default:t(()=>[n(b,{class:"mb2",modelValue:a.tabs2.active,"onUpdate:modelValue":o[1]||(o[1]=s=>a.tabs2.active=s),items:a.tabs2.items},null,8,["modelValue","items"]),i("strong",null,[e("v-model:"),i("code",B,l(a.tabs2.active),1)])]),_:1}),n(c,{h2:""},{default:t(()=>[e("Colors")]),_:1}),P,I,n(r,null,{pug:t(()=>[e('w-tabs(:items="tabs" color="blue" bg-color="indigo-light5")')]),html:t(()=>[e(`<w-tabs
  :items="tabs"
  color="blue"
...
`)]),default:t(()=>[n(b,{items:a.tabs2.items,color:"blue","bg-color":"indigo-light5"},null,8,["items"])]),_:1}),U,n(r,null,{pug:t(()=>[e('w-tabs(:items="tabs" slider-color="blue-light2")')]),html:t(()=>[e(`<w-tabs
  :items="tabs"
...
`)]),default:t(()=>[n(b,{items:a.tabs2.items,"slider-color":"blue-light2"},null,8,["items"])]),_:1}),E,n(r,null,{pug:t(()=>[e(`w-tabs(
  :items="tabs"
  color="blue"
  active-class="pink"
...
`)]),default:t(()=>[n(b,{items:a.tabs2.items,color:"blue","active-class":"pink","slider-color":"pink"},null,8,["items"])]),_:1}),n(c,{h2:""},{default:t(()=>[e("Pill slider")]),_:1}),n(r,null,{pug:t(()=>[e('w-tabs(:items="tabs" pill-slider)')]),html:t(()=>[e('<w-tabs :items="tabs" pill-slider></w-tabs>')]),js:t(()=>[e(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3', content: 'Tab 3 content.' },
...
`)]),default:t(()=>[n(b,{items:a.tabs2.items,"pill-slider":""},null,8,["items"])]),_:1}),n(c,{h2:""},{default:t(()=>[e("No slider")]),_:1}),n(r,null,{pug:t(()=>[e(`w-switch.mb3(v-model="tabsSlider") Slider
...
`)]),default:t(()=>[n(S,{class:"mb3","align-center":""},{default:t(()=>[e("Number of tabs:"),n(u,{class:"mx2",icon:"wi-minus",sm:"",onClick:o[4]||(o[4]=s=>a.tabs3.tabsCount-=a.tabs3.tabsCount<1?0:1)}),i("code",null,l(a.tabs3.tabsCount),1),n(u,{class:"mx2",icon:"wi-plus",sm:"",onClick:o[5]||(o[5]=s=>a.tabs3.tabsCount++)})]),_:1}),n(b,{items:a.tabs3.tabsCount},{"item-title":t(({index:s})=>[e("Tab "+l(s),1)]),"item-content":t(({index:s})=>[e("Content "+l(s),1)]),_:1},8,["items"])]),_:1}),n(c,{h2:""},{default:t(()=>[e("Card style tabs")]),_:1}),n(r,null,{pug:t(()=>[e('w-tabs(:items="tabs" card)')]),html:t(()=>[e('<w-tabs :items="tabs" card></w-tabs>')]),js:t(()=>[e(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3 has a long title', content: 'Tab 3 content.' }
...
`)]),default:t(()=>[n(b,{items:a.tabs1,card:""},null,8,["items"])]),_:1}),n(c,{h2:""},{default:t(()=>[e("Close button")]),_:1}),n(k,{tip:""},{default:t(()=>[e("When using a close button, don't forget to stop the click propagation "),F,e(` to prevent
...
`)]),default:t(()=>[n(b,{items:a.tabs6.items,card:""},{"item-title":t(({item:s,index:h})=>[e(l(s.title),1),n(u,{class:"ml1 mr-1",onClick:V(at=>a.tabs6.items.splice(h-1,1),["stop"]),icon:"wi-cross",outline:"",xs:""},null,8,["onClick"])]),_:1},8,["items"]),n(u,{class:"mt4","bg-color":"primary",onClick:o[6]||(o[6]=s=>a.tabs6.items=a.tabs6.originals.slice(0)),disabled:a.tabs6.items.length===3},{default:t(()=>[e("Reset tabs")]),_:1},8,["disabled"])]),_:1}),n(c,{h2:""},{default:t(()=>[e("Customizing the tabs title & contents")]),_:1}),n(r,null,{pug:t(()=>[e(`w-tabs(:items="tabs" card)
...
`)]),default:t(()=>[n(b,{items:a.tabs5,card:""},{"item-title":t(({item:s})=>[n(p,{class:"mr1 green"},{default:t(()=>[e("mdi mdi-star")]),_:1}),i("span",K,l(s.title),1)]),"item-title.3":t(({item:s})=>[n(p,{class:"pink"},{default:t(()=>[e("mdi mdi-heart")]),_:1}),i("span",D,l(s.title),1),n(p,{class:"pink"},{default:t(()=>[e("mdi mdi-heart")]),_:1})]),"item-content.1":t(({item:s})=>[L,i("div",{innerHTML:s.content},null,8,M)]),_:1},8,["items"])]),_:1}),n(c,{h2:""},{default:t(()=>[e("Adding a tabs bar extra element")]),_:1}),Y,n(r,null,{pug:t(()=>[e(`w-tabs(ref="tabs" :items="tabs.tabsCount" v-model="tabs.currentTab")
...
`)]),default:t(()=>[n(b,{ref:"tabs",items:a.tabs7.tabsCount,modelValue:a.tabs7.currentTab,"onUpdate:modelValue":o[8]||(o[8]=s=>a.tabs7.currentTab=s)},{"item-title":t(({index:s})=>[e("Item title "+l(s),1)]),"item-content":t(({index:s})=>[e("Item content "+l(s),1)]),"tabs-bar-extra":t(()=>[n(u,{class:"bdrsr mr2",icon:"wi-plus",onClick:o[7]||(o[7]=s=>{a.tabs7.tabsCount++,a.tabs7.currentTab=a.tabs7.tabsCount-1})})]),_:1},8,["items","modelValue"])]),_:1}),n(c,{h2:""},{default:t(()=>[e("Refreshing the slider width or position")]),_:1}),H,n(r,null,{pug:t(()=>[e(`w-tabs(ref="tabs" :items="tabs")
