import{n as s,w as r}from"./index.052c2afa.js";import"./vendor.4f8da9ec.js";var c=function(){var e=this,n=e.$createElement,t=e._self._c||n;return t("div",[e._m(0),t("title-link",{attrs:{h2:""}},[e._v("Overlay with custom opacity and control on "),t("span",{staticClass:"code"},[e._v("persistent")])]),t("p",[e._v("When the overlay is persistent, it will not close on click and on escape key.")]),t("p",[e._v("When persistent is set to false and by default, the escape key will also close the overlay.")]),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-flex wrap>
  ...
  <div>
    ...
    <w-button
      ...
      sm
      dark>
      :persistent-no-animation="`+e._s(e.persistentNoAnimation)+`"
    </w-button>
