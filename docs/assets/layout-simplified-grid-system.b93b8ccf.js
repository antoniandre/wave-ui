import{r as t,o as r,f as a,a as s,w as o,b as n,F as i,j as u,d as e,_ as m}from"./index.22bb3915.js";const g=e("code",null,"gap",-1),b=e("code",null,"wrap",-1),h=e("br",null,null,-1),w=e("br",null,null,-1),x=e("strong",{class:"code"},"w-grid",-1),v=e("strong",{class:"code"},"w-flex",-1),y=e("br",null,null,-1),k=e("br",null,null,-1),S=e("strong",{class:"code"},"w-flex",-1),C=e("p",null,[n("The "),e("strong",{class:"code"},"w-grid"),n(` component is very straightforward, you need to define a number of column
...
per breakpoint.`)],-1),N={class:"box"};function V(F,H){const l=t("title-link"),_=t("router-link"),f=t("alert"),d=t("w-grid"),c=t("example");return r(),a("main",null,[s(l,{class:"mt4",h1:""},{default:o(()=>[n("Simplified grid system (CSS grids)")]),_:1}),s(f,{info:""},{default:o(()=>[n(`The 12-cell based flexbox grid system works well and for most cases, but it has
...
.box {
  ...
  border: 1px solid #b2c2f0;
  padding: 12px;
}`)]),default:o(()=>[s(d,{class:"wrapper",columns:{xs:1,sm:2,md:3,lg:4,xl:6},gap:"3"},{default:o(()=>[(r(),a(i,null,u(12,p=>e("div",N)),64))]),_:1})]),_:1})])}const j={},E=m(j,[["render",V]]);export{E as default};
