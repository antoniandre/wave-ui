import{N as e,U as t,c as n,d as r,g as i,gt as a,h as o,k as s,yt as c}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as l}from"./_plugin-vue_export-helper-S3RvzygF.js";import{H as u}from"./index-CKcZQ2YR.js";var d={class:`mt3`},f={class:`ml1`},p={class:`mt3`},m={class:`ml1`},h={class:`mt3`},g={class:`ml1`},_={class:`mt3`},v={class:`ml1`},y={class:`ml1`};function b(l,u,b,x,S,C){let w=e(`alert`),T=e(`title-link`),E=e(`w-accordion`),D=e(`example`),O=e(`w-button`),k=e(`w-icon`),A=e(`w-alert`),j=e(`w-tag`),M=e(`w-list`),N=e(`w-accordion-item`);return s(),r(`div`,null,[i(w,{info:``},{default:t(()=>[...u[7]||=[n(`p`,null,`Two components are available:`,-1),n(`ul`,null,[n(`li`,null,[n(`strong`,{class:`code`},`w-accordion`),o(`: The root accordion component.`)]),n(`li`,{class:`mt2`},[n(`strong`,{class:`code`},`w-accordion-item`),o(`: An optional component if you don't need / prefer not to use
