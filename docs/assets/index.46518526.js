import{r as c,o as h,e as m,f as r,w as e,g as l,h as _,v as D,i as t,N as k}from"./vendor.e64646cc.js";import{_ as b,m as C}from"./index.90e40c3f.js";const $=t("Basic"),T=t("Open drawer"),P=t(`w-button(@click="openDrawer = true" outline) Open drawer
...
`),S=t("Positions"),j=t("Open left drawer"),A=t("Open right drawer"),R=t("Open top drawer"),B=t("Open bottom drawer"),L=t(`w-button.ma1(
...
`),q=t("Control width or height"),F=k(`<p>The <strong class="code">w-drawer</strong> component accepts a <span class="code">width</span> or <span class="code">height</span> parameter
...
anything until you accept.`,-1),Se=t("Show the cookie notice"),je={class:"w-flex pa2 align-center wrap"},Ae={class:"w-flex align-center py1"},Re=t("wi-info-circle"),Be=l("span",{class:"grey-dark3"},`Our website uses cookies to give you the best user experience.
