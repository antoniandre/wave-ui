import{N as e,U as t,c as n,d as r,g as i,h as a,k as o,yt as s}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as c}from"./_plugin-vue_export-helper-S3RvzygF.js";import{i as l}from"./index-BJr8b_n6.js";function u(c,l,u,d,f,p){let m=e(`title-link`),h=e(`w-timeline`),g=e(`example`),_=e(`w-icon`),v=e(`w-tag`);return o(),r(`div`,null,[i(m,{h2:``},{default:t(()=>[...l[0]||=[a(`Basic`,-1)]]),_:1}),i(g,null,{pug:t(()=>[...l[1]||=[a(`w-timeline(:items="items")`,-1)]]),html:t(()=>[...l[2]||=[a(`<w-timeline :items="items"></w-timeline>`,-1)]]),js:t(()=>[...l[3]||=[a(`data: () => ({
  items: [
