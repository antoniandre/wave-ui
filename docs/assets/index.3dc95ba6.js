var $=Object.defineProperty;var F=Object.getOwnPropertySymbols;var j=Object.prototype.hasOwnProperty,A=Object.prototype.propertyIsEnumerable;var I=(o,s,c)=>s in o?$(o,s,{enumerable:!0,configurable:!0,writable:!0,value:c}):o[s]=c,_=(o,s)=>{for(var c in s||(s={}))j.call(s,c)&&I(o,c,s[c]);if(F)for(var c of F(s))A.call(s,c)&&I(o,c,s[c]);return o};import{a as T}from"./index.a0a717ed.js";import{r,o as g,e as y,f as t,w as n,g as i,t as p,i as e,N as v}from"./vendor.e64646cc.js";import{_ as x,r as L,F as D}from"./index.2577f3ac.js";const U=e("Default"),M=i("p",null,[e("By default the "),i("span",{class:"code"},"w-input"),e(` component has a label inside the input field, that moves up
...
`),G=e("Outline"),X=e(`w-input.mb6(label="Outline" outline)
w-input.mb3(placeholder="Outline" outline)
w-input.mb3(label="Outline" color="info" outline)
w-input.mb3(label="Outline" bg-color="blue-light5" outline)`),K=e(`<w-input
  class="mb6"
  label="Outline"
  outline>
</w-input>
...
label click.`),Pe=i("br",null,null,-1),Se=e(`
The `),ke=i("span",{class:"code"},"label",-1),Fe=e(` prop is here for this purpose and accepts any HTML.
...
`)],-1),Oe=e("mdi mdi-arrow-right"),$e=i("span",{class:"purple mx1"},"Inside",-1),je=e("mdi mdi-arrow-left"),Ae=i("span",{class:"green mr1"},"Left",-1),De=e("mdi mdi-arrow-right"),Ue=e("mdi mdi-arrow-left"),Me=i("span",{class:"red ml1"},"Right",-1),Ve=e(`w-input.mb3(label-position="inside" outline)
...
`),Ge=e("File input"),Xe=e("A "),Ke=i("strong",{class:"code mx1"},"w-input",-1),Qe=e(" field only needs a "),Ze=i("code",null,'type="file"',-1),en=e(" to become a file input."),nn=i("p",null,[e("By default, the file input will show a preview of the image you are uploading."),i("br"),e(`
...
a file, or you can provide a files array that you keep in sync with Wave UI.`,-1),Sn=e("Via @input"),kn=e("File"),Fn={class:"mt3"},In=e(`w-input(type="file" @input="onFileInput") File
...
`),Rn=e("Via v-model"),On=i("p",null,[e("The v-model can be used to access the files added by the user."),i("br")],-1),$n=i("strong",null,"Important",-1),jn=i("br",null,null,-1),An=e(`Even if a v-model is allowing a two-way binding,
...
the use of `),i("code",null,"FormData"),e(" and using the same HTML as the previous example.")],-1),Xn=e(`import axios from 'axios'
...
`),Kn=i("p",null,`Here is an example of a very minimalist way to receive and display the file on server side
...
type of input.`)],-1),wt=i("h3",null,"Textual inputs",-1),_t={class:"input-types"},gt=i("div",{class:"code mb1"},'type="date"',-1),yt=e("date"),vt={class:"mt4"},xt=i("div",{class:"code mb1"},'type="email"',-1),Pt=e("Email address"),St={class:"mt4"},kt=i("div",{class:"code mb1"},'type="number"',-1),Ft=e("Age"),It={class:"mt4"},Tt=i("div",{class:"code mb1"},'type="password"',-1),Lt=e("Password"),Rt={class:"mt4"},Ot=i("div",{class:"code mb1"},'type="search"',-1),$t=e("Search"),jt={class:"mt4"},At=i("div",{class:"code mb1"},'type="tel"',-1),Dt=e("Tel"),Ut={class:"mt4"},Mt=i("div",{class:"code mb1"},'type="text"',-1),Vt=e("Text"),qt={class:"mt4"},Et=i("div",{class:"code mb1"},'type="time"',-1),Ht=e("time"),Bt={class:"mt4"},Ct=i("div",{class:"code mb1"},'type="url"',-1),Nt=e("Url"),Wt={class:"mt4"},Yt=i("span",{class:"code mb1 mr2"},'type="hidden"',-1),zt=e("The hidden type is also accepted - but you don't need a "),Jt=i("span",{class:"code"},"w-input",-1),Gt=e(" for that!"),Xt=e(`<ul.input-types>
  <li>
    <.code.mb1 type="date"<
  ...
  <li>
    ...
    <w-input(type="hidden")<`),Kt=e(`<ul class="input-types">
  <li>
