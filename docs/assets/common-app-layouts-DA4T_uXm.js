import{A as e,G as t,P as n,c as r,d as i,g as a,h as o}from"./runtime-core.esm-bundler-CLfruy3s.js";import{t as s}from"./_plugin-vue_export-helper-B80Cc4Ui.js";var c={class:`mt6`},l={class:`mt2`},u={class:`mt2`};function d(s,d){let f=n(`title-link`),p=n(`alert`),m=n(`ssh-pre`),h=n(`w-accordion-item`),g=n(`w-accordion`),_=n(`example`),v=n(`w-badge`),y=n(`w-flex`),b=n(`router-link`);return e(),i(`main`,null,[a(f,{class:`mt4`,h1:``},{default:t(()=>[...d[0]||=[o(`Common app layouts`,-1)]]),_:1}),d[63]||=r(`p`,null,[o(`Wave UI places a `),r(`span`,{class:`code`},`.w-app`),o(` wrapping class at the root of your app.
