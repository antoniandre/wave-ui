import{A as e,G as t,K as n,P as r,c as i,d as a,g as o,h as s,m as c,vt as l,xt as u}from"./runtime-core.esm-bundler-BuLlhxCm.js";import{t as d}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{O as f,X as p}from"./index-DR7O6uV_.js";var m={class:`py12 w-flex column align-center justify-center`},h={class:`py12 w-flex column align-center justify-center`},g={class:`w-flex pa2 align-center wrap`},_={class:`w-flex align-center py1`},v={class:`w-flex align-center justify-center fill-height`};function y(d,f,y,b,x,S){let C=r(`title-link`),w=r(`w-button`),T=r(`example`),E=r(`w-drawer`),D=r(`w-card`),O=r(`w-icon`),k=r(`ssh-pre`);return e(),a(`div`,null,[o(C,{h2:``},{default:t(()=>[...f[29]||=[s(`Basic`,-1)]]),_:1}),o(T,{"content-class":`w-flex align-center wrap`},{pug:t(()=>[...f[31]||=[s(`w-button(@click="openDrawer = true" outline) Open drawer
