...
`),W=s("Progress value with label"),F=c(()=>r("p",null,[s("The default label displays the rounded value without the "),r("code",null,"%"),s(" sign, so it fits in smaller circles.")],-1)),Y=c(()=>r("p",null,"You can customize the label to display the value as you wish.",-1)),Z=c(()=>r("p",null,"Default label \xA0 - \xA0 Custom label",-1)),q=s(`p Default label - Custom label
...
`),J=c(()=>r("h3",null,"Providing a color for the custom label",-1)),K=s(`w-progress.ma1(
  ...
  size="3em"
  label
  label-color="indigo-light4")`),Q=s(`<w-progress
  class="ma1"
  circle
  model-value="38"
  size="3em"
...
`),X=s("Round linecap & default flat line cap"),ee=s(`w-progress.ma1(circle model-value="38" size="6em" round-cap)
