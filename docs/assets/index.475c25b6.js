...
`)]},proxy:!0}])},[t("w-checkboxes",{attrs:{items:e.checkboxes3,color:"green"},scopedSlots:e._u([{key:"item",fn:function(c){var n=c.item;return[t("span",{staticClass:"pr2"},[e._v(e._s(n.label))]),t("w-icon",{staticClass:"deep-purple"},[e._v(e._s(n.icon))])]}}])})],1),t("div",{staticClass:"w-divider grey-light5 my12"}),t("title-link",{attrs:{h2:""}},[e._v("Round checkboxes")]),t("example",{attrs:{"content-class":"mt3"},scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-checkboxes
  v-model="selection"
  :items="checkboxes"
  round
  inline>
