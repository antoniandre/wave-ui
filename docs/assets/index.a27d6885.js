...
`),N=s("h3",null,"Mix background and text colors",-1),E=s("p",null,[o("Like in most components, you can set a "),s("code",null,"color"),o(" for the text and a "),s("code",null,"bg-color"),o(` for the
background.`)],-1),R=o("success"),W=o("error"),H=o("warning"),M=o(`w-button.ma1(bg-color="success" color="yellow-light2") success
...
`),q=_(`<h3>Dark</h3><p>By default the <code>primary</code> color is considered dark as well as the four status colors:
...
For the rest you can use the <code>dark</code> prop or set the <code>color</code> prop to \`white\`.</p>`,2),F=o("normal"),j=o("mdi mdi-arrow-right"),J=o("dark"),K=o(`w-button.ma1(bg-color="primary-light3") normal
...
`),U=o("Sizes"),X=_(`<p>The button size can be controlled via the preset sizes <code>xs</code>, <code>sm</code>, <code>md</code>,
...
`),_o=s("h3",null,"Stretch to the available space",-1),go=o("primary"),wo=o(`w-flex
...
`),Po=o("Text"),Bo=o("extra small"),Go=o("small"),Vo=o("medium"),No=o("large"),Eo=o("extra large"),Ro=o("disabled"),Wo=o(`w-button.ma1(color="primary" text xs) extra small
...
`),Mo=o("Round & tile"),Oo=o("round"),qo=o("round"),Fo=o("tile"),jo=o("tile"),Jo=o(`w-button.ma1(bg-color="primary" round) round
...
`),dt=o("Loading spinner & custom loader"),ut=o("wi-check"),mt=o("Save"),bt=o("wi-check"),ht=o("Save"),_t=o("Loading..."),gt=o(`w-button.ma1(
  bg-color="primary"
...
`),ft=o("Links"),yt=_(`<p>If you are using Vue Router, all the links will automatically be <strong class="code">router-link</strong>s
