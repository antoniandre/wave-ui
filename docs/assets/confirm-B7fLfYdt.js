import{N as e,U as t,c as n,d as r,g as i,gt as a,h as o,k as s,m as c,u as l,yt as u}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as d}from"./_plugin-vue_export-helper-S3RvzygF.js";import{M as f}from"./index-CKcZQ2YR.js";var p={class:`w-flex wrap`},m={class:`w-flex align-center my4`},h={class:`w-flex justify-end align-center`};function g(d,f,g,_,v,y){let b=e(`alert`),x=e(`title-link`),S=e(`w-confirm`),C=e(`example`),w=e(`w-flex`),T=e(`w-icon`),E=e(`w-input`),D=e(`w-transition-slide-fade`),O=e(`w-card`);return s(),r(`div`,null,[i(b,{info:``},{default:t(()=>[...f[5]||=[n(`ul`,null,[n(`li`,null,[o(`The purpose of the `),n(`strong`,{class:`code`},`w-confirm`),o(` component is to quickly set up a
