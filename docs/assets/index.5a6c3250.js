import{r as l,o as b,f as g,a as n,w as s,b as t,h as v,e,c as k,d as L,M as y}from"./vendor.34d201f5.js";import{_ as q,n as C}from"./index.c056c3d3.js";const I=t("ul",null,[t("li",{class:"title5"},[e("The "),t("span",{class:"code"},"w-form"),e(" component is used for validation.")]),t("li",null,[e("A "),t("span",{class:"code"},"w-form"),e(` is invisible and has no style by default. You can put it in a
...
})`),Y={class:"mt6 title4"},P=e("Wrap the field in a "),N=t("span",{class:"code"},"w-form",-1),W=e(" and add a submit button"),J=e(`<w-form>
...
value (or v-model) to `),t("code",null,"null"),e(", like pristine.")],-1),Fe={class:"text-right mt6"},Ue=e("Reset"),je=e("Validate"),Le=e(`<w-form v-model="valid">
  <w-input
    label="First name"
    :validators="[validators.required]">
  </w-input>
...
`),Pe=t("code",null,"success",-1),Ne=e(" events return the "),We=t("span",{class:"code"},"errorsCount",-1),Je=e("."),He=t("br",null,null,-1),ze=e(`
...
`),Vt=e("Asynchronous validations"),kt=t("p",null,"You may want to validate a field on server side, for this you can use an asynchronous validator.",-1),Ct=e("You should first be familiar with Promises and "),St=t("span",{class:"code"},"async",-1),At=e("/"),Ft=t("span",{class:"code"},"await",-1),Ut=e(`.
If you're not you can read about it
`),jt=t("a",{href:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function",target:"_blank"},"here",-1),Lt=e("."),It=t("p",null,[e(`This example presents a common case: checking if a username is already in use from a user
