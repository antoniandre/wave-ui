import{N as e,U as t,c as n,d as r,g as i,h as a,j as o,k as s,l as c,r as l,yt as u}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as d}from"./_plugin-vue_export-helper-S3RvzygF.js";import{t as f}from"./form-elements-dhQrrM2Q.js";import{p}from"./index-CKcZQ2YR.js";var m={class:`ml2`},h={class:`ml2`},g={class:`ml2`},_={key:1,class:`px2`},v={class:`ml1`};function y(d,f,p,y,b,x){let S=e(`alert`),C=e(`title-link`),w=e(`w-select`),T=e(`example`),E=e(`w-flex`),D=e(`w-icon`),O=e(`w-tag`);return s(),r(`div`,null,[i(S,{info:``},{default:t(()=>[...f[4]||=[a(`The `,-1),n(`span`,{class:`code`},`w-select`,-1),a(` component can be placed in a hidden overflow container and the dropdown
...
`,-1)]]),_:1}),i(C,{h2:``},{default:t(()=>[...f[5]||=[a(`Basic`,-1)]]),_:1}),f[118]||=n(`p`,null,[a(`This is the most basic use of the `),n(`span`,{class:`code`},`w-select`),a(` component. No label, no v-model, only items.`)],-1),i(T,null,{pug:t(()=>[...f[6]||=[a(`w-select(:items="items")`,-1)]]),html:t(()=>[...f[7]||=[a(`<w-select :items="items"></w-select>`,-1)]]),js:t(()=>[...f[8]||=[a(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`,-1)]]),default:t(()=>[i(w,{items:d.items1},null,8,[`items`])]),_:1}),i(C,{h2:``},{default:t(()=>[...f[9]||=[a(`Label and / or placeholder`,-1)]]),_:1}),f[119]||=n(`p`,null,[a(`The select list can have a label or not and a placeholder or not.`),n(`br`)],-1),i(T,null,{pug:t(()=>[...f[10]||=[a(`w-select(:items="items" label="Label")
w-select.mt4(:items="items" placeholder="Placeholder")
w-select.mt4(:items="items" label="Label" placeholder="Placeholder")`,-1)]]),html:t(()=>[...f[11]||=[a(`<w-select
  :items="items"
  label="Label">
</w-select>
...
`,-1)]]),default:t(()=>[i(w,{items:d.items1,label:`Label`},null,8,[`items`]),i(w,{class:`mt4`,items:d.items1,placeholder:`Placeholder`},null,8,[`items`]),i(w,{class:`mt4`,items:d.items1,label:`Label`,placeholder:`Placeholder`},null,8,[`items`])]),_:1}),i(S,{tip:``},{default:t(()=>[...f[13]||=[a(`The items of the select list should have a label, which is by default expected in each item
...
`,-1)]]),_:1}),i(C,{h2:``},{default:t(()=>[...f[14]||=[a(`Outline`,-1)]]),_:1}),i(T,null,{pug:t(()=>[...f[16]||=[a(`w-select(:items="items" outline) Label`,-1)]]),html:t(()=>[...f[17]||=[a(`<w-select :items="items" outline>Label</w-select>`,-1)]]),js:t(()=>[...f[18]||=[a(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`,-1)]]),default:t(()=>[i(w,{items:d.items1,outline:``},{default:t(()=>[...f[15]||=[a(`Label`,-1)]]),_:1},8,[`items`])]),_:1}),i(C,{h2:``},{default:t(()=>[...f[19]||=[a(`Colors`,-1)]]),_:1}),f[120]||=n(`p`,{class:`mb4`},[a(`Like in most components, you can set a `),n(`code`,null,`color`),a(` for the text and a `),n(`code`,null,`bg-color`),a(` for the
background.`),n(`br`),a(`
By default, the text has the "`),n(`span`,{class:`code`},`primary`),a(`" color.`)],-1),i(C,{h3:``,slug:`default-style`},{default:t(()=>[...f[20]||=[a(`Default style (Underline)`,-1)]]),_:1}),i(T,null,{pug:t(()=>[...f[23]||=[a(`w-select(:items="items" color="blue") Label
w-select.mt4(:items="items" bg-color="blue-light5" color="blue-dark3") Label`,-1)]]),html:t(()=>[...f[24]||=[a(`<w-select
  :items="items"
  color="blue">
  Label
</w-select>
...
`,-1)]]),default:t(()=>[i(w,{items:d.items1,color:`blue`},{default:t(()=>[...f[21]||=[a(`Label`,-1)]]),_:1},8,[`items`]),i(w,{class:`mt4`,items:d.items1,"bg-color":`blue-light5`,color:`blue-dark3`},{default:t(()=>[...f[22]||=[a(`Label`,-1)]]),_:1},8,[`items`])]),_:1}),i(C,{h3:``},{default:t(()=>[...f[26]||=[a(`Outline style`,-1)]]),_:1}),i(T,null,{pug:t(()=>[...f[29]||=[a(`w-select(:items="items" outline color="blue") Label
w-select.mt4(:items="items" outline bg-color="blue-light5" color="blue-dark3") Label`,-1)]]),html:t(()=>[...f[30]||=[a(`<w-select
  :items="items"
  outline
  color="blue">
  Label
...
`,-1)]]),default:t(()=>[i(w,{items:d.items1,outline:``,color:`blue`},{default:t(()=>[...f[27]||=[a(`Label`,-1)]]),_:1},8,[`items`]),i(w,{class:`mt4`,items:d.items1,outline:``,"bg-color":`blue-light5`,color:`blue-dark3`},{default:t(()=>[...f[28]||=[a(`Label`,-1)]]),_:1},8,[`items`])]),_:1}),i(C,{h3:``},{default:t(()=>[...f[32]||=[a(`List items colors`,-1)]]),_:1}),f[121]||=n(`p`,null,[a(`If an item object contains the key `),n(`code`,null,`color`),a(`, it will naturally be used by the
`),n(`strong`,{class:`code`},`w-select`),a(` component to display this list item in this color.`),n(`br`),a(`
To disable this you can set the `),n(`code`,null,`item-color-key`),a(` prop to an empty string.`)],-1),i(T,null,{pug:t(()=>[...f[34]||=[a(`w-select(:items="items") Pick a color`,-1)]]),html:t(()=>[...f[35]||=[a(`<w-select :items="items">
  Pick a color
</w-select>`,-1)]]),js:t(()=>[...f[36]||=[a(`data: () => ({
  items: [
...
`,-1)]]),default:t(()=>[i(w,{items:d.items4},{default:t(()=>[...f[33]||=[a(`Pick a color`,-1)]]),_:1},8,[`items`])]),_:1}),i(C,{h2:``},{default:t(()=>[...f[37]||=[a(`Shadow`,-1)]]),_:1}),i(T,null,{pug:t(()=>[...f[40]||=[a(`.title4.mb2 Default style (Underline)
w-select(:items="items" shadow) Label

.title4.mt6.mb2 Outline style
w-select(:items="items" outline shadow) Label`,-1)]]),html:t(()=>[...f[41]||=[a(`<div class="title4 mb2">
...
`,-1)]]),default:t(()=>[f[43]||=n(`div`,{class:`title4`},`Default style (Underline)`,-1),i(w,{items:d.items1,shadow:``},{default:t(()=>[...f[38]||=[a(`Label`,-1)]]),_:1},8,[`items`]),f[44]||=n(`div`,{class:`title4 mt6`},`Outline style`,-1),i(w,{items:d.items1,outline:``,shadow:``},{default:t(()=>[...f[39]||=[a(`Label`,-1)]]),_:1},8,[`items`])]),_:1}),i(C,{h2:``},{default:t(()=>[...f[45]||=[a(`Tile & round`,-1)]]),_:1}),i(T,null,{pug:t(()=>[...f[50]||=[a(`.title4 Default style (Underline)
...
w-select.mt4(:items="items" outline round) Round`,-1)]]),html:t(()=>[...f[51]||=[a(`<div class="title4">
  Default style (Underline)
</div>
...
`,-1)]]),default:t(()=>[f[53]||=n(`div`,{class:`title4`},`Default style (Underline)`,-1),i(w,{items:d.items1,"bg-color":`purple-light5`,tile:``},{default:t(()=>[...f[46]||=[a(`Tile`,-1)]]),_:1},8,[`items`]),i(w,{class:`mt4`,items:d.items1,"bg-color":`purple-light5`,round:``},{default:t(()=>[...f[47]||=[a(`Round`,-1)]]),_:1},8,[`items`]),f[54]||=n(`div`,{class:`title4 mt6`},`Outline style`,-1),i(w,{items:d.items1,outline:``,tile:``},{default:t(()=>[...f[48]||=[a(`Tile`,-1)]]),_:1},8,[`items`]),i(w,{class:`mt4`,items:d.items1,outline:``,round:``},{default:t(()=>[...f[49]||=[a(`Round`,-1)]]),_:1},8,[`items`])]),_:1}),i(C,{h2:``},{default:t(()=>[...f[55]||=[a(`Fit to content`,-1)]]),_:1}),i(T,null,{pug:t(()=>[...f[57]||=[a(`w-select(
  :items="items"
  placeholder="Select an item"
  fit-to-content) Fit to content`,-1)]]),html:t(()=>[...f[58]||=[a(`<w-select
  :items="items"
  placeholder="Select an item"
  fit-to-content>
  Fit to content
...
`,-1)]]),default:t(()=>[i(w,{items:d.items5,placeholder:`Select an item`,"fit-to-content":``},{default:t(()=>[...f[56]||=[a(`Fit to content`,-1)]]),_:1},8,[`items`])]),_:1}),i(C,{h2:``},{default:t(()=>[...f[60]||=[a(`Multiple selection`,-1)]]),_:1}),i(T,null,{pug:t(()=>[...f[61]||=[a(`w-select(:items="items" multiple)`,-1)]]),html:t(()=>[...f[62]||=[a(`<w-select :items="items" multiple></w-select>`,-1)]]),js:t(()=>[...f[63]||=[a(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`,-1)]]),default:t(()=>[i(w,{items:d.items1,multiple:``},null,8,[`items`])]),_:1}),i(C,{h2:``},{default:t(()=>[...f[64]||=[a(`V-model`,-1)]]),_:1}),i(S,{tip:``},{default:t(()=>[...f[65]||=[a(`By default, the `,-1),n(`span`,{class:`code`},`w-select`,-1),a(` component expects the items to have a `,-1),n(`code`,null,`model-value`,-1),a(` attribute.`,-1),n(`br`,null,null,-1),a(`
If this is a constraint, you can use the option `,-1),n(`code`,null,`item-value-key`,-1),a(` to specify the name of another
attribute to be used instead (must have a unique value), like an id for instance.`,-1)]]),_:1}),i(T,null,{pug:t(()=>[...f[67]||=[a(`w-select(v-model="selection" :items="items" multiple)
w-flex.align-center.mt4
  span v-model:
  code.ml2 `+u(`{{ selection }}`),-1)]]),html:t(()=>[...f[68]||=[a(`<w-select
  v-model="selection"
  :items="items"
  multiple>
</w-select>
...
`,-1)]]),default:t(()=>[i(w,{modelValue:d.vModelSelect1,"onUpdate:modelValue":f[0]||=e=>d.vModelSelect1=e,items:d.items3,multiple:``},null,8,[`modelValue`,`items`]),i(E,{class:`align-center mt4`},{default:t(()=>[f[66]||=n(`span`,null,`v-model:`,-1),n(`code`,m,u(d.vModelSelect1),1)]),_:1})]),_:1}),i(C,{h3:``},{default:t(()=>[...f[70]||=[a(`Without values (using labels)`,-1)]]),_:1}),f[122]||=n(`p`,null,`If no values are provided in the items objects, the labels will be used to identify the selected items.`,-1),i(T,null,{pug:t(()=>[...f[72]||=[a(`w-select(v-model="selection" :items="items" multiple)
w-flex.align-center.mt4
  span v-model:
  code.ml2 `+u(`{{ selection }}`),-1)]]),html:t(()=>[...f[73]||=[a(`<w-select
  v-model="selection"
  :items="items"
  multiple>
</w-select>
...
`,-1)]]),default:t(()=>[i(w,{modelValue:d.vModelSelect2,"onUpdate:modelValue":f[1]||=e=>d.vModelSelect2=e,items:d.items1,multiple:``},null,8,[`modelValue`,`items`]),i(E,{class:`align-center mt4`},{default:t(()=>[f[71]||=n(`span`,null,`v-model:`,-1),n(`code`,h,u(d.vModelSelect2),1)]),_:1})]),_:1}),i(C,{h3:``},{default:t(()=>[...f[75]||=[a(`Using full objects in v-model`,-1)]]),_:1}),f[123]||=n(`p`,null,[a(`If it's more convenient for you, you can ask the `),n(`span`,{class:`code`},`w-select`),a(` component to return the
...
if you want to prefill the select list.`)],-1),f[124]||=n(`p`,null,null,-1),i(T,null,{pug:t(()=>[...f[77]||=[a(`w-select(v-model="selection" :items="items" multiple return-object)
w-flex.align-center.mt4
  span v-model:
  code.ml2 `+u(`{{ selection }}`),-1)]]),html:t(()=>[...f[78]||=[a(`<w-select
  v-model="selection"
  :items="items"
  multiple
  return-object>
...
`,-1)]]),default:t(()=>[i(w,{modelValue:d.vModelSelect3,"onUpdate:modelValue":f[2]||=e=>d.vModelSelect3=e,items:d.items1,multiple:``,"return-object":``},null,8,[`modelValue`,`items`]),i(E,{class:`align-center mt4`},{default:t(()=>[f[76]||=n(`span`,null,`v-model:`,-1),n(`code`,g,u(d.vModelSelect3),1)]),_:1})]),_:1}),i(C,{h2:``},{default:t(()=>[...f[80]||=[a(`Label position`,-1)]]),_:1}),f[125]||=n(`p`,null,`By default the label is positioned inside, you can also place it on the left or right outside of
the select list.`,-1),i(T,null,{pug:t(()=>[...f[81]||=[a(`w-select(:items="items" label="Select an item")
w-select.mt4(:items="items" label="Select an item" label-position="left")
w-select.mt4(:items="items" label="Select an item" label-position="right")`,-1)]]),html:t(()=>[...f[82]||=[a(`<w-select
  :items="items"
...
`)],-1),i(T,null,{pug:t(()=>[...f[92]||=[a(`w-select(:items="items" label-position="inside" outline)
...
w-select.mt4(:items="items" label-position="right" outline)
  w-icon.orange mdi mdi-arrow-left
  span.red.ml1 Right`,-1)]]),html:t(()=>[...f[93]||=[a(`<w-select
  :items="items"
...
`,-1)]]),default:t(()=>[i(w,{items:d.items1,"label-position":`inside`,outline:``},{default:t(()=>[i(D,{class:`orange`},{default:t(()=>[...f[85]||=[a(`mdi mdi-arrow-right`,-1)]]),_:1}),f[87]||=n(`span`,{class:`purple mx1`},`Inside`,-1),i(D,{class:`orange`},{default:t(()=>[...f[86]||=[a(`mdi mdi-arrow-left`,-1)]]),_:1})]),_:1},8,[`items`]),i(w,{class:`mt4`,items:d.items1,"label-position":`left`,outline:``},{default:t(()=>[f[89]||=n(`span`,{class:`green mr1`},`Left`,-1),i(D,{class:`orange`},{default:t(()=>[...f[88]||=[a(`mdi mdi-arrow-right`,-1)]]),_:1})]),_:1},8,[`items`]),i(w,{class:`mt4`,items:d.items1,"label-position":`right`,outline:``},{default:t(()=>[i(D,{class:`orange`},{default:t(()=>[...f[90]||=[a(`mdi mdi-arrow-left`,-1)]]),_:1}),f[91]||=n(`span`,{class:`red ml1`},`Right`,-1)]),_:1},8,[`items`])]),_:1}),i(C,{h2:``},{default:t(()=>[...f[95]||=[a(`Custom selection string`,-1)]]),_:1}),f[127]||=n(`p`,null,[a(`The selection string is customizable through the `),n(`code`,null,`selection`),a(` slot.`),n(`br`),a(`
For consistency, the name of the provided parameter containing the selected item(s) is `),n(`code`,null,`item`),a(`,
whether you use a multiple or single select list.`)],-1),i(T,null,{pug:t(()=>[...f[96]||=[a(`w-select(:items="items" v-model="selection" multiple)
  template(#selection="{ item }")
    w-tag.mr2(v-for="(item, i) in item" :key="i" bg-color="grey-light4")
      | `+u(`{{ item.label }}`),-1)]]),html:t(()=>[...f[97]||=[a(`<w-select :items="items" v-model="selection" multiple>
  <template #selection="{ item }">
    <w-tag
      class="mr2"
...
`,-1)]]),default:t(()=>[i(w,{items:d.items3,modelValue:d.customSelection,"onUpdate:modelValue":f[3]||=e=>d.customSelection=e,multiple:``},{selection:t(({item:e})=>[(s(!0),r(l,null,o(e,(e,n)=>(s(),c(O,{class:`mr2`,key:n,"bg-color":`grey-light4`},{default:t(()=>[a(u(e.label),1)]),_:2},1024))),128))]),_:1},8,[`items`,`modelValue`])]),_:1}),i(C,{h2:``},{default:t(()=>[...f[99]||=[a(`Custom list items`,-1)]]),_:1}),i(T,null,{pug:t(()=>[...f[101]||=[a(`w-select(:items="items")
  template(#item="{ item, selected }")
    w-icon.primary(v-if="selected") wi-check
    span.px2(v-else)
    span.ml1 `+u(`{{ item.label }}`)+`
    w-tag.ml2(bg-color="grey-light4" xs) `+u(`{{ item.value }}`),-1)]]),html:t(()=>[...f[102]||=[a(`<w-select :items="items">
  <template #item="{ item, selected }">
...
`,-1)]]),default:t(()=>[i(w,{items:d.items3},{item:t(({item:e,selected:o})=>[o?(s(),c(D,{key:0,class:`primary`},{default:t(()=>[...f[100]||=[a(`wi-check`,-1)]]),_:1})):(s(),r(`span`,_)),n(`span`,v,u(e.label),1),i(O,{class:`ml2`,"bg-color":`grey-light4`,xs:``},{default:t(()=>[a(u(e.value),1)]),_:2},1024)]),_:1},8,[`items`])]),_:1}),i(C,{h2:``},{default:t(()=>[...f[104]||=[a(`Inner icons`,-1)]]),_:1}),i(T,null,{pug:t(()=>[...f[105]||=[a(`.title4.mb2 Label outside
...
w-select.mt4(:items="items" label="Select" label-position="inside" outline inner-icon-right="mdi mdi-arrow-down")`,-1)]]),html:t(()=>[...f[106]||=[a(`<div class="title4 mb2">
  Label outside
</div>
...
`,-1)]]),default:t(()=>[f[108]||=n(`div`,{class:`title4 mb2`},`Label outside`,-1),i(w,{items:d.items1,label:`Select`,"label-position":`left`,outline:``,"inner-icon-left":`mdi mdi-star`},null,8,[`items`]),i(w,{class:`mt4`,items:d.items1,label:`Select`,"label-position":`right`,outline:``,"inner-icon-right":`mdi mdi-arrow-down`},null,8,[`items`]),f[109]||=n(`div`,{class:`title4 mt6 mb2`},`Label inside`,-1),i(w,{items:d.items1,label:`Select`,"label-position":`inside`,outline:``,"inner-icon-left":`mdi mdi-star`},null,8,[`items`]),i(w,{class:`mt4`,items:d.items1,label:`Select`,"label-position":`inside`,outline:``,"inner-icon-right":`mdi mdi-arrow-down`},null,8,[`items`])]),_:1}),i(C,{h2:``},{default:t(()=>[...f[110]||=[a(`Disabled & readonly`,-1)]]),_:1}),i(T,null,{pug:t(()=>[...f[111]||=[a(`w-select.mb4(
  :items="items"
...
w-select(
  ...
  outline
  readonly)`,-1)]]),html:t(()=>[...f[112]||=[a(`<w-select
  class="mb4"
  :items="items"
  label="Disabled & empty"
  outline
