...
w-dialog(
  ...
  template(#actions)
    .spacer
    w-button(@click="dialog.show = false") Close`),j=n(`<w-button class="px4" @click="dialog.show = true">
  Open dialog
</w-button>
...
`),L=n("Basic"),W=n("Open dialog"),B=n("Lorem ipsum dolor sit amet consectetur adipisicing elit."),M=s("br",null,null,-1),R=n(`
...
sed ut labore?`),G=s("br",null,null,-1),z=s("br",null,null,-1),Y=n(`
...
beatae ex nihil.`),H=s("br",null,null,-1),J=n(`
...
perspiciatis repellendus. Sunt!`),K=n(`w-button.px4(@click="showDialog = true") Open dialog
...
w-dialog(
  ...
  template(#actions)
    .spacer
    w-button(@click="dialog.show = false" bg-color="error") Close`),Ge=n(`<w-button
  class="px4"
