import{r as c,o as h,f as w,a as t,w as e,b as n,d as o,h as f,n as T,e as D,i as E,_ as g,E as k}from"./index.59a44df4.js";const S=o("ul",null,[o("li",{class:"title4"},[n("The purpose of the "),o("strong",{class:"code"},"w-confirm"),n(` component is to quickly set up a
...
values stay untouched. For that, you can use the `),o("code",null,"disable-prompt"),n(" option.")],-1),H={class:"w-flex align-center my4"},G={class:"w-flex justify-end align-center"};function J(l,r,b,_,y,m){const d=c("alert"),s=c("title-link"),i=c("w-confirm"),a=c("example"),p=c("w-flex"),v=c("w-icon"),x=c("w-input"),A=c("w-transition-slide-fade"),C=c("w-card");return h(),w("div",null,[t(d,{info:""},{default:e(()=>[S]),_:1}),t(s,{h2:""},{default:e(()=>[n("Integrated tooltip")]),_:1}),B,t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n(`w-flex(wrap)
...
`)]),default:e(()=>[o("div",j,[t(i,{class:"ma4",tooltip:"Delete this?"},{default:e(()=>[n("Delete")]),_:1}),t(i,{class:"ma4",tooltip:{label:"Delete this?",bgColor:"error",top:!0,transition:"twist"}},{default:e(()=>[n("Delete")]),_:1})])]),_:1}),t(s,{h2:""},{default:e(()=>[n("Basic")]),_:1}),t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n("w-confirm Delete")]),html:e(()=>[n(`<w-confirm>Delete</w-confirm>
`)]),default:e(()=>[t(i,null,{default:e(()=>[n("Delete")]),_:1})]),_:1}),t(s,{h2:""},{default:e(()=>[n("Icon button")]),_:1}),t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n('w-confirm(icon="mdi mdi-delete")')]),html:e(()=>[n(`<w-confirm icon="mdi mdi-delete">
  Delete
</w-confirm>
`)]),default:e(()=>[t(i,{icon:"mdi mdi-delete"})]),_:1}),t(s,{h2:""},{default:e(()=>[n("Colors")]),_:1}),q,t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n(`w-confirm.mb2(bg-color="success") Ask for confirm
w-confirm.mb2(bg-color="info" color="yellow") Ask for confirm
w-confirm(:menu="{ bgColor: 'indigo-light1', color: 'white' }") Ask for confirm`)]),html:e(()=>[n(`<w-confirm bg-color="success" class="mb2">
  Ask for confirm
</w-confirm>
...
`)]),default:e(()=>[t(i,{class:"mb2","bg-color":"success"},{default:e(()=>[n("Ask for confirm")]),_:1}),t(i,{class:"mb2","bg-color":"info",color:"yellow"},{default:e(()=>[n("Ask for confirm")]),_:1}),t(i,{menu:{bgColor:"indigo-light1",color:"white"}},{default:e(()=>[n("Ask for confirm")]),_:1})]),_:1}),t(s,{h2:""},{default:e(()=>[n("Positions & alignments")]),_:1}),t(s,{h3:""},{default:e(()=>[n("Positions")]),_:1}),t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n(`w-confirm.my5(top) Top
w-confirm.my5(right) Right
w-confirm.my5(bottom) Bottom
w-confirm.my5(left) Left`)]),html:e(()=>[n(`<w-confirm top class="my5">
  Top
</w-confirm>
...
`)]),default:e(()=>[t(i,{class:"my5",top:""},{default:e(()=>[n("Top")]),_:1}),t(i,{class:"my5",right:""},{default:e(()=>[n("Right")]),_:1}),t(i,{class:"my5",bottom:""},{default:e(()=>[n("Bottom")]),_:1}),t(i,{class:"my5",left:""},{default:e(()=>[n("Left")]),_:1})]),_:1}),t(s,{h3:""},{default:e(()=>[n("Alignments")]),_:1}),t(s,{h4:""},{default:e(()=>[n("Horizontal")]),_:1}),t(a,null,{pug:e(()=>[n(`w-flex(justify-center)
...
`)]),default:e(()=>[t(p,{class:"mt12","justify-center":""},{default:e(()=>[t(i,{class:"ma2",top:"","align-left":""},{default:e(()=>[n("Top, align left")]),_:1}),t(i,{class:"ma2",top:""},{default:e(()=>[n("Top, align center")]),_:1}),t(i,{class:"ma2",top:"","align-right":""},{default:e(()=>[n("Top, align right")]),_:1})]),_:1}),t(p,{"justify-center":""},{default:e(()=>[t(i,{class:"ma2",bottom:"","align-left":""},{default:e(()=>[n("Bottom, align left")]),_:1}),t(i,{class:"ma2",bottom:""},{default:e(()=>[n("Bottom, align center")]),_:1}),t(i,{class:"ma2",bottom:"","align-right":""},{default:e(()=>[n("Bottom, align right")]),_:1})]),_:1})]),_:1}),t(s,{h4:""},{default:e(()=>[n("Vertical")]),_:1}),t(a,null,{pug:e(()=>[n(`w-flex.text-center(justify-center)
  div
...
`)]),default:e(()=>[t(p,{class:"text-center","justify-center":""},{default:e(()=>[o("div",null,[t(i,{class:"ma2",left:"","align-top":""},{default:e(()=>[n("Left, align top")]),_:1}),t(i,{class:"ma2",left:""},{default:e(()=>[n("Left, align center")]),_:1}),t(i,{class:"ma2",left:"","align-bottom":""},{default:e(()=>[n("Left, align bottom")]),_:1})]),o("div",null,[t(i,{class:"ma2",right:"","align-top":""},{default:e(()=>[n("Right, align top")]),_:1}),t(i,{class:"ma2",right:""},{default:e(()=>[n("Right, align center")]),_:1}),t(i,{class:"ma2",right:"","align-bottom":""},{default:e(()=>[n("Right, align bottom")]),_:1})])]),_:1})]),_:1}),t(s,{h2:""},{default:e(()=>[n("Persistent")]),_:1}),N,t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n("w-confirm(persistent) Ask for confirm")]),html:e(()=>[n(`<w-confirm persistent>
  Ask for confirm
</w-confirm>
`)]),default:e(()=>[t(i,{persistent:""},{default:e(()=>[n("Ask for confirm")]),_:1})]),_:1}),t(s,{h2:""},{default:e(()=>[n("Inline question")]),_:1}),U,t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n("w-confirm(inline) Ask for confirm")]),html:e(()=>[n(`<w-confirm inline>
  Ask for confirm
</w-confirm>
`)]),default:e(()=>[t(i,{inline:""},{default:e(()=>[n("Ask for confirm")]),_:1})]),_:1}),t(s,{h2:""},{default:e(()=>[n("Custom question")]),_:1}),P,t(s,{h3:"",slug:"using-question-prop"},{default:e(()=>[n("Using the "),$,n(" prop")]),_:1}),t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n(`w-confirm(question="Are you sure you want to delete this?").
  Ask for confirm`)]),html:e(()=>[n(`<w-confirm question="Are you sure you want to delete this?">
  Ask for confirm
</w-confirm>
`)]),default:e(()=>[t(i,{question:"Are you sure you want to delete this?"},{default:e(()=>[n("Ask for confirm")]),_:1})]),_:1}),t(s,{h3:"",slug:"using-question-slot"},{default:e(()=>[n("Using the "),R,n(" slot")]),_:1}),t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n(`w-confirm
  | Ask for confirm
...
`)]),default:e(()=>[t(i,null,{question:e(()=>[n("Are you sure you want to delete this?")]),default:e(()=>[n("Ask for confirm")]),_:1})]),_:1}),t(s,{h2:""},{default:e(()=>[n("Cancel & confirm buttons")]),_:1}),L,t(s,{h3:""},{default:e(()=>[n("Custom buttons labels")]),_:1}),z,t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n(`w-confirm(cancel="No" confirm="Yes").
  Ask for confirm`)]),html:e(()=>[n(`<w-confirm cancel="No" confirm="Yes">
  Ask for confirm
</w-confirm>
`)]),default:e(()=>[t(i,{cancel:"No",confirm:"Yes"},{default:e(()=>[n("Ask for confirm")]),_:1})]),_:1}),t(s,{h3:""},{default:e(()=>[n("No cancel button")]),_:1}),t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n('w-confirm(:cancel="false") Ask for confirm')]),html:e(()=>[n(`<w-confirm :cancel="false">
  Ask for confirm
</w-confirm>
`)]),default:e(()=>[t(i,{cancel:!1},{default:e(()=>[n("Ask for confirm")]),_:1})]),_:1}),t(s,{h3:""},{default:e(()=>[n("Full custom buttons")]),_:1}),I,t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n(`w-confirm(
  inline
...
`)]),default:e(()=>[t(i,{inline:"",cancel:{bgColor:"error-dark1",color:"white",icon:"mdi mdi-close"},confirm:{bgColor:"green-dark1",color:"white",icon:"mdi mdi-check"}},{default:e(()=>[n("Ask for confirm")]),_:1})]),_:1}),t(s,{h3:"",slug:"custom-label-in-object"},{default:e(()=>[n("Custom button label in the "),Y,n(" form")]),_:1}),V,t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n(`w-confirm(
  inline
...
`)]),default:e(()=>[t(i,{inline:"",cancel:{bgColor:"error-dark1",color:"white",label:"No"},confirm:{bgColor:"green-dark1",color:"white",label:"Yes"}},{default:e(()=>[n("Ask for confirm")]),_:1})]),_:1}),t(s,{h2:""},{default:e(()=>[n("No arrow")]),_:1}),F,t(a,{class:"example--no-arrow","content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n(`w-confirm.ma2(no-arrow :menu="{ bgColor: 'blue-light5' }") Bottom
w-confirm.ma2(no-arrow right) Right
w-confirm.ma2.mb12(:menu="{ noPosition: true }") No position`)]),html:e(()=>[n(`<w-confirm
  no-arrow
...
`)]),default:e(()=>[t(i,{class:"ma2","no-arrow":"",menu:{bgColor:"blue-light5"}},{default:e(()=>[n("Bottom")]),_:1}),t(i,{class:"ma2","no-arrow":"",right:""},{default:e(()=>[n("Right")]),_:1}),t(i,{class:"ma2 mb12",menu:{noPosition:!0,appendTo:".example--no-arrow"}},{default:e(()=>[n("No position")]),_:1},8,["menu"])]),_:1}),t(s,{h2:""},{default:e(()=>[n("Transitions")]),_:1}),t(a,null,{pug:e(()=>[n(`w-flex(wrap)
...
`)]),default:e(()=>[t(p,{wrap:""},{default:e(()=>[t(i,{class:"ma1"},{default:e(()=>[n("Default (scale-fade)")]),_:1}),t(i,{class:"ma1",transition:"fade"},{default:e(()=>[n("Fade")]),_:1}),t(i,{class:"ma1",transition:"slide-fade-up"},{default:e(()=>[n("Slide fade up")]),_:1}),t(i,{class:"ma1",transition:"slide-fade-right"},{default:e(()=>[n("Slide fade right")]),_:1}),t(i,{class:"ma1",transition:"slide-fade-down"},{default:e(()=>[n("Slide fade down")]),_:1}),t(i,{class:"ma1",transition:"slide-fade-left"},{default:e(()=>[n("Slide fade left")]),_:1}),t(i,{class:"ma1",transition:"scale"},{default:e(()=>[n("Scale")]),_:1}),t(i,{class:"ma1",transition:"bounce"},{default:e(()=>[n("Bounce")]),_:1}),t(i,{class:"ma1",transition:"twist"},{default:e(()=>[n("Twist")]),_:1})]),_:1})]),_:1}),t(s,{h2:""},{default:e(()=>[n("Events")]),_:1}),O,K,M,t(a,{"content-class":"text-center","app-props-string":"align-center"},{pug:e(()=>[n(`w-confirm(
...
`)]),default:e(()=>[t(i,{onCancel:r[0]||(r[0]=u=>l.$waveui.notify("Canceled.","error")),onConfirm:r[1]||(r[1]=u=>l.$waveui.notify("Confirmed!","success"))},{default:e(()=>[n("Ask for confirm")]),_:1})]),_:1}),t(s,{h2:""},{default:e(()=>[n("Disable prompt")]),_:1}),W,t(a,{"content-class":"w-flex justify-center","app-props-string":"justify-center align-center"},{pug:e(()=>[n(`w-card(title="My user details" style="max-width: 300px")
  ...
  .w-flex.justify-end.align-center
    w-transition-slide-fade(left)
      strong.mr3(v-if="saved" :class="hasEdits ? 'green' : 'grey'") `+f("{{ hasEdits ? 'Saved!' : 'No changes.' }}")+`
    w-confirm(
      ...
      w-icon.mr1 wi-check
      | `+f("{{ hasEdits ? 'Save' : 'OK' }}"),1)]),html:e(()=>[n(`<w-card title="My user details" style="max-width: 300px">
