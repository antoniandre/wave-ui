...
`)],-1);function ht(d,s,g,_,l,c){const o=p("title-link"),r=p("w-table"),h=p("example"),b=p("w-button"),F=p("w-icon"),B=p("w-flex"),L=p("ssh-pre"),V=p("w-tag"),j=p("w-radios"),I=p("alert"),q=p("w-input");return f(),N("div",null,[n(o,{h2:""},{default:t(()=>[e("Basic")]),_:1}),n(h,null,{pug:t(()=>[e('w-table(:headers="table.headers" :items="table.items")')]),html:t(()=>[e(`<w-table
