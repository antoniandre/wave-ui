import{r as i,g as b,o as v,a as l,b as n,w as o,e,_ as f,ad as g}from"./index-C780IYji.js";function x(d,t){const p=i("title-link"),a=i("w-toolbar"),c=i("w-icon"),m=i("w-button"),r=i("example"),s=i("w-card"),w=i("w-flex"),u=i("w-divider");return v(),b("div",null,[l(p,{h2:""},{default:o(()=>t[0]||(t[0]=[e("Simple toolbar with shadow")])),_:1,__:[0]}),l(r,{"content-class":"pa4"},{pug:o(()=>t[5]||(t[5]=[e(`w-toolbar(shadow)
  .title2 Title
  .spacer
  span.ml2 Item 1
  span.ml2 Item 2
