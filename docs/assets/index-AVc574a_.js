import{r,g as d,o as u,a as i,b as o,w as n,e,t as c,_ as w,ac as C}from"./index-CBPNvwPY.js";function k(l,t,f,g,b,p){const s=r("title-link"),m=r("w-timeline"),a=r("example"),h=r("w-icon"),I=r("w-tag");return u(),d("div",null,[i(s,{h2:""},{default:n(()=>t[0]||(t[0]=[e("Basic")])),_:1,__:[0]}),i(a,null,{pug:n(()=>t[1]||(t[1]=[e('w-timeline(:items="items")')])),html:n(()=>t[2]||(t[2]=[e('<w-timeline :items="items"></w-timeline>')])),js:n(()=>t[3]||(t[3]=[e(`data: () => ({
  items: [
...
`)])),default:n(()=>[i(m,{items:l.items1},null,8,["items"])]),_:1}),i(s,{h2:""},{default:n(()=>t[4]||(t[4]=[e("Color")])),_:1,__:[4]}),t[32]||(t[32]=o("p",null,[e("When setting a color through the "),o("code",null,"color"),e(` prop, the color will be applied to both the item
...
`)])),default:n(()=>[i(m,{items:l.items1,color:"green"},null,8,["items"])]),_:1}),i(s,{h3:""},{default:n(()=>t[8]||(t[8]=[e("Different color per item")])),_:1,__:[8]}),t[33]||(t[33]=o("p",null,[e("It is possible to set a different color per item (and override the global "),o("code",null,"color"),e(` prop)
...
`)])),default:n(()=>[i(m,{items:l.items1,icon:"wi-check",color:"green"},null,8,["items"])]),_:1}),i(s,{h3:""},{default:n(()=>t[16]||(t[16]=[e("Different icon per item")])),_:1,__:[16]}),t[35]||(t[35]=o("p",null,[e("It is possible to set a different icon per item (and override the global "),o("code",null,"icon"),e(` prop)
...
`)])),default:n(()=>[i(m,{items:l.items3,color:"primary"},null,8,["items"])]),_:1}),i(s,{h2:""},{default:n(()=>t[20]||(t[20]=[e("Custom item template")])),_:1,__:[20]}),i(a,null,{pug:n(()=>t[23]||(t[23]=[e(`w-timeline(:items="items")
...
`)])),default:n(()=>[i(m,{items:l.items1},{item:n(({item:K,index:y})=>[i(h,null,{default:n(()=>t[21]||(t[21]=[e("wi-check")])),_:1,__:[21]}),t[22]||(t[22]=o("span",{class:"mx2"},"This is the custom item",-1)),i(I,{class:"white grey-light2--bg"},{default:n(()=>[e(c(y),1)]),_:2},1024)]),_:1},8,["items"])]),_:1}),i(s,{h3:""},{default:n(()=>t[26]||(t[26]=[e("Different custom template per item")])),_:1,__:[26]}),i(a,null,{pug:n(()=>t[29]||(t[29]=[e(`w-timeline(:items="items")
  template(#item.3)
