import{r as m,g as w,o as g,a as e,b as l,h as D,w as o,e as t,d as _,n as E,t as u,_ as b,H as x}from"./index-DoO3O3su.js";const S={class:"w-flex wrap"},B={class:"w-flex align-center my4"},j={class:"w-flex justify-end align-center"};function q(a,n,h,y,k,f){const c=m("alert"),s=m("title-link"),i=m("w-confirm"),r=m("example"),d=m("w-flex"),v=m("w-icon"),A=m("w-input"),C=m("w-transition-slide-fade"),T=m("w-card");return g(),w("div",null,[e(c,{info:""},{default:o(()=>n[5]||(n[5]=[l("ul",null,[l("li",null,[t("The purpose of the "),l("strong",{class:"code"},"w-confirm"),t(` component is to quickly set up a
