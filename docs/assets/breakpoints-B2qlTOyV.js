...
`)])),_:1,__:[21]},8,["dark"]),e[41]||(e[41]=u(`<p class="mt6">To use them on a particular breakpoint, the syntax is: <code>.[breakpoint][extend]-[class]</code>, with:</p><ul><li><strong class="code">[breakpoint]</strong> one of: <code>xs</code>, <code>sm</code>, <code>md</code>, <code>lg</code>, <code>xl</code>.</li><li><strong class="code">[extend]</strong> one of <code>u</code> (and up), <code>d</code> (and down) and
<strong>no character</strong> to target only this breakpoint.</li><li><strong class="code">[class]</strong> one of the above CSS class name.</li></ul>`,2)),l(m,{info:""},{default:s(()=>e[22]||(e[22]=[t("Note that "),n("code",null,".xsd-[class]",-1),t(" and "),n("code",null,".xlu-[class]",-1),t(" don't exist since they are the same as "),n("code",null,".xs-[class]",-1),t(" and "),n("code",null,".xl-[class]",-1),t(".")])),_:1,__:[22]}),e[42]||(e[42]=n("p",{class:"mt6"},[t("In these two examples, resize your browser to less than 900px (default "),n("code",null,"md"),t(`) to see see the
...
<div class="text-right smd-text-center">Some text on the right.</div>`)])),default:s(()=>[e[25]||(e[25]=n("div",{class:"text-left smd-text-center"},"Some text on the left.",-1)),e[26]||(e[26]=n("div",{class:"text-center smd-hide"},"Some text in the center.",-1)),e[27]||(e[27]=n("div",{class:"text-right smd-text-center"},"Some text on the right.",-1))]),_:1,__:[25,26,27]}),l(r,null,{pug:s(()=>e[28]||(e[28]=[t(`.w-flex.justify-space-between.smd-column
...
`)])),default:s(()=>[e[30]||(e[30]=n("div",{class:"w-flex justify-space-between smd-column"},[n("span",null,"Some text on the left."),n("span",null,"Some text in the center."),n("span",null,"Some text on the right.")],-1))]),_:1,__:[30]}),l(m,{tip:""},{default:s(()=>[e[32]||(e[32]=t(`If you'd rather not have these CSS layout classes, you can disable them via the
...
`)])),_:1,__:[31]},8,["dark"])]),_:1,__:[32,33,34]}),l(o,{h2:""},{default:s(()=>e[35]||(e[35]=[t("Setting custom breakpoints")])),_:1,__:[35]}),e[43]||(e[43]=n("p",{class:"mt4"},"You can override the default breakpoints values with:",-1)),l(d,{language:"js",dark:a.$store.state.darkMode},{default:s(()=>e[36]||(e[36]=[t(`app.use(WaveUI, {
  breakpoints: {
    xs: 600,
    sm: 900,
    md: 1200,
...
})`)])),_:1,__:[36]},8,["dark"])])}const v={},S=c(v,[["render",w]]);export{S as default};
