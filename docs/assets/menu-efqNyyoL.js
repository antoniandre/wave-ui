import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,xt as s}from"./runtime-core.esm-bundler-BuLlhxCm.js";import{t as c}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{S as l}from"./index-DR7O6uV_.js";var u={class:`mt4`},d={class:`ml1`};function f(c,l,f,p,m,h){let g=n(`title-link`),_=n(`w-button`),v=n(`w-menu`),y=n(`example`),b=n(`w-switch`),x=n(`w-flex`),S=n(`w-toolbar`),C=n(`w-card`),w=n(`w-list`),T=n(`alert`);return e(),i(`div`,null,[a(g,{h2:``},{default:t(()=>[...l[15]||=[o(`Basic`,-1)]]),_:1}),a(y,{class:`example1`,"content-class":`text-center pt5`,"app-classes-string":`align-center`},{pug:t(()=>[...l[18]||=[o(`w-menu
  w-button Show menu
  template(#content)
...
div.mt4
  ...
  code.ml1 `+s(`{{ listSelection || 'none' }}`),-1)]]),html:t(()=>[...l[158]||=[o(`<w-menu
  custom
  hide-on-menu-click
  persistent
  shadow>
...
<div class="mt4">
  ...
  <code class="ml1">`+s(`{{ listSelection || 'none' }}`)+`</code>
...
w-menu(:activator="activator" arrow)
  template(#content)
    | `+s(`{{ activator.includes('dog') ? 'Woof!' : 'Meow!' }}`),-1)]]),html:t(()=>[...l[172]||=[o(`<w-button
  icon="mdi mdi-cat"
  xl
...
w-menu(:activator="activator" arrow show-on-hover :delay="100")
  template(#content)
    | `+s(`{{ menuContent }}`),-1)]]),html:t(()=>[...l[177]||=[o(`<w-button
  icon="mdi mdi-cat"
  xl
  class="pet-button cat-button ma4"
  @mouseenter="activator = '.cat-button';menuContent = 'Meow!'"
