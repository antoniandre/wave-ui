import{n as o}from"./index.e31dd236.js";var l=function(){var n=this,e=n.$createElement,t=n._self._c||e;return t("main",[t("title-link",{staticClass:"mt4",attrs:{h1:""}},[n._v("Transitions")]),t("p",[n._v("Here is a list of all the available transition components.")]),n._m(0),t("alert",{attrs:{info:""}},[n._v(`The transitions (based on
...
work with element toggling using `),t("code",[n._v("v-if")]),n._v(" or "),t("code",[n._v("v-show")]),n._v("."),t("br"),n._v("Simple example (with "),t("code",[n._v("show")]),n._v(" a boolean variable):"),t("div",{staticClass:"w-flex"},[t("ssh-pre",{directives:[{name:"show",rawName:"v-show",value:n.$store.state.usePug,expression:"$store.state.usePug"}],staticClass:"mb0",attrs:{language:"pug",label:"Pug"}},[n._v(`w-transition-fade
  span(v-if="show") Hello!`)]),t("ssh-pre",{directives:[{name:"show",rawName:"v-show",value:!n.$store.state.usePug,expression:"!$store.state.usePug"}],staticClass:"mb0",attrs:{language:"html-vue"}},[n._v(`<w-transition-fade>
...
`)]},proxy:!0}])},[t("div",{staticStyle:{height:"90px",overflow:"hidden",padding:"4px"}},[t("w-button",{staticClass:"mb2",on:{click:function(i){n.showCard=!n.showCard}}},[n._v(n._s(n.showCard?"Hide":"Show")+" Card")]),t("w-transition-slide",{attrs:{left:""}},[n.showCard?t("w-card",{staticClass:"primary-light3--bg white sliding-card"},[t("div",{staticClass:"title3 mb0"},[n._v("A sliding card.")])]):n._e()],1)],1)]),t("title-link",{attrs:{h2:""}},[n._v("Transition duration")]),n._m(3),n._m(4),t("alert",{staticClass:"mt12",attrs:{warning:""}},[n._v("Be aware that when using "),t("code",[n._v("v-if")]),n._v(`, the transitions unmount components as soon as the
transition starts the leave phase (`),t("code",[n._v("@before-leave")]),n._v(" and not "),t("code",[n._v("@after-leave")]),n._v(`).
`),t("br"),n._v("This is by design in Vue:"),t("a",{staticClass:"ml1",attrs:{href:"https://github.com/vuejs/core/issues/994"}},[n._v("Unmounted hooks should run with afterLeave (#994)"),t("w-icon",{staticClass:"ml1"},[n._v("mdi mdi-open-in-new")])],1)])],1)},s=[function(){var n=this,e=n.$createElement,t=n._self._c||e;return t("ul",[t("li",[t("code",[n._v("w-transition-fade")])]),t("li",{staticClass:"mt1"},[t("code",[n._v("w-transition-scale")])]),t("li",{staticClass:"mt1"},[t("code",[n._v("w-transition-scale-fade")])]),t("li",{staticClass:"mt1"},[t("code",[n._v("w-transition-bounce")])]),t("li",{staticClass:"mt1"},[t("code",[n._v("w-transition-twist")])]),t("li",{staticClass:"mt1"},[t("code",[n._v("w-transition-expand")])]),t("li",{staticClass:"mt1"},[t("code",[n._v("w-transition-slide")])]),t("li",{staticClass:"mt1"},[t("code",[n._v("w-transition-slide-fade")])])])},function(){var n=this,e=n.$createElement,t=n._self._c||e;return t("p",[t("strong",{staticClass:"mr1"},[n._v("Note:")]),n._v("the "),t("span",{staticClass:"code"},[n._v("slide-fade")]),n._v(" transition take the direction in parameter, e.g. "),t("span",{staticClass:"code"},[n._v("left")]),n._v(`,
...
`),t("code",[n._v('style="animation-duration: 3s"')]),n._v(".")])},function(){var n=this,e=n.$createElement,t=n._self._c||e;return t("p",[n._v("The expand transition is JavaScript driven: it accepts a "),t("code",[n._v("duration")]),n._v(` parameter in milliseconds.
So you don't need to override the duration from a CSS rule.
`)])}];const r={data:()=>({toggleFade:!1,toggleScale:!1,toggleScaleFade:!1,toggleBounce:!1,toggleTwist:!1,toggleExpandX:!1,toggleExpandY:!1,toggleExpandXY:!1,toggleExpandXY2:!1,toggleSlideFadeDown:!1,toggleSlideFadeRight:!1,showCard:!1})},a={};var g=o(r,l,s,!1,d,null,null,null);function d(n){for(let e in a)this[e]=a[e]}var w=function(){return g.exports}();export{w as default};
