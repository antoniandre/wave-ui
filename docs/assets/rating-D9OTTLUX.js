import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,xt as s}from"./runtime-core.esm-bundler-CLfruy3s.js";import{t as c}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{B as l,h as u}from"./index-I7dyuwKt.js";var d={class:`mt2`},f={class:`mt2`};function p(c,l,u,p,m,h){let g=n(`title-link`),_=n(`w-rating`),v=n(`example`);return e(),i(`div`,null,[a(g,{h2:``},{default:t(()=>[...l[2]||=[o(`Default`,-1)]]),_:1}),a(v,null,{pug:t(()=>[...l[3]||=[o(`w-rating`,-1)]]),html:t(()=>[...l[4]||=[o(`<w-rating></w-rating>
...
div.mt2
  strong.mr2 v-model:
  code `+s(`{{ rating2 }}`),-1)]]),html:t(()=>[...l[9]||=[o(`<w-rating v-model="rating1"></w-rating>
<div class="mt2">
...
`,-1)]]),default:t(()=>[a(_,{modelValue:c.rating1,"onUpdate:modelValue":l[0]||=e=>c.rating1=e},null,8,[`modelValue`]),r(`div`,d,[l[6]||=r(`strong`,{class:`mr2`},`v-model:`,-1),r(`code`,null,s(c.rating1),1)]),a(_,{class:`mt4`,modelValue:c.rating2,"onUpdate:modelValue":l[1]||=e=>c.rating2=e},null,8,[`modelValue`]),r(`div`,f,[l[7]||=r(`strong`,{class:`mr2`},`v-model:`,-1),r(`code`,null,s(c.rating2),1)])]),_:1}),a(g,{h2:``},{default:t(()=>[...l[11]||=[o(`Color`,-1)]]),_:1}),l[34]||=r(`p`,null,[o(`Like in most components, you can set a `),r(`code`,null,`color`),o(` for the foreground icons (when on) and a `),r(`code`,null,`bg-color`),o(` for the
