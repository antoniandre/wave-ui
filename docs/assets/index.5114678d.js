var h=Object.defineProperty;var c=Object.getOwnPropertySymbols;var b=Object.prototype.hasOwnProperty,f=Object.prototype.propertyIsEnumerable;var r=(e,l,t)=>l in e?h(e,l,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[l]=t,a=(e,l)=>{for(var t in l||(l={}))b.call(l,t)&&r(e,t,l[t]);if(c)for(var t of c(l))f.call(l,t)&&r(e,t,l[t]);return e};import{n as o,C as m,F as _}from"./index.1430b630.js";import"./vendor.4f8da9ec.js";var w=function(){var e=this,l=e.$createElement,t=e._self._c||l;return t("div",[t("alert",{attrs:{info:""}},[e._v("The "),t("span",{staticClass:"code"},[e._v("w-select")]),e._v(` component can be placed in a hidden overflow container and the dropdown
...
`)]),t("title-link",{attrs:{h2:""}},[e._v("Basic")]),e._m(0),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v('<w-select :items="items"></w-select>')]},proxy:!0},{key:"js",fn:function(){return[e._v(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`)]},proxy:!0}])},[t("w-select",{attrs:{items:e.items1}})],1),t("title-link",{attrs:{h2:""}},[e._v("Label and / or placeholder")]),e._m(1),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-select
  :items="items"
  label="Label">
</w-select>
...
`)]),t("title-link",{attrs:{h2:""}},[e._v("Outline")]),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v('<w-select :items="items" outline>Label</w-select>')]},proxy:!0},{key:"js",fn:function(){return[e._v(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`)]},proxy:!0}])},[t("w-select",{attrs:{items:e.items1,outline:""}},[e._v("Label")])],1),t("title-link",{attrs:{h2:""}},[e._v("Colors")]),e._m(2),t("title-link",{attrs:{h3:"",slug:"default-style"}},[e._v("Default style (Underline)")]),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-select
  :items="items"
  color="blue">
  Label
</w-select>
...
`)]},proxy:!0}])},[t("w-select",{attrs:{items:e.items1,color:"blue"}},[e._v("Label")]),t("w-select",{staticClass:"mt4",attrs:{items:e.items1,"bg-color":"blue-light5",color:"blue-dark3"}},[e._v("Label")])],1),t("title-link",{attrs:{h3:""}},[e._v("Outline style")]),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-select
  :items="items"
  outline
  color="blue">
  Label
...
`)]},proxy:!0}])},[t("w-select",{attrs:{items:e.items1,outline:"",color:"blue"}},[e._v("Label")]),t("w-select",{staticClass:"mt4",attrs:{items:e.items1,outline:"","bg-color":"blue-light5",color:"blue-dark3"}},[e._v("Label")])],1),t("title-link",{attrs:{h3:""}},[e._v("List items colors")]),e._m(3),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-select :items="items">
  Pick a color
</w-select>`)]},proxy:!0},{key:"js",fn:function(){return[e._v(`data: () => ({
  items: [
...
`)]},proxy:!0}])},[t("w-select",{attrs:{items:e.items4}},[e._v("Pick a color")])],1),t("title-link",{attrs:{h2:""}},[e._v("Shadow")]),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<div class="title4 mb2">
...
`)]},proxy:!0}])},[t("div",{staticClass:"title4"},[e._v("Default style (Underline)")]),t("w-select",{attrs:{items:e.items1,shadow:""}},[e._v("Label")]),t("div",{staticClass:"title4 mt6"},[e._v("Outline style")]),t("w-select",{attrs:{items:e.items1,outline:"",shadow:""}},[e._v("Label")])],1),t("title-link",{attrs:{h2:""}},[e._v("Tile & round")]),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<div class="title4">
  Default style (Underline)
</div>
...
`)]},proxy:!0}])},[t("div",{staticClass:"title4"},[e._v("Default style (Underline)")]),t("w-select",{attrs:{items:e.items1,"bg-color":"purple-light5",tile:""}},[e._v("Tile")]),t("w-select",{staticClass:"mt4",attrs:{items:e.items1,"bg-color":"purple-light5",round:""}},[e._v("Round")]),t("div",{staticClass:"title4 mt6"},[e._v("Outline style")]),t("w-select",{attrs:{items:e.items1,outline:"",tile:""}},[e._v("Tile")]),t("w-select",{staticClass:"mt4",attrs:{items:e.items1,outline:"",round:""}},[e._v("Round")])],1),t("title-link",{attrs:{h2:""}},[e._v("Multiple selection")]),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v('<w-select :items="items" multiple></w-select>')]},proxy:!0},{key:"js",fn:function(){return[e._v(`data: () => ({
  items: [
    { label: 'Item 1' },
    { label: 'Item 2' },
    { label: 'Item 3' }
...
`)]},proxy:!0}])},[t("w-select",{attrs:{items:e.items3,multiple:""},model:{value:e.vModelSelect1,callback:function(n){e.vModelSelect1=n},expression:"vModelSelect1"}}),t("w-flex",{staticClass:"align-center mt4"},[t("span",[e._v("v-model:")]),t("code",{staticClass:"ml2"},[e._v(e._s(e.vModelSelect1))])])],1),t("title-link",{attrs:{h3:""}},[e._v("Without values (using labels)")]),t("p",[e._v("If no values are provided in the items objects, the labels will be used to identify the selected items.")]),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-select
  v-model="selection"
  :items="items"
  multiple>
</w-select>
...
the select list.`)]),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-select
  :items="items"
...
`)]},proxy:!0}])},[t("w-select",{attrs:{items:e.items3,multiple:""},scopedSlots:e._u([{key:"selection",fn:function(n){var s=n.item;return e._l(s,function(i,v){return t("w-tag",{key:v,staticClass:"mr2",attrs:{"bg-color":"grey-light4"}},[e._v(e._s(i.label))])})}}]),model:{value:e.customSelection,callback:function(n){e.customSelection=n},expression:"customSelection"}})],1),t("title-link",{attrs:{h2:""}},[e._v("Custom list items")]),t("example",{scopedSlots:e._u([{key:"html",fn:function(){return[e._v(`<w-select :items="items">
...
})`)]},proxy:!0}])},[t("w-select",{staticClass:"mb4",attrs:{items:e.items1,label:"Disabled & empty",outline:"",disabled:""}}),t("w-select",{staticClass:"mb4",attrs:{items:e.items1,label:"Disabled & filled",value:"Item 1",outline:"",disabled:""}}),t("w-select",{staticClass:"mb4",attrs:{items:e.items1,label:"Readonly & empty",outline:"",readonly:""}}),t("w-select",{attrs:{items:e.items1,value:"Item 1",label:"Readonly & filled",outline:"",readonly:""}})],1)],1)},y=[function(){var e=this,l=e.$createElement,t=e._self._c||l;return t("p",[e._v("This is the most basic use of the "),t("span",{staticClass:"code"},[e._v("w-select")]),e._v(" component. No label, no v-model, only items.")])},function(){var e=this,l=e.$createElement,t=e._self._c||l;return t("p",[e._v("The select list can have a label or not and a placeholder or not."),t("br")])},function(){var e=this,l=e.$createElement,t=e._self._c||l;return t("p",{staticClass:"mb4"},[e._v("Like in most components, you can set a "),t("code",[e._v("color")]),e._v(" for the text and a "),t("code",[e._v("bg-color")]),e._v(` for the
