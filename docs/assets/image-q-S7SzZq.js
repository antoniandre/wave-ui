import{H as e,N as t,c as n,d as r,g as i,h as a,k as o,l as s,u as c,vt as l}from"./runtime-core.esm-bundler-DPe36P4s.js";import{t as u}from"./_plugin-vue_export-helper-S3RvzygF.js";import{T as d}from"./index-D1jKshrg.js";var f={class:`w-card w-flex mdu-row basis-zero pa4 gap4`},p={class:`mr5`},m={class:`w-flex wrap justify-center align-center`},h={class:`mr4 my2`},g={class:`w-flex gap6`};function _(u,d,_,v,y,b){let x=t(`title-link`),S=t(`w-divider`),C=t(`alert`),w=t(`w-image`),T=t(`example`),E=t(`w-card`),D=t(`w-radios`),O=t(`w-button`),k=t(`w-alert`);return o(),r(`div`,null,[i(x,{h2:``},{default:e(()=>[...d[2]||=[a(`Why using w-image and not a simple <img>`,-1)]]),_:1}),n(`div`,f,[d[4]||=n(`div`,null,[n(`div`,{class:`title3`},`A simple <img>`),n(`p`,null,[a(`will display when loaded, and will take the dimensions of the actual image.`),n(`br`),a(`
