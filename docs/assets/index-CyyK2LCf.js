import{r as d,g as c,o as h,a as t,b as i,w as l,e as n,t as o,_ as p,a7 as g,G as V}from"./index-DyPyadtc.js";const $={class:"title3 mb0"},A={class:"ml2"};function x(a,e,v,f,b,w){const r=d("title-link"),s=d("w-switch"),u=d("example"),k=d("ssh-pre"),O=d("alert"),y=d("w-icon");return h(),c("div",null,[t(r,{h2:"",slug:"on-off-and-disabled"},{default:l(()=>e[5]||(e[5]=[n("On, off & disabled",-1)])),_:1,__:[5]}),t(u,{"content-class":"pt4"},{pug:l(()=>e[6]||(e[6]=[])),html:l(()=>e[7]||(e[7]=[n(`<w-switch
  class="ma2"
  :model-value="true"
  label="On">
</w-switch>
...
`,-1)])),default:l(()=>[t(s,{class:"ma2","model-value":!0,label:"On"}),t(s,{class:"ma2","model-value":!1,label:"Off"}),t(s,{class:"ma2","model-value":!0,disabled:"",label:"On disabled"}),t(s,{class:"ma2","model-value":!1,disabled:"",label:"Off disabled"})]),_:1}),t(r,{h2:""},{default:l(()=>e[8]||(e[8]=[n("V-model",-1)])),_:1,__:[8]}),t(u,{"content-class":"w-flex wrap align-center"},{pug:l(()=>[n(`w-switch.mr6(v-model="value")
span.title3.mb0
  | v-model value:
...
</span>`,-1)])),js:l(()=>e[11]||(e[11]=[n(`data: () => ({
  value: true
})
`,-1)])),default:l(()=>[t(s,{class:"mr6",modelValue:a.value,"onUpdate:modelValue":e[0]||(e[0]=m=>a.value=m)},null,8,["modelValue"]),i("span",$,[e[9]||(e[9]=n("v-model value:",-1)),i("code",A,o(a.value),1)])]),_:1}),t(r,{h2:""},{default:l(()=>e[12]||(e[12]=[n("Colors",-1)])),_:1,__:[12]}),t(u,{"content-class":"pt4"},{pug:l(()=>e[13]||(e[13]=[n(`w-switch.ma2(:model-value="true" color="pink")
...
w-switch.ma2(:model-value="true" color="info")`,-1)])),html:l(()=>e[14]||(e[14]=[n(`<w-switch
  class="ma2"
  :model-value="true"
  color="pink">
</w-switch>
...
`,-1)])),default:l(()=>[t(s,{class:"ma2","model-value":!0,color:"pink"}),t(s,{class:"ma2","model-value":!0,color:"error"}),t(s,{class:"ma2","model-value":!0,color:"warning"}),t(s,{class:"ma2","model-value":!0,color:"success"}),t(s,{class:"ma2","model-value":!0,color:"info"})]),_:1}),t(r,{h2:""},{default:l(()=>e[15]||(e[15]=[n("Thin version",-1)])),_:1,__:[15]}),t(u,{"content-class":"pt5"},{pug:l(()=>e[16]||(e[16]=[n(`w-switch.ma2(:model-value="true" thin label="On")
w-switch.ma2(:model-value="false" thin label="Off")
w-switch.ma2(:model-value="true" disabled thin label="On disabled")
w-switch.ma2(:model-value="false" disabled thin label="Off disabled")`,-1)])),html:l(()=>e[17]||(e[17]=[n(`<w-switch
  class="ma2"
  :model-value="true"
  thin label="On">
</w-switch>
...
`,-1)])),default:l(()=>[t(s,{class:"ma2","model-value":!0,thin:"",label:"On"}),t(s,{class:"ma2","model-value":!1,thin:"",label:"Off"}),t(s,{class:"ma2","model-value":!0,disabled:"",thin:"",label:"On disabled"}),t(s,{class:"ma2","model-value":!1,disabled:"",thin:"",label:"Off disabled"})]),_:1}),t(r,{h2:""},{default:l(()=>e[18]||(e[18]=[n("Track slot",-1)])),_:1,__:[18]}),e[34]||(e[34]=i("p",null,[n("You can easily add some custom content in the switch track via the "),i("code",null,"#track"),n(" slot."),i("br")],-1)),t(O,{tip:""},{default:l(()=>[e[20]||(e[20]=n("If the ",-1)),e[21]||(e[21]=i("strong",{class:"code"},"w-switch",-1)),e[22]||(e[22]=n(` width is too small for your custom content, it's very easy to
increase its width with CSS like in this example, and the component elements will adapt:`,-1)),t(k,{language:"css",dark:a.$store.state.darkMode},{default:l(()=>e[19]||(e[19]=[i("div",{class:"w-switch--custom-track"},".w-switch--custom-track .w-switch__input {width: 55px;}",-1)])),_:1,__:[19]},8,["dark"])]),_:1,__:[20,21,22]}),t(u,{"content-class":"pt5"},{pug:l(()=>e[23]||(e[23]=[n(`w-switch.ma4(v-model="value")
  template(#track)
    small `+o("{{ value ? 'on' : 'off' }}")+`

w-switch.w-switch--wide.ma4(v-model="value")
  template(#track)
    strong `+o("{{ value ? 'on' : 'off' }}"),-1)])),html:l(()=>e[24]||(e[24]=[n(`<w-switch v-model="value" class="ma4">
  <template #track>
...
</w-switch>`,-1)])),js:l(()=>e[25]||(e[25]=[n(`data: () => ({
  value: true
})`,-1)])),css:l(()=>e[26]||(e[26]=[n(`/* Adapt text color according to the background color. */
...
`,-1)])),default:l(()=>[t(s,{class:"ma4",modelValue:a.value2,"onUpdate:modelValue":e[1]||(e[1]=m=>a.value2=m)},{track:l(()=>[i("small",null,o(a.value2?"on":"off"),1)]),_:1},8,["modelValue"]),t(s,{class:"w-switch--wide ma4",modelValue:a.value2,"onUpdate:modelValue":e[2]||(e[2]=m=>a.value2=m)},{track:l(()=>[i("strong",null,o(a.value2?"on":"off"),1)]),_:1},8,["modelValue"])]),_:1}),t(r,{h2:""},{default:l(()=>e[27]||(e[27]=[n("Thumb slot",-1)])),_:1,__:[27]}),e[35]||(e[35]=i("p",null,[n("It is possible to add an icon or any kind of content in the switch thumb via the "),i("code",null,"#thumb"),n(`
slot.`),i("br"),n(`
...
w-switch.ma4(v-model="value" label="Dark theme")
  template(#thumb)
    w-icon `+o("{{ value ? 'mdi mdi-weather-night' : 'mdi mdi-white-balance-sunny' }}"),-1)])),html:l(()=>e[29]||(e[29]=[n(`<w-switch v-model="value" class="ma4">
  <template #thumb>
    <small>`+o("{{ value ? 'on' : 'off' }}")+`</small>
  </template>
</w-switch>
...
</w-switch>`,-1)])),js:l(()=>e[30]||(e[30]=[n(`data: () => ({
  value: true
})
`,-1)])),default:l(()=>[t(s,{class:"ma4",modelValue:a.value3,"onUpdate:modelValue":e[3]||(e[3]=m=>a.value3=m)},{thumb:l(()=>[i("small",null,o(a.value3?"on":"off"),1)]),_:1},8,["modelValue"]),t(s,{class:"ma4",modelValue:a.value3,"onUpdate:modelValue":e[4]||(e[4]=m=>a.value3=m),label:"Dark theme"},{thumb:l(()=>[t(y,null,{default:l(()=>[n(o(a.value3?"mdi mdi-weather-night":"mdi mdi-white-balance-sunny"),1)]),_:1})]),_:1},8,["modelValue"])]),_:1}),t(r,{h2:""},{default:l(()=>e[31]||(e[31]=[n("Loading",-1)])),_:1,__:[31]}),e[36]||(e[36]=i("p",null,`If a number is given it will be the value of the progress. If true is given, the progress will
be indefinitely spinning.`,-1)),t(u,{"content-class":"pt4"},{pug:l(()=>e[32]||(e[32]=[n(`w-switch.ma2(:model-value="true" :loading="43")
w-switch.ma2(:model-value="true" loading)`,-1)])),html:l(()=>e[33]||(e[33]=[n(`<w-switch
  class="ma2"
  :model-value="true"
  :loading="43">
</w-switch>
