import{r,o as _,f as T,a as n,w as t,b as o,h as i,e,bq as V,_ as w,b_ as y}from"./index.98731952.js";const j=e("Basic"),$=e('w-tabs(:items="tabs")'),B=e('<w-tabs :items="tabs"></w-tabs>'),P=e(`data: () => ({
  tabs: [
...
`),M=e("V-model"),Y=o("strong",null,"Since version 1.21.0",-1),q=e(", the v-model/value only accepts a numeric tab index (previously an array of boolean)."),H=o("p",null,[e("It is possible to open a particular tab programmatically via "),o("code",null,"v-model"),e(" or "),o("code",null,"model-value"),e(".")],-1),R=e("v-model:"),z={class:"ml2"},O=e(`w-tabs(v-model="activeTab" :items="tabs")
strong
  | v-model:
...
`),xt=e("Add / remove tabs"),St=o("p",null,`The tabs will naturally try to fit in the available space. But if they can't fit because there are
...
`),Lt=e("Customizing the tabs title & contents"),Mt=e("mdi mdi-star"),Yt={class:"green"},qt=e("mdi mdi-heart"),Ht={class:"pink mx1"},Rt=e("mdi mdi-heart"),zt=o("div",{class:"title3"},"This is a custom tab content.",-1),Ot=["innerHTML"],Gt=e(`data: () => ({
  tabs: [
    { title: 'Tab 1', content: 'Tab 1 content.' },
    { title: 'Tab 2', content: 'Tab 2 content.' },
    { title: 'Tab 3', content: 'Tab 3 content.' }
...
`),Jt=e("Adding a tabs bar extra element"),Qt=o("p",null,[e("You can add extra elements at the right of the tabs title bar via the "),o("code",null,"tabs-bar-extra"),e(" slot.")],-1),Xt=e(`<w-tabs
  ref="tabs"
...
`),te=e("Refreshing the slider width or position"),ee=o("p",null,[e("By default there is no data watcher on the tabs title to recalculate the slider width or position."),o("br"),e(`
...
so the slider width adapts to the number of characters on the current tab's title.`)],-1),ne=e(`w-tabs(ref="tabs" :items="tabs")
  template(#item-content="{ item }")
    w-input.my6(v-model="item.title" label="Tab title" @keyup="onTitleChange")`),ae=e(`<w-tabs ref="tabs" :items="tabs">
  <template #item-content="{ item }">
    <w-input
      v-model="item.title"
      class="my6"
...
</w-tabs>`,1)]),js:t(()=>[Dt]),default:t(()=>[n(c,{items:a.tabs6.items,card:""},{"item-title":t(({item:s,index:p})=>[e(i(s.title),1),n(u,{class:"ml1 mr-1",onClick:V(fe=>a.tabs6.items.splice(p-1,1),["stop"]),icon:"wi-cross",outline:"",xs:""},null,8,["onClick"])]),_:1},8,["items"]),n(u,{class:"mt4","bg-color":"primary",onClick:l[6]||(l[6]=s=>a.tabs6.items=a.tabs6.originals.slice(0)),disabled:a.tabs6.items.length===3},{default:t(()=>[Kt]),_:1},8,["disabled"])]),_:1}),n(b,{h2:""},{default:t(()=>[Lt]),_:1}),n(d,null,{pug:t(()=>[e(`w-tabs(:items="tabs" card)
