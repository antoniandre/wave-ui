import{n}from"./index.d288a6b4.js";import"./vendor.4f8da9ec.js";var i=function(){var t=this,e=t.$createElement,s=t._self._c||e;return s("main",[s("title-link",{staticClass:"mt4",attrs:{h1:""}},[t._v("Flex layout classes")]),s("title-link",{attrs:{h2:"",slug:"w-flex-component-and-helper-classes"}},[s("span",{staticClass:"code"},[t._v("w-flex")]),t._v(" component & helper classes")]),t._m(0),t._m(1),s("title-link",{attrs:{h2:""}},[t._v("Alignments")]),s("p",[t._v("Align children with these classes on the parent container:")]),t._m(2),s("p",{staticClass:"mt4"},[t._v("Align a child with these classes directly on the child element:")]),t._m(3),t._m(4),s("div",{staticClass:"w-divider my12"}),s("title-link",{staticClass:"mt12 headline",attrs:{h2:""}},[t._v("Examples")]),s("title-link",{staticClass:"mt8 title2",attrs:{h3:""}},[t._v("Justify")]),s("div",{staticClass:"title3 mt6"},[t._v("w-flex, row direction (default)")]),s("example",{scopedSlots:t._u([{key:"pug",fn:function(){return[t._v(`p.mb1 .justify-start (default)
