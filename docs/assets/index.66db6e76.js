import{r as d,o as w,f as m,a as o,w as e,e as t,h as p,c as v,d as k,b as l}from"./vendor.c30f2c6c.js";import{_,a as T}from"./index.67df9d80.js";const x={style:{"max-width":"1000px"}},A=t("Show / hide with v-model"),$=l("p",null,[t("By default alerts are visible, but if a "),l("code",null,"model-value"),t(" or "),l("code",null,"v-model"),t(` is provided,
...
w-alert(bg-color="cyan-light4" color="purple") This is an alert with a cyan background and purple color.`),j=t(`<w-alert color="primary">
...
`),H=t("Types (adds an icon)"),I=l("h3",null,"Normal",-1),L=t("This is a success alert."),Y=t("This is a warning alert."),W=t("This is an error alert."),q=t("This is an info alert."),F=t(`w-alert(success) This is a success alert.
...
`),je=t("Dismiss"),He=t("This is a dismissible alert."),Ie=t("This is a dismissible error type alert."),Le=t("This is a dismissible round alert."),Ye=t("Reset alerts"),We=t(`w-alert.mt0.mb2(v-model="dismissible1" color="primary" dismiss) This is a dismissible alert.
...
<w-alert info xl>This is an extra large alert.</w-alert>`);function tt(r,i,b,f,g,u){const a=d("title-link"),c=d("w-button"),s=d("w-alert"),y=d("w-transition-expand"),n=d("example");return w(),m("div",x,[o(a,{h2:"",slug:"show-and-hide-with-v-model"},{default:e(()=>[A]),_:1}),$,o(n,{"content-class":"pt5"},{pug:e(()=>[t('w-button(@click="showAlert = !showAlert" outline) '+p(r.showAlert?"Hide":"Show")+` alert
