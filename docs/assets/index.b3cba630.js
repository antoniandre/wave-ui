import{r as c,o as m,f as w,a as e,w as t,e as l,h as o,b as i,_ as p,bY as b,bz as y}from"./index.6ba25376.js";const V=l("On, off & disabled"),$=l(`<w-switch
  class="ma2"
  :model-value="true"
  label="On">
</w-switch>
...
`),x=l("V-model"),A={class:"title3 mb0"},D=l("v-model value:"),T={class:"ml2"},E=l(`<w-switch class="mr6" v-model="value"></w-switch>
...
increase its width with CSS like in this example, and the component elements will adapt:`),Y=i("div",{class:"w-switch--custom-track"},".w-switch--custom-track .w-switch__input {width: 55px;}",-1),H=l(`w-switch.ma4(v-model="value")
  template(#track)
    small `+o("{{ value ? 'on' : 'off' }}")+`

w-switch.w-switch--wide.ma4(v-model="value")
  template(#track)
    strong `+o("{{ value ? 'on' : 'off' }}")),R=l(`<w-switch v-model="value" class="ma4">
  <template #track>
...
<w-switch v-model="value" class="ma4 w-switch--wide">
  ...
  value: true
})`),F=l(`/* Adapt text color according to the background color. */
