...
`)]},proxy:!0}])},[t("w-input",{attrs:{type:"file"},model:{value:e.files2,callback:function(i){e.files2=i},expression:"files2"}},[e._v("File")]),t("pre",{staticClass:"mt3",domProps:{innerHTML:e._s(e.files2)}})],1),t("title-link",{attrs:{h3:""}},[e._v("Uploading the file to a backend server")]),t("p",[e._v("There are different ways you can do this. The 2 most common ways would be to:")]),e._m(10),t("p",{staticClass:"mt3"},[e._v(`The first option is recommended for a more modern approach. Here are two examples how to
set this up.`)]),t("title-link",{staticClass:"mt8",attrs:{h4:""}},[e._v("1st example")]),e._m(11),t("example",{attrs:{reactive:"","external-js":"https://cdnjs.cloudflare.com/ajax/libs/axios/0.25.0/axios.min.js"},scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-form(@success="onFormSuccess")
  w-input(
    type="file"
    v-model="files"
    :validators="[() => files.length || 'Please add a file']") File
  w-button.d-flex.mla.mt4(type="submit" :loading="loading") Send`)]},proxy:!0},{key:"html",fn:function(){return[e._v(`<w-form @success="onFormSuccess">
  <w-input
    type="file"
    v-model="files"
...
</w-form>`)]},proxy:!0},{key:"js",fn:function(){return[e._v(`methods: {
  // This method uses the Axios library.
  // import axios from 'axios' // If you use NPM.
  async onFormSuccess () {
    this.loading = true

    const binURL = 'https://filebin.net/waveui-`+e._s(e.todayFormatted)+e._s(e.userIP)+`'
...
`)]},proxy:!0}])},[t("w-form",{on:{success:e.onFormSuccess}},[t("w-input",{attrs:{type:"file",validators:[function(){return e.files5.length||"Please add a file"}]},model:{value:e.files5,callback:function(i){e.files5=i},expression:"files5"}},[e._v("File")]),t("w-button",{staticClass:"d-flex mla mt4",attrs:{type:"submit",loading:e.loading}},[e._v("Send")])],1)],1),t("title-link",{staticClass:"mt8",attrs:{h4:""}},[e._v("2nd example")]),e._m(12),t("ssh-pre",{attrs:{language:"js",label:"JavaScript"}},[e._v(`import axios from 'axios'
...
`)]),t("p",[e._v(`Here is an example of a very minimalist way to receive and display the file on server side
with PHP. Of course you should add more checks, and move the temporary uploaded file when all
the checks are passed.`)]),t("ssh-pre",{attrs:{language:"php",label:"PHP"}},[e._v(`<?php
...
?>
`)]),t("title-link",{attrs:{h3:""}},[e._v("Loading state")]),e._m(13),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`w-input(type="file"
  v-model="files"
...
`)]},proxy:!0}])},[t("w-input",{attrs:{type:"file",label:"File",accept:".jpg, .jpeg, .png, .gif, .svg",multiple:""}})],1),t("title-link",{attrs:{h2:""}},[e._v("Types")]),e._m(14),e._m(15),t("h3",[e._v("Textual inputs")]),t("example",{scopedSlots:e._u([{key:"pug",fn:function(){return[e._v(`<ul.input-types>
  <li>
    <.code.mb1 type="date"<
