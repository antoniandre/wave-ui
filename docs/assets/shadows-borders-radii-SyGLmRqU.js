import{r as l,g as i,o as b,a as o,b as n,h as k,w as d,e,F as u,j as m,n as x,t as w,_ as S}from"./index-eD21R81v.js";const C={class:"w-flex wrap"},$={class:"code"},I={class:"w-flex wrap"},U={class:"code"},B={class:"w-flex wrap"},N={class:"code"};function E(f,s,V,A,q,D){const a=l("title-link"),c=l("alert"),r=l("example"),g=l("w-divider"),v=l("w-image"),p=l("w-flex"),y=l("w-switch"),j=l("w-card"),h=l("w-accordion-item"),Y=l("w-accordion");return b(),i("main",null,[o(a,{class:"mt4",h1:""},{default:d(()=>s[0]||(s[0]=[e("shadows, borders & border radii")])),_:1}),s[31]||(s[31]=n("p",null,[e("Wave UI offers a few CSS helper classes to control the drop shadow, borders and border radii."),n("br"),e(`
...
</w-flex>`)])),css:d(()=>s[9]||(s[9]=[e(".box {\n  width: 80px;\n  height: 80px;\n  margin: 4px; /* You could use the class `ma1`. */\n  background-color: #e3f2fd; /* You could use the class `blue-light5--bg`. */\n  display: flex; /* You could use the class `d-flex`. */\n  align-items: center; /* You could use the class `align-center`. */\n  justify-content: center; /* You could use the class `justify-center`. */\n}\n")])),default:d(()=>[n("div",I,[(b(),i(u,null,m(7,t=>n("div",{class:x(["box blue-light5--bg ma4 d-flex align-center justify-center",`bd${t-1}`]),key:t},[n("span",U,".bd"+w(t-1),1)],2)),64))])]),_:1}),o(a,{h2:""},{default:d(()=>s[10]||(s[10]=[e("Border radii")])),_:1}),s[34]||(s[34]=k(`<p>The border radii range from <code>0</code> to <code>6</code>, and are incremented by the <code>$base-increment</code>
...
`)])),default:d(()=>[o(j,{class:"bdrs4 bd0 sh2","bg-color":"orange-light5"},{default:d(()=>s[23]||(s[23]=[n("div",{class:"caption"},[e("a "),n("strong",{class:"code mx1"},"w-card"),e(" with "),n("code",{class:"mx1"},".bd0"),e(", "),n("code",{class:"mx1"},".bdrs4"),e(" and "),n("code",{class:"mx1"},".sh2"),e(" classes.")],-1)])),_:1}),o(Y,{class:"mt8 bdrs2 bd1"},{default:d(()=>[o(h,null,{title:d(()=>s[24]||(s[24]=[n("div",{class:"title5 mb0"},[e("Accordion with "),n("code",{class:"mx1"},".bd1"),e(" and "),n("code",{class:"mx1"},".bdrs2"),e(" classes.")],-1)])),content:d(()=>s[25]||(s[25]=[e("Content 1")])),_:1}),o(h,null,{title:d(()=>s[26]||(s[26]=[e("Item 2")])),content:d(()=>s[27]||(s[27]=[e("Content 2")])),_:1})]),_:1})]),_:1}),o(c,{info:""},{default:d(()=>s[30]||(s[30]=[e(`Some of the UI components that have wrappers won't work nicely with the border and shadow classes.
