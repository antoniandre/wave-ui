import{C as e,N as t,R as n,U as r,c as i,d as a,g as o,h as s,k as c,yt as l}from"./runtime-core.esm-bundler-BAjkj7eY.js";import{t as u}from"./_plugin-vue_export-helper-S3RvzygF.js";import{S as d}from"./index-CI5qOTMg.js";var f={class:`mt4`},p={class:`ml1`};function m(u,d,m,h,g,_){let v=t(`title-link`),y=t(`w-button`),b=t(`w-menu`),x=t(`example`),S=t(`w-switch`),C=t(`w-flex`),w=t(`w-toolbar`),T=t(`w-card`),E=t(`w-list`),D=t(`alert`);return c(),a(`div`,null,[o(v,{h2:``},{default:r(()=>[...d[15]||=[s(`Basic`,-1)]]),_:1}),o(x,{class:`example1`,"content-class":`text-center pt5`,"app-classes-string":`align-center`},{pug:r(()=>[...d[18]||=[s(`w-menu
