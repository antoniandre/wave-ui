import{n as e,i as r}from"./index.6f80fb47.js";import"./vendor.4f8da9ec.js";var l=function(){var n=this,o=n.$createElement,t=n._self._c||o;return t("div",[t("alert",{attrs:{info:""}},[t("ul",[t("li",{staticClass:"title4"},[n._v("The purpose of the "),t("strong",{staticClass:"code"},[n._v("w-confirm")]),n._v(` component is to quickly set up a
...
`)]},proxy:!0}])},[t("w-confirm",{staticClass:"my5",attrs:{top:"","menu-border":""}},[n._v("Top")]),t("w-confirm",{staticClass:"my5",attrs:{right:"","menu-border":""}},[n._v("Right")]),t("w-confirm",{staticClass:"my5",attrs:{bottom:"","menu-border":""}},[n._v("Bottom")]),t("w-confirm",{staticClass:"my5",attrs:{left:"","menu-border":""}},[n._v("Left")])],1),t("title-link",{attrs:{h3:""}},[n._v("Alignments")]),t("title-link",{attrs:{h4:""}},[n._v("Horizontal")]),t("example",{scopedSlots:n._u([{key:"pug",fn:function(){return[n._v(`w-flex(justify-center)
...
`)]},proxy:!0}])},[t("w-flex",{attrs:{"justify-center":""}},[t("w-confirm",{staticClass:"ma2",attrs:{top:"","align-left":""}},[n._v("Top, align left")]),t("w-confirm",{staticClass:"ma2",attrs:{top:""}},[n._v("Top, align center")]),t("w-confirm",{staticClass:"ma2",attrs:{top:"","align-right":""}},[n._v("Top, align right")])],1),t("w-flex",{attrs:{"justify-center":""}},[t("w-confirm",{staticClass:"ma2",attrs:{bottom:"","align-left":""}},[n._v("Bottom, align left")]),t("w-confirm",{staticClass:"ma2",attrs:{bottom:""}},[n._v("Bottom, align center")]),t("w-confirm",{staticClass:"ma2",attrs:{bottom:"","align-right":""}},[n._v("Bottom, align right")])],1)],1),t("title-link",{attrs:{h4:""}},[n._v("Vertical")]),t("example",{scopedSlots:n._u([{key:"pug",fn:function(){return[n._v(`w-flex.text-center(justify-center)
  div
...
w-confirm.ma2.mb12(:menu="{ noPosition: true, detachTo: '.example--no-arrow' }") No position`)]},proxy:!0},{key:"html",fn:function(){return[n._v(`<w-confirm
  no-arrow
