import{r as i,o as b,g as v,a as l,w as o,b as e,d as n,_ as f,ac as g}from"./index-M5C_kbMe.js";function x(d,t){const p=i("title-link"),a=i("w-toolbar"),c=i("w-icon"),m=i("w-button"),r=i("example"),s=i("w-card"),w=i("w-flex"),u=i("w-divider");return b(),v("div",null,[l(p,{h2:""},{default:o(()=>t[0]||(t[0]=[e("Simple toolbar with shadow")])),_:1}),l(r,{"content-class":"pa4"},{pug:o(()=>t[5]||(t[5]=[e(`w-toolbar(shadow)
  .title2 Title
  .spacer
  span.ml2 Item 1
  span.ml2 Item 2
