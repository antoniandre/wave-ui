import{A as e,G as t,P as n,c as r,d as i,g as a,h as o,m as s,xt as c}from"./runtime-core.esm-bundler-BuLlhxCm.js";import{t as l}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{B as u,l as d}from"./index-BazmI9KH.js";var f={class:`title3 mb0`},p={class:`ml2`};function m(l,u,d,m,h,g){let _=n(`title-link`),v=n(`w-switch`),y=n(`example`),b=n(`ssh-pre`),x=n(`alert`),S=n(`w-icon`);return e(),i(`div`,null,[a(_,{h2:``,slug:`on-off-and-disabled`},{default:t(()=>[...u[5]||=[o(`On, off & disabled`,-1)]]),_:1}),a(y,{"content-class":`pt4`},{pug:t(()=>[...u[6]||=[]]),html:t(()=>[...u[7]||=[o(`<w-switch
  class="ma2"
  :model-value="true"
  label="On">
</w-switch>
