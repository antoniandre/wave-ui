import{r as g,o as h,f as _,a as o,w as e,b as d,e as t,M as y}from"./vendor.c30f2c6c.js";import{_ as u,c as v}from"./index.76d51146.js";const x=t("Default"),B=d("p",null,"The default badge background color is primary.",-1),k=t("3"),$=t("mdi mdi-email"),T=t("Emails"),C=t(`w-badge
  template(#badge) 3
...
`),O=t("Positions"),j=d("p",null,"The default position is top right.",-1),F=d("div",{class:"title4 mb2"},"Top",-1),I=t("3"),W=t("mdi mdi-email"),M=t("3"),U=t("mdi mdi-email"),L=d("div",{class:"title4 mt6 mb2"},"Bottom",-1),q=t("3"),G=t("mdi mdi-email"),H=t("3"),J=t("mdi mdi-email"),K=t(`.title4.mb2 Top
...
<code>lg</code>, <code>xl</code> or via the <code>size</code> prop (sets the font-size).</p>`,1),be=d("div",{class:"title3 mb2"},"Dots",-1),we=t("mdi mdi-account"),he=t("mdi mdi-account"),_e=t("mdi mdi-account"),ue=t("mdi mdi-account"),pe=t("mdi mdi-account"),fe=d("div",{class:"title3 mt6 mb2"},"Text content",-1),ze=t("busy"),ye=t("mdi mdi-account"),ve=t("busy"),xe=t("mdi mdi-account"),Be=t("busy"),ke=t("mdi mdi-account"),$e=t("busy"),Te=t("mdi mdi-account"),Ce=t("busy"),Ve=t("mdi mdi-account"),Ae=d("div",{class:"title3 mt6 mb2"},"Numeric content",-1),De=t("3"),Se=t("mdi mdi-account"),Pe=t("3"),Ne=t("mdi mdi-account"),Ee=t("3"),Oe=t("mdi mdi-account"),je=t("3"),Fe=t("mdi mdi-account"),Ie=t("3"),We=t("mdi mdi-account"),Me=t(`.title3.mb2 Dots
w-flex(wrap)
...
w-flex(wrap)
  ...
  w-badge.mr10(bg-color="error" xl)
    template(#badge) 3
    w-icon(size="2.5em") mdi mdi-account`),Ue=t(`<div class="title3 mb2">Dots</div>
<w-flex wrap>
...
`),jo=t("Icons"),Fo=t("mdi mdi-check"),Io=t("mdi mdi-account"),Wo=t("mdi mdi-close"),Mo=t("mdi mdi-account"),Uo=t("mdi mdi-heart"),Lo=t("mdi mdi-account"),qo=t(`w-badge.mr10(bg-color="success" overlap round)
  template(#badge)
