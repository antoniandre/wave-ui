import{r as d,o as h,g as w,b as e,w as t,a as l,t as o,d as i,_ as p,a8 as g,D as y}from"./index-CXWMPVZD.js";const V={class:"title3 mb0"},$={class:"ml2"},A=i("p",null,[l("You can easily add some custom content in the switch track via the "),i("code",null,"#track"),l(" slot."),i("br")],-1),D=i("strong",{class:"code"},"w-switch",-1),x=i("div",{class:"w-switch--custom-track"},".w-switch--custom-track .w-switch__input {width: 55px;}",-1),T=i("p",null,[l("It is possible to add an icon or any kind of content in the switch thumb via the "),i("code",null,"#thumb"),l(`
slot.`),i("br"),l(`
...
`)]),default:t(()=>[e(a,{class:"ma2","model-value":!0,thin:"",label:"On"}),e(a,{class:"ma2","model-value":!1,thin:"",label:"Off"}),e(a,{class:"ma2","model-value":!0,disabled:"",thin:"",label:"On disabled"}),e(a,{class:"ma2","model-value":!1,disabled:"",thin:"",label:"Off disabled"})]),_:1}),e(c,{h2:""},{default:t(()=>[l("Track slot")]),_:1}),A,e(k,{tip:""},{default:t(()=>[l("If the "),D,l(` width is too small for your custom content, it's very easy to
increase its width with CSS like in this example, and the component elements will adapt:`),e(_,{language:"css",dark:n.$store.state.darkMode},{default:t(()=>[x]),_:1},8,["dark"])]),_:1}),e(r,{"content-class":"pt5"},{pug:t(()=>[l(`w-switch.ma4(v-model="value")
  template(#track)
