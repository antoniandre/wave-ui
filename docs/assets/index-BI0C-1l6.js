import{r as s,o as b,g as c,a as l,w as a,d as i,b as t,_ as x,aa as f,D as g}from"./index-CSsuy43z.js";function h(u,e){const p=s("w-alert"),r=s("title-link"),n=s("w-textarea"),o=s("example"),d=s("w-icon");return b(),c("div",null,[l(p,{info:""},{default:a(()=>e[0]||(e[0]=[i("div",{class:"title4"},"Good to know",-1),i("p",{class:"body"},[t(`Any HTML attribute or JavaScript event listeners attached to the component will be applied to the
