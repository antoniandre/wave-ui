import{C as e,N as t,R as n,W as r,bt as i,c as a,d as o,g as s,h as c,k as l}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as u}from"./_plugin-vue_export-helper-B80Cc4Ui.js";import{n as d}from"./index-BhRaCC4I.js";var f={class:`tooltips-demo`},p={class:`d-iblock my2 mx6`},m={class:`mt4`},h={class:`text-center py6`},g={class:`another-container text-center green-light5--bg pa6`},_={class:`w-flex wrap align-start gap6`};function v(u,d,v,y,b,x){let S=t(`alert`),C=t(`title-link`),w=t(`w-icon`),T=t(`w-tooltip`),E=t(`example`),D=t(`w-button`),O=t(`w-switch`),k=t(`w-flex`),A=t(`w-radios`),j=t(`w-tag`),M=t(`w-card`);return l(),o(`div`,f,[s(S,{tip:``},{default:r(()=>[...d[12]||=[a(`strong`,null,`Important notes`,-1),a(`br`,null,null,-1),c(`
