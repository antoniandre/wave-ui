...
`),j=c(()=>r("h3",null,"Updated value example",-1)),T=s('w-progress(circle :model-value="progress")'),B=s('<w-progress circle :model-value="progress"></w-progress>'),E=s(`data: () => ({
  progress: 0
}),
...
`),L=s("Size & stroke thickness"),R=s(`w-progress.ma1(circle model-value="38" color="blue")
...
w-progress.ma1(circle model-value="38" size="6em" :stroke="40" color="blue")`),N=s(`<w-progress
  class="ma1"
  circle
  model-value="38"
  color="blue">
...
`),W=s("Progress value with label"),F=c(()=>r("p",null,[s("The default label displays the rounded value without the "),r("code",null,"%"),s(" sign, so it fits in smaller circles.")],-1)),Q=c(()=>r("p",null,"You can customize the label to display the value as you wish.",-1)),Y=c(()=>r("p",null,"Default label \xA0 - \xA0 Custom label",-1)),q=s(`p Default label - Custom label

w-progress.ma1.mr8(circle v-model="progress" size="5em" label)

w-progress.ma1(circle v-model="progress" size="5em")
  strong `+m("{{ progress }}")+"%"),G=s(`<p>Default label - Custom label</p>
