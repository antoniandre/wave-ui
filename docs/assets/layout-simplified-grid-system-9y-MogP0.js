import{N as e,W as t,c as n,d as r,g as i,h as a,j as o,k as s,r as c}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as l}from"./plugin-vue_export-helper-B80Cc4Ui.js";var u={class:`box`},d={class:`box`},f={class:`box`};function p(l,p){let m=e(`title-link`),h=e(`router-link`),g=e(`alert`),_=e(`w-grid`),v=e(`example`);return s(),r(`main`,null,[i(m,{class:`mt4`,h1:``},{default:t(()=>[...p[0]||=[a(`Simplified grid system (CSS grids)`,-1)]]),_:1}),i(g,{info:``},{default:t(()=>[p[2]||=a(`The 12-cell based flexbox grid system works well and for most cases, but it has
