import{r as o,o as r,f as c,a,w as s,b as e,d as n,i as h,_ as d}from"./index.23263e86.js";const g=h(`<p>Margins and paddings are incrementable from 0 to 12 using this syntax: <code>ma[number]</code>,
...
</p>`,1),p={class:"orange-light4--bg pa12"},m={class:"yellow-light5--bg pa3"},u=n("span",{class:"code"},"pa12",-1),x=n("br",null,null,-1),b=n("span",{class:"code"},"pax",-1),f=n("span",{class:"code"},"max",-1),_=n("br",null,null,-1),v=n("div",{class:"green-light4--bg mt8 pa3"},[e("This green container has a "),n("span",{class:"code"},"mt8"),e(` class which results in a top margin of: 8 x 4 x
...
orange container.`)],-1),T=n("div",{class:"orange-light4--bg pa8"},null,-1),z=n("div",{class:"green-light4--bg mt-8 mx8 pa3"},[e("This green container has a "),n("span",{class:"code"},"mt-8"),e(` class which results in a negative top margin of: -8 x 4 x
base-font-size pixels.`)],-1),S=n("p",null,[e("Last but not least, margin: auto is also possible with the "),n("code",null,"a"),e(" modifier."),n("br"),e(`
The syntax for it is `),n("code",null,"m[side]a")],-1),k=n("div",{class:"orange-light4--bg pa8"},[n("div",{class:"green-light4--bg mxa pa3",style:{"max-width":"240px"}},[e("This green container has a "),n("span",{class:"code"},"mxa"),e(" class which results in a margin auto on the left & right.")])],-1);function C(V,B){const t=o("title-link"),l=o("router-link"),i=o("example");return r(),c("main",null,[a(t,{class:"mt4",h1:""},{default:s(()=>[e("Spaces")]),_:1}),a(t,{h2:""},{default:s(()=>[e("Content spacing")]),_:1}),g,a(i,null,{pug:s(()=>[e(`.orange-light4--bg.pa12
  .yellow-light5--bg.pa3.
    The orange container has a \`pa12\` class which results in a padding of: 12 x 4 x
    base-font-size pixels.`),w,e("\n    The default base font size is 14px but it's easy to override it in your SCSS, as well as the\n    increment for `pax` and `max` classes.\n\n  .green-light4--bg.mt8.pa3.\n    This green container has a `mt8` class which results in a top margin of: 8 x 4 x\n    base-font-size pixels.")]),html:s(()=>[e(`<div class="orange-light4--bg pa12">
...
`)]),default:s(()=>[n("div",p,[n("div",m,[e("The orange container has a "),u,e(` class which results in a padding of: 12 x 4 x
base-font-size pixels.`),x,e(`
The default base font size is 14px but it's easy to override it in your SCSS, as well as the
increment for `),b,e(" and "),f,e(` classes. Read on in the
`),a(l,{to:"customization"},{default:s(()=>[e("customization")]),_:1}),e(" page."),_]),v])]),_:1}),a(t,{h3:""},{default:s(()=>[e("Negative margin")]),_:1}),y,a(i,null,{pug:s(()=>[e(`.orange-light4--bg.pa8
.green-light4--bg.mt-8.mx8.pa3.
  This green container has a \`mt-8\` class which results in a negative top margin of: -8 x 4 x
  base-font-size pixels.`)]),html:s(()=>[e(`<div class="orange-light4--bg pa8">
  <div class="green-light4--bg mt-8 mx8 pa3">
    This green container has a \`mt-8\` class which results in a negative top margin of: 8 x 4 x
    base-font-size pixels.
  </div>
</div>
`)]),default:s(()=>[T,z]),_:1}),a(t,{h3:""},{default:s(()=>[e("Margin auto")]),_:1}),S,a(i,null,{pug:s(()=>[e('.orange-light4--bg.pa8\n  .green-light4--bg.mxa.pa3(style="max-width: 240px").\n    This green container has a `mxa` class which results in a margin auto on the left & right.')]),html:s(()=>[e(`<div class="orange-light4--bg pa8">
...
</div>`)]),default:s(()=>[k]),_:1})])}const N={},I=d(N,[["render",C]]);export{I as default};
