...
`),t("code",[e._v("breakpointLayoutClasses")]),e._v(" config."),t("ssh-pre",{staticClass:"mb0",attrs:{language:"js"}},[e._v(`const waveui = new WaveUI({
  css: {
...
})`)])],1)},l=[function(){var e=this,s=e.$createElement,t=e._self._c||s;return t("p",[e._v("If you are not familiar with breakpoints, you should first read about it."),t("br"),e._v(`
The breakpoints are usaully useful when you want to change the layout for a particular viewport width.`),t("br"),e._v(`
In Wave UI, you can use them in different ways:`)])},function(){var e=this,s=e.$createElement,t=e._self._c||s;return t("ul",[t("li",{staticClass:"mb1"},[t("code",{staticClass:"mr2"},[e._v("xs")]),t("span",[e._v("from 0 to 600px")])]),t("li",{staticClass:"mb1"},[t("code",{staticClass:"mr2"},[e._v("sm")]),t("span",[e._v("from 601px to 900px")])]),t("li",{staticClass:"mb1"},[t("code",{staticClass:"mr2"},[e._v("md")]),t("span",[e._v("from 901px to 1200px")])]),t("li",{staticClass:"mb1"},[t("code",{staticClass:"mr2"},[e._v("lg")]),t("span",[e._v("from 1201px to 1700px")])]),t("li",{staticClass:"mb1"},[t("code",{staticClass:"mr2"},[e._v("xl")]),t("span",[e._v("from 1701px and more")])])])},function(){var e=this,s=e.$createElement,t=e._self._c||s;return t("p",{staticClass:"mt4"},[e._v(`You can access the current breakpoint from anywhere using
`),t("code",[e._v("this.$waveui.breakpoint.name")]),e._v(`, or one of these quick booleans from
the same `),t("code",[e._v("this.$waveui.breakpoint")]),e._v(" object:")])},function(){var e=this,s=e.$createElement,t=e._self._c||s;return t("ul",[t("li",{staticClass:"mb1"},[t("code",[e._v("xs")])]),t("li",{staticClass:"mb1"},[t("code",[e._v("sm")])]),t("li",{staticClass:"mb1"},[t("code",[e._v("md")])]),t("li",{staticClass:"mb1"},[t("code",[e._v("lg")])]),t("li",{staticClass:"mb1"},[t("code",[e._v("xl")])])])},function(){var e=this,s=e.$createElement,t=e._self._c||s;return t("p",{staticClass:"mt6"},[e._v("To use them on a particular breakpoint, the syntax is: "),t("code",[e._v(".[breakpoint][extend]-[class]")]),e._v(", with:")])},function(){var e=this,s=e.$createElement,t=e._self._c||s;return t("ul",[t("li",[t("strong",{staticClass:"code"},[e._v("[breakpoint]")]),e._v(" one of: "),t("code",[e._v("xs")]),e._v(", "),t("code",[e._v("sm")]),e._v(", "),t("code",[e._v("md")]),e._v(", "),t("code",[e._v("lg")]),e._v(", "),t("code",[e._v("xl")]),e._v(".")]),t("li",[t("strong",{staticClass:"code"},[e._v("[extend]")]),e._v(" one of "),t("code",[e._v("u")]),e._v(" (and up), "),t("code",[e._v("d")]),e._v(` (and down) and
`),t("strong",[e._v("no character")]),e._v(" to target only this breakpoint.")]),t("li",[t("strong",{staticClass:"code"},[e._v("[class]")]),e._v(" one of the above CSS class name.")])])},function(){var e=this,s=e.$createElement,t=e._self._c||s;return t("p",{staticClass:"mt6"},[e._v("In these two examples, resize your browser to less than 900px (default "),t("code",[e._v("md")]),e._v(`) to see see the
layout changed.`)])}];const r={},n={};var o=a(r,i,l,!1,c,null,null,null);function c(e){for(let s in n)this[s]=n[s]}var d=function(){return o.exports}();export{d as default};
