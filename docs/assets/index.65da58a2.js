import{r as p,o as v,f,a as e,w as t,t as l,m as c,e as n,h,b as i,_ as g,bM as k}from"./index.9037a58f.js";const T=n("Basic"),I=n("Show menu"),B=n("Menu content"),L=n(`w-menu
...
`),H=n("Persistent menu"),U=i("p",null,[n("A persistent menu can only be closed by clicking on the activator again, or programmatically."),i("br"),n(`
...
`),rt=n("Alignments"),dt=i("p",null,"In addition to positions, you can align the menu with its activator.",-1),pt=i("div",{class:"title4 mb2"},"Top position",-1),ht=n("Align left"),wt=n("Menu content"),_t=n("Centered"),vt=n("Menu content"),ft=n("Align right"),gt=n("Menu content"),bt=i("div",{class:"title4 mt6 mb2"},"Bottom position",-1),Mt=n("Align left"),xt=n("Menu content"),yt=n("Centered"),kt=n("Menu content"),St=n("Align right"),At=n("Menu content"),Ct=i("div",{class:"title4 mt6 mb2"},"Right position",-1),Tt=n("Align top"),It=n("Menu content"),Bt=n("Centered"),Lt=n("Menu content"),$t=n("Align bottom"),jt=n("Menu content"),Pt=i("div",{class:"title4 mt6 mb2"},"Left position",-1),Rt=n("Align top"),Vt=n("Menu content"),Ot=n("Centered"),Wt=n("Menu content"),Dt=n("Align bottom"),Et=n("Menu content"),Ht=n(`.title4.mb2 top position
...
w-menu(left align-bottom)
  template(#activator="{ on }")
    w-button.ma1(v-on="on") Align bottom
  | Menu content`),Ut=n(`<div class="title4 mb2">Top position</div>
<w-menu top align-left>
  <template #activator="{ on }">
...
`),Rn=n("Vertical"),Vn=n("Left, align top"),On=n("Menu content"),Wn=n("Left, align center"),Dn=n("Menu content"),En=n("Left, align bottom"),Hn=n("Menu content"),Un=n("Right, align top"),Nn=n("Menu content"),zn=n("Right, align center"),Fn=n("Menu content"),qn=n("Right, align bottom"),Yn=n("Menu content"),Gn=n(`w-flex.text-center(justify-center)
