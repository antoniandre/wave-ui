import{r as d,o as f,g,a as e,w as t,b as n,e as i,m as c,t as w,d as s,_ as b,S as k}from"./index-DmbSWeYz.js";const T=s("p",null,[n("A persistent menu can only be closed by clicking on the activator again, or programmatically."),s("br"),n(`
...
`),s("code",null,"hide-on-menu-click"),n(".")],-1),G={class:"mt4"},J=s("strong",null,"Current selection:",-1),K={class:"ml1"},Q=s("p",null,[n(`External activators offer a great flexibility in the code and the advantage of accepting
...
w-menu(:activator="activator" arrow)
  | `+w("{{ activator.includes('dog') ? 'Woof!' : 'Meow!' }}"))]),html:t(()=>[n(`<w-button
  icon="mdi mdi-cat"
  xl
