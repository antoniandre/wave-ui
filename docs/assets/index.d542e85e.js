...
<w-alert info xl>This is an extra large alert.</w-alert>`)]},proxy:!0}])},[e("w-alert",{attrs:{info:"",xs:""}},[r._v("This is an extra small alert.")]),e("w-alert",{attrs:{info:"",sm:""}},[r._v("This is a small alert.")]),e("w-alert",{attrs:{info:"",md:""}},[r._v("This is a medium alert.")]),e("w-alert",{attrs:{info:"",lg:""}},[r._v("This is a large alert.")]),e("w-alert",{attrs:{info:"",xl:""}},[r._v("This is an extra large alert.")])],1)],1)},d=[function(){var r=this,t=r.$createElement,e=r._self._c||t;return e("p",[r._v(`By default alerts are visible, but if a value or v-model is provided,
