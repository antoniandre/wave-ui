import{N as e,W as t,bt as n,c as r,d as i,g as a,h as o,k as s}from"./runtime-core.esm-bundler-inBY9EW4.js";import{t as c}from"./plugin-vue_export-helper-B80Cc4Ui.js";import{F as l,l as u}from"./index-BhRaCC4I.js";var d={class:`title3 mb0`},f={class:`ml2`};function p(c,l,u,p,m,h){let g=e(`title-link`),_=e(`w-switch`),v=e(`example`),y=e(`ssh-pre`),b=e(`alert`),x=e(`w-icon`);return s(),i(`div`,null,[a(g,{h2:``,slug:`on-off-and-disabled`},{default:t(()=>[...l[5]||=[o(`On, off & disabled`,-1)]]),_:1}),a(v,{"content-class":`pt4`},{pug:t(()=>[...l[6]||=[]]),html:t(()=>[...l[7]||=[o(`<w-switch
  class="ma2"
  :model-value="true"
  label="On">
</w-switch>
