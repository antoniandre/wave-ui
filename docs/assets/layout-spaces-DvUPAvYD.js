import{r as l,o as g,g as d,a as i,w as t,b as e,h as p,d as s,_ as m}from"./index-CCZXtjQr.js";const u={class:"orange-light4--bg pa12 grey-dark5"},h={class:"yellow-light5--bg pa3"};function x(f,n){const a=l("title-link"),r=l("router-link"),o=l("example");return g(),d("main",null,[i(a,{class:"mt4",h1:""},{default:t(()=>n[0]||(n[0]=[e("Spaces")])),_:1}),i(a,{h2:""},{default:t(()=>n[1]||(n[1]=[e("Content spacing")])),_:1}),n[26]||(n[26]=p(`<p>Margins and paddings are incrementable from 0 to 12 using this syntax: <code>ma[number]</code>,
...
`)),i(r,{to:"customization"},{default:t(()=>n[2]||(n[2]=[e("customization")])),_:1}),n[12]||(n[12]=e(" page.")),n[13]||(n[13]=s("br",null,null,-1))]),n[14]||(n[14]=s("div",{class:"green-light4--bg mt8 pa3"},[e("This green container has a "),s("span",{class:"code inherit"},"mt8"),e(` class which results in a top margin of: 8 x 4 x
base-font-size pixels.`)],-1))])]),_:1}),i(a,{h3:""},{default:t(()=>n[17]||(n[17]=[e("Negative margin")])),_:1}),n[27]||(n[27]=s("p",null,[e(`Sometimes you may need negative margins, Wave UI also provides 12 negative increments for this
purpose.`),s("br"),e(`
...
base-font-size pixels.`)],-1))]),_:1}),i(a,{h3:""},{default:t(()=>n[22]||(n[22]=[e("Margin auto")])),_:1}),n[28]||(n[28]=s("p",null,[e("Last but not least, margin: auto is also possible with the "),s("code",null,"a"),e(" modifier."),s("br"),e(`
...
</div>`)])),default:t(()=>[n[25]||(n[25]=s("div",{class:"orange-light4--bg pa8 grey-dark5"},[s("div",{class:"green-light4--bg mxa pa3",style:{"max-width":"240px"}},[e("This green container has a "),s("span",{class:"code inherit"},"mxa"),e(" class which results in a margin auto on the left & right.")])],-1))]),_:1})])}const b={},w=m(b,[["render",x]]);export{w as default};
