import{r as i,o as v,f as h,a as o,w as n,b as r,n as B,h as p,e as s,_ as w,bO as g}from"./index.9037a58f.js";const V=r("p",null,[s("By default the overlay has a "),r("span",{class:"code"},"0.3"),s(` opacity with a black color and a z-index
...
`),j=s("Overlay with custom background color"),M=s("Show a blue overlay"),R=s("wi-cross"),q=s("Hide overlay"),F=s(`w-button(bg-color="primary" dark @click="showOverlay = true") Show a blue overlay
