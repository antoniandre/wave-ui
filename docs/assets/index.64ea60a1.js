import{o as h,g as p,a as l,w as t,b as e,d as c,e as s,F as T,p as M,c as j,r,_ as v,a5 as S,E as A}from"./index.d241780a.js";const D=s("span",{class:"code"},"w-select",-1),P=s("br",null,null,-1),O=s("span",{class:"code"},".w-app",-1),V=s("p",null,[e("This is the most basic use of the "),s("span",{class:"code"},"w-select"),e(" component. No label, no v-model, only items.")],-1),E=s("p",null,[e("The select list can have a label or not and a placeholder or not."),s("br")],-1),R=s("code",null,"label",-1),U=s("br",null,null,-1),$=s("code",null,"item-label-key",-1),C=s("p",{class:"mb4"},[e("Like in most components, you can set a "),s("code",null,"color"),e(" for the text and a "),s("code",null,"bg-color"),e(` for the
background.`),s("br"),e(`
...
`)]),default:t(()=>[l(i,{items:n.items1,outline:""},{default:t(()=>[e("Label")]),_:1},8,["items"])]),_:1}),l(o,{h2:""},{default:t(()=>[e("Colors")]),_:1}),C,l(o,{h3:"",slug:"default-style"},{default:t(()=>[e("Default style (Underline)")]),_:1}),l(a,null,{pug:t(()=>[e(`w-select(:items="items" color="blue") Label
