...
<a href="/colors#colors-and-themes">Colors and themes section of the colors page</a>.</p></li>`,1),K={class:"mt6"};function Q(n,d,Z,x,ee,te){const l=r("title-link"),s=r("ssh-pre"),h=r("w-icon"),w=r("w-flex"),c=r("example"),u=r("w-button"),f=r("alert");return _(),p("main",null,[o(l,{class:"mt4",h1:""},{default:a(()=>[e("Themes")]),_:1}),y,o(l,{h2:""},{default:a(()=>[e("Setting an initial theme")]),_:1}),$,o(s,{language:"js",dark:n.$store.state.darkMode},{default:a(()=>[e(`app.use(WaveUI, {
...
variables.`)]),_:1}),o(l,{h3:""},{default:a(()=>[e("Triggering an action on theme change")]),_:1}),N,Y,o(s,{language:"js",dark:n.$store.state.darkMode},{default:a(()=>[e(`watch: {
  '$waveui.preferredTheme' (theme) {
    // Trigger an action.
  }
}
`)]),_:1},8,["dark"]),o(l,{h2:"",slug:"adding-themes-in-your-wave-ui-app"},{default:a(()=>[e("Adding themes in your Wave UI app that never had themes")]),_:1}),P,t("ol",null,[V,L,t("li",O,[e("Optionally, you can override these Wave UI defaults if you don't like them."),R,e(`
