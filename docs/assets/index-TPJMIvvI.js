import{r as m,o as p,g as c,a as e,w as l,b as t,t as d,d as o,_ as b,a0 as y,D as h}from"./index-DJW-wguP.js";const x={class:"mt2"},k={class:"mt2"};function V(a,n,v,w,f,u){const s=m("title-link"),r=m("w-rating"),i=m("example");return p(),c("div",null,[e(s,{h2:""},{default:l(()=>n[2]||(n[2]=[t("Default")])),_:1}),e(i,null,{pug:l(()=>n[3]||(n[3]=[t("w-rating")])),html:l(()=>n[4]||(n[4]=[t(`<w-rating></w-rating>
