import{r as c,o as g,f as _,a as e,w as o,b as n,h as s,d as x,e as t,b5 as N,bo as T,m as V,_ as y,bH as b,bN as C}from"./index.60a2b3d1.js";const E=t("Notification manager"),H=n("p",null,[t("The built-in notification manager can be used via "),n("code",null,"this.$waveui.notify()"),t(" from any component.")],-1),B=n("div",{class:"title3"},"Pros",-1),U=t("Very convenient and fast to use"),D=t("Handles the stacking of simultaneous notifications"),j=n("div",{class:"title3 mt4"},"Cons",-1),z=t("Less flexible than "),O=n("strong",{class:"code mx1"},"w-notification",-1),W=t(` in terms of layout (no slot available)
...
to `),Ct=t("."),At=t("You could even"),Mt={class:"ml1",href:"https://vuejs.org/v2/guide/transitions.html"},It=t("create your own transition"),Pt=t("mdi mdi-open-in-new"),xt=t("."),Et=t("Styling"),Ht=n("p",null,[t("By default, the notification manager is 280px-wide and all the notifications will inherit this width."),n("br"),t(`
