import{r as m,o as p,e as _,f as e,w as t,g as s,t as c,i as l}from"./vendor.e64646cc.js";import{_ as b,C as V}from"./index.f3654a4f.js";const S=l("Default"),x=s("p",null,[l("By default the range will have the "),s("code",null,"primary"),l(" color.")],-1),k=l(`<w-slider :model-value="50"></w-slider>
`),$=l("V-model & external controls"),C={class:"mt4"},D=l("v-model:"),A={class:"ml1"},M=l(`<w-flex align-center>
  <w-button
    @click="sliderValue -= 5"
    icon="wi-minus"
    bg-color="success"
...
`),L=l("Min & max"),U=s("div",{class:"title4 mb4"},"From 4 to 5",-1),j={class:"mt4"},z=l("v-model:"),E={class:"ml1"},I=s("div",{class:"title4 mt8 mb4"},"From -10 to 10",-1),W={class:"mt4"},B=l("v-model:"),N={class:"ml1"},P=l(`<div class="title4 mb4">From 4 to 5</div>
<w-slider
  v-model="sliderValue"
  :min="4"
  :max="5">
...
<w-slider
  ...
  sliderValue: 40
})`);function ke(o,a,v,f,w,u){const d=m("title-link"),n=m("w-slider"),r=m("example"),g=m("w-button"),y=m("w-flex"),h=m("w-icon");return p(),_("div",null,[e(d,{h2:""},{default:t(()=>[S]),_:1}),x,e(r,{"content-class":"mt5 px6"},{html:t(()=>[k]),default:t(()=>[e(n,{"model-value":50})]),_:1}),e(d,{h2:""},{default:t(()=>[$]),_:1}),e(r,{"content-class":"px6"},{html:t(()=>[M]),js:t(()=>[T]),default:t(()=>[e(y,{"align-center":""},{default:t(()=>[e(g,{onClick:a[0]||(a[0]=i=>o.sliderValue-=5),icon:"wi-minus","bg-color":"success",sm:""}),e(n,{class:"mx3 grow",modelValue:o.sliderValue,"onUpdate:modelValue":a[1]||(a[1]=i=>o.sliderValue=i),color:"green"},null,8,["modelValue"]),e(g,{onClick:a[2]||(a[2]=i=>o.sliderValue+=5),icon:"wi-plus","bg-color":"success",sm:""})]),_:1}),s("div",C,[D,s("code",A,c(o.sliderValue),1)])]),_:1}),e(d,{h2:""},{default:t(()=>[L]),_:1}),e(r,{"content-class":"px6"},{html:t(()=>[P]),js:t(()=>[F]),default:t(()=>[U,e(n,{modelValue:o.minMaxValue,"onUpdate:modelValue":a[3]||(a[3]=i=>o.minMaxValue=i),min:4,max:5},null,8,["modelValue"]),s("div",j,[z,s("code",E,c(o.minMaxValue),1)]),I,e(n,{modelValue:o.minMaxValue2,"onUpdate:modelValue":a[4]||(a[4]=i=>o.minMaxValue2=i),min:-10,max:10},null,8,["modelValue"]),s("div",W,[B,s("code",N,c(o.minMaxValue2),1)])]),_:1}),e(d,{h2:""},{default:t(()=>[q]),_:1}),e(r,{"content-class":"px6"},{html:t(()=>[O]),default:t(()=>[e(n,{class:"mt2","model-value":50,disabled:""}),e(n,{class:"mt8","model-value":50,readonly:""})]),_:1}),e(d,{h2:""},{default:t(()=>[R]),_:1}),e(r,{"content-class":"px6"},{html:t(()=>[Q]),default:t(()=>[e(n,{class:"mt2","model-value":50,"label-left":"0","label-right":"100"}),e(n,{class:"mt6","model-value":50,"label-left":"Left"}),e(n,{class:"mt6","model-value":50,"label-right":"Right"}),e(n,{class:"mt12","model-value":50},{"label-left":t(()=>[H,e(h,{class:"ml2 green"},{default:t(()=>[G]),_:1})]),"label-right":t(()=>[e(h,{class:"red"},{default:t(()=>[J]),_:1}),e(h,{class:"red"},{default:t(()=>[K]),_:1})]),_:1})]),_:1}),e(d,{h2:""},{default:t(()=>[X]),_:1}),e(r,{"content-class":"pt12 px8"},{html:t(()=>[Y]),default:t(()=>[e(n,{class:"mb4","model-value":24,"thumb-label":"",color:"primary-light3"})]),_:1}),e(d,{h3:"",slug:"custom-label-with-label-slot"},{default:t(()=>[Z,ee,le]),_:1}),e(r,{"content-class":"pt12 pb8 px8"},{html:t(()=>[l(`<w-slider
  class="ma12"
  :model-value="46.3"
  thumb-label
  color="primary-light3">
