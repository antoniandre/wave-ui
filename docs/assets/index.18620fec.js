import{r,o as _,f,a as t,w as a,b as o,h,e,_ as w,bR as k,bz as C,bS as O}from"./index.6bc90973.js";const $=o("p",{class:"mb3"},"What it looks like:",-1),I=o("div",{class:"title4 mt4"},"States",-1),E={class:"w-flex wrap"},P=o("p",{class:"mt12"},[e("There are 2 components: "),o("span",{class:"code"},"w-radio"),e(" & "),o("span",{class:"code"},"w-radios"),e(`.
...
`),Ie=e("Inline layout"),Ee=e('<w-radios :items="radioItems" inline></w-radios>'),Pe=e(`data: () => ({
  radioItems: [
    { label: 'Choice 1' },
    { label: 'Choice 2' },
    { label: 'Choice 3' }
...
`)],-1),Ne=o("span",{class:"code"},"w-radios",-1),We=e(" colors"),Re=e("Option 1"),ze=o("div",{class:"title4 mt8 mb2"},"Different color per item",-1),Ke=e("Option 2"),xe=e(`<w-radios
  class="mr2"
  v-model="selection1"
  :items="radios1"
  color="purple">
